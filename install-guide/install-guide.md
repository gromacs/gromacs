...
support OpenMP, and the current gcc ports do not support AVX
instructions. This may change when clang 3.5 becomes available.
...
value of `GMX_SIMD` to much the execution environment. If you
...
2. `SSE2` Essentially all x86 machines in existence have this
3. `SSE4.1` More recent x86 have this
4. `AVX_128_FMA` More recent AMD x86 have this
5. `AVX_256` More recent Intel x86 have this
6. `AVX2_256` Yet more recent Intel x86 have this
...
no accelerated kernels, and a custom build toolchain.
