...
the integrity (md5sum) of FFTW you should buid it yourself or
...
this option doesn't check the check the integrity of the tests and
thus poses a slight security risk.
