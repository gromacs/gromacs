...
the option {\tt --enable-mpi} to the {\tt configure} script and recompile.
...
With the implementation of threading in {\gromacs} version 4.5, 
if you have a single machine with multiple processors you don't have to
use the {\tt mpirun} command. Instead, you can supply the {\tt mdrun} option {\tt -nt}:
\type{mdrun -nt 8 -s topol.tpr}
