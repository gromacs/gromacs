...
The \normindex{hydrogen database} is stored in {\tt ffgmx.hdb}.
The \normindex{termini database}s are stored in {\tt ffgmx-n.tdb}
...
Note that option 9 is designed specifically to add a COOH
...
So \verb'confin.gro' is the {\gromacs} coordinate file and is almost
