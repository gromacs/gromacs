...
tab. bond	& {\tts bonds}$^{(excl)}$     & 2 & 8	& $k$ (\kJmol); table number ($\geq 0$) & $k$ 	\\
tab. bond	& {\tts bonds}                & 2 & 9	& $k$ (\kJmol); table number ($\geq 0$) & $k$ 	\\
LJ/Coul. 1-4	& {\tts pairs}		      & 2 & 1	& $V^{(cr)}$; $W^{(cr)}$ & all \\
LJ/C. 1-4 A	& {\tts pairs}		      & 2 & 2	& $V^{(cr)}$; $W^{(cr)}$ &     \\
...
Fourier dih.	& {\tts dihedrals}	      & 4 & 5	& $C_0$, $C_1$, $C_2$, $C_3$ (\kJmol) 	& all	\\
