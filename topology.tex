...
Cross bond-bond	& {\tts angles}$^{(c)}$	& 3 & 3	& $r_{1e}$, $r_{2e}$ (nm); $k_{rr'}$ (\kJmolnm{-2}) & 	\\
Cross bond-angle& {\tts angles}$^{(c)}$	& 3 & 4	&$r_{1e}$, $r_{2e}$ $r_{3e}$ (nm); $k_{r\theta}$ (\kJmolnm{-2}) & 	\\
Urey-Bradley    & {\tts angles}$^{(c)}$	& 3 & 5	& $\theta_0$ (deg); $k_\theta$ (\kJmol); $r_{13}$ (nm); $k_{UB}$ (
kJmol) & 	\\
