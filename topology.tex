...
proper dih.	& {\tt dihedraltypes}	& 2 & 1	& $\theta_{max}$ (deg); f$_c$ (\kJmol); mult & X	\\
...
\multicolumn{6}{l}{Multiplicities (mult) can never be modified.} \\
...
\begin{table}[p]
\centerline{\small\begin{tabular}{|l|llllc|}
\multicolumn{6}{c}{\bf \large Molecule(s)} \\
\hline
interaction 	& directive   	      & \#  & f. & parameters 				& pert \\
type	&		      	      & at. & tp &					& 	\\
\dline
...
proper dih.	& {\tt dihedrals}	& 4 & 1	& $\theta_{max}$ (deg); f$_c$ (\kJmol); mult & X	\\
...
distance res.	& {\tt distance\_restraints}	& 2 & 1	& type; index; low, up$_1$, up$_2$ (nm); & \\
 & & & & factor () & \\
angle res.	& {\tt angle\_restraints}	& 4 & 1	& $\theta_0$ (deg); f$_c$ (\kJmol); mult & X	\\
angle res. z & {\tt angle\_restraints\_z}	& 2 & 1	& $\theta_0$ (deg); f$_c$ (\kJmol); mult & X	\\
...
\multicolumn{6}{l}{'pert' indicates if this interaction type
can be modified during free energy perturbation} \\
\multicolumn{6}{l}{For atoms, only the type, charge and mass can be modified.} \\
\multicolumn{6}{l}{Multiplicities (mult) can never be modified.} \\
\multicolumn{6}{l}{For free energy perturbation, the parameters for topology 'B' (lambda = 1) should be added} \\
\multicolumn{6}{l}{on the same line, after the normal parameters,
in the same order as the normal parameters.} \\
