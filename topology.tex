...
The \normindex{bonded parameters} ({\ie} bonds, angles, improper and proper
...
\label{subsec:nbpar}
The \normindex{non-bonded parameters} consist of the Van der Waals parameters
...
The \normindex{1-4 interactions} are also listed for the atom types
