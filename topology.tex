...
scale factor for the HCT and OBC models. The values are taken from the original 
HCT reference~\cite{Truhlar96}, as well as the corresponding implementation in Tinker.
