...
heuristics do not always match your topology. Apply your brain, here!
...
* Grace - WYSIWYG 2D plotting tool for the X Window System and M\*\ tif. Grace runs on practically
  ...
  valid free alternative to Motif). As well, it has been successfully ported to VMS, OS/2, and
  Win9*/NT/2000/XP (some minor functionality may be missing, though)
