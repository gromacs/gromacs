...
This is the converted version of the LaTeX manual to rst,
...
This manual covers implementation details and can also be found as a `printable
pdf`_ (for those of you that hate trees).
