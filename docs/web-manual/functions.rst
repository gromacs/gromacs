...
:math:`f = \frac{1}{4\pi \varepsilon_0} = {138.935\,458}` (see chapter [ch:defunits])
...
-  Simple harmonic restraints: use ``[ bonds ]`` type 6 (see sec. [sec:excl]).

-  [subsec:harmonicrestraint]Piecewise linear/harmonic restraints: ``[ bonds ]`` type
   10.
