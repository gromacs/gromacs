...
2. Select the appropriate tools to be able to perform the simulation
   ...
   to read and familiarise yourself with publications by other
...
4. Generate the raw starting structure for the system by placing the
   ...
   be specifically placed or arranged randomly.
...
Some of the :ref:`command-line tools <command-line-reference>` refer
to these, and each tool documents which files it uses, and how they
are used.
