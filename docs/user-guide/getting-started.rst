...
by testing whether the non-environment variable ``POSRES_WATER`` was defined somewhere (i.e. "if defined").
...
restraints on your solvent, rather than your :ref:`top` file.
