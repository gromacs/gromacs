...
.. digraph:: flowchart
   ...
   input_pdb [
     ...
     URL="../web-manual/file-formats.html#pdb"
   ...
   pdb2gmx -> editconf [
     ...
     URL="../web-manual/file-formats.html#gro"
   ]
   ...
   pdb2gmx -> solvate [
     ...
     URL="../web-manual/file-formats.html#top"
   ]
   editconf -> solvate [
     label="conf.gro"
   ...
   input_mdp [
     ...
     URL="../web-manual/file-formats.html#mdp"
     shape=none, width=0, height=0, margin=0
     group=input
   ]
   grompp [
   ...
   grompp -> mdrun [
     ...
     URL="../web-manual/file-formats.html#tpr"
   ]
   mdrun -> mdrun [
     label="Continuation\nstate.cpt"
     labeltooltip="Checkpoint file"
     URL="../web-manual/file-formats.html#cpt"
   ]
   ...
   mdrun -> analysis [
     ...
     URL="../web-manual/file-formats.html#xtc"
   ]
   ...
   mdrun -> energy [
     ...
     URL="../web-manual/file-formats.html#edr"
   ]
