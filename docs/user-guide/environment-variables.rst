...
``GMX_DO_GALACTIC_DYNAMICS``
        ...
        this environment variable, which allows setting :term:`epsilon-r` to -1 in the :ref:`mdp`
...
``GMX_SCSIGMA_MIN``
        ...
        using the :term:`sc-sigma` keyword in the :ref:`mdp` file, but this environment variable can be used
