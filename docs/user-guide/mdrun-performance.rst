...
For more information see the `NVIDA blog article`_ on this topic.
...
``nvidia-smi``. If the system permissions allow, :red:`mdrun` has
...
For this reason, :ref:`mdrun` sets application clocks at initialization
