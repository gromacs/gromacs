...
|Gromacs| before version 2018:
  ...
  on GPUs. Each PP rank has a NB task that can be offloaded to a GPU.
...
.. TODO TODO: we need to be more concrete here, i.e. what machine/software aspects to take into consideration, when will default run mode be using PME-GPU and when will it not, when/how should the user reason about testing different settings than the default.
