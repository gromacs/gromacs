...
it can be worthwhile to optimized the use of those resources. Several issues
...
* If you have GPUs that support either CUDA or OpenCL, use them.
  ...
  * If compiling on a cluster head node, make sure that GMX_CPU_ACCELERATION is
    appropriate for the compute nodes.
