...
.. mdp:: awh-potential
   ...
   .. mdp-value:: convolved
      ...
      set of harmonic umbrella potentials (see :mdp:`awh-potential=umbrella` below). This results
...
.. mdp:: awh-share-bias-multisim
   ...
   .. mdp-value:: yes
      ...
      :ref:`gmx mdrun -multidir` will check whether the simulations are
      technically compatible for sharing, but the user should check that bias sharing
...
.. mdp:: awh1-growth
   ...
   As :mdp:`awh1-growth=exp-linear` but skip the initial stage. This may be useful if there is *a priori*
   knowledge (see :mdp:`awh1-error-init`) which eliminates the need for an initial stage. Also, this
   is the setting compatible with :mdp:`awh1-target=local-boltzmann`.
...
.. mdp:: awh1-equilibrate-histogram
   ...
   .. mdp-value:: yes
      ...
      Before entering the initial stage (see :mdp:`awh1-growth=exp-linear`), make sure the
...
.. mdp:: awh1-target
   ...
   .. mdp-value:: cutoff
      ...
      Similar to :mdp:`awh1-target=constant`, but the target
      distribution is proportional to 1/(1 + exp(F - :mdp:`awh1-target=cutoff`)),
   ...
   .. mdp-value:: local-boltzmann
      ...
      Same target distribution and use of :mdp:`awh1-target-beta-scaling=boltzmann`
      ...
      only compatible with :mdp:`growth=linear`, since for
      :mdp:`growth=exp-linear` histograms are globally rescaled initially.

.. mdp:: awh1-target-beta-scaling

   [0] \[kT\]/\[\]
   For :mdp:`awh1-target=boltzmann` and :mdp:`awh1-target=local-boltzmann`
...
.. mdp:: awh1-dim1-coord-provider
   ...
   .. mdp-value:: pull
      ...
      The module providing the raction coordinate for this dimension.
...
.. mdp:: awh1-dim1-cover-diameter
   ...
   before the point is considered covered in the initial stage (see :mdp:`awh1-growth=exp-linear`).
