...
.. mdp:: awh1-growth
   ...
   In the initial stage, the histogram is repeatedly 
   scaled down, keeping it at a constant size. Each time the sampling interval is 
   considered covered it is instead scaled up by a constant factor > 1.
...
.. mdp:: awh1-share-group
   ...
   .. mdp-value:: positive
      ...
      Within a simulation, the bias will be shared between biases with the
      ...
      can be critical, especially for many biases or replicas.
