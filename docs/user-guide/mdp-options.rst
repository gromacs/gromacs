...
.. mdp:: awh
   ...
   .. mdp-value:: yes
      ...
      the corresponding PMF. The PME and other AWH data are written to energy
...
.. mdp:: awh1-error-init
   ...
   (4.0) \[kT\]
   Estimated initial average error of the PMF for this bais. This value together with the
