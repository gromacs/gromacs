...
.. mdp:: awh-potential
   ...
   .. mdp-value:: umbrella
      ...
      from the relevant pull coordinate, see :mdp-value:`awh1-dim1-pull-coord`.
...
.. mdp:: awh1-growth
   ...
   is the setting compatible with :mdp-value:`awh1-target=local-boltzmann`.
...
.. mdp:: awh1-target-cutoff
   ...
   [0] \[kT\]/\[\]
   For :mdp:`awh1-target=cutoff` this this is the cutoff > 0 in units of kT.
...
.. mdp:: awh1-share-group
   ...
   .. mdp-value:: positive
      ...
      With :mdp-value:`awh-bias-share-multisim=yes` and
