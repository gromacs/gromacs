...
.. mdp:: nstxout
   ...
   trajectory file (.trr), the last coordinates are always written

.. mdp:: nstvout

   (0) \[steps\]
   number of steps that elapse between writing velocities to the output
   trajectory file (.trr), the last velocities are always written

.. mdp:: nstfout

   (0) \[steps\]
   number of steps that elapse between writing forces to the output
   trajectory file (.trr), the last forces are always written.
...
.. mdp:: nstxout-compressed
   ...
   using lossy compression (.xtc file)
