...
This version was released on August 4, 2016. These release notes
document the functionality changes that have taken place in GROMACS
since version 5.1.

Some bug fixes are mentioned here, but those fixed in 5.0 or 5.1
