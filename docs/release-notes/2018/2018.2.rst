...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
When the number of points in the AWH grid was large relative to the
number of samples required for covering the grid the detection of
covering was delayed because of too infrequent checks.
