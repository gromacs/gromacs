...
IncludeGroup.system_c = IncludeGroup(2)
IncludeGroup.system_c_cpp = IncludeGroup(3)
IncludeGroup.system_cpp = IncludeGroup(4)
IncludeGroup.system_other = IncludeGroup(5)
IncludeGroup.nonsystem_other = IncludeGroup(6)
IncludeGroup.gmx_general = IncludeGroup(7)
IncludeGroup.gmx_test = IncludeGroup(8)
IncludeGroup.gmx_local = IncludeGroup(9)
IncludeGroup.gmx_external = IncludeGroup(10)
IncludeGroup.config = IncludeGroup(11)
...
class GroupedSorter(object):
    ...
    def get_sortable_object(self, include):
        ...
        if not included_file:
            ...
            path = self._get_path(included_file, group, None)
        elif included_file.get_name() in ('config.h.cmakein', 'gmx_header_config.h'):
            ...
            if main_header and main_header == included_file:
                ...
                if included_file.get_directory().get_name() == 'testutils':
                ...
                elif including_file.get_directory() == included_file.get_directory():
                    if self._local_group == 'local':
                        ...
                        group = IncludeGroup.gmx_local
                    elif included_file.is_test_file():
                        group = IncludeGroup.gmx_test
                elif included_file.is_test_file():
                    group = IncludeGroup.gmx_test
