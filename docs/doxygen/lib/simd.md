...
than the full SIMD width and require the two most inner loops to be
vectorized together (OMP calls this collapse). For this SIMD4N functions are
...
These functions return the type alias Simd4NFloat / Simd4NDouble with is
