...
we can use this to improve performance. When GMX_SIMD_HAVE_HSIMD_FLOAT_UTIL
or GMX_SIMD_HAVE_HSIMD_DOUBLE_UTIL is set, a handful of routines to
...
<dt>`GMX_SIMD_HAVE_HSIMD_FLOAT_UTIL`</dt>
<dd>
Half-SIMD-width nonbonded kernel utilities available for float SIMD.
</dd>
<dt>`GMX_SIMD_HAVE_HSIMD_DOUBLE_UTIL`</dt>
<dd>
...
<dt>`GMX_SIMD_HAVE_HSIMD_UTIL`</dt>
<dd>
Half-SIMD-width kernel utilities available in default Gromacs precision.
</dd>
</dl>
