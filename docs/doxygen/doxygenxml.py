...
class BodyLocation(object):
    ...
    def __eq__(self, other):
        result = self.filepath == other.filepath
        if result:
            result = self.startline == other.startline
        if result:
            result = self.endline == other.endline
        return result
    ...
    def __lt__(self, other):
        ...
        if self.filepath == other.filepath:
            result = self.startline < other.startline
        if self.filepath == other.filepath and self.startline == other.startline:
            result = self.endline < other.endline
        return result
