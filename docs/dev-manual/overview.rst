...
intra-module/intra-file. Installed headers should compile by themselves,
without reference to variables defined in ``config.h`` or requiring
other headers to be included before it. Cyclic include dependencies
