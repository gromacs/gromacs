...
cppcheck
  cppcheck (<http://cppcheck.sourceforge.net>) is used for static code
...
uncrustify
  Uncrustify (<http://uncrustify.sourceforge.net>) is used for automatic
...
Doxygen
  Doxygen (<http://www.doxygen.org>) is used to extract documentation from
...
Sphinx
  Sphinx (<http://sphinx-doc.org/>; at least version 1.2.3) is used
