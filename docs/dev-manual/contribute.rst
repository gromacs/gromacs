...
on the fora, bug reports that let us reproduce the issue, and new
functionality.
...
* *Verifiable*: If you propose a new method that passes the first check,
  ...
  :doc:`jenkins` server, and we need quick feedback about whether your
...
* *Structured change process*: Reviewing code for correctness, quality
  ...
  break the process into manageable pieces, such as
    ...
    * the functionality to read the mdp settings you might require and
      write a tpr,
    * the functionality for mdrun to execute the simplest form of your
      feature,
...
* *Timeliness*: We make an annual release of |Gromacs|, with a feature
  ...
  change to propose, you need to
    ...
    a) make a group of smaller changes,
    b) negotiate in advance who will do the code review, and
    c) have them available for review and improvement months(!) before
...
help make the case for contributing the feature to the core.
...
you'll be the first to know when functionality is ready for people to
explore!
