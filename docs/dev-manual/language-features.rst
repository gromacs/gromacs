...
* Use ``not_null<T>`` pointers wherever possible to convey the
  ...
  is inappropriate. See also |linkref_not_null|.
...
.. |linkref_not_null| replace:: `here <http://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#Ri-nullptr> and here<http://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#Rf-nullptr>`__
