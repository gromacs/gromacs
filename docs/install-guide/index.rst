...
known under the "Knight's Corner" codename and the second generation
self-hosted "Knight's Landing" platform are supported.
...
In addition to the main DRAM memory, Knight's Landing has a high-bandwidth
