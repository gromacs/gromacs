...
by using the mdp option {\tt sc-coul} to {\tt yes}. The soft-core is
automatically switched on in the case of a single component lambda
in {\tt coul-lambdas}. Additionally, the soft-core interaction potential
is only applied when either the A or B
