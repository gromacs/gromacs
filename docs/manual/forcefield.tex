...
that in CHARMM.\cite{Steinbach1994} It is not recommended to switch
Coulomb interactions using this function,\cite{Spoel2006a} but
switching Lennard-Jones interactions using this function produces
acceptable results.
