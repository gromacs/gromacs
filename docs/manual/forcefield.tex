...
\item {\em Applied Forces}: forces due to electric
  fields.
\end{enumerate}
...
simulations of melting ice~\cite{Caleman2008a}. In the supporting
...
properties of molecules in the box. A pulsed electric field may look
like Fig.~\ref{fig:field}
\begin{figure}[ht]
...
\subsubsection{Using electric fields}
