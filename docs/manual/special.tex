...
GROMACS is capable of inserting the protein into pre-equilibrated lipid bilayers with minimal perturbation of the lipids using the method, which was initially described as a ProtSqueeze technique \cite{Yesylevskyy2007} and later implemented as g_membed tool \cite{Wolf2010}.
