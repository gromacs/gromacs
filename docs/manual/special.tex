...
If, to restore the requested ion counts, an ion from one compartment has to be exchaned 
with a water molecule from the other compartment, then those molecules are chosen
for the swap that have the largest distance to the compartment-defining boundaries
