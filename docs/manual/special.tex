...
The dihedral geometry requires six pull groups. These pair up in the same way as described above and define three vectors. The dihedral angle is defined as the angle between the two
