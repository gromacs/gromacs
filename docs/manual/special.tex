...
{\gromacs} can be used for solution-structural refinement by biasing the potential energy landscape towards configurations which reproduce experimental scattering data~\cite{Bjorling2015}. Currently this is implemented as a force based on the Debye equation, which describes the intensity ($S$) scattered by randomly oriented molecules composed of spherically scattering atoms.
	\begin{equation}
