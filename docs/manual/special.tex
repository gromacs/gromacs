...
within a cylinder with radius {\tt r-1} around the pull vector going
...
can be defined with {\tt r-0}, with a linear switch function that weighs
the contribution of atoms between {\tt r-0} and {\tt r-1} with
