...
\subsubsection{Definition of the angle pull geometry}
Four pull groups are required for {\tt pull-coord?-geometry = angle}. E.g., the {\tt .mdp} option {\tt pull-coord?-groups = 1 2 2 4}
defines the angle between the vector from group 1 to 2 and the vector from group 2 to 4. The angle takes values in the closed interval [0, 180] deg.
