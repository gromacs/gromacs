...
iontype0-name  = NA       ; Name of the ion type
iontype0-in-A  = 51       ; Reference count of iontype 0 in A
iontype0-in-B  = 35       ; Reference count of iontype 0 in B
iontype1-name  = K
iontype1-in-A  = 10
iontype1-in-B  = 38
iontype2-name  = CL
...
while the {\tt iontype0-name}, {\tt iontype0-in-A}, and {\tt iontype0-in-B} options
set the names and reference numbers of ions per type and per compartment.
The {\bf A} and {\bf B} reference numbers need to add up to the total number of ions in the group.
A number of {\tt -1} means: use the number of ions as found at the beginning
