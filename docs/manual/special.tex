...
The tensor $\eta_{\mu\nu}(\lambda)$ can be interpreted as the matrix elements of a friction tensor~\cite{sivak2012thermodynamic},
with elements inversely proportional to local diffusion coefficients.
...
A high peak in $\eta^{\frac{1}{2}}(\lambda)$ is an indicator of a region that takes relatively long to sample properly.
