...
not covalently bonded in one {\tt moleculetype} definition. Molecules are
to be infinitely long by connecting to themselves over periodic boundaries.
...
with other interactions that the usual non-bonded interactions. This is often
