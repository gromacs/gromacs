...
Isotropic polarization             & {\tts polarization}            & 2     & 1     & $\alpha$ (nm$^{3}$)                                   &            & \ssecref{polarize} \\
Anisotropic polarization           & {\ttss anisotropic_polarization} & 5    & 2     & $K_{11}$, $K_{22}$, $K_{33}$ ()                       &            & \ssecref{anisopol} \\
Thole screening                    & {\ttss thole_polarization}      & 4     & 2     & $\alpha_i$, $\alpha_j$ (nm$^{3}$); $a_1$, $a_2$ ()    &            & \ssecref{thole} \\
