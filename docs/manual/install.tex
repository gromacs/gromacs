...
\item   {\tt GMX_NBNXN_SIMD_2XNN}: force the use of 2x(N+N) SIMD CPU non-bonded kernels,
        mutually exclusive of {\tt GMX_NBNXN_SIMD_4XN} and {\tt GMX_NBNXN_NO_SIMD}.
\item   {\tt GMX_NBNXN_SIMD_4XN}: force the use of 4xN SIMD CPU non-bonded kernels,
        mutually exclusive of {\tt GMX_NBNXN_SIMD_2XNN} and {\tt GMX_NBNXN_NO_SIMD}.
\item   {\tt GMX_NBNXN_NO_SIMD}: force the use of the plain C 4x4 CPU non-bonded kernels,
        mutually exclusive of {\tt GMX_NBNXN_SIMD_2XNN} and {\tt GMX_NBNXN_SIMD_4XN}.
