...
.. table:: The :ref:`topology <top>` file.
        ...
        |                   |                           |     |    |  |C6LJ| (|KJN6|)                                |
        +-------------------+---------------------------+-----+----+-------------------------------------------------+
        |                   | ``distributed_charges``   |            atom type; distribution type (1) |DCT|;         |
        |                   |                           |            distribution constant |SC|                      |
        +-------------------+---------------------------+------------------------------------------------------------+
...
.. parsed-literal::
    ...
    |SC| the distribution constant is a function of the inverse distribution width
