...
;
/* With return value:
 * pmerecvqxX:             we should calculate PME mesh interactions for new x
 * pmerecvqxFINISH:        the simulation should finish, we should quit
 * pmerecvqxSWITCHGRID:    PME grid switch, grid_size and *ewaldcoeff are set
 * pmerecvqxRESETCOUNTERS: reset the cycle and flop counters, *step is set
 */
