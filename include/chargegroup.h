...
GMX_LIBGMX_EXPORT   void calc_chargegroup_radii(const gmx_mtop_t *mtop,rvec *x,
...
GMX_LIBGMX_EXPORT   void calc_cgcm(FILE *log,int cg0,int cg1,t_block *cgs,
			rvec pos[],rvec cg_cm[]);
  /* Routine to compute centers of geometry of charge groups. No periodicity
   * is used.
   */
  
GMX_LIBGMX_EXPORT   void put_charge_groups_in_box (FILE *log,int cg0,int cg1,
