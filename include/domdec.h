...
GMX_LIBMD_EXPORT
void dd_setup_dd_dlb_gpu_sharing(gmx_domdec_t *dd,
                                 int systemwide_unique_gpu_id);
 ...
 * systemwide_unique_gpu_id is used to split the MPI communicator, it should
 * therefore have a unique id for each GPU used in the whole simulation.
 */
