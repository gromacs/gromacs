...
enum 
{
    ...
    eNR_NBKERNEL_VDW_ELEC_VF,
    eNR_NBKERNEL_VDW_ELEC_F,
    eNR_NBKERNEL_VDW_ELEC_W3_VF,
    eNR_NBKERNEL_VDW_ELEC_W3_F,
    eNR_NBKERNEL_VDW_ELEC_W3W3_VF,
    eNR_NBKERNEL_VDW_ELEC_W3W3_F,
    eNR_NBKERNEL_VDW_ELEC_W4_VF,
    eNR_NBKERNEL_VDW_ELEC_W4_F,
    eNR_NBKERNEL_VDW_ELEC_W4W4_VF,
    eNR_NBKERNEL_VDW_ELEC_W4W4_F,
    
    eNR_NBKERNEL_NR,  /* Total number of "accelerated" kernel entries */
