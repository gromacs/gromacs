...
#  define gmx_mm256_castsi256_ps(a) _mm256_castsi256_ps(a)
#  define gmx_mm256_castps_si256(a) _mm256_castps_si256(a)
#  define gmx_mm256_castps_ps256(a) (a)
#elif defined(__GNUC__)
#  define gmx_mm256_castsi256_ps(a) ((__m256)(a))
#  define gmx_mm256_castps_si256(a) ((__m256i)(a))
#  define gmx_mm256_castps_ps256(a) ((__m256)(a))
#else
static __m256  gmx_mm256_castsi256_ps(__m256i a) { return *(__m256 *) &a;  } 
static __m256i gmx_mm256_castps_si256(__m256 a)  { return *(__m256i *) &a; } 
static __m256  gmx_mm256_castps_ps256(__m256 a) { return *(__m256 *) &a;  } 
#endif
...
{
    const __m256 signmask  = gmx_mm256_castsi256_ps( _mm256_set1_epi32(0x7FFFFFFF) );
...
{
	const __m256  expmask    = gmx_mm256_castsi256_ps( _mm256_set1_epi32(0x7F800000) );
    ...
    iexp  = gmx_mm256_castps_si256(fexp);
    ...
    imask = gmx_mm256_castps_si256(mask);
...
gmx_mm256_exp2_ps(__m256 x)
{
    ...
    fexppart  = _mm256_and_ps(valuemask,gmx_mm256_castsi256_ps(iexppart));
...
gmx_mm256_erf_ps(__m256 x)
{
    ...
    const __m256  sieve    = gmx_mm256_castsi256_ps( _mm256_set1_epi32(0xfffff000) );
    const __m256  signbit  = gmx_mm256_castsi256_ps( _mm256_set1_epi32(0x80000000) );
    const __m256  one      = _mm256_set1_ps(1.0f);
    const __m256  two      = _mm256_set1_ps(2.0f);
                    ...
                    __m256 *cosval)
{
    ...
    const __m256 mask_one    = gmx_mm256_castsi256_ps(_mm256_set1_epi32(1));
    const __m256 mask_two    = gmx_mm256_castsi256_ps(_mm256_set1_epi32(2));
    const __m256 mask_three  = gmx_mm256_castsi256_ps(_mm256_set1_epi32(3));
    ...
    offset_sin      = _mm256_and_ps(gmx_mm256_castsi256_ps(iz),mask_three); 
    ...
    offset_cos      = gmx_mm256_castsi256_ps(iz);  
    ...
    mask_sin        = _mm256_cmp_ps(_mm256_cvtepi32_ps(gmx_mm256_castps_si256(_mm256_and_ps(offset_sin,mask_one))),zero,_CMP_EQ_OQ);
    mask_cos        = _mm256_cmp_ps(_mm256_cvtepi32_ps(gmx_mm256_castps_si256(_mm256_and_ps(offset_cos,mask_one))),zero,_CMP_EQ_OQ);
#else
...
#ifdef __INTEL_COMPILER
    /* Intel Compiler version 12.1.3 20120130 is buggy if optimization is enabled unless we cast explicitly! */
    mask_sin        = _mm256_cmp_ps(_mm256_cvtepi32_ps(gmx_mm256_castps_si256(_mm256_and_ps(offset_sin,mask_two))),zero,_CMP_EQ_OQ);
    mask_cos        = _mm256_cmp_ps(_mm256_cvtepi32_ps(gmx_mm256_castps_si256(_mm256_and_ps(offset_cos,mask_two))),zero,_CMP_EQ_OQ);
#else
