...
extern void pr_scalar_gk(const char *fn,output_env_t oenv,int nx,int ny,int nz,
                         rvec box,real ***ghat);
...
extern real ***rd_ghat(FILE *log,output_env_t oenv,char *fn,ivec igrid,
...
extern void wr_ghat(const char *fn,output_env_t oenv, 
