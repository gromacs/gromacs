...
/* Yes, we do need all of these includes, since the instruction sets
 * are formally separate rather than incremental, although some compilers
 * would do it for us.
 */
#include <smmintrin.h>
...
/* The inline keyword is repeated here to avoid having the basic SSE4
 * definitions depend on other Gromacs include files.
 */
#ifndef gmx_inline
#  ifdef __cplusplus
