...
{
    const __m256d signmask  = gmx_mm256_castsi256_pd( _mm256_set_epi32(0x7FFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF, 0xFFFFFFFF, 
...
gmx_mm256_exp2_pd(__m256d x)
{
    ...
    fexppart  = _mm256_and_pd(valuemask,gmx_mm256_castsi256_pd(iexppart));
...
gmx_mm256_log_pd(__m256d x)
{
	...
	const __m256d expmask    = gmx_mm256_castsi256_pd( _mm256_set_epi32(0x7FF00000, 0x00000000, 0x7FF00000, 0x00000000,
    ...
    iexp     = gmx_mm256_castpd_si256(fexp);    
...
gmx_mm256_erf_pd(__m256d x)
{
    ...
    const __m256d signbit   = gmx_mm256_castsi256_pd( _mm256_set_epi32(0x80000000,0x00000000,0x80000000,0x00000000,
