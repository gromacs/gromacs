                              ...
                              gmx_mm_pb *interaction_mask_S2)
{
    ...
    *interaction_mask_S0  = gmx_checkbitmask_pb(mask_S, mask_S0);
    *interaction_mask_S2  = gmx_checkbitmask_pb(mask_S, mask_S2);
}
#endif
                             ...
                             gmx_mm_pb *interaction_mask_S3)
{
    ...
    gmx_exclmask mask_S = gmx_load1_exclmask(excl);
    *interaction_mask_S0  = gmx_checkbitmask_pb(mask_S, mask_S0);
    *interaction_mask_S1  = gmx_checkbitmask_pb(mask_S, mask_S1);
    *interaction_mask_S2  = gmx_checkbitmask_pb(mask_S, mask_S2);
    *interaction_mask_S3  = gmx_checkbitmask_pb(mask_S, mask_S3);
}
#endif
