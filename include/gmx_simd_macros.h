...
gmx_load_simd_2xnn_exclusions(int excl,
                              gmx_exclmask mask_S0, gmx_exclmask mask_S2,
                              gmx_mm_pb *excluded_S0, gmx_mm_pb *excluded_S2)
{
    /* Load integer interaction mask */
    gmx_exclmask mask_S = gmx_load1_exclmask(excl);
    *excluded_S0  = gmx_checkbitmask_pb(mask_S, mask_S0);
    *excluded_S2  = gmx_checkbitmask_pb(mask_S, mask_S2);
}
#endif

#if defined GMX_NBNXN_SIMD_4XN
static inline void
gmx_load_simd_4xn_exclusions(int excl,
                             gmx_exclmask mask_S0, gmx_exclmask mask_S1, gmx_exclmask mask_S2, gmx_exclmask mask_S3,
                             gmx_mm_pb *excluded_S0, gmx_mm_pb *excluded_S1, gmx_mm_pb *excluded_S2, gmx_mm_pb *excluded_S3)
{
    /* Load integer interaction mask */
    gmx_exclmask mask_S = gmx_load1_exclmask(excl);
    *excluded_S0  = gmx_checkbitmask_pb(mask_S, mask_S0);
    *excluded_S1  = gmx_checkbitmask_pb(mask_S, mask_S1);
    *excluded_S2  = gmx_checkbitmask_pb(mask_S, mask_S2);
    *excluded_S3  = gmx_checkbitmask_pb(mask_S, mask_S3);
}
#endif
