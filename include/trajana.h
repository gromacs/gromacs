...
extern int
gmx_ana_init_selections(gmx_ana_traj_t *d, output_env_t oenv);
...
extern int
gmx_ana_get_first_frame(gmx_ana_traj_t *d, t_trxframe **fr, output_env_t oenv);
...
extern int
xvgr_selections(FILE *out, gmx_ana_traj_t *d, output_env_t oenv);
