...
MACRO(GMX_TEST_FLOAT_FORMAT FP_IEEE754 FP_BIG_ENDIAN_BYTE FP_BIG_ENDIAN_WORD)
    IF(NOT DEFINED HAVE_${FP_IEEE754})
        ...
        elseif(GMX_IEEE754_LB_LW)
            ...
            MESSAGE(WARNING "Cannot detect your floating-point format. It is extremely unlikely to be anything else than IEEE754, but if we do not know the endian we need to reply on your OS providing the math functions erfd() and erfcd() rather than using our-built ones.")
        endif()
    ENDIF()
