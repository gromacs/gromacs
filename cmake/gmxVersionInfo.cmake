...
#
# Copyright (c) 2014,2015,2016,2017,2018,2019,2020,2021, The GROMACS development team.
...
set(REGRESSIONTEST_MD5SUM "7a4742db1fcd47328bbaf9d47fed3f72" CACHE INTERNAL "MD5 sum of the regressiontests tarball for this GROMACS version")
...
if (GMX_VERSION_STRING_OF_FORK)
    ...
    set(GMX_MANUAL_DOI_INTERNAL "10.5281/zenodo.5938884") # Set correct doi string here
    set(GMX_SOURCE_DOI_INTERNAL "10.5281/zenodo.5938877") # Set correct doi string here
endif()
