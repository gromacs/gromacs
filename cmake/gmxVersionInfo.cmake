...
if (GMX_GIT_VERSION_INFO)
    ...
    set(GENERATOR_IS_NINJA FALSE)
    if (CMAKE_GENERATOR STREQUAL "Ninja")
        set(GENERATOR_IS_NINJA TRUE)
        set(VERSION_INFO_STAMP_FILE ${PROJECT_BINARY_DIR}/VersionInfo.stamp)
        add_custom_command(OUTPUT ${VERSION_INFO_STAMP_FILE}
            COMMAND ${CMAKE_COMMAND} -E touch ${VERSION_INFO_STAMP_FILE}
            COMMENT "" VERBATIM)
        add_custom_command(OUTPUT ${VERSION_INFO_CMAKE_FILE}
            ...
            COMMAND ${CMAKE_COMMAND} -E remove -f ${VERSION_INFO_STAMP_FILE}
            WORKING_DIRECTORY ${PROJECT_SOURCE_DIR}
            DEPENDS ${VERSION_INFO_STAMP_FILE}
