...
set(REGRESSIONTEST_MD5SUM "ad2d2c32771f3fdf7d32aba2798b519a" CACHE INTERNAL "MD5 sum of the regressiontests tarball for this GROMACS version")
...
if (GMX_VERSION_STRING_OF_FORK)
    ...
    set(GMX_MANUAL_DOI_INTERNAL "10.5281/zenodo.18299930") # Set correct doi string here
    set(GMX_SOURCE_DOI_INTERNAL "10.5281/zenodo.18299929") # Set correct doi string here
endif()
