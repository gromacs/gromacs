...
set(REGRESSIONTEST_BRANCH "release-2026")
...
set(REGRESSIONTEST_MD5SUM "08714044b8fdcd45f0103fdb73afc9f7" CACHE INTERNAL "MD5 sum of the regressiontests tarball for this GROMACS version")
...
if (GMX_VERSION_STRING_OF_FORK)
    ...
    set(GMX_MANUAL_DOI_INTERNAL "10.5281/zenodo.17944199") # Set correct doi string here
    set(GMX_SOURCE_DOI_INTERNAL "10.5281/zenodo.17944095") # Set correct doi string here
endif()
