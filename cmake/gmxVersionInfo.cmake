...
set(REGRESSIONTEST_MD5SUM "5b8f458ca79f285abb4de34869afdfe6" CACHE INTERNAL "MD5 sum of the regressiontests tarball for this GROMACS version")
...
set(GMX_VERSION_STRING_OF_FORK "Colvars-2023-12-05" CACHE INTERNAL
...
if (GMX_VERSION_STRING_OF_FORK)
    ...
    set(GMX_MANUAL_DOI_INTERNAL "10.5281/zenodo.8134358") # Set correct doi string here
    set(GMX_SOURCE_DOI_INTERNAL "10.5281/zenodo.8134375") # Set correct doi string here
endif()
