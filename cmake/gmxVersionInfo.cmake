...
#   cmake_configure_version_file(<input> <output>
...
if (GMX_GIT_VERSION_INFO)
    ...
    configure_file(${VERSION_INFO_CMAKEIN_FILE}
                   ...
                   @ONLY)
    # Ensure that the file exists, to work around some generators on older
    # CMake versions generating build systems that choke if they try to resolve
    # all the dependencies before the file has been generated during a clean
    # build.
    file(WRITE ${VERSION_INFO_CMAKE_FILE} "Content will be generated at build time\n")
