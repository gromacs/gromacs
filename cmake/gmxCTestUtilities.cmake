...
macro (gmx_ctest_init)
    ...
    if (_cmake_build_type STREQUAL "ASAN")
        if (CMAKE_VERSION VERSION_LESS 3.1)
            message(WARNING "Running the tests with AddressSanitizer works much better in CMake 3.1+.")
        else()
...
function (gmx_get_test_prefix_cmd VAR)
    set(_one_value_args IGNORE_LEAKS)
    ...
    set(_cmd "")
    if (_opts AND MEMORYCHECK_TYPE STREQUAL "AddressSanitizer")
