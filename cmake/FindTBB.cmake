...
# this version too is hereby placed in the public domain and can be
...
if(NOT TBB_FIND_QUIETLY)
    message(STATUS "Looking for Intel Threading Building Blocks")
endif()
#
...
# We require that the release versions is present
if(TBB_LIBRARY_RELEASE)
    ...
    if(TBB_LIBRARY_DEBUG)
        set(TBB_LIBRARIES optimized ${TBB_LIBRARY_RELEASE} debug ${TBB_LIBRARY_DEBUG}
            CACHE STRING "Intel TBB libraries")
    else()
    ...
    if(NOT TBB_FIND_QUIETLY)
        message(STATUS "Looking for Intel Threading Building Blocks - found version ${TBB_VERSION}")
    endif()

else()
    # not found
    if(NOT TBB_FIND_QUIETLY)
        message(STATUS "Looking for Intel Threading Building Blocks - not found")    
    endif()
    if(TBB_FIND_REQUIRED)
        message(FATAL_ERROR "Required package Intel Threading Building Blocks not found.")
    endif()
endif()
