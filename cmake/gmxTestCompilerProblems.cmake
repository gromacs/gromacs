...
macro(gmx_test_compiler_problems)
    ...
    if(NOT "cxx_relaxed_constexpr" IN_LIST CMAKE_CXX_COMPILE_FEATURES) # relaxed constexpr is currently only required C++14. Also the feature is among the features last implemented in all supported compilers.
        if(CMAKE_COMPILER_IS_GNUCXX)
            set(cxx_required_version "GCC version 5")
        elseif(MSVC)
            set(cxx_required_version "Visual Studio 2017")
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
            set(cxx_required_version "Clang 3.6") # For feature complete C++14 only 3.4 is needed but prior version have bugs (e.g. debug symbol support)
        elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
            set(cxx_required_version "Intel Compiler 2017")
        endif()
        if (cxx_required_version)
            message(FATAL_ERROR "${cxx_required_version} or later required. Earlier versions don't have full C++14 support.")
        else()
