...
macro(gmx_test_compiler_problems)
    ...
    if(CMAKE_COMPILER_IS_GNUCC AND
            ...
            AND (WIN32 OR CYGWIN)
            AND(GMX_SIMD STREQUAL "AVX_256" OR GMX_SIMD STREQUAL "AVX2_256"))
        message(WARNING "GCC on Windows (GCC older than 4.9 or any version when compiling for 64bit) with AVX crashes. Choose SSE4_1 or a different compiler.") # GCC bug 49001, 54412.
    endif()
