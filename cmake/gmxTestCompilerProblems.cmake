...
macro(gmx_test_compiler_problems)
    ...
    # Since we are gradually moving entirely to C++, we only test the versions of the C++ compilers below
    if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")

        # Gromacs-2017 will require g++-4.8.1
        ...
        if((CMAKE_C_COMPILER_VERSION VERSION_LESS "4.9.0" OR CMAKE_SIZEOF_VOID_P EQUAL 8)
           AND (WIN32 OR CYGWIN)
    ...
    elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
        ...
        if(WIN32)
            if(CMAKE_VERSION VERSION_LESS "3.0.0")
                message(WARNING "Using Clang on Windows requires CMake 3.0.0")
            endif()
    ...
    elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
        ...
        if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "14.0")
            message(FATAL_ERROR "GROMACS requires version 14.0 or later of the Intel C++ compiler for complete C++11 support")
        endif()
