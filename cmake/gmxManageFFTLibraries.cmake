...
# Configure different FFT libraries
set(PKG_FFT "")
set(PKG_FFT_LIBS "")
...
if(${GMX_FFT_LIBRARY} STREQUAL "FFTW3")
    ...
    if((${GMX_CPU_ACCELERATION} MATCHES "SSE" OR ${GMX_CPU_ACCELERATION} MATCHES "AVX") AND ${FFTW}_HAVE_AVX)
        ...
        message(WARNING "The FFTW library was compiled with --enable-avx to enable AVX SIMD “
			“instructions. That might sound like a good idea for yourprocessor, but “
			...
			“instructions for the way GROMACS uses FFTs. Limitations in the way FFTW “
                        “allows GROMACS to measure performance make it awkward for either GROMACS “
                        “or FFTW to make the decision for you based on runtime performance. You “
                        “should compile a different FFTW library with --enable-sse or “
                        “-—enable-sse2. If you have a more recent FFTW, you may like to compare “
                        “the performance of GROMACS with FFTW libraries compiled with and without "
                        "--enable-avx. However, the GROMACS developers do not really expect the “
                        “FFTW AVX optimization to help, because the performance is limited by “
