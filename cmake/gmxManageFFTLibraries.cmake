...
if(${GMX_FFT_LIBRARY} STREQUAL "FFTW3")
    ...
    if ((${GMX_SIMD} MATCHES "SSE" OR ${GMX_SIMD} MATCHES "AVX") AND NOT ${FFTW}_HAVE_SIMD)
      ...
      if(${GMX_SIMD} MATCHES "AVX" AND NOT (${FFTW}_HAVE_SSE OR ${FFTW}_HAVE_SSE2 OR ${FFTW}_HAVE_AVX_128 OR ${FFTW}_HAVE_AVX2_128))
        # If we end up here we have an AVX CPU, and FFTW with SIMD, but no 128-bit SIMD, this means AVX is enabled for FFTW.
        message(WARNING "The FFTW library was compiled with neither --enable-sse or --enable-sse2; those would have enabled SSE(2) SIMD instructions. This will give sub-optimal performance. You should compile a different FFTW library with --enable-sse2 in addition to --enable-avx. The FFTW library will determine at runtime which SIMD instruction set is fastest for different parts of the FFTs.")
        endif()
    endif()
