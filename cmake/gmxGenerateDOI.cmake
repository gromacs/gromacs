...
# if build from a git repo, print the info that it is not a release version
if(NOT GMX_GET_RELEASE_DOI)
    if(SOURCE_IS_GIT_REPOSITORY)
    # include empty strings to set the information declaring this is not a release build
    ...
    # Not from git, so we can use the information we wrote before to populate the variables
    # gmxDOIVersion is generated from release builds, and populates both manual and source doi
    # strings. We can not get the info from Zenodo because it would require the use of our secret token
    # that I wont include here for obvious reasons.
    # TODO is it ok for me to generate an extra CMake file to use like this?
