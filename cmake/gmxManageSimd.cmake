...
if(NOT DEFINED GMX_SIMD_CALLING_CONVENTION)
    foreach(callconv __vectorcall __regcall "")
        # __vectorcall appears to be buggy for debug builds with clang-3.6 and 3.7; skip
        if(NOT ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang" AND "${callconv}" MATCHES "__vectorcall"))
