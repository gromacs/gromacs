...
# sourced from https://github.com/rpavlik/cmake-modules
...
function(add_cppcheck_sources _targetname)
	if(CPPCHECK_FOUND)
		...
		foreach(_source ${_input})
		  if(${_source} MATCHES "^-")
		    # Assume that all strings that match the above
		    # regex are options that should be passed to
		    # cppcheck. Note that usage such as "-D
		    # USE_CONFIG_H" will not work unless the space is
		    # removed.
		    list(APPEND _options "${_source}")
		  else()  
...
#			${CPPCHECK_QUIET_ARG}
			...
			COMMENT
			"Running cppcheck on all source files..."
			VERBATIM)
	endif()
endfunction()
