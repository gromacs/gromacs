...
set(FFTW_LIBRARY "${FFTW_LIBRARY_${FFTW_PKG}}" CACHE FILEPATH "Path to library ${FFTW_PKG}" FORCE)
...
elseif (NOT FFTW_LIBRARY_${FFTW_PKG})
  message("Could not find ${FFTW_PKG} library named lib${FFTW_PKG}, please specified its location in FFTW_LIBRARY by hand (e.g. -DFFTW_LIBRARY='/path/to/lib${FFTW_PKG}.so')")
elseif (NOT FFTW_INCLUDE_DIR_${FFTW_PKG})
  message("Could not the ${FFTW_PKG} header ${FFTW_HEADER}, please specified its path in FFTW_INCLUDE_DIR by hand (e.g. -DFFTW_INCLUDE_DIR='/path/to/include')")
endif()

set(FFTW_HAVE_SSE FALSE CACHE BOOL "If ${FFTW_PKG} was build with sse support")
if (FFTW_FOUND AND HAVE_LIBM)
  ...
  check_library_exists("${FFTW_LIBRARIES};m" "${FFTW_FUNCTION}" "" FOUND_FFTW_PLAN_${FFTW_PKG})
  ...
  foreach(SSE_FCT fftwf_have_simd_sse2;fftw_have_simd_sse2;fftwf_have_sse;fftw_have_sse2)
    check_library_exists("${FFTW_LIBRARIES};m" "${SSE_FCT}" "" FFTW_HAVE_${SSE_FCT}_${FFTW_PKG})
  ...
  endforeach()
  set(FFTW_HAVE_SSE "${FFTW_HAVE_SSE_${FFTW_PKG}}" CACHE BOOL "If ${FFTW_PKG} was build with sse support" FORCE)
