...
if (${CMAKE_SYSTEM_NAME} MATCHES static)
    set(BUILD_SHARED_LIBS OFF CACHE BOOL "Static build toolchain selected" FORCE)
endif()
...
set(GMX_THREAD_MPI OFF CACHE BOOL "Thread-MPI generally not compatible with BlueGene, disabled!" FORCE)
