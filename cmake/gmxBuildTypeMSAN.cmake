...
function(gmxManageMsanBuild)
    ...
    if(GMX_MSAN_PATH)
        set(_linker_flags "${_linker_flags} -L${GMX_MSAN_PATH}/lib -lc++abi -I${MSAN_PATH}/include -I${MSAN_PATH}/include/c++/v1 -Wl,-rpath,${GMX_MSAN_PATH}/lib")
    endif()
    set(CMAKE_EXE_LINKER_FLAGS "${_linker_flags} ${CMAKE_EXE_LINKER_FLAGS}" CACHE STRING "Linker flags for Memory Sanitizer")
    set(CMAKE_SHARED_LINKER_FLAGS "${_linker_flags} ${CMAKE_SHARED_LINKER_FLAGS}" CACHE STRING "Linker flags for Memory Sanitizer")
