...
if(GMX_OPENMP)
    ...
    set(GMX_OPENMP_MAX_THREADS 64 CACHE STRING "Maximum number of OpenMP Threads supported. Has to be multiple of 64.")
    mark_as_advanced(GMX_OPENMP_MAX_THREADS)
    math(EXPR MAX_THREAD_MOD "${GMX_OPENMP_MAX_THREADS} % 64")
    if (NOT ${MAX_THREAD_MOD} EQUAL 0)
       message(FATAL_ERROR "Only multiples of 64 supported for GMX_OPENMP_MAX_THREAD.S")  
    endif()
endif()
