...
MACRO(GMX_TEST_AVX_GCC_MASKLOAD_BUG VARIABLE)
    IF(NOT DEFINED TEST_${VARIABLE})

        MESSAGE(STATUS "Checking for gcc AVX maskload bug")

        FOREACH(MASKLOADDEF "" "-DGMX_X86_AVX_GCC_MASKLOAD_BUG")
            IF(NOT TEST_${VARIABLE})
                TRY_COMPILE(TEST_${VARIABLE} "${CMAKE_BINARY_DIR}"    
                            "${CMAKE_SOURCE_DIR}/cmake/TestAVXMaskload.c"
                            COMPILE_DEFINITIONS "@GROMACS_C_FLAGS@ ${MASKLOADDEF}" )
                SET(LAST_MASKLOADDEF ${MASKLOADDEF})
            ENDIF(NOT TEST_${VARIABLE})
        ENDFOREACH(MASKLOADDEF)

        IF(LAST_MASKLOADDEF MATCHES "-DGMX_X86_AVX_GCC_MASKLOAD_BUG")
        ...
        ELSE()
            ...
            MESSAGE(STATUS "Checking for gcc AVX maskload bug - not found")
        ENDIF()
