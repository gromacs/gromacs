...
function(gmx_manage_sz3)
    ...
    if(GMX_USE_HDF5)
        ...
        FetchContent_Declare(SZ3 EXCLUDE_FROM_ALL SOURCE_DIR ${CMAKE_SOURCE_DIR}/src/external/SZ3-bio)
        if (NOT ${SZ3}_POPULATED)
            message("Populating SZ3")
            FetchContent_MakeAvailable(SZ3)
        endif()
        message("CMake source dir: ${CMAKE_SOURCE_DIR}, SZ3 dirs:  ${SZ3_SOURCE_DIR} ${SZ3_BINARY_DIR}")
