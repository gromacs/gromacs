...
macro(GMX_TEST_LIBXML2 VARIABLE)
    find_package(LibXml2)

    if(NOT DEFINED ${VARIABLE} AND LIBXML2_FOUND)
        set(CMAKE_REQUIRED_INCLUDES "${LIBXML2_INCLUDE_DIR}")
        set(CMAKE_REQUIRED_LIBRARIES "${LIBXML2_LIBRARIES}")
        check_c_source_compiles(
            "#include <libxml/xmlwriter.h>
int main(void) { xmlTextWriterEndAttribute(0); }" LIBXML2_COMPILES_OK)
        set(${VARIABLE} ${LIBXML2_COMPILES_OK} CACHE INTERNAL "Result of test for system libxml2 support" FORCE)
    else()
        set(${VARIABLE} OFF CACHE INTERNAL "Result of not being able to test package libxml2 because it was not found" FORCE)
    endif()
endmacro()
