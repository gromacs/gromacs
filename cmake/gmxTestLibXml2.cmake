...
macro(GMX_TEST_LIBXML2 VARIABLE)
    ...
    if(LIBXML2_FOUND)
        gmx_check_if_changed(_do_libxml2_recompile LIBXML2_INCLUDE_DIR LIBXML2_LIBRARIES LIBXML2_COMPILES_OK)
        if(_do_libxml2_recompile)
            unset(LIBXML2_COMPILES_OK)
...
int main(void) { xmlTextWriterEndAttribute(0); }" LIBXML2_COMPILES_OK)
        ...
        set(${VARIABLE} ${LIBXML2_COMPILES_OK})
    else()
        set(${VARIABLE} OFF)
    endif()
endmacro()
