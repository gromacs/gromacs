...
# lmfit. Upon exit, the following cache variables may be set:
#
...
# LMFIT_INCLUDE_DIR and LMFIT_LIBRARIES on the cmake command line to
# suitable values will work.
...
find_library(LMFIT_LIBRARIES NAMES lmfit HINTS "${PC_LMFIT_LIBRARY_DIRS}" PATH_SUFFIXES lib64 lib)

# Make sure we can also link, so that cross-compilation is properly supported
if (LMFIT_INCLUDE_DIR AND LMFIT_LIBRARIES)
    include(CheckCXXSourceCompiles)
    set(CMAKE_REQUIRED_INCLUDES ${LMFIT_INCLUDE_DIR})
    set(CMAKE_REQUIRED_LIBRARIES ${LMFIT_LIBRARIES})
