...
if(GMX_MPI)
  ...
  if(NOT MPI_FOUND)
      ...
      # following flags, but if it ever does then we should re-visit
      # how we use the package.) If we are compiling with an MPI
      # wrapper compiler, then MPI_FOUND will be set above, and will
      # mean that none of these cache variables are populated by the
      # package. We need to do it manually so that test drivers can
      # work using the standard machinery for CMake + FindMPI.cmake.
      # Users will need to set these to suit their MPI setup in order
      # for tests to work.
