            ...
            if(NOT ${COMPILE_WORKS_VARIABLE})
                if (NOT RUN_QUIETLY)
                    if("${_testflag}" STREQUAL "")
                        message(STATUS "Could not find any compiler flags for test source. Try updating the compiler if you need this functionality.")
                    else()
                        message(STATUS "Found compiler flag, but executable did not build. Try updating binutils if you need this functionality.")
