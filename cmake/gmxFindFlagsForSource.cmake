    ...
    foreach(_testflag ${ARGN} "")
        ...
        if(${FLAG_ACCEPTED_VARIABLE})
            ...
            if(NOT ${COMPILE_WORKS_VARIABLE})
                if (NOT RUN_QUIETLY)
                    if("${_testflag}" STREQUAL "")
                        message(STATUS "Could not find any flag to build test source (this could be due either to the compiler or binutils)")
                    else()
                        message(STATUS "Flag was accepted, but it did not build test source (this could be due either to the compiler or binutils)")
