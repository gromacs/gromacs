            ...
            if(NOT ${COMPILE_WORKS_VARIABLE})
                if (NOT RUN_QUIETLY)
                    if("${_testflag}" STREQUAL "")
                        message(STATUS "Could not find working compiler flags. Updating compiler and/or binutils might help if you need this functionality.")
                    else()
                        message(STATUS "Found compiler flag, but executable did not build. Updating compiler and/or binutils might help if you need this functionality.")
