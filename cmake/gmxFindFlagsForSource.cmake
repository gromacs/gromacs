...
# VARIABLE            Name of variable to set true if we have found a flag that
#                     works (and set ${VARIABLE}_FLAG to contain that flag).
...
FUNCTION(GMX_FIND_CFLAG_FOR_SOURCE VARIABLE DESCRIPTION SOURCE CFLAGSVAR)
    ...
    if(TRUE)
        ...
        foreach(_testflag ${ARGN} "")
            ...
            # TODO These variables should not go into the cache, but
            ...
            if(${COMPILE_FLAG_VARIABLE} AND ${COMPILE_SIMD_VARIABLE})
                ...
                set(${VARIABLE} 1 CACHE INTERNAL "Result of test for ${DESCRIPTION}")
                break()
            endif()
        endforeach()
...
FUNCTION(GMX_FIND_CXXFLAG_FOR_SOURCE VARIABLE DESCRIPTION SOURCE CXXFLAGSVAR)
    ...
    if(TRUE)
        ...
        foreach(_testflag ${ARGN} "")
            ...
            # TODO These variables should not go into the cache, but
            # rather simply be set in the parent scope.
            if(${COMPILE_FLAG_VARIABLE} AND ${COMPILE_SIMD_VARIABLE})
                set(${VARIABLE}_FLAG "${_testflag}" CACHE INTERNAL "${DESCRIPTION}")
                set(${VARIABLE} 1 CACHE INTERNAL "Result of test for ${DESCRIPTION}")
                break()
