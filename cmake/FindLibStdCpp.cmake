...
if (NOT "${GCC_VERSION}" MATCHES "\\(GCC\\) ([0-9]+)\\.([0-9]+)") #Should never happen
   message(FATAL_ERROR "Couldn't detect g++ version for ${GCC_PATH}. Version output: ${GCC_VERSION}. Please report to developers."
           "${EXTRA_MESSAGE}")
endif()
if (${CMAKE_MATCH_1} LESS 5)
   set(GCC_PATH ${GCC_PATH})
   unset(GCC_PATH CACHE)
   message(FATAL_ERROR "Found g++ at ${GCC_PATH}. Its version is ${CMAKE_MATCH_1}.${CMAKE_MATCH_2}. GROMACS requires at least version 5.1. "
