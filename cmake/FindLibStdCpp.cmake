...
execute_process(COMMAND ${GCC_PATH} -dumpfullversion -dumpversion OUTPUT_VARIABLE GCC_VERSION
...
if (${GCC_VERSION} VERSION_LESS 5.1)
   ...
   message(FATAL_ERROR "Found g++ at ${GCC_PATH}. Its version is ${GCC_VERSION}. "
