...
if (NOT "${GCC_VERSION}" MATCHES "^[0-9]+\\.[0-9]+\\.[0-9]+$") #Should never happen
   message(FATAL_ERROR "Couldn't detect g++ version for ${GMX_GPLUSPLUS_PATH}. Version output: ${GCC_VERSION} "
           ", error: ${GCC_VERSION_ERROR}. Please report to developers. ${EXTRA_MESSAGE}")
endif()
...
if (${GCC_VERSION} VERSION_GREATER_EQUAL 7 AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19)
...
if (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
   ...
   if ("${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_${_cmake_build_type}}" MATCHES "--gcc-toolchain")
       message(WARNING "The --gcc-toolchain option is overwritten. Please set GMX_GPLUSPLUS_PATH.")
   endif()
   ...
   if ("${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_${_cmake_build_type}}" MATCHES "-gcc-name")
       message(WARNING "The -gcc-name option is overwritten. Please set GMX_GPLUSPLUS_PATH.")
   endif()
