...
function(gmx_set_build_information)
    ...
    gmx_run_cpu_detection(vendor   "Unknown${_reason}")
    gmx_run_cpu_detection(brand    "Unknown${_reason}")
    gmx_run_cpu_detection(family   "0")
    gmx_run_cpu_detection(model    "0")
    gmx_run_cpu_detection(stepping "0")
    gmx_run_cpu_detection(features "Unknown${_reason}")
endfunction()
