...
# build CPU features.
#
# The following cache variables will be set to the user/host/cpu used
# for configuration, or anonymous/unknown if it cannot be detected
# (Windows)
#
# BUILD_TIME
# BUILD_USER
...
function(gmx_set_build_information)
    ...
    gmx_run_cpu_detection(vendor)
    if (NOT BUILD_CPU_VENDOR)
        set(BUILD_CPU_VENDOR "Unknown${_reason}" PARENT_SCOPE)
    endif()
    ...
    if (NOT BUILD_CPU_FAMILY)
        set(BUILD_CPU_FAMILY "0" PARENT_SCOPE)
    endif()
    gmx_run_cpu_detection(model)
    if (NOT BUILD_CPU_MODEL)
        set(BUILD_CPU_MODEL "0" PARENT_SCOPE)
    endif()
    gmx_run_cpu_detection(stepping)
    if (NOT BUILD_CPU_STEPPING)
        set(BUILD_CPU_STEPPING "0" PARENT_SCOPE)
    endif()
    gmx_run_cpu_detection(features)
    if (NOT BUILD_CPU_FEATURES)
        set(BUILD_CPU_FEATURES "Unknown${_reason}" PARENT_SCOPE)
    endif()
endfunction()
