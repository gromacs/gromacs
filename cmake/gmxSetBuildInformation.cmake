...
function(gmx_set_build_information)
    ...
    set(_quietly FALSE)
    gmx_run_cpu_detection(vendor   "Unknown${_reason}" ${_quietly})
    gmx_run_cpu_detection(brand    "Unknown${_reason}" ${_quietly})
    gmx_run_cpu_detection(family   "0"                 ${_quietly})
    gmx_run_cpu_detection(model    "0"                 ${_quietly})
    gmx_run_cpu_detection(stepping "0"                 ${_quietly})
    gmx_run_cpu_detection(features "Unknown${_reason}" ${_quietly})
endfunction()
