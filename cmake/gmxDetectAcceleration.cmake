...
function(gmx_suggest_acceleration _suggested_acceleration)
    ...
    try_run(GMX_CPUID_RUN_ACC GMX_CPUID_COMPILED
            ...
            COMPILE_DEFINITIONS "@GCC_INLINE_ASM_DEFINE@ -I${CMAKE_SOURCE_DIR}/src/gromacs/legacyheaders/ -DGMX_CPUID_STANDALONE -DGMX_TARGET_X86"
...
function(gmx_detect_acceleration _suggested_acceleration)
    if(NOT DEFINED GMX_CPU_ACCELERATION)
        gmx_suggest_acceleration(${_suggested_acceleration})
