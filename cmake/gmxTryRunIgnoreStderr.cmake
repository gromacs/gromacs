    ...
    if(NOT DEFINED ${RUN_RESULT_VAR})
        ...
        if(NOT DEFINED ${COMPILE_RESULT_VAR})
            ...
            try_compile(${COMPILE_RESULT_VAR}
                        ...
                        OUTPUT_VARIABLE LOCAL_COMPILE_OUTPUT
            ...
            if(ARG_COMPILE_OUTPUT_VARIABLE)
                set(${ARG_COMPILE_OUTPUT_VARIABLE} "${LOCAL_COMPILE_OUTPUT}" CACHE INTERNAL "Output of compiling ${SRCFILE}")
            endif()
        endif()
        ...
        if(${${COMPILE_RESULT_VAR}})
            execute_process(COMMAND ${CMAKE_BINARY_DIR}/CMakeFiles/TryRunNoStderr_${COMPILE_RESULT_VAR}${CMAKE_EXECUTABLE_SUFFIX} ${ARG_ARGS}
                            RESULT_VARIABLE LOCAL_RUN_RESULT
                            OUTPUT_VARIABLE LOCAL_RUN_OUTPUT
                            ERROR_QUIET)

            if(ARG_RUN_OUTPUT_VARIABLE)
                set(${ARG_RUN_OUTPUT_VARIABLE} "${LOCAL_RUN_OUTPUT}" CACHE INTERNAL "Output of running compiled ${SRCFILE} with args ${ARG_ARGS}")
            endif()

            set(${RUN_RESULT_VAR} ${LOCAL_RUN_RESULT} CACHE INTERNAL "Result of running compiled ${SRCFILE} with args ${ARG_ARGS}")
