...
function(gmx_manage_onemkl)
    ...
    if("${SYCL_CXX_FLAGS_EXTRA}" MATCHES "fsycl-targets=.*(amdgcn|amd_gpu)")
    ...
    # spirv is default target when no fsycl-targets is specified
    if("${SYCL_CXX_FLAGS_EXTRA}" MATCHES "fsycl-targets=.*spir64" OR NOT "${SYCL_CXX_FLAGS_EXTRA}" MATCHES "fsycl-targets=")
