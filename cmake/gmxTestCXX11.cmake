  ...
  std::string message(\"hello\");
    ...
    if(NOT CXX11_STDLIB_PRESENT)
        if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel" AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS "16.0.3")
            message(FATAL_ERROR "GROMACS requires that the Intel C++ compiler use a compatible C++ standard library, for complete C++11 support, however not all compiler versions support all possible standard library implementations. In particular, before icc version 16.0.3, the gcc version 5 standard library was not supported. If you are affected by such a case, either update your compiler version, or consult the GROMACS installation guide for how to direct the use of a standard library from an older gcc version (but at least version 4.8.1 is needed).")
        else()
