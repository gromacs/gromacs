...
macro(GMX_TEST_IMAGEMAGICK VARIABLE)
    if(NOT ${ImageMagick_CONVERT_FOUND})
        set(${VARIABLE} OFF CACHE INTERNAL "Test if image conversion works" FORCE)
    ...
    elseif(NOT DEFINED ${VARIABLE})
        ...
        if (${TEST_OUTPUT} EQUAL 0)
            set(${VARIABLE} ON CACHE INTERNAL "Test if image conversion works" FORCE)
