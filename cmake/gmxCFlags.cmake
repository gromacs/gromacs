...
MACRO(gmx_c_flags)
    ...
    if (CMAKE_C_COMPILER_ID MATCHES "Intel")
	    ...
	    GMX_TEST_CFLAG(CFLAGS_FP_DEBUG "-fp-speculation safe" GMXC_CFLAGS_DEBUG)
	    GMX_TEST_CFLAG(CFLAGS_FP_RELASSERT "-fp-speculation safe" GMXC_CFLAGS_RELWITHASSERT)
        else()
            if(NOT GMX_OPENMP)
                GMX_TEST_CFLAG(CFLAGS_PRAGMA "/wd161" GMXC_CFLAGS)
            endif()
    ...
    if (CMAKE_CXX_COMPILER_ID MATCHES "Intel")
	    ...
	    GMX_TEST_CXXFLAG(CFLAGS_FP_DEBUG "-fp-speculation safe" GMXC_CXXFLAGS_DEBUG)
	    GMX_TEST_CXXFLAG(CFLAGS_FP_RELASSERT "-fp-speculation safe" GMXC_CXXFLAGS_RELWITHASSERT)
        endif()
    endif()
