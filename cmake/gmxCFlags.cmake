...
MACRO(gmx_c_flags)
    ...
    if (CMAKE_C_COMPILER_ID MATCHES "Intel")
        if (NOT WIN32) 
            if(NOT GMX_OPENMP)
                if(CMAKE_C_COMPILER_VERSION VERSION_GREATER 14.0.0)
...
#3346: dynamic exception specifications are deprecated
            ...
            GMX_TEST_CFLAG(CFLAGS_INLINE "/Qinline-max-size- /Qinline-max-total-size-" GMXC_CFLAGS)
        endif()
    endif()
    ...
    if (CMAKE_CXX_COMPILER_ID MATCHES "Intel")
        if (NOT WIN32) 
            if(NOT GMX_OPENMP)
                if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 14.0.0)
...
#2282: unrecognized GCC pragma
            ...
            GMX_TEST_CXXFLAG(CXXFLAGS_INLINE "/Qinline-max-size- /Qinline-max-total-size-" GMXC_CXXFLAGS)
        endif()
    endif()
