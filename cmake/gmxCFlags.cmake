...
MACRO(gmx_c_flags)
    ...
    elseif(${GMX_CPU_ACCELERATION} STREQUAL "SSE2")
        ...
        check_include_files(emmintrin.h  HAVE_EMMINTRIN_H ${ACCELERATION_C_FLAGS})
    ...
    elseif(${GMX_CPU_ACCELERATION} STREQUAL "SSE4.1")
        ...
        check_include_files(smmintrin.h  HAVE_SMMINTRIN_H ${ACCELERATION_C_FLAGS})
    ...
    elseif(${GMX_CPU_ACCELERATION} STREQUAL "AVX_128_FMA" OR ${GMX_CPU_ACCELERATION} STREQUAL "AVX_256")
        ...
        check_include_files(immintrin.h  HAVE_IMMINTRIN_H ${ACCELERATION_C_FLAGS})
        ...
        check_include_files(x86intrin.h HAVE_X86INTRIN_H ${ACCELERATION_C_FLAGS})
        check_include_files(intrin.h HAVE_INTRIN_H ${ACCELERATION_C_FLAGS})
