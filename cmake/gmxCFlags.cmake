...
MACRO(gmx_c_flags)
    ...
    if (CMAKE_C_COMPILER_ID MATCHES "Intel")
        if (NOT WIN32) 
            ...
            GMX_TEST_CFLAG(CFLAGS_FP_DEBUG "-fp-model strict" GMXC_CFLAGS_DEBUG)
            GMX_TEST_CFLAG(CFLAGS_FP_RELASSERT "-fp-model strict" GMXC_CFLAGS_RELWITHASSERT)
        else()
            if(NOT GMX_OPENMP)
                GMX_TEST_CFLAG(CFLAGS_PRAGMA "/wd161" GMXC_CFLAGS)
            endif()
    ...
    if (CMAKE_CXX_COMPILER_ID MATCHES "Intel")
        if (NOT WIN32) 
            ...
            GMX_TEST_CXXFLAG(CFLAGS_FP_DEBUG "-fp-model strict" GMXC_CXXFLAGS_DEBUG)
            GMX_TEST_CXXFLAG(CFLAGS_FP_RELASSERT "-fp-model strict" GMXC_CXXFLAGS_RELWITHASSERT)
        endif()
    endif()
