...
MACRO(gmx_c_flags)
    ...
    if(${CMAKE_C_COMPILER_ID} MATCHES Fujitsu OR
       (${CMAKE_C_COMPILER_ID} MATCHES unknown AND ${CMAKE_C_COMPILER} MATCHES ^fcc))
        ...
        GMX_TEST_CFLAG(CFLAG_OPT "-Kfast,reduction,swp,simd=2,uxsimd,fsimple,largepage,preex -x100 -DGMX_RELAXED_DOUBLE_PRECISION" GMXC_CFLAGS)
    endif()
    ...
    if(${CMAKE_CXX_COMPILER_ID} MATCHES Fujitsu OR
       (${CMAKE_CXX_COMPILER_ID} MATCHES unknown AND ${CMAKE_CXX_COMPILER} MATCHES ^FCC))
        ...
        GMX_TEST_CXXFLAG(CXXFLAG_PCH "--pch" GMXC_CXXFLAGS)
        GMX_TEST_CXXFLAG(CXXFLAG_OPT "-Kfast,reduction,swp,simd=2,uxsimd,fsimple,largepage,preex -x100 -DGMX_RELAXED_DOUBLE_PRECISION" GMXC_CXXFLAGS)
    endif()
