...
if (GMX_GPU_NB_NUM_CLUSTER_PER_BIN_X AND NOT "${GMX_GPU_NB_NUM_CLUSTER_PER_BIN_X}" EQUAL 2)
    message(FATAL_ERROR "Changing GMX_GPU_NB_NUM_CLUSTER_PER_BIN_X is not supported with OpenCL")
endif()
if (GMX_GPU_NB_NUM_CLUSTER_PER_BIN_Y AND NOT "${GMX_GPU_NB_NUM_CLUSTER_PER_BIN_Y}" EQUAL 2)
    message(FATAL_ERROR "Changing GMX_GPU_NB_NUM_CLUSTER_PER_BIN_Y is not supported with OpenCL")
endif()
if (GMX_GPU_NB_NUM_CLUSTER_PER_BIN_Z AND NOT "${GMX_GPU_NB_NUM_CLUSTER_PER_BIN_Z}" EQUAL 2)
    message(FATAL_ERROR "Changing GMX_GPU_NB_NUM_CLUSTER_PER_BIN_Z is not supported with OpenCL")
endif()
