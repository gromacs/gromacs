...
elseif(${GMX_CPU_ACCELERATION} STREQUAL "AVX_128_FMA")
    ...
    gmx_find_cflag_for_source(CFLAGS_AVX "C compiler AVX flag"
                              "#include<immintrin.h>
                              int main(){__m256 x=_mm256_set1_ps(0.5);x=_mm256_rsqrt_ps(x);return 0;}"
                              ACCELERATION_C_FLAGS
                              "-mavx")
    gmx_find_cxxflag_for_source(CXXFLAGS_AVX "C++ compiler AVX flag"
                                "#include<immintrin.h>
                                int main(){__m256 x=_mm256_set1_ps(0.5);x=_mm256_rsqrt_ps(x);return 0;}"
                                ACCELERATION_CXX_FLAGS
                                "-mavx")
    ...
    gmx_find_cflag_for_source(CFLAGS_AVX_128_FMA "C compiler AVX FMA4 flag"
                              "#include<immintrin.h>
                              int main(){__m128 x=_mm_set1_ps(0.5);x=_mm_macc_ps(x,x,x);return 0;}"
                              ACCELERATION_C_FLAGS
                              "-mfma4")
    gmx_find_cxxflag_for_source(CXXFLAGS_AVX_128_FMA "C++ compiler AVX FMA4 flag"
                                "#include<immintrin.h>
                                int main(){__m128 x=_mm_set1_ps(0.5);x=_mm_macc_ps(x,x,x);return 0;}"
                                ACCELERATION_CXX_FLAGS
                                "-mfma4")
    ...
    gmx_find_cflag_for_source(CFLAGS_AVX_XOP "C compiler AVX XOP flag"
                              "#include<immintrin.h>
                              int main(){__m128 x=_mm_set1_ps(0.5);x=_mm_frcz_ps(x);return 0;}"
                              ACCELERATION_C_FLAGS
                              "-mxop")
    gmx_find_cxxflag_for_source(CXXFLAGS_AVX_XOP "C++ compiler AVX XOP flag"
                                "#include<immintrin.h>
                                int main(){__m128 x=_mm_set1_ps(0.5);x=_mm_frcz_ps(x);return 0;}"
                                ACCELERATION_CXX_FLAGS
                                "-mxop")
...
elseif(${GMX_CPU_ACCELERATION} STREQUAL "AVX2_256")
    ...
    gmx_find_cflag_for_source(CFLAGS_AVX "C compiler AVX2 flag"
                              "#include<immintrin.h>
                              int main(){__m256 x=_mm256_set1_ps(0.5);x=_mm256_fmadd_ps(x,x,x);return 0;}"
                              ACCELERATION_C_FLAGS
                              "-march=core-avx2" "-mavx2")
    gmx_find_cxxflag_for_source(CXXFLAGS_AVX "C++ compiler AVX2 flag"
                                "#include<immintrin.h>
                                int main(){__m256 x=_mm256_set1_ps(0.5);x=_mm256_fmadd_ps(x,x,x);return 0;}"
                                ACCELERATION_CXX_FLAGS
                                "-march=core-avx2" "-mavx2")
