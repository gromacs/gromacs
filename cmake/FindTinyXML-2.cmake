...
if(PKG_CONFIG_FOUND)
    ...
    set(TinyXML2_INCLUDE_DIR ${PC_TINYXML2_INCLUDE_DIRS} CACHE PATH "TinyXML-2 include directory")
    set(TinyXML2_LIBRARIES ${PC_TINYXML2_LIBRARIES} CACHE STRING "TinyXML-2 libraries")
endif()

if(NOT TinyXML2_INCLUDE_DIR OR NOT TinyXML2_LIBRARIES)
    # Try to find tinyxml2 the hard way
    find_path(TinyXML2_INCLUDE_DIR tinyxml2.h "${TinyXML2_DIR}" PATH_SUFFIXES include)
    find_library(TinyXML2_LIBRARIES NAMES tinyxml2 "${TinyXML2_DIR}" PATH_SUFFIXES lib64 lib)
