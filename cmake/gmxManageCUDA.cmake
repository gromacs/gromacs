...
# Set up a variable that can later be changed to reflect whether
# gmxManageCUDA has already been run for this build without exiting
# with a fatal error.
if (NOT GMX_MANAGE_CUDA_DONE)
    set(GMX_MANAGE_CUDA_DONE FALSE CACHE INTERNAL "Whether gmxManageCUDA has already been run in this or a previous pass of CMake.")
endif()
...
# Set this property if the target has changed, or it's the first time we're here
if(_gmx_cuda_target_changed OR NOT GMX_MANAGE_CUDA_DONE)
