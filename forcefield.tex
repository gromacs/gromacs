...
It should be noted that the potential is asymetric, overstretching leads to
...
crystals~\cite{Ewald21}. The idea is to convert the single slowly
converging sum \eqnref{totalcoulomb} into two fast converging terms
and a constant term:
\begin{eqnarray}
...
blocks. Note that all {\gromacs} programs can read compressed or gzip:ed files.
