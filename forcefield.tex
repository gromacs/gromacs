...
{\gromacs} {\gmxver} includes two {\gromacs} force fields and
three {\gromos} forcefields. The {\gromacs} forcefields are based on
...
should be the inverse unit of the observable.
...
\section{\normindex{Free energy interactions}}
\label{sec:feia}
