...
The are two different types of bonds, one that generates exclusions (type 8)
...
\item[{\bf\sf 4fdn.}]From four atoms, with a fixed distance, see separate Fig.\ \ref{fig:vsite-4fdn}.
