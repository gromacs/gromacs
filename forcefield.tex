...
As explained in ~\secref{disre}, multiple distances can contribute
...
obtain a distance restraint which will never be time averaged, this
can be useful for restraining hydrogen bonds.
