...
over the {\gromacs} force field for proteins and all small molecules.
It is, however, recommended to be used for long alkanes and lipids.
The \gromosv{96} force field differs from the {\gromacs} force field
in a few aspects:
\begin{itemize}
