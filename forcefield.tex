...
\item[{\bf\sf COG.}]The center of geometry of $N$ atoms:
\beq
        \vvis ~=~ \frac{1}{N} \sum_{i=1}^N \ve{r_i}
\eeq
The force is determined analogously.

\item[{\bf\sf COM.}]The center of mass of $N$ atoms:
\beq
        \vvis ~=~ \sum_{i=1}^N m_i \ve{r_i} \left(\sum_{i=1}^N m_i \right)^{-1}
\eeq
The force is determined analogously.
