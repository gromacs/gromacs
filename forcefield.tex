...
\begin{figure}
\centerline{\raisebox{1.8cm}{\includegraphics[angle=270,width=5cm]{plots/bstretch}}\includegraphics[width=7cm]{plots/f_bond}}
...
\begin{figure}
\centerline{\raisebox{1.5cm}{\includegraphics[angle=270,width=5cm]{plots/angle}}\includegraphics[width=7cm]{plots/f_angle}}
...
\begin{figure}
\centerline{\raisebox{1cm}{\includegraphics[angle=270,width=5cm]{plots/dih}}\includegraphics[width=7cm]{plots/f_dih}}
