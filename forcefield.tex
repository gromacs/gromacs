...
\eeq
Tironi {\etal} have introduced a \normindex{generalized reaction field} in which
...
\normindex{Ewald}, or \normindex{PME}), the effect of such
...
\subsection{Modified short-range interactions with \normindex{Ewald} summation}
When \normindex{Ewald summation} or \seeindex{particle-mesh
