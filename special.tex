...
This provides a unique and contiunuous reference position that is nearly
...
Therefore numercal correspondence between some properties of the system's state
...
are hardcoded in OpenMM, i.e. obc\_alpha=1, obc\_beta=0.8 and obc\_gamma=4.85.
