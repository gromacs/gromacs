...
{\bf Note: the use of PVM is deprecated due to the fact that the FFTW
library only has support for MPI.}\\
If you have a parallel computer, it may be equipped with PVM (Parallel
Virtual Machines, see also \chref{algorithms}), otherwise,
