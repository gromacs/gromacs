...
acceleration is usually only about 4 times relative to a 3GHz CPU.
\end{itemize}
...
\begin{itemize}
\item CMAP dihedrals in CHARMM are not supported, so use the {\tt -nocmap} option with pdb2gmx.
\end{itemize}
