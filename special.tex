...
Another limitation is connected with pressure scaling.
...
Gamess-UK\cite{gamess-uk}, Gaussian\cite{g03} and CPMD\cite{cpmd}).


Gromacs interactions between the two subsystems are
either handled as described by Field {\it{et al.}}\cite{field90} or
within the ONIOM approach by Morokuma and coworkers\cite{Maseras96,
Svensson96}.
