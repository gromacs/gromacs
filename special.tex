...
work in most of the cases. Below we summarize how to get the GPU accelerated mdrun-gpu work.
...
to or higher then modern CPUs. For this reason, mdrun-gpu is compatible with 
...
mdrun-gpu and the OpenMM libraries. 

To compile mdrun-gpu change to the top level directory of the source 
