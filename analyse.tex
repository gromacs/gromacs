...
${\bf v}_1,\ldots,{\bf v}_n$ and ${\bf w}_1,\ldots,{\bf w}_n$
can be quantified as follows:
\beq
\mbox{overlap}({\bf v},{\bf w}) =
\frac{1}{n} \sum_{i=1}^n \sum_{j=1}^n ({\bf v}_i \cdot {\bf w}_j)^2
\eeq
The overlap is 1 when sets ${\bf v}$ and ${\bf w}$ span the same subspace.
