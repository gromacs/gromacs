...
viewer {\tt ngmx}; the advantage with this one is that it does not
...
can use the Einstein relation~\cite{Allen87}
\beq
...
The cosine content can be calculated with {\tt g\_analyze}.
