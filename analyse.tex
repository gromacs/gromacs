...
Usually the value of $r_{max}$ is half of the boxlength.  The
...
$r+dr$, see fig.~\ref{fig:rdfex}A) and makes a histogram in stead of
the $\delta$-function. An example of the rdf of Oxygen-Oxygen in
SPC-water~\cite{Berendsen81} is given in fig.~\ref{fig:rdf}.
