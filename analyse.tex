...
analysis programs.  To help creating such \normindex{index file}s ({\tt
...
The definition of the \normindex{autocorrelation function} (ACF)
...
\label{sec:msd}
To determine the self \normindex{diffusion coefficient} $D_A$ of particles $A$ one
...
\label{sec:covanal}
\normindex{Covariance analysis}, also called
\normindex{principal component analysis}
or \normindex{essential dynamics}
...
The overlap of the subspace of $m$ orthonormal vectors 
${\bf w}_1,\ldots,{\bf w}_n$ with a reference subspace of $n$ orthonormal
vectors ${\bf v}_1,\ldots,{\bf v}_n$ can be quantified as follows:
\beq
