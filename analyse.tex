...
example of $g_{AB}$), use \ttusindex{make}{ndx}. To generate an index file
with angles or dihedrals, use \ttusindex{mk}{angndx}. Of course you can also
...
\ttusindex{g}{select}\\
{\gromacs} also includes a {\tt g\us{}select} tool that can be used to
select atoms based on more flexible criteria than in {\tt make\us{}ndx},
...
read by running {\tt g\us{}select} and typing {\tt help} at the selection
...
monitored in time by the program \ttusindex{g}{com}. It is however
...
\caption[Definition of slices in {\tt g\us{}rdf}.]{Definition of slices
in {\tt g\us{}rdf}: A. $g_{AB}(r)$. B. $g_{AB}(r,\theta)$. The slices are
...
\ttusindex{g}{rdf} divides the system into spherical slices (from $r$ to
...
With {\tt g\us{}rdf} it is also possible to calculate an angle dependent rdf 
...
This can also be used for rotational autocorrelation (\ttusindex{g}{rotacf}) 
and dipole autocorrelation (\ttusindex{g}{dipoles}).
...
The program \ttusindex{g}{velacc} calculates th3 {\em velocity autocorrelation 
function}.
\beq
...
\ttusindex{g}{energy} can compute the viscosity,
...
program \ttusindex{g}{msd}. Normally an index file containing
...
nearly identical to averaging over atoms, however. The {\tt g\us{}msd}
program can
...
\label{sec:bad}
{\tt g\us{}bond, g\us{}angle, g\us{}sgangle}\\
To monitor specific {\em bonds} in your molecules during time, the program 
\ttusindex{g}{bond} calculates the distribution of the bond length in time. 
...
The program \ttusindex{g}{angle} calculates the distribution of {\em angles} and 
...
molecule, see \figref{sgangle}A, B, C), use the program \ttusindex{g}{sgangle}.

\begin{figure}
\centerline{
{\includegraphics[width=6.5cm,angle=270]{plots/sgangle}}}
\caption[Options of {\tt g\us{}sgangle}.]{Options of {\tt g\us{}sgangle}: A. Angle between 2 vectors. B. Angle between a vector and the normal of a plane. C. Angle between two planes. D. Distance between the geometrical centers of 2 planes. E. Distances between a vector and the center of a plane.}
\label{fig:sgangle}
\end{figure}

For planes, \ttusindex{g}{sgangle} uses the normal vector perpendicular to the plane.  It
...
\label{sec:rg}
{\tt g\us{}gyrate, g\us{}sgangle, g\us{}mindist, g\us{}mdmat, xpm2ps}\\
To have a rough measure for the compactness of a structure, you can calculate 
the {\em radius of gyration} with the program \ttusindex{g}{gyrate} as follows:
\beq
...
%\ifthenelse{\equal{\gmxlite}{1}}{
%\ttusindex{g}{sgangle}.}
{\ttusindex{g}{sgangle}, as explained in \secref{bad}.}
\item[$\bullet$] 
The {\em minimum distance} between two groups of atoms during time 
can be calculated with the program \ttusindex{g}{mindist}. It also calculates the 
...
the program \ttusindex{g}{mdmat}. This minimum distance between two residues
...
\ttusindex{g}{rms} by least-square fitting the structure to the reference structure
...
can be plotted and analyzed with \ttusindex{g}{anaeig}.
The cosine content can be calculated with \ttusindex{g}{analyze}.
%} % Brace matches ifthenelse test for gmxlite

%\ifthenelse{\equal{\gmxlite}{1}}{}{
\section{Dihedral principal component analysis}
{\tt g\us{}angle, g\us{}covar, g\us{}anaeig}\\
...
dihedral angles of interest in an index file, either using {\tt
  mk\us{}angndx} or otherwise. Then you use the {\tt g\us{}angle} program
...
necessary.  Then you can use this {\tt .trr} file as input for the {\tt
  g\us{}covar} program and perform principal component analysis as usual.
...
You should use the {\tt -nofit} option for {\tt
  g\us{}covar} since the coordinates in the dummy reference file do not
correspond in any way to the information in the {\tt .trr} file. Analysis of
the results is done using {\tt g\us{}anaeig}.  
%} % Brace matches ifthenelse test for gmxlite
...
{\tt g\us{}hbond}\\
The program \ttusindex{g}{hbond} analyses the {\em hydrogen bonds} (H-bonds)
...
The program {\tt g\us{}hbond} analyses all hydrogen bonds existing
...
% The -ins option appears to have been removed during the course of version 4.5 development
% \item
...
{\tt do\us{}dssp, g\us{}rama, g\us{}xrama, g\us{}wheel}\\
...
during your run. For this, you can use the program \ttusindex{do}{dssp}, which is 
...
{\tt do\us{}dssp} is given in \figref{dssp}.
...
To evaluate this Ramachandran plot you can use the program \ttusindex{g}{rama}. 
...
using the \ttusindex{g}{wheel} program. Two examples are 
...
{\tt g\us{}order, g\us{}density, g\us{}potential, g\us{}traj}\\
...
\ttusindex{g}{order} can calculate order parameters using the equation:
...
molecules. The program \ttusindex{g}{potential} divides the box in slices and
...
The program \ttusindex{g}{traj} is a very simple analysis program. All it
...
% The program \ttusindex{g}{pvd} calculates a lot of properties, among which
...
The program \ttusindex{g}{density} also calculates the density of groups, 
...
\ttusindex{do}{shift}. This is just an {\gromacs} interface to
