...
read by running {\tt g\_select} and typing {\tt help} at the selection
...
The program {\tt \normindex{g\_velacc}} calculates th3 {\em velocity autocorrelation 
function}.
\beq
...
For planes, {\tt \normindex{g\_sgangle}} uses the normal vector perpendicular to the plane.  It
...
{\tt do\_dssp, g\_rama, g\_xrama, g\_wheel}\\
...
using the {\tt \normindex{g\_wheel}} program. Two examples are 
...
The program {\tt \normindex{g\_density}} also calculates the density of groups, 
