...
example of $g_{AB}$), use {\tt \normindex{make_ndx}}. To generate an index file
...
``Protein'' entry.  The process for determinding DNA, RNA, etc. is analogous.
...
The program {\tt \normindex{g_velacc}} calculates th3 {\em velocity autocorrelation 
function}.
\beq
