...
if ("$ENV{RUNNER_OS}" STREQUAL "Windows")
    if ("$ENV{RUNNER_ARCH}" STREQUAL "ARM64")
        set(ninja_suffix "winarm64.zip")
        set(cmake_suffix "windows-arm64.zip")
        set(cmake_dir "cmake-${cmake_version}-windows-arm64/bin")
        set(ccache_suffix "windows-aarch64.zip")
        set(ccache_dir "ccache-${ccache_version}-windows-aarch64")
    else()
