...
The \myindex{g\_energy} program can also sum energy terms into one, e.g. 
...
are available using the lefthand side of \eqnref{sigmaterms}. While the average can
...
Since this can be easily done with a program such as \myindex{xmgr} this is not 
built-in in {\gromacs}.
