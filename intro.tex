...
(b) We can treat the bonds (and bond angles) as {\em \normindex{constraints}} in
...
\normindex{Force field}s provide the forces. They are not really a part of the
...
As mentioned in \secref{Compchem}, in many cases energy
