...
to the realm of \normindex{computational chemistry} and 
\normindex{molecular modelling}. 
...
\normindex{Schr\"{o}dinger equation} 
...
Macroscopic properties are always \normindex{ensemble average}s over a 
...
\item 	While molecular simulations in principle provide atomic details 
	...
	The science of \normindex{statistical mechanics} 
	...
	\normindex{stochastic dynamics}~\cite{Gunsteren90}, to {\em 
	\normindex{mesoscopic dynamics}} 
...
MD simulations solve Newton's \myindex{equations of motion} 
...
(b) We can treat the bonds (and bond angles) as {\em \myindex{constraints}} in
...
{\bf Electrons are in the ground state}    
...
(the {\em \myindex{Born-Oppenheimer}} approximation), and remain in their ground
...
\myindex{Force field}s provide the forces. They are not really a part of the
