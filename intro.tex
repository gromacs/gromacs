...
as well.  Due to the minimum-image convention, which states that only one image of each
particle in the periodic boundary conditions is considered for a pair
interaction, the cut-off range cannot exceed half the box size. That
