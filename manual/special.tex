...
one may want to apply a harmonic potential between each of the two channel and/or
bilayer centers using umbrella pulling (see section~\ref{sec:pull}) or add a
position restraint on each of the channel and/or bilayer centers in the swap
dimension (see section~\ref{subsec:positionrestraint}).
