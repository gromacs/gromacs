...
To suppress large fluctuations of each membrane/protein system along the swap direction,
a position restraint in form of a harmonic potential can be applied on each bilayer/protein
center during the simulation. This can be achieved with pull groups (see section~\ref{sec:pull}).
