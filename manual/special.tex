...
where
	...
	Calculating these forces amounts to evaluating two double sums over all scatterers, an $N^2$ problem which may sometimes (such as in refinement against difference scattering data at wide angles) be improved by using discance cutoffs ({\tt mdp} options {\tt debye-r-min} and {\tt debye-r-max}). 
