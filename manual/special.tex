...
If using the hardwall restraint, the quartic restraint potential specified using
{\tt drude-khyp} is not necessary, as the hardwall is more stable and effective at
preventing polarization catastrophe.  The quartic restraint is available in the
code for use with SCF, though in general it is discouraged in favor of the hardwall
for extended Lagrangian dynamics.
