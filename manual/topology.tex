...
\item {\tt phi} is the value of \phi_0 in equations~(\eqnref{dphi}) and~(\eqnref{dihre}) of the manual.
\item {\tt dphi} is the value of \Delta\phi in equation~(\eqnref{dihre}) of the manual.
