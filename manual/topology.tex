...
and/or add an atom type. A sample from the
{\tt gromos43a1.ff} force field is listed below.
...
{\tt pdb2gmx} automatically generates all angles. For the \gromosv{96}
force field the interaction number of all angles need to be specified.
...
its content. That content we can see in
{\tt share/top/amber99.ff/forcefield.itp} and it is
...
{\tt amber99.ff/forcefield.itp} earlier,
...
\begin{itemize}
 ...
 \item CHARMM27 all-atom force field (with CMAP) - version 2.0
