...
\item {\tt phi} is the value of \phi_0 in equations~(\ref{eqn:dphi}) and~(\ref{eqn:dihre}) of the manual.
\item {\tt dphi} is the value of \Delta\phi in equation~(\ref{eqn:dihre}) of the manual.
