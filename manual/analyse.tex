...
\caption[Options of {\tt gmx gangle}.]{Options of {\tt gmx gangle}:
% TODO Redo the figure.
A. Angle between 2 vectors.
B. Angle between a vector and the normal of a plane.
C. Angle between two planes.}
%D. Distance between the geometrical centers of 2 planes.
%E. Distances between a vector and the center of a plane.
\label{fig:sgangle}
\end{figure}
%} % Brace matches ifthenelse test for gmxlite
