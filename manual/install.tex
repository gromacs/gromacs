...
This library supports MPI-like communication between threads on a single
node. To run {\gromacs} in parallel over multiple nodes, e.g. on a cluster
or a supercomputer, you need to configure and compile {\gromacs} with an external
