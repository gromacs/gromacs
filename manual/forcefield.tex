...
\eeq
{\bfseries Cylinder} ($g=2,3,4$): The particle is kept in a cylinder of given radius
parallel to the $x$, $y$, or $z$-axis. The force from the flat-bottomed potential acts
...
\eeq
{\bfseries Layer} ($g=5,6,7$): The particle is kept in a layer defined by the
