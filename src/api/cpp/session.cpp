...
{
    // This version of the implementation does not actually use sessionImpl_
    // This line can be removed when sessionImpl_ is used and it is no longer
    // necessary to suppress compiler warnings.
    (void)sessionImpl_;
}
