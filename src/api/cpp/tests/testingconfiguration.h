...
class GmxApiTest : public gmx::test::CommandLineTestBase
{
    public:
        GmxApiTest()
        {
            ...
            mdArgs.emplace_back(fileManager_.getTemporaryFilePath(outputName + "trj"));
            mdArgs.emplace_back("-x");
            mdArgs.emplace_back(fileManager_.getTemporaryFilePath(outputName + "trjcomp"));
            mdArgs.emplace_back("-c");
            mdArgs.emplace_back(fileManager_.getTemporaryFilePath(outputName + "confout"));
            mdArgs.emplace_back("-g");
            mdArgs.emplace_back(fileManager_.getTemporaryFilePath(outputName));
            mdArgs.emplace_back("-e");
            mdArgs.emplace_back(fileManager_.getTemporaryFilePath(outputName + "ener"));
            mdArgs.emplace_back("-cpo");
            mdArgs.emplace_back(fileManager_.getTemporaryFilePath(outputName + "state"));
        }
