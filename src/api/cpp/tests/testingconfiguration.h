...
class GmxApiTest : public gmx::test::MdrunTestFixture
{
    public:
         ...
         * defined in the test. The setup also sets the variable \r tprFileName that is
         * used to run the test with.
         *
         * \param[in] steps Number of steps for test to run.
         * \returns Name of the TPR file used in the test.
         */
        std::string tprFileName(int steps)
        {
