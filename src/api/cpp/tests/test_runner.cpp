...
TEST(ApiRunner, Reinitialize)
{
...

    {
        ...
        // Launching a session should clear the stop condition, but does not in this version.
...
// This test should be enabled when we are able to reset the stop condition.
// Otherwise, session->run() does not return successful status.
