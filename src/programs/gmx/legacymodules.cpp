...
void registerLegacyModules(gmx::CommandLineModuleManager *manager)
{
    ...
    // These are commented out below, and are either missing the wrapper
    // (code directly in main()), or have some other issues to consider how to
    // best handle them.  The wrappers are being added for 4.6, so that part is
    ...
    //        "Generate index files for g_angle");
    ...
    // TODO: Also include binaries from old src/kernel/ subdirectory:
