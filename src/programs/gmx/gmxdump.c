...
static void list_tng(const char *fn, gmx_bool bXVG)
{
    tng_trajectory_t     tng;
    int                  nframe, indent = 0;
    char                 buf[256], block_name[256];
    gmx_int64_t          i, *block_ids = NULL, n_values_per_frame, n_atoms, step, ndatablocks;
    ...
    gmx_open_tng_for_reading(fn, &tng);
