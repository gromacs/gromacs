...
cl_R Slater_2S_6S(cl_R r,cl_R xi,cl_R xj)
{
  ...
  rxj = r*xj;
  if (xi == xj) {
        if (r == 0LL) {  S = (32555LL*xi)/196608LL

    ; } else {  S = (1LL/r)*((-125536739328000LL + 125536739328000LL*exp(2LL*rxi) - 230286692010375LL*rxi - 
    ...
    ; } else { S = (1LL/r)*((935550LL*exp(2LL*(rxi + rxj))*Power(Power(rxi,2LL) - Power(rxj,2LL),15LL) + 
