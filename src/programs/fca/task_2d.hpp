...
public:
    ...
    int newcol() {
        if(this->pairs) {
            fprintf(stderr,"NEWCOL   count_col %d (%d)   count_row %d \n",this->count_col,this->pair_count,this->count_row); // TODO
            if(!finished()) {
                fprintf(stderr,"pair_count %d\n", this->pair_count); // TODO
                fprintf(stderr,"count_col %d\n", this->count_col); // TODO
                fprintf(stderr,"this->pairs[this->count_col].first %d\n", this->pairs[this->count_col].first); // TODO
                ...
                fprintf(stderr,"do move (%d %d)\n",this->pairs[this->count_col].first,this->pairs[this->count_col].second); // TODO
    ...
    void push_result(double res) {
        ...
        if(this->com.getNumNodes() == 1) {
            fprintf(stderr,"push actual_row %d actual_col %d = %e\n",
                                                      this->actual_row, this->actual_col, res); // TODO
