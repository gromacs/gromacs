...
int gmx_fca(int argc, char* argv[])
{
...
#if GMX_MPI == 1
    AssertMpi(MPI_Bcast(&dim, 1, MPI_INT, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
    AssertMpi(MPI_Bcast(&nframes, 1, MPI_INT, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
#endif
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
#if GMX_MPI == 1
    AssertMpi(MPI_Bcast(&number_of_moves, 1, MPI_INT, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
    AssertMpi(MPI_Bcast(&bMinimize, 1, MPI_INT, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
#endif
    /// ---- Minimize
    if (bMinimize)
    {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
#if GMX_MPI == 1
    AssertMpi(MPI_Bcast(&bSort, 1, MPI_INT, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
    AssertMpi(MPI_Bcast(&amplitude_weight, 1, MPI_INT, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
#endif
...
#if GMX_MPI == 1
    // distribute flag
    AssertMpi(MPI_Bcast(&bWriteMI, 1, MPI_INT, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
    AssertMpi(MPI_Bcast(&log_kappa1, 1, MPI_DOUBLE, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
    AssertMpi(MPI_Bcast(&log_kappa2, 1, MPI_DOUBLE, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
    AssertMpi(MPI_Bcast(&bBasicHisto, 1, MPI_INT, FCA_MASTER_RANK, MPI_COMM_WORLD), __FILE__, __LINE__);
#endif
    // compute MI matrix
    if (bWriteMI)
    {
