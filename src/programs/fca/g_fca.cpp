...
static int gmx_fca_core(int argc, char* argv[])
{
    const char* desc[] =
    {
...
/////////////////////////////////////////////////////////////////////////////////////
/// Entry functions that manage MPI
/////////////////////////////////////////////////////////////////////////////////////

#if GMX_MPI

#if GMX_THREAD_MPI
// To create the thread MPI
int gmx_fca_thread_callback(int argc, char* argv[])
{
...
{
    // It could be that mpi is already initialized
    bool initMpiMySelf = false;
    if (gmx_mpi_initialized() == false)
    {
        // If not then do it
#if GMX_THREAD_MPI
        int    targc = 2;
        ...
        targv[1] = (char*)"1";
        char *** p = &targv;
        MPI_Init(&targc, p, gmx_fca_thread_callback);
        delete[] targv;
#else
...
// No MPI, simple call the real function directly
int gmx_fca(int argc, char* argv[])
{
    return gmx_fca_core(argc, argv);
}
