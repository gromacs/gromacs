...
#include "programs/fca/gmx_fca.h"
...
typedef gmx::test::CommandLineTestBase FcaModuleTestMpiDouble;
...
#define FcaModuleTestMpi_DEF FcaModuleTestMpiDouble
#else
//! The test group when using float
#define FcaModuleTestMpi_DEF FcaModuleTestMpi
#endif

TEST_F(FcaModuleTestMpi_DEF, ComputesFca)
{
