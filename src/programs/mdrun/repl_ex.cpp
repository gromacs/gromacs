...
static void copy_state_serial(t_state *src, const t_state *dest)
{
    GMX_RELEASE_ASSERT(dest == src, "We assume that with domain decomposition the local state pointer points to the global state");
}
