                  ...
                  gmx_walltime_accounting_t walltime_accounting)
{
...

    {
        ...
        bool awhWithEnsemble      = (ir->bDoAwh && ir->awhParams->shareBiasMultisim);
        bool checkpointIsLocal    = !useReplicaExchange && !bUsingEnsembleRestraints && !awhWithEnsemble;
        bool stopConditionIsLocal = !useReplicaExchange && !bUsingEnsembleRestraints && !awhWithEnsemble;
