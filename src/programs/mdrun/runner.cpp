...
int Mdrunner::mdrunner()
{
    ...
    /* TODO this should move to a different place after the -nsteps has been
     * removed from mdrun itself.
     */
    if (inputrec->nsteps != -1 && inputrec->init_step > inputrec->nsteps)
    {
        gmx_fatal(FARGS, gmx::formatString("Total requested number of steps %ld is "
