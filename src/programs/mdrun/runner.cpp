...
int sts_init_and_assign_threads_for_force()
{
    ...
    for (int t=0; t<nthreadsNB; t++) {
        sts->assign("nonbonded_loop", t, {{t, nthreadsNB},{t+1, nthreadsNB}});
    ...
    if (MMBarrier::getInstance("fft") == nullptr) {
             ...
             int imdport, unsigned long Flags)
{
    ...
    int nthreadsPME = sts_init_and_assign_threads_for_force();
