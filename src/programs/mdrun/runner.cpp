...
int Mdrunner::mdrunner()
{
    ...
    PmeRunMode pmeRunModeUserInput;
    ...
    bool tryUsePhysicalGpuPME   = false;                           //TODO change default behavior
    ...
    if (cr->duty & DUTY_PP)
    {
        ...
        init_forcerec(fplog, mdlog, fr, fcd,
                      ...
                      FALSE,
                      pforce);
        fr->pmeRunMode = pmeRunMode; // TODO what is the better place to store it?
