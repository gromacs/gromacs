             ...
             int imdport, unsigned long Flags)
{
    ...
    const bool bNBForceUseGPU  = (strncmp(nbpu_opt, "gpu", 3) == 0);
    const bool bPMEForceUseGPU = FALSE;
    const bool bForceUseGPU    = bNBForceUseGPU || bPMEForceUseGPU;
    const bool bNBTryUseGPU    = (strncmp(nbpu_opt, "auto", 4) == 0) || bNBForceUseGPU;
    const bool bPMETryUseGPU   = bPMEForceUseGPU;
    const bool bTryUseGPU      = bNBTryUseGPU || bPMETryUseGPU;
