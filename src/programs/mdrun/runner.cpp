...
int Mdrunner::mdrunner()
{
    ...
    /* Call the destructor of MDModules with ForceProviders before cudaDeviceReset()
     * is called in free_gpu().
     * This way, a force provider that uses the GPU can clean up properly
     * before the GPU context gets destroyed */
    mdModules = nullptr;
