...
/*! /brief Number of real MPI ranks for child mdrun call */
static int gmx_unused numRanks = 1;
...
MdrunTestFixture::callGrompp()
{
    ...
    gmx::test::ProgramCaller caller("grompp", gmx_grompp);
...
{
    gmx::test::ProgramCaller caller("mdrun", gmx_mdrun);
