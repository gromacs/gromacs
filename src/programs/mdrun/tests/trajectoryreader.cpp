...
//! Compares the box from \c reference and \c test according to the \c matchSettings and \c tolerance.
...
//! Compares the positions from \c reference and \c test according to the \c matchSettings and \c tolerance.
...
//! Compares the velocities from \c reference and \c test according to the \c matchSettings and \c tolerance.
...
//! Compares the forces from \c reference and \c test according to the \c matchSettings and \c tolerance.
