...
static std::unordered_map<std::string, FloatingPointTolerance> potentialEnergyToleranceForSystem_g =
{{
     {
         "argon12",
         relativeToleranceAsPrecisionDependentUlp(-1, 10, 1)
     },
     {
         "spc5",
         relativeToleranceAsPrecisionDependentUlp(-50, 100, 1)
     },
     {
         "glycine_vacuo",
         relativeToleranceAsPrecisionDependentUlp(300, 100, 1)
     },
     {
         "alanine_vsite_vacuo",
         relativeToleranceAsPrecisionDependentUlp(-160, 100, 1)
     },
     {
         "glycine_no_constraints_vacuo",
         relativeToleranceAsPrecisionDependentUlp(2000, 100, 1)
     }
 }};
