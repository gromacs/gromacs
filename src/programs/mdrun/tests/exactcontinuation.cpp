...
// GCC 4.6 libc++ tuple isn't good enough for ::testing::Combine used
// here, so use the one from GoogleTest
...
INSTANTIATE_TEST_CASE_P(WithVariousLeapFrogIntegrators,
                        MdrunContinuationIsExact,
                            ::testing::Combine(::testing::Values("md"),
                                                   ::testing::Values("no", "berendsen", "v-rescale"),
                                                   ::testing::Values("no", "berendsen", "parrinello-rahman")));

INSTANTIATE_TEST_CASE_P(WithVariousVelocityVerletIntegrators,
                        MdrunContinuationIsExact,
                            ::testing::Combine(::testing::Values("md-vv"), // Doesn't currently work with multiple ranks
                                                   ::testing::Values("no", "berendsen", "v-rescale"),
                                                   ::testing::Values("no", "berendsen")));
// Broken are:
// no, berendsen (slightly)
// berensen, no (bad)
// berensen, berendsen (bad)
// v-rescale, no (bad)
// v-rescale, berendsen (bad)

INSTANTIATE_TEST_CASE_P(WithVariousVelocityVerletNHIntegrators,
                        MdrunContinuationIsExact,
                            ::testing::Combine(::testing::Values("md-vv"), // Doesn't currently work with multiple ranks
                                                   ::testing::Values("nose-hoover"),
                                                   ::testing::Values("no", "MTTK")));
// Broken are:
// nose-hoover, MTTK (slightly)

INSTANTIATE_TEST_CASE_P(WithVariousStochasticIntegrators,
                        MdrunContinuationIsExact,
                            ::testing::Combine(::testing::Values("bd", "sd"),
                                                   ::testing::Values("no"),
                                                   ::testing::Values("no", "berendsen")));
