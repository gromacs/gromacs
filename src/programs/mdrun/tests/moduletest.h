 ...
 *
 * By default, the convenienced methods callGrompp() and callMdrun()
 ...
 * -maxwarn n, or -reprod), then make a CommandLine object and pass
 * that into the routines that accept such.
 *
