...
{
    runTest("spc5", "md-vv", "no", "no", relativeToleranceAsPrecisionDependentUlp(1.0, 40, 20));
}

TEST_F(RerunReproducesNormalMdrunFor, Water5_BrownianDynamics)
{
    runTest("spc5", "bd", "no", "no", relativeToleranceAsPrecisionDependentUlp(1.0, 100, 700));
}
...
{
    runTest("alanine_vsite_vacuo", "sd", "no", "no", relativeToleranceAsPrecisionDependentUlp(1.0, 140, 100));
}
