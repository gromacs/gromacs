...
RerunTestParams mdrunParams_g[] = {
    { "argon12", "md", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 1, 1), 0 },
    { "argon12", "md-vv", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 1, 1), 0 },
    { "argon12", "bd", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 1, 1), 0 },
    { "argon12", "sd", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 1, 1), 0 },
    { "spc5", "md", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 40, 30), 0 },
    { "spc5", "md-vv", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 40, 20), 0 },
    { "spc5", "bd", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 150, 700), 0 },
    { "spc5", "sd", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 30, 10), 0 },
    { "alanine_vsite_vacuo", "md", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 1100, 600), 0 },
    { "alanine_vsite_vacuo", "md-vv", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 80, 50), 0 },
    { "alanine_vsite_vacuo", "bd", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 140, 150), 0 },
    { "alanine_vsite_vacuo", "sd", potentialEnergy_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 140, 100), 0 },
};
...
//! Specify the energies compared. The nonanol_vacuo case doesn't compute any Coulomb.
...
RerunTestParams freeEnergyParams_g[] = {
    ...
    { "nonanol_vacuo", "md", freeEnergyTestEnergies_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 10, 20), 1 },
    { "nonanol_vacuo", "md-vv", freeEnergyTestEnergies_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 10, 20), 0 },
    { "nonanol_vacuo", "sd", freeEnergyTestEnergies_g, matchSettings_g, relativeToleranceAsPrecisionDependentUlp(1.0, 10, 40), 0 },
};

// TODO MSVC seems to expose an existing bug (dvdl_nonlin[efptCOUL]
// contains garbage). It has been observed to hang on an AMD OpenCL
// build on Jenkins too. See Redmine 2122 This test is disabled
// compiler until the issue is diagnosed.
INSTANTIATE_TEST_CASE_P(DISABLED_FreeEnergyMdrun, WithinTolerances, ::testing::ValuesIn(freeEnergyParams_g));
