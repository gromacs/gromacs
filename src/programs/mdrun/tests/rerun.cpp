...
RerunTestParams mdrunParams_g[] = {
    ...
    { "spc5", "bd", potentialEnergy_g, relativeToleranceAsPrecisionDependentUlp(1.0, 150, 700), 0 },
    ...
    { "alanine_vsite_vacuo", "md-vv", potentialEnergy_g, relativeToleranceAsPrecisionDependentUlp(1.0, 80, 50), 0 },
...
// TODO MSVC seems to expose an existing bug (dvdl_nonlin[efptCOUL] contains garbage)
#if defined(_MSVC)
INSTANTIATE_TEST_CASE_P(FreeEnergyMdrun, DISABLED_WithinTolerances, ::testing::ValuesIn(freeEnergyParams_g));
#else
