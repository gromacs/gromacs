 ...
 * \param[in] dd_node_order
 * \param[in] npme     The number of separate PME ranks requested
...
int mdrunner(gmx_hw_opt_t *hw_opt,
             ...
             gmx_bool bCompact, int nstglobalcomm, ivec ddxyz,
             int dd_node_order, int npme,
