...
int gmx_mdrun(int argc, char *argv[])
{
     ...
     * For the moment, a shared_ptr serves as a de facto handle object with
     * adequate access and lifetime management behavior.
     *
     ...
     * \todo Take ownership of and responsibility for log file handle (fplog).
     */
    std::shared_ptr<SimulationContext> context = gmx::createSimulationContext(cr, hw_opt, filenames, oenv, &fplog);
     ...
     */
    auto builder = gmx::MdrunnerBuilder(context);
