...
int gmx_mdrun(int argc, char *argv[])
{
    ...
    domdecOptions.numCells[XX] = gmx::roundToInt(realddxyz[XX]);
    domdecOptions.numCells[YY] = gmx::roundToInt(realddxyz[YY]);
    domdecOptions.numCells[ZZ] = gmx::roundToInt(realddxyz[ZZ]);
