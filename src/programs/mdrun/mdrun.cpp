...
int gmx_mdrun(int argc, char *argv[])
{
    ...
    // This routine will turn off bAppendFiles and bStartFromCpt if the checkpoint
    // file cannot be found, since we then assume it is the very first part of the run.
    handleRestart(cr, &bAppendFiles, NFILE, fnm, &bStartFromCpt);
