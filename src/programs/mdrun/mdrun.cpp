...
int gmx_mdrun(int argc, char *argv[])
{
    const char   *desc[] = {
        ...
        "this can not be more than half of the ranks.",
        "By default [TT]mdrun[tt] makes a guess for the number of PME",
        "ranks when the number of ranks is larger than 11 or performance wise",
...
#define NFILE asize(fnm)
    ...
    t_pargs         pa[] = {
        ...
        { "-pin",     FALSE, etENUM, {thread_aff_opt},
          "Set the affinity of each thread to a specific core" },
