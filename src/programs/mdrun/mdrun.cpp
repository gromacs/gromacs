...
int gmx_mdrun(int argc, char *argv[])
{
    const char   *desc[] = {
        ...
        "[PAR]",
        "The option [TT]-gcom[tt] can be used to constrain global",
        "intra-simulation communication to occur only every n steps.",
        "By default, it is set to the minimum value that makes sure",
        "energy calculations work. Setting [TT]-gcom[tt]",
        "can improve performance for highly parallel simulations",
        "where this global communication step becomes the bottleneck.",
        "For a global thermostat and/or barostat the temperature and/or",
        "pressure will also only be updated every [TT]-gcom[tt] steps.",
        "If needed, the value set here can be modified by mdrun.[PAR]",
