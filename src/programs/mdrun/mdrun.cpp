...
#define NFILE asize(fnm)
    ...
    // TODO: Consider whether also the file extension completion should be
    // disabled, as it will not be terribly useful to complete based on file
    // names that are not going to get used.
