...
int cmain(int argc, char *argv[])
{
    const char   *desc[] = {
        ...
        "environment variable for seting the number of OpenMP and GMX_PME_NUM_THREADS",
        "can be used to for the PME-only processes.",
        ...
        "susbstantially improve scaling to higher number of cores by relieveing",
