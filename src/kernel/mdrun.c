...
/* openmm specific information */
    ...
    "[PAR]",
    "[TT]mdrun[tt] pins threads to cores,",
    ...
    "If you don't want pinning, use [TT]-nopin[tt].",
    ...
    "pinning consecutive threads. The default value of 0 will put as few",
    "threads per physical core as possible, to optimize the performance.",
...
#define NFILE asize(fnm)
  ...
  gmx_hw_opt_t hw_opt={0,0,0,0,TRUE,0,0,NULL};
  ...
  t_pargs pa[] = {
    ...
    { "-pin",     FALSE, etBOOL, {&hw_opt.bThreadPinning},
      "Pin threads (or processes) to cores" },
    { "-pinstride", FALSE, etINT, {&hw_opt.core_pinning_stride},
      "Stride in logical cores for thread pinning, 0 means minimize the number of threads per physical core" },
