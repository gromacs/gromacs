...
int main(int argc,char *argv[])
{
  static char *desc[] = {
    ...
    "When PME is used, the PME x and y grid dimensions should be divisible",
    "by the number of nodes that take part in the PME calculation.",
    "If this is not the case, mdrun will try to enlarge the PME grid by",
    "up to 10%.[PAR]",
    ...
    "[TT]-npme[tt], this can not be more than half of the nodes.", 
