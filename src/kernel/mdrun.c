...
/* openmm specific information */
    ...
    "The option [TT]-gcom[tt] can be used to constrain global intra-simulation",
    "communication to occur only every n steps.",
    ...
    "The option [TT]-signalcom[tt] is used particularly in [TT]-multi[tt]",
    ...
    "that is being used in the simulation. For non-multi-simualations,",
...
#define NFILE asize(fnm)
  ...
  t_pargs pa[] = {
    ...
    { "-gcom",    FALSE, etINT,{&nstglobalcomm},
      "Global intra-simulation communication frequency" },
    { "-signalcom",    FALSE, etINT,{&nstsignalcomm},
  ...
  rc = mdrunner(nthreads, fplog,cr,NFILE,fnm,oenv,bVerbose,bCompact,
                nstglobalcomm,nstsignalcomm,ddxyz,dd_node_order,rdd,rconstr,
