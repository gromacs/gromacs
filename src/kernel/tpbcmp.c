...
static void cmp_inputrec(FILE *fp,t_inputrec *ir1,t_inputrec *ir2,real ftol, real abstol)
{
  ...
  cmp_int(fp,"ir->badress_chempot_dx" ,-1,ir1->badress_chempot_dx,ir2->badress_chempot_dx);
  cmp_int(fp,"ir->adress_tf_full_box" ,-1,ir1->adress_tf_full_box,ir2->adress_tf_full_box);
