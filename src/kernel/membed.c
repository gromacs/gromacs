...
int get_mol_id(int at, gmx_mtop_t  *mtop, int *type, int *block)
{
    int mol_id=0;
    int i;
    int atnr_mol;
...
int get_molblock(int mol_id,int nmblock,gmx_molblock_t *mblock)
{
    int i;
    int nmol=0;
...
int init_ins_at(t_block *ins_at,t_block *rest_at,t_state *state, pos_ins_t *pos_ins,
