                                        ...
                                        int                     *n_nonlin_vsite)
{
    ...
    for (mb = 0; mb < mtop->nmolblock; mb++)
    {
        ...
        for (a = 0; a < atoms->nr; a++)
        {
             ...
             * a mass of least 1.5 its own mass. This is not a critical
             ...
             */
            type[a].bConstr = (type[a].con_mass > 1.5*type[a].mass);
                                    ...
                                    real *sigma2_3d)
{
    ...
    /* Determine the variance for rotational velocity around the COM.
     * The effective mass for the atom rotating around the COM turns
     * out to be simply the mass of the atom itself.
     */
    sigma2_rot = kT_fac/type->mass;
