             ...
             gmx_runtime_t *runtime)
{
     ...
     * and in that case we should only do operations here that are done at
     * the end of the MD loop afer writing the checkpoint file (which is
     * nothing with leap-frog and a few things with VV).
