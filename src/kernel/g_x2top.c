...
#define NFILE asize(fnm)
  ...
  rtp_header_settings.bRemoveDih = FALSE;
  rtp_header_settings.bH14 = TRUE;
  rtp_header_settings.bAlldih = FALSE;
  rtp_header_settings.nexcl = 3;
  ...
  t_pargs pa[] = {
    ...
    { "-nexcl", FALSE, etINT,  {&rtp_header_settings.nexcl},
      "Number of exclusions" },
    { "-H14",    FALSE, etBOOL, {&rtp_header_settings.bH14}, 
      "Use 3rd neighbour interactions for hydrogen atoms" },
    { "-alldih", FALSE, etBOOL, {&rtp_header_settings.bAlldih}, 
      "Generate all proper dihedrals" },
    { "-remdih", FALSE, etBOOL, {&rtp_header_settings.bRemoveDihIfWithImproper}, 
  ...
  if (bTOP) {    
    ...
    write_top(fp,NULL,mymol.name,atoms,FALSE,bts,plist,excls,atype,
	      cgnr,rtp_header_settings.nexcl);
