...
#define NFILE asize(fnm)
  ...
  rtp_header_settings.bRemoveDihedralIfWithImproper = FALSE;
  rtp_header_settings.bGenerateHH14Interactions = TRUE;
  rtp_header_settings.bKeepAllGeneratedDihedrals = FALSE;
  rtp_header_settings.nrexcl = 3;
  ...
  t_pargs pa[] = {
    ...
    { "-nexcl", FALSE, etINT,  {&rtp_header_settings.nrexcl},
      "Number of exclusions" },
    { "-H14",    FALSE, etBOOL, {&rtp_header_settings.bGenerateHH14Interactions},
      "Use 3rd neighbour interactions for hydrogen atoms" },
    { "-alldih", FALSE, etBOOL, {&rtp_header_settings.bKeepAllGeneratedDihedrals},
      "Generate all proper dihedrals" },
    { "-remdih", FALSE, etBOOL, {&rtp_header_settings.bRemoveDihedralIfWithImproper},
