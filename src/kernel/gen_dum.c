			...
			int nrfound, int *ats, int add_shift, t_dumtop *dumtop, int ndumtop)
{
  ...
  vdist=3.0*bond_oh;
  mM=at->atom[ats[atHH]].m/3.0;
  at->atom[ats[atOH]].m+=mM*2.0;  /* add 2/3 of original H mass */
  at->atom[ats[atOH]].mB+=mM*2.0; /* add 2/3 of original H mass */
  ...
  add_dum2_param(&plist[F_DUMMY2],
		 ats[atHH],ats[atOH],add_shift+atM,1.0/3.0);
  return ndum;
}
