 ...
 */
int
_gmx_sel_yyparse(int nexp, struct gmx_ana_indexgrps_t *grps, void *scanner);
 ...
 */
static int
run_parser(int maxnr, gmx_ana_indexgrps_t *grps, yyscan_t scanner)
{
    gmx_ana_selcollection_t *sc = _gmx_sel_lexer_selcollection(scanner);
    bool bOk;
    int  nr;
                                  ...
                                  gmx_ana_indexgrps_t *grps, bool bInteractive)
{
    ...
    return run_parser(nr, grps, scanner);
}
                                ...
                                gmx_ana_indexgrps_t *grps)
{
    ...
    return run_parser(-1, grps, scanner);
}
