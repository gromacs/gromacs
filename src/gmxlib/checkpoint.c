...
static void do_cpt_real_err(XDR *xd, const char * UNUSED(desc), real *f)
{
    bool_t res = 0;
...
static int do_cpt_footer(XDR *xd, gmx_bool UNUSED(bRead), int file_version)
{
    bool_t res = 0;
    int    magic;
...
static int do_cpt_state(XDR *xd, gmx_bool UNUSED(bRead),
...
static int do_cpt_ekinstate(XDR *xd, gmx_bool UNUSED(bRead),
...
static int do_cpt_df_hist(XDR *xd, gmx_bool UNUSED(bRead), int fflags, df_history_t *dfhist, FILE *list)
{
    int  i, nlambda;
    int  ret;
