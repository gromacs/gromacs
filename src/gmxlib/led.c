 ...
 * Grunge ROck MAChoS
 */
static char *SRCID_led_c = "$Id$";

#include "led.h"
#include "delay.h"

#define LEDPORT		0xc00001e0
typedef unsigned char	byte;

static byte ledport=INIT_LED; /* copy of ledport, ledport can't be read from */

void put_port(int value)
{
  ledport=value;
  *(byte *)LEDPORT=~ledport; /* convert software state to hardware */
}
