...
/* Should the above code be deleted?*/  
/* 
 *The entries should be ordered in:
...
static void do_simtempvals(t_fileio *fio,t_simtemp *simtemp, int n_lambda, gmx_bool bRead, int file_version) 
{
  gmx_bool bDum=TRUE;
                        ...
                        int file_version, real *fudgeQQ)
{
    ...
    if((file_version > 25) || (file_version < 76))
    ...
    if(file_version >= 26 && file_version < 76) {
