                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        if(jidx<j_index_end)
        {
            ...
            /* Calculate table index by multiplying r with table scale and truncate to integer */
            rt               = _mm_mul_ps(_mm_and_ps(r13,mask),vftabscale);
            vfitab           = _mm_cvttps_epi32(rt);
            vfeps            = _mm_sub_ps(rt,_mm_cvtepi32_ps(vfitab));
            vfitab           = _mm_slli_epi32(vfitab,2);
            ...
            /* Calculate table index by multiplying r with table scale and truncate to integer */
            rt               = _mm_mul_ps(_mm_and_ps(r23,mask),vftabscale);
            vfitab           = _mm_cvttps_epi32(rt);
            vfeps            = _mm_sub_ps(rt,_mm_cvtepi32_ps(vfitab));
            vfitab           = _mm_slli_epi32(vfitab,2);
            ...
            /* Calculate table index by multiplying r with table scale and truncate to integer */
            rt               = _mm_mul_ps(_mm_and_ps(r31,mask),vftabscale);
            vfitab           = _mm_cvttps_epi32(rt);
            vfeps            = _mm_sub_ps(rt,_mm_cvtepi32_ps(vfitab));
            vfitab           = _mm_slli_epi32(vfitab,2);
            ...
            /* Calculate table index by multiplying r with table scale and truncate to integer */
            rt               = _mm_mul_ps(_mm_and_ps(r32,mask),vftabscale);
            vfitab           = _mm_cvttps_epi32(rt);
            vfeps            = _mm_sub_ps(rt,_mm_cvtepi32_ps(vfitab));
            vfitab           = _mm_slli_epi32(vfitab,2);
            ...
            /* Calculate table index by multiplying r with table scale and truncate to integer */
            rt               = _mm_mul_ps(_mm_and_ps(r33,mask),vftabscale);
            vfitab           = _mm_cvttps_epi32(rt);
            vfeps            = _mm_sub_ps(rt,_mm_cvtepi32_ps(vfitab));
            vfitab           = _mm_slli_epi32(vfitab,2);
