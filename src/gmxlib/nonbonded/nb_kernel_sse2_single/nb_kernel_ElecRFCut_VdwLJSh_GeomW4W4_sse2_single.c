                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        if(jidx<j_index_end)
        {
            if(jidx<j_index_end-2)
            {
                ...
                j_coord_offsetC  = DIM*jnrC;
                /* load j atom coordinates */
                gmx_mm_load_4rvec_3ptr_swizzle_ps(x+j_coord_offsetA,x+j_coord_offsetB,
                                                  x+j_coord_offsetC,
                                                  &jx0,&jy0,&jz0,&jx1,&jy1,&jz1,&jx2,
                                                  &jy2,&jz2,&jx3,&jy3,&jz3);
                mask             = mask3;
            ...
            else if(jidx<j_index_end-1)
            {
                ...
                j_coord_offsetB  = DIM*jnrB;
                /* load j atom coordinates */
                gmx_mm_load_4rvec_2ptr_swizzle_ps(x+j_coord_offsetA,x+j_coord_offsetB,
                                                  &jx0,&jy0,&jz0,&jx1,&jy1,&jz1,&jx2,
                                                  &jy2,&jz2,&jx3,&jy3,&jz3);
                mask             = mask2;
            }
            else
            {
                ...
                j_coord_offsetA  = DIM*jnrA;
                /* load j atom coordinates */
                gmx_mm_load_4rvec_1ptr_swizzle_ps(x+j_coord_offsetA,
                                                  &jx0,&jy0,&jz0,&jx1,&jy1,&jz1,&jx2,
                                                  &jy2,&jz2,&jx3,&jy3,&jz3);
                mask             = mask1;
            }
            ...
            if(jidx<j_index_end-2)
            {
                gmx_mm_decrement_4rvec_3ptr_swizzle_ps(f+j_coord_offsetA,f+j_coord_offsetB,
                                                       f+j_coord_offsetC,
                                                       fjx0,fjy0,fjz0,fjx1,fjy1,fjz1,
                                                       fjx2,fjy2,fjz2,fjx3,fjy3,fjz3);
            }
            ...
            {
                gmx_mm_decrement_4rvec_2ptr_swizzle_ps(f+j_coord_offsetA,f+j_coord_offsetB,
                                                       fjx0,fjy0,fjz0,fjx1,fjy1,fjz1,
                                                       fjx2,fjy2,fjz2,fjx3,fjy3,fjz3);
            }
            else
            {
                gmx_mm_decrement_4rvec_1ptr_swizzle_ps(f+j_coord_offsetA,
                                                       fjx0,fjy0,fjz0,fjx1,fjy1,fjz1,
                                                       fjx2,fjy2,fjz2,fjx3,fjy3,fjz3);
            }
        }
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W4W4_VF,outeriter*38 + inneriter*316);
}
/*
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W4W4_F,outeriter*36 + inneriter*261);
}
