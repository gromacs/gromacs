                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
        ...
        if(jidx<j_index_end)
        {
            if(jidx<j_index_end-2)
            {
                ...
                jq0              = gmx_mm_load_3real_swizzle_ps(charge+jnrA+0,charge+jnrB+0,
                                                                  charge+jnrC+0);
                isaj0            = gmx_mm_load_3real_swizzle_ps(invsqrta+jnrA+0,invsqrta+jnrB+0,
                                                                  invsqrta+jnrC+0);
                mask             = mask3;
            }
            else if(jidx<j_index_end-1)
            {
                ...
                isaj0            = gmx_mm_load_2real_swizzle_ps(invsqrta+jnrA+0,invsqrta+jnrB+0);
                mask             = mask2;
            }
            else
            {
                ...
                isaj0            = gmx_mm_load_1real_ps(invsqrta+jnrA+0);
                mask             = mask1;
            }
            ...
            vgbsum           = _mm_add_ps(vgbsum,_mm_and_ps(vgb,mask));
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VF,outeriter*12 + inneriter*58);
}
/*
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_F,outeriter*10 + inneriter*56);
}
