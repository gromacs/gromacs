 ...
 */
#ifndef _NB_KERNEL430_SSE_SINGLE_H_
#define _NB_KERNEL430_SSE_SINGLE_H_

/*! \file  nb_kernel430_sse_single.h
 ...
 */
void
nb_kernel430_sse_single  (int *   nri,        int     iinr[],   int     jindex[],
 ...
 */
void
nb_kernel430nf_sse_single(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL430_SSE_SINGLE_H_ */
