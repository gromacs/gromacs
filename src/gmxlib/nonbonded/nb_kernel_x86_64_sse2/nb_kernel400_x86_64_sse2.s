...
.nb400_outer:
	...
	xorpd xmm4, xmm4
	movapd [rsp + nb400_vctot], xmm4
	movapd [rsp + nb400_dvdasum], xmm4
	movapd [rsp + nb400_fix], xmm4
	movapd [rsp + nb400_fiy], xmm4
	movapd [rsp + nb400_fiz], xmm4
...
.nb400_unroll_loop:
	...
	mulpd  xmm2, [rsp + nb400_isai]
	movapd [rsp + nb400_isaprod], xmm2	
	movapd xmm1, xmm2
	mulpd xmm1, [rsp + nb400_gbtsc]
	...
	movapd xmm4, [rsp + nb400_ix]
	movapd xmm5, [rsp + nb400_iy]
	movapd xmm6, [rsp + nb400_iz]
	...
	;# store dr 
	movapd [rsp + nb400_dx], xmm4
	movapd [rsp + nb400_dy], xmm5
	movapd [rsp + nb400_dz], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	mulpd  xmm7, [rsp + nb400_two]	;# two*Heps2 
	...
	addpd  xmm6, xmm5
	addpd  xmm5, [rsp + nb400_vctot]
	movapd [rsp + nb400_vctot], xmm5 
	...
	;# update dvdasum
	addpd  xmm7, [rsp + nb400_dvdasum]
	movapd [rsp + nb400_dvdasum], xmm7 
	...
	movapd xmm0, [rsp + nb400_dx]
	movapd xmm1, [rsp + nb400_dy]
	movapd xmm2, [rsp + nb400_dz]
	...
	;# now update f_i 
	movapd xmm3, [rsp + nb400_fix]
	movapd xmm4, [rsp + nb400_fiy]
	movapd xmm5, [rsp + nb400_fiz]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm5, xmm2
	movapd [rsp + nb400_fix], xmm3
	movapd [rsp + nb400_fiy], xmm4
	movapd [rsp + nb400_fiz], xmm5
...
.nb400_dosingle:
	...
	mulsd  xmm7, [rsp + nb400_isai]
	movapd [rsp + nb400_isaprod], xmm7
	movapd xmm1, xmm7
	mulpd xmm1, [rsp + nb400_gbtsc]
	movapd [rsp + nb400_gbscale], xmm1
	
	mulsd  xmm7, [rsp + nb400_iq]
	mulsd  xmm6, xmm7
	movapd [rsp + nb400_qq], xmm6
	...
	mulsd  xmm7, [rsp + nb400_two]	;# two*Heps2 
	movapd xmm3, [rsp + nb400_qq]
	addsd  xmm7, xmm6
	...
	addsd  xmm6, xmm5
	addsd  xmm5, [rsp + nb400_vctot]
	movsd [rsp + nb400_vctot], xmm5 
	...
	;# update dvdasum
	addsd  xmm7, [rsp + nb400_dvdasum]
	movsd [rsp + nb400_dvdasum], xmm7 
	...
	movsd xmm0, [rsp + nb400_dx]
	movsd xmm1, [rsp + nb400_dy]
	movsd xmm2, [rsp + nb400_dz]
	...
	;# xmm0-xmm2 contains tx-tz (partial force) 
	;# now update f_i 
	movsd xmm3, [rsp + nb400_fix]
	movsd xmm4, [rsp + nb400_fiy]
	movsd xmm5, [rsp + nb400_fiz]
	addsd  xmm3, xmm0
	addsd  xmm4, xmm1
	addsd  xmm5, xmm2
	movlpd [rsp + nb400_fix], xmm3
	movlpd [rsp + nb400_fiy], xmm4
	movlpd [rsp + nb400_fiz], xmm5
	;# update fj 
	movlpd xmm3, [rdi + rax*8]
	movlpd xmm4, [rdi + rax*8 + 8]
	movlpd xmm5, [rdi + rax*8 + 16]
...
.nb400_updateouterdata:
	...
	movapd xmm0, [rsp + nb400_fix]
	movapd xmm1, [rsp + nb400_fiy]
	movapd xmm2, [rsp + nb400_fiz]
