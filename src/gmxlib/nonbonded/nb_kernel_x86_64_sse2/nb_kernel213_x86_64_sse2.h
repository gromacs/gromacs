 ...
 */
#ifndef _NB_KERNEL213_X86_64_SSE2_H_
#define _NB_KERNEL213_X86_64_SSE2_H_

/*! \file  nb_kernel213_x86_64_sse2.h
 *  \brief x86-64 SSE2-optimized versions of nonbonded kernel 213
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 213 with forces, optimized for x86-64 sse2.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel213_x86_64_sse2(int *    nri,        int      iinr[],    int      jindex[],
...
/*! \brief Nonbonded kernel 213 without forces, optimized for x86-64 sse2.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Reaction-field <br>
 ...
 */
void
nb_kernel213nf_x86_64_sse2(int *    nri,        int      iinr[],    int      jindex[],
                           int      jjnr[],     int      shift[],   double   shiftvec[],
                           double   fshift[],   int      gid[],     double   pos[],
                           double   faction[],  double   charge[],  double * facel,
                           double * krf,        double * crf,       double   Vc[],
...
#endif /* _NB_KERNEL213_X86_64_SSE2_H_ */
