...
.nb211_unroll_loop:
	...
	movapd xmm4, [rsp + nb211_ixO]
	movapd xmm5, [rsp + nb211_iyO]
	movapd xmm6, [rsp + nb211_izO]
	...
	movapd xmm4, [rsp + nb211_ixH1]
	movapd xmm5, [rsp + nb211_iyH1]
	movapd xmm6, [rsp + nb211_izH1]
	...
	movapd xmm3, [rsp + nb211_ixH2]
	movapd xmm4, [rsp + nb211_iyH2]
	movapd xmm5, [rsp + nb211_izH2]
	...
	mulpd  xmm0, [rsp + nb211_krf]	
	mulpd  xmm1, [rsp + nb211_krf]	
	mulpd  xmm2, [rsp + nb211_krf]	
	...
	mulpd   xmm4, [rsp + nb211_half] ;# iter1 ( new lu) 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [rsp + nb211_half] ;# rinv 
	...
	mulpd  xmm1, [rsp + nb211_c6]
	mulpd  xmm2, [rsp + nb211_c12]
	movapd xmm3, xmm2
	subpd  xmm3, xmm1	;# Vvdw=Vvdw12-Vvdw6 		
	addpd  xmm3, [rsp + nb211_Vvdwtot]
	mulpd  xmm1, [rsp + nb211_six]
	mulpd  xmm2, [rsp + nb211_twelve]
	subpd  xmm2, xmm1	;# nb part of fs  

	movapd xmm0, xmm7
	movapd xmm1, [rsp + nb211_krsqO]
	addpd  xmm0, xmm1
	mulpd  xmm1, [rsp + nb211_two]
	subpd  xmm0, [rsp + nb211_crf] ;# xmm0=rinv+ krsq-crf 
	subpd  xmm7, xmm1
	mulpd  xmm0, [rsp + nb211_qqO]
	mulpd  xmm7, [rsp + nb211_qqO]
	addpd  xmm2, xmm7

	mulpd  xmm4, xmm2	;# total fsO in xmm4 

	addpd  xmm0, [rsp + nb211_vctot]
	movapd [rsp + nb211_Vvdwtot], xmm3
	movapd [rsp + nb211_vctot], xmm0
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb211_fixO], xmm3
	movapd [rsp + nb211_fiyO], xmm4
	movapd [rsp + nb211_fizO], xmm7
	;# update j forces with water O 
	movapd [rsp + nb211_fjx], xmm0
	movapd [rsp + nb211_fjy], xmm1
	movapd [rsp + nb211_fjz], xmm2
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb211_fixH1], xmm3
	movapd [rsp + nb211_fiyH1], xmm4
	movapd [rsp + nb211_fizH1], xmm7
	;# update j forces with water H1 
	addpd  xmm0, [rsp + nb211_fjx]
	addpd  xmm1, [rsp + nb211_fjy]
	addpd  xmm2, [rsp + nb211_fjz]
	movapd [rsp + nb211_fjx], xmm0
	movapd [rsp + nb211_fjy], xmm1
	movapd [rsp + nb211_fjz], xmm2
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb211_fixH2], xmm3
	movapd [rsp + nb211_fiyH2], xmm4
	movapd [rsp + nb211_fizH2], xmm7
