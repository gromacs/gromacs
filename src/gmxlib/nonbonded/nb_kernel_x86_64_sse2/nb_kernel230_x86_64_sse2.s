...
.nb230_unroll_loop:	
	...
	movapd xmm4, [rsp + nb230_ix]
	movapd xmm5, [rsp + nb230_iy]
	movapd xmm6, [rsp + nb230_iz]
	...
	movapd xmm0, [rsp + nb230_dx]
	movapd xmm1, [rsp + nb230_dy]
	movapd xmm2, [rsp + nb230_dz]
	...
	;# now update f_i 
	movapd xmm3, [rsp + nb230_fix]
	movapd xmm4, [rsp + nb230_fiy]
	movapd xmm5, [rsp + nb230_fiz]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm5, xmm2
	movapd [rsp + nb230_fix], xmm3
	movapd [rsp + nb230_fiy], xmm4
	movapd [rsp + nb230_fiz], xmm5
...
.nb230_dosingle:			
	...
	movsd xmm0, [rsp + nb230_dx]
	movsd xmm1, [rsp + nb230_dy]
	movsd xmm2, [rsp + nb230_dz]
	...
	;# xmm0-xmm2 contains tx-tz (partial force) 
	;# now update f_i 
	movlpd xmm3, [rsp + nb230_fix]
	movlpd xmm4, [rsp + nb230_fiy]
	movlpd xmm5, [rsp + nb230_fiz]
	addsd  xmm3, xmm0
	addsd  xmm4, xmm1
	addsd  xmm5, xmm2
	movlpd [rsp + nb230_fix], xmm3
	movlpd [rsp + nb230_fiy], xmm4
	movlpd [rsp + nb230_fiz], xmm5
	;# the fj's - start by accumulating forces from memory 
	movlpd xmm3, [rdi + rax*8]
	movlpd xmm4, [rdi + rax*8 + 8]
	movlpd xmm5, [rdi + rax*8 + 16]
