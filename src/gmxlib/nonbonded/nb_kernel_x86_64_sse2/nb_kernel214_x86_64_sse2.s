...
.nb214_unroll_loop:
	...
	movapd 	[rsp + nb214_jxO], xmm0
	movapd 	[rsp + nb214_jyO], xmm1
	movapd 	[rsp + nb214_jzO], xmm3
	movapd 	[rsp + nb214_jxH1], xmm4
	...
	movapd 	[rsp + nb214_jyH1], xmm0
	movapd 	[rsp + nb214_jzH1], xmm1
	movapd 	[rsp + nb214_jxH2], xmm3
	movapd 	[rsp + nb214_jyH2], xmm4
	...
	movapd 	[rsp + nb214_jzH2], xmm0
	movapd 	[rsp + nb214_jxM], xmm1
	movapd 	[rsp + nb214_jyM], xmm3
	movapd 	[rsp + nb214_jzM], xmm4
	
	;# start calculating pairwise distances
	movapd xmm0, [rsp + nb214_ixO]
	movapd xmm1, [rsp + nb214_iyO]
	movapd xmm2, [rsp + nb214_izO]
	movapd xmm3, [rsp + nb214_ixH1]
	movapd xmm4, [rsp + nb214_iyH1]
	movapd xmm5, [rsp + nb214_izH1]
	subpd  xmm0, [rsp + nb214_jxO]
	subpd  xmm1, [rsp + nb214_jyO]
	subpd  xmm2, [rsp + nb214_jzO]
	subpd  xmm3, [rsp + nb214_jxH1]
	subpd  xmm4, [rsp + nb214_jyH1]
	subpd  xmm5, [rsp + nb214_jzH1]
	movapd [rsp + nb214_dxOO], xmm0
	movapd [rsp + nb214_dyOO], xmm1
	movapd [rsp + nb214_dzOO], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb214_dxH1H1], xmm3
	movapd [rsp + nb214_dyH1H1], xmm4
	movapd [rsp + nb214_dzH1H1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb214_rsqOO], xmm0
	movapd [rsp + nb214_rsqH1H1], xmm3

	movapd xmm0, [rsp + nb214_ixH1]
	movapd xmm1, [rsp + nb214_iyH1]
	movapd xmm2, [rsp + nb214_izH1]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb214_jxH2]
	subpd  xmm1, [rsp + nb214_jyH2]
	subpd  xmm2, [rsp + nb214_jzH2]
	subpd  xmm3, [rsp + nb214_jxM]
	subpd  xmm4, [rsp + nb214_jyM]
	subpd  xmm5, [rsp + nb214_jzM]
	...
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb214_dxH1M], xmm3
	movapd [rsp + nb214_dyH1M], xmm4
	movapd [rsp + nb214_dzH1M], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb214_rsqH1H2], xmm0
	movapd [rsp + nb214_rsqH1M], xmm3

	movapd xmm0, [rsp + nb214_ixH2]
	movapd xmm1, [rsp + nb214_iyH2]
	movapd xmm2, [rsp + nb214_izH2]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb214_jxH1]
	subpd  xmm1, [rsp + nb214_jyH1]
	subpd  xmm2, [rsp + nb214_jzH1]
	subpd  xmm3, [rsp + nb214_jxH2]
	subpd  xmm4, [rsp + nb214_jyH2]
	subpd  xmm5, [rsp + nb214_jzH2]
	movapd [rsp + nb214_dxH2H1], xmm0
	movapd [rsp + nb214_dyH2H1], xmm1
	movapd [rsp + nb214_dzH2H1], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb214_rsqH2H1], xmm0
	movapd [rsp + nb214_rsqH2H2], xmm3

	movapd xmm0, [rsp + nb214_ixH2]
	movapd xmm1, [rsp + nb214_iyH2]
	movapd xmm2, [rsp + nb214_izH2]
	movapd xmm3, [rsp + nb214_ixM]
	movapd xmm4, [rsp + nb214_iyM]
	movapd xmm5, [rsp + nb214_izM]
	subpd  xmm0, [rsp + nb214_jxM]
	subpd  xmm1, [rsp + nb214_jyM]
	subpd  xmm2, [rsp + nb214_jzM]
	subpd  xmm3, [rsp + nb214_jxH1]
	subpd  xmm4, [rsp + nb214_jyH1]
	subpd  xmm5, [rsp + nb214_jzH1]
	movapd [rsp + nb214_dxH2M], xmm0
	movapd [rsp + nb214_dyH2M], xmm1
	movapd [rsp + nb214_dzH2M], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb214_dxMH1], xmm3
	movapd [rsp + nb214_dyMH1], xmm4
	movapd [rsp + nb214_dzMH1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb214_rsqH2M], xmm0
	movapd [rsp + nb214_rsqMH1], xmm4

	movapd xmm0, [rsp + nb214_ixM]
	movapd xmm1, [rsp + nb214_iyM]
	movapd xmm2, [rsp + nb214_izM]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb214_jxH2]
	...
	subpd  xmm4, [rsp + nb214_jyM]
	subpd  xmm5, [rsp + nb214_jzM]
	movapd [rsp + nb214_dxMH2], xmm0
	movapd [rsp + nb214_dyMH2], xmm1
	movapd [rsp + nb214_dzMH2], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb214_dxMM], xmm3
	movapd [rsp + nb214_dyMM], xmm4
	movapd [rsp + nb214_dzMM], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb214_rsqMH2], xmm0
	movapd [rsp + nb214_rsqMM], xmm4
	...
	mulpd   xmm3, [rsp + nb214_half] ;# iter1 
	mulpd   xmm7, [rsp + nb214_half] ;# iter1 
	...
	mulpd   xmm1, [rsp + nb214_half] ;# rinv 
	mulpd   xmm5, [rsp + nb214_half] ;# rinv 
	movapd [rsp + nb214_rinvMH2], xmm1
	movapd [rsp + nb214_rinvMM], xmm5

	movapd xmm0, [rsp + nb214_rsqOO]
	movapd xmm4, [rsp + nb214_rsqH1H1]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb214_half] ;# iter1 of  
	mulpd   xmm7, [rsp + nb214_half] ;# iter1 of  
	...
	mulpd   xmm5, [rsp + nb214_half] ;# rinv
	mulpd   xmm1, xmm1
	movapd [rsp + nb214_rinvsqOO], xmm1
	movapd [rsp + nb214_rinvH1H1], xmm5

	movapd xmm0, [rsp + nb214_rsqH1H2]
	movapd xmm4, [rsp + nb214_rsqH1M]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb214_half] ;# rinv 
	mulpd   xmm5, [rsp + nb214_half] ;# rinv 
	movapd [rsp + nb214_rinvH1H2], xmm1
	movapd [rsp + nb214_rinvH1M], xmm5

	movapd xmm0, [rsp + nb214_rsqH2H1]
	movapd xmm4, [rsp + nb214_rsqH2H2]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb214_half] ;# iter1a 
	mulpd   xmm7, [rsp + nb214_half] ;# iter1b 
	...
	mulpd   xmm1, [rsp + nb214_half] ;# rinv 
	mulpd   xmm5, [rsp + nb214_half] ;# rinv 
	movapd [rsp + nb214_rinvH2H1], xmm1
	movapd [rsp + nb214_rinvH2H2], xmm5

	movapd xmm0, [rsp + nb214_rsqMH1]
	movapd xmm4, [rsp + nb214_rsqH2M]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb214_half] ;# rinv 
	mulpd   xmm5, [rsp + nb214_half] ;# rinv 
	movapd [rsp + nb214_rinvMH1], xmm1
	movapd [rsp + nb214_rinvH2M], xmm5

	;# start with OO interaction 
	movapd xmm0, [rsp + nb214_rinvsqOO] ;# xmm0=rinvsq
	movapd  xmm1, xmm0	
	mulpd   xmm1, xmm1 ;# rinv4
	mulpd   xmm1, xmm0 ;#rinvsix
	movapd  xmm2, xmm1
	mulpd	xmm2, xmm2 ;# rinvtwelve
	mulpd  xmm1, [rsp + nb214_c6]
	mulpd  xmm2, [rsp + nb214_c12]
	movapd xmm3, xmm2
	subpd  xmm3, xmm1	;# Vvdw=Vvdw12-Vvdw6 		
	addpd  xmm3, [rsp + nb214_Vvdwtot]
	mulpd  xmm1, [rsp + nb214_six]
	mulpd  xmm2, [rsp + nb214_twelve]
	subpd  xmm2, xmm1
	mulpd  xmm2, xmm0
	movapd [rsp + nb214_Vvdwtot], xmm3
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb214_dxOO]
	mulpd xmm1, [rsp + nb214_dyOO]
	mulpd xmm2, [rsp + nb214_dzOO]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixO]
	addpd xmm1, [rsp + nb214_fiyO]
	addpd xmm2, [rsp + nb214_fizO]
	movapd [rsp + nb214_fjxO], xmm3
	movapd [rsp + nb214_fjyO], xmm4
	movapd [rsp + nb214_fjzO], xmm5
	movapd [rsp + nb214_fixO], xmm0
	movapd [rsp + nb214_fiyO], xmm1
	movapd [rsp + nb214_fizO], xmm2

	;# H1-H1 interaction 
	movapd xmm0, [rsp + nb214_rinvH1H1]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqH1H1] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulpd  xmm5, [rsp + nb214_two]
	subpd  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulpd  xmm7, [rsp + nb214_qqHH] ;# xmm7 = coul part of fscal 
	
	addpd  xmm6, [rsp + nb214_vctot] ;# local vctot summation variable 
	mulpd  xmm0, xmm7
	movapd [rsp + nb214_vctot], xmm6
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb214_dxH1H1]
	mulpd xmm1, [rsp + nb214_dyH1H1]
	mulpd xmm2, [rsp + nb214_dzH1H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixH1]
	addpd xmm1, [rsp + nb214_fiyH1]
	addpd xmm2, [rsp + nb214_fizH1]
	movapd [rsp + nb214_fjxH1], xmm3
	movapd [rsp + nb214_fjyH1], xmm4
	movapd [rsp + nb214_fjzH1], xmm5
	movapd [rsp + nb214_fixH1], xmm0
	movapd [rsp + nb214_fiyH1], xmm1
	movapd [rsp + nb214_fizH1], xmm2

	;# H1-H2 interaction  
	movapd xmm0, [rsp + nb214_rinvH1H2]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqH1H2] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb214_dxH1H2]
	mulpd xmm1, [rsp + nb214_dyH1H2]
	mulpd xmm2, [rsp + nb214_dzH1H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixH1]
	addpd xmm1, [rsp + nb214_fiyH1]
	addpd xmm2, [rsp + nb214_fizH1]
	movapd [rsp + nb214_fjxH2], xmm3
	movapd [rsp + nb214_fjyH2], xmm4
	movapd [rsp + nb214_fjzH2], xmm5
	movapd [rsp + nb214_fixH1], xmm0
	movapd [rsp + nb214_fiyH1], xmm1
	movapd [rsp + nb214_fizH1], xmm2

	;# H1-M interaction 
	movapd xmm0, [rsp + nb214_rinvH1M]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqH1M] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqMH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulpd  xmm5, [rsp + nb214_two]
	subpd  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulpd  xmm7, [rsp + nb214_qqMH] ;# xmm7 = coul part of fscal 
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb214_dxH1M]
	mulpd xmm1, [rsp + nb214_dyH1M]
	mulpd xmm2, [rsp + nb214_dzH1M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixH1]
	addpd xmm1, [rsp + nb214_fiyH1]
	addpd xmm2, [rsp + nb214_fizH1]
	movapd [rsp + nb214_fjxM], xmm3
	movapd [rsp + nb214_fjyM], xmm4
	movapd [rsp + nb214_fjzM], xmm5
	movapd [rsp + nb214_fixH1], xmm0
	movapd [rsp + nb214_fiyH1], xmm1
	movapd [rsp + nb214_fizH1], xmm2

	;# H2-H1 interaction 
	movapd xmm0, [rsp + nb214_rinvH2H1]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqH2H1] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm3, [rsp + nb214_fjxH1]
	movapd xmm4, [rsp + nb214_fjyH1]
	movapd xmm5, [rsp + nb214_fjzH1]
	mulpd xmm0, [rsp + nb214_dxH2H1]
	mulpd xmm1, [rsp + nb214_dyH2H1]
	mulpd xmm2, [rsp + nb214_dzH2H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixH2]
	addpd xmm1, [rsp + nb214_fiyH2]
	addpd xmm2, [rsp + nb214_fizH2]
	movapd [rsp + nb214_fjxH1], xmm3
	movapd [rsp + nb214_fjyH1], xmm4
	movapd [rsp + nb214_fjzH1], xmm5
	movapd [rsp + nb214_fixH2], xmm0
	movapd [rsp + nb214_fiyH2], xmm1
	movapd [rsp + nb214_fizH2], xmm2

	;# H2-H2 interaction 
	movapd xmm0, [rsp + nb214_rinvH2H2]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqH2H2] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm3, [rsp + nb214_fjxH2]
	movapd xmm4, [rsp + nb214_fjyH2]
	movapd xmm5, [rsp + nb214_fjzH2]
	mulpd xmm0, [rsp + nb214_dxH2H2]
	mulpd xmm1, [rsp + nb214_dyH2H2]
	mulpd xmm2, [rsp + nb214_dzH2H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixH2]
	...
	;# H2-M interaction 
	movapd xmm0, [rsp + nb214_rinvH2M]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqH2M] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqMH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm3, [rsp + nb214_fjxM]
	movapd xmm4, [rsp + nb214_fjyM]
	movapd xmm5, [rsp + nb214_fjzM]
	mulpd xmm0, [rsp + nb214_dxH2M]
	mulpd xmm1, [rsp + nb214_dyH2M]
	mulpd xmm2, [rsp + nb214_dzH2M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixH2]
	...
	;# M-H1 interaction 
	movapd xmm0, [rsp + nb214_rinvMH1]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqMH1] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqMH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm4, [rsp + nb214_fjyH1]
	movapd xmm5, [rsp + nb214_fjzH1]
	mulpd xmm0, [rsp + nb214_dxMH1]
	mulpd xmm1, [rsp + nb214_dyMH1]
	mulpd xmm2, [rsp + nb214_dzMH1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixM]
	addpd xmm1, [rsp + nb214_fiyM]
	addpd xmm2, [rsp + nb214_fizM]
	movapd [rsp + nb214_fjxH1], xmm3
	movapd [rsp + nb214_fjyH1], xmm4
	movapd [rsp + nb214_fjzH1], xmm5
	movapd [rsp + nb214_fixM], xmm0
	movapd [rsp + nb214_fiyM], xmm1
	movapd [rsp + nb214_fizM], xmm2

	;# M-H2 interaction 
	movapd xmm0, [rsp + nb214_rinvMH2]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqMH2] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqMH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm4, [rsp + nb214_fjyH2]
	movapd xmm5, [rsp + nb214_fjzH2]
	mulpd xmm0, [rsp + nb214_dxMH2]
	mulpd xmm1, [rsp + nb214_dyMH2]
	mulpd xmm2, [rsp + nb214_dzMH2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixM]
	...
	;# M-M interaction 
	movapd xmm0, [rsp + nb214_rinvMM]
	movapd xmm7, xmm0	;# xmm7=rinv 
	movapd xmm5, [rsp + nb214_krf]
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 

	mulpd  xmm5, [rsp + nb214_rsqMM] ;# xmm5=krsq 
	movapd xmm6, xmm5
	addpd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subpd  xmm6, [rsp + nb214_crf]
	mulpd  xmm6, [rsp + nb214_qqMM] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulpd  xmm5, [rsp + nb214_two]
	subpd  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulpd  xmm7, [rsp + nb214_qqMM] ;# xmm7 = coul part of fscal 
	...
	movapd xmm4, [rsp + nb214_fjyM] 
	movapd xmm5, [rsp + nb214_fjzM]
	mulpd xmm0, [rsp + nb214_dxMM]
	mulpd xmm1, [rsp + nb214_dyMM]
	mulpd xmm2, [rsp + nb214_dzMM]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb214_fixM]
	...
	movapd xmm0, [rsp + nb214_fjxO]
	movapd xmm1, [rsp + nb214_fjyO]
	movapd xmm2, [rsp + nb214_fjzO]
	movapd xmm3, [rsp + nb214_fjxH1]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	...
	movapd xmm0, [rsp + nb214_fjyH1]
	movapd xmm1, [rsp + nb214_fjzH1]
	movapd xmm2, [rsp + nb214_fjxH2]
	movapd xmm3, [rsp + nb214_fjyH2]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	unpcklpd xmm0, xmm1   ;# fjOxA fjOyA
	unpckhpd xmm4, xmm1   ;# fjOxB fjOyB
	...
	movapd xmm0, [rsp + nb214_fjzH2]
	movapd xmm1, [rsp + nb214_fjxM]
	movapd xmm2, [rsp + nb214_fjyM]
	movapd xmm3, [rsp + nb214_fjzM]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	unpcklpd xmm0, xmm1   ;# fjOxA fjOyA
	unpckhpd xmm4, xmm1   ;# fjOxB fjOyB
...
.nb214_dosingle:
	...
	movsd  [rsp + nb214_jxO], xmm0
	movsd  [rsp + nb214_jzO], xmm1
	movsd  [rsp + nb214_jyH1], xmm2
	movsd  [rsp + nb214_jxH2], xmm3
	movsd  [rsp + nb214_jzH2], xmm4
	movsd  [rsp + nb214_jyM], xmm5
	unpckhpd xmm0, xmm0
	unpckhpd xmm1, xmm1
	unpckhpd xmm2, xmm2
	unpckhpd xmm3, xmm3
	unpckhpd xmm4, xmm4
	unpckhpd xmm5, xmm5
	movsd  [rsp + nb214_jyO], xmm0
	movsd  [rsp + nb214_jxH1], xmm1
	movsd  [rsp + nb214_jzH1], xmm2
	movsd  [rsp + nb214_jyH2], xmm3
	movsd  [rsp + nb214_jxM], xmm4
	movsd  [rsp + nb214_jzM], xmm5
	...
	movapd xmm4, [rsp + nb214_iyH1]
	movapd xmm5, [rsp + nb214_izH1]
	subsd  xmm0, [rsp + nb214_jxO]
	subsd  xmm1, [rsp + nb214_jyO]
	subsd  xmm2, [rsp + nb214_jzO]
	subsd  xmm3, [rsp + nb214_jxH1]
	subsd  xmm4, [rsp + nb214_jyH1]
	subsd  xmm5, [rsp + nb214_jzH1]
	movapd [rsp + nb214_dxOO], xmm0
	movapd [rsp + nb214_dyOO], xmm1
	movapd [rsp + nb214_dzOO], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subsd  xmm0, [rsp + nb214_jxH2]
	subsd  xmm1, [rsp + nb214_jyH2]
	subsd  xmm2, [rsp + nb214_jzH2]
	subsd  xmm3, [rsp + nb214_jxM]
	subsd  xmm4, [rsp + nb214_jyM]
	subsd  xmm5, [rsp + nb214_jzM]
	movapd [rsp + nb214_dxH1H2], xmm0
	movapd [rsp + nb214_dyH1H2], xmm1
	movapd [rsp + nb214_dzH1H2], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subsd  xmm0, [rsp + nb214_jxH1]
	subsd  xmm1, [rsp + nb214_jyH1]
	subsd  xmm2, [rsp + nb214_jzH1]
	subsd  xmm3, [rsp + nb214_jxH2]
	subsd  xmm4, [rsp + nb214_jyH2]
	subsd  xmm5, [rsp + nb214_jzH2]
	movapd [rsp + nb214_dxH2H1], xmm0
	movapd [rsp + nb214_dyH2H1], xmm1
	movapd [rsp + nb214_dzH2H1], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb214_iyM]
	movapd xmm5, [rsp + nb214_izM]
	subsd  xmm0, [rsp + nb214_jxM]
	subsd  xmm1, [rsp + nb214_jyM]
	subsd  xmm2, [rsp + nb214_jzM]
	subsd  xmm3, [rsp + nb214_jxH1]
	subsd  xmm4, [rsp + nb214_jyH1]
	subsd  xmm5, [rsp + nb214_jzH1]
	movapd [rsp + nb214_dxH2M], xmm0
	...
	mulsd   xmm3, [rsp + nb214_half] ;# iter1 
	mulsd   xmm7, [rsp + nb214_half] ;# iter1 
	...
	mulsd   xmm1, [rsp + nb214_half] ;# rinv 
	mulsd   xmm5, [rsp + nb214_half] ;# rinv 
	movapd [rsp + nb214_rinvMH2], xmm1
	movapd [rsp + nb214_rinvMM], xmm5
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb214_half] ;# iter1 of  
	mulsd   xmm7, [rsp + nb214_half] ;# iter1 of  
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb214_half] ;# iter1a 
	mulsd   xmm7, [rsp + nb214_half] ;# iter1b 
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb214_dxOO]
	mulsd xmm1, [rsp + nb214_dyOO]
	mulsd xmm2, [rsp + nb214_dzOO]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixO]
	addsd xmm1, [rsp + nb214_fiyO]
	addsd xmm2, [rsp + nb214_fizO]
	movsd [rsp + nb214_fjxO], xmm3
	movsd [rsp + nb214_fjyO], xmm4
	movsd [rsp + nb214_fjzO], xmm5
	movsd [rsp + nb214_fixO], xmm0
	movsd [rsp + nb214_fiyO], xmm1
	movsd [rsp + nb214_fizO], xmm2

	;# H1-H1 interaction 
	movsd xmm0, [rsp + nb214_rinvH1H1]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqH1H1] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulsd  xmm5, [rsp + nb214_two]
	subsd  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulsd  xmm7, [rsp + nb214_qqHH] ;# xmm7 = coul part of fscal 
	
	addsd  xmm6, [rsp + nb214_vctot] ;# local vctot summation variable 
	mulsd  xmm0, xmm7
	movsd [rsp + nb214_vctot], xmm6
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb214_dxH1H1]
	mulsd xmm1, [rsp + nb214_dyH1H1]
	mulsd xmm2, [rsp + nb214_dzH1H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixH1]
	addsd xmm1, [rsp + nb214_fiyH1]
	addsd xmm2, [rsp + nb214_fizH1]
	movsd [rsp + nb214_fjxH1], xmm3
	movsd [rsp + nb214_fjyH1], xmm4
	movsd [rsp + nb214_fjzH1], xmm5
	movsd [rsp + nb214_fixH1], xmm0
	movsd [rsp + nb214_fiyH1], xmm1
	movsd [rsp + nb214_fizH1], xmm2

	;# H1-H2 interaction  
	movsd xmm0, [rsp + nb214_rinvH1H2]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqH1H2] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb214_dxH1H2]
	mulsd xmm1, [rsp + nb214_dyH1H2]
	mulsd xmm2, [rsp + nb214_dzH1H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixH1]
	addsd xmm1, [rsp + nb214_fiyH1]
	addsd xmm2, [rsp + nb214_fizH1]
	movsd [rsp + nb214_fjxH2], xmm3
	movsd [rsp + nb214_fjyH2], xmm4
	movsd [rsp + nb214_fjzH2], xmm5
	movsd [rsp + nb214_fixH1], xmm0
	movsd [rsp + nb214_fiyH1], xmm1
	movsd [rsp + nb214_fizH1], xmm2

	;# H1-M interaction 
	movsd xmm0, [rsp + nb214_rinvH1M]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqH1M] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqMH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulsd  xmm5, [rsp + nb214_two]
	subsd  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulsd  xmm7, [rsp + nb214_qqMH] ;# xmm7 = coul part of fscal 
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb214_dxH1M]
	mulsd xmm1, [rsp + nb214_dyH1M]
	mulsd xmm2, [rsp + nb214_dzH1M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixH1]
	addsd xmm1, [rsp + nb214_fiyH1]
	addsd xmm2, [rsp + nb214_fizH1]
	movsd [rsp + nb214_fjxM], xmm3
	movsd [rsp + nb214_fjyM], xmm4
	movsd [rsp + nb214_fjzM], xmm5
	movsd [rsp + nb214_fixH1], xmm0
	movsd [rsp + nb214_fiyH1], xmm1
	movsd [rsp + nb214_fizH1], xmm2

	;# H2-H1 interaction 
	movsd xmm0, [rsp + nb214_rinvH2H1]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqH2H1] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm4, [rsp + nb214_fjyH1]
	movapd xmm5, [rsp + nb214_fjzH1]
	mulsd xmm0, [rsp + nb214_dxH2H1]
	mulsd xmm1, [rsp + nb214_dyH2H1]
	mulsd xmm2, [rsp + nb214_dzH2H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixH2]
	addsd xmm1, [rsp + nb214_fiyH2]
	addsd xmm2, [rsp + nb214_fizH2]
	movsd [rsp + nb214_fjxH1], xmm3
	movsd [rsp + nb214_fjyH1], xmm4
	movsd [rsp + nb214_fjzH1], xmm5
	movsd [rsp + nb214_fixH2], xmm0
	movsd [rsp + nb214_fiyH2], xmm1
	movsd [rsp + nb214_fizH2], xmm2

	;# H2-H2 interaction 
	movsd xmm0, [rsp + nb214_rinvH2H2]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqH2H2] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movsd xmm3, [rsp + nb214_fjxH2]
	movsd xmm4, [rsp + nb214_fjyH2]
	movsd xmm5, [rsp + nb214_fjzH2]
	mulsd xmm0, [rsp + nb214_dxH2H2]
	mulsd xmm1, [rsp + nb214_dyH2H2]
	mulsd xmm2, [rsp + nb214_dzH2H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixH2]
	...
	;# H2-M interaction 
	movsd xmm0, [rsp + nb214_rinvH2M]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqH2M] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqMH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm4, [rsp + nb214_fjyM]
	movapd xmm5, [rsp + nb214_fjzM]
	mulsd xmm0, [rsp + nb214_dxH2M]
	mulsd xmm1, [rsp + nb214_dyH2M]
	mulsd xmm2, [rsp + nb214_dzH2M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixH2]
	...
	;# M-H1 interaction 
	movsd xmm0, [rsp + nb214_rinvMH1]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqMH1] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqMH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm4, [rsp + nb214_fjyH1]
	movapd xmm5, [rsp + nb214_fjzH1]
	mulsd xmm0, [rsp + nb214_dxMH1]
	mulsd xmm1, [rsp + nb214_dyMH1]
	mulsd xmm2, [rsp + nb214_dzMH1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixM]
	addsd xmm1, [rsp + nb214_fiyM]
	addsd xmm2, [rsp + nb214_fizM]
	movsd [rsp + nb214_fjxH1], xmm3
	movsd [rsp + nb214_fjyH1], xmm4
	movsd [rsp + nb214_fjzH1], xmm5
	movsd [rsp + nb214_fixM], xmm0
	movsd [rsp + nb214_fiyM], xmm1
	movsd [rsp + nb214_fizM], xmm2

	;# M-H2 interaction 
	movsd xmm0, [rsp + nb214_rinvMH2]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqMH2] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqMH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	...
	movapd xmm4, [rsp + nb214_fjyH2]
	movapd xmm5, [rsp + nb214_fjzH2]
	mulsd xmm0, [rsp + nb214_dxMH2]
	mulsd xmm1, [rsp + nb214_dyMH2]
	mulsd xmm2, [rsp + nb214_dzMH2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixM]
	...
	;# M-M interaction 
	movsd xmm0, [rsp + nb214_rinvMM]
	movsd xmm7, xmm0	;# xmm7=rinv 
	movsd xmm5, [rsp + nb214_krf]
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm5, [rsp + nb214_rsqMM] ;# xmm5=krsq 
	movsd xmm6, xmm5
	addsd  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subsd  xmm6, [rsp + nb214_crf]
	mulsd  xmm6, [rsp + nb214_qqMM] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulsd  xmm5, [rsp + nb214_two]
	subsd  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulsd  xmm7, [rsp + nb214_qqMM] ;# xmm7 = coul part of fscal 
	...
	movapd xmm4, [rsp + nb214_fjyM]
	movapd xmm5, [rsp + nb214_fjzM]
	mulsd xmm0, [rsp + nb214_dxMM]
	mulsd xmm1, [rsp + nb214_dyMM]
	mulsd xmm2, [rsp + nb214_dzMM]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb214_fixM]
	...
	;# Did all interactions - now update j forces 
	;# Step1 - merge forces
	movlpd xmm0, [rsp + nb214_fjxO]
	movlpd xmm1, [rsp + nb214_fjzO]
	movlpd xmm2, [rsp + nb214_fjyH1]
	movlpd xmm3, [rsp + nb214_fjxH2]
	movlpd xmm4, [rsp + nb214_fjzH2]
	movlpd xmm5, [rsp + nb214_fjyM]

	movhpd xmm0, [rsp + nb214_fjyO]
	movhpd xmm1, [rsp + nb214_fjxH1]
	movhpd xmm2, [rsp + nb214_fjzH1]
	movhpd xmm3, [rsp + nb214_fjyH2]
	movhpd xmm4, [rsp + nb214_fjxM]
	movhpd xmm5, [rsp + nb214_fjzM]
