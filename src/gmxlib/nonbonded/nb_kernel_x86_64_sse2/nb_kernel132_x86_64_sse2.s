...
.nb132_unroll_loop:
	...
	movapd 	[rsp + nb132_jxO], xmm2
	movapd 	[rsp + nb132_jyO], xmm3
	movapd 	[rsp + nb132_jzO], xmm4
	movapd 	[rsp + nb132_jxH1], xmm5
	movapd 	[rsp + nb132_jyH1], xmm6
	movapd 	[rsp + nb132_jzH1], xmm7
	...
	movapd 	[rsp + nb132_jxH2], xmm2
	movapd 	[rsp + nb132_jyH2], xmm3
	movapd 	[rsp + nb132_jzH2], xmm4
	
	movapd xmm0, [rsp + nb132_ixO]
	movapd xmm1, [rsp + nb132_iyO]
	movapd xmm2, [rsp + nb132_izO]
	movapd xmm3, [rsp + nb132_ixO]
	movapd xmm4, [rsp + nb132_iyO]
	movapd xmm5, [rsp + nb132_izO]
	subpd  xmm0, [rsp + nb132_jxO]
	subpd  xmm1, [rsp + nb132_jyO]
	subpd  xmm2, [rsp + nb132_jzO]
	subpd  xmm3, [rsp + nb132_jxH1]
	subpd  xmm4, [rsp + nb132_jyH1]
	subpd  xmm5, [rsp + nb132_jzH1]
	...
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb132_dxOH1], xmm3
	movapd [rsp + nb132_dyOH1], xmm4
	movapd [rsp + nb132_dzOH1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	movapd xmm1, [rsp + nb132_iyO]
	movapd xmm2, [rsp + nb132_izO]
	movapd xmm3, [rsp + nb132_ixH1]
	movapd xmm4, [rsp + nb132_iyH1]
	movapd xmm5, [rsp + nb132_izH1]
	subpd  xmm0, [rsp + nb132_jxH2]
	subpd  xmm1, [rsp + nb132_jyH2]
	subpd  xmm2, [rsp + nb132_jzH2]
	subpd  xmm3, [rsp + nb132_jxO]
	subpd  xmm4, [rsp + nb132_jyO]
	subpd  xmm5, [rsp + nb132_jzO]
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb132_rsqOH2], xmm0
	movapd [rsp + nb132_rsqH1O], xmm3

	movapd xmm0, [rsp + nb132_ixH1]
	movapd xmm1, [rsp + nb132_iyH1]
	movapd xmm2, [rsp + nb132_izH1]
	movapd xmm3, [rsp + nb132_ixH1]
	movapd xmm4, [rsp + nb132_iyH1]
	movapd xmm5, [rsp + nb132_izH1]
	subpd  xmm0, [rsp + nb132_jxH1]
	subpd  xmm1, [rsp + nb132_jyH1]
	subpd  xmm2, [rsp + nb132_jzH1]
	subpd  xmm3, [rsp + nb132_jxH2]
	subpd  xmm4, [rsp + nb132_jyH2]
	subpd  xmm5, [rsp + nb132_jzH2]
	movapd [rsp + nb132_dxH1H1], xmm0
	movapd [rsp + nb132_dyH1H1], xmm1
	movapd [rsp + nb132_dzH1H1], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb132_rsqH1H1], xmm0
	movapd [rsp + nb132_rsqH1H2], xmm3

	movapd xmm0, [rsp + nb132_ixH2]
	movapd xmm1, [rsp + nb132_iyH2]
	movapd xmm2, [rsp + nb132_izH2]
	movapd xmm3, [rsp + nb132_ixH2]
	movapd xmm4, [rsp + nb132_iyH2]
	movapd xmm5, [rsp + nb132_izH2]
	subpd  xmm0, [rsp + nb132_jxO]
	subpd  xmm1, [rsp + nb132_jyO]
	subpd  xmm2, [rsp + nb132_jzO]
	subpd  xmm3, [rsp + nb132_jxH1]
	subpd  xmm4, [rsp + nb132_jyH1]
	subpd  xmm5, [rsp + nb132_jzH1]
	movapd [rsp + nb132_dxH2O], xmm0
	movapd [rsp + nb132_dyH2O], xmm1
	movapd [rsp + nb132_dzH2O], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb132_dxH2H1], xmm3
	movapd [rsp + nb132_dyH2H1], xmm4
	movapd [rsp + nb132_dzH2H1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb132_rsqH2O], xmm0
	movapd [rsp + nb132_rsqH2H1], xmm4
	...
	subpd  xmm1, [rsp + nb132_jyH2]
	subpd  xmm2, [rsp + nb132_jzH2]
	movapd [rsp + nb132_dxH2H2], xmm0
	movapd [rsp + nb132_dyH2H2], xmm1
	movapd [rsp + nb132_dzH2H2], xmm2
	mulpd xmm0, xmm0
	mulpd xmm1, xmm1
	mulpd xmm2, xmm2
	addpd xmm0, xmm1
	addpd xmm0, xmm2
	movapd [rsp + nb132_rsqH2H2], xmm0
	...
	mulpd   xmm3, [rsp + nb132_half] ;# iter1 
	mulpd   xmm7, [rsp + nb132_half] ;# iter1 
	...
	mulpd   xmm1, [rsp + nb132_half] ;# rinv 
	mulpd   xmm5, [rsp + nb132_half] ;# rinv 
	movapd [rsp + nb132_rinvH2H2], xmm1
	movapd [rsp + nb132_rinvH2H1], xmm5

	movapd xmm0, [rsp + nb132_rsqOO]
	movapd xmm4, [rsp + nb132_rsqOH1]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb132_half] ;# iter1 of  
	mulpd   xmm7, [rsp + nb132_half] ;# iter1 of  
	...
	mulpd   xmm1, [rsp + nb132_half] ;# rinv 
	mulpd   xmm5, [rsp + nb132_half] ;# rinv
	movapd [rsp + nb132_rinvOO], xmm1
	movapd [rsp + nb132_rinvOH1], xmm5

	movapd xmm0, [rsp + nb132_rsqOH2]
	movapd xmm4, [rsp + nb132_rsqH1O]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb132_half] ;# rinv 
	mulpd   xmm5, [rsp + nb132_half] ;# rinv 
	movapd [rsp + nb132_rinvOH2], xmm1
	movapd [rsp + nb132_rinvH1O], xmm5

	movapd xmm0, [rsp + nb132_rsqH1H1]
	movapd xmm4, [rsp + nb132_rsqH1H2]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb132_half] ;# iter1a 
	mulpd   xmm7, [rsp + nb132_half] ;# iter1b 
	...
	mulpd   xmm1, [rsp + nb132_half] ;# rinv 
	mulpd   xmm5, [rsp + nb132_half] ;# rinv 
	movapd [rsp + nb132_rinvH1H1], xmm1
	movapd [rsp + nb132_rinvH1H2], xmm5

	movapd xmm0, [rsp + nb132_rsqH2O]
	cvtpd2ps xmm1, xmm0	
	rsqrtps xmm1, xmm1
	cvtps2pd xmm1, xmm1
	...
	mulpd   xmm1, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm1, [rsp + nb132_half] ;# rinv 
	movapd [rsp + nb132_rinvH2O], xmm1
	
	;# start with OO interaction 	
	movapd xmm0, [rsp + nb132_rinvOO]
	movapd xmm7, xmm0		;# xmm7=rinv 
	mulpd  xmm7, [rsp + nb132_qqOO]
	movapd xmm6, xmm7
	mulpd  xmm7, xmm0
	
	addpd  xmm6, [rsp + nb132_vctot]
	movapd [rsp + nb132_vctot], xmm6
	movapd [rsp + nb132_fstmp], xmm7

	;# LJ table interaction
	movapd xmm4, [rsp + nb132_rsqOO]
	
	mulpd xmm4, xmm0	;# xmm4=r 
	mulpd xmm4, [rsp + nb132_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb132_dxOO]
	mulpd xmm1, [rsp + nb132_dyOO]
	mulpd xmm2, [rsp + nb132_dzOO]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixO]
	addpd xmm1, [rsp + nb132_fiyO]
	addpd xmm2, [rsp + nb132_fizO]
	movapd [rsp + nb132_fjxO], xmm3
	movapd [rsp + nb132_fjyO], xmm4
	movapd [rsp + nb132_fjzO], xmm5
	movapd [rsp + nb132_fixO], xmm0
	movapd [rsp + nb132_fiyO], xmm1
	movapd [rsp + nb132_fizO], xmm2

	;# O-H1 interaction 
	movapd xmm0, [rsp + nb132_rinvOH1]
	movapd xmm6, xmm0		;# xmm7=rinv 
	mulpd  xmm6, [rsp + nb132_qqOH]
	mulpd  xmm0, xmm0
	mulpd  xmm0, xmm6
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb132_dxOH1]
	mulpd xmm1, [rsp + nb132_dyOH1]
	mulpd xmm2, [rsp + nb132_dzOH1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixO]
	addpd xmm1, [rsp + nb132_fiyO]
	addpd xmm2, [rsp + nb132_fizO]
	movapd [rsp + nb132_fjxH1], xmm3
	movapd [rsp + nb132_fjyH1], xmm4
	movapd [rsp + nb132_fjzH1], xmm5
	movapd [rsp + nb132_fixO], xmm0
	movapd [rsp + nb132_fiyO], xmm1
	movapd [rsp + nb132_fizO], xmm2

	;# O-H2 interaction  
	movapd xmm0, [rsp + nb132_rinvOH2]
	movapd xmm4, xmm0		;# xmm7=rinv 
	mulpd  xmm4, [rsp + nb132_qqOH]
	mulpd  xmm0, xmm0
	mulpd  xmm0, xmm4
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb132_dxOH2]
	mulpd xmm1, [rsp + nb132_dyOH2]
	mulpd xmm2, [rsp + nb132_dzOH2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixO]
	addpd xmm1, [rsp + nb132_fiyO]
	addpd xmm2, [rsp + nb132_fizO]
	movapd [rsp + nb132_fjxH2], xmm3
	movapd [rsp + nb132_fjyH2], xmm4
	movapd [rsp + nb132_fjzH2], xmm5
	movapd [rsp + nb132_fixO], xmm0
	movapd [rsp + nb132_fiyO], xmm1
	movapd [rsp + nb132_fizO], xmm2

	;# H1-O interaction 
	movapd xmm0, [rsp + nb132_rinvH1O]
	...
	movapd xmm3, [rsp + nb132_fjxO]
	movapd xmm4, [rsp + nb132_fjyO]
	movapd xmm5, [rsp + nb132_fjzO]
	mulpd xmm0, [rsp + nb132_dxH1O]
	mulpd xmm1, [rsp + nb132_dyH1O]
	mulpd xmm2, [rsp + nb132_dzH1O]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixH1]
	addpd xmm1, [rsp + nb132_fiyH1]
	addpd xmm2, [rsp + nb132_fizH1]
	movapd [rsp + nb132_fjxO], xmm3
	movapd [rsp + nb132_fjyO], xmm4
	movapd [rsp + nb132_fjzO], xmm5
	movapd [rsp + nb132_fixH1], xmm0
	movapd [rsp + nb132_fiyH1], xmm1
	movapd [rsp + nb132_fizH1], xmm2

	;# H1-H1 interaction 
	movapd xmm0, [rsp + nb132_rinvH1H1]
	movapd xmm4, xmm0		;# xmm4=rinv 
	mulpd  xmm4, [rsp + nb132_qqHH]
	mulpd  xmm0, xmm0
	mulpd  xmm0, xmm4
	...
	movapd xmm3, [rsp + nb132_fjxH1]
	movapd xmm4, [rsp + nb132_fjyH1]
	movapd xmm5, [rsp + nb132_fjzH1]
	mulpd xmm0, [rsp + nb132_dxH1H1]
	mulpd xmm1, [rsp + nb132_dyH1H1]
	mulpd xmm2, [rsp + nb132_dzH1H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixH1]
	...
	;# H1-H2 interaction 
	movapd xmm0, [rsp + nb132_rinvH1H2]
	movapd xmm4, xmm0		;# xmm4=rinv 
	mulpd  xmm4, [rsp + nb132_qqHH]
	mulpd  xmm0, xmm0
	mulpd  xmm0, xmm4
	...
	movapd xmm3, [rsp + nb132_fjxH2]
	movapd xmm4, [rsp + nb132_fjyH2]
	movapd xmm5, [rsp + nb132_fjzH2]
	mulpd xmm0, [rsp + nb132_dxH1H2]
	mulpd xmm1, [rsp + nb132_dyH1H2]
	mulpd xmm2, [rsp + nb132_dzH1H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixH1]
	...
	movapd xmm4, [rsp + nb132_fjyO]
	movapd xmm5, [rsp + nb132_fjzO]
	mulpd xmm0, [rsp + nb132_dxH2O]
	mulpd xmm1, [rsp + nb132_dyH2O]
	mulpd xmm2, [rsp + nb132_dzH2O]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixH2]
	addpd xmm1, [rsp + nb132_fiyH2]
	addpd xmm2, [rsp + nb132_fizH2]
	movapd [rsp + nb132_fjxO], xmm3
	movapd [rsp + nb132_fjyO], xmm4
	movapd [rsp + nb132_fjzO], xmm5
	movapd [rsp + nb132_fixH2], xmm0
	movapd [rsp + nb132_fiyH2], xmm1
	movapd [rsp + nb132_fizH2], xmm2

	;# H2-H1 interaction 
	movapd xmm0, [rsp + nb132_rinvH2H1]
	movapd xmm4, xmm0		;# xmm4=rinv 
	mulpd  xmm4, [rsp + nb132_qqHH]
	mulpd  xmm0, xmm0
	mulpd  xmm0, xmm4
	...
	movapd xmm4, [rsp + nb132_fjyH1]
	movapd xmm5, [rsp + nb132_fjzH1]
	mulpd xmm0, [rsp + nb132_dxH2H1]
	mulpd xmm1, [rsp + nb132_dyH2H1]
	mulpd xmm2, [rsp + nb132_dzH2H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixH2]
	...
	;# H2-H2 interaction 
	movapd xmm0, [rsp + nb132_rinvH2H2]
	movapd xmm4, xmm0		;# xmm4=rinv 
	mulpd  xmm4, [rsp + nb132_qqHH]
	mulpd  xmm0, xmm0
	mulpd  xmm0, xmm4
	...
	movapd xmm4, [rsp + nb132_fjyH2]
	movapd xmm5, [rsp + nb132_fjzH2]
	mulpd xmm0, [rsp + nb132_dxH2H2]
	mulpd xmm1, [rsp + nb132_dyH2H2]
	mulpd xmm2, [rsp + nb132_dzH2H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb132_fixH2]
	...
	addpd xmm0, [rsp + nb132_fjxO]
	addpd xmm1, [rsp + nb132_fjyO]
	addpd xmm2, [rsp + nb132_fjzO]
	addpd xmm3, [rsp + nb132_fjxH1]
	addpd xmm4, [rsp + nb132_fjyH1]
	addpd xmm5, [rsp + nb132_fjzH1]
	addpd xmm6, [rsp + nb132_fjxH2]
	addpd xmm7, [rsp + nb132_fjyH2]
...
.nb132_dosingle:
	...
	movapd xmm4, [rsp + nb132_iyO]
	movapd xmm5, [rsp + nb132_izO]
	subsd  xmm0, [rsp + nb132_jxO]
	subsd  xmm1, [rsp + nb132_jyO]
	subsd  xmm2, [rsp + nb132_jzO]
	subsd  xmm3, [rsp + nb132_jxH1]
	subsd  xmm4, [rsp + nb132_jyH1]
	subsd  xmm5, [rsp + nb132_jzH1]
	movapd [rsp + nb132_dxOO], xmm0
	movapd [rsp + nb132_dyOO], xmm1
	movapd [rsp + nb132_dzOO], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb132_iyH1]
	movapd xmm5, [rsp + nb132_izH1]
	subsd  xmm0, [rsp + nb132_jxH2]
	subsd  xmm1, [rsp + nb132_jyH2]
	subsd  xmm2, [rsp + nb132_jzH2]
	subsd  xmm3, [rsp + nb132_jxO]
	subsd  xmm4, [rsp + nb132_jyO]
	subsd  xmm5, [rsp + nb132_jzO]
	movapd [rsp + nb132_dxOH2], xmm0
	movapd [rsp + nb132_dyOH2], xmm1
	movapd [rsp + nb132_dzOH2], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb132_iyH1]
	movapd xmm5, [rsp + nb132_izH1]
	subsd  xmm0, [rsp + nb132_jxH1]
	subsd  xmm1, [rsp + nb132_jyH1]
	subsd  xmm2, [rsp + nb132_jzH1]
	subsd  xmm3, [rsp + nb132_jxH2]
	subsd  xmm4, [rsp + nb132_jyH2]
	subsd  xmm5, [rsp + nb132_jzH2]
	movapd [rsp + nb132_dxH1H1], xmm0
	movapd [rsp + nb132_dyH1H1], xmm1
	movapd [rsp + nb132_dzH1H1], xmm2
	mulsd  xmm0, xmm0
	...
	mulsd   xmm3, [rsp + nb132_half] ;# iter1 
	mulsd   xmm7, [rsp + nb132_half] ;# iter1 
	...
	mulsd   xmm1, [rsp + nb132_half] ;# rinv 
	mulsd   xmm5, [rsp + nb132_half] ;# rinv 
	movapd [rsp + nb132_rinvH2H2], xmm1
	movapd [rsp + nb132_rinvH2H1], xmm5
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb132_half] ;# iter1 of  
	mulsd   xmm7, [rsp + nb132_half] ;# iter1 of  
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb132_half] ;# iter1a 
	mulsd   xmm7, [rsp + nb132_half] ;# iter1b 
	...
	;# start with OO interaction 	
	movsd xmm0, [rsp + nb132_rinvOO]
	movsd xmm7, xmm0		;# xmm7=rinv 
	mulsd  xmm7, [rsp + nb132_qqOO]	;# xmm7 = qq*rinv
	movsd  xmm6, xmm7
	mulsd  xmm7, xmm0
	
	addsd  xmm6, [rsp + nb132_vctot]
	movsd [rsp + nb132_vctot], xmm6
	movsd [rsp + nb132_fstmp], xmm7

	;# LJ table interaction
	movsd xmm4, [rsp + nb132_rsqOO]
	
	mulsd xmm4, xmm0	;# xmm4=r 
	mulsd xmm4, [rsp + nb132_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb132_dxOO]
	mulsd xmm1, [rsp + nb132_dyOO]
	mulsd xmm2, [rsp + nb132_dzOO]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixO]
	addsd xmm1, [rsp + nb132_fiyO]
	addsd xmm2, [rsp + nb132_fizO]
	movlpd [rsp + nb132_fjxO], xmm3
	movlpd [rsp + nb132_fjyO], xmm4
	movlpd [rsp + nb132_fjzO], xmm5
	movlpd [rsp + nb132_fixO], xmm0
	movlpd [rsp + nb132_fiyO], xmm1
	movlpd [rsp + nb132_fizO], xmm2

	;# O-H1 interaction 
	movsd xmm0, [rsp + nb132_rinvOH1]
	movsd xmm6, xmm0		;# xmm6=rinv 
	mulsd  xmm6, [rsp + nb132_qqOH]
	mulsd  xmm0, xmm0
	mulsd  xmm0, xmm6
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb132_dxOH1]
	mulsd xmm1, [rsp + nb132_dyOH1]
	mulsd xmm2, [rsp + nb132_dzOH1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixO]
	addsd xmm1, [rsp + nb132_fiyO]
	addsd xmm2, [rsp + nb132_fizO]
	movlpd [rsp + nb132_fjxH1], xmm3
	movlpd [rsp + nb132_fjyH1], xmm4
	movlpd [rsp + nb132_fjzH1], xmm5
	movlpd [rsp + nb132_fixO], xmm0
	movlpd [rsp + nb132_fiyO], xmm1
	movlpd [rsp + nb132_fizO], xmm2

	;# O-H2 interaction  
	movsd xmm0, [rsp + nb132_rinvOH2]
	movsd xmm4, xmm0		;# xmm4=rinv 
	mulsd  xmm4, [rsp + nb132_qqOH]
	mulsd  xmm0, xmm0
	mulsd  xmm0, xmm4
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb132_dxOH2]
	mulsd xmm1, [rsp + nb132_dyOH2]
	mulsd xmm2, [rsp + nb132_dzOH2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixO]
	addsd xmm1, [rsp + nb132_fiyO]
	addsd xmm2, [rsp + nb132_fizO]
	movlpd [rsp + nb132_fjxH2], xmm3
	movlpd [rsp + nb132_fjyH2], xmm4
	movlpd [rsp + nb132_fjzH2], xmm5
	movlpd [rsp + nb132_fixO], xmm0
	movlpd [rsp + nb132_fiyO], xmm1
	movlpd [rsp + nb132_fizO], xmm2

	;# H1-O interaction 
	movsd xmm0, [rsp + nb132_rinvH1O]
	movsd xmm4, xmm0		;# xmm4=rinv 
	mulsd  xmm4, [rsp + nb132_qqOH]
	mulsd  xmm0, xmm0
	mulsd  xmm0, xmm4
	...
	movapd xmm4, [rsp + nb132_fjyO]
	movapd xmm5, [rsp + nb132_fjzO]
	mulsd xmm0, [rsp + nb132_dxH1O]
	mulsd xmm1, [rsp + nb132_dyH1O]
	mulsd xmm2, [rsp + nb132_dzH1O]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixH1]
	addsd xmm1, [rsp + nb132_fiyH1]
	addsd xmm2, [rsp + nb132_fizH1]
	movlpd [rsp + nb132_fjxO], xmm3
	movlpd [rsp + nb132_fjyO], xmm4
	movlpd [rsp + nb132_fjzO], xmm5
	movlpd [rsp + nb132_fixH1], xmm0
	movlpd [rsp + nb132_fiyH1], xmm1
	movlpd [rsp + nb132_fizH1], xmm2

	;# H1-H1 interaction 
	movsd xmm0, [rsp + nb132_rinvH1H1]
	movsd xmm4, xmm0		;# xmm4=rinv 
	mulsd  xmm4, [rsp + nb132_qqHH]
	mulsd  xmm0, xmm0
	mulsd  xmm0, xmm4
	...
	movapd xmm4, [rsp + nb132_fjyH1]
	movapd xmm5, [rsp + nb132_fjzH1]
	mulsd xmm0, [rsp + nb132_dxH1H1]
	mulsd xmm1, [rsp + nb132_dyH1H1]
	mulsd xmm2, [rsp + nb132_dzH1H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixH1]
	...
	movapd xmm4, [rsp + nb132_fjyH2]
	movapd xmm5, [rsp + nb132_fjzH2]
	mulsd xmm0, [rsp + nb132_dxH1H2]
	mulsd xmm1, [rsp + nb132_dyH1H2]
	mulsd xmm2, [rsp + nb132_dzH1H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixH1]
	...
	movapd xmm4, [rsp + nb132_fjyO]
	movapd xmm5, [rsp + nb132_fjzO]
	mulsd xmm0, [rsp + nb132_dxH2O]
	mulsd xmm1, [rsp + nb132_dyH2O]
	mulsd xmm2, [rsp + nb132_dzH2O]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixH2]
	addsd xmm1, [rsp + nb132_fiyH2]
	addsd xmm2, [rsp + nb132_fizH2]
	movlpd [rsp + nb132_fjxO], xmm3
	movlpd [rsp + nb132_fjyO], xmm4
	movlpd [rsp + nb132_fjzO], xmm5
	movlpd [rsp + nb132_fixH2], xmm0
	movlpd [rsp + nb132_fiyH2], xmm1
	movlpd [rsp + nb132_fizH2], xmm2

	;# H2-H1 interaction 
	movsd xmm0, [rsp + nb132_rinvH2H1]
	movsd xmm4, xmm0		;# xmm4=rinv 
	mulsd  xmm4, [rsp + nb132_qqHH]
	mulsd  xmm0, xmm0
	mulsd  xmm0, xmm4
	...
	movapd xmm4, [rsp + nb132_fjyH1]
	movapd xmm5, [rsp + nb132_fjzH1]
	mulsd xmm0, [rsp + nb132_dxH2H1]
	mulsd xmm1, [rsp + nb132_dyH2H1]
	mulsd xmm2, [rsp + nb132_dzH2H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixH2]
	...
	movapd xmm4, [rsp + nb132_fjyH2]
	movapd xmm5, [rsp + nb132_fjzH2]
	mulsd xmm0, [rsp + nb132_dxH2H2]
	mulsd xmm1, [rsp + nb132_dyH2H2]
	mulsd xmm2, [rsp + nb132_dzH2H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb132_fixH2]
	...
	movlpd xmm6, [rdi + rax*8 + 48]
	movlpd xmm7, [rdi + rax*8 + 56]
	addsd xmm0, [rsp + nb132_fjxO]
	addsd xmm1, [rsp + nb132_fjyO]
	addsd xmm2, [rsp + nb132_fjzO]
	addsd xmm3, [rsp + nb132_fjxH1]
	addsd xmm4, [rsp + nb132_fjyH1]
	addsd xmm5, [rsp + nb132_fjzH1]
	addsd xmm6, [rsp + nb132_fjxH2]
	addsd xmm7, [rsp + nb132_fjyH2]
	movlpd [rdi + rax*8], xmm0
	movlpd [rdi + rax*8 + 8], xmm1
	movlpd [rdi + rax*8 + 16], xmm2
	movlpd [rdi + rax*8 + 24], xmm3
