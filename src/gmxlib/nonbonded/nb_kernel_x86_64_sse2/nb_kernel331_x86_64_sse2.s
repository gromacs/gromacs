...
.nb331_unroll_loop:
	...
	movapd xmm4, [rsp + nb331_ixO]
	movapd xmm5, [rsp + nb331_iyO]
	movapd xmm6, [rsp + nb331_izO]
	...
	;# store dr 
	movapd [rsp + nb331_dxO], xmm4
	movapd [rsp + nb331_dyO], xmm5
	movapd [rsp + nb331_dzO], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	movapd xmm4, [rsp + nb331_ixH1]
	movapd xmm5, [rsp + nb331_iyH1]
	movapd xmm6, [rsp + nb331_izH1]
	...
	;# store dr 
	movapd [rsp + nb331_dxH1], xmm4
	movapd [rsp + nb331_dyH1], xmm5
	movapd [rsp + nb331_dzH1], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	movapd xmm3, [rsp + nb331_ixH2]
	movapd xmm4, [rsp + nb331_iyH2]
	movapd xmm5, [rsp + nb331_izH2]
	...
	;# store dr 
	movapd [rsp + nb331_dxH2], xmm3
	movapd [rsp + nb331_dyH2], xmm4
	movapd [rsp + nb331_dzH2], xmm5
	;# square it 
	mulpd xmm3,xmm3
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [rsp + nb331_half] ;# rinv 
	movapd  [rsp + nb331_rinvO], xmm4	;# rinvO in xmm4 
	mulpd   xmm7, xmm4
	movapd  [rsp + nb331_rO], xmm7	;# r in xmm7 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [rsp + nb331_half] ;# rinv 
	movapd [rsp + nb331_rinvH1], xmm4	;# rinvH1 
	mulpd  xmm6, xmm4
	movapd [rsp + nb331_rH1], xmm6	;# rH1 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [rsp + nb331_half] ;# rinv 
	movapd [rsp + nb331_rinvH2], xmm4 ;# rinv 
	mulpd xmm5, xmm4
	movapd [rsp + nb331_rH2], xmm5 ;# r 

	;# do O interactions 
	;# rO is still in xmm7
	movapd xmm0, [rsp + nb331_rinvO]
	mulpd   xmm7, [rsp + nb331_tsc]
    ...
    mulpd  xmm7, [rsp + nb331_two]       ;# two*Heps2 
    movapd xmm0, [rsp + nb331_qqO]
    addpd  xmm7, xmm6
	...
	;# update vctot 
	addpd  xmm5, [rsp + nb331_vctot]
	movapd [rsp + nb331_vctot], xmm5 
	...
	xorpd xmm4, xmm4
	subpd xmm4, xmm7
	movapd xmm0, [rsp + nb331_dxO]
	movapd xmm1, [rsp + nb331_dyO]
	movapd xmm2, [rsp + nb331_dzO]
	...
	;# update O forces 
	movapd xmm3, [rsp + nb331_fixO]
	movapd xmm4, [rsp + nb331_fiyO]
	movapd xmm7, [rsp + nb331_fizO]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb331_fixO], xmm3
	movapd [rsp + nb331_fiyO], xmm4
	movapd [rsp + nb331_fizO], xmm7
	;# update j forces with water O 
	movapd [rsp + nb331_fjx], xmm0
	movapd [rsp + nb331_fjy], xmm1
	movapd [rsp + nb331_fjz], xmm2

	;# Done with O interactions - now H1! 
	movapd xmm7, [rsp + nb331_rH1]
	mulpd xmm7, [rsp + nb331_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	xorpd  xmm4, xmm4
    addpd  xmm5, [rsp + nb331_vctot]
	mulpd  xmm3, [rsp + nb331_rinvH1]
    movapd [rsp + nb331_vctot], xmm5 
	mulpd  xmm3, [rsp + nb331_tsc]
	subpd xmm4, xmm3

	movapd xmm0, [rsp + nb331_dxH1]
	movapd xmm1, [rsp + nb331_dyH1]
	movapd xmm2, [rsp + nb331_dzH1]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4

	;# update H1 forces 
	movapd xmm3, [rsp + nb331_fixH1]
	movapd xmm4, [rsp + nb331_fiyH1]
	movapd xmm7, [rsp + nb331_fizH1]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb331_fixH1], xmm3
	movapd [rsp + nb331_fiyH1], xmm4
	movapd [rsp + nb331_fizH1], xmm7
	;# update j forces with water H1 
	addpd  xmm0, [rsp + nb331_fjx]
	addpd  xmm1, [rsp + nb331_fjy]
	addpd  xmm2, [rsp + nb331_fjz]
	movapd [rsp + nb331_fjx], xmm0
	movapd [rsp + nb331_fjy], xmm1
	movapd [rsp + nb331_fjz], xmm2

	;# Done with H1, finally we do H2 interactions 
	movapd xmm7, [rsp + nb331_rH2]
	mulpd   xmm7, [rsp + nb331_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	xorpd  xmm4, xmm4
    addpd  xmm5, [rsp + nb331_vctot]
	mulpd  xmm3, [rsp + nb331_rinvH2]
    movapd [rsp + nb331_vctot], xmm5 
	mulpd  xmm3, [rsp + nb331_tsc]
	subpd  xmm4, xmm3

	movapd xmm0, [rsp + nb331_dxH2]
	movapd xmm1, [rsp + nb331_dyH2]
	movapd xmm2, [rsp + nb331_dzH2]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	;# update H2 forces 
	movapd xmm3, [rsp + nb331_fixH2]
	movapd xmm4, [rsp + nb331_fiyH2]
	movapd xmm7, [rsp + nb331_fizH2]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb331_fixH2], xmm3
	movapd [rsp + nb331_fiyH2], xmm4
	movapd [rsp + nb331_fizH2], xmm7
...
.nb331_dosingle:
	...
	mulsd   xmm4, [rsp + nb331_half] ;# iter1 ( new lu) 
	...
	mulsd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulsd xmm4, [rsp + nb331_half] ;# rinv 
	movapd  [rsp + nb331_rinvO], xmm4	;# rinvO in xmm4 
	mulsd   xmm7, xmm4
	movapd  [rsp + nb331_rO], xmm7	;# r in xmm7 
    ...
    mulsd  xmm7, [rsp + nb331_two]       ;# two*Heps2 
	...
	;# increment vcoul - then we can get rid of mm5 
	;# update vctot 
	addsd  xmm5, [rsp + nb331_vctot]
	movlpd [rsp + nb331_vctot], xmm5 
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [rsp + nb331_fixO], xmm3
	movlpd [rsp + nb331_fiyO], xmm4
	movlpd [rsp + nb331_fizO], xmm7
	;# update j forces with water O 
	movlpd [rsp + nb331_fjx], xmm0
	movlpd [rsp + nb331_fjy], xmm1
	movlpd [rsp + nb331_fjz], xmm2
	...
	xorpd  xmm4, xmm4
    addsd  xmm5, [rsp + nb331_vctot]
	mulsd  xmm3, [rsp + nb331_rinvH1]
    movlpd [rsp + nb331_vctot], xmm5 
	mulsd  xmm3, [rsp + nb331_tsc]
	subsd xmm4, xmm3
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [rsp + nb331_fixH1], xmm3
	movlpd [rsp + nb331_fiyH1], xmm4
	movlpd [rsp + nb331_fizH1], xmm7
	;# update j forces with water H1 
	addsd  xmm0, [rsp + nb331_fjx]
	addsd  xmm1, [rsp + nb331_fjy]
	addsd  xmm2, [rsp + nb331_fjz]
	movlpd [rsp + nb331_fjx], xmm0
	movlpd [rsp + nb331_fjy], xmm1
	movlpd [rsp + nb331_fjz], xmm2
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [rsp + nb331_fixH2], xmm3
	movlpd [rsp + nb331_fiyH2], xmm4
	movlpd [rsp + nb331_fizH2], xmm7
