...
.nb103_unroll_loop:
	...
	movapd xmm4, [rsp + nb103_ixM]
	movapd xmm5, [rsp + nb103_iyM]
	movapd xmm6, [rsp + nb103_izM]
	...
	movapd xmm4, [rsp + nb103_ixH1]
	movapd xmm5, [rsp + nb103_iyH1]
	movapd xmm6, [rsp + nb103_izH1]
	...
	movapd xmm3, [rsp + nb103_ixH2]
	movapd xmm4, [rsp + nb103_iyH2]
	movapd xmm5, [rsp + nb103_izH2]
	...
	mulpd   xmm4, [rsp + nb103_half] ;# iter1 ( new lu) 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [rsp + nb103_half] ;# rinv 
	...
	mulpd  xmm7, [rsp + nb103_qqM]	;# xmm7=vcoul 
	
	mulpd  xmm4, xmm7	;# total fsO in xmm4 

	addpd  xmm7, [rsp + nb103_vctot]
	
	movapd [rsp + nb103_vctot], xmm7
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb103_fixM], xmm3
	movapd [rsp + nb103_fiyM], xmm4
	movapd [rsp + nb103_fizM], xmm7
	;# update j forces with water M
	movapd [rsp + nb103_fjx], xmm0
	movapd [rsp + nb103_fjy], xmm1
	movapd [rsp + nb103_fjz], xmm2

	;# H1 interactions 
	movapd  xmm4, xmm6	
	mulpd   xmm4, xmm4	;# xmm6=rinv, xmm4=rinvsq 
	mulpd  xmm6, [rsp + nb103_qqH]	;# xmm6=vcoul 
	mulpd  xmm4, xmm6		;# total fsH1 in xmm4 
	
	addpd  xmm6, [rsp + nb103_vctot]

	movapd xmm0, [rsp + nb103_dxH1]
	movapd xmm1, [rsp + nb103_dyH1]
	movapd xmm2, [rsp + nb103_dzH1]
	movapd [rsp + nb103_vctot], xmm6
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb103_fixH1], xmm3
	movapd [rsp + nb103_fiyH1], xmm4
	movapd [rsp + nb103_fizH1], xmm7
	;# update j forces with water H1 
	addpd  xmm0, [rsp + nb103_fjx]
	addpd  xmm1, [rsp + nb103_fjy]
	addpd  xmm2, [rsp + nb103_fjz]
	movapd [rsp + nb103_fjx], xmm0
	movapd [rsp + nb103_fjy], xmm1
	movapd [rsp + nb103_fjz], xmm2
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb103_fixH2], xmm3
	movapd [rsp + nb103_fiyH2], xmm4
	movapd [rsp + nb103_fizH2], xmm7
