...
.nb334_unroll_loop:
	...
	movapd 	[rsp + nb334_jxO], xmm0
	movapd 	[rsp + nb334_jyO], xmm1
	movapd 	[rsp + nb334_jzO], xmm3
	movapd 	[rsp + nb334_jxH1], xmm4
	...
	movapd 	[rsp + nb334_jyH1], xmm0
	movapd 	[rsp + nb334_jzH1], xmm1
	movapd 	[rsp + nb334_jxH2], xmm3
	movapd 	[rsp + nb334_jyH2], xmm4
	...
	movapd 	[rsp + nb334_jzH2], xmm0
	movapd 	[rsp + nb334_jxM], xmm1
	movapd 	[rsp + nb334_jyM], xmm3
	movapd 	[rsp + nb334_jzM], xmm4
	
	;# start calculating pairwise distances
	movapd xmm0, [rsp + nb334_ixO]
	movapd xmm1, [rsp + nb334_iyO]
	movapd xmm2, [rsp + nb334_izO]
	movapd xmm3, [rsp + nb334_ixH1]
	movapd xmm4, [rsp + nb334_iyH1]
	movapd xmm5, [rsp + nb334_izH1]
	subpd  xmm0, [rsp + nb334_jxO]
	subpd  xmm1, [rsp + nb334_jyO]
	subpd  xmm2, [rsp + nb334_jzO]
	subpd  xmm3, [rsp + nb334_jxH1]
	subpd  xmm4, [rsp + nb334_jyH1]
	subpd  xmm5, [rsp + nb334_jzH1]
	movapd [rsp + nb334_dxOO], xmm0
	movapd [rsp + nb334_dyOO], xmm1
	movapd [rsp + nb334_dzOO], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb334_dxH1H1], xmm3
	movapd [rsp + nb334_dyH1H1], xmm4
	movapd [rsp + nb334_dzH1H1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb334_rsqOO], xmm0
	movapd [rsp + nb334_rsqH1H1], xmm3

	movapd xmm0, [rsp + nb334_ixH1]
	movapd xmm1, [rsp + nb334_iyH1]
	movapd xmm2, [rsp + nb334_izH1]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb334_jxH2]
	subpd  xmm1, [rsp + nb334_jyH2]
	subpd  xmm2, [rsp + nb334_jzH2]
	subpd  xmm3, [rsp + nb334_jxM]
	subpd  xmm4, [rsp + nb334_jyM]
	subpd  xmm5, [rsp + nb334_jzM]
	...
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb334_dxH1M], xmm3
	movapd [rsp + nb334_dyH1M], xmm4
	movapd [rsp + nb334_dzH1M], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb334_rsqH1H2], xmm0
	movapd [rsp + nb334_rsqH1M], xmm3

	movapd xmm0, [rsp + nb334_ixH2]
	movapd xmm1, [rsp + nb334_iyH2]
	movapd xmm2, [rsp + nb334_izH2]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb334_jxH1]
	subpd  xmm1, [rsp + nb334_jyH1]
	subpd  xmm2, [rsp + nb334_jzH1]
	subpd  xmm3, [rsp + nb334_jxH2]
	subpd  xmm4, [rsp + nb334_jyH2]
	subpd  xmm5, [rsp + nb334_jzH2]
	movapd [rsp + nb334_dxH2H1], xmm0
	movapd [rsp + nb334_dyH2H1], xmm1
	movapd [rsp + nb334_dzH2H1], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb334_rsqH2H1], xmm0
	movapd [rsp + nb334_rsqH2H2], xmm3

	movapd xmm0, [rsp + nb334_ixH2]
	movapd xmm1, [rsp + nb334_iyH2]
	movapd xmm2, [rsp + nb334_izH2]
	movapd xmm3, [rsp + nb334_ixM]
	movapd xmm4, [rsp + nb334_iyM]
	movapd xmm5, [rsp + nb334_izM]
	subpd  xmm0, [rsp + nb334_jxM]
	subpd  xmm1, [rsp + nb334_jyM]
	subpd  xmm2, [rsp + nb334_jzM]
	subpd  xmm3, [rsp + nb334_jxH1]
	subpd  xmm4, [rsp + nb334_jyH1]
	subpd  xmm5, [rsp + nb334_jzH1]
	movapd [rsp + nb334_dxH2M], xmm0
	movapd [rsp + nb334_dyH2M], xmm1
	movapd [rsp + nb334_dzH2M], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb334_dxMH1], xmm3
	movapd [rsp + nb334_dyMH1], xmm4
	movapd [rsp + nb334_dzMH1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb334_rsqH2M], xmm0
	movapd [rsp + nb334_rsqMH1], xmm4

	movapd xmm0, [rsp + nb334_ixM]
	movapd xmm1, [rsp + nb334_iyM]
	movapd xmm2, [rsp + nb334_izM]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb334_jxH2]
	...
	subpd  xmm4, [rsp + nb334_jyM]
	subpd  xmm5, [rsp + nb334_jzM]
	movapd [rsp + nb334_dxMH2], xmm0
	movapd [rsp + nb334_dyMH2], xmm1
	movapd [rsp + nb334_dzMH2], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb334_dxMM], xmm3
	movapd [rsp + nb334_dyMM], xmm4
	movapd [rsp + nb334_dzMM], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb334_rsqMH2], xmm0
	movapd [rsp + nb334_rsqMM], xmm4
	...
	mulpd   xmm3, [rsp + nb334_half] ;# iter1 
	mulpd   xmm7, [rsp + nb334_half] ;# iter1 
	...
	mulpd   xmm1, [rsp + nb334_half] ;# rinv 
	mulpd   xmm5, [rsp + nb334_half] ;# rinv 
	movapd [rsp + nb334_rinvMH2], xmm1
	movapd [rsp + nb334_rinvMM], xmm5

	movapd xmm0, [rsp + nb334_rsqOO]
	movapd xmm4, [rsp + nb334_rsqH1H1]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb334_half] ;# iter1 of  
	mulpd   xmm7, [rsp + nb334_half] ;# iter1 of  
	...
	mulpd   xmm1, [rsp + nb334_half] ;# rinv 
	mulpd   xmm5, [rsp + nb334_half] ;# rinv
	movapd [rsp + nb334_rinvOO], xmm1
	movapd [rsp + nb334_rinvH1H1], xmm5

	movapd xmm0, [rsp + nb334_rsqH1H2]
	movapd xmm4, [rsp + nb334_rsqH1M]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb334_half] ;# rinv 
	mulpd   xmm5, [rsp + nb334_half] ;# rinv 
	movapd [rsp + nb334_rinvH1H2], xmm1
	movapd [rsp + nb334_rinvH1M], xmm5

	movapd xmm0, [rsp + nb334_rsqH2H1]
	movapd xmm4, [rsp + nb334_rsqH2H2]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb334_half] ;# iter1a 
	mulpd   xmm7, [rsp + nb334_half] ;# iter1b 
	...
	mulpd   xmm1, [rsp + nb334_half] ;# rinv 
	mulpd   xmm5, [rsp + nb334_half] ;# rinv 
	movapd [rsp + nb334_rinvH2H1], xmm1
	movapd [rsp + nb334_rinvH2H2], xmm5

	movapd xmm0, [rsp + nb334_rsqMH1]
	movapd xmm4, [rsp + nb334_rsqH2M]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb334_half] ;# rinv 
	mulpd   xmm5, [rsp + nb334_half] ;# rinv 
	movapd [rsp + nb334_rinvMH1], xmm1
	movapd [rsp + nb334_rinvH2M], xmm5

	;# start with OO interaction 
	movapd xmm0, [rsp + nb334_rinvOO]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqOO] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]
	...
	movapd xmm4, [rsp + nb334_c12]
	mulpd  xmm7, xmm4 ;# fijR 
	mulpd  xmm5, xmm4 ;# Vvdw12 
	addpd  xmm7, [rsp + nb334_fscal]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb334_dxOO]
	mulpd xmm1, [rsp + nb334_dyOO]
	mulpd xmm2, [rsp + nb334_dzOO]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixO]
	addpd xmm1, [rsp + nb334_fiyO]
	addpd xmm2, [rsp + nb334_fizO]
	movapd [rsp + nb334_fjxO], xmm3
	movapd [rsp + nb334_fjyO], xmm4
	movapd [rsp + nb334_fjzO], xmm5
	movapd [rsp + nb334_fixO], xmm0
	movapd [rsp + nb334_fiyO], xmm1
	movapd [rsp + nb334_fizO], xmm2

	;# H1-H1 interaction 
	movapd xmm0, [rsp + nb334_rinvH1H1]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqH1H1] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]
	...
	mulpd  xmm3, xmm7 ;# fijC=FF*qq 
    	...
    	addpd  xmm5, [rsp + nb334_vctot]
    	movapd [rsp + nb334_vctot], xmm5
	xorpd  xmm1, xmm1
	mulpd  xmm3,  [rsp + nb334_tsc]
	mulpd  xmm3, xmm0
	subpd  xmm1, xmm3
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb334_dxH1H1]
	mulpd xmm1, [rsp + nb334_dyH1H1]
	mulpd xmm2, [rsp + nb334_dzH1H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixH1]
	addpd xmm1, [rsp + nb334_fiyH1]
	addpd xmm2, [rsp + nb334_fizH1]
	movapd [rsp + nb334_fjxH1], xmm3
	movapd [rsp + nb334_fjyH1], xmm4
	movapd [rsp + nb334_fjzH1], xmm5
	movapd [rsp + nb334_fixH1], xmm0
	movapd [rsp + nb334_fiyH1], xmm1
	movapd [rsp + nb334_fizH1], xmm2

	;# H1-H2 interaction  
	movapd xmm0, [rsp + nb334_rinvH1H2]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqH1H2] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb334_dxH1H2]
	mulpd xmm1, [rsp + nb334_dyH1H2]
	mulpd xmm2, [rsp + nb334_dzH1H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixH1]
	addpd xmm1, [rsp + nb334_fiyH1]
	addpd xmm2, [rsp + nb334_fizH1]
	movapd [rsp + nb334_fjxH2], xmm3
	movapd [rsp + nb334_fjyH2], xmm4
	movapd [rsp + nb334_fjzH2], xmm5
	movapd [rsp + nb334_fixH1], xmm0
	movapd [rsp + nb334_fiyH1], xmm1
	movapd [rsp + nb334_fizH1], xmm2

	;# H1-M interaction 
	movapd xmm0, [rsp + nb334_rinvH1M]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqH1M] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb334_dxH1M]
	mulpd xmm1, [rsp + nb334_dyH1M]
	mulpd xmm2, [rsp + nb334_dzH1M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixH1]
	addpd xmm1, [rsp + nb334_fiyH1]
	addpd xmm2, [rsp + nb334_fizH1]
	movapd [rsp + nb334_fjxM], xmm3
	movapd [rsp + nb334_fjyM], xmm4
	movapd [rsp + nb334_fjzM], xmm5
	movapd [rsp + nb334_fixH1], xmm0
	movapd [rsp + nb334_fiyH1], xmm1
	movapd [rsp + nb334_fizH1], xmm2

	;# H2-H1 interaction 
	movapd xmm0, [rsp + nb334_rinvH2H1]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqH2H1] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]	
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm3, [rsp + nb334_fjxH1]
	movapd xmm4, [rsp + nb334_fjyH1]
	movapd xmm5, [rsp + nb334_fjzH1]
	mulpd xmm0, [rsp + nb334_dxH2H1]
	mulpd xmm1, [rsp + nb334_dyH2H1]
	mulpd xmm2, [rsp + nb334_dzH2H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixH2]
	addpd xmm1, [rsp + nb334_fiyH2]
	addpd xmm2, [rsp + nb334_fizH2]
	movapd [rsp + nb334_fjxH1], xmm3
	movapd [rsp + nb334_fjyH1], xmm4
	movapd [rsp + nb334_fjzH1], xmm5
	movapd [rsp + nb334_fixH2], xmm0
	movapd [rsp + nb334_fiyH2], xmm1
	movapd [rsp + nb334_fizH2], xmm2

	;# H2-H2 interaction 
	movapd xmm0, [rsp + nb334_rinvH2H2]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqH2H2] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]	
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm3, [rsp + nb334_fjxH2]
	movapd xmm4, [rsp + nb334_fjyH2]
	movapd xmm5, [rsp + nb334_fjzH2]
	mulpd xmm0, [rsp + nb334_dxH2H2]
	mulpd xmm1, [rsp + nb334_dyH2H2]
	mulpd xmm2, [rsp + nb334_dzH2H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixH2]
	...
	;# H2-M interaction 
	movapd xmm0, [rsp + nb334_rinvH2M]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqH2M] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm3, [rsp + nb334_fjxM]
	movapd xmm4, [rsp + nb334_fjyM]
	movapd xmm5, [rsp + nb334_fjzM]
	mulpd xmm0, [rsp + nb334_dxH2M]
	mulpd xmm1, [rsp + nb334_dyH2M]
	mulpd xmm2, [rsp + nb334_dzH2M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixH2]
	...
	;# M-H1 interaction 
	movapd xmm0, [rsp + nb334_rinvMH1]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqMH1] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]	
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb334_fjyH1]
	movapd xmm5, [rsp + nb334_fjzH1]
	mulpd xmm0, [rsp + nb334_dxMH1]
	mulpd xmm1, [rsp + nb334_dyMH1]
	mulpd xmm2, [rsp + nb334_dzMH1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixM]
	addpd xmm1, [rsp + nb334_fiyM]
	addpd xmm2, [rsp + nb334_fizM]
	movapd [rsp + nb334_fjxH1], xmm3
	movapd [rsp + nb334_fjyH1], xmm4
	movapd [rsp + nb334_fjzH1], xmm5
	movapd [rsp + nb334_fixM], xmm0
	movapd [rsp + nb334_fiyM], xmm1
	movapd [rsp + nb334_fizM], xmm2

	;# M-H2 interaction 
	movapd xmm0, [rsp + nb334_rinvMH2]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqMH2] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb334_fjyH2]
	movapd xmm5, [rsp + nb334_fjzH2]
	mulpd xmm0, [rsp + nb334_dxMH2]
	mulpd xmm1, [rsp + nb334_dyMH2]
	mulpd xmm2, [rsp + nb334_dzMH2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixM]
	...
	;# M-M interaction 
	movapd xmm0, [rsp + nb334_rinvMM]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb334_rsqMM] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb334_tsc]	
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb334_fjyM] 
	movapd xmm5, [rsp + nb334_fjzM]
	mulpd xmm0, [rsp + nb334_dxMM]
	mulpd xmm1, [rsp + nb334_dyMM]
	mulpd xmm2, [rsp + nb334_dzMM]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb334_fixM]
	...
	movapd xmm0, [rsp + nb334_fjxO]
	movapd xmm1, [rsp + nb334_fjyO]
	movapd xmm2, [rsp + nb334_fjzO]
	movapd xmm3, [rsp + nb334_fjxH1]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	...
	movapd xmm0, [rsp + nb334_fjyH1]
	movapd xmm1, [rsp + nb334_fjzH1]
	movapd xmm2, [rsp + nb334_fjxH2]
	movapd xmm3, [rsp + nb334_fjyH2]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	unpcklpd xmm0, xmm1   ;# fjOxA fjOyA
	unpckhpd xmm4, xmm1   ;# fjOxB fjOyB
	...
	movapd xmm0, [rsp + nb334_fjzH2]
	movapd xmm1, [rsp + nb334_fjxM]
	movapd xmm2, [rsp + nb334_fjyM]
	movapd xmm3, [rsp + nb334_fjzM]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	unpcklpd xmm0, xmm1   ;# fjOxA fjOyA
	unpckhpd xmm4, xmm1   ;# fjOxB fjOyB
...
.nb334_dosingle:
	...
	movsd  [rsp + nb334_jxO], xmm0
	movsd  [rsp + nb334_jzO], xmm1
	movsd  [rsp + nb334_jyH1], xmm2
	movsd  [rsp + nb334_jxH2], xmm3
	movsd  [rsp + nb334_jzH2], xmm4
	movsd  [rsp + nb334_jyM], xmm5
	unpckhpd xmm0, xmm0
	unpckhpd xmm1, xmm1
	unpckhpd xmm2, xmm2
	unpckhpd xmm3, xmm3
	unpckhpd xmm4, xmm4
	unpckhpd xmm5, xmm5
	movsd  [rsp + nb334_jyO], xmm0
	movsd  [rsp + nb334_jxH1], xmm1
	movsd  [rsp + nb334_jzH1], xmm2
	movsd  [rsp + nb334_jyH2], xmm3
	movsd  [rsp + nb334_jxM], xmm4
	movsd  [rsp + nb334_jzM], xmm5
	...
	movapd xmm4, [rsp + nb334_iyH1]
	movapd xmm5, [rsp + nb334_izH1]
	subsd  xmm0, [rsp + nb334_jxO]
	subsd  xmm1, [rsp + nb334_jyO]
	subsd  xmm2, [rsp + nb334_jzO]
	subsd  xmm3, [rsp + nb334_jxH1]
	subsd  xmm4, [rsp + nb334_jyH1]
	subsd  xmm5, [rsp + nb334_jzH1]
	movapd [rsp + nb334_dxOO], xmm0
	movapd [rsp + nb334_dyOO], xmm1
	movapd [rsp + nb334_dzOO], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subsd  xmm0, [rsp + nb334_jxH2]
	subsd  xmm1, [rsp + nb334_jyH2]
	subsd  xmm2, [rsp + nb334_jzH2]
	subsd  xmm3, [rsp + nb334_jxM]
	subsd  xmm4, [rsp + nb334_jyM]
	subsd  xmm5, [rsp + nb334_jzM]
	movapd [rsp + nb334_dxH1H2], xmm0
	movapd [rsp + nb334_dyH1H2], xmm1
	movapd [rsp + nb334_dzH1H2], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subsd  xmm0, [rsp + nb334_jxH1]
	subsd  xmm1, [rsp + nb334_jyH1]
	subsd  xmm2, [rsp + nb334_jzH1]
	subsd  xmm3, [rsp + nb334_jxH2]
	subsd  xmm4, [rsp + nb334_jyH2]
	subsd  xmm5, [rsp + nb334_jzH2]
	movapd [rsp + nb334_dxH2H1], xmm0
	movapd [rsp + nb334_dyH2H1], xmm1
	movapd [rsp + nb334_dzH2H1], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb334_iyM]
	movapd xmm5, [rsp + nb334_izM]
	subsd  xmm0, [rsp + nb334_jxM]
	subsd  xmm1, [rsp + nb334_jyM]
	subsd  xmm2, [rsp + nb334_jzM]
	subsd  xmm3, [rsp + nb334_jxH1]
	subsd  xmm4, [rsp + nb334_jyH1]
	subsd  xmm5, [rsp + nb334_jzH1]
	movapd [rsp + nb334_dxH2M], xmm0
	...
	mulsd   xmm3, [rsp + nb334_half] ;# iter1 
	mulsd   xmm7, [rsp + nb334_half] ;# iter1 
	...
	mulsd   xmm1, [rsp + nb334_half] ;# rinv 
	mulsd   xmm5, [rsp + nb334_half] ;# rinv 
	movapd [rsp + nb334_rinvMH2], xmm1
	movapd [rsp + nb334_rinvMM], xmm5
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb334_half] ;# iter1 of  
	mulsd   xmm7, [rsp + nb334_half] ;# iter1 of  
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb334_half] ;# iter1a 
	mulsd   xmm7, [rsp + nb334_half] ;# iter1b 
	...
	movapd xmm0, [rsp + nb334_rinvOO]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqOO] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]
	...
	mulsd  xmm7, [rsp + nb334_two]	;# two*Heps2 
	addsd  xmm7, xmm6
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb334_dxOO]
	mulsd xmm1, [rsp + nb334_dyOO]
	mulsd xmm2, [rsp + nb334_dzOO]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixO]
	addsd xmm1, [rsp + nb334_fiyO]
	addsd xmm2, [rsp + nb334_fizO]
	movsd [rsp + nb334_fjxO], xmm3
	movsd [rsp + nb334_fjyO], xmm4
	movsd [rsp + nb334_fjzO], xmm5
	...
	movapd xmm0, [rsp + nb334_rinvH1H1]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqH1H1] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]
	...
	mulsd  xmm3, xmm7 ;# fijC=FF*qq 
    	...
    	addsd  xmm5, [rsp + nb334_vctot]
    	movsd [rsp + nb334_vctot], xmm5
	xorpd  xmm1, xmm1
	mulsd  xmm3,  [rsp + nb334_tsc]
	mulsd  xmm3, xmm0
	subsd  xmm1, xmm3
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb334_dxH1H1]
	mulsd xmm1, [rsp + nb334_dyH1H1]
	mulsd xmm2, [rsp + nb334_dzH1H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixH1]
	addsd xmm1, [rsp + nb334_fiyH1]
	addsd xmm2, [rsp + nb334_fizH1]
	movsd [rsp + nb334_fjxH1], xmm3
	movsd [rsp + nb334_fjyH1], xmm4
	movsd [rsp + nb334_fjzH1], xmm5
	movsd [rsp + nb334_fixH1], xmm0
	movsd [rsp + nb334_fiyH1], xmm1
	movsd [rsp + nb334_fizH1], xmm2

	;# H1-H2 interaction  
	movapd xmm0, [rsp + nb334_rinvH1H2]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqH1H2] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb334_dxH1H2]
	mulsd xmm1, [rsp + nb334_dyH1H2]
	mulsd xmm2, [rsp + nb334_dzH1H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixH1]
	addsd xmm1, [rsp + nb334_fiyH1]
	addsd xmm2, [rsp + nb334_fizH1]
	movsd [rsp + nb334_fjxH2], xmm3
	movsd [rsp + nb334_fjyH2], xmm4
	movsd [rsp + nb334_fjzH2], xmm5
	movsd [rsp + nb334_fixH1], xmm0
	movsd [rsp + nb334_fiyH1], xmm1
	movsd [rsp + nb334_fizH1], xmm2
	...
	movapd xmm0, [rsp + nb334_rinvH1M]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqH1M] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]
	...
	shl eax, 2		;# idx *= 4 
	mov  rsi, [rbp + nb334_VFtab]
	lea  eax, [rax + rax*2]	;# idx*=3 (12 total now) 
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb334_dxH1M]
	mulsd xmm1, [rsp + nb334_dyH1M]
	mulsd xmm2, [rsp + nb334_dzH1M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixH1]
	addsd xmm1, [rsp + nb334_fiyH1]
	addsd xmm2, [rsp + nb334_fizH1]
	movsd [rsp + nb334_fjxM], xmm3
	movsd [rsp + nb334_fjyM], xmm4
	movsd [rsp + nb334_fjzM], xmm5
	movsd [rsp + nb334_fixH1], xmm0
	movsd [rsp + nb334_fiyH1], xmm1
	movsd [rsp + nb334_fizH1], xmm2
	...
	movapd xmm0, [rsp + nb334_rinvH2H1]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqH2H1] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]	
	...
	movapd xmm4, [rsp + nb334_fjyH1]
	movapd xmm5, [rsp + nb334_fjzH1]
	mulsd xmm0, [rsp + nb334_dxH2H1]
	mulsd xmm1, [rsp + nb334_dyH2H1]
	mulsd xmm2, [rsp + nb334_dzH2H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixH2]
	addsd xmm1, [rsp + nb334_fiyH2]
	addsd xmm2, [rsp + nb334_fizH2]
	movsd [rsp + nb334_fjxH1], xmm3
	movsd [rsp + nb334_fjyH1], xmm4
	movsd [rsp + nb334_fjzH1], xmm5
	movsd [rsp + nb334_fixH2], xmm0
	movsd [rsp + nb334_fiyH2], xmm1
	movsd [rsp + nb334_fizH2], xmm2

	;# H2-H2 interaction 
	movapd xmm0, [rsp + nb334_rinvH2H2]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqH2H2] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]	
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb334_fjyH2]
	movapd xmm5, [rsp + nb334_fjzH2]
	mulsd xmm0, [rsp + nb334_dxH2H2]
	mulsd xmm1, [rsp + nb334_dyH2H2]
	mulsd xmm2, [rsp + nb334_dzH2H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixH2]
	...
	movapd xmm0, [rsp + nb334_rinvH2M]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqH2M] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb334_fjyM]
	movapd xmm5, [rsp + nb334_fjzM]
	mulsd xmm0, [rsp + nb334_dxH2M]
	mulsd xmm1, [rsp + nb334_dyH2M]
	mulsd xmm2, [rsp + nb334_dzH2M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixH2]
	...
	movapd xmm0, [rsp + nb334_rinvMH1]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqMH1] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]	
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb334_fjyH1]
	movapd xmm5, [rsp + nb334_fjzH1]
	mulsd xmm0, [rsp + nb334_dxMH1]
	mulsd xmm1, [rsp + nb334_dyMH1]
	mulsd xmm2, [rsp + nb334_dzMH1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixM]
	addsd xmm1, [rsp + nb334_fiyM]
	addsd xmm2, [rsp + nb334_fizM]
	movsd [rsp + nb334_fjxH1], xmm3
	movsd [rsp + nb334_fjyH1], xmm4
	movsd [rsp + nb334_fjzH1], xmm5
	movsd [rsp + nb334_fixM], xmm0
	movsd [rsp + nb334_fiyM], xmm1
	movsd [rsp + nb334_fizM], xmm2

	;# M-H2 interaction 
	movapd xmm0, [rsp + nb334_rinvMH2]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqMH2] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb334_fjyH2]
	movapd xmm5, [rsp + nb334_fjzH2]
	mulsd xmm0, [rsp + nb334_dxMH2]
	mulsd xmm1, [rsp + nb334_dyMH2]
	mulsd xmm2, [rsp + nb334_dzMH2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixM]
	...
	movapd xmm0, [rsp + nb334_rinvMM]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb334_rsqMM] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb334_tsc]	
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb334_fjyM]
	movapd xmm5, [rsp + nb334_fjzM]
	mulsd xmm0, [rsp + nb334_dxMM]
	mulsd xmm1, [rsp + nb334_dyMM]
	mulsd xmm2, [rsp + nb334_dzMM]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb334_fixM]
	...
	;# Did all interactions - now update j forces 
	;# Step1 - merge forces
	movlpd xmm0, [rsp + nb334_fjxO]
	movlpd xmm1, [rsp + nb334_fjzO]
	movlpd xmm2, [rsp + nb334_fjyH1]
	movlpd xmm3, [rsp + nb334_fjxH2]
	movlpd xmm4, [rsp + nb334_fjzH2]
	movlpd xmm5, [rsp + nb334_fjyM]

	movhpd xmm0, [rsp + nb334_fjyO]
	movhpd xmm1, [rsp + nb334_fjxH1]
	movhpd xmm2, [rsp + nb334_fjzH1]
	movhpd xmm3, [rsp + nb334_fjyH2]
	movhpd xmm4, [rsp + nb334_fjxM]
	movhpd xmm5, [rsp + nb334_fjzM]
