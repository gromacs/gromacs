...
.nb213_unroll_loop:
	...
	movapd xmm4, [rsp + nb213_ixO]
	movapd xmm5, [rsp + nb213_iyO]
	movapd xmm6, [rsp + nb213_izO]
	...
	movapd xmm4, [rsp + nb213_ixH1]
	movapd xmm5, [rsp + nb213_iyH1]
	movapd xmm6, [rsp + nb213_izH1]
	...
	movapd xmm3, [rsp + nb213_ixH2]
	movapd xmm4, [rsp + nb213_iyH2]
	movapd xmm5, [rsp + nb213_izH2]
	...
	movapd xmm3, [rsp + nb213_iyM]
	movapd xmm4, [rsp + nb213_izM]
	subpd  xmm3, xmm1
	subpd  xmm4, xmm2
	movapd xmm2, [rsp + nb213_ixM]
	subpd  xmm2, xmm0	

	;# store dr 
	movapd [rsp + nb213_dxM], xmm2
	movapd [rsp + nb213_dyM], xmm3
	movapd [rsp + nb213_dzM], xmm4
	;# square it 
	mulpd xmm2,xmm2
	mulpd xmm3,xmm3
	mulpd xmm4,xmm4
	...
	;# calculate krsq
	movapd xmm0, [rsp + nb213_krf]
	movapd xmm1, xmm0
	movapd xmm2, xmm0
	mulpd xmm0, xmm4  
	mulpd xmm1, xmm5
	mulpd xmm2, xmm6
	movapd [rsp + nb213_krsqM], xmm0
	movapd [rsp + nb213_krsqH2], xmm1
	movapd [rsp + nb213_krsqH1], xmm2
	...
	mulpd   xmm1, [rsp + nb213_half] ;# iter1 ( new lu) 
	...
	mulpd xmm1, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm1, [rsp + nb213_half] ;# rinv 
	...
	mulpd  xmm1, [rsp + nb213_c6]
	mulpd  xmm2, [rsp + nb213_c12]
	movapd xmm3, xmm2
	subpd  xmm3, xmm1	;# Vvdw=Vvdw12-Vvdw6 		
	addpd  xmm3, [rsp + nb213_Vvdwtot]
	mulpd  xmm1, [rsp + nb213_six]
	mulpd  xmm2, [rsp + nb213_twelve]
	subpd  xmm2, xmm1
	mulpd  xmm2, xmm0
	movapd xmm4, xmm2 ;# total fsO 
	movapd [rsp + nb213_Vvdwtot], xmm3
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb213_fixO], xmm3
	movapd [rsp + nb213_fiyO], xmm4
	movapd [rsp + nb213_fizO], xmm7
	;# update j forces with water O 
	movapd [rsp + nb213_fjx], xmm0
	movapd [rsp + nb213_fjy], xmm1
	movapd [rsp + nb213_fjz], xmm2

	;# H1 interactions 
	movapd  xmm6, [rsp + nb213_rinvH1] 
	movapd  xmm4, xmm6
	mulpd   xmm4, xmm4	;# xmm6=rinv, xmm4=rinvsq 
	movapd  xmm7, xmm6
	movapd  xmm0, [rsp + nb213_krsqH1]
	addpd   xmm6, xmm0	;# xmm6=rinv+ krsq 
	mulpd   xmm0, [rsp + nb213_two]
	subpd   xmm6, [rsp + nb213_crf]
	subpd   xmm7, xmm0	;# xmm7=rinv-2*krsq 
	mulpd   xmm6, [rsp + nb213_qqH] ;# vcoul 
	mulpd   xmm7, [rsp + nb213_qqH]
	mulpd  xmm4, xmm7		;# total fsH1 in xmm4 
	addpd  xmm6, [rsp + nb213_vctot]

	movapd xmm0, [rsp + nb213_dxH1]
	movapd xmm1, [rsp + nb213_dyH1]
	movapd xmm2, [rsp + nb213_dzH1]
	movapd [rsp + nb213_vctot], xmm6
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb213_fixH1], xmm3
	movapd [rsp + nb213_fiyH1], xmm4
	movapd [rsp + nb213_fizH1], xmm7
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb213_fixH2], xmm3
	movapd [rsp + nb213_fiyH2], xmm4
	movapd [rsp + nb213_fizH2], xmm7
	...
	;# M interactions 
	movapd  xmm5, [rsp + nb213_rinvM] 
	movapd  xmm4, xmm5	
	mulpd   xmm4, xmm4	;# xmm5=rinv, xmm4=rinvsq 
	movapd  xmm7, xmm5
	movapd  xmm0, [rsp + nb213_krsqM]
	addpd   xmm5, xmm0	;# xmm5=rinv+ krsq 
	mulpd   xmm0, [rsp + nb213_two]
	subpd   xmm5, [rsp + nb213_crf]
	subpd   xmm7, xmm0	;# xmm7=rinv-2*krsq 
	mulpd   xmm5, [rsp + nb213_qqM] ;# vcoul 
	mulpd   xmm7, [rsp + nb213_qqM]
	mulpd  xmm4, xmm7		;# total fsH2 in xmm4 
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb213_fixM], xmm3
	movapd [rsp + nb213_fiyM], xmm4
	movapd [rsp + nb213_fizM], xmm7
