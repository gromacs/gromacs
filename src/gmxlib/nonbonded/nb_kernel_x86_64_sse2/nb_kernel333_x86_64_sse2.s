...
.nb333_unroll_loop:
	...
	movapd xmm4, [rsp + nb333_ixO]
	movapd xmm5, [rsp + nb333_iyO]
	movapd xmm6, [rsp + nb333_izO]
	...
	;# store dr 
	movapd [rsp + nb333_dxO], xmm4
	movapd [rsp + nb333_dyO], xmm5
	movapd [rsp + nb333_dzO], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	movapd xmm4, [rsp + nb333_ixH1]
	movapd xmm5, [rsp + nb333_iyH1]
	movapd xmm6, [rsp + nb333_izH1]
	...
	;# store dr 
	movapd [rsp + nb333_dxH1], xmm4
	movapd [rsp + nb333_dyH1], xmm5
	movapd [rsp + nb333_dzH1], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	movapd xmm3, [rsp + nb333_ixH2]
	movapd xmm4, [rsp + nb333_iyH2]
	movapd xmm5, [rsp + nb333_izH2]
	...
	movapd xmm3, [rsp + nb333_iyM]
	movapd xmm4, [rsp + nb333_izM]
	subpd  xmm3, xmm1
	subpd  xmm4, xmm2
	movapd xmm2, [rsp + nb333_ixM]
	subpd  xmm2, xmm0	

	;# store dr 
	movapd [rsp + nb333_dxM], xmm2
	movapd [rsp + nb333_dyM], xmm3
	movapd [rsp + nb333_dzM], xmm4
	;# square it 
	mulpd xmm2,xmm2
	mulpd xmm3,xmm3
	mulpd xmm4,xmm4
	...
	mulpd xmm0, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm0, [rsp + nb333_half] ;# rinv 
	movapd  [rsp + nb333_rinvO], xmm0	;# rinvO in xmm0
	mulpd   xmm7, xmm0
	movapd  [rsp + nb333_rO], xmm7	;# r in xmm7 
	...
	mulpd xmm0, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm0, [rsp + nb333_half] ;# rinv 
	movapd [rsp + nb333_rinvH1], xmm0	;# rinvH1 
	mulpd  xmm6, xmm0
	movapd [rsp + nb333_rH1], xmm6	;# rH1 
	...
	mulpd xmm0, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm0, [rsp + nb333_half] ;# rinv 
	movapd [rsp + nb333_rinvH2], xmm0 ;# rinv 
	mulpd xmm5, xmm0
	movapd [rsp + nb333_rH2], xmm5 ;# r 
	...
	mulpd xmm0, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm0, [rsp + nb333_half] ;# rinv 
	movapd [rsp + nb333_rinvM], xmm0 ;# rinv 
	mulpd xmm4, xmm0
	movapd [rsp + nb333_rM], xmm4 ;# r 

	;# do O interactions 
	;# rO is still in xmm7 
	movapd xmm0, [rsp + nb333_rinvO]
	...
	mulpd  xmm7, [rsp + nb333_two]	;# two*Heps2 
	addpd  xmm7, xmm6
	addpd  xmm7, xmm5 ;# xmm7=FF 
	mulpd  xmm5, xmm1 ;# xmm5=eps*Fp 
	addpd  xmm5, xmm4 ;# xmm5=VV 

	movapd xmm4, [rsp + nb333_c6]
	...
	xorpd xmm4, xmm4
	subpd xmm4, xmm7
	movapd xmm0, [rsp + nb333_dxO]
	movapd xmm1, [rsp + nb333_dyO]
	movapd xmm2, [rsp + nb333_dzO]
	...
	;# update O forces 
	movapd xmm3, [rsp + nb333_fixO]
	movapd xmm4, [rsp + nb333_fiyO]
	movapd xmm7, [rsp + nb333_fizO]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb333_fixO], xmm3
	movapd [rsp + nb333_fiyO], xmm4
	movapd [rsp + nb333_fizO], xmm7
	;# update j forces with water O 
	movapd [rsp + nb333_fjx], xmm0
	movapd [rsp + nb333_fjy], xmm1
	movapd [rsp + nb333_fjz], xmm2

	;# Done with O interactions - now H1! 
	movapd xmm7, [rsp + nb333_rH1]
	mulpd xmm7, [rsp + nb333_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	mulpd  xmm3, xmm7 ;# fijC=FF*qq 
    	...
    	;# increment vcoul 
	xorpd  xmm4, xmm4
    	addpd  xmm5, [rsp + nb333_vctot]
	mulpd  xmm3, [rsp + nb333_rinvH1]
    	movapd [rsp + nb333_vctot], xmm5 
	mulpd  xmm3, [rsp + nb333_tsc]
	subpd xmm4, xmm3

	movapd xmm0, [rsp + nb333_dxH1]
	movapd xmm1, [rsp + nb333_dyH1]
	movapd xmm2, [rsp + nb333_dzH1]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4

	;# update H1 forces 
	movapd xmm3, [rsp + nb333_fixH1]
	movapd xmm4, [rsp + nb333_fiyH1]
	movapd xmm7, [rsp + nb333_fizH1]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb333_fixH1], xmm3
	movapd [rsp + nb333_fiyH1], xmm4
	movapd [rsp + nb333_fizH1], xmm7
	...
	xorpd  xmm4, xmm4
    	addpd  xmm5, [rsp + nb333_vctot]
	mulpd  xmm3, [rsp + nb333_rinvH2]
    	movapd [rsp + nb333_vctot], xmm5 
	mulpd  xmm3, [rsp + nb333_tsc]
	subpd  xmm4, xmm3

	movapd xmm0, [rsp + nb333_dxH2]
	movapd xmm1, [rsp + nb333_dyH2]
	movapd xmm2, [rsp + nb333_dzH2]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	;# update H2 forces 
	movapd xmm3, [rsp + nb333_fixH2]
	movapd xmm4, [rsp + nb333_fiyH2]
	movapd xmm7, [rsp + nb333_fizH2]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb333_fixH2], xmm3
	movapd [rsp + nb333_fiyH2], xmm4
	movapd [rsp + nb333_fizH2], xmm7
	;# update j forces with water H1 
	addpd  xmm0, [rsp + nb333_fjx]
	addpd  xmm1, [rsp + nb333_fjy]
	addpd  xmm2, [rsp + nb333_fjz]
	...
	xorpd  xmm4, xmm4
    	addpd  xmm5, [rsp + nb333_vctot]
	mulpd  xmm3, [rsp + nb333_rinvM]
    	movapd [rsp + nb333_vctot], xmm5 
	mulpd  xmm3, [rsp + nb333_tsc]
	subpd  xmm4, xmm3

	movapd xmm0, [rsp + nb333_dxM]
	movapd xmm1, [rsp + nb333_dyM]
	movapd xmm2, [rsp + nb333_dzM]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	;# update H2 forces 
	movapd xmm3, [rsp + nb333_fixM]
	movapd xmm4, [rsp + nb333_fiyM]
	movapd xmm7, [rsp + nb333_fizM]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb333_fixM], xmm3
	movapd [rsp + nb333_fiyM], xmm4
	movapd [rsp + nb333_fizM], xmm7
...
.nb333_dosingle:
	...
	mulsd   xmm0, [rsp + nb333_half] ;# iter1 ( new lu) 
	...
	mulsd xmm0, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulsd xmm0, [rsp + nb333_half] ;# rinv 
	movapd  [rsp + nb333_rinvO], xmm0	;# rinvO in xmm0 
	mulsd   xmm7, xmm0
	movapd  [rsp + nb333_rO], xmm7	;# r in xmm7 
	...
	mulsd  xmm7, [rsp + nb333_two]	;# two*Heps2 
	addsd  xmm7, xmm6
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [rsp + nb333_fixO], xmm3
	movlpd [rsp + nb333_fiyO], xmm4
	movlpd [rsp + nb333_fizO], xmm7
	;# update j forces with water O 
	movlpd [rsp + nb333_fjx], xmm0
	movlpd [rsp + nb333_fjy], xmm1
	movlpd [rsp + nb333_fjz], xmm2
    ...
    ;# increment vcoul 
	xorpd  xmm4, xmm4
    addsd  xmm5, [rsp + nb333_vctot]
	mulsd  xmm3, [rsp + nb333_rinvH1]
    movlpd [rsp + nb333_vctot], xmm5 
	mulsd  xmm3, [rsp + nb333_tsc]
	subsd xmm4, xmm3
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [rsp + nb333_fixH1], xmm3
	movlpd [rsp + nb333_fiyH1], xmm4
	movlpd [rsp + nb333_fizH1], xmm7
	;# update j forces with water H1 
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [rsp + nb333_fixH2], xmm3
	movlpd [rsp + nb333_fiyH2], xmm4
	movlpd [rsp + nb333_fizH2], xmm7
	;# update j forces with water H1 
	addsd  xmm0, [rsp + nb333_fjx]
	addsd  xmm1, [rsp + nb333_fjy]
	addsd  xmm2, [rsp + nb333_fjz]
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [rsp + nb333_fixM], xmm3
	movlpd [rsp + nb333_fiyM], xmm4
	movlpd [rsp + nb333_fizM], xmm7
