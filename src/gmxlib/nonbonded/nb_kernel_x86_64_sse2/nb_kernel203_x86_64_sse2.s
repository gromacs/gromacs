...
.nb203_unroll_loop:
	...
	movapd xmm4, [rsp + nb203_ixM]
	movapd xmm5, [rsp + nb203_iyM]
	movapd xmm6, [rsp + nb203_izM]
	...
	movapd xmm4, [rsp + nb203_ixH1]
	movapd xmm5, [rsp + nb203_iyH1]
	movapd xmm6, [rsp + nb203_izH1]
	...
	movapd xmm3, [rsp + nb203_ixH2]
	movapd xmm4, [rsp + nb203_iyH2]
	movapd xmm5, [rsp + nb203_izH2]
	...
	mulpd  xmm0, [rsp + nb203_krf]	
	mulpd  xmm1, [rsp + nb203_krf]	
	mulpd  xmm2, [rsp + nb203_krf]	
	...
	mulpd   xmm4, [rsp + nb203_half] ;# iter1 ( new lu) 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [rsp + nb203_half] ;# rinv 
	...
	mulpd   xmm0, [rsp + nb203_two]
	subpd   xmm7, [rsp + nb203_crf]
	subpd   xmm3, xmm0	;# xmm7=rinv-2*krsq 
	mulpd   xmm7, [rsp + nb203_qqM] ;# vcoul 
	mulpd   xmm3, [rsp + nb203_qqM]
	mulpd  xmm4, xmm3	;# total fsH1 in xmm4 
	
	addpd  xmm7, [rsp + nb203_vctot]

	movapd xmm0, [rsp + nb203_dxM]
	movapd xmm1, [rsp + nb203_dyM]
	movapd xmm2, [rsp + nb203_dzM]
	movapd [rsp + nb203_vctot], xmm7
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb203_fixM], xmm3
	movapd [rsp + nb203_fiyM], xmm4
	movapd [rsp + nb203_fizM], xmm7
	;# update j forces with water M 
	movapd [rsp + nb203_fjx], xmm0
	movapd [rsp + nb203_fjy], xmm1
	movapd [rsp + nb203_fjz], xmm2
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb203_fixH1], xmm3
	movapd [rsp + nb203_fiyH1], xmm4
	movapd [rsp + nb203_fizH1], xmm7
	;# update j forces with water H1 
	addpd  xmm0, [rsp + nb203_fjx]
	addpd  xmm1, [rsp + nb203_fjy]
	addpd  xmm2, [rsp + nb203_fjz]
	movapd [rsp + nb203_fjx], xmm0
	movapd [rsp + nb203_fjy], xmm1
	movapd [rsp + nb203_fjz], xmm2
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb203_fixH2], xmm3
	movapd [rsp + nb203_fiyH2], xmm4
	movapd [rsp + nb203_fizH2], xmm7
