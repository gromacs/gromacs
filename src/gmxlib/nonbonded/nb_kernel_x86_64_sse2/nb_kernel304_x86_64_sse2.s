...
.nb304_unroll_loop:	
	...
	movapd 	[rsp + nb304_jxH1], xmm2
	movapd 	[rsp + nb304_jyH1], xmm3
	movapd 	[rsp + nb304_jzH1], xmm4
	movapd 	[rsp + nb304_jxH2], xmm5
	movapd 	[rsp + nb304_jyH2], xmm6
	movapd 	[rsp + nb304_jzH2], xmm7
	...
	movapd 	[rsp + nb304_jxM], xmm2
	movapd 	[rsp + nb304_jyM], xmm3
	movapd 	[rsp + nb304_jzM], xmm4
	
	movapd xmm0, [rsp + nb304_ixM]
	movapd xmm1, [rsp + nb304_iyM]
	movapd xmm2, [rsp + nb304_izM]
	movapd xmm3, [rsp + nb304_ixM]
	movapd xmm4, [rsp + nb304_iyM]
	movapd xmm5, [rsp + nb304_izM]
	subpd  xmm0, [rsp + nb304_jxM]
	subpd  xmm1, [rsp + nb304_jyM]
	subpd  xmm2, [rsp + nb304_jzM]
	subpd  xmm3, [rsp + nb304_jxH1]
	subpd  xmm4, [rsp + nb304_jyH1]
	subpd  xmm5, [rsp + nb304_jzH1]
	movapd [rsp + nb304_dxMM], xmm0
	movapd [rsp + nb304_dyMM], xmm1
	movapd [rsp + nb304_dzMM], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb304_dxMH1], xmm3
	movapd [rsp + nb304_dyMH1], xmm4
	movapd [rsp + nb304_dzMH1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb304_rsqMM], xmm0
	movapd [rsp + nb304_rsqMH1], xmm3

	movapd xmm0, [rsp + nb304_ixM]
	movapd xmm1, [rsp + nb304_iyM]
	movapd xmm2, [rsp + nb304_izM]
	movapd xmm3, [rsp + nb304_ixH1]
	movapd xmm4, [rsp + nb304_iyH1]
	movapd xmm5, [rsp + nb304_izH1]
	subpd  xmm0, [rsp + nb304_jxH2]
	subpd  xmm1, [rsp + nb304_jyH2]
	subpd  xmm2, [rsp + nb304_jzH2]
	subpd  xmm3, [rsp + nb304_jxM]
	subpd  xmm4, [rsp + nb304_jyM]
	subpd  xmm5, [rsp + nb304_jzM]
	movapd [rsp + nb304_dxMH2], xmm0
	movapd [rsp + nb304_dyMH2], xmm1
	movapd [rsp + nb304_dzMH2], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb304_dxH1M], xmm3
	movapd [rsp + nb304_dyH1M], xmm4
	movapd [rsp + nb304_dzH1M], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb304_rsqMH2], xmm0
	movapd [rsp + nb304_rsqH1M], xmm3

	movapd xmm0, [rsp + nb304_ixH1]
	movapd xmm1, [rsp + nb304_iyH1]
	movapd xmm2, [rsp + nb304_izH1]
	movapd xmm3, [rsp + nb304_ixH1]
	movapd xmm4, [rsp + nb304_iyH1]
	movapd xmm5, [rsp + nb304_izH1]
	subpd  xmm0, [rsp + nb304_jxH1]
	subpd  xmm1, [rsp + nb304_jyH1]
	subpd  xmm2, [rsp + nb304_jzH1]
	subpd  xmm3, [rsp + nb304_jxH2]
	subpd  xmm4, [rsp + nb304_jyH2]
	subpd  xmm5, [rsp + nb304_jzH2]
	...
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb304_dxH1H2], xmm3
	movapd [rsp + nb304_dyH1H2], xmm4
	movapd [rsp + nb304_dzH1H2], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb304_rsqH1H1], xmm0
	movapd [rsp + nb304_rsqH1H2], xmm3

	movapd xmm0, [rsp + nb304_ixH2]
	movapd xmm1, [rsp + nb304_iyH2]
	movapd xmm2, [rsp + nb304_izH2]
	movapd xmm3, [rsp + nb304_ixH2]
	movapd xmm4, [rsp + nb304_iyH2]
	movapd xmm5, [rsp + nb304_izH2]
	subpd  xmm0, [rsp + nb304_jxM]
	subpd  xmm1, [rsp + nb304_jyM]
	subpd  xmm2, [rsp + nb304_jzM]
	subpd  xmm3, [rsp + nb304_jxH1]
	subpd  xmm4, [rsp + nb304_jyH1]
	subpd  xmm5, [rsp + nb304_jzH1]
	movapd [rsp + nb304_dxH2M], xmm0
	movapd [rsp + nb304_dyH2M], xmm1
	movapd [rsp + nb304_dzH2M], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb304_rsqH2M], xmm0
	movapd [rsp + nb304_rsqH2H1], xmm4
	...
	subpd  xmm1, [rsp + nb304_jyH2]
	subpd  xmm2, [rsp + nb304_jzH2]
	movapd [rsp + nb304_dxH2H2], xmm0
	movapd [rsp + nb304_dyH2H2], xmm1
	movapd [rsp + nb304_dzH2H2], xmm2
	mulpd xmm0, xmm0
	mulpd xmm1, xmm1
	mulpd xmm2, xmm2
	addpd xmm0, xmm1
	addpd xmm0, xmm2
	movapd [rsp + nb304_rsqH2H2], xmm0
	...
	mulpd   xmm3, [rsp + nb304_half] ;# iter1 
	mulpd   xmm7, [rsp + nb304_half] ;# iter1 
	...
	mulpd   xmm1, [rsp + nb304_half] ;# rinv 
	mulpd   xmm5, [rsp + nb304_half] ;# rinv 
	movapd [rsp + nb304_rinvH2H2], xmm1
	movapd [rsp + nb304_rinvH2H1], xmm5

	movapd xmm0, [rsp + nb304_rsqMM]
	movapd xmm4, [rsp + nb304_rsqMH1]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb304_half] ;# iter1 of  
	mulpd   xmm7, [rsp + nb304_half] ;# iter1 of  
	...
	mulpd   xmm1, [rsp + nb304_half] ;# rinv 
	mulpd   xmm5, [rsp + nb304_half] ;# rinv
	movapd [rsp + nb304_rinvMM], xmm1
	movapd [rsp + nb304_rinvMH1], xmm5

	movapd xmm0, [rsp + nb304_rsqMH2]
	movapd xmm4, [rsp + nb304_rsqH1M]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb304_half] ;# rinv 
	mulpd   xmm5, [rsp + nb304_half] ;# rinv 
	movapd [rsp + nb304_rinvMH2], xmm1
	movapd [rsp + nb304_rinvH1M], xmm5

	movapd xmm0, [rsp + nb304_rsqH1H1]
	movapd xmm4, [rsp + nb304_rsqH1H2]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb304_half] ;# iter1a 
	mulpd   xmm7, [rsp + nb304_half] ;# iter1b 
	...
	mulpd   xmm1, [rsp + nb304_half] ;# rinv 
	mulpd   xmm5, [rsp + nb304_half] ;# rinv 
	movapd [rsp + nb304_rinvH1H1], xmm1
	movapd [rsp + nb304_rinvH1H2], xmm5

	movapd xmm0, [rsp + nb304_rsqH2M]
	cvtpd2ps xmm1, xmm0	
	rsqrtps xmm1, xmm1
	cvtps2pd xmm1, xmm1
	...
	mulpd   xmm1, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm1, [rsp + nb304_half] ;# rinv 
	movapd [rsp + nb304_rinvH2M], xmm1
	
	;# start with MM interaction 
	movapd xmm0, [rsp + nb304_rinvMM]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqMM] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]
	...
	mulpd  xmm7, [rsp + nb304_two]	;# two*Heps2 
	movapd xmm3, [rsp + nb304_qqMM]
	addpd  xmm7, xmm6
    ...
    ;# update vctot 
    addpd  xmm5, [rsp + nb304_vctot]
	xorpd  xmm2, xmm2
    movapd [rsp + nb304_vctot], xmm5
	mulpd  xmm3, [rsp + nb304_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb304_dxMM]
	mulpd xmm1, [rsp + nb304_dyMM]
	mulpd xmm2, [rsp + nb304_dzMM]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixM]
	addpd xmm1, [rsp + nb304_fiyM]
	addpd xmm2, [rsp + nb304_fizM]
	movapd [rsp + nb304_fjxM], xmm3
	movapd [rsp + nb304_fjyM], xmm4
	movapd [rsp + nb304_fjzM], xmm5
	movapd [rsp + nb304_fixM], xmm0
	movapd [rsp + nb304_fiyM], xmm1
	movapd [rsp + nb304_fizM], xmm2

	;# M-H1 interaction 
	movapd xmm0, [rsp + nb304_rinvMH1]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqMH1] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb304_dxMH1]
	mulpd xmm1, [rsp + nb304_dyMH1]
	mulpd xmm2, [rsp + nb304_dzMH1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixM]
	addpd xmm1, [rsp + nb304_fiyM]
	addpd xmm2, [rsp + nb304_fizM]
	movapd [rsp + nb304_fjxH1], xmm3
	movapd [rsp + nb304_fjyH1], xmm4
	movapd [rsp + nb304_fjzH1], xmm5
	movapd [rsp + nb304_fixM], xmm0
	movapd [rsp + nb304_fiyM], xmm1
	movapd [rsp + nb304_fizM], xmm2

	;# M-H2 interaction  
	movapd xmm0, [rsp + nb304_rinvMH2]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqMH2] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb304_dxMH2]
	mulpd xmm1, [rsp + nb304_dyMH2]
	mulpd xmm2, [rsp + nb304_dzMH2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixM]
	addpd xmm1, [rsp + nb304_fiyM]
	addpd xmm2, [rsp + nb304_fizM]
	movapd [rsp + nb304_fjxH2], xmm3
	movapd [rsp + nb304_fjyH2], xmm4
	movapd [rsp + nb304_fjzH2], xmm5
	movapd [rsp + nb304_fixM], xmm0
	movapd [rsp + nb304_fiyM], xmm1
	movapd [rsp + nb304_fizM], xmm2

	;# H1-M interaction 
	movapd xmm0, [rsp + nb304_rinvH1M]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqH1M] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]
	...
	movapd xmm3, [rsp + nb304_fjxM]
	movapd xmm4, [rsp + nb304_fjyM]
	movapd xmm5, [rsp + nb304_fjzM]
	mulpd xmm0, [rsp + nb304_dxH1M]
	mulpd xmm1, [rsp + nb304_dyH1M]
	mulpd xmm2, [rsp + nb304_dzH1M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixH1]
	addpd xmm1, [rsp + nb304_fiyH1]
	addpd xmm2, [rsp + nb304_fizH1]
	movapd [rsp + nb304_fjxM], xmm3
	movapd [rsp + nb304_fjyM], xmm4
	movapd [rsp + nb304_fjzM], xmm5
	movapd [rsp + nb304_fixH1], xmm0
	movapd [rsp + nb304_fiyH1], xmm1
	movapd [rsp + nb304_fizH1], xmm2

	;# H1-H1 interaction 
	movapd xmm0, [rsp + nb304_rinvH1H1]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqH1H1] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]	
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm3, [rsp + nb304_fjxH1]
	movapd xmm4, [rsp + nb304_fjyH1]
	movapd xmm5, [rsp + nb304_fjzH1]
	mulpd xmm0, [rsp + nb304_dxH1H1]
	mulpd xmm1, [rsp + nb304_dyH1H1]
	mulpd xmm2, [rsp + nb304_dzH1H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixH1]
	...
	;# H1-H2 interaction 
	movapd xmm0, [rsp + nb304_rinvH1H2]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqH1H2] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm3, [rsp + nb304_fjxH2]
	movapd xmm4, [rsp + nb304_fjyH2]
	movapd xmm5, [rsp + nb304_fjzH2]
	mulpd xmm0, [rsp + nb304_dxH1H2]
	mulpd xmm1, [rsp + nb304_dyH1H2]
	mulpd xmm2, [rsp + nb304_dzH1H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixH1]
	...
	;# H2-M interaction 
	movapd xmm0, [rsp + nb304_rinvH2M]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqH2M] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]	
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb304_fjyM]
	movapd xmm5, [rsp + nb304_fjzM]
	mulpd xmm0, [rsp + nb304_dxH2M]
	mulpd xmm1, [rsp + nb304_dyH2M]
	mulpd xmm2, [rsp + nb304_dzH2M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixH2]
	addpd xmm1, [rsp + nb304_fiyH2]
	addpd xmm2, [rsp + nb304_fizH2]
	movapd [rsp + nb304_fjxM], xmm3
	movapd [rsp + nb304_fjyM], xmm4
	movapd [rsp + nb304_fjzM], xmm5
	movapd [rsp + nb304_fixH2], xmm0
	movapd [rsp + nb304_fiyH2], xmm1
	movapd [rsp + nb304_fizH2], xmm2

	;# H2-H1 interaction 
	movapd xmm0, [rsp + nb304_rinvH2H1]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqH2H1] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb304_fjyH1]
	movapd xmm5, [rsp + nb304_fjzH1]
	mulpd xmm0, [rsp + nb304_dxH2H1]
	mulpd xmm1, [rsp + nb304_dyH2H1]
	mulpd xmm2, [rsp + nb304_dzH2H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixH2]
	...
	;# H2-H2 interaction 
	movapd xmm0, [rsp + nb304_rinvH2H2]
	movapd xmm1, xmm0
	mulpd  xmm1, [rsp + nb304_rsqH2H2] ;# xmm1=r 
	mulpd  xmm1, [rsp + nb304_tsc]	
	cvttpd2pi mm6, xmm1	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb304_fjyH2]
	movapd xmm5, [rsp + nb304_fjzH2]
	mulpd xmm0, [rsp + nb304_dxH2H2]
	mulpd xmm1, [rsp + nb304_dyH2H2]
	mulpd xmm2, [rsp + nb304_dzH2H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb304_fixH2]
	...
	addpd xmm0, [rsp + nb304_fjxH1]
	addpd xmm1, [rsp + nb304_fjyH1]
	addpd xmm2, [rsp + nb304_fjzH1]
	addpd xmm3, [rsp + nb304_fjxH2]
	addpd xmm4, [rsp + nb304_fjyH2]
	addpd xmm5, [rsp + nb304_fjzH2]
	addpd xmm6, [rsp + nb304_fjxM]
	addpd xmm7, [rsp + nb304_fjyM]
...
.nb304_dosingle:
	...
	movapd xmm4, [rsp + nb304_iyM]
	movapd xmm5, [rsp + nb304_izM]
	subsd  xmm0, [rsp + nb304_jxM]
	subsd  xmm1, [rsp + nb304_jyM]
	subsd  xmm2, [rsp + nb304_jzM]
	subsd  xmm3, [rsp + nb304_jxH1]
	subsd  xmm4, [rsp + nb304_jyH1]
	subsd  xmm5, [rsp + nb304_jzH1]
	movapd [rsp + nb304_dxMM], xmm0
	movapd [rsp + nb304_dyMM], xmm1
	movapd [rsp + nb304_dzMM], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb304_iyH1]
	movapd xmm5, [rsp + nb304_izH1]
	subsd  xmm0, [rsp + nb304_jxH2]
	subsd  xmm1, [rsp + nb304_jyH2]
	subsd  xmm2, [rsp + nb304_jzH2]
	subsd  xmm3, [rsp + nb304_jxM]
	subsd  xmm4, [rsp + nb304_jyM]
	subsd  xmm5, [rsp + nb304_jzM]
	movapd [rsp + nb304_dxMH2], xmm0
	movapd [rsp + nb304_dyMH2], xmm1
	movapd [rsp + nb304_dzMH2], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb304_iyH1]
	movapd xmm5, [rsp + nb304_izH1]
	subsd  xmm0, [rsp + nb304_jxH1]
	subsd  xmm1, [rsp + nb304_jyH1]
	subsd  xmm2, [rsp + nb304_jzH1]
	subsd  xmm3, [rsp + nb304_jxH2]
	subsd  xmm4, [rsp + nb304_jyH2]
	subsd  xmm5, [rsp + nb304_jzH2]
	movapd [rsp + nb304_dxH1H1], xmm0
	movapd [rsp + nb304_dyH1H1], xmm1
	movapd [rsp + nb304_dzH1H1], xmm2
	mulsd  xmm0, xmm0
	...
	mulsd   xmm3, [rsp + nb304_half] ;# iter1 
	mulsd   xmm7, [rsp + nb304_half] ;# iter1 
	...
	mulsd   xmm1, [rsp + nb304_half] ;# rinv 
	mulsd   xmm5, [rsp + nb304_half] ;# rinv 
	movapd [rsp + nb304_rinvH2H2], xmm1
	movapd [rsp + nb304_rinvH2H1], xmm5
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb304_half] ;# iter1 of  
	mulsd   xmm7, [rsp + nb304_half] ;# iter1 of  
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb304_half] ;# iter1a 
	mulsd   xmm7, [rsp + nb304_half] ;# iter1b 
	...
	movapd xmm0, [rsp + nb304_rinvMM]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqMM] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]
	...
	mulsd  xmm7, [rsp + nb304_two]	;# two*Heps2 
	movapd xmm3, [rsp + nb304_qqMM]
	addsd  xmm7, xmm6
    ...
    ;# increment vcoul - then we can get rid of mm5 
    ;# update vctot 
    addsd  xmm5, [rsp + nb304_vctot]
	xorpd  xmm2, xmm2
    movlpd [rsp + nb304_vctot], xmm5
	mulsd  xmm3, [rsp + nb304_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb304_dxMM]
	mulsd xmm1, [rsp + nb304_dyMM]
	mulsd xmm2, [rsp + nb304_dzMM]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixM]
	addsd xmm1, [rsp + nb304_fiyM]
	addsd xmm2, [rsp + nb304_fizM]
	movlpd [rsp + nb304_fjxM], xmm3
	movlpd [rsp + nb304_fjyM], xmm4
	movlpd [rsp + nb304_fjzM], xmm5
	movlpd [rsp + nb304_fixM], xmm0
	movlpd [rsp + nb304_fiyM], xmm1
	movlpd [rsp + nb304_fizM], xmm2

	;# M-H1 interaction 
	movapd xmm0, [rsp + nb304_rinvMH1]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqMH1] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb304_dxMH1]
	mulsd xmm1, [rsp + nb304_dyMH1]
	mulsd xmm2, [rsp + nb304_dzMH1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixM]
	addsd xmm1, [rsp + nb304_fiyM]
	addsd xmm2, [rsp + nb304_fizM]
	movlpd [rsp + nb304_fjxH1], xmm3
	movlpd [rsp + nb304_fjyH1], xmm4
	movlpd [rsp + nb304_fjzH1], xmm5
	movlpd [rsp + nb304_fixM], xmm0
	movlpd [rsp + nb304_fiyM], xmm1
	movlpd [rsp + nb304_fizM], xmm2
	...
	movapd xmm0, [rsp + nb304_rinvMH2]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqMH2] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb304_dxMH2]
	mulsd xmm1, [rsp + nb304_dyMH2]
	mulsd xmm2, [rsp + nb304_dzMH2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixM]
	addsd xmm1, [rsp + nb304_fiyM]
	addsd xmm2, [rsp + nb304_fizM]
	movlpd [rsp + nb304_fjxH2], xmm3
	movlpd [rsp + nb304_fjyH2], xmm4
	movlpd [rsp + nb304_fjzH2], xmm5
	movlpd [rsp + nb304_fixM], xmm0
	movlpd [rsp + nb304_fiyM], xmm1
	movlpd [rsp + nb304_fizM], xmm2
	...
	movapd xmm0, [rsp + nb304_rinvH1M]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqH1M] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]
	...
	movapd xmm4, [rsp + nb304_fjyM]
	movapd xmm5, [rsp + nb304_fjzM]
	mulsd xmm0, [rsp + nb304_dxH1M]
	mulsd xmm1, [rsp + nb304_dyH1M]
	mulsd xmm2, [rsp + nb304_dzH1M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixH1]
	addsd xmm1, [rsp + nb304_fiyH1]
	addsd xmm2, [rsp + nb304_fizH1]
	movlpd [rsp + nb304_fjxM], xmm3
	movlpd [rsp + nb304_fjyM], xmm4
	movlpd [rsp + nb304_fjzM], xmm5
	movlpd [rsp + nb304_fixH1], xmm0
	movlpd [rsp + nb304_fiyH1], xmm1
	movlpd [rsp + nb304_fizH1], xmm2

	;# H1-H1 interaction 
	movapd xmm0, [rsp + nb304_rinvH1H1]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqH1H1] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]	
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb304_fjyH1]
	movapd xmm5, [rsp + nb304_fjzH1]
	mulsd xmm0, [rsp + nb304_dxH1H1]
	mulsd xmm1, [rsp + nb304_dyH1H1]
	mulsd xmm2, [rsp + nb304_dzH1H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixH1]
	...
	movapd xmm0, [rsp + nb304_rinvH1H2]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqH1H2] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb304_fjyH2]
	movapd xmm5, [rsp + nb304_fjzH2]
	mulsd xmm0, [rsp + nb304_dxH1H2]
	mulsd xmm1, [rsp + nb304_dyH1H2]
	mulsd xmm2, [rsp + nb304_dzH1H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixH1]
	...
	movapd xmm0, [rsp + nb304_rinvH2M]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqH2M] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]	
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb304_fjyM]
	movapd xmm5, [rsp + nb304_fjzM]
	mulsd xmm0, [rsp + nb304_dxH2M]
	mulsd xmm1, [rsp + nb304_dyH2M]
	mulsd xmm2, [rsp + nb304_dzH2M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixH2]
	addsd xmm1, [rsp + nb304_fiyH2]
	addsd xmm2, [rsp + nb304_fizH2]
	movlpd [rsp + nb304_fjxM], xmm3
	movlpd [rsp + nb304_fjyM], xmm4
	movlpd [rsp + nb304_fjzM], xmm5
	movlpd [rsp + nb304_fixH2], xmm0
	movlpd [rsp + nb304_fiyH2], xmm1
	movlpd [rsp + nb304_fizH2], xmm2

	;# H2-H1 interaction 
	movapd xmm0, [rsp + nb304_rinvH2H1]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqH2H1] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subpd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb304_fjyH1]
	movapd xmm5, [rsp + nb304_fjzH1]
	mulsd xmm0, [rsp + nb304_dxH2H1]
	mulsd xmm1, [rsp + nb304_dyH2H1]
	mulsd xmm2, [rsp + nb304_dzH2H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixH2]
	...
	movapd xmm0, [rsp + nb304_rinvH2H2]
	movapd xmm1, xmm0
	mulsd  xmm1, [rsp + nb304_rsqH2H2] ;# xmm1=r 
	mulsd  xmm1, [rsp + nb304_tsc]	
	cvttsd2si eax, xmm1	;# mm6 = lu idx 
	cvtsi2sd xmm6, eax
	subsd xmm1, xmm6	;# xmm1=eps 
	...
	movapd xmm4, [rsp + nb304_fjyH2]
	movapd xmm5, [rsp + nb304_fjzH2]
	mulsd xmm0, [rsp + nb304_dxH2H2]
	mulsd xmm1, [rsp + nb304_dyH2H2]
	mulsd xmm2, [rsp + nb304_dzH2H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb304_fixH2]
	...
	movlpd xmm6, [rdi + rax*8 + 72]
	movlpd xmm7, [rdi + rax*8 + 80]
	addsd xmm0, [rsp + nb304_fjxH1]
	addsd xmm1, [rsp + nb304_fjyH1]
	addsd xmm2, [rsp + nb304_fjzH1]
	addsd xmm3, [rsp + nb304_fjxH2]
	addsd xmm4, [rsp + nb304_fjyH2]
	addsd xmm5, [rsp + nb304_fjzH2]
	addsd xmm6, [rsp + nb304_fjxM]
	addsd xmm7, [rsp + nb304_fjyM]
	movlpd [rdi + rax*8 + 24], xmm0
	movlpd [rdi + rax*8 + 32], xmm1
	movlpd [rdi + rax*8 + 40], xmm2
	movlpd [rdi + rax*8 + 48], xmm3
