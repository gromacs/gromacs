...
.nb113_unroll_loop:
	...
	movd  eax, mm0
	movd  ebx, mm1
	movapd [rsp + nb113_c6], xmm4
	movapd [rsp + nb113_c12], xmm6
	...
	movapd xmm4, [rsp + nb113_ixO]
	movapd xmm5, [rsp + nb113_iyO]
	movapd xmm6, [rsp + nb113_izO]
	...
	movapd xmm4, [rsp + nb113_ixH1]
	movapd xmm5, [rsp + nb113_iyH1]
	movapd xmm6, [rsp + nb113_izH1]
	...
	movapd xmm3, [rsp + nb113_ixH2]
	movapd xmm4, [rsp + nb113_iyH2]
	movapd xmm5, [rsp + nb113_izH2]
	...
	movapd xmm3, [rsp + nb113_iyM]
	movapd xmm4, [rsp + nb113_izM]
	subpd  xmm3, xmm1
	subpd  xmm4, xmm2
	movapd xmm2, [rsp + nb113_ixM]
	subpd  xmm2, xmm0	

	;# store dr 
	movapd [rsp + nb113_dxM], xmm2
	movapd [rsp + nb113_dyM], xmm3
	movapd [rsp + nb113_dzM], xmm4
	;# square it 
	mulpd xmm2,xmm2
	mulpd xmm3,xmm3
	mulpd xmm4,xmm4
	...
	mulpd   xmm1, [rsp + nb113_half] ;# iter1 ( new lu) 
	...
	mulpd xmm1, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm1, [rsp + nb113_half] ;# rinv 
	...
	mulpd  xmm1, [rsp + nb113_c6]
	mulpd  xmm2, [rsp + nb113_c12]
	movapd xmm3, xmm2
	subpd  xmm3, xmm1	;# Vvdw=Vvdw12-Vvdw6 		
	addpd  xmm3, [rsp + nb113_Vvdwtot]
	mulpd  xmm1, [rsp + nb113_six]
	mulpd  xmm2, [rsp + nb113_twelve]
	subpd  xmm2, xmm1
	mulpd  xmm2, xmm0
	movapd xmm4, xmm2 ;# total fsO 
	movapd [rsp + nb113_Vvdwtot], xmm3
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb113_fixO], xmm3
	movapd [rsp + nb113_fiyO], xmm4
	movapd [rsp + nb113_fizO], xmm7
	;# update j forces with water O 
	movapd [rsp + nb113_fjx], xmm0
	movapd [rsp + nb113_fjy], xmm1
	movapd [rsp + nb113_fjz], xmm2

	;# H1 interactions
	movapd  xmm6, [rsp + nb113_rinvH1] 
	movapd  xmm4, xmm6	
	mulpd   xmm4, xmm4	;# xmm6=rinv, xmm4=rinvsq 
	mulpd  xmm6, [rsp + nb113_qqH]	;# xmm6=vcoul 
	mulpd  xmm4, xmm6		;# total fsH1 in xmm4 
	
	addpd  xmm6, [rsp + nb113_vctot]

	movapd xmm0, [rsp + nb113_dxH1]
	movapd xmm1, [rsp + nb113_dyH1]
	movapd xmm2, [rsp + nb113_dzH1]
	movapd [rsp + nb113_vctot], xmm6
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb113_fixH1], xmm3
	movapd [rsp + nb113_fiyH1], xmm4
	movapd [rsp + nb113_fizH1], xmm7
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb113_fixH2], xmm3
	movapd [rsp + nb113_fiyH2], xmm4
	movapd [rsp + nb113_fizH2], xmm7
	...
	movapd  xmm4, xmm5	
	mulpd   xmm4, xmm4	;# xmm5=rinv, xmm4=rinvsq 
	mulpd  xmm5, [rsp + nb113_qqM]	;# xmm5=vcoul 
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb113_fixM], xmm3
	movapd [rsp + nb113_fiyM], xmm4
	movapd [rsp + nb113_fizM], xmm7
