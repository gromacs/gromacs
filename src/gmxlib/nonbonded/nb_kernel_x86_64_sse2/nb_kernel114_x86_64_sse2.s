...
.nb114_unroll_loop:
	...
	movapd 	[rsp + nb114_jxO], xmm0
	movapd 	[rsp + nb114_jyO], xmm1
	movapd 	[rsp + nb114_jzO], xmm3
	movapd 	[rsp + nb114_jxH1], xmm4
	...
	movapd 	[rsp + nb114_jyH1], xmm0
	movapd 	[rsp + nb114_jzH1], xmm1
	movapd 	[rsp + nb114_jxH2], xmm3
	movapd 	[rsp + nb114_jyH2], xmm4
	...
	movapd 	[rsp + nb114_jzH2], xmm0
	movapd 	[rsp + nb114_jxM], xmm1
	movapd 	[rsp + nb114_jyM], xmm3
	movapd 	[rsp + nb114_jzM], xmm4
	
	;# start calculating pairwise distances
	movapd xmm0, [rsp + nb114_ixO]
	movapd xmm1, [rsp + nb114_iyO]
	movapd xmm2, [rsp + nb114_izO]
	movapd xmm3, [rsp + nb114_ixH1]
	movapd xmm4, [rsp + nb114_iyH1]
	movapd xmm5, [rsp + nb114_izH1]
	subpd  xmm0, [rsp + nb114_jxO]
	subpd  xmm1, [rsp + nb114_jyO]
	subpd  xmm2, [rsp + nb114_jzO]
	subpd  xmm3, [rsp + nb114_jxH1]
	subpd  xmm4, [rsp + nb114_jyH1]
	subpd  xmm5, [rsp + nb114_jzH1]
	movapd [rsp + nb114_dxOO], xmm0
	movapd [rsp + nb114_dyOO], xmm1
	movapd [rsp + nb114_dzOO], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb114_dxH1H1], xmm3
	movapd [rsp + nb114_dyH1H1], xmm4
	movapd [rsp + nb114_dzH1H1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb114_rsqOO], xmm0
	movapd [rsp + nb114_rsqH1H1], xmm3

	movapd xmm0, [rsp + nb114_ixH1]
	movapd xmm1, [rsp + nb114_iyH1]
	movapd xmm2, [rsp + nb114_izH1]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb114_jxH2]
	subpd  xmm1, [rsp + nb114_jyH2]
	subpd  xmm2, [rsp + nb114_jzH2]
	subpd  xmm3, [rsp + nb114_jxM]
	subpd  xmm4, [rsp + nb114_jyM]
	subpd  xmm5, [rsp + nb114_jzM]
	...
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb114_dxH1M], xmm3
	movapd [rsp + nb114_dyH1M], xmm4
	movapd [rsp + nb114_dzH1M], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb114_rsqH1H2], xmm0
	movapd [rsp + nb114_rsqH1M], xmm3

	movapd xmm0, [rsp + nb114_ixH2]
	movapd xmm1, [rsp + nb114_iyH2]
	movapd xmm2, [rsp + nb114_izH2]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb114_jxH1]
	subpd  xmm1, [rsp + nb114_jyH1]
	subpd  xmm2, [rsp + nb114_jzH1]
	subpd  xmm3, [rsp + nb114_jxH2]
	subpd  xmm4, [rsp + nb114_jyH2]
	subpd  xmm5, [rsp + nb114_jzH2]
	movapd [rsp + nb114_dxH2H1], xmm0
	movapd [rsp + nb114_dyH2H1], xmm1
	movapd [rsp + nb114_dzH2H1], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb114_rsqH2H1], xmm0
	movapd [rsp + nb114_rsqH2H2], xmm3

	movapd xmm0, [rsp + nb114_ixH2]
	movapd xmm1, [rsp + nb114_iyH2]
	movapd xmm2, [rsp + nb114_izH2]
	movapd xmm3, [rsp + nb114_ixM]
	movapd xmm4, [rsp + nb114_iyM]
	movapd xmm5, [rsp + nb114_izM]
	subpd  xmm0, [rsp + nb114_jxM]
	subpd  xmm1, [rsp + nb114_jyM]
	subpd  xmm2, [rsp + nb114_jzM]
	subpd  xmm3, [rsp + nb114_jxH1]
	subpd  xmm4, [rsp + nb114_jyH1]
	subpd  xmm5, [rsp + nb114_jzH1]
	movapd [rsp + nb114_dxH2M], xmm0
	movapd [rsp + nb114_dyH2M], xmm1
	movapd [rsp + nb114_dzH2M], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb114_dxMH1], xmm3
	movapd [rsp + nb114_dyMH1], xmm4
	movapd [rsp + nb114_dzMH1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb114_rsqH2M], xmm0
	movapd [rsp + nb114_rsqMH1], xmm4

	movapd xmm0, [rsp + nb114_ixM]
	movapd xmm1, [rsp + nb114_iyM]
	movapd xmm2, [rsp + nb114_izM]
	movapd xmm3, xmm0
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subpd  xmm0, [rsp + nb114_jxH2]
	...
	subpd  xmm4, [rsp + nb114_jyM]
	subpd  xmm5, [rsp + nb114_jzM]
	movapd [rsp + nb114_dxMH2], xmm0
	movapd [rsp + nb114_dyMH2], xmm1
	movapd [rsp + nb114_dzMH2], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb114_dxMM], xmm3
	movapd [rsp + nb114_dyMM], xmm4
	movapd [rsp + nb114_dzMM], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb114_rsqMH2], xmm0
	movapd [rsp + nb114_rsqMM], xmm4
	...
	mulpd   xmm3, [rsp + nb114_half] ;# iter1 
	mulpd   xmm7, [rsp + nb114_half] ;# iter1 
	...
	mulpd   xmm1, [rsp + nb114_half] ;# rinv 
	mulpd   xmm5, [rsp + nb114_half] ;# rinv 
	movapd [rsp + nb114_rinvMH2], xmm1
	movapd [rsp + nb114_rinvMM], xmm5

	movapd xmm0, [rsp + nb114_rsqOO]
	movapd xmm4, [rsp + nb114_rsqH1H1]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb114_half] ;# iter1 of  
	mulpd   xmm7, [rsp + nb114_half] ;# iter1 of  
	...
	mulpd   xmm5, [rsp + nb114_half] ;# rinv
	mulpd   xmm1, xmm1
	movapd [rsp + nb114_rinvsqOO], xmm1
	movapd [rsp + nb114_rinvH1H1], xmm5

	movapd xmm0, [rsp + nb114_rsqH1H2]
	movapd xmm4, [rsp + nb114_rsqH1M]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb114_half] ;# rinv 
	mulpd   xmm5, [rsp + nb114_half] ;# rinv 
	movapd [rsp + nb114_rinvH1H2], xmm1
	movapd [rsp + nb114_rinvH1M], xmm5

	movapd xmm0, [rsp + nb114_rsqH2H1]
	movapd xmm4, [rsp + nb114_rsqH2H2]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb114_half] ;# iter1a 
	mulpd   xmm7, [rsp + nb114_half] ;# iter1b 
	...
	mulpd   xmm1, [rsp + nb114_half] ;# rinv 
	mulpd   xmm5, [rsp + nb114_half] ;# rinv 
	movapd [rsp + nb114_rinvH2H1], xmm1
	movapd [rsp + nb114_rinvH2H2], xmm5

	movapd xmm0, [rsp + nb114_rsqMH1]
	movapd xmm4, [rsp + nb114_rsqH2M]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb114_half] ;# rinv 
	mulpd   xmm5, [rsp + nb114_half] ;# rinv 
	movapd [rsp + nb114_rinvMH1], xmm1
	movapd [rsp + nb114_rinvH2M], xmm5

	;# start with OO interaction 
	movapd xmm0, [rsp + nb114_rinvsqOO] ;# xmm0=rinvsq
	movapd  xmm1, xmm0	
	mulpd   xmm1, xmm1 ;# rinv4
	mulpd   xmm1, xmm0 ;#rinvsix
	movapd  xmm2, xmm1
	mulpd	xmm2, xmm2 ;# rinvtwelve
	mulpd  xmm1, [rsp + nb114_c6]
	mulpd  xmm2, [rsp + nb114_c12]
	movapd xmm3, xmm2
	subpd  xmm3, xmm1	;# Vvdw=Vvdw12-Vvdw6 		
	addpd  xmm3, [rsp + nb114_Vvdwtot]
	mulpd  xmm1, [rsp + nb114_six]
	mulpd  xmm2, [rsp + nb114_twelve]
	subpd  xmm2, xmm1
	mulpd  xmm2, xmm0
	movapd [rsp + nb114_Vvdwtot], xmm3
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb114_dxOO]
	mulpd xmm1, [rsp + nb114_dyOO]
	mulpd xmm2, [rsp + nb114_dzOO]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixO]
	addpd xmm1, [rsp + nb114_fiyO]
	addpd xmm2, [rsp + nb114_fizO]
	movapd [rsp + nb114_fjxO], xmm3
	movapd [rsp + nb114_fjyO], xmm4
	movapd [rsp + nb114_fjzO], xmm5
	movapd [rsp + nb114_fixO], xmm0
	movapd [rsp + nb114_fiyO], xmm1
	movapd [rsp + nb114_fizO], xmm2

	;# H1-H1 interaction 
	movapd xmm0, [rsp + nb114_rinvH1H1]
	movapd xmm7, xmm0		;# xmm7=rinv 
	mulpd  xmm0, xmm0		;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqHH] ;# xmm7=vcoul
	mulpd  xmm0, xmm7		;# fscal
	addpd  xmm7, [rsp + nb114_vctot] ;# local vctot summation variable 
	movapd [rsp + nb114_vctot], xmm7
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb114_dxH1H1]
	mulpd xmm1, [rsp + nb114_dyH1H1]
	mulpd xmm2, [rsp + nb114_dzH1H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixH1]
	addpd xmm1, [rsp + nb114_fiyH1]
	addpd xmm2, [rsp + nb114_fizH1]
	movapd [rsp + nb114_fjxH1], xmm3
	movapd [rsp + nb114_fjyH1], xmm4
	movapd [rsp + nb114_fjzH1], xmm5
	movapd [rsp + nb114_fixH1], xmm0
	movapd [rsp + nb114_fiyH1], xmm1
	movapd [rsp + nb114_fizH1], xmm2

	;# H1-H2 interaction  
	movapd xmm0, [rsp + nb114_rinvH1H2]
	movapd xmm7, xmm0	;# xmm7=rinv 
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqHH] ;# vcoul
	mulpd  xmm0, xmm7
	addpd  xmm7, [rsp + nb114_vctot] ;# local vctot summation variable 
	movapd [rsp + nb114_vctot], xmm7
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb114_dxH1H2]
	mulpd xmm1, [rsp + nb114_dyH1H2]
	mulpd xmm2, [rsp + nb114_dzH1H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixH1]
	addpd xmm1, [rsp + nb114_fiyH1]
	addpd xmm2, [rsp + nb114_fizH1]
	movapd [rsp + nb114_fjxH2], xmm3
	movapd [rsp + nb114_fjyH2], xmm4
	movapd [rsp + nb114_fjzH2], xmm5
	movapd [rsp + nb114_fixH1], xmm0
	movapd [rsp + nb114_fiyH1], xmm1
	movapd [rsp + nb114_fizH1], xmm2

	;# H1-M interaction 
	movapd xmm0, [rsp + nb114_rinvH1M]
	movapd xmm7, xmm0	;# xmm7=rinv 
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqMH] ;# vcoul
	mulpd  xmm0, xmm7
	addpd  xmm7, [rsp + nb114_vctot] ;# local vctot summation variable 
	movapd [rsp + nb114_vctot], xmm7
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb114_dxH1M]
	mulpd xmm1, [rsp + nb114_dyH1M]
	mulpd xmm2, [rsp + nb114_dzH1M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixH1]
	addpd xmm1, [rsp + nb114_fiyH1]
	addpd xmm2, [rsp + nb114_fizH1]
	movapd [rsp + nb114_fjxM], xmm3
	movapd [rsp + nb114_fjyM], xmm4
	movapd [rsp + nb114_fjzM], xmm5
	movapd [rsp + nb114_fixH1], xmm0
	movapd [rsp + nb114_fiyH1], xmm1
	movapd [rsp + nb114_fizH1], xmm2

	;# H2-H1 interaction 
	movapd xmm0, [rsp + nb114_rinvH2H1]
	movapd xmm7, xmm0	;# xmm7=rinv 
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqHH] 
	mulpd  xmm0, xmm7
	addpd  xmm7, [rsp + nb114_vctot] ;# local vctot summation variable 
	movapd [rsp + nb114_vctot], xmm7
	...
	movapd xmm3, [rsp + nb114_fjxH1]
	movapd xmm4, [rsp + nb114_fjyH1]
	movapd xmm5, [rsp + nb114_fjzH1]
	mulpd xmm0, [rsp + nb114_dxH2H1]
	mulpd xmm1, [rsp + nb114_dyH2H1]
	mulpd xmm2, [rsp + nb114_dzH2H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixH2]
	addpd xmm1, [rsp + nb114_fiyH2]
	addpd xmm2, [rsp + nb114_fizH2]
	movapd [rsp + nb114_fjxH1], xmm3
	movapd [rsp + nb114_fjyH1], xmm4
	movapd [rsp + nb114_fjzH1], xmm5
	movapd [rsp + nb114_fixH2], xmm0
	movapd [rsp + nb114_fiyH2], xmm1
	movapd [rsp + nb114_fizH2], xmm2

	;# H2-H2 interaction 
	movapd xmm0, [rsp + nb114_rinvH2H2]
	movapd xmm7, xmm0	;# xmm7=rinv 
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqHH] ;# vcoul
	...
	movapd xmm3, [rsp + nb114_fjxH2]
	movapd xmm4, [rsp + nb114_fjyH2]
	movapd xmm5, [rsp + nb114_fjzH2]
	mulpd xmm0, [rsp + nb114_dxH2H2]
	mulpd xmm1, [rsp + nb114_dyH2H2]
	mulpd xmm2, [rsp + nb114_dzH2H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixH2]
	...
	;# H2-M interaction 
	movapd xmm0, [rsp + nb114_rinvH2M]
	movapd xmm7, xmm0	;# xmm7=rinv 
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqMH] ;# vcoul
	
	mulpd  xmm0, xmm7
	addpd  xmm7, [rsp + nb114_vctot] 
	movapd [rsp + nb114_vctot], xmm7
	
	movapd xmm1, xmm0
	movapd xmm2, xmm0

	movapd xmm3, [rsp + nb114_fjxM]
	movapd xmm4, [rsp + nb114_fjyM]
	movapd xmm5, [rsp + nb114_fjzM]
	mulpd xmm0, [rsp + nb114_dxH2M]
	mulpd xmm1, [rsp + nb114_dyH2M]
	mulpd xmm2, [rsp + nb114_dzH2M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixH2]
	...
	;# M-H1 interaction 
	movapd xmm0, [rsp + nb114_rinvMH1]
	movapd xmm7, xmm0	;# xmm7=rinv 
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqMH]
	...
	movapd xmm4, [rsp + nb114_fjyH1]
	movapd xmm5, [rsp + nb114_fjzH1]
	mulpd xmm0, [rsp + nb114_dxMH1]
	mulpd xmm1, [rsp + nb114_dyMH1]
	mulpd xmm2, [rsp + nb114_dzMH1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixM]
	addpd xmm1, [rsp + nb114_fiyM]
	addpd xmm2, [rsp + nb114_fizM]
	movapd [rsp + nb114_fjxH1], xmm3
	movapd [rsp + nb114_fjyH1], xmm4
	movapd [rsp + nb114_fjzH1], xmm5
	movapd [rsp + nb114_fixM], xmm0
	movapd [rsp + nb114_fiyM], xmm1
	movapd [rsp + nb114_fizM], xmm2

	;# M-H2 interaction 
	movapd xmm0, [rsp + nb114_rinvMH2]
	movapd xmm7, xmm0	;# xmm7=rinv 
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqMH] 
	...
	movapd xmm4, [rsp + nb114_fjyH2]
	movapd xmm5, [rsp + nb114_fjzH2]
	mulpd xmm0, [rsp + nb114_dxMH2]
	mulpd xmm1, [rsp + nb114_dyMH2]
	mulpd xmm2, [rsp + nb114_dzMH2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixM]
	...
	;# M-M interaction 
	movapd xmm0, [rsp + nb114_rinvMM]
	movapd xmm7, xmm0	;# xmm7=rinv 
	mulpd  xmm0, xmm0	;# xmm0=rinvsq 
	mulpd  xmm7, [rsp + nb114_qqMM] ;# vcoul
	...
	movapd xmm4, [rsp + nb114_fjyM] 
	movapd xmm5, [rsp + nb114_fjzM]
	mulpd xmm0, [rsp + nb114_dxMM]
	mulpd xmm1, [rsp + nb114_dyMM]
	mulpd xmm2, [rsp + nb114_dzMM]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb114_fixM]
	...
	movapd xmm0, [rsp + nb114_fjxO]
	movapd xmm1, [rsp + nb114_fjyO]
	movapd xmm2, [rsp + nb114_fjzO]
	movapd xmm3, [rsp + nb114_fjxH1]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	...
	movapd xmm0, [rsp + nb114_fjyH1]
	movapd xmm1, [rsp + nb114_fjzH1]
	movapd xmm2, [rsp + nb114_fjxH2]
	movapd xmm3, [rsp + nb114_fjyH2]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	unpcklpd xmm0, xmm1   ;# fjOxA fjOyA
	unpckhpd xmm4, xmm1   ;# fjOxB fjOyB
	...
	movapd xmm0, [rsp + nb114_fjzH2]
	movapd xmm1, [rsp + nb114_fjxM]
	movapd xmm2, [rsp + nb114_fjyM]
	movapd xmm3, [rsp + nb114_fjzM]
	movapd xmm4, xmm0
	movapd xmm5, xmm2
	unpcklpd xmm0, xmm1   ;# fjOxA fjOyA
	unpckhpd xmm4, xmm1   ;# fjOxB fjOyB
...
.nb114_dosingle:
	...
	movsd  [rsp + nb114_jxO], xmm0
	movsd  [rsp + nb114_jzO], xmm1
	movsd  [rsp + nb114_jyH1], xmm2
	movsd  [rsp + nb114_jxH2], xmm3
	movsd  [rsp + nb114_jzH2], xmm4
	movsd  [rsp + nb114_jyM], xmm5
	unpckhpd xmm0, xmm0
	unpckhpd xmm1, xmm1
	unpckhpd xmm2, xmm2
	unpckhpd xmm3, xmm3
	unpckhpd xmm4, xmm4
	unpckhpd xmm5, xmm5
	movsd  [rsp + nb114_jyO], xmm0
	movsd  [rsp + nb114_jxH1], xmm1
	movsd  [rsp + nb114_jzH1], xmm2
	movsd  [rsp + nb114_jyH2], xmm3
	movsd  [rsp + nb114_jxM], xmm4
	movsd  [rsp + nb114_jzM], xmm5
	...
	movapd xmm4, [rsp + nb114_iyH1]
	movapd xmm5, [rsp + nb114_izH1]
	subsd  xmm0, [rsp + nb114_jxO]
	subsd  xmm1, [rsp + nb114_jyO]
	subsd  xmm2, [rsp + nb114_jzO]
	subsd  xmm3, [rsp + nb114_jxH1]
	subsd  xmm4, [rsp + nb114_jyH1]
	subsd  xmm5, [rsp + nb114_jzH1]
	movapd [rsp + nb114_dxOO], xmm0
	movapd [rsp + nb114_dyOO], xmm1
	movapd [rsp + nb114_dzOO], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subsd  xmm0, [rsp + nb114_jxH2]
	subsd  xmm1, [rsp + nb114_jyH2]
	subsd  xmm2, [rsp + nb114_jzH2]
	subsd  xmm3, [rsp + nb114_jxM]
	subsd  xmm4, [rsp + nb114_jyM]
	subsd  xmm5, [rsp + nb114_jzM]
	movapd [rsp + nb114_dxH1H2], xmm0
	movapd [rsp + nb114_dyH1H2], xmm1
	movapd [rsp + nb114_dzH1H2], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, xmm1
	movapd xmm5, xmm2
	subsd  xmm0, [rsp + nb114_jxH1]
	subsd  xmm1, [rsp + nb114_jyH1]
	subsd  xmm2, [rsp + nb114_jzH1]
	subsd  xmm3, [rsp + nb114_jxH2]
	subsd  xmm4, [rsp + nb114_jyH2]
	subsd  xmm5, [rsp + nb114_jzH2]
	movapd [rsp + nb114_dxH2H1], xmm0
	movapd [rsp + nb114_dyH2H1], xmm1
	movapd [rsp + nb114_dzH2H1], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb114_iyM]
	movapd xmm5, [rsp + nb114_izM]
	subsd  xmm0, [rsp + nb114_jxM]
	subsd  xmm1, [rsp + nb114_jyM]
	subsd  xmm2, [rsp + nb114_jzM]
	subsd  xmm3, [rsp + nb114_jxH1]
	subsd  xmm4, [rsp + nb114_jyH1]
	subsd  xmm5, [rsp + nb114_jzH1]
	movapd [rsp + nb114_dxH2M], xmm0
	...
	mulsd   xmm3, [rsp + nb114_half] ;# iter1 
	mulsd   xmm7, [rsp + nb114_half] ;# iter1 
	...
	mulsd   xmm1, [rsp + nb114_half] ;# rinv 
	mulsd   xmm5, [rsp + nb114_half] ;# rinv 
	movapd [rsp + nb114_rinvMH2], xmm1
	movapd [rsp + nb114_rinvMM], xmm5
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb114_half] ;# iter1 of  
	mulsd   xmm7, [rsp + nb114_half] ;# iter1 of  
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb114_half] ;# iter1a 
	mulsd   xmm7, [rsp + nb114_half] ;# iter1b 
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb114_dxOO]
	mulsd xmm1, [rsp + nb114_dyOO]
	mulsd xmm2, [rsp + nb114_dzOO]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixO]
	addsd xmm1, [rsp + nb114_fiyO]
	addsd xmm2, [rsp + nb114_fizO]
	movsd [rsp + nb114_fjxO], xmm3
	movsd [rsp + nb114_fjyO], xmm4
	movsd [rsp + nb114_fjzO], xmm5
	movsd [rsp + nb114_fixO], xmm0
	movsd [rsp + nb114_fiyO], xmm1
	movsd [rsp + nb114_fizO], xmm2

	;# H1-H1 interaction 
	movsd xmm0, [rsp + nb114_rinvH1H1]
	movsd xmm7, xmm0	;# xmm7=rinv 
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 
	mulsd  xmm7, [rsp + nb114_qqHH] 
	
	mulsd  xmm0, xmm7
	addsd  xmm7, [rsp + nb114_vctot]
	movsd [rsp + nb114_vctot], xmm7
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb114_dxH1H1]
	mulsd xmm1, [rsp + nb114_dyH1H1]
	mulsd xmm2, [rsp + nb114_dzH1H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixH1]
	addsd xmm1, [rsp + nb114_fiyH1]
	addsd xmm2, [rsp + nb114_fizH1]
	movsd [rsp + nb114_fjxH1], xmm3
	movsd [rsp + nb114_fjyH1], xmm4
	movsd [rsp + nb114_fjzH1], xmm5
	movsd [rsp + nb114_fixH1], xmm0
	movsd [rsp + nb114_fiyH1], xmm1
	movsd [rsp + nb114_fizH1], xmm2

	;# H1-H2 interaction  
	movsd xmm0, [rsp + nb114_rinvH1H2]
	movsd xmm7, xmm0	;# xmm7=rinv 
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 
	mulsd  xmm7, [rsp + nb114_qqHH] ;# vcoul
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb114_dxH1H2]
	mulsd xmm1, [rsp + nb114_dyH1H2]
	mulsd xmm2, [rsp + nb114_dzH1H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixH1]
	addsd xmm1, [rsp + nb114_fiyH1]
	addsd xmm2, [rsp + nb114_fizH1]
	movsd [rsp + nb114_fjxH2], xmm3
	movsd [rsp + nb114_fjyH2], xmm4
	movsd [rsp + nb114_fjzH2], xmm5
	movsd [rsp + nb114_fixH1], xmm0
	movsd [rsp + nb114_fiyH1], xmm1
	movsd [rsp + nb114_fizH1], xmm2

	;# H1-M interaction 
	movsd xmm0, [rsp + nb114_rinvH1M]
	movsd xmm7, xmm0	;# xmm7=rinv 
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 
	mulsd  xmm7, [rsp + nb114_qqMH] ;# vcoul
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb114_dxH1M]
	mulsd xmm1, [rsp + nb114_dyH1M]
	mulsd xmm2, [rsp + nb114_dzH1M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixH1]
	addsd xmm1, [rsp + nb114_fiyH1]
	addsd xmm2, [rsp + nb114_fizH1]
	movsd [rsp + nb114_fjxM], xmm3
	movsd [rsp + nb114_fjyM], xmm4
	movsd [rsp + nb114_fjzM], xmm5
	movsd [rsp + nb114_fixH1], xmm0
	movsd [rsp + nb114_fiyH1], xmm1
	movsd [rsp + nb114_fizH1], xmm2

	;# H2-H1 interaction 
	movsd xmm0, [rsp + nb114_rinvH2H1]
	movsd xmm7, xmm0	;# xmm7=rinv 
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 
	mulsd  xmm7, [rsp + nb114_qqHH] ;# vcoul
	...
	movapd xmm4, [rsp + nb114_fjyH1]
	movapd xmm5, [rsp + nb114_fjzH1]
	mulsd xmm0, [rsp + nb114_dxH2H1]
	mulsd xmm1, [rsp + nb114_dyH2H1]
	mulsd xmm2, [rsp + nb114_dzH2H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixH2]
	addsd xmm1, [rsp + nb114_fiyH2]
	addsd xmm2, [rsp + nb114_fizH2]
	movsd [rsp + nb114_fjxH1], xmm3
	movsd [rsp + nb114_fjyH1], xmm4
	movsd [rsp + nb114_fjzH1], xmm5
	movsd [rsp + nb114_fixH2], xmm0
	movsd [rsp + nb114_fiyH2], xmm1
	movsd [rsp + nb114_fizH2], xmm2

	;# H2-H2 interaction 
	movsd xmm0, [rsp + nb114_rinvH2H2]
	movsd xmm7, xmm0	;# xmm7=rinv 
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 
	mulsd  xmm7, [rsp + nb114_qqHH] ;# vcoul
	...
	movsd xmm3, [rsp + nb114_fjxH2]
	movsd xmm4, [rsp + nb114_fjyH2]
	movsd xmm5, [rsp + nb114_fjzH2]
	mulsd xmm0, [rsp + nb114_dxH2H2]
	mulsd xmm1, [rsp + nb114_dyH2H2]
	mulsd xmm2, [rsp + nb114_dzH2H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixH2]
	...
	;# H2-M interaction 
	movsd xmm0, [rsp + nb114_rinvH2M]
	movsd xmm7, xmm0	;# xmm7=rinv 
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 
	mulsd  xmm7, [rsp + nb114_qqMH] 	
	mulsd  xmm0, xmm7
	addsd  xmm7, [rsp + nb114_vctot] 
	movsd [rsp + nb114_vctot], xmm7
	...
	movapd xmm4, [rsp + nb114_fjyM]
	movapd xmm5, [rsp + nb114_fjzM]
	mulsd xmm0, [rsp + nb114_dxH2M]
	mulsd xmm1, [rsp + nb114_dyH2M]
	mulsd xmm2, [rsp + nb114_dzH2M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixH2]
	...
	mulsd  xmm0, xmm7
	addsd  xmm7, [rsp + nb114_vctot] ;# local vctot summation variable 
	movsd [rsp + nb114_vctot], xmm7
	...
	movapd xmm4, [rsp + nb114_fjyH1]
	movapd xmm5, [rsp + nb114_fjzH1]
	mulsd xmm0, [rsp + nb114_dxMH1]
	mulsd xmm1, [rsp + nb114_dyMH1]
	mulsd xmm2, [rsp + nb114_dzMH1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixM]
	addsd xmm1, [rsp + nb114_fiyM]
	addsd xmm2, [rsp + nb114_fizM]
	movsd [rsp + nb114_fjxH1], xmm3
	movsd [rsp + nb114_fjyH1], xmm4
	movsd [rsp + nb114_fjzH1], xmm5
	movsd [rsp + nb114_fixM], xmm0
	movsd [rsp + nb114_fiyM], xmm1
	movsd [rsp + nb114_fizM], xmm2

	;# M-H2 interaction 
	movsd xmm0, [rsp + nb114_rinvMH2]
	movsd xmm7, xmm0	;# xmm7=rinv 
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 
	...
	movapd xmm4, [rsp + nb114_fjyH2]
	movapd xmm5, [rsp + nb114_fjzH2]
	mulsd xmm0, [rsp + nb114_dxMH2]
	mulsd xmm1, [rsp + nb114_dyMH2]
	mulsd xmm2, [rsp + nb114_dzMH2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixM]
	...
	;# M-M interaction 
	movsd xmm0, [rsp + nb114_rinvMM]
	movsd xmm7, xmm0	;# xmm7=rinv 
	mulsd  xmm0, xmm0	;# xmm0=rinvsq 

	mulsd  xmm7, [rsp + nb114_qqMM] 
	...
	movapd xmm4, [rsp + nb114_fjyM]
	movapd xmm5, [rsp + nb114_fjzM]
	mulsd xmm0, [rsp + nb114_dxMM]
	mulsd xmm1, [rsp + nb114_dyMM]
	mulsd xmm2, [rsp + nb114_dzMM]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb114_fixM]
	...
	;# Did all interactions - now update j forces 
	;# Step1 - merge forces
	movlpd xmm0, [rsp + nb114_fjxO]
	movlpd xmm1, [rsp + nb114_fjzO]
	movlpd xmm2, [rsp + nb114_fjyH1]
	movlpd xmm3, [rsp + nb114_fjxH2]
	movlpd xmm4, [rsp + nb114_fjzH2]
	movlpd xmm5, [rsp + nb114_fjyM]

	movhpd xmm0, [rsp + nb114_fjyO]
	movhpd xmm1, [rsp + nb114_fjxH1]
	movhpd xmm2, [rsp + nb114_fjzH1]
	movhpd xmm3, [rsp + nb114_fjyH2]
	movhpd xmm4, [rsp + nb114_fjxM]
	movhpd xmm5, [rsp + nb114_fjzM]
	...
	movlps [rdi + rax*8],      xmm0
	movhps [rdi + rax*8 + 8],  xmm0
	movlps [rdi + rax*8 + 16], xmm1
	movhps [rdi + rax*8 + 24], xmm1
	movlps [rdi + rax*8 + 32], xmm2
	movhps [rdi + rax*8 + 40], xmm2
	movlps [rdi + rax*8 + 48], xmm3
	movhps [rdi + rax*8 + 56], xmm3
	movlps [rdi + rax*8 + 64], xmm4
	movhps [rdi + rax*8 + 72], xmm4
	movlps [rdi + rax*8 + 80], xmm5
	movhps [rdi + rax*8 + 88], xmm5
