...
.nb133_unroll_loop:
	...
	movapd xmm4, [rsp + nb133_ixO]
	movapd xmm5, [rsp + nb133_iyO]
	movapd xmm6, [rsp + nb133_izO]
	...
	movapd xmm4, [rsp + nb133_ixH1]
	movapd xmm5, [rsp + nb133_iyH1]
	movapd xmm6, [rsp + nb133_izH1]
	...
	movapd xmm3, [rsp + nb133_ixH2]
	movapd xmm4, [rsp + nb133_iyH2]
	movapd xmm5, [rsp + nb133_izH2]
	...
	movapd xmm3, [rsp + nb133_iyM]
	movapd xmm4, [rsp + nb133_izM]
	subpd  xmm3, xmm1
	subpd  xmm4, xmm2
	movapd xmm2, [rsp + nb133_ixM]
	subpd  xmm2, xmm0	

	;# store dr 
	movapd [rsp + nb133_dxM], xmm2
	movapd [rsp + nb133_dyM], xmm3
	movapd [rsp + nb133_dzM], xmm4
	;# square it 
	mulpd xmm2,xmm2
	mulpd xmm3,xmm3
	mulpd xmm4,xmm4
	...
	mulpd   xmm1, [rsp + nb133_half] ;# iter1 ( new lu) 
	...
	mulpd xmm1, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm1, [rsp + nb133_half] ;# rinv 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [rsp + nb133_half] ;# rinv 
	movapd  xmm7, xmm4	;# rinvO in xmm7 
	
	movapd xmm4, [rsp + nb133_rsqO]
	movapd xmm0, xmm7
	;# LJ table interaction.
	mulpd xmm4, xmm7	;# xmm4=r 
	mulpd xmm4, [rsp + nb133_tsc]
	...
	mulpd  xmm7, [rsp + nb133_two]	;# two*Heps2 
	addpd  xmm7, xmm6
	addpd  xmm7, xmm5 ;# xmm7=FF 
	mulpd  xmm5, xmm1 ;# xmm5=eps*Fp 
	addpd  xmm5, xmm4 ;# xmm5=VV 

	movapd xmm4, [rsp + nb133_c6]
	...
	movapd xmm4, [rsp + nb133_c12]
	mulpd  xmm7, xmm4 
	mulpd  xmm5, xmm4  
	
	addpd  xmm5, [rsp + nb133_Vvdwtot]
	movapd xmm3, [rsp + nb133_fstmp]
	mulpd  xmm7, [rsp + nb133_tsc]
	subpd  xmm3, xmm7
	movapd [rsp + nb133_Vvdwtot], xmm5
	...
	movapd xmm0, [rsp + nb133_dxO]
	movapd xmm1, [rsp + nb133_dyO]
	movapd xmm2, [rsp + nb133_dzO]
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb133_fixO], xmm3
	movapd [rsp + nb133_fiyO], xmm4
	movapd [rsp + nb133_fizO], xmm7
	;# update j forces with water O 
	movapd [rsp + nb133_fjx], xmm0
	movapd [rsp + nb133_fjy], xmm1
	movapd [rsp + nb133_fjz], xmm2

	;# H1 interactions 
	movapd  xmm6, [rsp + nb133_rinvH1] 
	movapd  xmm4, xmm6
	mulpd   xmm4, xmm4	;# xmm6=rinv, xmm4=rinvsq 
	mulpd   xmm6, [rsp + nb133_qqH] ;# vcoul 
	mulpd   xmm4, xmm6    ;# fscal
	addpd   xmm6, [rsp + nb133_vctot]
	movapd  [rsp + nb133_vctot], xmm6
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb133_fixH1], xmm3
	movapd [rsp + nb133_fiyH1], xmm4
	movapd [rsp + nb133_fizH1], xmm7
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb133_fixH2], xmm3
	movapd [rsp + nb133_fiyH2], xmm4
	movapd [rsp + nb133_fizH2], xmm7
	...
	;# M interactions 
	movapd  xmm6, [rsp + nb133_rinvM] 
	movapd  xmm4, xmm6
	mulpd   xmm4, xmm4	;# xmm6=rinv, xmm4=rinvsq 
	mulpd   xmm6, [rsp + nb133_qqM] ;# vcoul 
	mulpd   xmm4, xmm6    ;# fscal
	addpd  xmm6, [rsp + nb133_vctot]
	movapd [rsp + nb133_vctot], xmm6
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb133_fixM], xmm3
	movapd [rsp + nb133_fiyM], xmm4
	movapd [rsp + nb133_fizM], xmm7
