...
.nb104_unroll_loop:	
	...
	movapd 	[rsp + nb104_jxH1], xmm2
	movapd 	[rsp + nb104_jyH1], xmm3
	movapd 	[rsp + nb104_jzH1], xmm4
	movapd 	[rsp + nb104_jxH2], xmm5
	movapd 	[rsp + nb104_jyH2], xmm6
	movapd 	[rsp + nb104_jzH2], xmm7
	...
	movapd 	[rsp + nb104_jxM], xmm2
	movapd 	[rsp + nb104_jyM], xmm3
	movapd 	[rsp + nb104_jzM], xmm4
	
	movapd xmm0, [rsp + nb104_ixM]
	movapd xmm1, [rsp + nb104_iyM]
	movapd xmm2, [rsp + nb104_izM]
	movapd xmm3, [rsp + nb104_ixM]
	movapd xmm4, [rsp + nb104_iyM]
	movapd xmm5, [rsp + nb104_izM]
	subpd  xmm0, [rsp + nb104_jxM]
	subpd  xmm1, [rsp + nb104_jyM]
	subpd  xmm2, [rsp + nb104_jzM]
	subpd  xmm3, [rsp + nb104_jxH1]
	subpd  xmm4, [rsp + nb104_jyH1]
	subpd  xmm5, [rsp + nb104_jzH1]
	movapd [rsp + nb104_dxMM], xmm0
	movapd [rsp + nb104_dyMM], xmm1
	movapd [rsp + nb104_dzMM], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb104_dxMH1], xmm3
	movapd [rsp + nb104_dyMH1], xmm4
	movapd [rsp + nb104_dzMH1], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb104_rsqMM], xmm0
	movapd [rsp + nb104_rsqMH1], xmm3

	movapd xmm0, [rsp + nb104_ixM]
	movapd xmm1, [rsp + nb104_iyM]
	movapd xmm2, [rsp + nb104_izM]
	movapd xmm3, [rsp + nb104_ixH1]
	movapd xmm4, [rsp + nb104_iyH1]
	movapd xmm5, [rsp + nb104_izH1]
	subpd  xmm0, [rsp + nb104_jxH2]
	subpd  xmm1, [rsp + nb104_jyH2]
	subpd  xmm2, [rsp + nb104_jzH2]
	subpd  xmm3, [rsp + nb104_jxM]
	subpd  xmm4, [rsp + nb104_jyM]
	subpd  xmm5, [rsp + nb104_jzM]
	movapd [rsp + nb104_dxMH2], xmm0
	movapd [rsp + nb104_dyMH2], xmm1
	movapd [rsp + nb104_dzMH2], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb104_dxH1M], xmm3
	movapd [rsp + nb104_dyH1M], xmm4
	movapd [rsp + nb104_dzH1M], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb104_rsqMH2], xmm0
	movapd [rsp + nb104_rsqH1M], xmm3

	movapd xmm0, [rsp + nb104_ixH1]
	movapd xmm1, [rsp + nb104_iyH1]
	movapd xmm2, [rsp + nb104_izH1]
	movapd xmm3, [rsp + nb104_ixH1]
	movapd xmm4, [rsp + nb104_iyH1]
	movapd xmm5, [rsp + nb104_izH1]
	subpd  xmm0, [rsp + nb104_jxH1]
	subpd  xmm1, [rsp + nb104_jyH1]
	subpd  xmm2, [rsp + nb104_jzH1]
	subpd  xmm3, [rsp + nb104_jxH2]
	subpd  xmm4, [rsp + nb104_jyH2]
	subpd  xmm5, [rsp + nb104_jzH2]
	...
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	movapd [rsp + nb104_dxH1H2], xmm3
	movapd [rsp + nb104_dyH1H2], xmm4
	movapd [rsp + nb104_dzH1H2], xmm5
	mulpd  xmm3, xmm3
	mulpd  xmm4, xmm4
	mulpd  xmm5, xmm5
	addpd  xmm0, xmm1
	...
	addpd  xmm3, xmm4
	addpd  xmm3, xmm5
	movapd [rsp + nb104_rsqH1H1], xmm0
	movapd [rsp + nb104_rsqH1H2], xmm3

	movapd xmm0, [rsp + nb104_ixH2]
	movapd xmm1, [rsp + nb104_iyH2]
	movapd xmm2, [rsp + nb104_izH2]
	movapd xmm3, [rsp + nb104_ixH2]
	movapd xmm4, [rsp + nb104_iyH2]
	movapd xmm5, [rsp + nb104_izH2]
	subpd  xmm0, [rsp + nb104_jxM]
	subpd  xmm1, [rsp + nb104_jyM]
	subpd  xmm2, [rsp + nb104_jzM]
	subpd  xmm3, [rsp + nb104_jxH1]
	subpd  xmm4, [rsp + nb104_jyH1]
	subpd  xmm5, [rsp + nb104_jzH1]
	movapd [rsp + nb104_dxH2M], xmm0
	movapd [rsp + nb104_dyH2M], xmm1
	movapd [rsp + nb104_dzH2M], xmm2
	mulpd  xmm0, xmm0
	mulpd  xmm1, xmm1
	mulpd  xmm2, xmm2
	...
	addpd  xmm4, xmm3
	addpd  xmm4, xmm5
	movapd [rsp + nb104_rsqH2M], xmm0
	movapd [rsp + nb104_rsqH2H1], xmm4
	...
	subpd  xmm1, [rsp + nb104_jyH2]
	subpd  xmm2, [rsp + nb104_jzH2]
	movapd [rsp + nb104_dxH2H2], xmm0
	movapd [rsp + nb104_dyH2H2], xmm1
	movapd [rsp + nb104_dzH2H2], xmm2
	mulpd xmm0, xmm0
	mulpd xmm1, xmm1
	mulpd xmm2, xmm2
	addpd xmm0, xmm1
	addpd xmm0, xmm2
	movapd [rsp + nb104_rsqH2H2], xmm0
	...
	mulpd   xmm3, [rsp + nb104_half] ;# iter1 
	mulpd   xmm7, [rsp + nb104_half] ;# iter1 
	...
	mulpd   xmm1, [rsp + nb104_half] ;# rinv 
	mulpd   xmm5, [rsp + nb104_half] ;# rinv 
	movapd [rsp + nb104_rinvH2H2], xmm1
	movapd [rsp + nb104_rinvH2H1], xmm5

	movapd xmm0, [rsp + nb104_rsqMM]
	movapd xmm4, [rsp + nb104_rsqMH1]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb104_half] ;# iter1 of  
	mulpd   xmm7, [rsp + nb104_half] ;# iter1 of  
	...
	mulpd   xmm1, [rsp + nb104_half] ;# rinv 
	mulpd   xmm5, [rsp + nb104_half] ;# rinv
	movapd [rsp + nb104_rinvMM], xmm1
	movapd [rsp + nb104_rinvMH1], xmm5

	movapd xmm0, [rsp + nb104_rsqMH2]
	movapd xmm4, [rsp + nb104_rsqH1M]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm1, [rsp + nb104_half] ;# rinv 
	mulpd   xmm5, [rsp + nb104_half] ;# rinv 
	movapd [rsp + nb104_rinvMH2], xmm1
	movapd [rsp + nb104_rinvH1M], xmm5

	movapd xmm0, [rsp + nb104_rsqH1H1]
	movapd xmm4, [rsp + nb104_rsqH1H2]	
	cvtpd2ps xmm1, xmm0	
	cvtpd2ps xmm5, xmm4	
	rsqrtps xmm1, xmm1
	rsqrtps xmm5, xmm5
	...
	mulpd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulpd   xmm3, [rsp + nb104_half] ;# iter1a 
	mulpd   xmm7, [rsp + nb104_half] ;# iter1b 
	...
	mulpd   xmm1, [rsp + nb104_half] ;# rinv 
	mulpd   xmm5, [rsp + nb104_half] ;# rinv 
	movapd [rsp + nb104_rinvH1H1], xmm1
	movapd [rsp + nb104_rinvH1H2], xmm5

	movapd xmm0, [rsp + nb104_rsqH2M]
	cvtpd2ps xmm1, xmm0	
	rsqrtps xmm1, xmm1
	cvtps2pd xmm1, xmm1
	...
	mulpd   xmm1, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulpd   xmm1, [rsp + nb104_half] ;# rinv 
	movapd [rsp + nb104_rinvH2M], xmm1

	;# start with MM interaction 
	movapd xmm0, [rsp + nb104_rinvMM]
	movapd xmm7, xmm0
	mulpd  xmm0, xmm0		;# rinvsq 
	mulpd  xmm7, [rsp + nb104_qqMM]	
	mulpd  xmm0, xmm7	
	addpd  xmm7, [rsp + nb104_vctot] 
	movapd xmm1, xmm0
	movapd xmm2, xmm0
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb104_dxMM]
	mulpd xmm1, [rsp + nb104_dyMM]
	mulpd xmm2, [rsp + nb104_dzMM]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixM]
	addpd xmm1, [rsp + nb104_fiyM]
	addpd xmm2, [rsp + nb104_fizM]
	movapd [rsp + nb104_fjxM], xmm3
	movapd [rsp + nb104_fjyM], xmm4
	movapd [rsp + nb104_fjzM], xmm5
	movapd [rsp + nb104_fixM], xmm0
	movapd [rsp + nb104_fiyM], xmm1
	movapd [rsp + nb104_fizM], xmm2

	;# M-H1 interaction 
	movapd xmm0, [rsp + nb104_rinvMH1]
	movapd xmm1, xmm0
	mulpd xmm0, xmm0
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb104_dxMH1]
	mulpd xmm1, [rsp + nb104_dyMH1]
	mulpd xmm2, [rsp + nb104_dzMH1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixM]
	addpd xmm1, [rsp + nb104_fiyM]
	addpd xmm2, [rsp + nb104_fizM]
	movapd [rsp + nb104_fjxH1], xmm3
	movapd [rsp + nb104_fjyH1], xmm4
	movapd [rsp + nb104_fjzH1], xmm5
	movapd [rsp + nb104_fixM], xmm0
	movapd [rsp + nb104_fiyM], xmm1
	movapd [rsp + nb104_fizM], xmm2

	;# M-H2 interaction  
	movapd xmm0, [rsp + nb104_rinvMH2]
	movapd xmm1, xmm0
	mulpd xmm0, xmm0
	mulpd xmm1, [rsp + nb104_qqMH]
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulpd xmm0, [rsp + nb104_dxMH2]
	mulpd xmm1, [rsp + nb104_dyMH2]
	mulpd xmm2, [rsp + nb104_dzMH2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixM]
	addpd xmm1, [rsp + nb104_fiyM]
	addpd xmm2, [rsp + nb104_fizM]
	movapd [rsp + nb104_fjxH2], xmm3
	movapd [rsp + nb104_fjyH2], xmm4
	movapd [rsp + nb104_fjzH2], xmm5
	movapd [rsp + nb104_fixM], xmm0
	movapd [rsp + nb104_fiyM], xmm1
	movapd [rsp + nb104_fizM], xmm2

	;# H1-M interaction 
	movapd xmm0, [rsp + nb104_rinvH1M]
	movapd xmm1, xmm0
	mulpd xmm0, xmm0
	mulpd xmm1, [rsp + nb104_qqMH]
	...
	movapd xmm1, xmm0
	movapd xmm2, xmm0
	movapd xmm3, [rsp + nb104_fjxM]
	movapd xmm4, [rsp + nb104_fjyM]
	movapd xmm5, [rsp + nb104_fjzM]
	mulpd xmm0, [rsp + nb104_dxH1M]
	mulpd xmm1, [rsp + nb104_dyH1M]
	mulpd xmm2, [rsp + nb104_dzH1M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixH1]
	addpd xmm1, [rsp + nb104_fiyH1]
	addpd xmm2, [rsp + nb104_fizH1]
	movapd [rsp + nb104_fjxM], xmm3
	movapd [rsp + nb104_fjyM], xmm4
	movapd [rsp + nb104_fjzM], xmm5
	movapd [rsp + nb104_fixH1], xmm0
	movapd [rsp + nb104_fiyH1], xmm1
	movapd [rsp + nb104_fizH1], xmm2

	;# H1-H1 interaction 
	movapd xmm0, [rsp + nb104_rinvH1H1]
	movapd xmm1, xmm0
	mulpd xmm0, xmm0
	...
	movapd xmm1, xmm0
	movapd xmm2, xmm0
	movapd xmm3, [rsp + nb104_fjxH1]
	movapd xmm4, [rsp + nb104_fjyH1]
	movapd xmm5, [rsp + nb104_fjzH1]
	mulpd xmm0, [rsp + nb104_dxH1H1]
	mulpd xmm1, [rsp + nb104_dyH1H1]
	mulpd xmm2, [rsp + nb104_dzH1H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixH1]
	...
	;# H1-H2 interaction 
	movapd xmm0, [rsp + nb104_rinvH1H2]
	movapd xmm1, xmm0
	mulpd xmm0, xmm0
	mulpd xmm1, [rsp + nb104_qqHH]
	mulpd xmm0, xmm1	;# fsMH2  
	...
	movapd xmm1, xmm0
	movapd xmm2, xmm0
	movapd xmm3, [rsp + nb104_fjxH2]
	movapd xmm4, [rsp + nb104_fjyH2]
	movapd xmm5, [rsp + nb104_fjzH2]
	mulpd xmm0, [rsp + nb104_dxH1H2]
	mulpd xmm1, [rsp + nb104_dyH1H2]
	mulpd xmm2, [rsp + nb104_dzH1H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixH1]
	...
	movapd xmm4, [rsp + nb104_fjyM]
	movapd xmm5, [rsp + nb104_fjzM]
	mulpd xmm0, [rsp + nb104_dxH2M]
	mulpd xmm1, [rsp + nb104_dyH2M]
	mulpd xmm2, [rsp + nb104_dzH2M]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixH2]
	addpd xmm1, [rsp + nb104_fiyH2]
	addpd xmm2, [rsp + nb104_fizH2]
	movapd [rsp + nb104_fjxM], xmm3
	movapd [rsp + nb104_fjyM], xmm4
	movapd [rsp + nb104_fjzM], xmm5
	movapd [rsp + nb104_fixH2], xmm0
	movapd [rsp + nb104_fiyH2], xmm1
	movapd [rsp + nb104_fizH2], xmm2

	;# H2-H1 interaction 
	movapd xmm0, [rsp + nb104_rinvH2H1]
	movapd xmm1, xmm0
	mulpd xmm0, xmm0
	mulpd xmm1, [rsp + nb104_qqHH]
	...
	movapd xmm4, [rsp + nb104_fjyH1]
	movapd xmm5, [rsp + nb104_fjzH1]
	mulpd xmm0, [rsp + nb104_dxH2H1]
	mulpd xmm1, [rsp + nb104_dyH2H1]
	mulpd xmm2, [rsp + nb104_dzH2H1]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixH2]
	...
	;# H2-H2 interaction 
	movapd xmm0, [rsp + nb104_rinvH2H2]
	movapd xmm1, xmm0
	mulpd xmm0, xmm0
	mulpd xmm1, [rsp + nb104_qqHH]
	...
	addpd xmm7, xmm1	;# add to local vctot 
	movapd xmm1, xmm0
	movapd [rsp + nb104_vctot], xmm7
	movapd xmm2, xmm0
	movapd xmm3, [rsp + nb104_fjxH2]
	movapd xmm4, [rsp + nb104_fjyH2]
	movapd xmm5, [rsp + nb104_fjzH2]
	mulpd xmm0, [rsp + nb104_dxH2H2]
	mulpd xmm1, [rsp + nb104_dyH2H2]
	mulpd xmm2, [rsp + nb104_dzH2H2]
	subpd xmm3, xmm0
	subpd xmm4, xmm1
	subpd xmm5, xmm2
	addpd xmm0, [rsp + nb104_fixH2]
	...
	movlpd xmm3, [rdi + rax*8 + 48]
	movlpd xmm4, [rdi + rax*8 + 56]
	movlpd xmm5, [rdi + rax*8 + 64]
	movlpd xmm6, [rdi + rax*8 + 72]
	movlpd xmm7, [rdi + rax*8 + 80]
	movhpd xmm0, [rdi + rbx*8 + 24]
	movhpd xmm1, [rdi + rbx*8 + 32]
	movhpd xmm2, [rdi + rbx*8 + 40]
	movhpd xmm3, [rdi + rbx*8 + 48]
	movhpd xmm4, [rdi + rbx*8 + 56]
	movhpd xmm5, [rdi + rbx*8 + 64]
	movhpd xmm6, [rdi + rbx*8 + 72]
	movhpd xmm7, [rdi + rbx*8 + 80]
	addpd xmm0, [rsp + nb104_fjxH1]
	addpd xmm1, [rsp + nb104_fjyH1]
	addpd xmm2, [rsp + nb104_fjzH1]
	addpd xmm3, [rsp + nb104_fjxH2]
	addpd xmm4, [rsp + nb104_fjyH2]
	addpd xmm5, [rsp + nb104_fjzH2]
	addpd xmm6, [rsp + nb104_fjxM]
	addpd xmm7, [rsp + nb104_fjyM]
	movlpd [rdi + rax*8 + 24], xmm0
	movlpd [rdi + rax*8 + 32], xmm1
	movlpd [rdi + rax*8 + 40], xmm2
	movlpd [rdi + rax*8 + 48], xmm3
	movlpd [rdi + rax*8 + 56], xmm4
	movlpd [rdi + rax*8 + 64], xmm5
	movlpd [rdi + rax*8 + 72], xmm6
	movlpd [rdi + rax*8 + 80], xmm7
	movhpd [rdi + rbx*8 + 24], xmm0
	movhpd [rdi + rbx*8 + 32], xmm1
	movhpd [rdi + rbx*8 + 40], xmm2
	movhpd [rdi + rbx*8 + 48], xmm3
	movhpd [rdi + rbx*8 + 56], xmm4
	movhpd [rdi + rbx*8 + 64], xmm5
	movhpd [rdi + rbx*8 + 72], xmm6
	movhpd [rdi + rbx*8 + 80], xmm7

	movlpd xmm0, [rdi + rax*8 + 88]
	movhpd xmm0, [rdi + rbx*8 + 88]
	addpd xmm0, [rsp + nb104_fjzM]
	movlpd [rdi + rax*8 + 88], xmm0
	movhpd [rdi + rbx*8 + 88], xmm0
...
.nb104_dosingle:
	...
	movapd xmm4, [rsp + nb104_iyM]
	movapd xmm5, [rsp + nb104_izM]
	subsd  xmm0, [rsp + nb104_jxM]
	subsd  xmm1, [rsp + nb104_jyM]
	subsd  xmm2, [rsp + nb104_jzM]
	subsd  xmm3, [rsp + nb104_jxH1]
	subsd  xmm4, [rsp + nb104_jyH1]
	subsd  xmm5, [rsp + nb104_jzH1]
	movapd [rsp + nb104_dxMM], xmm0
	movapd [rsp + nb104_dyMM], xmm1
	movapd [rsp + nb104_dzMM], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb104_iyH1]
	movapd xmm5, [rsp + nb104_izH1]
	subsd  xmm0, [rsp + nb104_jxH2]
	subsd  xmm1, [rsp + nb104_jyH2]
	subsd  xmm2, [rsp + nb104_jzH2]
	subsd  xmm3, [rsp + nb104_jxM]
	subsd  xmm4, [rsp + nb104_jyM]
	subsd  xmm5, [rsp + nb104_jzM]
	movapd [rsp + nb104_dxMH2], xmm0
	movapd [rsp + nb104_dyMH2], xmm1
	movapd [rsp + nb104_dzMH2], xmm2
	mulsd  xmm0, xmm0
	...
	movapd xmm4, [rsp + nb104_iyH1]
	movapd xmm5, [rsp + nb104_izH1]
	subsd  xmm0, [rsp + nb104_jxH1]
	subsd  xmm1, [rsp + nb104_jyH1]
	subsd  xmm2, [rsp + nb104_jzH1]
	subsd  xmm3, [rsp + nb104_jxH2]
	subsd  xmm4, [rsp + nb104_jyH2]
	subsd  xmm5, [rsp + nb104_jzH2]
	movapd [rsp + nb104_dxH1H1], xmm0
	movapd [rsp + nb104_dyH1H1], xmm1
	movapd [rsp + nb104_dzH1H1], xmm2
	mulsd  xmm0, xmm0
	...
	mulsd   xmm3, [rsp + nb104_half] ;# iter1 
	mulsd   xmm7, [rsp + nb104_half] ;# iter1 
	...
	mulsd   xmm1, [rsp + nb104_half] ;# rinv 
	mulsd   xmm5, [rsp + nb104_half] ;# rinv 
	movapd [rsp + nb104_rinvH2H2], xmm1
	movapd [rsp + nb104_rinvH2H1], xmm5
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb104_half] ;# iter1 of  
	mulsd   xmm7, [rsp + nb104_half] ;# iter1 of  
	...
	mulsd   xmm3, xmm2	;# luA*(3-rsqA*luA*luA) 
	mulsd   xmm7, xmm6	;# luB*(3-rsqB*luB*luB) 
	mulsd   xmm3, [rsp + nb104_half] ;# iter1a 
	mulsd   xmm7, [rsp + nb104_half] ;# iter1b 
	...
	movapd xmm7, xmm0
	mulsd  xmm0, xmm0
	mulsd  xmm7, [rsp + nb104_qqMM]
	mulsd  xmm0, xmm7	
	addsd  xmm7, [rsp + nb104_vctot] 
	movapd xmm1, xmm0
	movapd xmm2, xmm0
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb104_dxMM]
	mulsd xmm1, [rsp + nb104_dyMM]
	mulsd xmm2, [rsp + nb104_dzMM]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixM]
	addsd xmm1, [rsp + nb104_fiyM]
	addsd xmm2, [rsp + nb104_fizM]
	movlpd [rsp + nb104_fjxM], xmm3
	movlpd [rsp + nb104_fjyM], xmm4
	movlpd [rsp + nb104_fjzM], xmm5
	movlpd [rsp + nb104_fixM], xmm0
	movlpd [rsp + nb104_fiyM], xmm1
	movlpd [rsp + nb104_fizM], xmm2
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb104_dxMH1]
	mulsd xmm1, [rsp + nb104_dyMH1]
	mulsd xmm2, [rsp + nb104_dzMH1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixM]
	addsd xmm1, [rsp + nb104_fiyM]
	addsd xmm2, [rsp + nb104_fizM]
	movlpd [rsp + nb104_fjxH1], xmm3
	movlpd [rsp + nb104_fjyH1], xmm4
	movlpd [rsp + nb104_fjzH1], xmm5
	movlpd [rsp + nb104_fixM], xmm0
	movlpd [rsp + nb104_fiyM], xmm1
	movlpd [rsp + nb104_fizM], xmm2
	...
	movapd xmm4, xmm3
	movapd xmm5, xmm3
	mulsd xmm0, [rsp + nb104_dxMH2]
	mulsd xmm1, [rsp + nb104_dyMH2]
	mulsd xmm2, [rsp + nb104_dzMH2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixM]
	addsd xmm1, [rsp + nb104_fiyM]
	addsd xmm2, [rsp + nb104_fizM]
	movlpd [rsp + nb104_fjxH2], xmm3
	movlpd [rsp + nb104_fjyH2], xmm4
	movlpd [rsp + nb104_fjzH2], xmm5
	movlpd [rsp + nb104_fixM], xmm0
	movlpd [rsp + nb104_fiyM], xmm1
	movlpd [rsp + nb104_fizM], xmm2
	...
	movapd xmm4, [rsp + nb104_fjyM]
	movapd xmm5, [rsp + nb104_fjzM]
	mulsd xmm0, [rsp + nb104_dxH1M]
	mulsd xmm1, [rsp + nb104_dyH1M]
	mulsd xmm2, [rsp + nb104_dzH1M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixH1]
	addsd xmm1, [rsp + nb104_fiyH1]
	addsd xmm2, [rsp + nb104_fizH1]
	movlpd [rsp + nb104_fjxM], xmm3
	movlpd [rsp + nb104_fjyM], xmm4
	movlpd [rsp + nb104_fjzM], xmm5
	movlpd [rsp + nb104_fixH1], xmm0
	movlpd [rsp + nb104_fiyH1], xmm1
	movlpd [rsp + nb104_fizH1], xmm2
	...
	movapd xmm4, [rsp + nb104_fjyH1]
	movapd xmm5, [rsp + nb104_fjzH1]
	mulsd xmm0, [rsp + nb104_dxH1H1]
	mulsd xmm1, [rsp + nb104_dyH1H1]
	mulsd xmm2, [rsp + nb104_dzH1H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixH1]
	...
	movapd xmm4, [rsp + nb104_fjyH2]
	movapd xmm5, [rsp + nb104_fjzH2]
	mulsd xmm0, [rsp + nb104_dxH1H2]
	mulsd xmm1, [rsp + nb104_dyH1H2]
	mulsd xmm2, [rsp + nb104_dzH1H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixH1]
	...
	movapd xmm4, [rsp + nb104_fjyM]
	movapd xmm5, [rsp + nb104_fjzM]
	mulsd xmm0, [rsp + nb104_dxH2M]
	mulsd xmm1, [rsp + nb104_dyH2M]
	mulsd xmm2, [rsp + nb104_dzH2M]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixH2]
	addsd xmm1, [rsp + nb104_fiyH2]
	addsd xmm2, [rsp + nb104_fizH2]
	movlpd [rsp + nb104_fjxM], xmm3
	movlpd [rsp + nb104_fjyM], xmm4
	movlpd [rsp + nb104_fjzM], xmm5
	movlpd [rsp + nb104_fixH2], xmm0
	movlpd [rsp + nb104_fiyH2], xmm1
	movlpd [rsp + nb104_fizH2], xmm2
	...
	movapd xmm4, [rsp + nb104_fjyH1]
	movapd xmm5, [rsp + nb104_fjzH1]
	mulsd xmm0, [rsp + nb104_dxH2H1]
	mulsd xmm1, [rsp + nb104_dyH2H1]
	mulsd xmm2, [rsp + nb104_dzH2H1]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixH2]
	...
	addsd xmm7, xmm1	;# add to local vctot 
	movapd xmm1, xmm0
	movsd [rsp + nb104_vctot], xmm7
	movapd xmm2, xmm0
	movapd xmm3, [rsp + nb104_fjxH2]
	movapd xmm4, [rsp + nb104_fjyH2]
	movapd xmm5, [rsp + nb104_fjzH2]
	mulsd xmm0, [rsp + nb104_dxH2H2]
	mulsd xmm1, [rsp + nb104_dyH2H2]
	mulsd xmm2, [rsp + nb104_dzH2H2]
	subsd xmm3, xmm0
	subsd xmm4, xmm1
	subsd xmm5, xmm2
	addsd xmm0, [rsp + nb104_fixH2]
	...
	movlpd xmm6, [rdi + rax*8 + 72]
	movlpd xmm7, [rdi + rax*8 + 80]
	addsd xmm0, [rsp + nb104_fjxH1]
	addsd xmm1, [rsp + nb104_fjyH1]
	addsd xmm2, [rsp + nb104_fjzH1]
	addsd xmm3, [rsp + nb104_fjxH2]
	addsd xmm4, [rsp + nb104_fjyH2]
	addsd xmm5, [rsp + nb104_fjzH2]
	addsd xmm6, [rsp + nb104_fjxM]
	addsd xmm7, [rsp + nb104_fjyM]
	movlpd [rdi + rax*8 + 24], xmm0
	movlpd [rdi + rax*8 + 32], xmm1
	movlpd [rdi + rax*8 + 40], xmm2
	movlpd [rdi + rax*8 + 48], xmm3
