...
.nb301_unroll_loop:
	...
	movapd xmm4, [rsp + nb301_ixO]
	movapd xmm5, [rsp + nb301_iyO]
	movapd xmm6, [rsp + nb301_izO]
	...
	movapd xmm4, [rsp + nb301_ixH1]
	movapd xmm5, [rsp + nb301_iyH1]
	movapd xmm6, [rsp + nb301_izH1]
	...
	movapd xmm3, [rsp + nb301_ixH2]
	movapd xmm4, [rsp + nb301_iyH2]
	movapd xmm5, [rsp + nb301_izH2]
	...
	mulpd   xmm4, [rsp + nb301_half] ;# iter1 ( new lu) 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [rsp + nb301_half] ;# rinv 
	...
	mulpd  xmm7, [rsp + nb301_two]	;# two*Heps2 
    ...
    addpd  xmm5, [rsp + nb301_vctot]
    movapd [rsp + nb301_vctot], xmm5 
	xorpd  xmm4, xmm4

	mulpd  xmm3, [rsp + nb301_tsc]
	...
	movapd [rsp + nb301_fiyO], xmm4
	movapd [rsp + nb301_fizO], xmm7
	;# update j forces with water O 
	movapd [rsp + nb301_fjx], xmm0
	movapd [rsp + nb301_fjy], xmm1
	movapd [rsp + nb301_fjz], xmm2
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb301_fixH1], xmm3
	movapd [rsp + nb301_fiyH1], xmm4
	movapd [rsp + nb301_fizH1], xmm7
	;# update j forces with water H1 
	addpd  xmm0, [rsp + nb301_fjx]
	addpd  xmm1, [rsp + nb301_fjy]
	addpd  xmm2, [rsp + nb301_fjz]
	movapd [rsp + nb301_fjx], xmm0
	movapd [rsp + nb301_fjy], xmm1
	movapd [rsp + nb301_fjz], xmm2
	...
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [rsp + nb301_fixH2], xmm3
	movapd [rsp + nb301_fiyH2], xmm4
	movapd [rsp + nb301_fizH2], xmm7
