...
.nb330_unroll_loop:	
	...
	movaps xmm4, [rsp + nb330_ix]
	movaps xmm5, [rsp + nb330_iy]
	movaps xmm6, [rsp + nb330_iz]
	...
	;# store dr 
	movaps [rsp + nb330_dx], xmm4
	movaps [rsp + nb330_dy], xmm5
	movaps [rsp + nb330_dz], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm2, xmm5
	mulps xmm5, xmm5
	movaps xmm1, [rsp + nb330_three]
	mulps xmm5, xmm4	;# rsq*lu*lu 			
	movaps xmm0, [rsp + nb330_half]
	subps xmm1, xmm5	;# 30-rsq*lu*lu 
	mulps xmm1, xmm2	
	mulps xmm0, xmm1	;# xmm0=rinv 
	mulps xmm4, xmm0	;# xmm4=r 
	mulps xmm4, [rsp + nb330_tsc]
	...
	mulps  xmm7, [rsp + nb330_two]	;# two*Heps2 
	movaps xmm3, [rsp + nb330_qq]
	addps  xmm7, xmm6
	...
	;# update vctot 
	addps  xmm5, [rsp + nb330_vctot]
	movaps [rsp + nb330_vctot], xmm5 

	;# put scalar force on stack temporarily 
	movaps [rsp + nb330_fscal], xmm3
	...
	movaps xmm4, [rsp + nb330_c6]
	mulps  xmm7, xmm4	 ;# fijD 
	mulps  xmm5, xmm4	 ;# Vvdw6 
	addps  xmm7, [rsp + nb330_fscal] ;# add to fscal 

	;# put scalar force on stack Update Vvdwtot directly 
	addps  xmm5, [rsp + nb330_Vvdwtot]
	movaps [rsp + nb330_fscal], xmm7
	...
	movaps xmm4, [rsp + nb330_c12]
	mulps  xmm7, xmm4 ;# fijR 
	mulps  xmm5, xmm4 ;# Vvdw12 
	addps  xmm7, [rsp + nb330_fscal] 
	
	addps  xmm5, [rsp + nb330_Vvdwtot]
	movaps [rsp + nb330_Vvdwtot], xmm5
	xorps  xmm4, xmm4

	mulps xmm7, [rsp + nb330_tsc]
	mulps xmm7, xmm0
	subps  xmm4, xmm7

	movaps xmm0, [rsp + nb330_dx]
	movaps xmm1, [rsp + nb330_dy]
	movaps xmm2, [rsp + nb330_dz]
	...
	;# now update f_i 
	movaps xmm3, [rsp + nb330_fix]
	movaps xmm4, [rsp + nb330_fiy]
	movaps xmm5, [rsp + nb330_fiz]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm5, xmm2
	movaps [rsp + nb330_fix], xmm3
	movaps [rsp + nb330_fiy], xmm4
	movaps [rsp + nb330_fiz], xmm5
...
.nb330_dosingle:
	...
	mulps  xmm6, [rsp + nb330_iq]
	movaps [rsp + nb330_qq], xmm6
	...
	;# increment vcoul - then we can get rid of mm5 
	;# update vctot 
	addss  xmm5, [rsp + nb330_vctot]
	movss [rsp + nb330_vctot], xmm5 
	...
	;# put scalar force on stack Update Vvdwtot directly 
	addss  xmm5, [rsp + nb330_Vvdwtot]
	movaps [rsp + nb330_fscal], xmm7
	movss [rsp + nb330_Vvdwtot], xmm5
