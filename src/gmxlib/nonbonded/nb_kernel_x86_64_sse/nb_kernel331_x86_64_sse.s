...
.nb331_unroll_loop:
	...
	movaps xmm4, [rsp + nb331_ixO]
	movaps xmm5, [rsp + nb331_iyO]
	movaps xmm6, [rsp + nb331_izO]
	...
	;# store dr 
	movaps [rsp + nb331_dxO], xmm4
	movaps [rsp + nb331_dyO], xmm5
	movaps [rsp + nb331_dzO], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm4, [rsp + nb331_ixH1]
	movaps xmm5, [rsp + nb331_iyH1]
	movaps xmm6, [rsp + nb331_izH1]
	...
	;# store dr 
	movaps [rsp + nb331_dxH1], xmm4
	movaps [rsp + nb331_dyH1], xmm5
	movaps [rsp + nb331_dzH1], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm3, [rsp + nb331_ixH2]
	movaps xmm4, [rsp + nb331_iyH2]
	movaps xmm5, [rsp + nb331_izH2]
	...
	;# store dr 
	movaps [rsp + nb331_dxH2], xmm3
	movaps [rsp + nb331_dyH2], xmm4
	movaps [rsp + nb331_dzH2], xmm5
	;# square it 
	mulps xmm3,xmm3
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	...
	movaps  xmm3, xmm2
	mulps   xmm2, xmm2
	movaps  xmm4, [rsp + nb331_three]
	mulps   xmm2, xmm7	;# rsq*lu*lu 
	subps   xmm4, xmm2	;# 30-rsq*lu*lu 
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb331_half]
	movaps  [rsp + nb331_rinvO], xmm4	;# rinvO in xmm4 
	mulps   xmm7, xmm4
	movaps  [rsp + nb331_rO], xmm7	
	...
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb331_half]
	movaps  [rsp + nb331_rinvH1], xmm4	;# rinvH1 in xmm4 
	mulps   xmm6, xmm4
	movaps  [rsp + nb331_rH1], xmm6
	...
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb331_half]
	movaps  [rsp + nb331_rinvH2], xmm4	;# rinvH2 in xmm4 
	mulps   xmm5, xmm4
	movaps  [rsp + nb331_rH2], xmm5
	...
	;# update O forces 
	movaps xmm3, [rsp + nb331_fixO]
	movaps xmm4, [rsp + nb331_fiyO]
	movaps xmm7, [rsp + nb331_fizO]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb331_fixO], xmm3
	movaps [rsp + nb331_fiyO], xmm4
	movaps [rsp + nb331_fizO], xmm7
	;# update j forces with water O 
	movaps [rsp + nb331_fjx], xmm0
	movaps [rsp + nb331_fjy], xmm1
	movaps [rsp + nb331_fjz], xmm2

	;# Done with O interactions - now H1! 
	movaps xmm7, [rsp + nb331_rH1]
	mulps   xmm7, [rsp + nb331_tsc]
	movhlps xmm4, xmm7
	cvttps2pi mm6, xmm7
	cvttps2pi mm7, xmm4    ;# mm6/mm7 contain lu indices 
	...
	xorps  xmm4, xmm4
    addps  xmm5, [rsp + nb331_vctot]
	mulps  xmm7, [rsp + nb331_rinvH1]
    movaps [rsp + nb331_vctot], xmm5 
	mulps  xmm7, [rsp + nb331_tsc]
	subps xmm4, xmm7

	movaps xmm0, [rsp + nb331_dxH1]
	movaps xmm1, [rsp + nb331_dyH1]
	movaps xmm2, [rsp + nb331_dzH1]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H1 forces 
	movaps xmm3, [rsp + nb331_fixH1]
	movaps xmm4, [rsp + nb331_fiyH1]
	movaps xmm7, [rsp + nb331_fizH1]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb331_fixH1], xmm3
	movaps [rsp + nb331_fiyH1], xmm4
	movaps [rsp + nb331_fizH1], xmm7
	;# update j forces with water H1 
	addps  xmm0, [rsp + nb331_fjx]
	addps  xmm1, [rsp + nb331_fjy]
	addps  xmm2, [rsp + nb331_fjz]
	movaps [rsp + nb331_fjx], xmm0
	movaps [rsp + nb331_fjy], xmm1
	movaps [rsp + nb331_fjz], xmm2

	;# Done with H1, finally we do H2 interactions 
	movaps xmm7, [rsp + nb331_rH2]
	mulps   xmm7, [rsp + nb331_tsc]
	movhlps xmm4, xmm7
	cvttps2pi mm6, xmm7
	cvttps2pi mm7, xmm4    ;# mm6/mm7 contain lu indices 
	...
	xorps  xmm4, xmm4
    addps  xmm5, [rsp + nb331_vctot]
	mulps  xmm7, [rsp + nb331_rinvH2]
    movaps [rsp + nb331_vctot], xmm5 
	mulps  xmm7, [rsp + nb331_tsc]
	subps  xmm4, xmm7

	movaps xmm0, [rsp + nb331_dxH2]
	movaps xmm1, [rsp + nb331_dyH2]
	movaps xmm2, [rsp + nb331_dzH2]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4
	...
	;# update H2 forces 
	movaps xmm3, [rsp + nb331_fixH2]
	movaps xmm4, [rsp + nb331_fiyH2]
	movaps xmm7, [rsp + nb331_fizH2]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb331_fixH2], xmm3
	movaps [rsp + nb331_fiyH2], xmm4
	movaps [rsp + nb331_fizH2], xmm7
...
.nb331_odd_loop:
	...
	movss xmm3, [rsp + nb331_ixO]
	movss xmm4, [rsp + nb331_iyO]
	movss xmm5, [rsp + nb331_izO]
