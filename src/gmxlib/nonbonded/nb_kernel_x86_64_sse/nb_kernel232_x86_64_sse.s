...
.nb232_unroll_loop:	
	...
	movaps [rsp + nb232_jyO], xmm2
	movlhps  xmm1, xmm3
	movaps [rsp + nb232_jxH1], xmm1
	movhlps  xmm3, xmm7
	movaps   xmm6, xmm4
	movaps [rsp + nb232_jyH1], xmm3
	movlhps  xmm4, xmm5
	movaps [rsp + nb232_jxH2], xmm4
	movhlps  xmm5, xmm6
	movaps [rsp + nb232_jyH2], xmm5
	...
	movaps [rsp + nb232_jzO],  xmm0
	movaps [rsp + nb232_jzH1],  xmm1
	movaps [rsp + nb232_jzH2],  xmm2

	movaps xmm0, [rsp + nb232_ixO]
	movaps xmm1, [rsp + nb232_iyO]
	movaps xmm2, [rsp + nb232_izO]
	movaps xmm3, [rsp + nb232_ixO]
	movaps xmm4, [rsp + nb232_iyO]
	movaps xmm5, [rsp + nb232_izO]
	subps  xmm0, [rsp + nb232_jxO]
	subps  xmm1, [rsp + nb232_jyO]
	subps  xmm2, [rsp + nb232_jzO]
	subps  xmm3, [rsp + nb232_jxH1]
	subps  xmm4, [rsp + nb232_jyH1]
	subps  xmm5, [rsp + nb232_jzH1]
	...
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb232_dxOH1], xmm3
	movaps [rsp + nb232_dyOH1], xmm4
	movaps [rsp + nb232_dzOH1], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	movaps xmm1, [rsp + nb232_iyO]
	movaps xmm2, [rsp + nb232_izO]
	movaps xmm3, [rsp + nb232_ixH1]
	movaps xmm4, [rsp + nb232_iyH1]
	movaps xmm5, [rsp + nb232_izH1]
	subps  xmm0, [rsp + nb232_jxH2]
	subps  xmm1, [rsp + nb232_jyH2]
	subps  xmm2, [rsp + nb232_jzH2]
	subps  xmm3, [rsp + nb232_jxO]
	subps  xmm4, [rsp + nb232_jyO]
	subps  xmm5, [rsp + nb232_jzO]
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb232_rsqOH2], xmm0
	movaps [rsp + nb232_rsqH1O], xmm3

	movaps xmm0, [rsp + nb232_ixH1]
	movaps xmm1, [rsp + nb232_iyH1]
	movaps xmm2, [rsp + nb232_izH1]
	movaps xmm3, [rsp + nb232_ixH1]
	movaps xmm4, [rsp + nb232_iyH1]
	movaps xmm5, [rsp + nb232_izH1]
	subps  xmm0, [rsp + nb232_jxH1]
	subps  xmm1, [rsp + nb232_jyH1]
	subps  xmm2, [rsp + nb232_jzH1]
	subps  xmm3, [rsp + nb232_jxH2]
	subps  xmm4, [rsp + nb232_jyH2]
	subps  xmm5, [rsp + nb232_jzH2]
	movaps [rsp + nb232_dxH1H1], xmm0
	movaps [rsp + nb232_dyH1H1], xmm1
	movaps [rsp + nb232_dzH1H1], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb232_rsqH1H1], xmm0
	movaps [rsp + nb232_rsqH1H2], xmm3

	movaps xmm0, [rsp + nb232_ixH2]
	movaps xmm1, [rsp + nb232_iyH2]
	movaps xmm2, [rsp + nb232_izH2]
	movaps xmm3, [rsp + nb232_ixH2]
	movaps xmm4, [rsp + nb232_iyH2]
	movaps xmm5, [rsp + nb232_izH2]
	subps  xmm0, [rsp + nb232_jxO]
	subps  xmm1, [rsp + nb232_jyO]
	subps  xmm2, [rsp + nb232_jzO]
	subps  xmm3, [rsp + nb232_jxH1]
	subps  xmm4, [rsp + nb232_jyH1]
	subps  xmm5, [rsp + nb232_jzH1]
	movaps [rsp + nb232_dxH2O], xmm0
	movaps [rsp + nb232_dyH2O], xmm1
	movaps [rsp + nb232_dzH2O], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb232_dxH2H1], xmm3
	movaps [rsp + nb232_dyH2H1], xmm4
	movaps [rsp + nb232_dzH2H1], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm4, xmm3
	addps  xmm4, xmm5
	movaps [rsp + nb232_rsqH2O], xmm0
	movaps [rsp + nb232_rsqH2H1], xmm4
	...
	subps  xmm1, [rsp + nb232_jyH2]
	subps  xmm2, [rsp + nb232_jzH2]
	movaps [rsp + nb232_dxH2H2], xmm0
	movaps [rsp + nb232_dyH2H2], xmm1
	movaps [rsp + nb232_dzH2H2], xmm2
	mulps xmm0, xmm0
	mulps xmm1, xmm1
	mulps xmm2, xmm2
	addps xmm0, xmm1
	addps xmm0, xmm2
	movaps [rsp + nb232_rsqH2H2], xmm0
	...
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb232_half] ;# rinvH2H2 
	mulps   xmm7, [rsp + nb232_half] ;# rinvH2H1 
	movaps  [rsp + nb232_rinvH2H2], xmm3
	movaps  [rsp + nb232_rinvH2H1], xmm7
	
	rsqrtps xmm1, [rsp + nb232_rsqOO]
	rsqrtps xmm5, [rsp + nb232_rsqOH1]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb232_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb232_rsqOO]
	mulps   xmm5, [rsp + nb232_rsqOH1]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb232_half] 
	mulps   xmm7, [rsp + nb232_half]
	movaps  [rsp + nb232_rinvOO], xmm3
	movaps  [rsp + nb232_rinvOH1], xmm7
	
	rsqrtps xmm1, [rsp + nb232_rsqOH2]
	rsqrtps xmm5, [rsp + nb232_rsqH1O]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb232_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb232_rsqOH2]
	mulps   xmm5, [rsp + nb232_rsqH1O]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb232_half] 
	mulps   xmm7, [rsp + nb232_half]
	movaps  [rsp + nb232_rinvOH2], xmm3
	movaps  [rsp + nb232_rinvH1O], xmm7
	
	rsqrtps xmm1, [rsp + nb232_rsqH1H1]
	rsqrtps xmm5, [rsp + nb232_rsqH1H2]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb232_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb232_rsqH1H1]
	mulps   xmm5, [rsp + nb232_rsqH1H2]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb232_half] 
	mulps   xmm7, [rsp + nb232_half]
	movaps  [rsp + nb232_rinvH1H1], xmm3
	movaps  [rsp + nb232_rinvH1H2], xmm7
	
	rsqrtps xmm1, [rsp + nb232_rsqH2O]
	movaps  xmm2, xmm1
	mulps   xmm1, xmm1
	movaps  xmm3, [rsp + nb232_three]
	mulps   xmm1, [rsp + nb232_rsqH2O]
	subps   xmm3, xmm1
	mulps   xmm3, xmm2
	mulps   xmm3, [rsp + nb232_half] 
	movaps  [rsp + nb232_rinvH2O], xmm3

	;# start with OO interaction - first the table LJ part
	movaps xmm0, [rsp + nb232_rinvOO]
	movaps xmm1, xmm0
	mulps  xmm1, [rsp + nb232_rsqOO] ;# xmm1=r 
	mulps  xmm1, [rsp + nb232_tsc]
    ...
    mulps  xmm7, [rsp + nb232_two]       ;# two*Heps2 
    addps  xmm7, xmm6
    addps  xmm7, xmm5 ;# xmm7=FF 
    mulps  xmm5, xmm1 ;# xmm5=eps*Fp 
    addps  xmm5, xmm4 ;# xmm5=VV 

    movaps xmm4, [rsp + nb232_c6]
    ...
    movaps xmm4, [rsp + nb232_c12]
    mulps  xmm7, xmm4 ;# fijR 
    mulps  xmm5, xmm4 ;# Vvdw12 
    addps  xmm7, [rsp + nb232_fstmp] 
	...
	movaps xmm5, [rsp + nb232_krf]
	mulps  xmm5, [rsp + nb232_rsqOO] ;# xmm5=krsq 
	movaps xmm6, xmm5
	addps  xmm6, xmm2	;# xmm6=rinv+ krsq 
	subps  xmm6, [rsp + nb232_crf]
	
	mulps  xmm6, [rsp + nb232_qqOO] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulps xmm5, [rsp + nb232_two]
	subps  xmm2, xmm5	;# xmm2=rinv-2*krsq 
	mulps  xmm2, [rsp + nb232_qqOO] ;# xmm2 = coul part of fscal 
	
	addps  xmm6, [rsp + nb232_vctot] ;# local vctot summation variable 
	...
	;# O-H1 interaction 
	movaps xmm0, [rsp + nb232_rinvOH1]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb232_krf]
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb232_rsqOH1] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=rinv+ krsq 
	mulps  xmm0, xmm0
	subps  xmm4, [rsp + nb232_crf]
	mulps  xmm4, [rsp + nb232_qqOH] ;# xmm4=voul=qq*(rinv+ krsq) 
	mulps  xmm5, [rsp + nb232_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb232_qqOH] ;# xmm7 = coul part of fscal 
	...
	addps xmm1, [rsp + nb232_fiyO]
	addps xmm2, [rsp + nb232_fizO]
	movaps [rsp + nb232_fjxH1], xmm3
	movaps [rsp + nb232_fjyH1], xmm4
	movaps [rsp + nb232_fjzH1], xmm5
	movaps [rsp + nb232_fixO], xmm0
	movaps [rsp + nb232_fiyO], xmm1
	movaps [rsp + nb232_fizO], xmm2

	;# O-H2 interaction  
	movaps xmm0, [rsp + nb232_rinvOH2]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb232_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb232_rsqOH2] ;# xmm5=krsq 
	movaps xmm4, xmm5
	...
	addps xmm1, [rsp + nb232_fiyO]
	addps xmm2, [rsp + nb232_fizO]
	movaps [rsp + nb232_fjxH2], xmm3
	movaps [rsp + nb232_fjyH2], xmm4
	movaps [rsp + nb232_fjzH2], xmm5
	movaps [rsp + nb232_fixO], xmm0
	movaps [rsp + nb232_fiyO], xmm1
	movaps [rsp + nb232_fizO], xmm2

	;# H1-O interaction 
	movaps xmm0, [rsp + nb232_rinvH1O]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb232_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb232_rsqH1O] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=rinv+ krsq 
	mulps xmm0, xmm0
	subps  xmm4, [rsp + nb232_crf]
	...
	;# H1-H1 interaction 
	movaps xmm0, [rsp + nb232_rinvH1H1]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb232_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb232_rsqH1H1] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb232_crf]
	mulps xmm0, xmm0
	mulps  xmm4, [rsp + nb232_qqHH] ;# xmm4=voul=qq*(rinv+ krsq) 
	mulps  xmm5, [rsp + nb232_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb232_qqHH] ;# xmm7 = coul part of fscal 
	addps  xmm6, xmm4	;# add to local vctot 
	mulps xmm0, xmm7	;# fsOH2 
	movaps xmm1, xmm0
	movaps xmm2, xmm0

	movaps xmm3, [rsp + nb232_fjxH1]
	movaps xmm4, [rsp + nb232_fjyH1]
	movaps xmm5, [rsp + nb232_fjzH1]
	mulps xmm0, [rsp + nb232_dxH1H1]
	mulps xmm1, [rsp + nb232_dyH1H1]
	mulps xmm2, [rsp + nb232_dzH1H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb232_fixH1]
	...
	;# H1-H2 interaction 
	movaps xmm0, [rsp + nb232_rinvH1H2]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb232_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb232_rsqH1H2] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	mulps xmm0, xmm0
	subps  xmm4, [rsp + nb232_crf]
	...
	movaps xmm3, [rsp + nb232_fjxH2]
	movaps xmm4, [rsp + nb232_fjyH2]
	movaps xmm5, [rsp + nb232_fjzH2]
	mulps xmm0, [rsp + nb232_dxH1H2]
	mulps xmm1, [rsp + nb232_dyH1H2]
	mulps xmm2, [rsp + nb232_dzH1H2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb232_fixH1]
	...
	;# H2-O interaction 
	movaps xmm0, [rsp + nb232_rinvH2O]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb232_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb232_rsqH2O] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb232_crf]
	mulps xmm0, xmm0
	...
	;# H2-H1 interaction 
	movaps xmm0, [rsp + nb232_rinvH2H1]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb232_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb232_rsqH2H1] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb232_crf]
	mulps xmm0, xmm0
	...
	movaps xmm4, [rsp + nb232_fjyH1]
	movaps xmm5, [rsp + nb232_fjzH1]
	mulps xmm0, [rsp + nb232_dxH2H1]
	mulps xmm1, [rsp + nb232_dyH2H1]
	mulps xmm2, [rsp + nb232_dzH2H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb232_fixH2]
	...
	;# H2-H2 interaction 
	movaps xmm0, [rsp + nb232_rinvH2H2]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb232_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb232_rsqH2H2] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb232_crf]
	mulps xmm0, xmm0
	...
	movaps xmm4, [rsp + nb232_fjyH2]
	movaps xmm5, [rsp + nb232_fjzH2]
	mulps xmm0, [rsp + nb232_dxH2H2]
	mulps xmm1, [rsp + nb232_dyH2H2]
	mulps xmm2, [rsp + nb232_dzH2H2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb232_fixH2]
	...
	movaps xmm0, [rsp + nb232_fjxO] ;# xmm0= fjxOa  fjxOb  fjxOc  fjxOd 
	movaps xmm2, [rsp + nb232_fjyO] ;# xmm1= fjyOa  fjyOb  fjyOc  fjyOd
	...
	movaps xmm0, [rsp + nb232_fjzO]  ;# xmm0= fjzOa   fjzOb   fjzOc   fjzOd 
	movaps xmm2, [rsp + nb232_fjxH1] ;# xmm1= fjxH1a  fjxH1b  fjxH1c  fjxH1d
	...
	movaps xmm0, [rsp + nb232_fjyH1]  ;# xmm0= fjyH1a  fjyH1b  fjyH1c  fjyH1d 
	movaps xmm2, [rsp + nb232_fjzH1] ;# xmm1= fjzH1a  fjzH1b  fjzH1c  fjzH1d
	...
	movaps xmm0, [rsp + nb232_fjxH2]  ;# xmm0= fjxH2a  fjxH2b  fjxH2c  fjxH2d 
	movaps xmm2, [rsp + nb232_fjyH2] ;# xmm1= fjyH2a  fjyH2b  fjyH2c  fjyH2d
	...
	addss xmm4, [rsp + nb232_fjzH2] 
	addss xmm5, [rsp + nb232_fjzH2 + 4] 
	addss xmm6, [rsp + nb232_fjzH2 + 8] 
	addss xmm7, [rsp + nb232_fjzH2 + 12]
	;# store back
...
.nb232_single_loop:
	...
	movaps [rsp + nb232_jxO], xmm3
	movaps [rsp + nb232_jyO], xmm4
	movaps [rsp + nb232_jzO], xmm5
	subps  xmm0, xmm3
	subps  xmm1, xmm4
	subps  xmm2, xmm5
	movaps [rsp + nb232_dxOO], xmm0
