...
.nb301_unroll_loop:
	...
	movaps xmm4, [rsp + nb301_ixO]
	movaps xmm5, [rsp + nb301_iyO]
	movaps xmm6, [rsp + nb301_izO]
	...
	;# store dr 
	movaps [rsp + nb301_dxO], xmm4
	movaps [rsp + nb301_dyO], xmm5
	movaps [rsp + nb301_dzO], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm4, [rsp + nb301_ixH1]
	movaps xmm5, [rsp + nb301_iyH1]
	movaps xmm6, [rsp + nb301_izH1]
	...
	;# store dr 
	movaps [rsp + nb301_dxH1], xmm4
	movaps [rsp + nb301_dyH1], xmm5
	movaps [rsp + nb301_dzH1], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm3, [rsp + nb301_ixH2]
	movaps xmm4, [rsp + nb301_iyH2]
	movaps xmm5, [rsp + nb301_izH2]
	...
	;# store dr 
	movaps [rsp + nb301_dxH2], xmm3
	movaps [rsp + nb301_dyH2], xmm4
	movaps [rsp + nb301_dzH2], xmm5
	;# square it 
	mulps xmm3,xmm3
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	...
	movaps  xmm3, xmm2
	mulps   xmm2, xmm2
	movaps  xmm4, [rsp + nb301_three]
	mulps   xmm2, xmm7	;# rsq*lu*lu 
	subps   xmm4, xmm2	;# 30-rsq*lu*lu 
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb301_half]
	movaps  [rsp + nb301_rinvO], xmm4	;# rinvO in xmm4 
	mulps   xmm7, xmm4
	movaps  [rsp + nb301_rO], xmm7	
	...
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb301_half]
	movaps  [rsp + nb301_rinvH1], xmm4	;# rinvH1 in xmm4 
	mulps   xmm6, xmm4
	movaps  [rsp + nb301_rH1], xmm6
	...
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb301_half]
	movaps  [rsp + nb301_rinvH2], xmm4	;# rinvH2 in xmm4 
	mulps   xmm5, xmm4
	movaps  [rsp + nb301_rH2], xmm5

	;# do O interactions 
	;# rO is still in xmm7 
	mulps   xmm7, [rsp + nb301_tsc]
	movhlps xmm4, xmm7
	cvttps2pi mm6, xmm7
	...
	;# update O forces 
	movaps xmm3, [rsp + nb301_fixO]
	movaps xmm4, [rsp + nb301_fiyO]
	movaps xmm7, [rsp + nb301_fizO]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb301_fixO], xmm3
	movaps [rsp + nb301_fiyO], xmm4
	movaps [rsp + nb301_fizO], xmm7
	;# update j forces with water O 
	movaps [rsp + nb301_fjx], xmm0
	movaps [rsp + nb301_fjy], xmm1
	movaps [rsp + nb301_fjz], xmm2

	;# Done with O interactions - now H1! 
	movaps xmm7, [rsp + nb301_rH1]
	mulps   xmm7, [rsp + nb301_tsc]
	movhlps xmm4, xmm7
	cvttps2pi mm6, xmm7
	cvttps2pi mm7, xmm4    ;# mm6/mm7 contain lu indices 
	...
	movaps xmm0, [rsp + nb301_dxH1]
	movaps xmm1, [rsp + nb301_dyH1]
	movaps xmm2, [rsp + nb301_dzH1]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H1 forces 
	movaps xmm3, [rsp + nb301_fixH1]
	movaps xmm4, [rsp + nb301_fiyH1]
	movaps xmm7, [rsp + nb301_fizH1]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb301_fixH1], xmm3
	movaps [rsp + nb301_fiyH1], xmm4
	movaps [rsp + nb301_fizH1], xmm7
	;# update j forces with water H1 
	addps  xmm0, [rsp + nb301_fjx]
	addps  xmm1, [rsp + nb301_fjy]
	addps  xmm2, [rsp + nb301_fjz]
	movaps [rsp + nb301_fjx], xmm0
	movaps [rsp + nb301_fjy], xmm1
	movaps [rsp + nb301_fjz], xmm2

	;# Done with H1, finally we do H2 interactions 
	movaps xmm7, [rsp + nb301_rH2]
	mulps   xmm7, [rsp + nb301_tsc]
	movhlps xmm4, xmm7
	cvttps2pi mm6, xmm7
	cvttps2pi mm7, xmm4    ;# mm6/mm7 contain lu indices 
	...
	xorps  xmm4, xmm4
    	addps  xmm5, [rsp + nb301_vctot]
	mulps  xmm7, [rsp + nb301_rinvH2]
    	movaps [rsp + nb301_vctot], xmm5 
	mulps  xmm7, [rsp + nb301_tsc]
	subps  xmm4, xmm7

	movaps xmm0, [rsp + nb301_dxH2]
	movaps xmm1, [rsp + nb301_dyH2]
	movaps xmm2, [rsp + nb301_dzH2]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4
	...
	;# update H2 forces 
	movaps xmm3, [rsp + nb301_fixH2]
	movaps xmm4, [rsp + nb301_fiyH2]
	movaps xmm7, [rsp + nb301_fizH2]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb301_fixH2], xmm3
	movaps [rsp + nb301_fiyH2], xmm4
	movaps [rsp + nb301_fizH2], xmm7
...
.nb301_odd_loop:
	...
	movss xmm3, [rsp + nb301_ixO]
	movss xmm4, [rsp + nb301_iyO]
	movss xmm5, [rsp + nb301_izO]
