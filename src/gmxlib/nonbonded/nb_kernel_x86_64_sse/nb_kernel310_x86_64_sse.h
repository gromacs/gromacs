 ...
 */
#ifndef _NB_KERNEL310_X86_64_SSE_H_
#define _NB_KERNEL310_X86_64_SSE_H_

/*! \file  nb_kernel310_x86_64_sse.h
 *  \brief x86_64 SSE-optimized versions of nonbonded kernel 310
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 310 with forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel310_x86_64_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 310 without forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Tabulated <br>
 ...
 */
void
nb_kernel310nf_x86_64_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL310_X86_64_SSE_H_ */
