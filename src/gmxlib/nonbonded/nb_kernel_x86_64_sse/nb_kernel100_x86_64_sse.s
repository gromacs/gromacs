...
.nb100_outer:
	...
	movaps [rsp + nb100_ix], xmm0
	movaps [rsp + nb100_iy], xmm1
	movaps [rsp + nb100_iz], xmm2

	mov   [rsp + nb100_ii3], ebx
	
	;# clear vctot and i forces 
	xorps xmm4, xmm4
	movaps [rsp + nb100_vctot], xmm4
	movaps [rsp + nb100_fix], xmm4
	movaps [rsp + nb100_fiy], xmm4
	movaps [rsp + nb100_fiz], xmm4
...
.nb100_unroll_loop:	
	...
	movaps xmm4, [rsp + nb100_ix]
	movaps xmm5, [rsp + nb100_iy]
	movaps xmm6, [rsp + nb100_iz]
	...
	;# store dr 
	movaps [rsp + nb100_dx], xmm4
	movaps [rsp + nb100_dy], xmm5
	movaps [rsp + nb100_dz], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm5, [rsp + nb100_vctot]
	mulps  xmm3, xmm0	;# xmm3=vcoul 
	mulps  xmm4, xmm3	;# xmm4=fscal 
	addps  xmm5, xmm3

	movaps xmm0, [rsp + nb100_dx]
	movaps xmm1, [rsp + nb100_dy]
	movaps xmm2, [rsp + nb100_dz]

	movaps [rsp + nb100_vctot], xmm5
	...
	;# now update f_i 
	movaps xmm3, [rsp + nb100_fix]
	movaps xmm4, [rsp + nb100_fiy]
	movaps xmm5, [rsp + nb100_fiz]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm5, xmm2
	movaps [rsp + nb100_fix], xmm3
	movaps [rsp + nb100_fiy], xmm4
	movaps [rsp + nb100_fiz], xmm5
...
.nb100_dopair:	
	...
	mov   eax, [rcx]	
	mov   ebx, [rcx + 4]              
	add qword ptr [rsp + nb100_innerjjnr],  8
...
.nb100_updateouterdata:
	...
	movaps xmm0, [rsp + nb100_fix]
	movaps xmm1, [rsp + nb100_fiy]
	movaps xmm2, [rsp + nb100_fiz]
