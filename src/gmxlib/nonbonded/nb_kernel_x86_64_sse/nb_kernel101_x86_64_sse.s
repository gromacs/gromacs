...
.nb101_unroll_loop:
	...
	mulps  xmm3, [rsp + nb101_iqO]
	mulps  xmm4, [rsp + nb101_iqH]

	movaps  [rsp + nb101_qqO], xmm3
	movaps  [rsp + nb101_qqH], xmm4	
	...
	movaps xmm4, [rsp + nb101_ixO]
	movaps xmm5, [rsp + nb101_iyO]
	movaps xmm6, [rsp + nb101_izO]
	...
	;# store dr 
	movaps [rsp + nb101_dxO], xmm4
	movaps [rsp + nb101_dyO], xmm5
	movaps [rsp + nb101_dzO], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm4, [rsp + nb101_ixH1]
	movaps xmm5, [rsp + nb101_iyH1]
	movaps xmm6, [rsp + nb101_izH1]
	...
	;# store dr 
	movaps [rsp + nb101_dxH1], xmm4
	movaps [rsp + nb101_dyH1], xmm5
	movaps [rsp + nb101_dzH1], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm3, [rsp + nb101_ixH2]
	movaps xmm4, [rsp + nb101_iyH2]
	movaps xmm5, [rsp + nb101_izH2]
	...
	;# store dr 
	movaps [rsp + nb101_dxH2], xmm3
	movaps [rsp + nb101_dyH2], xmm4
	movaps [rsp + nb101_dzH2], xmm5
	;# square it 
	mulps xmm3,xmm3
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	...
	mulps  xmm7, [rsp + nb101_qqO]	;# xmm7=vcoul 
	
	mulps  xmm4, xmm7	;# total fsO in xmm4 

	addps  xmm7, [rsp + nb101_vctot]
	
	movaps [rsp + nb101_vctot], xmm7
	...
	;# update O forces 
	movaps xmm3, [rsp + nb101_fixO]
	movaps xmm4, [rsp + nb101_fiyO]
	movaps xmm7, [rsp + nb101_fizO]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb101_fixO], xmm3
	movaps [rsp + nb101_fiyO], xmm4
	movaps [rsp + nb101_fizO], xmm7
	;# update j forces with water O 
	movaps [rsp + nb101_fjx], xmm0
	movaps [rsp + nb101_fjy], xmm1
	movaps [rsp + nb101_fjz], xmm2

	;# H1 interactions 
	movaps  xmm4, xmm6	
	mulps   xmm4, xmm4	;# xmm6=rinv, xmm4=rinvsq 
	mulps  xmm6, [rsp + nb101_qqH]	;# xmm6=vcoul 
	mulps  xmm4, xmm6		;# total fsH1 in xmm4 
	
	addps  xmm6, [rsp + nb101_vctot]

	movaps xmm0, [rsp + nb101_dxH1]
	movaps xmm1, [rsp + nb101_dyH1]
	movaps xmm2, [rsp + nb101_dzH1]
	movaps [rsp + nb101_vctot], xmm6
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H1 forces 
	movaps xmm3, [rsp + nb101_fixH1]
	movaps xmm4, [rsp + nb101_fiyH1]
	movaps xmm7, [rsp + nb101_fizH1]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb101_fixH1], xmm3
	movaps [rsp + nb101_fiyH1], xmm4
	movaps [rsp + nb101_fizH1], xmm7
	;# update j forces with water H1 
	addps  xmm0, [rsp + nb101_fjx]
	addps  xmm1, [rsp + nb101_fjy]
	addps  xmm2, [rsp + nb101_fjz]
	movaps [rsp + nb101_fjx], xmm0
	movaps [rsp + nb101_fjy], xmm1
	movaps [rsp + nb101_fjz], xmm2
	...
	mulps  xmm5, [rsp + nb101_qqH]	;# xmm5=vcoul 
	mulps  xmm4, xmm5		;# total fsH1 in xmm4 
	
	addps  xmm5, [rsp + nb101_vctot]

	movaps xmm0, [rsp + nb101_dxH2]
	movaps xmm1, [rsp + nb101_dyH2]
	movaps xmm2, [rsp + nb101_dzH2]
	movaps [rsp + nb101_vctot], xmm5
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H2 forces 
	movaps xmm3, [rsp + nb101_fixH2]
	movaps xmm4, [rsp + nb101_fiyH2]
	movaps xmm7, [rsp + nb101_fizH2]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb101_fixH2], xmm3
	movaps [rsp + nb101_fiyH2], xmm4
	movaps [rsp + nb101_fizH2], xmm7
...
.nb101_odd_loop:
	...
	movss xmm3, [rsp + nb101_ixO]
	movss xmm4, [rsp + nb101_iyO]
	movss xmm5, [rsp + nb101_izO]
