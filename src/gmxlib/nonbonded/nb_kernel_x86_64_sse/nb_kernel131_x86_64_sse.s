...
.nb131_unroll_loop:
	...
	movaps xmm4, [rsp + nb131_ixO]
	movaps xmm5, [rsp + nb131_iyO]
	movaps xmm6, [rsp + nb131_izO]
	...
	;# store dr 
	movaps [rsp + nb131_dxO], xmm4
	movaps [rsp + nb131_dyO], xmm5
	movaps [rsp + nb131_dzO], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm4, [rsp + nb131_ixH1]
	movaps xmm5, [rsp + nb131_iyH1]
	movaps xmm6, [rsp + nb131_izH1]
	...
	;# store dr 
	movaps [rsp + nb131_dxH1], xmm4
	movaps [rsp + nb131_dyH1], xmm5
	movaps [rsp + nb131_dzH1], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm3, [rsp + nb131_ixH2]
	movaps xmm4, [rsp + nb131_iyH2]
	movaps xmm5, [rsp + nb131_izH2]
	...
	;# store dr 
	movaps [rsp + nb131_dxH2], xmm3
	movaps [rsp + nb131_dyH2], xmm4
	movaps [rsp + nb131_dzH2], xmm5
	;# square it 
	mulps xmm3,xmm3
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	...
	movaps  xmm3, xmm2
	mulps   xmm2, xmm2
	movaps  xmm4, [rsp + nb131_three]
	mulps   xmm2, xmm7	;# rsq*lu*lu 
	subps   xmm4, xmm2	;# constant 30-rsq*lu*lu 
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb131_half]
	movaps  [rsp + nb131_rinvO], xmm4	;# rinvO in xmm0, rsqO in xmm7
	...
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb131_half]
	movaps  [rsp + nb131_rinvH1], xmm4	;# rinvH1 in xmm6 
	...
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb131_half]
	movaps  [rsp + nb131_rinvH2], xmm4	;# rinvH2 in xmm5 
	
	
	;# do O table interactions - rsqO in xmm7.
	mulps xmm7, [rsp + nb131_rinvO]
	mulps xmm7, [rsp + nb131_tsc] ;# rtab
	...
	movaps xmm4, [rsp + nb131_c12]
	mulps  xmm7, xmm4 ;# fijR 
	mulps  xmm5, xmm4 ;# Vvdw12 
	mulps  xmm7, [rsp + nb131_tsc]
	addps  xmm7, [rsp + nb131_fstmp]
	movaps [rsp + nb131_fstmp], xmm7
	...
	;# analytical coulomb
	movaps xmm0, [rsp + nb131_rinvO]
	movaps xmm2, xmm0
	mulps  xmm2, [rsp + nb131_qqO]
	movaps xmm3, xmm2
	...
	;# update O forces 
	movaps xmm3, [rsp + nb131_fixO]
	movaps xmm4, [rsp + nb131_fiyO]
	movaps xmm7, [rsp + nb131_fizO]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb131_fixO], xmm3
	movaps [rsp + nb131_fiyO], xmm4
	movaps [rsp + nb131_fizO], xmm7
	;# update j forces with water O 
	movaps [rsp + nb131_fjx], xmm0
	movaps [rsp + nb131_fjy], xmm1
	movaps [rsp + nb131_fjz], xmm2

	;# H1 interactions 
	movaps xmm0, [rsp + nb131_rinvH1]
	movaps xmm2, xmm0
	...
	movaps xmm0, [rsp + nb131_dxH1]
	movaps xmm1, [rsp + nb131_dyH1]
	movaps xmm2, [rsp + nb131_dzH1]
	...
	;# update H1 forces 
	movaps xmm3, [rsp + nb131_fixH1]
	movaps xmm4, [rsp + nb131_fiyH1]
	movaps xmm7, [rsp + nb131_fizH1]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb131_fixH1], xmm3
	movaps [rsp + nb131_fiyH1], xmm4
	movaps [rsp + nb131_fizH1], xmm7
	;# update j forces with water H1 
	addps  xmm0, [rsp + nb131_fjx]
	addps  xmm1, [rsp + nb131_fjy]
	addps  xmm2, [rsp + nb131_fjz]
	movaps [rsp + nb131_fjx], xmm0
	movaps [rsp + nb131_fjy], xmm1
	movaps [rsp + nb131_fjz], xmm2

	;# H2 interactions 
	movaps xmm0, [rsp + nb131_rinvH2]
	movaps xmm2, xmm0
	mulps  xmm2, [rsp + nb131_qqH]
	movaps xmm3, xmm2
	...
	movaps xmm0, [rsp + nb131_dxH2]
	movaps xmm1, [rsp + nb131_dyH2]
	movaps xmm2, [rsp + nb131_dzH2]

	mulps  xmm0, xmm3
	mulps  xmm1, xmm3
	mulps  xmm2, xmm3
	;# update H2 forces 
	movaps xmm3, [rsp + nb131_fixH2]
	movaps xmm4, [rsp + nb131_fiyH2]
	movaps xmm7, [rsp + nb131_fizH2]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb131_fixH2], xmm3
	movaps [rsp + nb131_fiyH2], xmm4
	movaps [rsp + nb131_fizH2], xmm7
...
.nb131_odd_loop:
	...
	movss xmm3, [rsp + nb131_ixO]
	movss xmm4, [rsp + nb131_iyO]
	movss xmm5, [rsp + nb131_izO]
