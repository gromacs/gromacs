...
.nb113_unroll_loop:
	...
	movaps xmm4, [rsp + nb113_ixO]
	movaps xmm5, [rsp + nb113_iyO]
	movaps xmm6, [rsp + nb113_izO]
	...
	;# store dr 
	movaps [rsp + nb113_dxO], xmm4
	movaps [rsp + nb113_dyO], xmm5
	movaps [rsp + nb113_dzO], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm4, [rsp + nb113_ixH1]
	movaps xmm5, [rsp + nb113_iyH1]
	movaps xmm6, [rsp + nb113_izH1]
	...
	;# store dr 
	movaps [rsp + nb113_dxH1], xmm4
	movaps [rsp + nb113_dyH1], xmm5
	movaps [rsp + nb113_dzH1], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm3, [rsp + nb113_ixH2]
	movaps xmm4, [rsp + nb113_iyH2]
	movaps xmm5, [rsp + nb113_izH2]
	...
	movaps xmm3, [rsp + nb113_iyM]
	movaps xmm4, [rsp + nb113_izM]
	subps  xmm3, xmm1
	subps  xmm4, xmm2
	movaps xmm2, [rsp + nb113_ixM]
	subps  xmm2, xmm0	

	;# store dr 
	movaps [rsp + nb113_dxM], xmm2
	movaps [rsp + nb113_dyM], xmm3
	movaps [rsp + nb113_dzM], xmm4
	;# square it 
	mulps xmm2,xmm2
	mulps xmm3,xmm3
	mulps xmm4,xmm4
	...
	movaps  xmm3, xmm2
	mulps   xmm2, xmm2
	movaps  xmm0, [rsp + nb113_three]
	mulps   xmm2, xmm6	;# rsq*lu*lu 
	subps   xmm0, xmm2	;# 30-rsq*lu*lu 
	mulps   xmm0, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm0, [rsp + nb113_half]
	movaps  [rsp + nb113_rinvH1], xmm0	;# rinvH1 
	...
	mulps   xmm0, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm0, [rsp + nb113_half]
	movaps  [rsp + nb113_rinvH2], xmm0	;# rinvH2 
	...
	mulps   xmm0, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm0, [rsp + nb113_half]
	movaps  [rsp + nb113_rinvM], xmm0
	
	;# Do the O LJ-only interaction directly.	
	rcpps   xmm2, xmm7
	movaps  xmm1, [rsp + nb113_two]
	mulps   xmm7, xmm2
	subps   xmm1, xmm7
	...
	movaps  xmm1, xmm0
	mulps   xmm1, xmm1  	;# r12
	mulps   xmm0, [rsp + nb113_c6]
	mulps   xmm1, [rsp + nb113_c12]
	movaps  xmm3, xmm1
	subps   xmm3, xmm0  	;# Vvdw12-Vvdw6
	addps   xmm3, [rsp + nb113_Vvdwtot]
	movaps  [rsp + nb113_Vvdwtot], xmm3
	mulps   xmm0, [rsp + nb113_six]
	mulps   xmm1, [rsp + nb113_twelve]
	subps   xmm1, xmm0
	mulps   xmm1, xmm2 	;# fscal
	movaps xmm3, [rsp + nb113_dxO]
	movaps xmm4, [rsp + nb113_dyO]
	movaps xmm5, [rsp + nb113_dzO]
	mulps  xmm3, xmm1
	mulps  xmm4, xmm1
	...
	addps  xmm1, xmm4
	addps  xmm2, xmm5
	movaps [rsp + nb113_fixO], xmm0
	movaps [rsp + nb113_fiyO], xmm1
	movaps [rsp + nb113_fizO], xmm2
	;# update j forces with water O 
	movaps [rsp + nb113_fjx], xmm3
	movaps [rsp + nb113_fjy], xmm4
	movaps [rsp + nb113_fjz], xmm5

	;# Do H1 interaction
	movaps  xmm7, [rsp + nb113_rinvH1]
	movaps  xmm4, xmm7	
	mulps   xmm4, xmm4	;# xmm7=rinv, xmm4=rinvsq 
	mulps  xmm7, [rsp + nb113_qqH]	;# xmm7=vcoul 
	mulps  xmm4, xmm7	;# total fsH1 in xmm4 

	addps  xmm7, [rsp + nb113_vctot]	
	movaps [rsp + nb113_vctot], xmm7

	movaps xmm0, [rsp + nb113_dxH1]
	movaps xmm1, [rsp + nb113_dyH1]
	movaps xmm2, [rsp + nb113_dzH1]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H1 forces 
	movaps xmm3, [rsp + nb113_fixH1]
	movaps xmm4, [rsp + nb113_fiyH1]
	movaps xmm7, [rsp + nb113_fizH1]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb113_fixH1], xmm3
	movaps [rsp + nb113_fiyH1], xmm4
	movaps [rsp + nb113_fizH1], xmm7
	;# update j forces with water H1 
	addps  xmm0, [rsp + nb113_fjx]
	addps  xmm1, [rsp + nb113_fjy]
	addps  xmm2, [rsp + nb113_fjz]
	movaps [rsp + nb113_fjx], xmm0
	movaps [rsp + nb113_fjy], xmm1
	movaps [rsp + nb113_fjz], xmm2

	;# Done with H1, do H2 interactions
	movaps  xmm7, [rsp + nb113_rinvH2]
	movaps  xmm4, xmm7	
	mulps   xmm4, xmm4	;# xmm7=rinv, xmm4=rinvsq 
	mulps  xmm7, [rsp + nb113_qqH]	;# xmm7=vcoul 
	...
	movaps xmm0, [rsp + nb113_dxH2]
	movaps xmm1, [rsp + nb113_dyH2]
	movaps xmm2, [rsp + nb113_dzH2]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H2 forces 
	movaps xmm3, [rsp + nb113_fixH2]
	movaps xmm4, [rsp + nb113_fiyH2]
	movaps xmm7, [rsp + nb113_fizH2]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb113_fixH2], xmm3
	movaps [rsp + nb113_fiyH2], xmm4
	movaps [rsp + nb113_fizH2], xmm7
	addps xmm0, [rsp + nb113_fjx]
        addps xmm1, [rsp + nb113_fjy]
        addps xmm2, [rsp + nb113_fjz]
	movaps [rsp + nb113_fjx], xmm0
	...
	movaps  xmm7, [rsp + nb113_rinvM]
	movaps  xmm4, xmm7	
	mulps   xmm4, xmm4	;# xmm7=rinv, xmm4=rinvsq 
	mulps  xmm7, [rsp + nb113_qqM]	;# xmm7=vcoul 
	mulps  xmm4, xmm7	;# total fsM in xmm4 

	addps  xmm7, [rsp + nb113_vctot]	
	movaps [rsp + nb113_vctot], xmm7

	movaps xmm0, [rsp + nb113_dxM]
	movaps xmm1, [rsp + nb113_dyM]
	movaps xmm2, [rsp + nb113_dzM]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4
	
	;# update M forces 
	movaps xmm3, [rsp + nb113_fixM]
	movaps xmm4, [rsp + nb113_fiyM]
	movaps xmm7, [rsp + nb113_fizM]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb113_fixM], xmm3
	movaps [rsp + nb113_fiyM], xmm4
	movaps [rsp + nb113_fizM], xmm7
...
.nb113_odd_loop:
	...
	movss xmm5, [rsp + nb113_izO]
	movss xmm0, [rsp + nb113_ixH1]
	movss xmm1, [rsp + nb113_iyH1]
	movss xmm2, [rsp + nb113_izH1]
	unpcklps xmm3, [rsp + nb113_ixH2] 	;# ixO ixH2 - -
	unpcklps xmm4, [rsp + nb113_iyH2]  	;# iyO iyH2 - -
	unpcklps xmm5, [rsp + nb113_izH2]	;# izO izH2 - -
	unpcklps xmm0, [rsp + nb113_ixM] 	;# ixH1 ixM - -
	unpcklps xmm1, [rsp + nb113_iyM]  	;# iyH1 iyM - -
	unpcklps xmm2, [rsp + nb113_izM]	;# izH1 izM - -
