...
_nb_kernel310_x86_64_sse.nb310_updateouterdata: 
    ...
    movaps %xmm0,%xmm3
        ...
        incl %esi
        subl %esi,%ecx
        jecxz _nb_kernel310_x86_64_sse.nb310_outerend
...
_nb_kernel310_x86_64_sse.nb310_outerend: 
        ...
        subl  %esi,%ecx
        jecxz _nb_kernel310_x86_64_sse.nb310_end
...
_nb_kernel310nf_x86_64_sse.nb310nf_updateouterdata: 
        ...
        incl %esi
        subl %esi,%ecx
        jecxz _nb_kernel310nf_x86_64_sse.nb310nf_outerend
...
_nb_kernel310nf_x86_64_sse.nb310nf_outerend: 
        ...
        ## esi already loaded with n above
        subl  %esi,%ecx
        jecxz _nb_kernel310nf_x86_64_sse.nb310nf_end
        ## non-zero, do one more workunit
