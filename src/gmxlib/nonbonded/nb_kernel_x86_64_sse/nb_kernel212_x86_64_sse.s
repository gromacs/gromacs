...
.nb212_unroll_loop:	
	...
	movaps [rsp + nb212_jyO], xmm2
	movlhps  xmm1, xmm3
	movaps [rsp + nb212_jxH1], xmm1
	movhlps  xmm3, xmm7
	movaps   xmm6, xmm4
	movaps [rsp + nb212_jyH1], xmm3
	movlhps  xmm4, xmm5
	movaps [rsp + nb212_jxH2], xmm4
	movhlps  xmm5, xmm6
	movaps [rsp + nb212_jyH2], xmm5
	...
	movaps [rsp + nb212_jzO],  xmm0
	movaps [rsp + nb212_jzH1],  xmm1
	movaps [rsp + nb212_jzH2],  xmm2

	movaps xmm0, [rsp + nb212_ixO]
	movaps xmm1, [rsp + nb212_iyO]
	movaps xmm2, [rsp + nb212_izO]
	movaps xmm3, [rsp + nb212_ixO]
	movaps xmm4, [rsp + nb212_iyO]
	movaps xmm5, [rsp + nb212_izO]
	subps  xmm0, [rsp + nb212_jxO]
	subps  xmm1, [rsp + nb212_jyO]
	subps  xmm2, [rsp + nb212_jzO]
	subps  xmm3, [rsp + nb212_jxH1]
	subps  xmm4, [rsp + nb212_jyH1]
	subps  xmm5, [rsp + nb212_jzH1]
	...
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb212_dxOH1], xmm3
	movaps [rsp + nb212_dyOH1], xmm4
	movaps [rsp + nb212_dzOH1], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb212_rsqOO], xmm0
	movaps [rsp + nb212_rsqOH1], xmm3

	movaps xmm0, [rsp + nb212_ixO]
	movaps xmm1, [rsp + nb212_iyO]
	movaps xmm2, [rsp + nb212_izO]
	movaps xmm3, [rsp + nb212_ixH1]
	movaps xmm4, [rsp + nb212_iyH1]
	movaps xmm5, [rsp + nb212_izH1]
	subps  xmm0, [rsp + nb212_jxH2]
	subps  xmm1, [rsp + nb212_jyH2]
	subps  xmm2, [rsp + nb212_jzH2]
	subps  xmm3, [rsp + nb212_jxO]
	subps  xmm4, [rsp + nb212_jyO]
	subps  xmm5, [rsp + nb212_jzO]
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb212_rsqOH2], xmm0
	movaps [rsp + nb212_rsqH1O], xmm3

	movaps xmm0, [rsp + nb212_ixH1]
	movaps xmm1, [rsp + nb212_iyH1]
	movaps xmm2, [rsp + nb212_izH1]
	movaps xmm3, [rsp + nb212_ixH1]
	movaps xmm4, [rsp + nb212_iyH1]
	movaps xmm5, [rsp + nb212_izH1]
	subps  xmm0, [rsp + nb212_jxH1]
	subps  xmm1, [rsp + nb212_jyH1]
	subps  xmm2, [rsp + nb212_jzH1]
	subps  xmm3, [rsp + nb212_jxH2]
	subps  xmm4, [rsp + nb212_jyH2]
	subps  xmm5, [rsp + nb212_jzH2]
	movaps [rsp + nb212_dxH1H1], xmm0
	movaps [rsp + nb212_dyH1H1], xmm1
	movaps [rsp + nb212_dzH1H1], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb212_rsqH1H1], xmm0
	movaps [rsp + nb212_rsqH1H2], xmm3

	movaps xmm0, [rsp + nb212_ixH2]
	movaps xmm1, [rsp + nb212_iyH2]
	movaps xmm2, [rsp + nb212_izH2]
	movaps xmm3, [rsp + nb212_ixH2]
	movaps xmm4, [rsp + nb212_iyH2]
	movaps xmm5, [rsp + nb212_izH2]
	subps  xmm0, [rsp + nb212_jxO]
	subps  xmm1, [rsp + nb212_jyO]
	subps  xmm2, [rsp + nb212_jzO]
	subps  xmm3, [rsp + nb212_jxH1]
	subps  xmm4, [rsp + nb212_jyH1]
	subps  xmm5, [rsp + nb212_jzH1]
	movaps [rsp + nb212_dxH2O], xmm0
	movaps [rsp + nb212_dyH2O], xmm1
	movaps [rsp + nb212_dzH2O], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb212_dxH2H1], xmm3
	movaps [rsp + nb212_dyH2H1], xmm4
	movaps [rsp + nb212_dzH2H1], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm4, xmm3
	addps  xmm4, xmm5
	movaps [rsp + nb212_rsqH2O], xmm0
	movaps [rsp + nb212_rsqH2H1], xmm4
	...
	subps  xmm1, [rsp + nb212_jyH2]
	subps  xmm2, [rsp + nb212_jzH2]
	movaps [rsp + nb212_dxH2H2], xmm0
	movaps [rsp + nb212_dyH2H2], xmm1
	movaps [rsp + nb212_dzH2H2], xmm2
	mulps xmm0, xmm0
	mulps xmm1, xmm1
	mulps xmm2, xmm2
	addps xmm0, xmm1
	addps xmm0, xmm2
	movaps [rsp + nb212_rsqH2H2], xmm0
	...
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb212_half] ;# rinvH2H2 
	mulps   xmm7, [rsp + nb212_half] ;# rinvH2H1 
	movaps  [rsp + nb212_rinvH2H2], xmm3
	movaps  [rsp + nb212_rinvH2H1], xmm7
	
	rsqrtps xmm1, [rsp + nb212_rsqOO]
	rsqrtps xmm5, [rsp + nb212_rsqOH1]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb212_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb212_rsqOO]
	mulps   xmm5, [rsp + nb212_rsqOH1]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb212_half] 
	mulps   xmm7, [rsp + nb212_half]
	movaps  [rsp + nb212_rinvOO], xmm3
	movaps  [rsp + nb212_rinvOH1], xmm7
	
	rsqrtps xmm1, [rsp + nb212_rsqOH2]
	rsqrtps xmm5, [rsp + nb212_rsqH1O]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb212_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb212_rsqOH2]
	mulps   xmm5, [rsp + nb212_rsqH1O]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb212_half] 
	mulps   xmm7, [rsp + nb212_half]
	movaps  [rsp + nb212_rinvOH2], xmm3
	movaps  [rsp + nb212_rinvH1O], xmm7
	
	rsqrtps xmm1, [rsp + nb212_rsqH1H1]
	rsqrtps xmm5, [rsp + nb212_rsqH1H2]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb212_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb212_rsqH1H1]
	mulps   xmm5, [rsp + nb212_rsqH1H2]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb212_half] 
	mulps   xmm7, [rsp + nb212_half]
	movaps  [rsp + nb212_rinvH1H1], xmm3
	movaps  [rsp + nb212_rinvH1H2], xmm7
	
	rsqrtps xmm1, [rsp + nb212_rsqH2O]
	movaps  xmm2, xmm1
	mulps   xmm1, xmm1
	movaps  xmm3, [rsp + nb212_three]
	mulps   xmm1, [rsp + nb212_rsqH2O]
	subps   xmm3, xmm1
	mulps   xmm3, xmm2
	mulps   xmm3, [rsp + nb212_half] 
	movaps  [rsp + nb212_rinvH2O], xmm3

	;# start with OO interaction 
	movaps xmm0, [rsp + nb212_rinvOO]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]
	mulps  xmm0, xmm0
	movaps xmm1, xmm0
	mulps  xmm1, xmm0
	mulps  xmm1, xmm0	;# xmm1=rinvsix 
	mulps  xmm5, [rsp + nb212_rsqOO] ;# xmm5=krsq 
	movaps xmm6, xmm5
	addps  xmm6, xmm7	;# xmm6=rinv+ krsq 
	subps  xmm6, [rsp + nb212_crf]
	
	mulps  xmm6, [rsp + nb212_qqOO] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulps xmm5, [rsp + nb212_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb212_qqOO] ;# xmm7 = coul part of fscal 
	
	movaps xmm2, xmm1
	mulps  xmm2, xmm2	;# xmm2=rinvtwelve 
	mulps  xmm1, [rsp + nb212_c6]	
	mulps  xmm2, [rsp + nb212_c12]	
	movaps xmm3, xmm2
	subps  xmm3, xmm1	;# xmm3=Vvdw12-Vvdw6 
	addps  xmm3, [rsp + nb212_Vvdwtot]
	mulps  xmm1, [rsp + nb212_six]
	mulps  xmm2, [rsp + nb212_twelve]
	movaps [rsp + nb212_Vvdwtot], xmm3
	subps  xmm2, xmm1
	addps  xmm2, xmm7
	addps  xmm6, [rsp + nb212_vctot] ;# local vctot summation variable 
	mulps  xmm0, xmm2
	...
	;# O-H1 interaction 
	movaps xmm0, [rsp + nb212_rinvOH1]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb212_rsqOH1] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=rinv+ krsq 
	mulps  xmm0, xmm0
	subps  xmm4, [rsp + nb212_crf]
	mulps  xmm4, [rsp + nb212_qqOH] ;# xmm4=voul=qq*(rinv+ krsq) 
	mulps  xmm5, [rsp + nb212_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb212_qqOH] ;# xmm7 = coul part of fscal 
	...
	addps xmm1, [rsp + nb212_fiyO]
	addps xmm2, [rsp + nb212_fizO]
	movaps [rsp + nb212_fjxH1], xmm3
	movaps [rsp + nb212_fjyH1], xmm4
	movaps [rsp + nb212_fjzH1], xmm5
	movaps [rsp + nb212_fixO], xmm0
	movaps [rsp + nb212_fiyO], xmm1
	movaps [rsp + nb212_fizO], xmm2

	;# O-H2 interaction  
	movaps xmm0, [rsp + nb212_rinvOH2]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb212_rsqOH2] ;# xmm5=krsq 
	movaps xmm4, xmm5
	...
	addps xmm1, [rsp + nb212_fiyO]
	addps xmm2, [rsp + nb212_fizO]
	movaps [rsp + nb212_fjxH2], xmm3
	movaps [rsp + nb212_fjyH2], xmm4
	movaps [rsp + nb212_fjzH2], xmm5
	movaps [rsp + nb212_fixO], xmm0
	movaps [rsp + nb212_fiyO], xmm1
	movaps [rsp + nb212_fizO], xmm2

	;# H1-O interaction 
	movaps xmm0, [rsp + nb212_rinvH1O]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb212_rsqH1O] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=rinv+ krsq 
	mulps xmm0, xmm0
	subps  xmm4, [rsp + nb212_crf]
	...
	;# H1-H1 interaction 
	movaps xmm0, [rsp + nb212_rinvH1H1]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb212_rsqH1H1] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb212_crf]
	mulps xmm0, xmm0
	mulps  xmm4, [rsp + nb212_qqHH] ;# xmm4=voul=qq*(rinv+ krsq) 
	mulps  xmm5, [rsp + nb212_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb212_qqHH] ;# xmm7 = coul part of fscal 
	addps  xmm6, xmm4	;# add to local vctot 
	mulps xmm0, xmm7	;# fsOH2 
	movaps xmm1, xmm0
	movaps xmm2, xmm0

	movaps xmm3, [rsp + nb212_fjxH1]
	movaps xmm4, [rsp + nb212_fjyH1]
	movaps xmm5, [rsp + nb212_fjzH1]
	mulps xmm0, [rsp + nb212_dxH1H1]
	mulps xmm1, [rsp + nb212_dyH1H1]
	mulps xmm2, [rsp + nb212_dzH1H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb212_fixH1]
	...
	;# H1-H2 interaction 
	movaps xmm0, [rsp + nb212_rinvH1H2]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb212_rsqH1H2] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	mulps xmm0, xmm0
	subps  xmm4, [rsp + nb212_crf]
	...
	movaps xmm3, [rsp + nb212_fjxH2]
	movaps xmm4, [rsp + nb212_fjyH2]
	movaps xmm5, [rsp + nb212_fjzH2]
	mulps xmm0, [rsp + nb212_dxH1H2]
	mulps xmm1, [rsp + nb212_dyH1H2]
	mulps xmm2, [rsp + nb212_dzH1H2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb212_fixH1]
	...
	;# H2-O interaction 
	movaps xmm0, [rsp + nb212_rinvH2O]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb212_rsqH2O] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb212_crf]
	mulps xmm0, xmm0
	...
	;# H2-H1 interaction 
	movaps xmm0, [rsp + nb212_rinvH2H1]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb212_rsqH2H1] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb212_crf]
	mulps xmm0, xmm0
	...
	movaps xmm4, [rsp + nb212_fjyH1]
	movaps xmm5, [rsp + nb212_fjzH1]
	mulps xmm0, [rsp + nb212_dxH2H1]
	mulps xmm1, [rsp + nb212_dyH2H1]
	mulps xmm2, [rsp + nb212_dzH2H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb212_fixH2]
	...
	;# H2-H2 interaction 
	movaps xmm0, [rsp + nb212_rinvH2H2]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb212_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb212_rsqH2H2] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb212_crf]
	mulps xmm0, xmm0
	...
	movaps xmm4, [rsp + nb212_fjyH2]
	movaps xmm5, [rsp + nb212_fjzH2]
	mulps xmm0, [rsp + nb212_dxH2H2]
	mulps xmm1, [rsp + nb212_dyH2H2]
	mulps xmm2, [rsp + nb212_dzH2H2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb212_fixH2]
	...
	movaps xmm0, [rsp + nb212_fjxO] ;# xmm0= fjxOa  fjxOb  fjxOc  fjxOd 
	movaps xmm2, [rsp + nb212_fjyO] ;# xmm1= fjyOa  fjyOb  fjyOc  fjyOd
	...
	movaps xmm0, [rsp + nb212_fjzO]  ;# xmm0= fjzOa   fjzOb   fjzOc   fjzOd 
	movaps xmm2, [rsp + nb212_fjxH1] ;# xmm1= fjxH1a  fjxH1b  fjxH1c  fjxH1d
	...
	movaps xmm0, [rsp + nb212_fjyH1]  ;# xmm0= fjyH1a  fjyH1b  fjyH1c  fjyH1d 
	movaps xmm2, [rsp + nb212_fjzH1] ;# xmm1= fjzH1a  fjzH1b  fjzH1c  fjzH1d
	...
	movaps xmm0, [rsp + nb212_fjxH2]  ;# xmm0= fjxH2a  fjxH2b  fjxH2c  fjxH2d 
	movaps xmm2, [rsp + nb212_fjyH2] ;# xmm1= fjyH2a  fjyH2b  fjyH2c  fjyH2d
	...
	addss xmm4, [rsp + nb212_fjzH2] 
	addss xmm5, [rsp + nb212_fjzH2 + 4] 
	addss xmm6, [rsp + nb212_fjzH2 + 8] 
	addss xmm7, [rsp + nb212_fjzH2 + 12]
	;# store back
...
.nb212_single_loop:
	...
	movaps [rsp + nb212_jxO], xmm3
	movaps [rsp + nb212_jyO], xmm4
	movaps [rsp + nb212_jzO], xmm5
	subps  xmm0, xmm3
	subps  xmm1, xmm4
	subps  xmm2, xmm5
	movaps [rsp + nb212_dxOO], xmm0
