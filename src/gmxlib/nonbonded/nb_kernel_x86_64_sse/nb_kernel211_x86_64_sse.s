...
.nb211_unroll_loop:
	...
	movaps xmm4, [rsp + nb211_ixO]
	movaps xmm5, [rsp + nb211_iyO]
	movaps xmm6, [rsp + nb211_izO]
	...
	;# store dr 
	movaps [rsp + nb211_dxO], xmm4
	movaps [rsp + nb211_dyO], xmm5
	movaps [rsp + nb211_dzO], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm4, [rsp + nb211_ixH1]
	movaps xmm5, [rsp + nb211_iyH1]
	movaps xmm6, [rsp + nb211_izH1]
	...
	;# store dr 
	movaps [rsp + nb211_dxH1], xmm4
	movaps [rsp + nb211_dyH1], xmm5
	movaps [rsp + nb211_dzH1], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm3, [rsp + nb211_ixH2]
	movaps xmm4, [rsp + nb211_iyH2]
	movaps xmm5, [rsp + nb211_izH2]
	...
	;# store dr 
	movaps [rsp + nb211_dxH2], xmm3
	movaps [rsp + nb211_dyH2], xmm4
	movaps [rsp + nb211_dzH2], xmm5
	;# square it 
	mulps xmm3,xmm3
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	...
	mulps  xmm1, [rsp + nb211_krf]	
	mulps  xmm2, [rsp + nb211_krf]	

	movaps [rsp + nb211_krsqH2], xmm0
	movaps [rsp + nb211_krsqH1], xmm1
	movaps [rsp + nb211_krsqO], xmm2
	
	;# start with rsqO - seed in xmm2 	
	rsqrtps xmm2, xmm7
	movaps  xmm3, xmm2
	mulps   xmm2, xmm2
	movaps  xmm4, [rsp + nb211_three]
	mulps   xmm2, xmm7	;# rsq*lu*lu 
	subps   xmm4, xmm2	;# 30-rsq*lu*lu 
	mulps   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm4, [rsp + nb211_half]
	...
	addps  xmm3, [rsp + nb211_Vvdwtot]
	mulps  xmm1, [rsp + nb211_six]
	mulps  xmm2, [rsp + nb211_twelve]
	subps  xmm2, xmm1	;# nb part of fs  

	movaps xmm0, xmm7
	movaps xmm1, [rsp + nb211_krsqO]
	addps  xmm0, xmm1
	mulps  xmm1, [rsp + nb211_two]
	subps  xmm0, [rsp + nb211_crf] ;# xmm0=rinv+ krsq-crf 
	subps  xmm7, xmm1
	mulps  xmm0, [rsp + nb211_qqO]
	mulps  xmm7, [rsp + nb211_qqO]
	addps  xmm2, xmm7

	mulps  xmm4, xmm2	;# total fsO in xmm4 

	addps  xmm0, [rsp + nb211_vctot]
	movaps [rsp + nb211_Vvdwtot], xmm3
	...
	;# update O forces 
	movaps xmm3, [rsp + nb211_fixO]
	movaps xmm4, [rsp + nb211_fiyO]
	movaps xmm7, [rsp + nb211_fizO]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb211_fixO], xmm3
	movaps [rsp + nb211_fiyO], xmm4
	movaps [rsp + nb211_fizO], xmm7
	;# update j forces with water O 
	movaps [rsp + nb211_fjx], xmm0
	movaps [rsp + nb211_fjy], xmm1
	movaps [rsp + nb211_fjz], xmm2

	;# H1 interactions 
	movaps  xmm4, xmm6	
	mulps   xmm4, xmm4	;# xmm6=rinv, xmm4=rinvsq 
	movaps  xmm7, xmm6
	movaps  xmm0, [rsp + nb211_krsqH1]
	addps   xmm6, xmm0	;# xmm6=rinv+ krsq 
	mulps   xmm0, [rsp + nb211_two]
	subps   xmm6, [rsp + nb211_crf]
	subps   xmm7, xmm0	;# xmm7=rinv-2*krsq 
	mulps   xmm6, [rsp + nb211_qqH] ;# vcoul 
	mulps   xmm7, [rsp + nb211_qqH]
	mulps  xmm4, xmm7		;# total fsH1 in xmm4 
	
	addps  xmm6, [rsp + nb211_vctot]

	movaps xmm0, [rsp + nb211_dxH1]
	movaps xmm1, [rsp + nb211_dyH1]
	movaps xmm2, [rsp + nb211_dzH1]
	movaps [rsp + nb211_vctot], xmm6
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H1 forces 
	movaps xmm3, [rsp + nb211_fixH1]
	movaps xmm4, [rsp + nb211_fiyH1]
	movaps xmm7, [rsp + nb211_fizH1]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb211_fixH1], xmm3
	movaps [rsp + nb211_fiyH1], xmm4
	movaps [rsp + nb211_fizH1], xmm7
	;# update j forces with water H1 
	addps  xmm0, [rsp + nb211_fjx]
	addps  xmm1, [rsp + nb211_fjy]
	addps  xmm2, [rsp + nb211_fjz]
	movaps [rsp + nb211_fjx], xmm0
	movaps [rsp + nb211_fjy], xmm1
	movaps [rsp + nb211_fjz], xmm2
	...
	movaps  xmm7, xmm5
	movaps  xmm0, [rsp + nb211_krsqH2]
	addps   xmm5, xmm0	;# xmm5=rinv+ krsq 
	mulps   xmm0, [rsp + nb211_two]
	subps   xmm5, [rsp + nb211_crf]
	subps   xmm7, xmm0	;# xmm7=rinv-2*krsq 
	mulps   xmm5, [rsp + nb211_qqH] ;# vcoul 
	mulps   xmm7, [rsp + nb211_qqH]
	mulps  xmm4, xmm7		;# total fsH2 in xmm4 
	
	addps  xmm5, [rsp + nb211_vctot]

	movaps xmm0, [rsp + nb211_dxH2]
	movaps xmm1, [rsp + nb211_dyH2]
	movaps xmm2, [rsp + nb211_dzH2]
	movaps [rsp + nb211_vctot], xmm5
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H2 forces 
	movaps xmm3, [rsp + nb211_fixH2]
	movaps xmm4, [rsp + nb211_fiyH2]
	movaps xmm7, [rsp + nb211_fizH2]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb211_fixH2], xmm3
	movaps [rsp + nb211_fiyH2], xmm4
	movaps [rsp + nb211_fizH2], xmm7
...
.nb211_odd_loop:
	...
	movss xmm3, [rsp + nb211_ixO]
	movss xmm4, [rsp + nb211_iyO]
	movss xmm5, [rsp + nb211_izO]
