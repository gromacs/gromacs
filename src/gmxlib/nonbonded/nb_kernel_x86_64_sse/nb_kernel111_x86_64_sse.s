...
.nb111_unroll_loop:
	...
	mulps  xmm3, [rsp + nb111_iqO]
	mulps  xmm4, [rsp + nb111_iqH]
	...
	movaps  [rsp + nb111_qqO], xmm3
	movaps  [rsp + nb111_qqH], xmm4
	...
	movaps [rsp + nb111_c6], xmm4
	movaps [rsp + nb111_c12], xmm6
	...
	movaps xmm4, [rsp + nb111_ixO]
	movaps xmm5, [rsp + nb111_iyO]
	movaps xmm6, [rsp + nb111_izO]
	...
	;# store dr 
	movaps [rsp + nb111_dxO], xmm4
	movaps [rsp + nb111_dyO], xmm5
	movaps [rsp + nb111_dzO], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm4, [rsp + nb111_ixH1]
	movaps xmm5, [rsp + nb111_iyH1]
	movaps xmm6, [rsp + nb111_izH1]
	...
	;# store dr 
	movaps [rsp + nb111_dxH1], xmm4
	movaps [rsp + nb111_dyH1], xmm5
	movaps [rsp + nb111_dzH1], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm3, [rsp + nb111_ixH2]
	movaps xmm4, [rsp + nb111_iyH2]
	movaps xmm5, [rsp + nb111_izH2]
	...
	;# store dr 
	movaps [rsp + nb111_dxH2], xmm3
	movaps [rsp + nb111_dyH2], xmm4
	movaps [rsp + nb111_dzH2], xmm5
	;# square it 
	mulps xmm3,xmm3
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	...
	mulps  xmm7, [rsp + nb111_qqO]	;# xmm7=vcoul 
	
	mulps  xmm1, [rsp + nb111_c6]
	mulps  xmm2, [rsp + nb111_c12]
	movaps xmm3, xmm2
	subps  xmm3, xmm1	;# Vvdw=Vvdw12-Vvdw6 		
	addps  xmm3, [rsp + nb111_Vvdwtot]
	mulps  xmm1, [rsp + nb111_six]
	mulps  xmm2, [rsp + nb111_twelve]
	subps  xmm2, xmm1
	addps  xmm2, xmm7	
	mulps  xmm4, xmm2	;# total fsO in xmm4 

	addps  xmm7, [rsp + nb111_vctot]
	
	movaps [rsp + nb111_Vvdwtot], xmm3
	movaps [rsp + nb111_vctot], xmm7
	...
	;# update O forces 
	movaps xmm3, [rsp + nb111_fixO]
	movaps xmm4, [rsp + nb111_fiyO]
	movaps xmm7, [rsp + nb111_fizO]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb111_fixO], xmm3
	movaps [rsp + nb111_fiyO], xmm4
	movaps [rsp + nb111_fizO], xmm7
	;# update j forces with water O 
	movaps [rsp + nb111_fjx], xmm0
	movaps [rsp + nb111_fjy], xmm1
	movaps [rsp + nb111_fjz], xmm2

	;# H1 interactions 
	movaps  xmm4, xmm6	
	mulps   xmm4, xmm4	;# xmm6=rinv, xmm4=rinvsq 
	mulps  xmm6, [rsp + nb111_qqH]	;# xmm6=vcoul 
	mulps  xmm4, xmm6		;# total fsH1 in xmm4 
	
	addps  xmm6, [rsp + nb111_vctot]

	movaps xmm0, [rsp + nb111_dxH1]
	movaps xmm1, [rsp + nb111_dyH1]
	movaps xmm2, [rsp + nb111_dzH1]
	movaps [rsp + nb111_vctot], xmm6
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H1 forces 
	movaps xmm3, [rsp + nb111_fixH1]
	movaps xmm4, [rsp + nb111_fiyH1]
	movaps xmm7, [rsp + nb111_fizH1]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb111_fixH1], xmm3
	movaps [rsp + nb111_fiyH1], xmm4
	movaps [rsp + nb111_fizH1], xmm7
	;# update j forces with water H1 
	addps  xmm0, [rsp + nb111_fjx]
	addps  xmm1, [rsp + nb111_fjy]
	addps  xmm2, [rsp + nb111_fjz]
	movaps [rsp + nb111_fjx], xmm0
	movaps [rsp + nb111_fjy], xmm1
	movaps [rsp + nb111_fjz], xmm2
	...
	mulps  xmm5, [rsp + nb111_qqH]	;# xmm5=vcoul 
	mulps  xmm4, xmm5		;# total fsH1 in xmm4 
	
	addps  xmm5, [rsp + nb111_vctot]

	movaps xmm0, [rsp + nb111_dxH2]
	movaps xmm1, [rsp + nb111_dyH2]
	movaps xmm2, [rsp + nb111_dzH2]
	movaps [rsp + nb111_vctot], xmm5
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H2 forces 
	movaps xmm3, [rsp + nb111_fixH2]
	movaps xmm4, [rsp + nb111_fiyH2]
	movaps xmm7, [rsp + nb111_fizH2]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb111_fixH2], xmm3
	movaps [rsp + nb111_fiyH2], xmm4
	movaps [rsp + nb111_fizH2], xmm7
...
.nb111_odd_loop:
	...
	movss xmm3, [rsp + nb111_ixO]
	movss xmm4, [rsp + nb111_iyO]
	movss xmm5, [rsp + nb111_izO]
