...
.nb104_unroll_loop:	
	...
	movaps [rsp + nb104_jxH1], xmm0
	movhlps  xmm2, xmm6	;# xmm2= jyH1a  jyH1b  jyH1c  jyH1d 
	movaps [rsp + nb104_jyH1], xmm2
	movlhps  xmm1, xmm3
	movaps [rsp + nb104_jxH2], xmm1
	movhlps  xmm3, xmm7
	movaps   xmm6, xmm4
	movaps [rsp + nb104_jyH2], xmm3
	movlhps  xmm4, xmm5
	movaps [rsp + nb104_jxM], xmm4
	movhlps  xmm5, xmm6
	movaps [rsp + nb104_jyM], xmm5
	...
	movaps [rsp + nb104_jzH1],  xmm0
	movaps [rsp + nb104_jzH2],  xmm1
	movaps [rsp + nb104_jzM],  xmm2

	movaps xmm0, [rsp + nb104_ixH1]
	movaps xmm1, [rsp + nb104_iyH1]
	movaps xmm2, [rsp + nb104_izH1]
	movaps xmm3, [rsp + nb104_ixH1]
	movaps xmm4, [rsp + nb104_iyH1]
	movaps xmm5, [rsp + nb104_izH1]
	subps  xmm0, [rsp + nb104_jxH1]
	subps  xmm1, [rsp + nb104_jyH1]
	subps  xmm2, [rsp + nb104_jzH1]
	subps  xmm3, [rsp + nb104_jxH2]
	subps  xmm4, [rsp + nb104_jyH2]
	subps  xmm5, [rsp + nb104_jzH2]
	...
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb104_dxH1H2], xmm3
	movaps [rsp + nb104_dyH1H2], xmm4
	movaps [rsp + nb104_dzH1H2], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb104_rsqH1H1], xmm0
	movaps [rsp + nb104_rsqH1H2], xmm3

	movaps xmm0, [rsp + nb104_ixH1]
	movaps xmm1, [rsp + nb104_iyH1]
	movaps xmm2, [rsp + nb104_izH1]
	movaps xmm3, [rsp + nb104_ixH2]
	movaps xmm4, [rsp + nb104_iyH2]
	movaps xmm5, [rsp + nb104_izH2]
	subps  xmm0, [rsp + nb104_jxM]
	subps  xmm1, [rsp + nb104_jyM]
	subps  xmm2, [rsp + nb104_jzM]
	subps  xmm3, [rsp + nb104_jxH1]
	subps  xmm4, [rsp + nb104_jyH1]
	subps  xmm5, [rsp + nb104_jzH1]
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb104_rsqH1M], xmm0
	movaps [rsp + nb104_rsqH2H1], xmm3

	movaps xmm0, [rsp + nb104_ixH2]
	movaps xmm1, [rsp + nb104_iyH2]
	movaps xmm2, [rsp + nb104_izH2]
	movaps xmm3, [rsp + nb104_ixH2]
	movaps xmm4, [rsp + nb104_iyH2]
	movaps xmm5, [rsp + nb104_izH2]
	subps  xmm0, [rsp + nb104_jxH2]
	subps  xmm1, [rsp + nb104_jyH2]
	subps  xmm2, [rsp + nb104_jzH2]
	subps  xmm3, [rsp + nb104_jxM]
	subps  xmm4, [rsp + nb104_jyM]
	subps  xmm5, [rsp + nb104_jzM]
	movaps [rsp + nb104_dxH2H2], xmm0
	movaps [rsp + nb104_dyH2H2], xmm1
	movaps [rsp + nb104_dzH2H2], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb104_rsqH2H2], xmm0
	movaps [rsp + nb104_rsqH2M], xmm3

	movaps xmm0, [rsp + nb104_ixM]
	movaps xmm1, [rsp + nb104_iyM]
	movaps xmm2, [rsp + nb104_izM]
	movaps xmm3, [rsp + nb104_ixM]
	movaps xmm4, [rsp + nb104_iyM]
	movaps xmm5, [rsp + nb104_izM]
	subps  xmm0, [rsp + nb104_jxH1]
	subps  xmm1, [rsp + nb104_jyH1]
	subps  xmm2, [rsp + nb104_jzH1]
	subps  xmm3, [rsp + nb104_jxH2]
	subps  xmm4, [rsp + nb104_jyH2]
	subps  xmm5, [rsp + nb104_jzH2]
	movaps [rsp + nb104_dxMH1], xmm0
	movaps [rsp + nb104_dyMH1], xmm1
	movaps [rsp + nb104_dzMH1], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb104_dxMH2], xmm3
	movaps [rsp + nb104_dyMH2], xmm4
	movaps [rsp + nb104_dzMH2], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm4, xmm3
	addps  xmm4, xmm5
	movaps [rsp + nb104_rsqMH1], xmm0
	movaps [rsp + nb104_rsqMH2], xmm4
	...
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb104_half] ;# rinvMM 
	mulps   xmm7, [rsp + nb104_half] ;# rinvMH2 
	movaps  [rsp + nb104_rinvMM], xmm3
	movaps  [rsp + nb104_rinvMH2], xmm7
	
	rsqrtps xmm1, [rsp + nb104_rsqH1H1]
	rsqrtps xmm5, [rsp + nb104_rsqH1H2]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb104_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb104_rsqH1H1]
	mulps   xmm5, [rsp + nb104_rsqH1H2]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb104_half] 
	mulps   xmm7, [rsp + nb104_half]
	movaps  [rsp + nb104_rinvH1H1], xmm3
	movaps  [rsp + nb104_rinvH1H2], xmm7
	
	rsqrtps xmm1, [rsp + nb104_rsqH1M]
	rsqrtps xmm5, [rsp + nb104_rsqH2H1]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb104_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb104_rsqH1M]
	mulps   xmm5, [rsp + nb104_rsqH2H1]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb104_half] 
	mulps   xmm7, [rsp + nb104_half]
	movaps  [rsp + nb104_rinvH1M], xmm3
	movaps  [rsp + nb104_rinvH2H1], xmm7
	
	rsqrtps xmm1, [rsp + nb104_rsqH2H2]
	rsqrtps xmm5, [rsp + nb104_rsqH2M]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb104_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb104_rsqH2H2]
	mulps   xmm5, [rsp + nb104_rsqH2M]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb104_half] 
	mulps   xmm7, [rsp + nb104_half]
	movaps  [rsp + nb104_rinvH2H2], xmm3
	movaps  [rsp + nb104_rinvH2M], xmm7
	
	rsqrtps xmm1, [rsp + nb104_rsqMH1]
	movaps  xmm2, xmm1
	mulps   xmm1, xmm1
	movaps  xmm3, [rsp + nb104_three]
	mulps   xmm1, [rsp + nb104_rsqMH1]
	subps   xmm3, xmm1
	mulps   xmm3, xmm2
	mulps   xmm3, [rsp + nb104_half] 
	movaps  [rsp + nb104_rinvMH1], xmm3

	;# start with H1-H1 interaction 
	movaps xmm0, [rsp + nb104_rinvH1H1]
	movaps xmm7, xmm0
	mulps  xmm0, xmm0
	mulps  xmm7, [rsp + nb104_qqHH]
	mulps  xmm0, xmm7	
	addps  xmm7, [rsp + nb104_vctot] 
	movaps xmm1, xmm0
	movaps xmm2, xmm0
	...
	movaps xmm4, xmm3
	movaps xmm5, xmm3
	mulps xmm0, [rsp + nb104_dxH1H1]
	mulps xmm1, [rsp + nb104_dyH1H1]
	mulps xmm2, [rsp + nb104_dzH1H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	...
	movaps [rsp + nb104_fjxH1], xmm3
	movaps [rsp + nb104_fjyH1], xmm4
	movaps [rsp + nb104_fjzH1], xmm5
	movaps [rsp + nb104_fixH1], xmm0
	movaps [rsp + nb104_fiyH1], xmm1
	movaps [rsp + nb104_fizH1], xmm2

	;# H1-H2 interaction 
	movaps xmm0, [rsp + nb104_rinvH1H2]
	movaps xmm1, xmm0
	mulps xmm0, xmm0
	...
	movaps xmm4, xmm3
	movaps xmm5, xmm3
	mulps xmm0, [rsp + nb104_dxH1H2]
	mulps xmm1, [rsp + nb104_dyH1H2]
	mulps xmm2, [rsp + nb104_dzH1H2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb104_fixH1]
	addps xmm1, [rsp + nb104_fiyH1]
	addps xmm2, [rsp + nb104_fizH1]
	movaps [rsp + nb104_fjxH2], xmm3
	movaps [rsp + nb104_fjyH2], xmm4
	movaps [rsp + nb104_fjzH2], xmm5
	movaps [rsp + nb104_fixH1], xmm0
	movaps [rsp + nb104_fiyH1], xmm1
	movaps [rsp + nb104_fizH1], xmm2

	;# H1-M interaction  
	movaps xmm0, [rsp + nb104_rinvH1M]
	movaps xmm1, xmm0
	mulps xmm0, xmm0
	...
	;# H2-H1 interaction 
	movaps xmm0, [rsp + nb104_rinvH2H1]
	movaps xmm1, xmm0
	mulps xmm0, xmm0
	mulps xmm1, [rsp + nb104_qqHH]
	...
	movaps xmm1, xmm0
	movaps xmm2, xmm0
	movaps xmm3, [rsp + nb104_fjxH1]
	movaps xmm4, [rsp + nb104_fjyH1]
	movaps xmm5, [rsp + nb104_fjzH1]
	mulps xmm0, [rsp + nb104_dxH2H1]
	mulps xmm1, [rsp + nb104_dyH2H1]
	mulps xmm2, [rsp + nb104_dzH2H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	...
	;# H2-H2 interaction 
	movaps xmm0, [rsp + nb104_rinvH2H2]
	movaps xmm1, xmm0
	mulps xmm0, xmm0
	mulps xmm1, [rsp + nb104_qqHH]
	...
	movaps xmm1, xmm0
	movaps xmm2, xmm0
	movaps xmm3, [rsp + nb104_fjxH2]
	movaps xmm4, [rsp + nb104_fjyH2]
	movaps xmm5, [rsp + nb104_fjzH2]
	mulps xmm0, [rsp + nb104_dxH2H2]
	mulps xmm1, [rsp + nb104_dyH2H2]
	mulps xmm2, [rsp + nb104_dzH2H2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb104_fixH2]
	...
	movaps xmm4, [rsp + nb104_fjyH1]
	movaps xmm5, [rsp + nb104_fjzH1]
	mulps xmm0, [rsp + nb104_dxMH1]
	mulps xmm1, [rsp + nb104_dyMH1]
	mulps xmm2, [rsp + nb104_dzMH1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	...
	movaps xmm4, [rsp + nb104_fjyH2]
	movaps xmm5, [rsp + nb104_fjzH2]
	mulps xmm0, [rsp + nb104_dxMH2]
	mulps xmm1, [rsp + nb104_dyMH2]
	mulps xmm2, [rsp + nb104_dzMH2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb104_fixM]
	...
	;# M-M interaction 
	movaps xmm0, [rsp + nb104_rinvMM]
	movaps xmm1, xmm0
	mulps xmm0, xmm0
	mulps xmm1, [rsp + nb104_qqMM]
	mulps xmm0, xmm1	;# fs M-M 
	addps xmm7, xmm1	;# add to local vctot 
	movaps xmm1, xmm0
	movaps [rsp + nb104_vctot], xmm7
	movaps xmm2, xmm0
	movaps xmm3, [rsp + nb104_fjxM]
	movaps xmm4, [rsp + nb104_fjyM]
	movaps xmm5, [rsp + nb104_fjzM]
	...
	movaps xmm0, [rsp + nb104_fjxH1] ;# xmm0= fjxH1a  fjxH1b  fjxH1c  fjxH1d 
	movaps xmm2, [rsp + nb104_fjyH1] ;# xmm1= fjyH1a  fjyH1b  fjyH1c  fjyH1d
	...
	movaps xmm0, [rsp + nb104_fjzH1]  ;# xmm0= fjzH1a   fjzH1b   fjzH1c   fjzH1d 
	movaps xmm2, [rsp + nb104_fjxH2] ;# xmm1= fjxH2a  fjxH2b  fjxH2c  fjxH2d
	...
	movaps xmm0, [rsp + nb104_fjyH2] ;# xmm0= fjyH2a  fjyH2b  fjyH2c  fjyH2d 
	movaps xmm2, [rsp + nb104_fjzH2] ;# xmm1= fjzH2a  fjzH2b  fjzH2c  fjzH2d
	...
	movaps xmm0, [rsp + nb104_fjxM] ;# xmm0= fjxMa  fjxMb  fjxMc  fjxMd 
	movaps xmm2, [rsp + nb104_fjyM] ;# xmm1= fjyMa  fjyMb  fjyMc  fjyMd
	...
	addss xmm4, [rsp + nb104_fjzM] 
	addss xmm5, [rsp + nb104_fjzM + 4] 
	addss xmm6, [rsp + nb104_fjzM + 8] 
	addss xmm7, [rsp + nb104_fjzM + 12]
	;# store back
...
.nb104_single_loop:
	...
	movaps [rsp + nb104_jxM], xmm3
	movaps [rsp + nb104_jyM], xmm4
	movaps [rsp + nb104_jzM], xmm5
	subps  xmm0, xmm3
	subps  xmm1, xmm4
	subps  xmm2, xmm5
	movaps [rsp + nb104_dxMM], xmm0
