...
_nb_kernel200_x86_64_sse.nb200_updateouterdata: 
    ...
    movaps %xmm0,%xmm3
        ...
        incl %esi
        subl %esi,%ecx
        jecxz _nb_kernel200_x86_64_sse.nb200_outerend
...
_nb_kernel200_x86_64_sse.nb200_outerend: 
        ...
        subl  %esi,%ecx
        jecxz _nb_kernel200_x86_64_sse.nb200_end
...
_nb_kernel200nf_x86_64_sse.nb200nf_updateouterdata: 
       ...
       ## finish if last 
        ...
        incl %esi
        subl %esi,%ecx
        jecxz _nb_kernel200nf_x86_64_sse.nb200nf_outerend
...
_nb_kernel200nf_x86_64_sse.nb200nf_outerend: 
        ...
        ## esi already loaded with n above
        subl  %esi,%ecx
        jecxz _nb_kernel200nf_x86_64_sse.nb200nf_end
        ## non-zero, do one more workunit
