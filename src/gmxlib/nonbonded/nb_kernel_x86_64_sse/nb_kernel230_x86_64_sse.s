...
.nb230_unroll_loop:	
	...
	movaps [rsp + nb230_c6], xmm4
	movaps [rsp + nb230_c12], xmm6
	...
	movaps xmm4, [rsp + nb230_ix]
	movaps xmm5, [rsp + nb230_iy]
	movaps xmm6, [rsp + nb230_iz]
	...
	;# store dr 
	movaps [rsp + nb230_dx], xmm4
	movaps [rsp + nb230_dy], xmm5
	movaps [rsp + nb230_dz], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm7, [rsp + nb230_krf]
	rsqrtps xmm5, xmm4
	;# lookup seed in xmm5 
	movaps xmm2, xmm5
	mulps xmm5, xmm5
	movaps xmm1, [rsp + nb230_three]
	mulps xmm5, xmm4	;# rsq*lu*lu 			
	movaps xmm0, [rsp + nb230_half]
	...
	subps  xmm6, [rsp + nb230_crf]
	mulps  xmm6, xmm3	;# xmm6=vcoul=qq*(rinv+ krsq-crf) 
	mulps  xmm7, [rsp + nb230_two]  ;# 2*krsq
	addps  xmm6, [rsp + nb230_vctot]
	movaps [rsp + nb230_vctot], xmm6

	subps  xmm0, xmm7  ;# rinv-2*krsq
	mulps  xmm0, xmm3  ;# qq*(rinv-2*krsq)
	mulps  xmm0, xmm1  ;# qq*(rinv-2*krsq)*rinv 
	movaps [rsp + nb230_fstmp], xmm0
	
	;# LJ table
	mulps  xmm4, xmm1  ;# r
	mulps  xmm4, [rsp + nb230_tsc] ;# rtab
	...
	movaps xmm0, [rsp + nb230_dx]
	movaps xmm1, [rsp + nb230_dy]
	movaps xmm2, [rsp + nb230_dz]
	...
	;# now update f_i 
	movaps xmm3, [rsp + nb230_fix]
	movaps xmm4, [rsp + nb230_fiy]
	movaps xmm5, [rsp + nb230_fiz]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm5, xmm2
	movaps [rsp + nb230_fix], xmm3
	movaps [rsp + nb230_fiy], xmm4
	movaps [rsp + nb230_fiz], xmm5
...
.nb230_dosingle:			
	...
	movss xmm7, [rsp + nb230_krf]
	rsqrtss xmm5, xmm4
	;# lookup seed in xmm5 
	movss xmm2, xmm5
	mulss xmm5, xmm5
	movss xmm1, [rsp + nb230_three]
	mulss xmm5, xmm4	;# rsq*lu*lu 			
	movss xmm0, [rsp + nb230_half]
	...
	subss  xmm6, [rsp + nb230_crf]
	mulss  xmm6, xmm3	;# xmm6=vcoul=qq*(rinv+ krsq-crf) 
	mulss  xmm7, [rsp + nb230_two]  ;# 2*krsq
	addss  xmm6, [rsp + nb230_vctot]
	movss [rsp + nb230_vctot], xmm6

	subss  xmm0, xmm7  ;# rinv-2*krsq
	mulss  xmm0, xmm3  ;# qq*(rinv-2*krsq)
	mulss  xmm0, xmm1  ;# qq*(rinv-2*krsq)*rinv 
	movss [rsp + nb230_fstmp], xmm0
	
	;# LJ table
	mulss  xmm4, xmm1  ;# r
	mulss  xmm4, [rsp + nb230_tsc] ;# rtab
