...
.nb130_unroll_loop:	
	...
	movaps [rsp + nb130_c6], xmm4
	movaps [rsp + nb130_c12], xmm6
	...
	movaps xmm4, [rsp + nb130_ix]
	movaps xmm5, [rsp + nb130_iy]
	movaps xmm6, [rsp + nb130_iz]
	...
	;# store dr 
	movaps [rsp + nb130_dx], xmm4
	movaps [rsp + nb130_dy], xmm5
	movaps [rsp + nb130_dz], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm2, xmm5
	mulps xmm5, xmm5
	movaps xmm1, [rsp + nb130_three]
	mulps xmm5, xmm4	;# rsq*lu*lu 			
	movaps xmm0, [rsp + nb130_half]
	...
	addps  xmm3, [rsp + nb130_vctot]
	movaps [rsp + nb130_vctot], xmm3

	movaps [rsp + nb130_fstmp], xmm2
	
	;# LJ table
	mulps  xmm4, xmm1  ;# r
	mulps  xmm4, [rsp + nb130_tsc] ;# rtab
	...
	movaps xmm0, [rsp + nb130_dx]
	movaps xmm1, [rsp + nb130_dy]
	movaps xmm2, [rsp + nb130_dz]
	...
	;# now update f_i 
	movaps xmm3, [rsp + nb130_fix]
	movaps xmm4, [rsp + nb130_fiy]
	movaps xmm5, [rsp + nb130_fiz]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm5, xmm2
	movaps [rsp + nb130_fix], xmm3
	movaps [rsp + nb130_fiy], xmm4
	movaps [rsp + nb130_fiz], xmm5
...
.nb130_dosingle:			
	...
	movss xmm2, xmm5
	mulss xmm5, xmm5
	movss xmm1, [rsp + nb130_three]
	mulss xmm5, xmm4	;# rsq*lu*lu 			
	movss xmm0, [rsp + nb130_half]
	...
	addss  xmm3, [rsp + nb130_vctot]
	movss [rsp + nb130_vctot], xmm3

	movss [rsp + nb130_fstmp], xmm2
	
	;# LJ table
	mulss  xmm4, xmm1  ;# r
	mulss  xmm4, [rsp + nb130_tsc] ;# rtab
