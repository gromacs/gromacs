...
.nb133_unroll_loop:
	...
	movaps xmm4, [rsp + nb133_ixO]
	movaps xmm5, [rsp + nb133_iyO]
	movaps xmm6, [rsp + nb133_izO]
	...
	;# store dr 
	movaps [rsp + nb133_dxO], xmm4
	movaps [rsp + nb133_dyO], xmm5
	movaps [rsp + nb133_dzO], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm4, [rsp + nb133_ixH1]
	movaps xmm5, [rsp + nb133_iyH1]
	movaps xmm6, [rsp + nb133_izH1]
	...
	;# store dr 
	movaps [rsp + nb133_dxH1], xmm4
	movaps [rsp + nb133_dyH1], xmm5
	movaps [rsp + nb133_dzH1], xmm6
	;# square it 
	mulps xmm4,xmm4
	mulps xmm5,xmm5
	mulps xmm6,xmm6
	...
	movaps xmm3, [rsp + nb133_ixH2]
	movaps xmm4, [rsp + nb133_iyH2]
	movaps xmm5, [rsp + nb133_izH2]
	...
	movaps xmm3, [rsp + nb133_iyM]
	movaps xmm4, [rsp + nb133_izM]
	subps  xmm3, xmm1
	subps  xmm4, xmm2
	movaps xmm2, [rsp + nb133_ixM]
	subps  xmm2, xmm0	

	;# store dr 
	movaps [rsp + nb133_dxM], xmm2
	movaps [rsp + nb133_dyM], xmm3
	movaps [rsp + nb133_dzM], xmm4
	;# square it 
	mulps xmm2,xmm2
	mulps xmm3,xmm3
	mulps xmm4,xmm4
	...
	mulps   xmm0, xmm3	;# lu*(3-rsq*lu*lu) 
	mulps   xmm0, [rsp + nb133_half]
	movaps  [rsp + nb133_rinvH2], xmm0	;# rinvH2 
	...
	movaps xmm4, [rsp + nb133_c12]
	mulps  xmm7, xmm4 ;# fijR 
	mulps  xmm5, xmm4 ;# Vvdw12 
	mulps  xmm7, [rsp + nb133_tsc]
	addps  xmm7, [rsp + nb133_fstmp]
	...
	movaps xmm3, [rsp + nb133_dxO]
	movaps xmm4, [rsp + nb133_dyO]
	movaps xmm5, [rsp + nb133_dzO]
	mulps  xmm3, xmm1
	mulps  xmm4, xmm1
	...
	addps  xmm1, xmm4
	addps  xmm2, xmm5
	movaps [rsp + nb133_fixO], xmm0
	movaps [rsp + nb133_fiyO], xmm1
	movaps [rsp + nb133_fizO], xmm2
	;# update j forces with water O 
	movaps [rsp + nb133_fjx], xmm3
	movaps [rsp + nb133_fjy], xmm4
	movaps [rsp + nb133_fjz], xmm5

	;# Do H1 interaction
	movaps  xmm7, [rsp + nb133_rinvH1]
	movaps  xmm4, xmm7	
	mulps   xmm4, xmm4	;# xmm7=rinv, xmm4=rinvsq
	mulps  xmm7, [rsp + nb133_qqH]
	mulps  xmm4, xmm7	;# total fs H1 in xmm4 

	addps  xmm7, [rsp + nb133_vctot]	
	movaps [rsp + nb133_vctot], xmm7

	movaps xmm0, [rsp + nb133_dxH1]
	movaps xmm1, [rsp + nb133_dyH1]
	movaps xmm2, [rsp + nb133_dzH1]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H1 forces 
	movaps xmm3, [rsp + nb133_fixH1]
	movaps xmm4, [rsp + nb133_fiyH1]
	movaps xmm7, [rsp + nb133_fizH1]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb133_fixH1], xmm3
	movaps [rsp + nb133_fiyH1], xmm4
	movaps [rsp + nb133_fizH1], xmm7
	;# update j forces with water H1 
	addps  xmm0, [rsp + nb133_fjx]
	addps  xmm1, [rsp + nb133_fjy]
	addps  xmm2, [rsp + nb133_fjz]
	movaps [rsp + nb133_fjx], xmm0
	movaps [rsp + nb133_fjy], xmm1
	movaps [rsp + nb133_fjz], xmm2

	;# Done with H1, do H2 interactions
	movaps  xmm7, [rsp + nb133_rinvH2]
	movaps  xmm4, xmm7	
	mulps   xmm4, xmm4	;# xmm7=rinv, xmm4=rinvsq
	mulps  xmm7, [rsp + nb133_qqH]
	...
	movaps xmm0, [rsp + nb133_dxH2]
	movaps xmm1, [rsp + nb133_dyH2]
	movaps xmm2, [rsp + nb133_dzH2]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4

	;# update H2 forces 
	movaps xmm3, [rsp + nb133_fixH2]
	movaps xmm4, [rsp + nb133_fiyH2]
	movaps xmm7, [rsp + nb133_fizH2]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb133_fixH2], xmm3
	movaps [rsp + nb133_fiyH2], xmm4
	movaps [rsp + nb133_fizH2], xmm7
	addps xmm0, [rsp + nb133_fjx]
        addps xmm1, [rsp + nb133_fjy]
        addps xmm2, [rsp + nb133_fjz]
	movaps [rsp + nb133_fjx], xmm0
	...
	movaps  xmm7, [rsp + nb133_rinvM]
	movaps  xmm4, xmm7	
	mulps   xmm4, xmm4	;# xmm7=rinv, xmm4=rinvsq
	mulps  xmm7, [rsp + nb133_qqM]
	...
	movaps xmm0, [rsp + nb133_dxM]
	movaps xmm1, [rsp + nb133_dyM]
	movaps xmm2, [rsp + nb133_dzM]
	mulps  xmm0, xmm4
	mulps  xmm1, xmm4
	mulps  xmm2, xmm4
	
	;# update M forces 
	movaps xmm3, [rsp + nb133_fixM]
	movaps xmm4, [rsp + nb133_fiyM]
	movaps xmm7, [rsp + nb133_fizM]
	addps  xmm3, xmm0
	addps  xmm4, xmm1
	addps  xmm7, xmm2
	movaps [rsp + nb133_fixM], xmm3
	movaps [rsp + nb133_fiyM], xmm4
	movaps [rsp + nb133_fizM], xmm7
...
.nb133_odd_loop:
	...
	movss xmm3, [rsp + nb133_ixO]
	movss xmm4, [rsp + nb133_iyO]
	movss xmm5, [rsp + nb133_izO]
	movss xmm0, [rsp + nb133_ixH1]
	movss xmm1, [rsp + nb133_iyH1]
	movss xmm2, [rsp + nb133_izH1]
	unpcklps xmm3, [rsp + nb133_ixH2] 	;# ixO ixH2 - -
	unpcklps xmm4, [rsp + nb133_iyH2]  	;# iyO iyH2 - -
	unpcklps xmm5, [rsp + nb133_izH2]	;# izO izH2 - -
	unpcklps xmm0, [rsp + nb133_ixM] 	;# ixH1 ixM - -
	unpcklps xmm1, [rsp + nb133_iyM]  	;# iyH1 iyM - -
	unpcklps xmm2, [rsp + nb133_izM]	;# izH1 izM - -
