...
_nb_kernel010_x86_64_sse.nb010_updateouterdata: 
    ...
    movl  (%rdx,%rsi,4),%edx            ## ggid=gid[n]
        ...
        incl %esi
        subl %esi,%ecx
        jecxz _nb_kernel010_x86_64_sse.nb010_outerend
...
_nb_kernel010_x86_64_sse.nb010_outerend: 
        ...
        subl  %esi,%ecx
        jecxz _nb_kernel010_x86_64_sse.nb010_end
...
_nb_kernel010nf_x86_64_sse.nb010nf_updateouterdata: 
        ...
        incl %esi
        subl %esi,%ecx
        jecxz _nb_kernel010nf_x86_64_sse.nb010nf_outerend
...
_nb_kernel010nf_x86_64_sse.nb010nf_outerend: 
        ...
        ## esi already loaded with n above
        subl  %esi,%ecx
        jecxz _nb_kernel010nf_x86_64_sse.nb010nf_end
        ## non-zero, do one more workunit
