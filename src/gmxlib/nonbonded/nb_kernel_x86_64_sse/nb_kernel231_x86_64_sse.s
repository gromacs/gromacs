...
_nb_kernel231_x86_64_sse.nb231_updateouterdata: 
        ...
        incl %esi
        subl %esi,%ecx
        jecxz _nb_kernel231_x86_64_sse.nb231_outerend
...
_nb_kernel231_x86_64_sse.nb231_outerend: 
        ...
        subl  %esi,%ecx
        jecxz _nb_kernel231_x86_64_sse.nb231_end
...
_nb_kernel231nf_x86_64_sse.nb231nf_updateouterdata: 
        ...
        incl %esi
        subl %esi,%ecx
        jecxz _nb_kernel231nf_x86_64_sse.nb231nf_outerend
...
_nb_kernel231nf_x86_64_sse.nb231nf_outerend: 
        ...
        ## esi already loaded with n above
        subl  %esi,%ecx
        jecxz _nb_kernel231nf_x86_64_sse.nb231nf_end
        ## non-zero, do one more workunit
