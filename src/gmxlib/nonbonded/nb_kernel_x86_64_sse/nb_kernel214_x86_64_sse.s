...
.nb214_unroll_loop:	
	...
	;# store
	movaps [rsp + nb214_jxO], xmm0
	movaps [rsp + nb214_jyO], xmm1
	movaps [rsp + nb214_jzO], xmm2
	movaps [rsp + nb214_jxH1], xmm3
	...
	;# coordinates in xmm0-xmm3	
	;# store
	movaps [rsp + nb214_jyH1], xmm0
	movaps [rsp + nb214_jzH1], xmm1
	movaps [rsp + nb214_jxH2], xmm2
	movaps [rsp + nb214_jyH2], xmm3
	...
	;# coordinates in xmm0-xmm3	
	;# store
	movaps [rsp + nb214_jzH2], xmm0
	movaps [rsp + nb214_jxM], xmm1
	movaps [rsp + nb214_jyM], xmm2
	movaps [rsp + nb214_jzM], xmm3
	
	;# start calculating pairwise distances
	movaps xmm0, [rsp + nb214_ixO]
	movaps xmm1, [rsp + nb214_iyO]
	movaps xmm2, [rsp + nb214_izO]
	movaps xmm3, [rsp + nb214_ixH1]
	movaps xmm4, [rsp + nb214_iyH1]
	movaps xmm5, [rsp + nb214_izH1]
	subps  xmm0, [rsp + nb214_jxO]
	subps  xmm1, [rsp + nb214_jyO]
	subps  xmm2, [rsp + nb214_jzO]
	subps  xmm3, [rsp + nb214_jxH1]
	subps  xmm4, [rsp + nb214_jyH1]
	subps  xmm5, [rsp + nb214_jzH1]
	...
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb214_dxH1H1], xmm3
	movaps [rsp + nb214_dyH1H1], xmm4
	movaps [rsp + nb214_dzH1H1], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb214_rsqOO], xmm0
	movaps [rsp + nb214_rsqH1H1], xmm3

	movaps xmm0, [rsp + nb214_ixH1]
	movaps xmm1, [rsp + nb214_iyH1]
	movaps xmm2, [rsp + nb214_izH1]
	movaps xmm3, xmm0
	movaps xmm4, xmm1
	movaps xmm5, xmm2
	subps  xmm0, [rsp + nb214_jxH2]
	subps  xmm1, [rsp + nb214_jyH2]
	subps  xmm2, [rsp + nb214_jzH2]
	subps  xmm3, [rsp + nb214_jxM]
	subps  xmm4, [rsp + nb214_jyM]
	subps  xmm5, [rsp + nb214_jzM]
	...
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb214_dxH1M], xmm3
	movaps [rsp + nb214_dyH1M], xmm4
	movaps [rsp + nb214_dzH1M], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb214_rsqH1H2], xmm0
	movaps [rsp + nb214_rsqH1M], xmm3

	movaps xmm0, [rsp + nb214_ixH2]
	movaps xmm1, [rsp + nb214_iyH2]
	movaps xmm2, [rsp + nb214_izH2]
	movaps xmm3, xmm0
	movaps xmm4, xmm1
	movaps xmm5, xmm2
	subps  xmm0, [rsp + nb214_jxH1]
	subps  xmm1, [rsp + nb214_jyH1]
	subps  xmm2, [rsp + nb214_jzH1]
	subps  xmm3, [rsp + nb214_jxH2]
	subps  xmm4, [rsp + nb214_jyH2]
	subps  xmm5, [rsp + nb214_jzH2]
	movaps [rsp + nb214_dxH2H1], xmm0
	movaps [rsp + nb214_dyH2H1], xmm1
	movaps [rsp + nb214_dzH2H1], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [rsp + nb214_rsqH2H1], xmm0
	movaps [rsp + nb214_rsqH2H2], xmm3

	movaps xmm0, [rsp + nb214_ixH2]
	movaps xmm1, [rsp + nb214_iyH2]
	movaps xmm2, [rsp + nb214_izH2]
	movaps xmm3, [rsp + nb214_ixM]
	movaps xmm4, [rsp + nb214_iyM]
	movaps xmm5, [rsp + nb214_izM]
	subps  xmm0, [rsp + nb214_jxM]
	subps  xmm1, [rsp + nb214_jyM]
	subps  xmm2, [rsp + nb214_jzM]
	subps  xmm3, [rsp + nb214_jxH1]
	subps  xmm4, [rsp + nb214_jyH1]
	subps  xmm5, [rsp + nb214_jzH1]
	movaps [rsp + nb214_dxH2M], xmm0
	movaps [rsp + nb214_dyH2M], xmm1
	movaps [rsp + nb214_dzH2M], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [rsp + nb214_dxMH1], xmm3
	movaps [rsp + nb214_dyMH1], xmm4
	movaps [rsp + nb214_dzMH1], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm4, xmm3
	addps  xmm4, xmm5
	movaps [rsp + nb214_rsqH2M], xmm0
	movaps [rsp + nb214_rsqMH1], xmm4

	movaps xmm0, [rsp + nb214_ixM]
	movaps xmm1, [rsp + nb214_iyM]
	movaps xmm2, [rsp + nb214_izM]
	movaps xmm3, xmm0
	movaps xmm4, xmm1
	movaps xmm5, xmm2
	subps  xmm0, [rsp + nb214_jxH2]
	...
	subps  xmm4, [rsp + nb214_jyM]
	subps  xmm5, [rsp + nb214_jzM]
	movaps [rsp + nb214_dxMH2], xmm0
	movaps [rsp + nb214_dyMH2], xmm1
	movaps [rsp + nb214_dzMH2], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	...
	addps  xmm4, xmm3
	addps  xmm4, xmm5
	movaps [rsp + nb214_rsqMH2], xmm0
	movaps [rsp + nb214_rsqMM], xmm4

	;# start by doing reciprocal for OO
	movaps  xmm7, [rsp + nb214_rsqOO]
	rcpps   xmm2, xmm7
	movaps  xmm1, [rsp + nb214_two]
	mulps   xmm7, xmm2
	subps   xmm1, xmm7
	mulps   xmm2, xmm1 ;# rinvsq 
	movaps [rsp + nb214_rinvsqOO], xmm2
	
	;# next step is invsqrt - do two at a time.
	rsqrtps xmm1, [rsp + nb214_rsqH1H1]
	rsqrtps xmm5, [rsp + nb214_rsqH1H2]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	...
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb214_rsqH1H1]
	mulps   xmm5, [rsp + nb214_rsqH1H2]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb214_half] ;# rinvH1H1 
	mulps   xmm7, [rsp + nb214_half] ;# rinvH1H2 
	movaps  [rsp + nb214_rinvH1H1], xmm3
	movaps  [rsp + nb214_rinvH1H2], xmm7
	
	rsqrtps xmm1, [rsp + nb214_rsqH1M]
	rsqrtps xmm5, [rsp + nb214_rsqH2H1]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb214_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb214_rsqH1M]
	mulps   xmm5, [rsp + nb214_rsqH2H1]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb214_half] 
	mulps   xmm7, [rsp + nb214_half]
	movaps  [rsp + nb214_rinvH1M], xmm3
	movaps  [rsp + nb214_rinvH2H1], xmm7
	
	rsqrtps xmm1, [rsp + nb214_rsqH2H2]
	rsqrtps xmm5, [rsp + nb214_rsqH2M]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb214_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb214_rsqH2H2]
	mulps   xmm5, [rsp + nb214_rsqH2M]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb214_half] 
	mulps   xmm7, [rsp + nb214_half]
	movaps  [rsp + nb214_rinvH2H2], xmm3
	movaps  [rsp + nb214_rinvH2M], xmm7
	
	rsqrtps xmm1, [rsp + nb214_rsqMH1]
	rsqrtps xmm5, [rsp + nb214_rsqMH2]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [rsp + nb214_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [rsp + nb214_rsqMH1]
	mulps   xmm5, [rsp + nb214_rsqMH2]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [rsp + nb214_half] 
	mulps   xmm7, [rsp + nb214_half]
	movaps  [rsp + nb214_rinvMH1], xmm3
	movaps  [rsp + nb214_rinvMH2], xmm7
        		
	rsqrtps xmm1, [rsp + nb214_rsqMM]
	movaps  xmm2, xmm1
	mulps   xmm1, xmm1
	movaps  xmm3, [rsp + nb214_three]
	mulps   xmm1, [rsp + nb214_rsqMM]
	subps   xmm3, xmm1
	mulps   xmm3, xmm2
	mulps   xmm3, [rsp + nb214_half] 
	movaps  [rsp + nb214_rinvMM], xmm3
	
	;# start with OO LJ interaction
	movaps xmm0, [rsp + nb214_rinvsqOO]
	movaps xmm1, xmm0
	mulps  xmm1, xmm1	;# rinv4
	mulps  xmm1, xmm0	;# xmm1=rinvsix 
	movaps xmm2, xmm1
	mulps  xmm2, xmm2	;# xmm2=rinvtwelve 
	mulps  xmm1, [rsp + nb214_c6]
	mulps  xmm2, [rsp + nb214_c12]
	movaps xmm4, xmm2
	subps  xmm4, xmm1
	addps  xmm4, [rsp + nb214_Vvdwtot]
	mulps  xmm1, [rsp + nb214_six]
	mulps  xmm2, [rsp + nb214_twelve]
	movaps [rsp + nb214_Vvdwtot], xmm4
	subps  xmm2, xmm1
	...
	movaps xmm4, xmm3
	movaps xmm5, xmm3
	mulps xmm0, [rsp + nb214_dxOO]
	mulps xmm1, [rsp + nb214_dyOO]
	mulps xmm2, [rsp + nb214_dzOO]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb214_fixO]
	addps xmm1, [rsp + nb214_fiyO]
	addps xmm2, [rsp + nb214_fizO]
	...
	mulps  xmm6, [rsp + nb214_qqHH] ;# xmm6=voul=qq*(rinv+ krsq-crf) 
	mulps xmm5, [rsp + nb214_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb214_qqHH] ;# xmm7 = coul part of fscal 
	...
	movaps [rsp + nb214_fjxH1], xmm3
	movaps [rsp + nb214_fjyH1], xmm4
	movaps [rsp + nb214_fjzH1], xmm5
	movaps [rsp + nb214_fixH1], xmm0
	movaps [rsp + nb214_fiyH1], xmm1
	movaps [rsp + nb214_fizH1], xmm2

	;# H1-H2 interaction 
	movaps xmm0, [rsp + nb214_rinvH1H2]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb214_krf]
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb214_rsqH1H2] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb214_crf]
	mulps  xmm0, xmm0
	mulps  xmm4, [rsp + nb214_qqHH] ;# xmm4=voul=qq*(rinv+ krsq-crf) 
	mulps  xmm5, [rsp + nb214_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb214_qqHH] ;# xmm7 = coul part of fscal 
	...
	addps xmm1, [rsp + nb214_fiyH1]
	addps xmm2, [rsp + nb214_fizH1]
	movaps [rsp + nb214_fjxH2], xmm3
	movaps [rsp + nb214_fjyH2], xmm4
	movaps [rsp + nb214_fjzH2], xmm5
	movaps [rsp + nb214_fixH1], xmm0
	movaps [rsp + nb214_fiyH1], xmm1
	movaps [rsp + nb214_fizH1], xmm2

	;# H1-M interaction  
	movaps xmm0, [rsp + nb214_rinvH1M]
	movaps xmm7, xmm0	;# xmm7=Rinv 
	movaps xmm5, [rsp + nb214_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb214_rsqH1M] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb214_crf]
	mulps xmm0, xmm0
	mulps  xmm4, [rsp + nb214_qqMH] ;# xmm4=voul=qq*(rinv+ krsq-crf) 
	mulps  xmm5, [rsp + nb214_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb214_qqMH] ;# xmm7 = coul part of fscal 
	addps  xmm6, xmm4	;# add to local vctot 
	...
	addps xmm1, [rsp + nb214_fiyH1]
	addps xmm2, [rsp + nb214_fizH1]
	movaps [rsp + nb214_fjxM], xmm3
	movaps [rsp + nb214_fjyM], xmm4
	movaps [rsp + nb214_fjzM], xmm5
	movaps [rsp + nb214_fixH1], xmm0
	movaps [rsp + nb214_fiyH1], xmm1
	movaps [rsp + nb214_fizH1], xmm2

	;# H2-H1 interaction 
	movaps xmm0, [rsp + nb214_rinvH2H1]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb214_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb214_rsqH2H1] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb214_crf]
	mulps xmm0, xmm0
	...
	movaps xmm3, [rsp + nb214_fjxH1]
	movaps xmm4, [rsp + nb214_fjyH1]
	movaps xmm5, [rsp + nb214_fjzH1]
	mulps xmm0, [rsp + nb214_dxH2H1]
	mulps xmm1, [rsp + nb214_dyH2H1]
	mulps xmm2, [rsp + nb214_dzH2H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	...
	movaps xmm3, [rsp + nb214_fjxH2]
	movaps xmm4, [rsp + nb214_fjyH2]
	movaps xmm5, [rsp + nb214_fjzH2]
	...
	;# H2-M interaction 
	movaps xmm0, [rsp + nb214_rinvH2M]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb214_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb214_rsqH2M] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb214_crf]
	mulps xmm0, xmm0
	...
	movaps xmm3, [rsp + nb214_fjxM]
	movaps xmm4, [rsp + nb214_fjyM]
	movaps xmm5, [rsp + nb214_fjzM]
	mulps xmm0, [rsp + nb214_dxH2M]
	mulps xmm1, [rsp + nb214_dyH2M]
	mulps xmm2, [rsp + nb214_dzH2M]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb214_fixH2]
	...
	;# M-H1 interaction 
	movaps xmm0, [rsp + nb214_rinvMH1]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb214_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb214_rsqMH1] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb214_crf]
	mulps xmm0, xmm0
	...
	movaps xmm4, [rsp + nb214_fjyH1]
	movaps xmm5, [rsp + nb214_fjzH1]
	mulps xmm0, [rsp + nb214_dxMH1]
	mulps xmm1, [rsp + nb214_dyMH1]
	mulps xmm2, [rsp + nb214_dzMH1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	...
	;# M-H2 interaction 
	movaps xmm0, [rsp + nb214_rinvMH2]
	movaps xmm7, xmm0	;# xmm7=rinv 
	movaps xmm5, [rsp + nb214_krf]	
	movaps xmm1, xmm0
	mulps  xmm5, [rsp + nb214_rsqMH2] ;# xmm5=krsq 
	movaps xmm4, xmm5
	addps  xmm4, xmm7	;# xmm4=r inv+ krsq 
	subps  xmm4, [rsp + nb214_crf]
	mulps xmm0, xmm0
	...
	movaps xmm4, [rsp + nb214_fjyH2]
	movaps xmm5, [rsp + nb214_fjzH2]
	mulps xmm0, [rsp + nb214_dxMH2]
	mulps xmm1, [rsp + nb214_dyMH2]
	mulps xmm2, [rsp + nb214_dzMH2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [rsp + nb214_fixM]
	...
	subps  xmm4, [rsp + nb214_crf]
	mulps xmm0, xmm0
	mulps  xmm4, [rsp + nb214_qqMM] ;# xmm4=voul=qq*(rinv+ krsq-crf) 
	mulps  xmm5, [rsp + nb214_two]
	subps  xmm7, xmm5	;# xmm7=rinv-2*krsq 
	mulps  xmm7, [rsp + nb214_qqMM] ;# xmm7 = coul part of fscal 
	addps  xmm6, xmm4	;# add to local vctot 
	mulps xmm0, xmm7	;# fsOH2 
	movaps xmm1, xmm0
	movaps xmm2, xmm0
	...
	movaps xmm0, [rsp + nb214_fjxO]
	movaps xmm1, [rsp + nb214_fjyO]
	movaps xmm2, [rsp + nb214_fjzO]
	movaps xmm3, [rsp + nb214_fjxH1]
	movaps xmm4, xmm0
	movaps xmm5, xmm1
	unpcklps xmm4, xmm2 	
	...
	movaps xmm0, [rsp + nb214_fjyH1]
	movaps xmm1, [rsp + nb214_fjzH1]
	movaps xmm2, [rsp + nb214_fjxH2]
	movaps xmm3, [rsp + nb214_fjyH2]
	movaps xmm4, xmm0
	movaps xmm5, xmm1
	unpcklps xmm4, xmm2 	
	unpcklps xmm5, xmm3	
	...
	movaps xmm0, [rsp + nb214_fjzH2]
	movaps xmm1, [rsp + nb214_fjxM]
	movaps xmm2, [rsp + nb214_fjyM]
	movaps xmm3, [rsp + nb214_fjzM]
...
.nb214_single_loop:
	...
	subps  xmm1, [rsp + nb214_jyO]
	subps  xmm2, [rsp + nb214_jzO]
	subps  xmm3, [rsp + nb214_jxO]
	subps  xmm4, [rsp + nb214_jyO]
	subps  xmm5, [rsp + nb214_jzO]
	...
	movaps  xmm1, [rsp + nb214_iyH1]
	movaps  xmm2, [rsp + nb214_izH1]	
	movaps  xmm3, [rsp + nb214_ixH2] 
	movaps  xmm4, [rsp + nb214_iyH2] 
	movaps  xmm5, [rsp + nb214_izH2] 
	subps   xmm0, [rsp + nb214_jxO]
	subps   xmm1, [rsp + nb214_jyO]
	subps   xmm2, [rsp + nb214_jzO]
	subps   xmm3, [rsp + nb214_jxO]
