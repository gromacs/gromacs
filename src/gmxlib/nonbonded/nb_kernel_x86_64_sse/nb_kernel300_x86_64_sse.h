 ...
 * $Id$
 * 
 * This file is part of Gromacs        Copyright (c) 1991-3004
 ...
 */
#ifndef _NB_KERNEL300_X86_64_SSE_H_
#define _NB_KERNEL300_X86_64_SSE_H_

/*! \file  nb_kernel300_x86_64_sse.h
 *  \brief x86_64 SSE-optimized versions of nonbonded kernel 300
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 300 with forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel300_x86_64_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 300 without forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Tabulated <br>
 ...
 */
void
nb_kernel300nf_x86_64_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL300_X86_64_SSE_H_ */
