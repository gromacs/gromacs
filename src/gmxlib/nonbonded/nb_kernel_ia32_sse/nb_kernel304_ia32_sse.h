 ...
 */
#ifndef _NB_KERNEL304_IA32_SSE_H_
#define _NB_KERNEL304_IA32_SSE_H_

/*! \file  nb_kernel304_ia32_sse.h
 *  \brief ia32 SSE-optimized versions of nonbonded kernel 304
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 304 with forces, optimized for ia32 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel304_ia32_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 304 without forces, optimized for ia32 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Tabulated <br>
 ...
 */
void
nb_kernel304nf_ia32_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL304_IA32_SSE_H_ */
