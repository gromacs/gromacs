 ...
 */
#ifndef _NB_KERNEL331_IA32_SSE_H_
#define _NB_KERNEL331_IA32_SSE_H_


/*! \file  nb_kernel331_ia32_sse.h
 *  \brief ia32 SSE-optimized versions of nonbonded kernel 331
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 331 with forces, optimized for ia32 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel331_ia32_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 331 without forces, optimized for ia32 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Tabulated <br>
 ...
 */
void
nb_kernel331nf_ia32_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL331_IA32_SSE_H_ */
