...
.equiv          nb302_fjzH2b,           1092
.equiv          nb302_fjzH2c,           1096
.equiv          nb302_fjzH2d,           1100
...
.equiv          nb302_salign,           1460
	...
	shufps xmm4, xmm4, 0
	shufps xmm5, xmm5, 0
	movaps [esp + nb302_qqOO], xmm3
	movaps [esp + nb302_qqOH], xmm4
	movaps [esp + nb302_qqHH], xmm5		

	;# create constant floating-point factors on stack
	mov eax, 0x3f000000     ;# constant 0.5 in IEEE (hex)
	mov [esp + nb302_half], eax
	movss xmm1, [esp + nb302_half]
	...
	movaps [esp + nb302_half],  xmm1
	movaps [esp + nb302_two],  xmm2
	movaps [esp + nb302_three],  xmm3
...
.nb302_outer:
	...
	shufps xmm4, xmm4, 0
	shufps xmm5, xmm5, 0
	movaps [esp + nb302_ixO], xmm3
	movaps [esp + nb302_iyO], xmm4
	movaps [esp + nb302_izO], xmm5
	...
	shufps xmm4, xmm4, 0
	shufps xmm5, xmm5, 0
	movaps [esp + nb302_ixH1], xmm0
	movaps [esp + nb302_iyH1], xmm1
	movaps [esp + nb302_izH1], xmm2
	movaps [esp + nb302_ixH2], xmm3
	movaps [esp + nb302_iyH2], xmm4
	movaps [esp + nb302_izH2], xmm5

	;# clear vctot and i forces 
	xorps xmm4, xmm4
	movaps [esp + nb302_vctot], xmm4
	movaps [esp + nb302_fixO], xmm4
	movaps [esp + nb302_fiyO], xmm4
	movaps [esp + nb302_fizO], xmm4
	movaps [esp + nb302_fixH1], xmm4
	movaps [esp + nb302_fiyH1], xmm4
	movaps [esp + nb302_fizH1], xmm4
	movaps [esp + nb302_fixH2], xmm4
	movaps [esp + nb302_fiyH2], xmm4
	movaps [esp + nb302_fizH2], xmm4
...
.nb302_unroll_loop:	
	...
	add dword ptr [esp + nb302_innerjjnr],  16 ;# advance pointer (unrolled 4) 
	...
	movaps [esp + nb302_jxO], xmm0
	movhlps  xmm2, xmm6	;# xmm2= jyOa  jyOb  jyOc  jyOd 
	movaps [esp + nb302_jyO], xmm2
	movlhps  xmm1, xmm3
	movaps [esp + nb302_jxH1], xmm1
	movhlps  xmm3, xmm7
	movaps   xmm6, xmm4
	movaps [esp + nb302_jyH1], xmm3
	movlhps  xmm4, xmm5
	movaps [esp + nb302_jxH2], xmm4
	movhlps  xmm5, xmm6
	movaps [esp + nb302_jyH2], xmm5
	...
	movaps [esp + nb302_jzO],  xmm0
	movaps [esp + nb302_jzH1],  xmm1
	movaps [esp + nb302_jzH2],  xmm2

	movaps xmm0, [esp + nb302_ixO]
	movaps xmm1, [esp + nb302_iyO]
	movaps xmm2, [esp + nb302_izO]
	movaps xmm3, [esp + nb302_ixO]
	movaps xmm4, [esp + nb302_iyO]
	movaps xmm5, [esp + nb302_izO]
	subps  xmm0, [esp + nb302_jxO]
	subps  xmm1, [esp + nb302_jyO]
	subps  xmm2, [esp + nb302_jzO]
	subps  xmm3, [esp + nb302_jxH1]
	subps  xmm4, [esp + nb302_jyH1]
	subps  xmm5, [esp + nb302_jzH1]
	...
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [esp + nb302_dxOH1], xmm3
	movaps [esp + nb302_dyOH1], xmm4
	movaps [esp + nb302_dzOH1], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [esp + nb302_rsqOO], xmm0
	movaps [esp + nb302_rsqOH1], xmm3

	movaps xmm0, [esp + nb302_ixO]
	movaps xmm1, [esp + nb302_iyO]
	movaps xmm2, [esp + nb302_izO]
	movaps xmm3, [esp + nb302_ixH1]
	movaps xmm4, [esp + nb302_iyH1]
	movaps xmm5, [esp + nb302_izH1]
	subps  xmm0, [esp + nb302_jxH2]
	subps  xmm1, [esp + nb302_jyH2]
	subps  xmm2, [esp + nb302_jzH2]
	subps  xmm3, [esp + nb302_jxO]
	subps  xmm4, [esp + nb302_jyO]
	subps  xmm5, [esp + nb302_jzO]
	movaps [esp + nb302_dxOH2], xmm0
	movaps [esp + nb302_dyOH2], xmm1
	movaps [esp + nb302_dzOH2], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [esp + nb302_dxH1O], xmm3
	movaps [esp + nb302_dyH1O], xmm4
	movaps [esp + nb302_dzH1O], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [esp + nb302_rsqOH2], xmm0
	movaps [esp + nb302_rsqH1O], xmm3
	...
	movaps xmm4, [esp + nb302_iyH1]
	movaps xmm5, [esp + nb302_izH1]
	subps  xmm0, [esp + nb302_jxH1]
	subps  xmm1, [esp + nb302_jyH1]
	subps  xmm2, [esp + nb302_jzH1]
	subps  xmm3, [esp + nb302_jxH2]
	subps  xmm4, [esp + nb302_jyH2]
	subps  xmm5, [esp + nb302_jzH2]
	movaps [esp + nb302_dxH1H1], xmm0
	movaps [esp + nb302_dyH1H1], xmm1
	movaps [esp + nb302_dzH1H1], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [esp + nb302_dxH1H2], xmm3
	movaps [esp + nb302_dyH1H2], xmm4
	movaps [esp + nb302_dzH1H2], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [esp + nb302_rsqH1H1], xmm0
	movaps [esp + nb302_rsqH1H2], xmm3

	movaps xmm0, [esp + nb302_ixH2]
	movaps xmm1, [esp + nb302_iyH2]
	movaps xmm2, [esp + nb302_izH2]
	...
	subps  xmm4, [esp + nb302_jyH1]
	subps  xmm5, [esp + nb302_jzH1]
	movaps [esp + nb302_dxH2O], xmm0
	movaps [esp + nb302_dyH2O], xmm1
	movaps [esp + nb302_dzH2O], xmm2
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	movaps [esp + nb302_dxH2H1], xmm3
	movaps [esp + nb302_dyH2H1], xmm4
	movaps [esp + nb302_dzH2H1], xmm5
	mulps  xmm3, xmm3
	mulps  xmm4, xmm4
	mulps  xmm5, xmm5
	addps  xmm0, xmm1
	...
	addps  xmm4, xmm3
	addps  xmm4, xmm5
	movaps [esp + nb302_rsqH2O], xmm0
	movaps [esp + nb302_rsqH2H1], xmm4
	...
	subps  xmm1, [esp + nb302_jyH2]
	subps  xmm2, [esp + nb302_jzH2]
	movaps [esp + nb302_dxH2H2], xmm0
	movaps [esp + nb302_dyH2H2], xmm1
	movaps [esp + nb302_dzH2H2], xmm2
	mulps xmm0, xmm0
	mulps xmm1, xmm1
	mulps xmm2, xmm2
	addps xmm0, xmm1
	addps xmm0, xmm2
	movaps [esp + nb302_rsqH2H2], xmm0
	...
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302_half] ;# rinvH2H2 
	mulps   xmm7, [esp + nb302_half] ;# rinvH2H1 
	movaps  [esp + nb302_rinvH2H2], xmm3
	movaps  [esp + nb302_rinvH2H1], xmm7
		
	rsqrtps xmm1, [esp + nb302_rsqOO]
	rsqrtps xmm5, [esp + nb302_rsqOH1]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [esp + nb302_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [esp + nb302_rsqOO]
	mulps   xmm5, [esp + nb302_rsqOH1]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302_half] 
	mulps   xmm7, [esp + nb302_half]
	movaps  [esp + nb302_rinvOO], xmm3
	movaps  [esp + nb302_rinvOH1], xmm7
	
	rsqrtps xmm1, [esp + nb302_rsqOH2]
	rsqrtps xmm5, [esp + nb302_rsqH1O]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [esp + nb302_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [esp + nb302_rsqOH2]
	mulps   xmm5, [esp + nb302_rsqH1O]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302_half] 
	mulps   xmm7, [esp + nb302_half]
	movaps  [esp + nb302_rinvOH2], xmm3
	movaps  [esp + nb302_rinvH1O], xmm7
	
	rsqrtps xmm1, [esp + nb302_rsqH1H1]
	rsqrtps xmm5, [esp + nb302_rsqH1H2]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [esp + nb302_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [esp + nb302_rsqH1H1]
	mulps   xmm5, [esp + nb302_rsqH1H2]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302_half] 
	mulps   xmm7, [esp + nb302_half]
	movaps  [esp + nb302_rinvH1H1], xmm3
	movaps  [esp + nb302_rinvH1H2], xmm7
	
	rsqrtps xmm1, [esp + nb302_rsqH2O]
	movaps  xmm2, xmm1
	mulps   xmm1, xmm1
	movaps  xmm3, [esp + nb302_three]
	mulps   xmm1, [esp + nb302_rsqH2O]
	subps   xmm3, xmm1
	mulps   xmm3, xmm2
	mulps   xmm3, [esp + nb302_half] 
	movaps  [esp + nb302_rinvH2O], xmm3

	;# start with OO interaction 
	movaps xmm0, [esp + nb302_rinvOO]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqOO] ;# xmm1=r 
	...
	;# O-H1 interaction 
	movaps xmm0, [esp + nb302_rinvOH1]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqOH1] ;# xmm1=r 
	mulps  xmm1, [esp + nb302_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	movaps xmm4, xmm3
	movaps xmm5, xmm3
	mulps xmm0, [esp + nb302_dxOH1]
	mulps xmm1, [esp + nb302_dyOH1]
	mulps xmm2, [esp + nb302_dzOH1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [esp + nb302_fixO]
	addps xmm1, [esp + nb302_fiyO]
	addps xmm2, [esp + nb302_fizO]
	movaps [esp + nb302_fjxH1], xmm3
	movaps [esp + nb302_fjyH1], xmm4
	movaps [esp + nb302_fjzH1], xmm5
	movaps [esp + nb302_fixO], xmm0
	movaps [esp + nb302_fiyO], xmm1
	movaps [esp + nb302_fizO], xmm2

	;# O-H2 interaction  
	movaps xmm0, [esp + nb302_rinvOH2]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqOH2] ;# xmm1=r 
	mulps  xmm1, [esp + nb302_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	movaps xmm4, xmm3
	movaps xmm5, xmm3
	mulps xmm0, [esp + nb302_dxOH2]
	mulps xmm1, [esp + nb302_dyOH2]
	mulps xmm2, [esp + nb302_dzOH2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [esp + nb302_fixO]
	addps xmm1, [esp + nb302_fiyO]
	addps xmm2, [esp + nb302_fizO]
	movaps [esp + nb302_fjxH2], xmm3
	movaps [esp + nb302_fjyH2], xmm4
	movaps [esp + nb302_fjzH2], xmm5
	movaps [esp + nb302_fixO], xmm0
	movaps [esp + nb302_fiyO], xmm1
	movaps [esp + nb302_fizO], xmm2

	;# H1-O interaction 
	movaps xmm0, [esp + nb302_rinvH1O]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqH1O] ;# xmm1=r 
	mulps  xmm1, [esp + nb302_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	;# H1-H1 interaction 
	movaps xmm0, [esp + nb302_rinvH1H1]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqH1H1] ;# xmm1=r 
	mulps  xmm1, [esp + nb302_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	movaps xmm3, [esp + nb302_fjxH1]
	movaps xmm4, [esp + nb302_fjyH1]
	movaps xmm5, [esp + nb302_fjzH1]
	mulps xmm0, [esp + nb302_dxH1H1]
	mulps xmm1, [esp + nb302_dyH1H1]
	mulps xmm2, [esp + nb302_dzH1H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [esp + nb302_fixH1]
	...
	;# H1-H2 interaction 
	movaps xmm0, [esp + nb302_rinvH1H2]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqH1H2] ;# xmm1=r 
	mulps  xmm1, [esp + nb302_tsc]
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	movaps xmm3, [esp + nb302_fjxH2]
	movaps xmm4, [esp + nb302_fjyH2]
	movaps xmm5, [esp + nb302_fjzH2]
	mulps xmm0, [esp + nb302_dxH1H2]
	mulps xmm1, [esp + nb302_dyH1H2]
	mulps xmm2, [esp + nb302_dzH1H2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [esp + nb302_fixH1]
	...
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqH2O] ;# xmm1=r 
	mulps  xmm1, [esp + nb302_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	;# H2-H1 interaction 
	movaps xmm0, [esp + nb302_rinvH2H1]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqH2H1] ;# xmm1=r 
	mulps  xmm1, [esp + nb302_tsc]
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	movaps xmm4, [esp + nb302_fjyH1]
	movaps xmm5, [esp + nb302_fjzH1]
	mulps xmm0, [esp + nb302_dxH2H1]
	mulps xmm1, [esp + nb302_dyH2H1]
	mulps xmm2, [esp + nb302_dzH2H1]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [esp + nb302_fixH2]
	...
	;# H2-H2 interaction 
	movaps xmm0, [esp + nb302_rinvH2H2]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302_rsqH2H2] ;# xmm1=r 
	mulps  xmm1, [esp + nb302_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	movaps xmm4, [esp + nb302_fjyH2]
	movaps xmm5, [esp + nb302_fjzH2]
	mulps xmm0, [esp + nb302_dxH2H2]
	mulps xmm1, [esp + nb302_dyH2H2]
	mulps xmm2, [esp + nb302_dzH2H2]
	subps xmm3, xmm0
	subps xmm4, xmm1
	subps xmm5, xmm2
	addps xmm0, [esp + nb302_fixH2]
	...
	movaps xmm0, [esp + nb302_fjxO] ;# xmm0= fjxOa  fjxOb  fjxOc  fjxOd 
	movaps xmm2, [esp + nb302_fjyO] ;# xmm1= fjyOa  fjyOb  fjyOc  fjyOd
	...
	movaps xmm0, [esp + nb302_fjzO]  ;# xmm0= fjzOa   fjzOb   fjzOc   fjzOd 
	movaps xmm2, [esp + nb302_fjxH1] ;# xmm1= fjxH1a  fjxH1b  fjxH1c  fjxH1d
	...
	movaps xmm0, [esp + nb302_fjyH1]  ;# xmm0= fjyH1a  fjyH1b  fjyH1c  fjyH1d 
	movaps xmm2, [esp + nb302_fjzH1] ;# xmm1= fjzH1a  fjzH1b  fjzH1c  fjzH1d
	...
	movaps xmm0, [esp + nb302_fjxH2]  ;# xmm0= fjxH2a  fjxH2b  fjxH2c  fjxH2d 
	movaps xmm2, [esp + nb302_fjyH2] ;# xmm1= fjyH2a  fjyH2b  fjyH2c  fjyH2d
	...
	addss xmm4, [esp + nb302_fjzH2] 
	addss xmm5, [esp + nb302_fjzH2b] 
	addss xmm6, [esp + nb302_fjzH2c] 
	addss xmm7, [esp + nb302_fjzH2d]
	;# store back
	...
	sub dword ptr [esp + nb302_innerk],  4
	jl    .nb302_single_check
	jmp   .nb302_unroll_loop
.nb302_single_check:
	add dword ptr [esp + nb302_innerk],  4
...
.nb302_updateouterdata:
	...
	movaps xmm0, [esp + nb302_fixO]
	movaps xmm1, [esp + nb302_fiyO] 
	movaps xmm2, [esp + nb302_fizO]
	...
	movaps xmm0, [esp + nb302_fixH1]
	movaps xmm1, [esp + nb302_fiyH1]
	movaps xmm2, [esp + nb302_fizH1]
	...
	movaps xmm0, [esp + nb302_fixH2]
	movaps xmm1, [esp + nb302_fiyH2]
	movaps xmm2, [esp + nb302_fizH2]
...
.equiv          nb302nf_salign,         724
	...
	shufps xmm4, xmm4, 0
	shufps xmm5, xmm5, 0
	movaps [esp + nb302nf_qqOO], xmm3
	movaps [esp + nb302nf_qqOH], xmm4
	movaps [esp + nb302nf_qqHH], xmm5		

	;# create constant floating-point factors on stack
	mov eax, 0x3f000000     ;# constant 0.5 in IEEE (hex)
	mov [esp + nb302nf_half], eax
	movss xmm1, [esp + nb302nf_half]
	shufps xmm1, xmm1, 0    ;# splat to all elements
	movaps xmm2, xmm1       
	addps  xmm2, xmm2	;# constant 1.0
	movaps xmm3, xmm2
	addps  xmm2, xmm2	;# constant 2.0
	addps  xmm3, xmm2	;# constant 3.0
	movaps [esp + nb302nf_half],  xmm1
	movaps [esp + nb302nf_three],  xmm3
...
.nb302nf_outer:
	...
	shufps xmm4, xmm4, 0
	shufps xmm5, xmm5, 0
	movaps [esp + nb302nf_ixO], xmm3
	movaps [esp + nb302nf_iyO], xmm4
	movaps [esp + nb302nf_izO], xmm5
	...
	shufps xmm4, xmm4, 0
	shufps xmm5, xmm5, 0
	movaps [esp + nb302nf_ixH1], xmm0
	movaps [esp + nb302nf_iyH1], xmm1
	movaps [esp + nb302nf_izH1], xmm2
	movaps [esp + nb302nf_ixH2], xmm3
	movaps [esp + nb302nf_iyH2], xmm4
	movaps [esp + nb302nf_izH2], xmm5

	;# clear vctot and i forces 
	xorps xmm4, xmm4
	movaps [esp + nb302nf_vctot], xmm4
...
.nb302nf_unroll_loop:	
	...
	add dword ptr [esp + nb302nf_innerjjnr],  16 ;# advance pointer (unrolled 4) 
	...
	movaps   xmm7, xmm1
	movlhps  xmm0, xmm2	;# xmm0= jxOa  jxOb  jxOc  jxOd 
	movaps [esp + nb302nf_jxO], xmm0
	movhlps  xmm2, xmm6	;# xmm2= jyOa  jyOb  jyOc  jyOd 
	movaps [esp + nb302nf_jyO], xmm2
	movlhps  xmm1, xmm3
	movaps [esp + nb302nf_jxH1], xmm1
	movhlps  xmm3, xmm7
	movaps   xmm6, xmm4
	movaps [esp + nb302nf_jyH1], xmm3
	movlhps  xmm4, xmm5
	movaps [esp + nb302nf_jxH2], xmm4
	movhlps  xmm5, xmm6
	movaps [esp + nb302nf_jyH2], xmm5
	...
	shufps xmm1, xmm4, 204  ;# constant 11001100
	shufps xmm2, xmm5, 204  ;# constant 11001100
	movaps [esp + nb302nf_jzO],  xmm0
	movaps [esp + nb302nf_jzH1],  xmm1
	movaps [esp + nb302nf_jzH2],  xmm2

	movaps xmm0, [esp + nb302nf_ixO]
	movaps xmm1, [esp + nb302nf_iyO]
	movaps xmm2, [esp + nb302nf_izO]
	movaps xmm3, [esp + nb302nf_ixO]
	movaps xmm4, [esp + nb302nf_iyO]
	movaps xmm5, [esp + nb302nf_izO]
	subps  xmm0, [esp + nb302nf_jxO]
	subps  xmm1, [esp + nb302nf_jyO]
	subps  xmm2, [esp + nb302nf_jzO]
	subps  xmm3, [esp + nb302nf_jxH1]
	subps  xmm4, [esp + nb302nf_jyH1]
	subps  xmm5, [esp + nb302nf_jzH1]
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	mulps  xmm3, xmm3
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [esp + nb302nf_rsqOO], xmm0
	movaps [esp + nb302nf_rsqOH1], xmm3

	movaps xmm0, [esp + nb302nf_ixO]
	movaps xmm1, [esp + nb302nf_iyO]
	movaps xmm2, [esp + nb302nf_izO]
	movaps xmm3, [esp + nb302nf_ixH1]
	movaps xmm4, [esp + nb302nf_iyH1]
	movaps xmm5, [esp + nb302nf_izH1]
	subps  xmm0, [esp + nb302nf_jxH2]
	subps  xmm1, [esp + nb302nf_jyH2]
	subps  xmm2, [esp + nb302nf_jzH2]
	subps  xmm3, [esp + nb302nf_jxO]
	subps  xmm4, [esp + nb302nf_jyO]
	subps  xmm5, [esp + nb302nf_jzO]
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	mulps  xmm3, xmm3
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [esp + nb302nf_rsqOH2], xmm0
	movaps [esp + nb302nf_rsqH1O], xmm3

	movaps xmm0, [esp + nb302nf_ixH1]
	movaps xmm1, [esp + nb302nf_iyH1]
	movaps xmm2, [esp + nb302nf_izH1]
	movaps xmm3, [esp + nb302nf_ixH1]
	movaps xmm4, [esp + nb302nf_iyH1]
	movaps xmm5, [esp + nb302nf_izH1]
	subps  xmm0, [esp + nb302nf_jxH1]
	subps  xmm1, [esp + nb302nf_jyH1]
	subps  xmm2, [esp + nb302nf_jzH1]
	subps  xmm3, [esp + nb302nf_jxH2]
	subps  xmm4, [esp + nb302nf_jyH2]
	subps  xmm5, [esp + nb302nf_jzH2]
	mulps  xmm0, xmm0
	mulps  xmm1, xmm1
	mulps  xmm2, xmm2
	mulps  xmm3, xmm3
	...
	addps  xmm3, xmm4
	addps  xmm3, xmm5
	movaps [esp + nb302nf_rsqH1H1], xmm0
	movaps [esp + nb302nf_rsqH1H2], xmm3

	movaps xmm0, [esp + nb302nf_ixH2]
	movaps xmm1, [esp + nb302nf_iyH2]
	movaps xmm2, [esp + nb302nf_izH2]
	movaps xmm3, [esp + nb302nf_ixH2]
	movaps xmm4, [esp + nb302nf_iyH2]
	movaps xmm5, [esp + nb302nf_izH2]
	subps  xmm0, [esp + nb302nf_jxO]
	subps  xmm1, [esp + nb302nf_jyO]
	subps  xmm2, [esp + nb302nf_jzO]
	subps  xmm3, [esp + nb302nf_jxH1]
	...
	addps  xmm4, xmm3
	addps  xmm4, xmm5
	movaps [esp + nb302nf_rsqH2O], xmm0
	movaps [esp + nb302nf_rsqH2H1], xmm4
	...
	addps xmm0, xmm1
	addps xmm0, xmm2
	movaps [esp + nb302nf_rsqH2H2], xmm0
	...
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302nf_half] ;# rinvH2H2 
	mulps   xmm7, [esp + nb302nf_half] ;# rinvH2H1 
	movaps  [esp + nb302nf_rinvH2H2], xmm3
	movaps  [esp + nb302nf_rinvH2H1], xmm7
		
	rsqrtps xmm1, [esp + nb302nf_rsqOO]
	rsqrtps xmm5, [esp + nb302nf_rsqOH1]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [esp + nb302nf_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [esp + nb302nf_rsqOO]
	mulps   xmm5, [esp + nb302nf_rsqOH1]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302nf_half] 
	mulps   xmm7, [esp + nb302nf_half]
	movaps  [esp + nb302nf_rinvOO], xmm3
	movaps  [esp + nb302nf_rinvOH1], xmm7
	
	rsqrtps xmm1, [esp + nb302nf_rsqOH2]
	rsqrtps xmm5, [esp + nb302nf_rsqH1O]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [esp + nb302nf_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [esp + nb302nf_rsqOH2]
	mulps   xmm5, [esp + nb302nf_rsqH1O]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302nf_half] 
	mulps   xmm7, [esp + nb302nf_half]
	movaps  [esp + nb302nf_rinvOH2], xmm3
	movaps  [esp + nb302nf_rinvH1O], xmm7
	
	rsqrtps xmm1, [esp + nb302nf_rsqH1H1]
	rsqrtps xmm5, [esp + nb302nf_rsqH1H2]
	movaps  xmm2, xmm1
	movaps  xmm6, xmm5
	mulps   xmm1, xmm1
	mulps   xmm5, xmm5
	movaps  xmm3, [esp + nb302nf_three]
	movaps  xmm7, xmm3
	mulps   xmm1, [esp + nb302nf_rsqH1H1]
	mulps   xmm5, [esp + nb302nf_rsqH1H2]
	subps   xmm3, xmm1
	subps   xmm7, xmm5
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302nf_half] 
	mulps   xmm7, [esp + nb302nf_half]
	movaps  [esp + nb302nf_rinvH1H1], xmm3
	movaps  [esp + nb302nf_rinvH1H2], xmm7
	
	rsqrtps xmm1, [esp + nb302nf_rsqH2O]
	movaps  xmm2, xmm1
	mulps   xmm1, xmm1
	movaps  xmm3, [esp + nb302nf_three]
	mulps   xmm1, [esp + nb302nf_rsqH2O]
	subps   xmm3, xmm1
	mulps   xmm3, xmm2
	mulps   xmm3, [esp + nb302nf_half] 
	movaps  [esp + nb302nf_rinvH2O], xmm3

	;# start with OO interaction 
	movaps xmm0, [esp + nb302nf_rinvOO]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqOO] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]
	...
	;# increment vcoul - then we can get rid of mm5 
	;# update vctot 
	addps  xmm5, [esp + nb302nf_vctot]
	movaps [esp + nb302nf_vctot], xmm5

	;# O-H1 interaction 
	movaps xmm0, [esp + nb302nf_rinvOH1]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqOH1] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	;# O-H2 interaction  
	movaps xmm0, [esp + nb302nf_rinvOH2]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqOH2] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	;# H1-O interaction 
	movaps xmm0, [esp + nb302nf_rinvH1O]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqH1O] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	;# H1-H1 interaction 
	movaps xmm0, [esp + nb302nf_rinvH1H1]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqH1H1] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	movaps [esp + nb302nf_vctot], xmm5
	;# H1-H2 interaction 
	movaps xmm0, [esp + nb302nf_rinvH1H2]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqH1H2] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	;# H2-O interaction 
	movaps xmm0, [esp + nb302nf_rinvH2O]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqH2O] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	;# H2-H1 interaction 
	movaps xmm0, [esp + nb302nf_rinvH2H1]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqH2H1] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
	...
	;# H2-H2 interaction 
	movaps xmm0, [esp + nb302nf_rinvH2H2]
	movaps xmm1, xmm0
	mulps  xmm1, [esp + nb302nf_rsqH2H2] ;# xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]	
	movhlps xmm2, xmm1
	cvttps2pi mm6, xmm1
	cvttps2pi mm7, xmm2 	;# mm6/mm7 contain lu indices 
...
.nb302nf_single_loop:
	...
	;# store all j coordinates in jO  
	movaps [esp + nb302nf_jxO], xmm3
	movaps [esp + nb302nf_jyO], xmm4
	movaps [esp + nb302nf_jzO], xmm5
	subps  xmm0, xmm3
	subps  xmm1, xmm4
	subps  xmm2, xmm5
	mulps xmm0, xmm0
	...
	subps   xmm3, xmm1
	mulps   xmm3, xmm2							
	mulps   xmm3, [esp + nb302nf_half] ;# rinv iO - j water 
	...
	xorps  xmm3, xmm3
	;# fetch charges to xmm3 (temporary) 
	movss   xmm3, [esp + nb302nf_qqOO]
	movhps  xmm3, [esp + nb302nf_qqOH]
	...
	;# start with H1, save H2 data 
	movaps [esp + nb302nf_rsqH2O], xmm4
	...
	mulps   xmm3, xmm2
	mulps   xmm7, xmm6
	mulps   xmm3, [esp + nb302nf_half] ;# rinv H1 - j water 
	mulps   xmm7, [esp + nb302nf_half] ;# rinv H2 - j water  

	;# start with H1, save H2 data 
	movaps [esp + nb302nf_rinvH2O], xmm7
	...
	xorps  xmm3, xmm3
	;# fetch charges to xmm3 (temporary) 
	movss   xmm3, [esp + nb302nf_qqOH]
	movhps  xmm3, [esp + nb302nf_qqHH]
	...
	;# do table for H2 - j water interaction 
	movaps xmm0, [esp + nb302nf_rinvH2O]
	movaps xmm1, [esp + nb302nf_rsqH2O]
	mulps  xmm1, xmm0	;# xmm0=rinv, xmm1=r 
	mulps  xmm1, [esp + nb302nf_tsc]
