 ...
 */
#ifndef _NB_KERNEL132_IA32_SSE_H_
#define _NB_KERNEL132_IA32_SSE_H_


/*! \file  nb_kernel132_ia32_sse.h
 *  \brief ia32 SSE-optimized versions of nonbonded kernel 132
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 132 with forces, optimized for ia32 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel132_ia32_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 132 without forces, optimized for ia32 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Standard 1/r <br>
 ...
 */
void
nb_kernel132nf_ia32_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL132_IA32_SSE_H_ */
