                    ...
                    real *  work)
{
    ...
    const double _Complex one   = __cmplx(1.0,1.0);
    ...
    double _qM,_qH,_qqMM,_qqMH,_qqHH;
...
#pragma disjoint(*shiftvec,*fshift,*pos,*faction,*charge,*p_facel,*p_krf,*p_crf,*Vc, \
	...
	/* add the shift vector to all water atoms */
        ...
        double _ix4 = _shX + pos[ii3+9];
        double _iy4 = _shY + pos[ii3+10];
        double _iz4 = _shZ + pos[ii3+11];
