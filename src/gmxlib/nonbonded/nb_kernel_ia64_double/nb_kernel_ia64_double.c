...
#include "nb_kernel130_ia64_double.h"
#include "nb_kernel130nf_ia64_double.h"
...
#include "nb_kernel230_ia64_double.h"
#include "nb_kernel230nf_ia64_double.h"
...
static nb_kernel_t *
kernellist_ia64_double[eNR_NBKERNEL_NR] = 
{
    nb_kernel010_ia64_double,
    NULL,
    nb_kernel030_ia64_double,
    nb_kernel100_ia64_double,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    nb_kernel130_ia64_double,
    NULL,
    NULL,
    NULL,
    NULL,
    nb_kernel200_ia64_double,
    NULL,
    NULL,
    NULL,
    NULL,
    nb_kernel210_ia64_double,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    nb_kernel230_ia64_double,
    NULL,
    NULL,
    NULL,
    NULL,
    nb_kernel300_ia64_double,
    NULL,
    NULL,
    NULL,
    NULL,
    nb_kernel310_ia64_double,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    nb_kernel330_ia64_double,
    NULL,
    NULL,
    NULL,
    NULL,
    nb_kernel400_ia64_double,
