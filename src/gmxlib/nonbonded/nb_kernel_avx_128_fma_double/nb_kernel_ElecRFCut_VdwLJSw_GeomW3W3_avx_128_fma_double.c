...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecRFCut_VdwLJSw_GeomW3W3_VF_avx_128_fma_double
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end-1; jidx+=2)
        {
            ...
            velec            = _mm_mul_pd(qq00,_mm_sub_pd(gmx_mm_fmadd_pd(krf,rsq00,rinv00),crf));
            felec            = _mm_mul_pd(qq00,gmx_mm_fmsub_pd(rinv00,rinvsq00,krf2));
            ...
            /* REACTION-FIELD ELECTROSTATICS */
            velec            = _mm_mul_pd(qq01,_mm_sub_pd(gmx_mm_fmadd_pd(krf,rsq01,rinv01),crf));
            felec            = _mm_mul_pd(qq01,gmx_mm_fmsub_pd(rinv01,rinvsq01,krf2));
            ...
            /* REACTION-FIELD ELECTROSTATICS */
            velec            = _mm_mul_pd(qq02,_mm_sub_pd(gmx_mm_fmadd_pd(krf,rsq02,rinv02),crf));
            felec            = _mm_mul_pd(qq02,gmx_mm_fmsub_pd(rinv02,rinvsq02,krf2));
            ...
            /* REACTION-FIELD ELECTROSTATICS */
            velec            = _mm_mul_pd(qq10,_mm_sub_pd(gmx_mm_fmadd_pd(krf,rsq10,rinv10),crf));
            felec            = _mm_mul_pd(qq10,gmx_mm_fmsub_pd(rinv10,rinvsq10,krf2));
            ...
            /* REACTION-FIELD ELECTROSTATICS */
            velec            = _mm_mul_pd(qq20,_mm_sub_pd(gmx_mm_fmadd_pd(krf,rsq20,rinv20),crf));
            felec            = _mm_mul_pd(qq20,gmx_mm_fmsub_pd(rinv20,rinvsq20,krf2));
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecRFCut_VdwLJSw_GeomW3W3_F_avx_128_fma_double
 * Electrostatics interaction: ReactionField
 * VdW interaction:            LennardJones
 * Geometry:                   Water3-Water3
 ...
 */
void
nb_kernel_ElecRFCut_VdwLJSw_GeomW3W3_F_avx_128_fma_double
                    (t_nblist * gmx_restrict                nlist,
                     rvec * gmx_restrict                    xx,
                     rvec * gmx_restrict                    ff,
                     t_forcerec * gmx_restrict              fr,
