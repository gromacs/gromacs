...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecRFCut_VdwLJSh_GeomW3P1_VF_avx_128_fma_double
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end-1; jidx+=2)
        {
            ...
            vvdw             = gmx_mm_fmsub_pd(gmx_mm_fnmadd_pd(c12_00,_mm_mul_pd(sh_vdw_invrcut6,sh_vdw_invrcut6),vvdw12),one_twelfth,
                                           _mm_mul_pd(gmx_mm_fnmadd_pd( c6_00,sh_vdw_invrcut6,vvdw6),one_sixth));
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecRFCut_VdwLJSh_GeomW3P1_F_avx_128_fma_double
 * Electrostatics interaction: ReactionField
 * VdW interaction:            LennardJones
 * Geometry:                   Water3-Particle
