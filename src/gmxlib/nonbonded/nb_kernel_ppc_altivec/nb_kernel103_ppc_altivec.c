...
void 
nb_kernel103_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	vector float iH1x,iH1y,iH1z,iH2x,iH2y,iH2z,iMx,iMy,iMz;
	vector float dH1x,dH1y,dH1z,dH2x,dH2y,dH2z,dMx,dMy,dMz;
	vector float vfacel,vcoulM,vcoulH1,vcoulH2,nul;
	vector float fsM,fsH1,fsH2;
	...
	do {
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			ii         = iinr[n];
			ii3        = 3*ii;
			/* Use 3-atoms routine; we only need H1,H2,M here */
...
void 
nb_kernel103nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
