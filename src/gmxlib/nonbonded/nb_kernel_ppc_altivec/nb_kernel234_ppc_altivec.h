 ...
 */
#ifndef _NB_KERNEL234_ALTIVEC_H_
#define _NB_KERNEL234_ALTIVEC_H_

/*! \file  nb_kernel234_ppc_altivec.h
 *  \brief Altivec-optimized versions of nonbonded kernel 234
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 234 with forces, optimized for Altivec.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel234_ppc_altivec  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 234 without forces, optimized for Altivec.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Reaction-field <br>
 ...
 */
void
nb_kernel234nf_ppc_altivec(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL234_ALTIVEC_H_ */
