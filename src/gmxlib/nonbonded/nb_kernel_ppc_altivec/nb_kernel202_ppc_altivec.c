...
void 
nb_kernel202_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
...
void 
nb_kernel202nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	...
	vector float rsq11,rsq12,rsq13,rsq21,rsq22,rsq23,rsq31,rsq32,rsq33;
	vector float rinv11,rinv12,rinv13,rinv21,rinv22,rinv23,rinv31;
	vector float rinv32,rinv33;

	vector float vfacel,nul;
	vector float vctot,qqOO,qqOH,qqHH,qO,qH,vkrf,vcrf;
	vector float krsq11,krsq12,krsq13,krsq21,krsq22,krsq23,krsq31;
	vector float krsq32,krsq33;
	vector float qqOOt,qqOHt,qqHHt;
