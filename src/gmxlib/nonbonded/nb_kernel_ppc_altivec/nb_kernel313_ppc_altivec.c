...
void 
nb_kernel313_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	...
	vector float Vvdwtot,c6,c12,Vvdw6,Vvdw12,rinvsix;
	vector float fsO,fsH1,fsH2,fsM;
	vector float vctot,qqM,qqH,iqM,iqH,jq;
	vector float fiOx,fiOy,fiOz,fiH1x,fiH1y,fiH1z;
	vector float fiH2x,fiH2y,fiH2z,fiMx,fiMy,fiMz;
	vector float tmp1,tmp2,tmp3,tmp4;
	vector float rinvsqO,rinvH1,rinvH2,rinvM,rsqO,rsqH1,rsqH2,rsqM;
	vector float rH1,rH2,rM,VVcM,FFcM,VVcH1,FFcH1,VVcH2,FFcH2;
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				do_3_invsqrt(rsqH1,rsqH2,rsqM,&rinvH1,&rinvH2,&rinvM);
			...
			if(k<(nj1-2)) {
				...
				zero_highest_element_in_3_vectors(&rinvsqO,&rinvH1,&rinvH2);
				...
				zero_highest_2_elements_in_3_vectors(&rinvsqO,&rinvH1,&rinvH2);
				...
				zero_highest_3_elements_in_3_vectors(&rinvsqO,&rinvH1,&rinvH2);
...
void 
nb_kernel313nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	...
	vector float vctot,qqM,qqH,iqM,iqH,jq;
	vector float rinvsqO,rinvH1,rinvH2,rinvM,rsqO,rsqH1,rsqH2,rsqM;
	vector float rH1,rH2,rM,VVcM,VVcH1,VVcH2;
