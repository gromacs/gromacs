 ...
 */
#ifndef _NB_KERNEL330_ALTIVEC_H_
#define _NB_KERNEL330_ALTIVEC_H_

/*! \file  nb_kernel330_ppc_altivec.h
 *  \brief Altivec-optimized versions of nonbonded kernel 330
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 330 with forces, optimized for Altivec.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel330_ppc_altivec  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 330 without forces, optimized for Altivec.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Tabulated <br>
 ...
 */
void
nb_kernel330nf_ppc_altivec(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL330_ALTIVEC_H_ */
