...
void 
nb_kernel331_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				do_4_ljctable_coul_and_lj(VFtab,vec_madd(rO,tsc,nul),
										  &VVcO,&FFcO,&VVd,&FFd,&VVr,&FFr);
			...
			if(k<(nj1-2)) {
				...
				do_3_ljctable_coul_and_lj(VFtab,vec_madd(rO,tsc,nul),
										  &VVcO,&FFcO,&VVd,&FFd,&VVr,&FFr);
				...
				do_2_ljctable_coul_and_lj(VFtab,vec_madd(rO,tsc,nul),
										  &VVcO,&FFcO,&VVd,&FFd,&VVr,&FFr);
				...
				do_1_ljctable_coul_and_lj(VFtab,vec_madd(rO,tsc,nul),
										  &VVcO,&FFcO,&VVd,&FFd,&VVr,&FFr);
...
void 
nb_kernel331nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				jq=load_4_float(charge+jnra,charge+jnrb,
								charge+jnrc,charge+jnrd);
				load_4_pair(vdwparam+tja,vdwparam+tjb,vdwparam+tjc,vdwparam+tjd,&c6,&c12);
				do_vonly_4_ljctable_coul_and_lj(VFtab,vec_madd(rO,tsc,nul),
												&VVcO,&VVd,&VVr);
			...
			if(k<(nj1-2)) {
				...
				load_3_pair(vdwparam+tja,vdwparam+tjb,vdwparam+tjc,&c6,&c12);
				jq=load_3_float(charge+jnra,charge+jnrb,charge+jnrc);
				do_vonly_3_ljctable_coul_and_lj(VFtab,vec_madd(rO,tsc,nul),
												&VVcO,&VVd,&VVr);
				...
				jq=load_2_float(charge+jnra,charge+jnrb);
				load_2_pair(vdwparam+tja,vdwparam+tjb,&c6,&c12);
				do_vonly_2_ljctable_coul_and_lj(VFtab,vec_madd(rO,tsc,nul),
												&VVcO,&VVd,&VVr);
				...
				jq=load_1_float(charge+jnra);
				load_1_pair(vdwparam+tja,&c6,&c12);
				do_vonly_1_ljctable_coul_and_lj(VFtab,vec_madd(rO,tsc,nul),
												&VVcO,&VVd,&VVr);
