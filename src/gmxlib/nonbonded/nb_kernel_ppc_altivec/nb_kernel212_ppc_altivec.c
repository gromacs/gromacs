...
void 
nb_kernel212_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	...
	vector float Vvdw6,Vvdw12,Vvdwtot,qqOOt,qqOHt,qqHHt,c6t,c12t;
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				fs11            = vec_madd(vec_twelve(),Vvdw12,fs11);
...
void 
nb_kernel212nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
