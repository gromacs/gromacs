 ...
 *
 * 
 * This file is part of Gromacs        Copyright (c) 1991-1004
 ...
 */
#ifndef _NB_KERNEL100_IA64S_H_
#define _NB_KERNEL100_IA64S_H_

/*! \file  nb_kernel100_ia64_single.h
 *  \brief ia64(single)-optimized versions of nonbonded kernel 100
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 100 with forces, optimized for ia64 single precision assembly.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel100_ia64_single    (int *   nri,        int     iinr[],   int     jindex[],
