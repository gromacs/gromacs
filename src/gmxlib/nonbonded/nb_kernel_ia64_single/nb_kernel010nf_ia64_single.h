 ...
 */
#ifndef _NB_KERNEL010NF_IA64S_H_
#define _NB_KERNEL010NF_IA64S_H_

/*! \file  nb_kernel010nf_ia64_single.h
 *  \brief ia64(single)-optimized versions of nonbonded kernel 010
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 010 without forces, optimized for ia64 single precision assembly.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel010nf_ia64_single  (int *   nri,        int     iinr[],   int     jindex[],
...
#endif /* _NB_KERNEL010NF_IA64S_H_ */
