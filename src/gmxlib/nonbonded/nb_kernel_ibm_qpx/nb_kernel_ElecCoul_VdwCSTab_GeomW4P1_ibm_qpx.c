...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCoul_VdwCSTab_GeomW4P1_VF_ibm_qpx
 ...
 */
void
nb_kernel_ElecCoul_VdwCSTab_GeomW4P1_VF_ibm_qpx
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            /* COULOMB ELECTROSTATICS */
            velec            = vec_mul(qq30,rinv30);
            felec            = vec_mul(velec,rinvsq30);
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCoul_VdwCSTab_GeomW4P1_F_ibm_qpx
 * Electrostatics interaction: Coulomb
 * VdW interaction:            CubicSplineTable
 * Geometry:                   Water4-Particle
 ...
 */
void
nb_kernel_ElecCoul_VdwCSTab_GeomW4P1_F_ibm_qpx
                    (t_nblist * gmx_restrict                nlist,
                     rvec * gmx_restrict                    xx,
                     rvec * gmx_restrict                    ff,
                     t_forcerec * gmx_restrict              fr,
