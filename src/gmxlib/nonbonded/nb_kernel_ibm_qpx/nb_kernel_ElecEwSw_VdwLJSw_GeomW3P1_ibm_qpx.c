...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSw_VdwLJSw_GeomW3P1_VF_ibm_qpx
 ...
 */
void
nb_kernel_ElecEwSw_VdwLJSw_GeomW3P1_VF_ibm_qpx
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            felec            = vec_msub( felec,sw , vec_mul(rinv00,vec_mul(velec,dsw)) );
            fvdw             = vec_msub( fvdw,sw , vec_mul(rinv00,vec_mul(vvdw,dsw)) );
            ...
            /* Evaluate switch function */
            /* fscal'=f'/r=-(v*sw)'/r=-(v'*sw+v*dsw)/r=-v'*sw/r-v*dsw/r=fscal*sw-v*dsw/r */
            felec            = vec_msub( felec,sw , vec_mul(rinv10,vec_mul(velec,dsw)) );
            velec            = vec_mul(velec,sw);
            ...
            /* Evaluate switch function */
            /* fscal'=f'/r=-(v*sw)'/r=-(v'*sw+v*dsw)/r=-v'*sw/r-v*dsw/r=fscal*sw-v*dsw/r */
            felec            = vec_msub( felec,sw , vec_mul(rinv20,vec_mul(velec,dsw)) );
            velec            = vec_mul(velec,sw);
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSw_VdwLJSw_GeomW3P1_F_ibm_qpx
 * Electrostatics interaction: Ewald
 * VdW interaction:            LennardJones
 * Geometry:                   Water3-Particle
 ...
 */
void
nb_kernel_ElecEwSw_VdwLJSw_GeomW3P1_F_ibm_qpx
                    (t_nblist * gmx_restrict                nlist,
                     rvec * gmx_restrict                    xx,
                     rvec * gmx_restrict                    ff,
                     t_forcerec * gmx_restrict              fr,
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3_F,outeriter*18 + inneriter*168);
}
