...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCSTab_VdwLJ_GeomW4P1_VF_ibm_qpx
 ...
 */
void
nb_kernel_ElecCSTab_VdwLJ_GeomW4P1_VF_ibm_qpx
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            velec            = vec_mul(qq10,VV);
            FF               = vec_madd(vfeps,vec_madd(twovfeps,H,G),Fp);
            felec            = vec_neg(vec_mul(vec_mul(qq10,FF),vec_mul(vftabscale,rinv10)));
            ...
            Fp               = vec_madd(vfeps,vec_madd(H,vfeps,G),F);
            VV               = vec_madd(vfeps,Fp,Y);
            velec            = vec_mul(qq20,VV);
            FF               = vec_madd(vfeps,vec_madd(twovfeps,H,G),Fp);
            felec            = vec_neg(vec_mul(vec_mul(qq20,FF),vec_mul(vftabscale,rinv20)));
            ...
            Fp               = vec_madd(vfeps,vec_madd(H,vfeps,G),F);
            VV               = vec_madd(vfeps,Fp,Y);
            velec            = vec_mul(qq30,VV);
            FF               = vec_madd(vfeps,vec_madd(twovfeps,H,G),Fp);
            felec            = vec_neg(vec_mul(vec_mul(qq30,FF),vec_mul(vftabscale,rinv30)));
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCSTab_VdwLJ_GeomW4P1_F_ibm_qpx
 * Electrostatics interaction: CubicSplineTable
 * VdW interaction:            LennardJones
 * Geometry:                   Water4-Particle
 ...
 */
void
nb_kernel_ElecCSTab_VdwLJ_GeomW4P1_F_ibm_qpx
                    (t_nblist * gmx_restrict                nlist,
                     rvec * gmx_restrict                    xx,
                     rvec * gmx_restrict                    ff,
                     t_forcerec * gmx_restrict              fr,
