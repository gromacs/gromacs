...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecGB_VdwCSTab_GeomP1P1_VF_ibm_qpx
 ...
 */
void
nb_kernel_ElecGB_VdwCSTab_GeomP1P1_VF_ibm_qpx
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            isaj0            = gmx_ibm_qpx_load_4real_swizzle(invsqrta+jnrA+0,invsqrta+jnrB+0,
            ...
            isaprod          = vec_mul(isai0,isaj0);
            gbqqfactor       = vec_neg(vec_mul(qq00,vec_mul(isaprod,gbinvepsdiff)));
            ...
            dvdatmp          = vec_mul(minushalf,vec_madd(fgb,r00,vgb));
            dvdasum          = vec_add(dvdasum,dvdatmp);
            fjptrA           = dvda+jnrA;
            fjptrB           = dvda+jnrB;
            fjptrC           = dvda+jnrC;
            fjptrD           = dvda+jnrD;
            gmx_ibm_qpx_increment_4real_swizzle(fjptrA,fjptrB,fjptrC,fjptrD,vec_mul(dvdatmp,vec_mul(isaj0,isaj0)));
            velec            = vec_mul(qq00,rinv00);
            felec            = vec_mul(vec_msub(velec,rinv00,fgb),rinv00);
        ...
        dvdasum = vec_mul(dvdasum, vec_mul(isai0,isai0));
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecGB_VdwCSTab_GeomP1P1_F_ibm_qpx
 * Electrostatics interaction: GeneralizedBorn
 * VdW interaction:            CubicSplineTable
 * Geometry:                   Particle-Particle
 ...
 */
void
nb_kernel_ElecGB_VdwCSTab_GeomP1P1_F_ibm_qpx
                    (t_nblist * gmx_restrict                nlist,
                     rvec * gmx_restrict                    xx,
                     rvec * gmx_restrict                    ff,
                     t_forcerec * gmx_restrict              fr,
