...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEw_VdwCSTab_GeomW4P1_VF_ibm_qpx
 ...
 */
void
nb_kernel_ElecEw_VdwCSTab_GeomW4P1_VF_ibm_qpx
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            /* Analytical PME correction */
            zeta2            = vec_mul(beta2,rsq30);
            rinv3            = vec_mul(rinvsq30,rinv30);
            pmecorrF         = gmx_ibm_qpx_pmecorrF(zeta2);
            felec            = vec_madd(pmecorrF,beta3,rinv3);
            felec            = vec_mul(qq30,felec);
            pmecorrV         = gmx_ibm_qpx_pmecorrV(zeta2);
            velec            = vec_nmsub(pmecorrV,beta,rinv30);
            velec            = vec_mul(qq30,velec);
        ...
        if(jidx<j_index_end)
        {
            ...
            r30              = vec_mul(rsq30,rinv30);
            r30              = vec_sel(zero,r30,dummy_mask);
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W4_VF,outeriter*26 + inneriter*150);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEw_VdwCSTab_GeomW4P1_F_ibm_qpx
 * Electrostatics interaction: Ewald
 * VdW interaction:            CubicSplineTable
 * Geometry:                   Water4-Particle
 ...
 */
void
nb_kernel_ElecEw_VdwCSTab_GeomW4P1_F_ibm_qpx
                    (t_nblist * gmx_restrict                nlist,
                     rvec * gmx_restrict                    xx,
                     rvec * gmx_restrict                    ff,
                     t_forcerec * gmx_restrict              fr,
