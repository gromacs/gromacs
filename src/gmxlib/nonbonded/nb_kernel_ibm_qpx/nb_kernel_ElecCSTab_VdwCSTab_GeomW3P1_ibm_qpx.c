...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCSTab_VdwCSTab_GeomW3P1_VF_ibm_qpx
 ...
 */
void
nb_kernel_ElecCSTab_VdwCSTab_GeomW3P1_VF_ibm_qpx
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            velec            = vec_mul(qq00,VV);
            FF               = vec_madd(vfeps,vec_madd(twovfeps,H,G),Fp);
            felec            = vec_neg(vec_mul(vec_mul(qq00,FF),vec_mul(vftabscale,rinv00)));
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCSTab_VdwCSTab_GeomW3P1_F_ibm_qpx
 * Electrostatics interaction: CubicSplineTable
 * VdW interaction:            CubicSplineTable
 * Geometry:                   Water3-Particle
 ...
 */
void
nb_kernel_ElecCSTab_VdwCSTab_GeomW3P1_F_ibm_qpx
                    (t_nblist * gmx_restrict                nlist,
                     rvec * gmx_restrict                    xx,
                     rvec * gmx_restrict                    ff,
                     t_forcerec * gmx_restrict              fr,
