...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecRFCut_VdwNone_GeomP1P1_VF_avx_128_fma_single
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VF,outeriter*11 + inneriter*39);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecRFCut_VdwNone_GeomP1P1_F_avx_128_fma_single
 * Electrostatics interaction: ReactionField
 * VdW interaction:            None
 * Geometry:                   Particle-Particle
                     ...
                     t_nrnb * gmx_restrict                  nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_F,outeriter*10 + inneriter*33);
}
