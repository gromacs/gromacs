 ...
 */
#ifndef _NB_KERNEL301_IA32_3DNOW_H_
#define _NB_KERNEL301_IA32_3DNOW_H_

/*! \file  nb_kernel301_ia32_3dnow.h
 *  \brief ia32 3DNow-optimized versions of nonbonded kernel 301
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 301 with forces, optimized for ia32 3DNow.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel301_ia32_3dnow  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 301 without forces, optimized for ia32 3DNow.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Tabulated <br>
 ...
 */
void
nb_kernel301nf_ia32_3dnow(int *   nri,        int     iinr[],   int     jindex[],
                          int     jjnr[],     int     shift[],  float   shiftvec[],
                          float   fshift[],   int     gid[],    float   pos[],
                          float   faction[],  float   charge[], float * facel,
                          float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL301_IA32_3DNOW_H_ */
