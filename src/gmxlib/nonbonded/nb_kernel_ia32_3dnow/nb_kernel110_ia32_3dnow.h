 ...
 */
#ifndef _NB_KERNEL110_IA32_3DNOW_H_
#define _NB_KERNEL110_IA32_3DNOW_H_

/*! \file  nb_kernel110_ia32_3dnow.h
 *  \brief ia32 3DNow-optimized versions of nonbonded kernel 110
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 110 with forces, optimized for ia32 3DNow.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel110_ia32_3dnow  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 110 without forces, optimized for ia32 3DNow.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Standard 1/r <br>
 ...
 */
void
nb_kernel110nf_ia32_3dnow(int *   nri,        int     iinr[],   int     jindex[],
                          int     jjnr[],     int     shift[],  float   shiftvec[],
                          float   fshift[],   int     gid[],    float   pos[],
                          float   faction[],  float   charge[], float * facel,
                          float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL110_IA32_3DNOW_H_ */
