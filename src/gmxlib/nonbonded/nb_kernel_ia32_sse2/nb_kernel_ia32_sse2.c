...
nb_kernel_ia32_sse2_test_mutex = GMX_THREAD_MUTEX_INITIALIZER;
#endif
...
nb_kernel_ia32_sse2_test(FILE *                log)
{
	 ...
	 */
#ifdef GMX_THREADS
	gmx_thread_mutex_lock(&nb_kernel_ia32_sse2_test_mutex);
#endif
...
#ifdef GMX_THREADS
	gmx_thread_mutex_unlock(&nb_kernel_ia32_sse2_test_mutex);
#endif
