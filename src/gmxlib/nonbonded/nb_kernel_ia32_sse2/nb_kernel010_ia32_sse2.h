 ...
 */
#ifndef _NB_KERNEL010_IA32_SSE2_H_
#define _NB_KERNEL010_IA32_SSE2_H_

/*! \file  nb_kernel010_ia32_sse2.h
 *  \brief ia32 SSE2-optimized versions of nonbonded kernel 010
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 010 with forces, optimized for ia32 sse2.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel010_ia32_sse2  (int *    nri,        int      iinr[],    int      jindex[],
...
/*! \brief Nonbonded kernel 010 without forces, optimized for ia32 sse2.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> No <br>
 ...
 */
void
nb_kernel010nf_ia32_sse2(int *    nri,        int      iinr[],    int      jindex[],
                         int      jjnr[],     int      shift[],   double   shiftvec[],
                         double   fshift[],   int      gid[],     double   pos[],
                         double   faction[],  double   charge[],  double * facel,
                         double * krf,        double * crf,       double   Vc[],
...
#endif /* _NB_KERNEL010_IA32_SSE2_H_ */
