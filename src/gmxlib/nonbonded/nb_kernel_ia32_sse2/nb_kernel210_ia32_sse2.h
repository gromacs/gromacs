 ...
 */
#ifndef _NB_KERNEL210_IA32_SSE2_H_
#define _NB_KERNEL210_IA32_SSE2_H_

/*! \file  nb_kernel210_ia32_sse2.h
 *  \brief ia32 SSE2-optimized versions of nonbonded kernel 210
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 210 with forces, optimized for ia32 sse2.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel210_ia32_sse2  (int *    nri,        int      iinr[],    int      jindex[],
...
/*! \brief Nonbonded kernel 210 without forces, optimized for ia32 sse2.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Reaction-field <br>
 ...
 */
void
nb_kernel210nf_ia32_sse2(int *    nri,        int      iinr[],    int      jindex[],
                         int      jjnr[],     int      shift[],   double   shiftvec[],
                         double   fshift[],   int      gid[],     double   pos[],
                         double   faction[],  double   charge[],  double * facel,
                         double * krf,        double * crf,       double   Vc[],
...
#endif /* _NB_KERNEL210_IA32_SSE2_H_ */
