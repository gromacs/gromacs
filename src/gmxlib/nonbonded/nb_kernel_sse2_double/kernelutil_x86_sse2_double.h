...
{
    __m128 t1,t2,t3,t4,t5,sxy,sz,szx,syz;
...
{
    __m128 t1,t2,t3,t4,t5,t6,sxy,sz,szx,syz;
...
static gmx_inline void
gmx_mm_increment_1rvec_1ptr_noswizzle_pd(double * gmx_restrict ptrA,
...
static gmx_inline void
gmx_mm_increment_3rvec_1ptr_noswizzle_pd(double * gmx_restrict ptrA,
                                         ...
                                         __m128d xy3, __m128d z3)
{
    ...
    t1 = _mm_loadu_pd(ptrA);
    t2 = _mm_load_sd(ptrA+2);
    t3 = _mm_loadu_pd(ptrA+3);
    t4 = _mm_load_sd(ptrA+5);
    t5 = _mm_loadu_pd(ptrA+6);
    t6 = _mm_load_sd(ptrA+8);
    
    t1 = _mm_add_pd(t1,xy1);
    t2 = _mm_add_sd(t2,z1);
    t3 = _mm_add_pd(t3,xy2);
    t4 = _mm_add_sd(t4,z2);
    t5 = _mm_add_pd(t5,xy3);
    t6 = _mm_add_sd(t6,z3);
    
    _mm_storeu_pd(ptrA,t1);
    _mm_store_sd(ptrA+2,t2);
    _mm_storeu_pd(ptrA+3,t3);
    _mm_store_sd(ptrA+5,t4);
    _mm_storeu_pd(ptrA+6,t5);
    _mm_store_sd(ptrA+8,t6);
#else
    __m128d t1,t2;
    ...
    tA   = _mm_add_pd(tA,xy1);
    tB   = _mm_add_pd(tB,t1);
    tC   = _mm_add_pd(tC,t2);
    tD   = _mm_add_pd(tD,xy3);
    tE   = _mm_add_sd(tE,z3);
...
static gmx_inline void
gmx_mm_increment_4rvec_1ptr_noswizzle_pd(double * gmx_restrict ptrA,  
                                         __m128d xy1, __m128d z1,
                                         __m128d xy2, __m128d z2,
                                         __m128d xy3, __m128d z3,
                                         __m128d xy4, __m128d z4)
{
    ...
    t5 = _mm_loadu_pd(ptrA+6);
    t6 = _mm_load_sd(ptrA+8);
    t7 = _mm_loadu_pd(ptrA+9);
    t8 = _mm_load_sd(ptrA+11);
    ...
    _mm_storeu_pd(ptrA+6,t5);
    _mm_store_sd(ptrA+8,t6);
    _mm_storeu_pd(ptrA+9,t7);
    _mm_store_sd(ptrA+11,t8);
#else
    __m128d t1,t2,t3,t4;
...
static gmx_inline void
gmx_mm_increment_1rvec_1ptr_swizzle_pd(double * gmx_restrict ptrA,
...
static gmx_inline void
gmx_mm_increment_3rvec_1ptr_swizzle_pd(double * gmx_restrict ptrA,
                                       __m128d x1, __m128d y1, __m128d z1,
...
static gmx_inline void
gmx_mm_increment_4rvec_1ptr_swizzle_pd(double * gmx_restrict ptrA,
                                       __m128d x1, __m128d y1, __m128d z1,
                                       __m128d x2, __m128d y2, __m128d z2,
                                       __m128d x3, __m128d y3, __m128d z3,
                                       __m128d x4, __m128d y4, __m128d z4) 
{
    ...
    _mm_storeu_pd(ptrA,    _mm_add_pd( t1,x1 ));
    _mm_storeu_pd(ptrA+2,  _mm_add_pd( t2,z1 ));
    _mm_storeu_pd(ptrA+4,  _mm_add_pd( t3,y2 ));
    _mm_storeu_pd(ptrA+6,  _mm_add_pd( t4,x3 ));
    _mm_storeu_pd(ptrA+8,  _mm_add_pd( t5,z3 ));
    _mm_storeu_pd(ptrA+10, _mm_add_pd( t6,y4 ));
}

static gmx_inline void
gmx_mm_increment_1rvec_2ptr_swizzle_pd(double * gmx_restrict ptrA, double * gmx_restrict ptrB,
                                       __m128d x1, __m128d y1, __m128d z1) 
{
...
static gmx_inline void
gmx_mm_increment_3rvec_2ptr_swizzle_pd(double * gmx_restrict ptrA, double * gmx_restrict ptrB,
                                       __m128d x1, __m128d y1, __m128d z1,
                                       __m128d x2, __m128d y2, __m128d z2,
                                       __m128d x3, __m128d y3, __m128d z3) 
{
...
static gmx_inline void
gmx_mm_increment_4rvec_2ptr_swizzle_pd(double * gmx_restrict ptrA, double * gmx_restrict ptrB,
                                       __m128d x1, __m128d y1, __m128d z1,
                                       __m128d x2, __m128d y2, __m128d z2,
                                       __m128d x3, __m128d y3, __m128d z3,
                                       __m128d x4, __m128d y4, __m128d z4) 
{
    ...
    t8          = _mm_add_pd(t8,tD);
    t9          = _mm_add_pd(t9,tF);
    t10         = _mm_add_pd(t10,tH);
    t11         = _mm_add_pd(t11,tJ);
    t12         = _mm_add_pd(t12,tL);
                                         ...
                                         __m128d xy3, __m128d z3)
{
    ...
    t1 = _mm_sub_pd(t1,xy1);
    t2 = _mm_sub_sd(t2,z1);
    t3 = _mm_sub_pd(t3,xy2);
    t4 = _mm_sub_sd(t4,z2);
    t5 = _mm_sub_pd(t5,xy3);
    t6 = _mm_sub_sd(t6,z3);
...
static gmx_inline void
gmx_mm_update_iforce_2atom_swizzle_pd(__m128d fix1, __m128d fiy1, __m128d fiz1,
