...
static void sprint_gpus(char *sbuf, const gmx_gpu_info_t *gpu_info, gmx_bool UNUSED(bPrintAll))
{
    int      i, ndev;
    char     stmp[STRLEN];
...
static void parse_gpu_id_csv_string(const char * UNUSED(idstr), int * UNUSED(nid), int * UNUSED(idlist))
{
