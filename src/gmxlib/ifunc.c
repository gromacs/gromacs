...
const t_interaction_function interaction_function[F_NRE]=
{
  ...
  def_bond   ("TABBONDS", "Tab. Bonds",      2, 2, 1,  eNR_TABBONDS, tab_bonds   ),
  def_bonded ("TABBONDSNC", "Tab. Bonds NC", 2, 2, 1,  eNR_TABBONDS, tab_bonds   ),
  ...
  def_bonded ("TABANGLES", "Tab. Angles",    3, 2, 1,  eNR_TABANGLES, tab_angles ),
  ...
  def_angle  ("TABDIHS", "Tab. Dih.",        4, 2, 1,  eNR_TABDIHS, tab_dihs     ),
  ...
  def_nofc   ("UMBRELLA", "Pull Umbrella"    ),
