...
void gmx_print_version_info(FILE *fp)
{
    ...
    fprintf(fp, "Software invsqrt:   enabled\n");
#else
    fprintf(fp, "Software invsqrt:   disabled\n");
#endif
...
#    ifdef GMX_NATIVE_WINDOWS
    /* fftw3 requires you to manually set FFTW_DLL in a header for external
     * symbols to work properly in windows. Since most users likely won't
     * do this, we cannot rely on it here.
     */
    fprintf(fp, "FFT library:        fftw3 (cannot detect specific version for native MS Windows)\n");
