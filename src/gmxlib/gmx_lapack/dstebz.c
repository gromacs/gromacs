...
void
FortranCInterface_GLOBAL(dstebz,DSTEBZ)(const char *range, 
                        const char *order,
                        int *n,
                        double *vl, 
                        double *vu, 
                        ...
                        int *info)
{
    ...
    *nsplit = 1;
	...
	FortranCInterface_GLOBAL(dlaebz,DLAEBZ)(&c__3, &itmax, n, &c__2, &c__2, &nb, &atoli, &rtoli, &pivmin, 
    ...
    *info = 0;
	...
	if (in == 1) {
	    ...
	    work[*n + 1] = gl;
	    work[*n + in + 1] = gu;
	    FortranCInterface_GLOBAL(dlaebz,DLAEBZ)(&c__1, &c__0, &in, &in, &c__1, &nb, &atoli, &rtoli, &
	    ...
	    FortranCInterface_GLOBAL(dlaebz,DLAEBZ)(&c__2, &itmax, &in, &in, &c__1, &nb, &atoli, &rtoli, &
		    pivmin, &d__[ibegin], &e[ibegin], &work[ibegin], idumma, &
