...
void
FortranCInterface_GLOBAL(dlarrfx,DLARRFX)(int *n, 
	double *d__, 
	double *l, 
	double *ld, 
	double *lld, 
...
L30:
    ...
    if (dmax2 < dmax1) {
	*sigma = tmp;
	FortranCInterface_GLOBAL(dcopy,DCOPY)(n, &work[1], &i1, &dplus[1], &i1);
	i__1 = *n - 1;
	FortranCInterface_GLOBAL(dcopy,DCOPY)(&i__1, &work[*n + 1], &i1, &lplus[1], &i1);
    }
