...
void 
FortranCInterface_GLOBAL(slasq2,SLASQ2)(int *n, 
                        float *z__, 
                        int *info)
{
    int i__1, i__2, i__3;
	...
	*info = -((*n << 1) + 199);
	...
	FortranCInterface_GLOBAL(slasrt,SLASRT)("D", n, &z__[1], &iinfo);
	z__[(*n << 1) - 1] = d__;
	return;
    }
...
L100:
	...
	for (iwhilb = 1; iwhilb <= i__2; ++iwhilb) {
	    ...
	    FortranCInterface_GLOBAL(slasq3,SLASQ3)(&i0, &n0, &z__[1], &pp, &dmin__, &sigma, &desig, &qmax, &
