...
#if defined EL_EWALD || defined EL_EWALD_TAB
...
#if defined EL_EWALD || defined EL_EWALD_TAB || defined EL_RF
...
#if !defined PRUNE_NBL && !(CUDA_VERSION < 4010 && (defined EL_EWALD || defined EL_EWALD_TAB || defined EL_RF))
#pragma unroll 8
#endif
                    for(i = 0; i < NCL_PER_SUPERCL; i++)
                    {
