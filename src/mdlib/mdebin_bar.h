...
struct t_mde_delta_h_coll
{
    ...
    gmx_bool bEnergy; /* whether to write out a system energy block */
    gmx_bool bExpanded; /* whether to write out an expanded ensemble data
                           block */
    gmx_bool bPV; /* whether to write out a pressure-volume work block */
