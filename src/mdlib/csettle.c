...
#pragma ivdep
  ...
  for (i = 0; i < nsettle; ++i) {
    ...
    else
    {
        ...
        {
            sh_hw2[XX] = after[hw2    ] - (after[ow1    ] + doh2[XX]);
            sh_hw2[YY] = after[hw2 + 1] - (after[ow1 + 1] + doh2[YY]);
            sh_hw2[ZZ] = after[hw2 + 2] - (after[ow1 + 2] + doh2[ZZ]);
        ...
        {
            sh_hw3[XX] = after[hw3    ] - (after[ow1    ] + doh3[XX]);
            sh_hw3[YY] = after[hw3 + 1] - (after[ow1 + 1] + doh3[YY]);
            sh_hw3[ZZ] = after[hw3 + 2] - (after[ow1 + 2] + doh3[ZZ]);
     ...
     */
    xa1 = -(doh2[0] + doh3[0]) * wh;
    ya1 = -(doh2[1] + doh3[1]) * wh;
    za1 = -(doh2[2] + doh3[2]) * wh;

    xcom = after[ow1    ] - xa1;
    ycom = after[ow1 + 1] - ya1;
    zcom = after[ow1 + 2] - za1;
