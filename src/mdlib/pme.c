...
static void realloc_work(pme_work_t *work, int nkx)
{
    if (nkx > work->nalloc)
    {
        ...
        snew_aligned(work->denom, work->nalloc+GMX_SIMD_WIDTH_HERE, GMX_SIMD_WIDTH_HERE*sizeof(real));
        snew_aligned(work->tmp1,  work->nalloc+GMX_SIMD_WIDTH_HERE, GMX_SIMD_WIDTH_HERE*sizeof(real));
        snew_aligned(work->eterm, work->nalloc+GMX_SIMD_WIDTH_HERE, GMX_SIMD_WIDTH_HERE*sizeof(real));
