...
/* Declaration of extern functions this file defines */
#include "nbnxn_kernel_simd_2xnn.h"
/* Declarations of extern functions this file needs */
#include "nbnxn_kernel_simd_2xnn_includes.h"
/* General setup common to all SIMD kernel dispatch routines */
#include "../nbnxn_kernel_simd_common.h"
/* Code setup common to all SIMD kernel dispatch routines */
#include "../nbnxn_kernel_simd_common_code.h"
