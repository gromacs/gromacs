...
#else
{
    /* Ideally, we could access the kernel function name here, but I
     * can't think of a good, portable way to do that. */
    gmx_incons("SIMD kernel function called when its kernel path "
               " is not enabled.");
}
#endif
