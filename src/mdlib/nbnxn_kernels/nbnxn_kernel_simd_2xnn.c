...
#define UNROLLJ_HALF  (GMX_X86_SIMD_WIDTH_HERE/4)
...
#else
{
    gmx_incons("nbnxn_kernel_simd_2xnn called while GROMACS was configured without AVX enabled");
}
#endif
