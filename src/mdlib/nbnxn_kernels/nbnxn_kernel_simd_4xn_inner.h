...
#ifdef CHECK_EXCLS
#ifdef gmx_andmask_epi32
    {
        /* Integer mask set and operations, cast result to real */
        gmx_epi32 mask_pr_S = gmx_set1_epi32(l_cj[cjind].excl);

        int_S0  = gmx_castsi_pr(gmx_andmask_epi32(mask_pr_S, mask_S0));
        int_S1  = gmx_castsi_pr(gmx_andmask_epi32(mask_pr_S, mask_S1));
        int_S2  = gmx_castsi_pr(gmx_andmask_epi32(mask_pr_S, mask_S2));
        int_S3  = gmx_castsi_pr(gmx_andmask_epi32(mask_pr_S, mask_S3));
    }
#else
    {
        ...
        int_S0  = gmx_andmask_pr(mask_pr_S, mask_S0);
        int_S1  = gmx_andmask_pr(mask_pr_S, mask_S1);
        int_S2  = gmx_andmask_pr(mask_pr_S, mask_S2);
        int_S3  = gmx_andmask_pr(mask_pr_S, mask_S3);
    }
#endif
#endif
