...

{
    ...
    gmx_mm_pb  interaction_mask_S1;
    gmx_mm_pb  interaction_mask_S2;
    gmx_mm_pb  interaction_mask_S3;
#endif
...
#ifdef CHECK_EXCLS
    gmx_load_simd_4xn_exclusions(l_cj[cjind].excl, mask_S0, mask_S1, mask_S2, mask_S3, &interaction_mask_S0, &interaction_mask_S1, &interaction_mask_S2, &interaction_mask_S3);
#endif /* CHECK_EXCLS */
    ...
    wco_S1      = gmx_and_pb(wco_S1, interaction_mask_S1);
    wco_S2      = gmx_and_pb(wco_S2, interaction_mask_S2);
    wco_S3      = gmx_and_pb(wco_S3, interaction_mask_S3);
#endif
#endif
    ...
    rsq_S1      = gmx_masknot_add_pr(interaction_mask_S1, rsq_S1, avoid_sing_S);
    rsq_S2      = gmx_masknot_add_pr(interaction_mask_S2, rsq_S2, avoid_sing_S);
    rsq_S3      = gmx_masknot_add_pr(interaction_mask_S3, rsq_S3, avoid_sing_S);
#endif
    ...
    rinv_ex_S1  = gmx_blendzero_pr(rinv_S1, interaction_mask_S1);
    rinv_ex_S2  = gmx_blendzero_pr(rinv_S2, interaction_mask_S2);
    rinv_ex_S3  = gmx_blendzero_pr(rinv_S3, interaction_mask_S3);
#else
...
#define     rinv_ex_S3    rinv_S3
    ...
    vc_sub_S1   = gmx_add_pr(vc_sub_S1, gmx_blendzero_pr(sh_ewald_S, interaction_mask_S1));
    vc_sub_S2   = gmx_add_pr(vc_sub_S2, gmx_blendzero_pr(sh_ewald_S, interaction_mask_S2));
    vc_sub_S3   = gmx_add_pr(vc_sub_S3, gmx_blendzero_pr(sh_ewald_S, interaction_mask_S3));
#else
...
#define     wco_vdw_S3    wco_S3
    ...
    rinvsix_S1  = gmx_blendzero_pr(rinvsix_S1, interaction_mask_S1);
#endif
#ifndef HALF_LJ
    ...
    rinvsix_S3  = gmx_blendzero_pr(rinvsix_S3, interaction_mask_S3);
#endif
#endif
#ifdef VDW_CUTOFF_CHECK
    ...
    sir6_S1     = gmx_blendzero_pr(sir6_S1, interaction_mask_S1);
#endif
#ifndef HALF_LJ
    ...
    sir6_S3     = gmx_blendzero_pr(sir6_S3, interaction_mask_S3);
#endif
#endif
#ifdef VDW_CUTOFF_CHECK
    ...
    VLJ_S1      = gmx_blendzero_pr(VLJ_S1, interaction_mask_S1);
#ifndef HALF_LJ
    VLJ_S2      = gmx_blendzero_pr(VLJ_S2, interaction_mask_S2);
    VLJ_S3      = gmx_blendzero_pr(VLJ_S3, interaction_mask_S3);
#endif
#endif
#ifndef ENERGY_GROUPS
