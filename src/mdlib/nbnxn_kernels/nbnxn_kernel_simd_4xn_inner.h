...

{
    ...
    gmx_mm_pr  dx_SIMD1, dy_SIMD1, dz_SIMD1;
    gmx_mm_pr  dx_SIMD2, dy_SIMD2, dz_SIMD2;
    gmx_mm_pr  dx_SIMD3, dy_SIMD3, dz_SIMD3;
    gmx_mm_pr  tx_SIMD0, ty_SIMD0, tz_SIMD0;
    gmx_mm_pr  tx_SIMD1, ty_SIMD1, tz_SIMD1;
    gmx_mm_pr  tx_SIMD2, ty_SIMD2, tz_SIMD2;
    gmx_mm_pr  tx_SIMD3, ty_SIMD3, tz_SIMD3;
    gmx_mm_pr  rsq_SIMD0, rinv_SIMD0, rinvsq_SIMD0;
    gmx_mm_pr  rsq_SIMD1, rinv_SIMD1, rinvsq_SIMD1;
    gmx_mm_pr  rsq_SIMD2, rinv_SIMD2, rinvsq_SIMD2;
    gmx_mm_pr  rsq_SIMD3, rinv_SIMD3, rinvsq_SIMD3;
    ...
    gmx_mm_pr  wco_vdw_SIMD1;
#ifndef HALF_LJ
    gmx_mm_pr  wco_vdw_SIMD2;
    gmx_mm_pr  wco_vdw_SIMD3;
#endif
#endif
#ifdef CALC_COULOMB
#ifdef CHECK_EXCLS
    ...
    gmx_mm_pr  rinv_ex_SIMD1;
    gmx_mm_pr  rinv_ex_SIMD2;
    gmx_mm_pr  rinv_ex_SIMD3;
#endif
    gmx_mm_pr  jq_SIMD;
    gmx_mm_pr  qq_SIMD0;
    gmx_mm_pr  qq_SIMD1;
    ...
    gmx_mm_pr  fsub_SIMD1;
    gmx_mm_pr  fsub_SIMD2;
    gmx_mm_pr  fsub_SIMD3;
#endif
#ifdef CALC_COUL_EWALD
    gmx_mm_pr  brsq_SIMD0, brsq_SIMD1, brsq_SIMD2, brsq_SIMD3;
    gmx_mm_pr  ewcorr_SIMD0, ewcorr_SIMD1, ewcorr_SIMD2, ewcorr_SIMD3;
#endif

    /* frcoul = (1/r - fsub)*r */
    gmx_mm_pr  frcoul_SIMD0;
    gmx_mm_pr  frcoul_SIMD1;
    gmx_mm_pr  frcoul_SIMD2;
    gmx_mm_pr  frcoul_SIMD3;
#ifdef CALC_COUL_TAB
    /* For tables: r, rs=r/sp, rf=floor(rs), frac=rs-rf */
    gmx_mm_pr  r_SIMD0, rs_SIMD0, rf_SIMD0, frac_SIMD0;
    gmx_mm_pr  r_SIMD1, rs_SIMD1, rf_SIMD1, frac_SIMD1;
    gmx_mm_pr  r_SIMD2, rs_SIMD2, rf_SIMD2, frac_SIMD2;
    gmx_mm_pr  r_SIMD3, rs_SIMD3, rf_SIMD3, frac_SIMD3;
    /* Table index: rs truncated to an int */
#if !(defined GMX_MM256_HERE && defined GMX_DOUBLE)
    gmx_epi32  ti_SIMD0, ti_SIMD1, ti_SIMD2, ti_SIMD3;
#else
    /* FIXME: AVX/SSE-specific types below */
    __m128i    ti_SIMD0, ti_SIMD1, ti_SIMD2, ti_SIMD3;
#endif
    /* Linear force table values */
    gmx_mm_pr  ctab0_SIMD0, ctab1_SIMD0;
    gmx_mm_pr  ctab0_SIMD1, ctab1_SIMD1;
    gmx_mm_pr  ctab0_SIMD2, ctab1_SIMD2;
    gmx_mm_pr  ctab0_SIMD3, ctab1_SIMD3;
#ifdef CALC_ENERGIES
    /* Quadratic energy table value */
    gmx_mm_pr  ctabv_SIMD0;
    gmx_mm_pr  ctabv_SIMD1;
    gmx_mm_pr  ctabv_SIMD2;
    gmx_mm_pr  ctabv_SIMD3;
#endif
#endif
#if defined CALC_ENERGIES && (defined CALC_COUL_EWALD || defined CALC_COUL_TAB)
    /* The potential (PME mesh) we need to subtract from 1/r */
    gmx_mm_pr  vc_sub_SIMD0;
    gmx_mm_pr  vc_sub_SIMD1;
    gmx_mm_pr  vc_sub_SIMD2;
    gmx_mm_pr  vc_sub_SIMD3;
#endif
#ifdef CALC_ENERGIES
    /* Electrostatic potential */
    gmx_mm_pr  vcoul_SIMD0;
    gmx_mm_pr  vcoul_SIMD1;
    gmx_mm_pr  vcoul_SIMD2;
    gmx_mm_pr  vcoul_SIMD3;
#endif
#endif
    /* The force times 1/r */
    gmx_mm_pr  fscal_SIMD0;
    gmx_mm_pr  fscal_SIMD1;
    gmx_mm_pr  fscal_SIMD2;
    gmx_mm_pr  fscal_SIMD3;
    ...
    gmx_mm_pr  sig_SIMD1, eps_SIMD1;
#ifndef HALF_LJ
    gmx_mm_pr  sig_SIMD2, eps_SIMD2;
    gmx_mm_pr  sig_SIMD3, eps_SIMD3;
#endif
#ifdef CALC_ENERGIES
    gmx_mm_pr  sig2_SIMD0, sig6_SIMD0;
    gmx_mm_pr  sig2_SIMD1, sig6_SIMD1;
#ifndef HALF_LJ
    gmx_mm_pr  sig2_SIMD2, sig6_SIMD2;
    gmx_mm_pr  sig2_SIMD3, sig6_SIMD3;
#endif
#endif /* LJ_COMB_LB */
#endif /* CALC_LJ */
    ...
    gmx_mm_pr  c6_SIMD1, c12_SIMD1;
#ifndef HALF_LJ
    gmx_mm_pr  c6_SIMD2, c12_SIMD2;
    gmx_mm_pr  c6_SIMD3, c12_SIMD3;
#endif
#endif
    ...
    gmx_mm_pr  rinvsix_SIMD1;
#ifndef HALF_LJ
    gmx_mm_pr  rinvsix_SIMD2;
    gmx_mm_pr  rinvsix_SIMD3;
#endif
#endif
#ifdef LJ_COMB_LB
    gmx_mm_pr  sir_SIMD0, sir2_SIMD0, sir6_SIMD0;
    gmx_mm_pr  sir_SIMD1, sir2_SIMD1, sir6_SIMD1;
#ifndef HALF_LJ
    gmx_mm_pr  sir_SIMD2, sir2_SIMD2, sir6_SIMD2;
    gmx_mm_pr  sir_SIMD3, sir2_SIMD3, sir6_SIMD3;
#endif
#endif

    gmx_mm_pr  FrLJ6_SIMD0, FrLJ12_SIMD0;
    gmx_mm_pr  FrLJ6_SIMD1, FrLJ12_SIMD1;
#ifndef HALF_LJ
    gmx_mm_pr  FrLJ6_SIMD2, FrLJ12_SIMD2;
    gmx_mm_pr  FrLJ6_SIMD3, FrLJ12_SIMD3;
#endif
#ifdef CALC_ENERGIES
    gmx_mm_pr  VLJ6_SIMD0, VLJ12_SIMD0, VLJ_SIMD0;
    gmx_mm_pr  VLJ6_SIMD1, VLJ12_SIMD1, VLJ_SIMD1;
#ifndef HALF_LJ
    gmx_mm_pr  VLJ6_SIMD2, VLJ12_SIMD2, VLJ_SIMD2;
    gmx_mm_pr  VLJ6_SIMD3, VLJ12_SIMD3, VLJ_SIMD3;
#endif
#endif
#endif /* CALC_LJ */
...
#ifdef CHECK_EXCLS
    /* FIXME: AVX/SSE-specific defines and instructions, use generics instead */
#if defined GMX_X86_SSE2 && defined GMX_MM128_HERE
    {
        /* Load integer interaction mask */
        __m128i mask_int = _mm_set1_epi32(l_cj[cjind].excl);

        int_SIMD0  = gmx_mm_castsi128_pr(_mm_cmpeq_epi32(_mm_andnot_si128(mask_int, mask0), zeroi_SIMD));
        int_SIMD1  = gmx_mm_castsi128_pr(_mm_cmpeq_epi32(_mm_andnot_si128(mask_int, mask1), zeroi_SIMD));
        int_SIMD2  = gmx_mm_castsi128_pr(_mm_cmpeq_epi32(_mm_andnot_si128(mask_int, mask2), zeroi_SIMD));
        int_SIMD3  = gmx_mm_castsi128_pr(_mm_cmpeq_epi32(_mm_andnot_si128(mask_int, mask3), zeroi_SIMD));
    }
#endif
    /* FIXME: AVX/SSE-specific defines */
#if defined GMX_X86_SSE2 && defined GMX_MM256_HERE
    {
         ...
         */
        /* FIXME: AVX/SSE-specific instructions, use generics instead */
...
#define cast_cvt(x)  _mm256_castps_pd(_mm256_cvtepi32_ps(_mm256_castps_si256(x)))
        int_SIMD0  = gmx_cmpneq_pr(cast_cvt(_mm256_and_ps(mask_ps, mask0)), zero_SIMD);
        int_SIMD1  = gmx_cmpneq_pr(cast_cvt(_mm256_and_ps(mask_ps, mask1)), zero_SIMD);
        int_SIMD2  = gmx_cmpneq_pr(cast_cvt(_mm256_and_ps(mask_ps, mask2)), zero_SIMD);
        int_SIMD3  = gmx_cmpneq_pr(cast_cvt(_mm256_and_ps(mask_ps, mask3)), zero_SIMD);
#undef cast_cvt
#else
        /* FIXME: AVX/SSE-specific instructions */
...
#define cast_cvt(x)  _mm256_cvtepi32_ps(_mm256_castps_si256(x))
        ...
        int_SIMD1  = gmx_cmpneq_pr(cast_cvt(gmx_and_pr(mask_pr, mask1)), zero_SIMD);
        int_SIMD2  = gmx_cmpneq_pr(cast_cvt(gmx_and_pr(masksh_pr, mask0)), zero_SIMD);
        int_SIMD3  = gmx_cmpneq_pr(cast_cvt(gmx_and_pr(masksh_pr, mask1)), zero_SIMD);
#undef cast_cvt
#endif
    }
#endif
    ...
    jxSIMD         = gmx_load_pr(x+ajx);
    jySIMD         = gmx_load_pr(x+ajy);
    jzSIMD         = gmx_load_pr(x+ajz);

    /* Calculate distance */
    dx_SIMD0       = gmx_sub_pr(ix_SIMD0, jxSIMD);
    dy_SIMD0       = gmx_sub_pr(iy_SIMD0, jySIMD);
    dz_SIMD0       = gmx_sub_pr(iz_SIMD0, jzSIMD);
    dx_SIMD1       = gmx_sub_pr(ix_SIMD1, jxSIMD);
    dy_SIMD1       = gmx_sub_pr(iy_SIMD1, jySIMD);
    dz_SIMD1       = gmx_sub_pr(iz_SIMD1, jzSIMD);
    dx_SIMD2       = gmx_sub_pr(ix_SIMD2, jxSIMD);
    dy_SIMD2       = gmx_sub_pr(iy_SIMD2, jySIMD);
    dz_SIMD2       = gmx_sub_pr(iz_SIMD2, jzSIMD);
    dx_SIMD3       = gmx_sub_pr(ix_SIMD3, jxSIMD);
    dy_SIMD3       = gmx_sub_pr(iy_SIMD3, jySIMD);
    dz_SIMD3       = gmx_sub_pr(iz_SIMD3, jzSIMD);

    /* rsq = dx*dx+dy*dy+dz*dz */
    rsq_SIMD0      = gmx_calc_rsq_pr(dx_SIMD0, dy_SIMD0, dz_SIMD0);
    rsq_SIMD1      = gmx_calc_rsq_pr(dx_SIMD1, dy_SIMD1, dz_SIMD1);
    rsq_SIMD2      = gmx_calc_rsq_pr(dx_SIMD2, dy_SIMD2, dz_SIMD2);
    rsq_SIMD3      = gmx_calc_rsq_pr(dx_SIMD3, dy_SIMD3, dz_SIMD3);

#ifndef NBNXN_CUTOFF_USE_BLENDV
    wco_SIMD0      = gmx_cmplt_pr(rsq_SIMD0, rc2_SIMD);
    wco_SIMD1      = gmx_cmplt_pr(rsq_SIMD1, rc2_SIMD);
    wco_SIMD2      = gmx_cmplt_pr(rsq_SIMD2, rc2_SIMD);
    wco_SIMD3      = gmx_cmplt_pr(rsq_SIMD3, rc2_SIMD);
#endif
    ...
    if (cj == ci_sh)
    {
        ...
        wco_SIMD1  = gmx_and_pr(wco_SIMD1, diag_SIMD1);
        wco_SIMD2  = gmx_and_pr(wco_SIMD2, diag_SIMD2);
        wco_SIMD3  = gmx_and_pr(wco_SIMD3, diag_SIMD3);
    }
#else
#if UNROLLJ < UNROLLI
    if (cj == ci_sh*2)
    {
        wco_SIMD0  = gmx_and_pr(wco_SIMD0, diag0_SIMD0);
        wco_SIMD1  = gmx_and_pr(wco_SIMD1, diag0_SIMD1);
        wco_SIMD2  = gmx_and_pr(wco_SIMD2, diag0_SIMD2);
        wco_SIMD3  = gmx_and_pr(wco_SIMD3, diag0_SIMD3);
    }
    if (cj == ci_sh*2 + 1)
    {
        wco_SIMD0  = gmx_and_pr(wco_SIMD0, diag1_SIMD0);
        wco_SIMD1  = gmx_and_pr(wco_SIMD1, diag1_SIMD1);
        wco_SIMD2  = gmx_and_pr(wco_SIMD2, diag1_SIMD2);
        wco_SIMD3  = gmx_and_pr(wco_SIMD3, diag1_SIMD3);
    }
#else
    if (cj*2 == ci_sh)
    {
    ...
    wco_SIMD1      = gmx_and_pr(wco_SIMD1, int_SIMD1);
    wco_SIMD2      = gmx_and_pr(wco_SIMD2, int_SIMD2);
    wco_SIMD3      = gmx_and_pr(wco_SIMD3, int_SIMD3);
#endif
#endif
    ...
    rsq_SIMD1      = gmx_add_pr(rsq_SIMD1, gmx_andnot_pr(int_SIMD1, avoid_sing_SIMD));
    rsq_SIMD2      = gmx_add_pr(rsq_SIMD2, gmx_andnot_pr(int_SIMD2, avoid_sing_SIMD));
    rsq_SIMD3      = gmx_add_pr(rsq_SIMD3, gmx_andnot_pr(int_SIMD3, avoid_sing_SIMD));
#endif

    /* Calculate 1/r */
#ifdef GMX_DOUBLE
    GMX_MM_INVSQRT2_PD(rsq_SIMD0, rsq_SIMD1, rinv_SIMD0, rinv_SIMD1);
    GMX_MM_INVSQRT2_PD(rsq_SIMD2, rsq_SIMD3, rinv_SIMD2, rinv_SIMD3);
#else
    rinv_SIMD0     = gmx_invsqrt_pr(rsq_SIMD0);
    rinv_SIMD1     = gmx_invsqrt_pr(rsq_SIMD1);
    rinv_SIMD2     = gmx_invsqrt_pr(rsq_SIMD2);
    rinv_SIMD3     = gmx_invsqrt_pr(rsq_SIMD3);
#endif

#ifdef CALC_COULOMB
    /* Load parameters for j atom */
    jq_SIMD        = gmx_load_pr(q+aj);
    qq_SIMD0       = gmx_mul_pr(iq_SIMD0, jq_SIMD);
    qq_SIMD1       = gmx_mul_pr(iq_SIMD1, jq_SIMD);
    qq_SIMD2       = gmx_mul_pr(iq_SIMD2, jq_SIMD);
    qq_SIMD3       = gmx_mul_pr(iq_SIMD3, jq_SIMD);
#endif

#ifdef CALC_LJ

#if !defined LJ_COMB_GEOM && !defined LJ_COMB_LB && !defined FIX_LJ_C
    load_lj_pair_params(nbfp0, type, aj, c6_SIMD0, c12_SIMD0);
    load_lj_pair_params(nbfp1, type, aj, c6_SIMD1, c12_SIMD1);
#ifndef HALF_LJ
    load_lj_pair_params(nbfp2, type, aj, c6_SIMD2, c12_SIMD2);
    load_lj_pair_params(nbfp3, type, aj, c6_SIMD3, c12_SIMD3);
#endif
#endif /* not defined any LJ rule */

#ifdef LJ_COMB_GEOM
    c6s_j_SIMD     = gmx_load_pr(ljc+aj2+0);
    c12s_j_SIMD    = gmx_load_pr(ljc+aj2+STRIDE);
    c6_SIMD0       = gmx_mul_pr(c6s_SIMD0, c6s_j_SIMD );
    c6_SIMD1       = gmx_mul_pr(c6s_SIMD1, c6s_j_SIMD );
#ifndef HALF_LJ
    c6_SIMD2       = gmx_mul_pr(c6s_SIMD2, c6s_j_SIMD );
    c6_SIMD3       = gmx_mul_pr(c6s_SIMD3, c6s_j_SIMD );
#endif
    c12_SIMD0      = gmx_mul_pr(c12s_SIMD0, c12s_j_SIMD);
    c12_SIMD1      = gmx_mul_pr(c12s_SIMD1, c12s_j_SIMD);
#ifndef HALF_LJ
    c12_SIMD2      = gmx_mul_pr(c12s_SIMD2, c12s_j_SIMD);
    c12_SIMD3      = gmx_mul_pr(c12s_SIMD3, c12s_j_SIMD);
#endif
#endif /* LJ_COMB_GEOM */

#ifdef LJ_COMB_LB
    hsig_j_SIMD    = gmx_load_pr(ljc+aj2+0);
    seps_j_SIMD    = gmx_load_pr(ljc+aj2+STRIDE);

    sig_SIMD0      = gmx_add_pr(hsig_i_SIMD0, hsig_j_SIMD);
    sig_SIMD1      = gmx_add_pr(hsig_i_SIMD1, hsig_j_SIMD);
    eps_SIMD0      = gmx_mul_pr(seps_i_SIMD0, seps_j_SIMD);
    eps_SIMD1      = gmx_mul_pr(seps_i_SIMD1, seps_j_SIMD);
#ifndef HALF_LJ
    sig_SIMD2      = gmx_add_pr(hsig_i_SIMD2, hsig_j_SIMD);
    sig_SIMD3      = gmx_add_pr(hsig_i_SIMD3, hsig_j_SIMD);
    eps_SIMD2      = gmx_mul_pr(seps_i_SIMD2, seps_j_SIMD);
    eps_SIMD3      = gmx_mul_pr(seps_i_SIMD3, seps_j_SIMD);
#endif
#endif /* LJ_COMB_LB */
    ...
    rinv_SIMD1     = gmx_blendv_pr(rinv_SIMD1, zero_SIMD, gmx_sub_pr(rc2_SIMD, rsq_SIMD1));
    rinv_SIMD2     = gmx_blendv_pr(rinv_SIMD2, zero_SIMD, gmx_sub_pr(rc2_SIMD, rsq_SIMD2));
    rinv_SIMD3     = gmx_blendv_pr(rinv_SIMD3, zero_SIMD, gmx_sub_pr(rc2_SIMD, rsq_SIMD3));
#else
    rinv_SIMD0     = gmx_and_pr(rinv_SIMD0, wco_SIMD0);
    rinv_SIMD1     = gmx_and_pr(rinv_SIMD1, wco_SIMD1);
    rinv_SIMD2     = gmx_and_pr(rinv_SIMD2, wco_SIMD2);
    rinv_SIMD3     = gmx_and_pr(rinv_SIMD3, wco_SIMD3);
#endif

    rinvsq_SIMD0   = gmx_mul_pr(rinv_SIMD0, rinv_SIMD0);
    rinvsq_SIMD1   = gmx_mul_pr(rinv_SIMD1, rinv_SIMD1);
    rinvsq_SIMD2   = gmx_mul_pr(rinv_SIMD2, rinv_SIMD2);
    rinvsq_SIMD3   = gmx_mul_pr(rinv_SIMD3, rinv_SIMD3);
    ...
    rinv_ex_SIMD1  = gmx_and_pr(rinv_SIMD1, int_SIMD1);
    rinv_ex_SIMD2  = gmx_and_pr(rinv_SIMD2, int_SIMD2);
    rinv_ex_SIMD3  = gmx_and_pr(rinv_SIMD3, int_SIMD3);
#else
    /* No exclusion forces, we always need 1/r */
#define     rinv_ex_SIMD0    rinv_SIMD0
#define     rinv_ex_SIMD1    rinv_SIMD1
#define     rinv_ex_SIMD2    rinv_SIMD2
#define     rinv_ex_SIMD3    rinv_SIMD3
#endif

#ifdef CALC_COUL_RF
    /* Electrostatic interactions */
    frcoul_SIMD0   = gmx_mul_pr(qq_SIMD0, gmx_add_pr(rinv_ex_SIMD0, gmx_mul_pr(rsq_SIMD0, mrc_3_SIMD)));
    frcoul_SIMD1   = gmx_mul_pr(qq_SIMD1, gmx_add_pr(rinv_ex_SIMD1, gmx_mul_pr(rsq_SIMD1, mrc_3_SIMD)));
    frcoul_SIMD2   = gmx_mul_pr(qq_SIMD2, gmx_add_pr(rinv_ex_SIMD2, gmx_mul_pr(rsq_SIMD2, mrc_3_SIMD)));
    frcoul_SIMD3   = gmx_mul_pr(qq_SIMD3, gmx_add_pr(rinv_ex_SIMD3, gmx_mul_pr(rsq_SIMD3, mrc_3_SIMD)));

#ifdef CALC_ENERGIES
    vcoul_SIMD0    = gmx_mul_pr(qq_SIMD0, gmx_add_pr(rinv_ex_SIMD0, gmx_add_pr(gmx_mul_pr(rsq_SIMD0, hrc_3_SIMD), moh_rc_SIMD)));
    vcoul_SIMD1    = gmx_mul_pr(qq_SIMD1, gmx_add_pr(rinv_ex_SIMD1, gmx_add_pr(gmx_mul_pr(rsq_SIMD1, hrc_3_SIMD), moh_rc_SIMD)));
    vcoul_SIMD2    = gmx_mul_pr(qq_SIMD2, gmx_add_pr(rinv_ex_SIMD2, gmx_add_pr(gmx_mul_pr(rsq_SIMD2, hrc_3_SIMD), moh_rc_SIMD)));
    vcoul_SIMD3    = gmx_mul_pr(qq_SIMD3, gmx_add_pr(rinv_ex_SIMD3, gmx_add_pr(gmx_mul_pr(rsq_SIMD3, hrc_3_SIMD), moh_rc_SIMD)));
#endif
#endif
    ...
    brsq_SIMD1     = gmx_mul_pr(beta2_SIMD, gmx_blendv_pr(rsq_SIMD1, zero_SIMD, gmx_sub_pr(rc2_SIMD, rsq_SIMD1)));
    brsq_SIMD2     = gmx_mul_pr(beta2_SIMD, gmx_blendv_pr(rsq_SIMD2, zero_SIMD, gmx_sub_pr(rc2_SIMD, rsq_SIMD2)));
    brsq_SIMD3     = gmx_mul_pr(beta2_SIMD, gmx_blendv_pr(rsq_SIMD3, zero_SIMD, gmx_sub_pr(rc2_SIMD, rsq_SIMD3)));
#else
    brsq_SIMD0     = gmx_mul_pr(beta2_SIMD, gmx_and_pr(rsq_SIMD0, wco_SIMD0));
    brsq_SIMD1     = gmx_mul_pr(beta2_SIMD, gmx_and_pr(rsq_SIMD1, wco_SIMD1));
    brsq_SIMD2     = gmx_mul_pr(beta2_SIMD, gmx_and_pr(rsq_SIMD2, wco_SIMD2));
    brsq_SIMD3     = gmx_mul_pr(beta2_SIMD, gmx_and_pr(rsq_SIMD3, wco_SIMD3));
#endif
    ewcorr_SIMD0   = gmx_mul_pr(gmx_pmecorrF_pr(brsq_SIMD0), beta_SIMD);
    ewcorr_SIMD1   = gmx_mul_pr(gmx_pmecorrF_pr(brsq_SIMD1), beta_SIMD);
    ewcorr_SIMD2   = gmx_mul_pr(gmx_pmecorrF_pr(brsq_SIMD2), beta_SIMD);
    ewcorr_SIMD3   = gmx_mul_pr(gmx_pmecorrF_pr(brsq_SIMD3), beta_SIMD);
    frcoul_SIMD0   = gmx_mul_pr(qq_SIMD0, gmx_add_pr(rinv_ex_SIMD0, gmx_mul_pr(ewcorr_SIMD0, brsq_SIMD0)));
    frcoul_SIMD1   = gmx_mul_pr(qq_SIMD1, gmx_add_pr(rinv_ex_SIMD1, gmx_mul_pr(ewcorr_SIMD1, brsq_SIMD1)));
    frcoul_SIMD2   = gmx_mul_pr(qq_SIMD2, gmx_add_pr(rinv_ex_SIMD2, gmx_mul_pr(ewcorr_SIMD2, brsq_SIMD2)));
    frcoul_SIMD3   = gmx_mul_pr(qq_SIMD3, gmx_add_pr(rinv_ex_SIMD3, gmx_mul_pr(ewcorr_SIMD3, brsq_SIMD3)));

#ifdef CALC_ENERGIES
    vc_sub_SIMD0   = gmx_mul_pr(gmx_pmecorrV_pr(brsq_SIMD0), beta_SIMD);
    vc_sub_SIMD1   = gmx_mul_pr(gmx_pmecorrV_pr(brsq_SIMD1), beta_SIMD);
    vc_sub_SIMD2   = gmx_mul_pr(gmx_pmecorrV_pr(brsq_SIMD2), beta_SIMD);
    vc_sub_SIMD3   = gmx_mul_pr(gmx_pmecorrV_pr(brsq_SIMD3), beta_SIMD);
#endif
    ...
    load_table_f_v(tab_coul_F, ti_SIMD1, ti1, ctab0_SIMD1, ctab1_SIMD1, ctabv_SIMD1);
    load_table_f_v(tab_coul_F, ti_SIMD2, ti2, ctab0_SIMD2, ctab1_SIMD2, ctabv_SIMD2);
    load_table_f_v(tab_coul_F, ti_SIMD3, ti3, ctab0_SIMD3, ctab1_SIMD3, ctabv_SIMD3);
#else
    load_table_f_v(tab_coul_F, tab_coul_V, ti_SIMD0, ti0, ctab0_SIMD0, ctab1_SIMD0, ctabv_SIMD0);
    load_table_f_v(tab_coul_F, tab_coul_V, ti_SIMD1, ti1, ctab0_SIMD1, ctab1_SIMD1, ctabv_SIMD1);
    load_table_f_v(tab_coul_F, tab_coul_V, ti_SIMD2, ti2, ctab0_SIMD2, ctab1_SIMD2, ctabv_SIMD2);
    load_table_f_v(tab_coul_F, tab_coul_V, ti_SIMD3, ti3, ctab0_SIMD3, ctab1_SIMD3, ctabv_SIMD3);
#endif
#else
    load_table_f(tab_coul_F, ti_SIMD0, ti0, ctab0_SIMD0, ctab1_SIMD0);
    load_table_f(tab_coul_F, ti_SIMD1, ti1, ctab0_SIMD1, ctab1_SIMD1);
    load_table_f(tab_coul_F, ti_SIMD2, ti2, ctab0_SIMD2, ctab1_SIMD2);
    load_table_f(tab_coul_F, ti_SIMD3, ti3, ctab0_SIMD3, ctab1_SIMD3);
#endif
    fsub_SIMD0     = gmx_add_pr(ctab0_SIMD0, gmx_mul_pr(frac_SIMD0, ctab1_SIMD0));
    fsub_SIMD1     = gmx_add_pr(ctab0_SIMD1, gmx_mul_pr(frac_SIMD1, ctab1_SIMD1));
    fsub_SIMD2     = gmx_add_pr(ctab0_SIMD2, gmx_mul_pr(frac_SIMD2, ctab1_SIMD2));
    fsub_SIMD3     = gmx_add_pr(ctab0_SIMD3, gmx_mul_pr(frac_SIMD3, ctab1_SIMD3));
    frcoul_SIMD0   = gmx_mul_pr(qq_SIMD0, gmx_sub_pr(rinv_ex_SIMD0, gmx_mul_pr(fsub_SIMD0, r_SIMD0)));
    frcoul_SIMD1   = gmx_mul_pr(qq_SIMD1, gmx_sub_pr(rinv_ex_SIMD1, gmx_mul_pr(fsub_SIMD1, r_SIMD1)));
    frcoul_SIMD2   = gmx_mul_pr(qq_SIMD2, gmx_sub_pr(rinv_ex_SIMD2, gmx_mul_pr(fsub_SIMD2, r_SIMD2)));
    frcoul_SIMD3   = gmx_mul_pr(qq_SIMD3, gmx_sub_pr(rinv_ex_SIMD3, gmx_mul_pr(fsub_SIMD3, r_SIMD3)));

#ifdef CALC_ENERGIES
    vc_sub_SIMD0   = gmx_add_pr(ctabv_SIMD0, gmx_mul_pr(gmx_mul_pr(mhalfsp_SIMD, frac_SIMD0), gmx_add_pr(ctab0_SIMD0, fsub_SIMD0)));
    vc_sub_SIMD1   = gmx_add_pr(ctabv_SIMD1, gmx_mul_pr(gmx_mul_pr(mhalfsp_SIMD, frac_SIMD1), gmx_add_pr(ctab0_SIMD1, fsub_SIMD1)));
    vc_sub_SIMD2   = gmx_add_pr(ctabv_SIMD2, gmx_mul_pr(gmx_mul_pr(mhalfsp_SIMD, frac_SIMD2), gmx_add_pr(ctab0_SIMD2, fsub_SIMD2)));
    vc_sub_SIMD3   = gmx_add_pr(ctabv_SIMD3, gmx_mul_pr(gmx_mul_pr(mhalfsp_SIMD, frac_SIMD3), gmx_add_pr(ctab0_SIMD3, fsub_SIMD3)));
#endif
#endif /* CALC_COUL_TAB */
    ...
    vc_sub_SIMD1   = gmx_add_pr(vc_sub_SIMD1, gmx_and_pr(sh_ewald_SIMD, int_SIMD1));
    vc_sub_SIMD2   = gmx_add_pr(vc_sub_SIMD2, gmx_and_pr(sh_ewald_SIMD, int_SIMD2));
    vc_sub_SIMD3   = gmx_add_pr(vc_sub_SIMD3, gmx_and_pr(sh_ewald_SIMD, int_SIMD3));
#else
    vc_sub_SIMD0   = gmx_add_pr(vc_sub_SIMD0, sh_ewald_SIMD);
    vc_sub_SIMD1   = gmx_add_pr(vc_sub_SIMD1, sh_ewald_SIMD);
    vc_sub_SIMD2   = gmx_add_pr(vc_sub_SIMD2, sh_ewald_SIMD);
    vc_sub_SIMD3   = gmx_add_pr(vc_sub_SIMD3, sh_ewald_SIMD);
#endif
#endif

    vcoul_SIMD0    = gmx_mul_pr(qq_SIMD0, gmx_sub_pr(rinv_ex_SIMD0, vc_sub_SIMD0));
    vcoul_SIMD1    = gmx_mul_pr(qq_SIMD1, gmx_sub_pr(rinv_ex_SIMD1, vc_sub_SIMD1));
    vcoul_SIMD2    = gmx_mul_pr(qq_SIMD2, gmx_sub_pr(rinv_ex_SIMD2, vc_sub_SIMD2));
    vcoul_SIMD3    = gmx_mul_pr(qq_SIMD3, gmx_sub_pr(rinv_ex_SIMD3, vc_sub_SIMD3));
    ...
    vcoul_SIMD1    = gmx_and_pr(vcoul_SIMD1, wco_SIMD1);
    vcoul_SIMD2    = gmx_and_pr(vcoul_SIMD2, wco_SIMD2);
    vcoul_SIMD3    = gmx_and_pr(vcoul_SIMD3, wco_SIMD3);
#endif
...
#define     wco_vdw_SIMD3    wco_SIMD3
...
#ifdef CALC_COULOMB
#ifdef ENERGY_GROUPS
    add_ener_grp(vcoul_SIMD0, vctp[0], egp_jj);
    add_ener_grp(vcoul_SIMD1, vctp[1], egp_jj);
    add_ener_grp(vcoul_SIMD2, vctp[2], egp_jj);
    add_ener_grp(vcoul_SIMD3, vctp[3], egp_jj);
#else
    vctotSIMD      = gmx_add_pr(vctotSIMD, gmx_sum4_pr(vcoul_SIMD0, vcoul_SIMD1, vcoul_SIMD2, vcoul_SIMD3));
#endif
#endif
    ...
    VLJ6_SIMD1     = gmx_mul_pr(sixthSIMD, gmx_sub_pr(FrLJ6_SIMD1, gmx_mul_pr(c6_SIMD1, sh_invrc6_SIMD)));
#ifndef HALF_LJ
    VLJ6_SIMD2     = gmx_mul_pr(sixthSIMD, gmx_sub_pr(FrLJ6_SIMD2, gmx_mul_pr(c6_SIMD2, sh_invrc6_SIMD)));
    VLJ6_SIMD3     = gmx_mul_pr(sixthSIMD, gmx_sub_pr(FrLJ6_SIMD3, gmx_mul_pr(c6_SIMD3, sh_invrc6_SIMD)));
#endif
    VLJ12_SIMD0    = gmx_mul_pr(twelvethSIMD, gmx_sub_pr(FrLJ12_SIMD0, gmx_mul_pr(c12_SIMD0, sh_invrc12_SIMD)));
    VLJ12_SIMD1    = gmx_mul_pr(twelvethSIMD, gmx_sub_pr(FrLJ12_SIMD1, gmx_mul_pr(c12_SIMD1, sh_invrc12_SIMD)));
#ifndef HALF_LJ
    VLJ12_SIMD2    = gmx_mul_pr(twelvethSIMD, gmx_sub_pr(FrLJ12_SIMD2, gmx_mul_pr(c12_SIMD2, sh_invrc12_SIMD)));
    VLJ12_SIMD3    = gmx_mul_pr(twelvethSIMD, gmx_sub_pr(FrLJ12_SIMD3, gmx_mul_pr(c12_SIMD3, sh_invrc12_SIMD)));
#endif

    VLJ_SIMD0      = gmx_sub_pr(VLJ12_SIMD0, VLJ6_SIMD0);
    VLJ_SIMD1      = gmx_sub_pr(VLJ12_SIMD1, VLJ6_SIMD1);
#ifndef HALF_LJ
    VLJ_SIMD2      = gmx_sub_pr(VLJ12_SIMD2, VLJ6_SIMD2);
    VLJ_SIMD3      = gmx_sub_pr(VLJ12_SIMD3, VLJ6_SIMD3);
#endif
    /* The potential shift should be removed for pairs beyond cut-off */
    VLJ_SIMD0      = gmx_and_pr(VLJ_SIMD0, wco_vdw_SIMD0);
    VLJ_SIMD1      = gmx_and_pr(VLJ_SIMD1, wco_vdw_SIMD1);
#ifndef HALF_LJ
    VLJ_SIMD2      = gmx_and_pr(VLJ_SIMD2, wco_vdw_SIMD2);
    VLJ_SIMD3      = gmx_and_pr(VLJ_SIMD3, wco_vdw_SIMD3);
#endif
#ifdef CHECK_EXCLS
    /* The potential shift should be removed for excluded pairs */
    VLJ_SIMD0      = gmx_and_pr(VLJ_SIMD0, int_SIMD0);
    VLJ_SIMD1      = gmx_and_pr(VLJ_SIMD1, int_SIMD1);
#ifndef HALF_LJ
    VLJ_SIMD2      = gmx_and_pr(VLJ_SIMD2, int_SIMD2);
    VLJ_SIMD3      = gmx_and_pr(VLJ_SIMD3, int_SIMD3);
#endif
#endif
#ifdef ENERGY_GROUPS
    add_ener_grp(VLJ_SIMD0, vvdwtp[0], egp_jj);
    add_ener_grp(VLJ_SIMD1, vvdwtp[1], egp_jj);
#ifndef HALF_LJ
    add_ener_grp(VLJ_SIMD2, vvdwtp[2], egp_jj);
    add_ener_grp(VLJ_SIMD3, vvdwtp[3], egp_jj);
#endif
#else
    VvdwtotSIMD    = gmx_add_pr(VvdwtotSIMD,
#ifdef HALF_LJ
                                gmx_add_pr(VLJ_SIMD0, VLJ_SIMD1)
#else
                                gmx_sum4_pr(VLJ_SIMD0, VLJ_SIMD1, VLJ_SIMD2, VLJ_SIMD3)
#endif
                                );
#endif
#endif /* CALC_LJ */
    ...
    fscal_SIMD1    = gmx_mul_pr(rinvsq_SIMD1,
#ifdef CALC_COULOMB
                               gmx_add_pr(frcoul_SIMD1,
#else
                               (
#endif
                                          gmx_sub_pr(FrLJ12_SIMD1, FrLJ6_SIMD1)));
#else
    fscal_SIMD0    = gmx_mul_pr(rinvsq_SIMD0, frcoul_SIMD0);
    fscal_SIMD1    = gmx_mul_pr(rinvsq_SIMD1, frcoul_SIMD1);
#endif /* CALC_LJ */
    ...
    fscal_SIMD3    = gmx_mul_pr(rinvsq_SIMD3,
#ifdef CALC_COULOMB
                               gmx_add_pr(frcoul_SIMD3,
#else
                               (
#endif
                                          gmx_sub_pr(FrLJ12_SIMD3, FrLJ6_SIMD3)));
#else
    /* Atom 2 and 3 don't have LJ, so only add Coulomb forces */
    fscal_SIMD2    = gmx_mul_pr(rinvsq_SIMD2, frcoul_SIMD2);
    fscal_SIMD3    = gmx_mul_pr(rinvsq_SIMD3, frcoul_SIMD3);
#endif

    /* Calculate temporary vectorial force */
    tx_SIMD0       = gmx_mul_pr(fscal_SIMD0, dx_SIMD0);
    tx_SIMD1       = gmx_mul_pr(fscal_SIMD1, dx_SIMD1);
    tx_SIMD2       = gmx_mul_pr(fscal_SIMD2, dx_SIMD2);
    tx_SIMD3       = gmx_mul_pr(fscal_SIMD3, dx_SIMD3);
    ty_SIMD0       = gmx_mul_pr(fscal_SIMD0, dy_SIMD0);
    ty_SIMD1       = gmx_mul_pr(fscal_SIMD1, dy_SIMD1);
    ty_SIMD2       = gmx_mul_pr(fscal_SIMD2, dy_SIMD2);
    ty_SIMD3       = gmx_mul_pr(fscal_SIMD3, dy_SIMD3);
    tz_SIMD0       = gmx_mul_pr(fscal_SIMD0, dz_SIMD0);
    tz_SIMD1       = gmx_mul_pr(fscal_SIMD1, dz_SIMD1);
    tz_SIMD2       = gmx_mul_pr(fscal_SIMD2, dz_SIMD2);
    tz_SIMD3       = gmx_mul_pr(fscal_SIMD3, dz_SIMD3);

    /* Increment i atom force */
    fix_SIMD0      = gmx_add_pr(fix_SIMD0, tx_SIMD0);
    fix_SIMD1      = gmx_add_pr(fix_SIMD1, tx_SIMD1);
    fix_SIMD2      = gmx_add_pr(fix_SIMD2, tx_SIMD2);
    fix_SIMD3      = gmx_add_pr(fix_SIMD3, tx_SIMD3);
    fiy_SIMD0      = gmx_add_pr(fiy_SIMD0, ty_SIMD0);
    fiy_SIMD1      = gmx_add_pr(fiy_SIMD1, ty_SIMD1);
    fiy_SIMD2      = gmx_add_pr(fiy_SIMD2, ty_SIMD2);
    fiy_SIMD3      = gmx_add_pr(fiy_SIMD3, ty_SIMD3);
    fiz_SIMD0      = gmx_add_pr(fiz_SIMD0, tz_SIMD0);
    fiz_SIMD1      = gmx_add_pr(fiz_SIMD1, tz_SIMD1);
    fiz_SIMD2      = gmx_add_pr(fiz_SIMD2, tz_SIMD2);
    fiz_SIMD3      = gmx_add_pr(fiz_SIMD3, tz_SIMD3);

    /* Decrement j atom force */
    gmx_store_pr(f+ajx,
                 gmx_sub_pr( gmx_load_pr(f+ajx), gmx_sum4_pr(tx_SIMD0, tx_SIMD1, tx_SIMD2, tx_SIMD3) ));
    gmx_store_pr(f+ajy,
                 gmx_sub_pr( gmx_load_pr(f+ajy), gmx_sum4_pr(ty_SIMD0, ty_SIMD1, ty_SIMD2, ty_SIMD3) ));
    gmx_store_pr(f+ajz,
                 gmx_sub_pr( gmx_load_pr(f+ajz), gmx_sum4_pr(tz_SIMD0, tz_SIMD1, tz_SIMD2, tz_SIMD3) ));
}
