...
#ifdef CHECK_EXCLS
#ifdef gmx_andmask_si
    {
        /* Integer mask set and operations, cast result to real */
        gmx_epi32 mask_pr_S = gmx_set1_epi32(l_cj[cjind].excl);

        int_S0  = gmx_castsi_pr(gmx_andmask_si(mask_pr_S, mask_S0));
        int_S1  = gmx_castsi_pr(gmx_andmask_si(mask_pr_S, mask_S1));
        int_S2  = gmx_castsi_pr(gmx_andmask_si(mask_pr_S, mask_S2));
        int_S3  = gmx_castsi_pr(gmx_andmask_si(mask_pr_S, mask_S3));
    }
#else
    {
        ...
        int_S0  = gmx_cmpneq_pr(gmx_castcvtepi32_pr(gmx_and_pr(mask_pr_S, mask_S0)), zero_S);
        int_S1  = gmx_cmpneq_pr(gmx_castcvtepi32_pr(gmx_and_pr(mask_pr_S, mask_S1)), zero_S);
        int_S2  = gmx_cmpneq_pr(gmx_castcvtepi32_pr(gmx_and_pr(mask_pr_S, mask_S2)), zero_S);
        int_S3  = gmx_cmpneq_pr(gmx_castcvtepi32_pr(gmx_and_pr(mask_pr_S, mask_S3)), zero_S);
    }
#endif
#endif
