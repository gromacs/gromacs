...
#else
    fscal_S0    = gmx_mul_pr(rinvsq_S0, gmx_sub_pr(FrLJ12_S0, FrLJ6_S0));
#endif
#ifdef CALC_COULOMB
...
#else
    fscal_S1    = gmx_mul_pr(rinvsq_S1, gmx_sub_pr(FrLJ12_S1, FrLJ6_S1));
#endif
#else
...
#else
    fscal_S2    = gmx_mul_pr(rinvsq_S2, gmx_sub_pr(FrLJ12_S2, FrLJ6_S2));
#endif
#ifdef CALC_COULOMB
...
#else
    fscal_S3    = gmx_mul_pr(rinvsq_S3, gmx_sub_pr(FrLJ12_S3, FrLJ6_S3));
#endif
#else
