...
#define simd_align_real(x)  (real *)(((size_t)((x)+GMX_SIMD_WIDTH_HERE)) & (~((size_t)(GMX_SIMD_WIDTH_HERE*sizeof(real)-1))))
#define simd_align_int(x)   (int  *)(((size_t)((x)+GMX_SIMD_WIDTH_HERE)) & (~((size_t)(GMX_SIMD_WIDTH_HERE*sizeof(int )-1))))

#ifdef CALC_COUL_TAB
#if GMX_NBNXN_SIMD_BITWIDTH == 256
    /* Generate aligned table index pointers */
    ti0 = simd_align_int(ti0_array);
    ti1 = simd_align_int(ti1_array);
    ti2 = simd_align_int(ti2_array);
    ti3 = simd_align_int(ti3_array);
#endif
...
#ifdef CALC_ENERGIES
    tmpsum   = simd_align_real(tmpsum_array);
#endif
#ifdef CALC_SHIFTFORCES
    shf      = simd_align_real(shf_array);
#endif

#ifdef FIX_LJ_C
    pvdw_c6  = simd_align_real(pvdw_array+3);
...
#undef simd_align_real
#undef simd_align_int
