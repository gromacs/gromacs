                          ...
                          void *                     out_data)
{
    ...
    {
        cfftf1(n,(real *)out_data,fft->work+2*n,fft->work,fft->ifac, -1);
    }
                          ...
                          void *                     out_data)
{
    ...
    if(dir == GMX_FFT_REAL_TO_COMPLEX)
    {
         ...
         */
        rfftf1(n,(real *)out_data,fft->work+n,fft->work,fft->ifac);
    ...
    else if(dir == GMX_FFT_COMPLEX_TO_REAL)
    {
        ...
        rfftb1(n,(real *)out_data,fft->work+n,fft->work,fft->ifac); 
    }  
    else
    {
        gmx_fatal(FARGS,"FFT plan mismatch - bad plan or direction.");
