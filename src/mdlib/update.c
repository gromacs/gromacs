                   ...
                   t_idef       *idef)
{
    ...
    lrfreq = inputrec->nstcalclr >0 ? inputrec->nstcalclr : inputrec->nstlist;

    if (bDoLR && lrfreq > 1 && !EI_VV(inputrec->eI))  /* get this working with VV? */
    {
        ...
        combine_forces(lrfreq,constr,inputrec,md,idef,cr,
                       step,state,bMolPBC,
