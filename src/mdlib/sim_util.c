              ...
              int flags)
{
    ...
    double mu[2*DIM];
    gmx_bool   bSepDVDL,bStateChanged,bNS,bFillGrid,bCalcCGCM,bBS;
    gmx_bool   bDoLongRangeNS,bDoLongRangeNB,bDoForces,bDoPotential,bSepLRF;
    ...
    bDoLongRangeNS = (fr->bTwinRange && bNS && (flags & GMX_FORCE_LRNS));
    /* Should we perform the long-range nonbonded evaluation inside the neighborsearching? */
    bDoLongRangeNB = bDoLongRangeNS && (flags & GMX_FORCE_NS_DOLR);
    bFillGrid      = (bNS && bStateChanged);
    bCalcCGCM      = (bFillGrid && !DOMAINDECOMP(cr));
    bDoForces      = (flags & GMX_FORCE_FORCES);
    bDoPotential   = (flags & GMX_FORCE_ENERGY);
    bSepLRF        = (bDoLongRangeNB && bDoForces && (flags & GMX_FORCE_SEPLRF));
    ...
    if (bNS)
    {
        ...
        ns(fplog,fr,x,box,
           ...
           bDoLongRangeNS,bDoLongRangeNB,bDoForces,bDoPotential,bSepLRF ? fr->f_twin : f);
        if (bSepDVDL)
        {
