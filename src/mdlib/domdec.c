...
enum { setcellsizeslbALL, setcellsizeslbMASTER, setcellsizeslbPULSE_ONLY };
                              ...
                              gmx_wallcycle_t wcycle)
{
    ...
    {
        set_dd_cell_sizes_slb(dd, ddbox, setcellsizeslbALL, npulse);
