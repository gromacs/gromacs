...

{
  ...
  if (constr) {
    ...
    constrain(NULL,TRUE,TRUE,constr,&top->idef,	
              ...
              &dvdlambda,NULL,NULL,nrnb,econqCoord,FALSE,0);
                            ...
                            gmx_step_t count,bool bFirst)
{
  ...
  calc_dispcorr(fplog,inputrec,fr,count,top_global,ems->s.box,ems->s.lambda,
  ...
  if (PAR(cr)) {
    ...
    global_stat(fplog,gstat,cr,enerd,force_vir,shake_vir,mu_tot,
                inputrec,NULL,FALSE,FALSE,NULL,NULL,NULL,NULL,&terminate,
                top_global,&ems->s);
  ...
  if (constr) {
    ...
    constrain(NULL,FALSE,FALSE,constr,&top->idef,
              ...
              NULL,&shake_vir,nrnb,econqForceDispl,FALSE,0);
  ...
  refvolshift = log(det(rerun_fr.box));
	...
	copy_rvec(x_tp,state->x[a_tp0]);
            ...
            if (bOurStep)
            {
                ...
                /* Calculate long range corrections to pressure and energy */
                calc_dispcorr(fplog,inputrec,fr,step,top_global,rerun_fr.box,
