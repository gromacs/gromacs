...
static void print_reduction_cost(const nbnxn_buffer_flags_t *flags,int nnbl)
{
    int c0,c,b,nbl;
    ...
    fprintf(debug,"nbnxn reduction buffers: nlist %d flags %d only buf. 0: %4.2f av. reduction: %4.2f\n",
            nnbl,flags->nflag,
            (double)c0/(double)(flags->nflag),
            (double)c/(double)(flags->nflag));
}
