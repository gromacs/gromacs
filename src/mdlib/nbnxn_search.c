 ...
 * with AVX-256 in single precision giving 4x4 instead of 4x8.
 */
#if defined GMX_NBNXN_SIMD_256 && !defined GMX_DOUBLE
    ...
    case nbk4xN_SIMD_2xNN:
        {
            ...
            nbyte_simd = 16;
#endif
            cj_size = nbyte_simd/sizeof(real);
            if (nb_kernel_type == nbk4xN_SIMD_2xNN)
            {
                cj_size /= 2;
            }
        }
