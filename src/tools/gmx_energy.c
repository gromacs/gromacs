...
static void do_dhdl(t_enxframe *fr, t_inputrec *ir, FILE **fp_dhdl, const char *filename, gmx_bool bDp, const output_env_t oenv)
{
    ...
    /*  are these important?  not used elsewhere in code?
      (*hists)+=nblock_hist;  
      (*blocks)+=nblock_dh;
    */
