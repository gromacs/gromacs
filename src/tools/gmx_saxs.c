...
{
    const char *desc[] = {
        "g_saxs can calculate SAXS structure factor for a given number of index groups,",
        "using FFT methods based on Cromer method",
        "You need to supply topology file and trajectory",
        "[PAR]",
        "[TT]-ng[tt] specify a number of groups"
    };
