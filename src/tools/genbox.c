...
char *insert_mols(char *mol_insrt,int nmol_insrt,int ntry,int seed,int ntb,
...
#define NFILE asize(fnm)
  ...
  static int nmol_ins=0,nmol_try=10,seed=1997,ntb=0;
  ...
  t_pargs pa[] = {
    ...
    { "-try",   FALSE,etINT ,{&nmol_try},  "try inserting -nmol*-try times" },
  ...
  if (bInsert) 
    title_ins = insert_mols(opt2fn("-ci",NFILE,fnm),nmol_ins,nmol_try,seed,ntb,
