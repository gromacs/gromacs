...
int gmx_sans(int argc,char *argv[])
{
    const char *desc[] = {
        ...
        "[TT]-sqmean[TT] Computes SANS intensity curve for needed q diapason averaged over trajectory[PAR]",
        "[TT]-sq[TT] Computes SANS intensity curve for needed q diapason for each frame[PAR]",
