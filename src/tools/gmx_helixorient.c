...
#define NFILE asize(fnm)
  ...
  /* read index files */
    fprintf(stderr,"Select a group of Calpha atoms corresponding to a single continuous helix:\n");
    ...
    if(bSC)
    {
        fprintf(stderr,"Select a group of atoms defining the sidechain direction (1/residue):\n");
