...
#define NFILE asize(fnm)
    ...
    const char *in_trajfile, *in_ndxfile, *out_xvgrkfile = NULL,  *out_xvginstefffile = NULL,
            *out_xvgrhistfile = NULL, *out_xvgkhistfile = NULL,*out_datfile=NULL;
