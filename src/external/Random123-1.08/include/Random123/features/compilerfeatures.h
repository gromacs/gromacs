...
/* We only use the C interface of ThreeFry and r123array2x64. This file is a
   replacment of the original from the Random123 distribution, including
   all defines used by the code we use.
   Instead of determining values based on the Compiler (Name, Version, ..)
   we hard-code values based on our assumptions in Gromacs our own defines */
