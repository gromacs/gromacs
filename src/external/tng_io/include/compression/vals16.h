...
void Ptngc_comp_conv_to_vals16(const unsigned int* vals, int nvals, unsigned int* vals16, int* nvals16);

void Ptngc_comp_conv_from_vals16(const unsigned int* vals16, int nvals16, unsigned int* vals, int* nvals);
