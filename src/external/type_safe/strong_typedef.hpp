...
//All changes have GMX line comment
//Version: 441f054 on May 4, 2018
//GMX #include <type_safe/detail/all_of.hpp>
//GMX #include <type_safe/config.hpp>
#define TYPE_SAFE_CONSTEXPR14 constexpr //GMX
#define TYPE_SAFE_LVALUE_REF & //GMX
#define TYPE_SAFE_USE_REF_QUALIFIERS 1 //GMX
...
#define TYPE_SAFE_DETAIL_MAKE_STRONG_TYPEDEF_OP(Name, Op)                                          \
    ...
    TYPE_SAFE_DETAIL_MAKE_OP_COMPOUND_MIXED(Op## =, mixed_##Name##_noncommutative)
        ...
        struct iterator : dereference<StrongTypedef, T, T*, const T*>, increment<StrongTypedef>
        {
            ...
            using value_type        = typename std::remove_cv<T>::type; //GMX-BUGFIX
            using difference_type   = Distance; //GMX-BUGFIX
            using pointer           = T*;
            using reference         = T&;
        };
