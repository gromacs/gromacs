...
struct GroMatchSettings
{
    GroMatchSettings() : tolerance(defaultRealTolerance()), testData(true)
    {
    }
 ...
 * \ingroup module_testutils
 */
class GroMatch : public ITextBlockMatcherSettings
{
    public:
        //! Sets the tolerance for matching data point values.
        GroMatch &tolerance(const FloatingPointTolerance &tolerance)
        {
