...
function (gmx_add_unit_test_object_library NAME)
    if (GMX_BUILD_UNITTESTS AND BUILD_TESTING)
        ...
        set_property(SOURCE ${ARGN} PROPERTY COMPILE_DEFINITIONS GTEST_USE_OWN_TR1_TUPLE=1)
    endif()
endfunction ()
...
function (gmx_build_unit_test NAME EXENAME)
    if (GMX_BUILD_UNITTESTS AND BUILD_TESTING)
        ...
        set_property(SOURCE ${ARGN} ${TESTUTILS_DIR}/unittest_main.cpp PROPERTY COMPILE_DEFINITIONS GTEST_USE_OWN_TR1_TUPLE=1)
