...
function (gmx_add_gtest_executable EXENAME)
    if (GMX_BUILD_UNITTESTS AND BUILD_TESTING)
        ...
        set(_target_objects ${ARG_UNPARSED_ARGUMENTS})

        # Set up the executable target
        include_directories(BEFORE SYSTEM ${GMOCK_INCLUDE_DIRS})
        add_executable(${EXENAME} ${UNITTEST_TARGET_OPTIONS}
            ${TESTUTILS_DIR}/unittest_main.cpp ${_target_objects})
        ...
        # EXTRA_COMPILE_DEFINITIONS are only needed for
        # unittest_main.cpp, but for simplicity used for the whole
        # target (since there may be multiple executables in the same
        # directory, it is not straightforward to use a source file
        # property).
        #
