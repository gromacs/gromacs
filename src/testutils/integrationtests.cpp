...
IntegrationTestFixture::IntegrationTestFixture()
{
    ...
    _putenv_s("GMX_MAXBACKUP", maxBackup_s.c_str());
#else
    setenv("GMX_MAXBACKUP", maxBackup_s.c_str(), true);
#endif
}
