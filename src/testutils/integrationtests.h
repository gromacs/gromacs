...
class IntegrationTestFixture : public ::testing::Test
{
    ...
    protected:
         ...
         *
         * In theory, it could go in the impl_, but the test fixture
         * classes that derive from this are expected to make heavy
         * use of the file manager object.
         */
        ::gmx::test::TestFileManager fileManager;

        //! \brief Handle of implementation object;
