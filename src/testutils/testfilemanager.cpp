...
class TestFileManager::Impl
{
    public:
         ...
         * deleted upon destruction. Currently settable only via
         * command-line option.
         */
        static bool bDeleteFilesAfterTest;
