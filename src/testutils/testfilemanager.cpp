...
{
    public:
        Impl(bool bRemoveFilesAfterTest)
            : bRemoveFilesAfterTest_(bRemoveFilesAfterTest)
        {
        };

        /*! \brief Flag that controls whether temporary files are
         * deleted upon destruction.
         */
        bool bRemoveFilesAfterTest_;
...
TestFileManager::TestFileManager(bool bRemoveFilesAfterTest)
    : impl_(new Impl(bRemoveFilesAfterTest))
{
}

TestFileManager::~TestFileManager()
{
    if (impl_->bRemoveFilesAfterTest_)
    {
        impl_->removeFiles();
    }
}
