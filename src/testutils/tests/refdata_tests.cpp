...
TEST(ReferenceDataTest, ThrowsIfNonEmptyAndOnlyWhitespace)
{
    using gmx::test::internal::throwIfNonEmptyAndOnlyWhitespace;
    EXPECT_THROW_GMX(throwIfNonEmptyAndOnlyWhitespace("  ", "id"), gmx::test::TestException);
    EXPECT_NO_THROW_GMX(throwIfNonEmptyAndOnlyWhitespace("", "id"));
    EXPECT_NO_THROW_GMX(throwIfNonEmptyAndOnlyWhitespace("text", "id"));
    EXPECT_NO_THROW_GMX(throwIfNonEmptyAndOnlyWhitespace("  text", "id"));
}
