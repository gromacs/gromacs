...
from gromacs.TrajectoryAnalysis import TrajectoryAnalysisModule, TrajectoryAnalysisSettings, TrajectoryAnalysisRunnerCommon, SelectionOptionBehavior, SelectionCollection, AnalysisDataParallelOptions, createModuleByName
...
class Pipeline(ICommandLineOptionsModule):
    ...
    def addModule(self, module, argv):
        if isinstance(module, str):
            module = createModuleByName(module)
