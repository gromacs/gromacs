...
static void calc_interpolation_idx(struct gmx_pme *pme, pme_atomcomm_t *atc,
...
static void copy_local_grid(struct gmx_pme *pme, pmegrids_t *pmegrids,
...
static void
reduce_threadgrid_overlap(struct gmx_pme *pme,
...
static void sum_fftgrid_dd(struct gmx_pme *pme, real *fftgrid, int grid_index)
{
    ivec local_fft_ndata, local_fft_offset, local_fft_size;
...
void spread_on_grid(struct gmx_pme *pme,
