 ...
 */
CUDA_FUNC_QUALIFIER void pme_gpu_copy_coordinates(const gmx_pme_t *CUDA_FUNC_ARGUMENT(pme)) CUDA_FUNC_TERM
 ...
 */
CUDA_FUNC_QUALIFIER void pme_gpu_get_energy_virial(const gmx_pme_t *CUDA_FUNC_ARGUMENT(pme),
