...
#ifdef GMX_MPI
void gmx_sum_qgrid_dd(struct gmx_pme *pme, real *grid, int direction)
{
...
int copy_pmegrid_to_fftgrid(struct gmx_pme *pme, real *pmegrid, real *fftgrid, int grid_index)
{
...
int copy_fftgrid_to_pmegrid(struct gmx_pme *pme, const real *fftgrid, real *pmegrid, int grid_index,
...
void wrap_periodic_pmegrid(struct gmx_pme *pme, real *pmegrid)
{
...
void unwrap_periodic_pmegrid(struct gmx_pme *pme, real *pmegrid)
{
...
void reuse_pmegrids(const pmegrids_t *old, pmegrids_t *new)
{
    int d, t;
...
static void dump_local_fftgrid(struct gmx_pme *pme, const real *fftgrid)
{
    ivec local_fft_ndata, local_fft_offset, local_fft_size;
