...
static double pme_load_imbalance(struct gmx_pme *pme)
{
    int    nma, nmi;
    double n1, n2, n3;
...
static void init_atomcomm(struct gmx_pme *pme, pme_atomcomm_t *atc,
...
int gmx_pme_init(struct gmx_pme **pmedata,
                 t_commrec *      cr,
                 int              nnodes_major,
                 int              nnodes_minor,
                 t_inputrec *     ir,
...
static void
calc_initial_lb_coeffs(struct gmx_pme *pme, real *local_c6, real *local_sigma)
{
    int  i;
...
static void
calc_next_lb_coeffs(struct gmx_pme *pme, real *local_sigma)
{
    int  i;
