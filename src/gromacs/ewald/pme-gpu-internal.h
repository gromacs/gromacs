...
/*! \libinternal \brief
 * Rearranges the atom data, copied from GPU to the host after pme_gpu_sync_spline_atom_data() call,
...
CUDA_FUNC_QUALIFIER void myInitGpu(int CUDA_FUNC_ARGUMENT(gpuid)) CUDA_FUNC_TERM
