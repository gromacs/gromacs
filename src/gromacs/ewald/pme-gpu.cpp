 ...
 */
static inline void pme_gpu_get_staged_results(const gmx_pme_t                *pme,
                                    ...
                                    GpuTaskCompletion               completionKind)
{
    ...
    {
        // query the PME stream for completion of all tasks enqueued
        if (!queryPmeGpuStreamFinished(pme->gpu))
        {
...
void pme_gpu_wait_for_gpu(const gmx_pme_t                *pme,
                          ...
                          real                           *energy)
{
    pme_gpu_wait_or_check_finished(pme, wcycle, forces, virial, energy, GpuTaskCompletion::Wait);
}
