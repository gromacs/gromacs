...
{
    bool scaleWithWalls_ = false; /*! True if the simulation uses two walls and the box needs to be scaled in PME */
    real scalingFactor_  = 1.0;   /*! Box The scaling factor PME uses with walls */
