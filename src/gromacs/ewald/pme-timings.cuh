 ...
 * TODO: this class should be moved to gpu_utils to be reused in NB CUDA implementation.
 * That would allow to hide the pairs of start/stop cudaEvents which represent
 * a single region being timed.
 *
...
#include "gromacs/timing/gpu_timing.h"       // TODO: move to the source files
 ...
 * It should allow for host-side tracking of the accumulated execution timespans in the CUDA code.
...
{
    //! The underlying synchronization event pair - the beginning and the end of the timespan
    cudaEvent_t   eventStart_, eventStop_;
    //! The number of times the timespan was measured
    ...
    public:
        ...
        /*! \brief To be called after stopRecording and the CUDA stream of the event has been synchronised. */
        void update();
