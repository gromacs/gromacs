...
inline
void pme_gpu_stage_atom_data(const struct PmeOpenCLKernelParams          kernelParams,
                                                                   ...
                                                                   __global const float * __restrict__ gm_coordinates)
{
    ...
    else
    {
        ...
        /* Gridline indices */
        pme_gpu_stage_atom_data(kernelParams, (__local float *)sm_gridlineIndices, (__global const float *)gm_gridlineIndices, DIM); //FIXME
