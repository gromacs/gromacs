...
template<typename ValueType> void PmeGetGridAndSizes(const PmeSafePointer &pmeSafe, ValueType * &grid, IVec &gridSize, IVec &paddedGridSize) = delete;
