...
/*! \brief Convenience typedef of input parameters - grid dimensions (ivec), PME interpolation order, moduli type */
typedef std::tuple<const int *, int, ModuliType> BSplineModuliInputParameters;
