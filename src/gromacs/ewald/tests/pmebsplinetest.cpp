...
class PmeBSplineModuliTest : public ::testing::TestWithParam<BSplineModuliInputParameters>
{
    public:
        ...
        void RunTest()
        {
            ...
            SCOPED_TRACE(gmx::formatString("Testing B-spline moduli creation (%s) for PME order %d, grid size %d %d %d",
            ...
            auto tolerance           = gmx::test::relativeToleranceAsPrecisionDependentUlp(1.0, singlePrecisionUlps, doublePrecisionUlps);
