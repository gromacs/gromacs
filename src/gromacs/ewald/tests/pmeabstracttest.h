...
/*! \brief Abstract test fixture for initializing the PME test. */
...
/*! \brief Abstract test fixture for a PME death test (test that is supposed to terminate with gmx_fatal()). */
...
/*! \brief Abstract test fixture for a PME test that checks the outputs. */
