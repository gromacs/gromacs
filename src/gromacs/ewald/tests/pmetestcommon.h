...
//! Extern declaration for pmeSetGrid().
extern template void pmeSetGrid<real>(const gmx_pme_t *pme, CodePath mode,
                                      GridOrdering gridOrdering,
                                      const SparseGridValuesInput<real> &gridValues);
//! Extern declaration for pmeSetGrid().
extern template void pmeSetGrid<t_complex>(const gmx_pme_t *pme, CodePath mode,
                                           GridOrdering gridOrdering,
...
SparseGridValuesOutput<ValueType> pmeGetGrid(const gmx_pme_t *pme, CodePath mode,
                                             GridOrdering gridOrdering);
//! Extern declaration for pmeGetGrid().
extern template SparseGridValuesOutput<real> pmeGetGrid<real>(const gmx_pme_t *pme, CodePath mode,
                                                              GridOrdering gridOrdering);
//! Extern declaration for pmeGetGrid().
extern template SparseGridValuesOutput<t_complex> pmeGetGrid<t_complex>(const gmx_pme_t *pme, CodePath mode,
                                                                        GridOrdering gridOrdering);
