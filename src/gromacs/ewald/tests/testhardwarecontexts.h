...
{
    //! Raw GPU device id (as in result of cudaGetDevice() in case of CUDA)
    int         id_;
    //! Readable description
    std::string description_;
    public:
        //! Constructs the context with the given GPU id
        GpuTestHardwareContext(int id, const std::string &description) : id_(id), description_(description){}
