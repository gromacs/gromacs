        ...
        void RunTest()
        {
            ...
            for (const auto &mode : modesToTest)
            {
                ...
                const ForcesVector inputForcesFull {
                    RVec {0.02, 0.87, 0.95}, RVec {0.66, 0.67, 0.38}, RVec {0.45, 0.04, 0.94}, RVec {0.54, 0.76, 0.58},
                    RVec {0.83, 0.31, 0.73}, RVec {0.71, 0.06, 0.35}, RVec {0.32, 0.35, 0.61}, RVec {0.27, 0.98, 0.83},
                    RVec {0.11, 0.3, 0.42}, RVec {0.95, 0.69, 0.58}, RVec {0.29, 0.1, 0.68}, RVec {0.94, 0.62, 0.51},
                    RVec {0.47, 0.04, 0.47}, RVec {0.34, 0.71, 0.52}};
