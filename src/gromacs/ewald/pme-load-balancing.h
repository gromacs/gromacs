 ...
 * Sets bPMELoadBalActive to true is the load balancing is activated
 * and false otherwise. Active means either that we are already balancing
 * or that we should measure timings and potentially balance later.
 */
