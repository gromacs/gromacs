...
struct pme_gpu_cuda_host_t
{
    ...
    /*! \brief A synchronization event for the atom data being copied to the host after the spreading stage (for the host-side gathering / testing). */
    cudaEvent_t syncSpreadAtomDataD2H;
