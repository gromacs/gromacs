...
__global__ void pme_spline_and_spread_kernel(const pme_gpu_cuda_kernel_params_t kernelParams)
{
    ...
    // Staging charges for both stages;
                    ...
                    bool spreadCharges)
{
    ...
    const bool copyBackGrid     = pme_gpu_is_testing(pmeGPU) || !pme_gpu_performs_FFT(pmeGPU) && spreadCharges;
