                    ...
                    bool             spreadCharges)
{
    ...
    const int maxThreadsPerBlock = c_spreadMaxWarpsPerBlock * pmeGpu->contextHandle_->impl_->warpSize;
                   ...
                   GridOrdering gridOrdering, bool computeEnergyAndVirial)
{
    ...
    const int    maxThreadsPerBlock = c_solveMaxWarpsPerBlock * pmeGpu->contextHandle_->impl_->warpSize;
                    ...
                    )
{
    ...
    const int maxThreadsPerBlock = c_gatherMaxWarpsPerBlock * pmeGpu->contextHandle_->impl_->warpSize;
    const int atomsPerBlock      =  maxThreadsPerBlock / PME_SPREADGATHER_THREADS_PER_ATOM;
