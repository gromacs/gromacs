 ...
 * mostly shared between CUDA and OpenCL implementations, and used both in device and host code.
 * As OpenCL C is not aware of constexpr, most of this file is forwarded to the
 * OpenCL kernel compilation as defines with same names, for the sake of code similarity.
 *
 ...
 * TODO: this assumption leads to minimal warp size of 16.
 */
 ...
 * the device runtime limitations gracefulyl as well.
 */
