 ...
 * resulting in wrong kernel results.
 * The structures below are aligned manually and it seems to work on AMD and NVidia OpenCL.
 * It follows a pattern of ordering the members of structs from smallest to largest sizeof
