...
/*! \internal \file
 *
 * \brief Implements builder for schedules the operations necessary
...
std::unique_ptr<IForceSchedule> ScheduleBuilder::generateSchedule(FILE                         *fplog,
                                                                  t_commrec                    *cr,
...
{
    return std::make_unique<DefaultSchedule>(fplog, cr, ms, inputrec, nrnb, wcycle,
