                    ...
                    const pbc_simd_t *pbc)
{
     ...
     */
    gmx_incons(FARGS, "pbc_correct_dx_simd was called for code compiled with MSVC 2010 or older, which produces incorrect code (probably corrupts memory) and therefore this function should not have been called");
#endif
