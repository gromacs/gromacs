 ...
 * MSVC 2013 produces correct results, so we require at least MSVC 2013.
 */
#if defined  GMX_SIMD_HAVE_REAL && !(defined _MSC_VER && _MSC_VER < 1800)
#define GMX_HAVE_PBC_SIMD
#endif
