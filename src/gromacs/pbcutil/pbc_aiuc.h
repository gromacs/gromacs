...
struct PbcAiuc
{
    float invBoxDiagZ;   //!< 1/box[ZZ][ZZ]
    float boxZX;         //!< box[ZZ][XX]
    float boxZY;         //!< box[ZZ][YY]
    float boxZZ;         //!< box[ZZ][ZZ]
    float invBoxDiagY;   //!< 1/box[YY][YY]
    float boxYX;         //!< box[YY][XX]
    float boxYY;         //!< box[YY][YY]
    float invBoxDiagX;   //!< 1/box[XX][XX]
    float boxXX;         //!< box[XX][XX]
};
