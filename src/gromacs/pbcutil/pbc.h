...
typedef struct t_pbc {
    ...
    real       max_cutoff2;
    /*! \brief Whether distance calculations worked.
     *
     *  Determines whether the distance calculation between particles
     *  were limited by the skewedness of the box. For boxes generated
     *  by GROMACS this should always be FALSE. Internal use only.
     */
     ...
     *  of the box, that is the angles. Is used to limit testing
     *  possible shiftings when computing particle-particle distances
     *  to the (pre-determined) set of shift vectors. Can no be larger
     *  than MAX_NTRICVEC. Internal use only.
     */
    int        ntric_vec;
