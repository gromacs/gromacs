...
typedef struct t_pbc {
    ...
    int        ndim_ePBC;
    //! Indicator of how to compute distance vectors
    int        ePBCDX;
    ...
    real       max_cutoff2;
    //! Should we limit the distance from something to something?
    gmx_bool   bLimitDistance;
    //! Distance limit for something. Seems unused
...
/*! \brief DDump the contents of the pbc structure to the file
 *
