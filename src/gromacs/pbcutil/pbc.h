...
typedef struct t_pbc {
    ...
    real       max_cutoff2;
    /*! \brief Limit distance calculati0ns or not.
     *
     *  Determines whether we limit the distance between particles
     *  to the largest distance possible in a compact unitcell
     */
     ...
     */
    int        ntric_vec;
    //! The triclinic shift vectors in grid cells
