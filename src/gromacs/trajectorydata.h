 ...
 */
/*! \defgroup module_trajectorydata Parallelizable Handling of Trajectory Data (trajectorydata)
 * \ingroup group_analysismodules
 * \brief
 * Provides functionality for handling and processing trajectory data from
 * analysis.
 *
 * <H3>Overview</H3>
 *
 * This module provides functionality to do common processing for trajectory data
 ...
 * See \ref page_trajectorydata for an overview of the high-level functionality
 ...
 */
#ifndef GMX_TRAJECTORYDATA_H
#define GMX_TRAJECTORYDATA_H

#include "gromacs/trajectorydata/trajectorydata.h"
#include "gromacs/trajectorydata/arraydata.h"
#include "gromacs/trajectorydata/trajectoryframe.h"
#include "gromacs/trajectorydata/modules/writetrj.h"
