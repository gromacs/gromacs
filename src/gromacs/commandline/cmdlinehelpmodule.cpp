 ...
 * \param[in]     program Name of the current binary.
...
/********************************************************************
 * CommandLineHelpModule::Impl
 */

class CommandLineHelpModule::Impl
{
    public:
        Impl(const ProgramInfo                &programInfo,
...
void CommandLineHelpModule::Impl::exportHelp(HelpExportInterface *exporter) const
{
