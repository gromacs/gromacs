...
{
    gmx_large_int_t   value1 = 0, value2 = 0, value3 = 3;
    t_pargs           pa[]   = {
        { "-i1", FALSE, etGMX_LARGE_INT, {&value1}, "Description" },
        { "-i2", FALSE, etGMX_LARGE_INT, {&value2}, "Description" },
        { "-i3", FALSE, etGMX_LARGE_INT, {&value3}, "Description" }
    };
    const char *const cmdline[] = {
        "test", "-i1", "2", "-i2", "-3"
    };
