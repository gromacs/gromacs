...
{
    { iListInput(8e-6, 1e-8).setPolarization(0.12) },
    { iListInput(1e-3, 1e-8).setAnharmPolarization(0.0013, 0.02, 1235.6) },
    { iListInput(8e-4, 1e-8).setTholePolarization(0.26, 0.07, 0.09, 1.6) },
