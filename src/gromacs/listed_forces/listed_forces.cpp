              ...
              int *global_atom_index)
{
    ...
    if (bCalcEnerVir)
    {
        bondedKernelFlavor = BondedKernelFlavor::ForcesAndVirialAndEnergy;
    }
    else if (fr->use_simd_kernels)
    {
        bondedKernelFlavor = BondedKernelFlavor::ForcesSimdWhenAvailable;
    }
    else
    {
