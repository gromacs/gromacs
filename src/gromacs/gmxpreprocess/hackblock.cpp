...
{
    d->resname = s->resname;
    d->bGenerateHH14Interactions = s->bGenerateHH14Interactions;
    d->bKeepAllGeneratedDihedrals = s->bKeepAllGeneratedDihedrals;
    d->bRemoveDihedralIfWithImproper = s->bRemoveDihedralIfWithImproper;
    d->filebase = s->filebase;
    d->nrexcl = s->nrexcl;
    d->atomname.clear();
