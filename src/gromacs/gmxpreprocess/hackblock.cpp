...
ModificationType ModificationInstruction::type() const
{
...
void freeModificationBlock(gmx::ArrayRef<SystemModificationInstructions> amb)
{
...
void clearModificationBlock(SystemModificationInstructions *amb)
{
    amb->name.clear();
    amb->hack.clear();
...
void mergeAtomModifications(const SystemModificationInstructions &s, SystemModificationInstructions *d)
{
...
void mergeAtomAndBondModifications(const SystemModificationInstructions &s, SystemModificationInstructions *d)
{
    mergeAtomModifications(s, d);
    merge_t_bondeds(s.rb, d->rb, FALSE, FALSE);
}

void copyModificationBlocks(const SystemModificationInstructions &s, SystemModificationInstructions *d)
{
    *d       = s;
    d->name  = s.name;
    d->hack.clear();
