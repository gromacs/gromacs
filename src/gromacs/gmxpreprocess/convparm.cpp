                        ...
                        int start, bool bAppend)
{
    ...
    GMX_ASSERT(ffparams->iparams.size() == static_cast<size_t>(ffparams->ntypes), "sizes should match");
    GMX_ASSERT(ffparams->functype.size() == static_cast<size_t>(ffparams->ntypes), "sizes should match");
