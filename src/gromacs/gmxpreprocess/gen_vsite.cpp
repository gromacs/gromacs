...
static void count_bonds(int atom, SystemParameters *psb, char ***atomname,
...
static void my_add_param(SystemParameters *plist, int ai, int aj, real b)
{
...
static void add_vsites(gmx::ArrayRef<SystemParameters> plist, int vsite_type[],
...
static int gen_vsites_6ring(t_atoms *at, int *vsite_type[], gmx::ArrayRef<SystemParameters> plist,
...
static int gen_vsites_phe(t_atoms *at, int *vsite_type[], gmx::ArrayRef<SystemParameters> plist,
...
void do_vsites(gmx::ArrayRef<const PreprocessResidue> rtpFFDB, gpp_atomtype *atype,
               ...
               gmx::ArrayRef<SystemParameters> plist, int *vsite_type[], int *cgnr[],
...
#define NMASS 2
                    ...
                    for (int j = 0; (j < NMASS); j++)
                    {
                        ...
                        name[0] = 'M';
                        for (int k = 0; (*at->atomname[Heavy])[k] && ( k < NMASS ); k++)
                        {
