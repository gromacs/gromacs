...
{
    VirtualSiteTopology(std::string name) : resname(name)
    {}
    //! Residue name.
    std::string resname;
            ...
            else
            {
                ...
                switch (curdir)
                {
                    ...
                    case DDB_HISH:
                        ...
                        {
                            /* bond */
                            vsitetoplist->back().bond.push_back(
                                    VirtualSiteTopology::
                                        VirtualSiteBond(s1String, s2String, strtod(s3, nullptr)));
                        }
                        else if (n == 4)
                        {
                            /* angle */
                            vsitetoplist->back().angle.push_back(
                                    VirtualSiteTopology::
                                        VirtualSiteAngle(s1String, s2String, s3String, strtod(s4, nullptr)));
                            /* angle */
                        }
                        else
                        {
