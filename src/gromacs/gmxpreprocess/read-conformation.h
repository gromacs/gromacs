 ...
 * default value. Used directly and indirectly by generate-velocities
 * and insert-molecules for deciding whether molecules
 * clash. The return pointer should be freed by the caller. */
 ...
 *
 * Used by generate-velocities and insert-molecules. The returned
 * pointers *x and *v should be freed by the caller. atoms should call
 * its destructor. */
