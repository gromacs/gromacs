            ...
            WriteMdpHeader writeMdpHeader, warninp_t wi)
{
    ...
    /* Implicit solvation is no longer supported, but we need mdrun to
       be able to refuse to run old .tpr files that would have run it. */
    EETYPE("implicit-solvent", ir->implicit_solvent, yesno_names);
