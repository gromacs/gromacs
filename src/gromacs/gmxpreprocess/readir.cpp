            ...
            WriteMdpHeader writeMdpHeader, warninp_t wi)
{
    ...
    /* Note that the QMMM optiosn bOpt and bTS have been removed.
     * But we do not add REM_TYPE for those. Since grompp ignores options
     * with empty right hand side, we can catch set options in the input
