...
PreprocessingAtomTypes::PreprocessingAtomTypes(PreprocessingAtomTypes &&old)
    : impl_(std::move(old.impl_))
{}

PreprocessingAtomTypes &PreprocessingAtomTypes::operator=(PreprocessingAtomTypes &&old)
{
    impl_ = std::move(old.impl_);
    return *this;
}
