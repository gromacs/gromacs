...
static void gen_pairs(const SystemParameters &nbs, SystemParameters *pairs, real fudge, int comb)
{
    real    scaling;
    int     ntp       = nbs.nr;
                        ...
                        case Directive::d_molecules:
                        {
                            ...
                            if (!mi0->bProcessed)
                            {
                                ...
                                generate_excl(mi0->nrexcl,
                                              ...
                                              &nnb,
                                              &(mi0->excls));
                                exclusionBlocks[whichmol] = gmx::mergeExclusions(&(mi0->excls), exclusionBlocks[whichmol]);
                                    ...
                                    t_inputrec *ir, GmxQmmmMode qmmmMode)
{
    ...
    qmexcl2 = gmx::blockaToExclusionBlocks(&qmexcl, qmexcl2);
    qmexcl2 = gmx::mergeExclusions(&(molt->excls), qmexcl2);
