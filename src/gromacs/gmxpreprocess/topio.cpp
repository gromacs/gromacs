...
/* When the charge of a molecule is close to integer, round it to integer.
...
{
    /* We allow for an error of 1e-6 for inaccuracies beyond the 6th decimal
     * of the charges as specified in topology files.
