            ...
            switch (comb)
            {
                case eCOMB_GEOMETRIC:
                    ...
                    for (int i = 0; (i < nr); i++)
                    {
                        for (int j = 0; (j < nr); j++)
                        {
                            ...
                            {
                                ci             = atypes->atomNonBondedParamFromType(i, nf);
                                cj             = atypes->atomNonBondedParamFromType(j, nf);
                                c              = std::sqrt(ci * cj);
                                forceParam[nf] = c;
                            }
                ...
                case eCOMB_ARITHMETIC:
                    ...
                    for (int i = 0; (i < nr); i++)
                    {
                        for (int j = 0; (j < nr); j++)
                        {
                            ci0                  = atypes->atomNonBondedParamFromType(i, 0);
                            cj0                  = atypes->atomNonBondedParamFromType(j, 0);
                            ci1                  = atypes->atomNonBondedParamFromType(i, 1);
                            cj1                  = atypes->atomNonBondedParamFromType(j, 1);
        ...
        case F_BHAM:
            ...
            for (int i = 0; (i < nr); i++)
            {
                for (int j = 0; (j < nr); j++)
                {
                    ci0                  = atypes->atomNonBondedParamFromType(i, 0);
                    cj0                  = atypes->atomNonBondedParamFromType(j, 0);
                    ci2                  = atypes->atomNonBondedParamFromType(i, 2);
                    cj2                  = atypes->atomNonBondedParamFromType(j, 2);
                    bi                   = atypes->atomNonBondedParamFromType(i, 1);
                    bj                   = atypes->atomNonBondedParamFromType(j, 1);
