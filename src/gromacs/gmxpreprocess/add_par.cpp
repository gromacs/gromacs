               ...
               const char                *s)
{
    ...
    ps->param.emplace_back(atoms, forceParm, s ? s : "");
}
...
void add_vsite2_param(InteractionTypeParameters *ps, int ai, int aj, int ak, real c0)
{
    ...
    ps->param.emplace_back(atoms, forceParm, "");
}
