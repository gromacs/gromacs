 ...
 * \param[in] rtp Database with residue information.
 ...
 *
 * \param[in] rptname Name of the entry looked for.
 * \param[in] rtp Database to search.
 ...
 * \param[inout] rtp Database to populate.
...
void readResidueDatabase(const std::string              &resdb,
                         std::vector<PreprocessResidue> *rtp,
                         gpp_atomtype                   *atype,
                         t_symtab                       *tab,
 ...
 * \param[in] rtp Database to write out.
