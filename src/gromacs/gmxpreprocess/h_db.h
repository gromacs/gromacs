...
void read_ab(char *line, const char *fn, Patch *ab);
/* Read one add block */
...
void print_ab(FILE *out, const Patch &ab, const char *nname);
/* print one add block */
 ...
 */
void print_h_db(FILE *out, gmx::ArrayRef<const MoleculePatches> amb);
