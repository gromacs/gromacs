                     ...
                     real rshell, int max_sol)
{
    ...
    auto                     atomsSolvent = topInfoSolvent.releaseAtoms();
    ...
    sort_molecule(&sortedAtomsSolvent, &xSolvent, &vSolvent);
...
#define NFILE asize(fnm)
    ...
    auto atoms         = topInfo.releaseAtoms();
    ...
    fprintf(stderr, "\nOutput configuration contains %d atoms in %d residues\n",
            atoms->nr, atoms->nres);
    update_top(atoms.get(), box, NFILE, fnm, aps);
