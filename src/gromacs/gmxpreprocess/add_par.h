...
void add_imp_param(SystemParameters *ps, int ai, int aj, int ak, int al,
                   real c0, real c1, const char *s);

void add_dih_param(SystemParameters *ps, int ai, int aj, int ak, int al,
                   real c0, real c1, real c2, const char *s);

void add_cmap_param(SystemParameters *ps, int ai, int aj, int ak, int al, int am,
                    const char *s);

void add_vsite2_atoms(SystemParameters *ps, int ai, int aj, int ak);

void add_vsite3_atoms(SystemParameters *ps, int ai, int aj, int ak, int al,
                      bool bSwapParity);
...
void add_vsite4_atoms(SystemParameters *ps, int ai, int aj, int ak, int al,
                      int am);
