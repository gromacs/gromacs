...
class InsertMolecules : public gmx::test::IntegrationTestFixture
{
    public:
        //! Constructor
        InsertMolecules()
...
TEST_F(InsertMolecules, f_ci_Works)
{
...
TEST_F(InsertMolecules, box_ci_Works)
{
...
TEST_F(InsertMolecules, f_box_ci_Works)
{
    caller.addOption("-f", fileManager_.getInputFilePath("spc-and-methanol.gro"));
    caller.addOption("-box", "4");
