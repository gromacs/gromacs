...
bool PreprocessingAtomTypesTest::addType(const char *name,
                                         int         bondAtomType,
                                         int         atomNumber)
{
    int position = atypes_.addType(&symtab_,
                                   atom_,
                                   name,
                                   &nb_,
                                   bondAtomType,
                                   atomNumber);
    return position == gmx::ssize(atypes_) - 1;
}
