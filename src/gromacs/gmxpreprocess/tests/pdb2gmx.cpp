...
class Pdb2gmxTest : public gmx::test::CommandLineTestBase
{
    public:
        Pdb2gmxTest()
        {
            ...
            textMatcher_.addLineToSkip("^;\\s*File '.*' was generated.*");
            textMatcher_.addLineToSkip("^;\\s*By user:.*");
            textMatcher_.addLineToSkip("^;\\s*On host:.*");
            textMatcher_.addLineToSkip("^;\\s*At date:.*");
            textMatcher_.addLineToSkip("^;\\s*:-\\).*\\(-:.*");
            textMatcher_.addLineToSkip("^;\\s*Executable:.*");
            textMatcher_.addLineToSkip("^;\\s*Data prefix:.*");
            textMatcher_.addLineToSkip("^;\\s*Working dir:.*");
            textMatcher_.addLineToSkip("^;\\s*gmxpreprocess-test.*");
