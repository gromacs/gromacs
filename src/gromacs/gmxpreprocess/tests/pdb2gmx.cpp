...
class Pdb2gmxTest : public gmx::test::CommandLineTestBase
{
    public:
        Pdb2gmxTest()
        {
            ...
            textMatcher_.addLineToSkip("^;[[:space:]] *File '.*' was generated.*");
            textMatcher_.addLineToSkip("^;[[:space:]]*By user:.*");
            textMatcher_.addLineToSkip("^;[[:space:]]*On host:.*");
            textMatcher_.addLineToSkip("^;[[:space:]]*At date:.*");
            textMatcher_.addLineToSkip("^;[[:space:]]*:-\\).*\\(-:.*");
            textMatcher_.addLineToSkip("^;[[:space:]]*Executable:.*");
            textMatcher_.addLineToSkip("^;[[:space:]]*Data prefix:.*");
            textMatcher_.addLineToSkip("^;[[:space:]]*Working dir:.*");
            textMatcher_.addLineToSkip("^;[[:space:]]*gmxpreprocess-test.*");
