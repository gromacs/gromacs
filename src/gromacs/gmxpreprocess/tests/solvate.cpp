...
class GenerateSolventTest : public gmx::test::IntegrationTestFixture
{
    public:
        //! Constructor
        GenerateSolventTest()
...
TEST_F(GenerateSolventTest, cs_box_Works)
{
...
TEST_F(GenerateSolventTest, cs_cp_Works)
{
    caller.append("-cs"); // use default solvent box
...
TEST_F(GenerateSolventTest, cs_cp_p_Works)
{
    caller.append("-cs"); // use default solvent box
    caller.addOption("-cp", cpFileName);
