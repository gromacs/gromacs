...
static void print_resatoms(FILE *out, PreprocessingAtomType *atype, const PreprocessResidue &rtpDBEntry)
{
...
static bool read_atoms(FILE *in, char *line,
                       PreprocessResidue *r0, t_symtab *tab, PreprocessingAtomType *atype)
{
    int    cg;
