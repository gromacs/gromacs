...
void read_atype(const char *ffdir, t_symtab *tab, PreprocessingAtomTypes *at)
{
    FILE                    *in;
...
static void print_resatoms(FILE *out, PreprocessingAtomTypes *atype, const PreprocessResidue &rtpDBEntry)
{
