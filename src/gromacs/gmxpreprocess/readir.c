...
#define CHECK(b) _low_check(b, err_buf, wi)
    ...
    sprintf(err_buf, "nstlist can not be smaller than 0. (If you were trying to use the heuristic neighbour-list update scheme from GROMACS 4 for improved energy conservation, please use the Verlet cut-off scheme instead.)");
    CHECK(ir->nstlist < 0);
