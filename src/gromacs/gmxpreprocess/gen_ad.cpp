...
static bool acomp(const FFParameter &a1, const FFParameter &a2)
{
    int            ac;
...
static bool pcomp(const FFParameter &a1, const FFParameter &a2)
{
    int            pc;
...
static bool dcomp(const FFParameter &d1, const FFParameter &d2)
{
    int            dc;
...
static bool idcomp(const FFParameter &a, const FFParameter &b)
{
    int            d;
...
static void sort_id(gmx::ArrayRef<FFParameter> ps)
{
    if (ps.size() > 1)
    {
        ...
        {
            parm.sortID();
            //printf("ai is %d, aj is %d, ak is %d, al is %d\n", parm.ai(),parm.aj(),parm.ak(),parm.al());
        }
                                    ...
                                    do
                                    {
                                        ...
                                        for (auto &bondeds : hbdih->b)
                                        {
                                            ...
                                            if (bFound)
                                            {
                                                 ...
                                                 */
                                                nFound++;
                                                dih.push_back(FFParameter(atomNumbers, {}, name.c_str()));
