...
static int get_impropers(t_atoms *atoms, gmx::ArrayRef<t_hackblock> hb, t_param **improper,
                         bool bAllowMissing)
{
...
static void gen_excls(t_atoms *atoms, t_excls *excls, gmx::ArrayRef<t_hackblock> hb,
                      bool bAllowMissing)
{
    int         itmp;
    t_rbondeds *hbexcl;
...
void gen_pad(t_nextnb *nnb, t_atoms *atoms, gmx::ArrayRef<t_restp> rtp,
