                                          ...
                                          bool bRemoveDihedralIfWithImproper)
{
    ...
    std::vector < std::pair < FFParameter, int>> newDihedrals;
    if (bKeepAllGeneratedDihedrals)
    {
        ...
        {
            newDihedrals.emplace_back(std::pair<FFParameter, int>(dihedral, i++));
        }
    }
    else
    {
    ...
    std::vector<FFParameter> finalDihedrals;
            ...
            for (int k = 0; (k < nnb->nrexcl[j1][1]); k++)
            {
                ...
                if (k1 != i)
                {
                    ...
                    if (i < k1)
                    {
                        ...
                        ang.push_back(FFParameter(atomNumbers, {}, name));
                    }
                                    ...
                                    do
                                    {
                                        ...
                                        for (auto &bondeds : hbdih->b)
                                        {
                                            ...
                                            if (bFound)
                                            {
                                                 ...
                                                 */
                                                nFound++;
                                                dih.push_back(FFParameter(atomNumbers, {}, name));
        ...
        for (int i = 0; i < atoms->nres; i++)
        {
            ...
            for (auto &bondeds : hbang->b)
            {
                ...
                if (bFound)
                {
                    ...
                    ang.push_back(FFParameter(atomNumbers, {}, bondeds.s));
                }
            }
            ...
            for (auto &bondeds : hbdih->b)
            {
                ...
                if (bFound)
                {
                    ...
                    dih.push_back(FFParameter(atomNumbers, {}, bondeds.s));
                }
            }
        }
    }
