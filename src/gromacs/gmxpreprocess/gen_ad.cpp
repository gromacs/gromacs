                         ...
                         bool bAllowMissing)
{
    ...
    if (!globalPatches.empty())
    {
        ...
        {
            BondedInteractions *impropers = &globalPatches[i].rb[ebtsIDIHS];
                      ...
                      bool                                 bAllowMissing)
{
    ...
    for (int a = 0; a < atoms->nr; a++)
    {
        ...
        {
            BondedInteractions *hbexcl = &globalPatches[r].rb[ebtsEXCLS];
             ...
             bool bAllowMissing)
{
                    ...
                    if (i < k1)
                    {
                        ...
                        if (!globalPatches.empty())
                        {
                            ...
                            do
                            {
                                ...
                                BondedInteractions *hbang = &globalPatches[res].rb[ebtsANGLES];
                            ...
                            if ((l1 != i) && (l1 != j1))
                            {
                                ...
                                if (!globalPatches.empty())
                                {
                                    ...
                                    do
                                    {
                                        ...
                                        BondedInteractions *hbdih = &globalPatches[res].rb[ebtsPDIHS];
    ...
    if (!globalPatches.empty())
    {
        ...
        for (int i = 0; i < atoms->nres; i++)
        {
            ...
            BondedInteractions *hbang = &globalPatches[i].rb[ebtsANGLES];
            for (auto &bondeds : hbang->b)
            {
                if (bondeds.match)
                {
            ...
            BondedInteractions *hbdih = &globalPatches[i].rb[ebtsPDIHS];
            for (auto &bondeds : hbdih->b)
            {
                if (bondeds.match)
                {
