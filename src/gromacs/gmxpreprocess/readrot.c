    ...
    *extpos = '\0';
    ...
    for (g = 0; g < rot->ngrp; g++)
    {
        ...
        if (gmx_fexist(reffile))
        {
            ...
            read_trn(reffile, &header.step, &header.t, &header.lambda, f_box, &header.natoms, rotg->x_ref, NULL, NULL,NULL, NULL);
        ...
        else
        {
            ...
            write_trn(reffile, g, 0.0, 0.0, box, rotg->nat, rotg->x_ref, NULL, NULL, NULL, NULL);
        }
    }
}
