...
static void visualize_images(const char *fn, int ePBC, matrix box)
{
    ...
    write_sto_conf(fn, "Images", atoms, resinfo, {}, img, nullptr, ePBC, box);
...
#define NFILE asize(fnm)
    ...
    {
        get_pdb_atomnumber(atoms, pdb, &aps);
    }
    ...
    {
        mass = calc_mass(atoms, resinfo, !fn2bTPX(infile), &aps);
    }
