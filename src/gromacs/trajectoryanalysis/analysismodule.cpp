...
parallelizationPolicy TrajectoryAnalysisModule::parallelPolicy()
{
    return parallelizationPolicy::serialOnly;
}

unsigned long TrajectoryAnalysisModule::nThreadsAvailable()
{
    return 1;
}
} // namespace gmx
