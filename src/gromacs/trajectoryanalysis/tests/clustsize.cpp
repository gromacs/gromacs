...
{
    const char *const command[] = { "clustsize", "-sel", "all" };
...
{
    const char *const command[] = { "clustsize", "-cut", "0.3", "-sel", "all" };
...
TEST_F(ClustsizeTest, OwDefaultCutoff)
{
    const char *const command[] = { "clustsize", "-sel", "ow" };
...
TEST_F(ClustsizeTest, OwLongCutoff)
{
    const char *const command[] = { "clustsize", "-sel", "ow", "-cut", "0.6" };
...
TEST_F(ClustsizeTest, ComLongCutoff)
{
    const char *const command[] = { "clustsize", "-sel", "res_com of resname SOL", "-cut", "0.6" };
...
{
    const char *const command[] = { "clustsize", "-mol", "-sel", "all" };
...
{
    const char *const command[] = { "clustsize", "-mol", "-cut", "0.3", "-sel", "all" };
...
{
    const char *const command[] = { "clustsize", "-mol", "-sel", "all", "-nlevels", "5", "-nlevelsW", "6" };
