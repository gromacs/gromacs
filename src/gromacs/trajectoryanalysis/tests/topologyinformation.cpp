...
TEST(TopologyInformation, CantWorkWithoutReadingAFile)
{
    ...
    EXPECT_EQ(nullptr, topInfo.name());
}
...
TEST(TopologyInformation, WorksWithGroFile)
{
    ...
    ASSERT_NE(nullptr, topInfo.expandedTopology());
    auto releasedAtoms = topInfo.releaseAtoms();
    EXPECT_NE(nullptr, releasedAtoms);
    ASSERT_NE(nullptr, topInfo.atoms());
    EXPECT_NE(releasedAtoms.get(), topInfo.atoms());
    ...
    EXPECT_EQ(nullptr, topInfo.atoms()->pdbinfo);
    EXPECT_EQ(10, topInfo.atoms()->nres);
    ASSERT_NE(nullptr, topInfo.atoms()->resinfo);
    ASSERT_NE(nullptr, topInfo.atoms()->resinfo[4].name);
...
TEST(TopologyInformation, WorksWithPdbFile)
{
    ...
    ASSERT_NE(nullptr, topInfo.atoms()->pdbinfo);
    EXPECT_EQ(10, topInfo.atoms()->nres);
    ASSERT_NE(nullptr, topInfo.atoms()->resinfo);
    ASSERT_NE(nullptr, topInfo.atoms()->resinfo[4].name);
    EXPECT_STREQ("ARG", *topInfo.atoms()->resinfo[4].name);
