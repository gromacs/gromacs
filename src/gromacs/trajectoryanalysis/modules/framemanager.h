...
class IFrameManager
{
    public:
        ...
        //! Move constructor for metadata object.
        explicit IFrameManager(IFrameManager &&metadata)
            : prec_(std::move(metadata.prec_)), time_(std::move(metadata.time_)), bGC_(std::move(metadata.bGC_)),
              ...
              fwflags_(std::move(metadata.fwflags_)), atoms_(std::move(metadata.atoms_)), mtop_(std::move(metadata.mtop_)),
              newFrame_(std::move(metadata.newFrame_))
        {
        }
