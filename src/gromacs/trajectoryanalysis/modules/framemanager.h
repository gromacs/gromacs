...
/*!\libinternal
 * \brief
 * FrameManager class for handling trajectory file opening and data writing
 *
...
class FrameManager
{
    public:
        /*! \brief
         * Default constructor for FrameManager is deleted. Class should only be initialized with at least the base selection.
         */
        FrameManager() = delete;
        /*! \brief
         * Construct FrameManager object with initial selection.
         *
         * Can be used to initialize FrameManager from outside of trajectoryanalysis
         * framework.
         * TODO Add initializers for the remaining fields.
         */
        FrameManager(Selection *sel, TrajectoryOutputMetadata *metadata) : sel_(sel), metadata_(metadata)
        {
         ...
         */
        const t_trxframe *modifyFrame(const t_trxframe *input);
        /*! \brief
    ...
    private:
        ...
        /*! \brief
         * Storage of metadata from output manager.
         *
         * Used to store the information saved in the file output metadata in the framemanager for later use.
         */
