...
rmax {
    ...
    0, 0, 0
}, cutoff(0), sigmaf(0), nr(0), gauss_coef_atname {
    '\0'
}, gauss_coef_attype {
    '\0'
},
Ngaussians(0), Ai(0), Bi(0), C(0), parse_traj(0), lattice(0), lattice_old(0), lattice_squared(0), ncutoff {
    0, 0, 0
}, Nframes(0),
index_aux(0), m(0), X(0), Y(0), Z(0), onesMtotal(0), R {
    0, 0, 0
}, R_trans {
    0, 0, 0
}, nx(0), ny(0), nz(0), grid_vec {
    0, 0, 0
},
R_atom_grid {
    0, 0, 0
}, dist_atom_grid(0), density_contrib(0), g(0), i(0), j(0), k(0), n(0), index_oneD_aux(0), l(0)
{
...
// set parse_traj to one so the analysis is done
    ...
    FILE *pfile;
    pfile = fopen ( gauss_coef_.c_str(), "r");
    //printf("%s\n",gauss_coef);
    int col;
