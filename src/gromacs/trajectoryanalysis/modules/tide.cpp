...
void accumulate_denstiy( gmx_unused t_mapdata *map_av, gmx_unused t_mapdata *map_inst, gmx_unused t_mapdata *map_sd, Selection sel,  float res[], float L0[], int ncutoff[], float cutoff, const std::map < std::string, std::vector < float>> &Ai, const std::map < std::string, std::vector < float>> &Bi,  const std::vector<std::string> &attypeString)
{
