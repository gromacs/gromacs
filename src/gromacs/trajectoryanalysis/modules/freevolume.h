 ...
 */
#ifndef GMX_TRAJECTORYANALYSIS_MODULES_FREEVOLUME_HPP
#define GMX_TRAJECTORYANALYSIS_MODULES_FREEVOLUME_HPP
...
class Freevolume : public TrajectoryAnalysisModule
{
    ...
    private:
        ...
        Selection                        sel_[1];
        AnalysisData                     data_;
        AnalysisDataFrameAverageModulePointer   adata_;
