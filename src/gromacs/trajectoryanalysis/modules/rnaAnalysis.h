...
class RnaAnalysis : public TrajectoryAnalysisModule
{
    ...
    private:
        ...
        //! Get the mass (importance) for certain atom.
        real getMass(real m, const std::string &atomname);
        ...
        void printTriplets(const std::list<PairInfo> &tempPairs);

        void printTriplet(const PairInfo &pair1, const PairInfo &pair2, const bool swap1, const bool swap2);

        void printBasePairs(std::list<PairInfo> &tempPairs);

        void printBasePair(const PairInfo &tempPair);

        void getPlane(const Selection &sel, const ResInfo &base, rvec *out, rvec *center);

        void getPlaneAngleDistance(const Selection &sel, const ResInfo &base1, const ResInfo &base2,
