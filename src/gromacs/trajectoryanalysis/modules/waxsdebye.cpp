                       ...
                       TrajectoryAnalysisSettings *settings)
{
    ...
    // Add option for optional output file
    options->addOption(FileNameOption("waxs_ener").filetype(eftPlot).outputFile()
...
/*! \brief
 * This generates a vsite structure for analysis
 *
 * \param[in] top The analysis topology
 * \returns the vsite structure
 */
...
{
    please_cite(stdout, "Bjorling2015");
}
