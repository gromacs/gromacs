...
Select::initOptions(Options *options, TrajectoryAnalysisSettings * /*settings*/)
{
    static const char *const desc[] = {
        ...
        "and so on. With ``-dump``, the frame time and the number",
        ...
        "With ``-dump``, the frame time is omitted from the output.",
        ""
        ...
        "",
        "With ``-om``, ``-of`` and ``-ofpdb``, only one selection",
        "can be provided. ``-om`` and ``-of`` only accept dynamic",
        "selections."
    };
