...
Rdf::initOptions(Options *options, TrajectoryAnalysisSettings * /*settings*/)
{
    static const char *const desc[] = {
        ...
        "sets of positions (set with [TT]-sel[tt]). To compute the RDF",
        "with respect to the surface of [TT]-ref[tt] instead, use",
        "[TT]-surf[tt]: if set, then [TT]-ref[tt] is partitioned into groups",
        "based on the value of [TT]-surf[tt], and the closest position in each",
        "group is used. To compute the RDF around axes parallel to the",
