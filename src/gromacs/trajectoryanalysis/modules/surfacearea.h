 ...
 * other atom/sphere).  The dots are distributed evenly used an icosahedron- or
...
class SurfaceAreaCalculator
{
    public:
         ...
         *     (can be `NULL`).
         * \param[out] nu_dots Number of surface dots in \p lidots
         *     (can be `NULL`).
         *
