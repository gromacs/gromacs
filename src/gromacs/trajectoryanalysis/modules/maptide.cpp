                                      ...
                                      TrajectoryAnalysisSettings *settings)
{
    static const char *const desc[] = {
        ...
        " silently ignored unless the [TT]-v[tt] flag is set. Precision shall"
        " are always in nm.",
        "",
        ...
        " reference map.",
        "* [TT]-blocksize[tt] Block averaged density correlation with"
        " windows of blocksize. Block size one corresponds to the usual, non-averaged, case.",
        "",
        "A masking map is provided with [TT]-mask[tt]. Grid points in the "
        " mask, with density smaller than a user-specified"
        " threshold value ([TT]-maskcutoff[tt]), will be ignored. In the output maps, "
        " the masked points will be set to nan or any other, user specified"
