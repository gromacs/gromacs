    ...
    if (Xpm || statistic)
    {
        ...
        for (frameI = found.begin(); frameI != frameEnd; ++frameI)
        {
            ...
            if (Xpm)
            {
                ...
                {
                    matrix[posI->base2][posI->base1] = 0;
                    matrix[posI->base1][posI->base2] = 0;
                }
