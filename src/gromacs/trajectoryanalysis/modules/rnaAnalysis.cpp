                          ...
                          TrajectoryAnalysisModuleData *pdata)
{
    ...
    for (int base1 = 0; base1 < nrResidues; base1++)
    {
        ...
        while (pairSearch.findNextPair(&pair))
        {
            ...
            /*
               std::cout << "residue info before " << residueInfo[base1].type << " " << residueInfo[base1].resNr << " " << residueInfo[base2].type << " " << residueInfo[base2].resNr << std::endl;
               std::cout << "residue info temp before " << residueInfo[tempBase1].type << " " << residueInfo[tempBase1].resNr << " " << residueInfo[tempBase2].type << " " << residueInfo[tempBase2].resNr << std::endl;
             */
            tempBase1 = base1;
            tempBase2 = base2;
            /*
               std::cout << "residue info after " << residueInfo[base1].type << " " << residueInfo[base1].resNr << " " << residueInfo[base2].type << " " << residueInfo[base2].resNr << std::endl;
               std::cout << "residue info temp after " << residueInfo[tempBase1].type << " " << residueInfo[tempBase1].resNr << " " << residueInfo[tempBase2].type << " " << residueInfo[tempBase2].resNr << std::endl;
             */
            int         nrRuns = 1;
            float       x, y, z;
            int         atomId1, atomId2;
...
RnaAnalysis::writeOutput()
{
    ...
    if (Xpm || statistic)
    {
        ...
        //real ** matrix = new real[][nrResidues];
        real **matrix;
