...
static bool validateResInfo(ResInfo *ri)
{
    ...
    int dn = numberOfNucleotideAtoms[ri->residueType()] - ri->nAtoms();
    return (dn == 0 ||
                                  ...
                                  unsigned int        vecSize)
{
    bool bond = (*bpi)->isHBond(nucleotideInfo_[base1],
                                ...
                                pbc, bondDist_, sel);
    *RMSD = (*bpi)->computeRootMeanSquareDeviation(nucleotideInfo_[base1],
                                                   nucleotideInfo_[base2],
                                                   vec, vecSize);
    if (NULL != debug)
    {
...
static unsigned int fillVector(ResInfo            *ri1,
                               ResInfo            *ri2,
