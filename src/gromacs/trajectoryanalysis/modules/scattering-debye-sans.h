...
/*! \internal \brief
 * Derrived class for computing SANS scattering
 */
class SansDebye : public ComputeDebyeScattering
{
public:
    //! constructor
    SansDebye(std::vector<Isotope> isotopes);
...
private:
    ...
    std::vector<double> scatterFactors_;
};
