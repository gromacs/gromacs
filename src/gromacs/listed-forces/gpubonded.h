...
class GpuBonded
{
    public:
        ...
        void updateAfterSearch(ArrayRef<const int>  nbnxnAtomOrder,
                               const t_idef        &idef,
                               void                *xqDevice,
                               void                *forceDevice,
                               void                *fshiftDevice);
        ...
        void calculateInteractions(const t_forcerec *fr,
                                   int               forceFlags,
                                   const matrix      box);
        /*! \brief Copies back the bonded energies to \c enerd. */
        void transferEnergies(gmx_enerdata_t *enerd);
