...
{
    { iListInput(2e-5, 1e-8).setHarmonic(F_ANGLES, 100.0, 50.0) },
    { iListInput(2e-5, 1e-8).setHarmonic(F_ANGLES, 100.15, 50.0, 95.0, 30.0) },
    { iListInput(2e-3, 1e-8).setHarmonic(F_G96ANGLES, 100.0, 50.0) },
    { iListInput(2e-3, 1e-8).setHarmonic(F_G96ANGLES, 100.0, 50.0, 95.0, 30.0) },
    ...
    { iListInput(1e-4, 1e-8).setUreyBradley(950.0, 46.0, 0.3, 5.0) },
    { iListInput(1e-4, 1e-8).setUreyBradley(100.0, 45.0, 0.3, 5.0, 90.0, 47.0, 0.32, 7.0) },
    { iListInput(4e-5, 1e-8).setQuarticAngles(87.0, cQuarticAngles ) }
};
...
{
    { iListInput(4e-5, 1e-8).setProperDihedrals(-100.0, 10.0, 2, -80.0, 20.0) },
    ...
    { iListInput(1e-5, 1e-8).setRbDihedrals(rbcA, rbcB) },
