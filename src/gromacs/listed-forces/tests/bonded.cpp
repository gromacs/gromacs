...
{
    { iListInput(8e-5, 1e-8).setHarmonic(F_ANGLES, 100.0, 50.0) },
    { iListInput(8e-5, 1e-8).setHarmonic(F_ANGLES, 100.15, 50.0, 95.0, 30.0) },
    { iListInput(4e-3, 1e-8).setHarmonic(F_G96ANGLES, 100.0, 50.0) },
    { iListInput(4e-3, 1e-8).setHarmonic(F_G96ANGLES, 100.0, 50.0, 95.0, 30.0) },
...
{
    { iListInput(6e-5, 1e-8).setProperDihedrals(-100.0, 10.0, 2, -80.0, 20.0) },
    { iListInput(6e-5, 1e-8).setProperDihedrals(-105.0, 15.0, 2) },
    { iListInput(2e-4, 1e-8).setHarmonic(F_IDIHS, 100.0, 50.0) },
    { iListInput(2e-4, 1e-8).setHarmonic(F_IDIHS, 100.15, 50.0, 95.0, 30.0) },
    { iListInput(4e-5, 1e-8).setRbDihedrals(rbcA, rbcB) },
    { iListInput(4e-5, 1e-8).setRbDihedrals(rbc) }
};
