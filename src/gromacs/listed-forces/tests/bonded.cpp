...
{
    { iListInput(6e-4, 1e-8).setHarmonic(F_ANGLES, 100.0, 50.0) },
    { iListInput(6e-4, 1e-8).setHarmonic(F_ANGLES, 100.15, 50.0, 95.0, 30.0) },
    ...
    { iListInput(3e-4, 1e-8).setUreyBradley(950.0, 46.0, 0.3, 5.0) },
    { iListInput(3e-4, 1e-8).setUreyBradley(100.0, 45.0, 0.3, 5.0, 90.0, 47.0, 0.32, 7.0) },
...
std::vector<iListInput> c_InputDihs =
{
    ...
    { iListInput(2e-4, 1e-8).setRbDihedrals(rbcA, rbcB) },
    { iListInput(2e-4, 1e-8).setRbDihedrals(rbc) }
};
