...
typedef struct
{
    ...
    int               mask_nalloc;  /**< Allocation size of mask of block_index */
...
struct bonded_threading_t
{
    ...
    int           *mask_index;  /**< Index of size nblock_used into mask */
    ...
    int            mask_nalloc; /**< Allocation size of mask_index and mask */
