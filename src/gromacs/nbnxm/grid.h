...
//! 2log of c_packedBoundingBoxesDimSize
static constexpr int c_packedBoundingBoxesDimSize2Log = 2;
...
{
    return (clusterIndex >> c_packedBoundingBoxesDimSize2Log)*c_packedBoundingBoxesSize;
}
