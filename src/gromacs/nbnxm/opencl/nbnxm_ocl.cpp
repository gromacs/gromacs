 ...
 *
 *  TODO (psz):
 *  - Add a static const cl_uint c_pruneKernelWorkDim / c_nbnxmKernelWorkDim = 3;
 ...
 *
 *  - Consider extracting common sections of the OpenCL and CUDA nbnxm logic, e.g:
 *    - in nbnxm_gpu_launch_kernel_pruneonly() the pre- and post-kernel launch logic
...
static const char* nb_kfunc_noener_noprune_ptr[c_numElecTypes][c_numVdwTypes] = {
    { "nbnxm_kernel_ElecCut_VdwLJ_F_opencl",
      "nbnxm_kernel_ElecCut_VdwLJCombGeom_F_opencl",
      "nbnxm_kernel_ElecCut_VdwLJCombLB_F_opencl",
      "nbnxm_kernel_ElecCut_VdwLJFsw_F_opencl",
      "nbnxm_kernel_ElecCut_VdwLJPsw_F_opencl",
      "nbnxm_kernel_ElecCut_VdwLJEwCombGeom_F_opencl",
      "nbnxm_kernel_ElecCut_VdwLJEwCombLB_F_opencl" },
    { "nbnxm_kernel_ElecRF_VdwLJ_F_opencl",
      "nbnxm_kernel_ElecRF_VdwLJCombGeom_F_opencl",
      "nbnxm_kernel_ElecRF_VdwLJCombLB_F_opencl",
      "nbnxm_kernel_ElecRF_VdwLJFsw_F_opencl",
      "nbnxm_kernel_ElecRF_VdwLJPsw_F_opencl",
      "nbnxm_kernel_ElecRF_VdwLJEwCombGeom_F_opencl",
      "nbnxm_kernel_ElecRF_VdwLJEwCombLB_F_opencl" },
    { "nbnxm_kernel_ElecEwQSTab_VdwLJ_F_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJCombGeom_F_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJCombLB_F_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJFsw_F_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJPsw_F_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJEwCombGeom_F_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJEwCombLB_F_opencl" },
    { "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJ_F_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_F_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_F_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJFsw_F_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJPsw_F_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_F_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_F_opencl" },
    { "nbnxm_kernel_ElecEw_VdwLJ_F_opencl",
      "nbnxm_kernel_ElecEw_VdwLJCombGeom_F_opencl",
      "nbnxm_kernel_ElecEw_VdwLJCombLB_F_opencl",
      "nbnxm_kernel_ElecEw_VdwLJFsw_F_opencl",
      "nbnxm_kernel_ElecEw_VdwLJPsw_F_opencl",
      "nbnxm_kernel_ElecEw_VdwLJEwCombGeom_F_opencl",
      "nbnxm_kernel_ElecEw_VdwLJEwCombLB_F_opencl" },
    { "nbnxm_kernel_ElecEwTwinCut_VdwLJ_F_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJCombGeom_F_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJCombLB_F_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJFsw_F_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJPsw_F_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJEwCombGeom_F_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJEwCombLB_F_opencl" }
};

/*! \brief Force + energy kernel function pointers. */
static const char* nb_kfunc_ener_noprune_ptr[c_numElecTypes][c_numVdwTypes] = {
    { "nbnxm_kernel_ElecCut_VdwLJ_VF_opencl",
      "nbnxm_kernel_ElecCut_VdwLJCombGeom_VF_opencl",
      "nbnxm_kernel_ElecCut_VdwLJCombLB_VF_opencl",
      "nbnxm_kernel_ElecCut_VdwLJFsw_VF_opencl",
      "nbnxm_kernel_ElecCut_VdwLJPsw_VF_opencl",
      "nbnxm_kernel_ElecCut_VdwLJEwCombGeom_VF_opencl",
      "nbnxm_kernel_ElecCut_VdwLJEwCombLB_VF_opencl" },
    { "nbnxm_kernel_ElecRF_VdwLJ_VF_opencl",
      "nbnxm_kernel_ElecRF_VdwLJCombGeom_VF_opencl",
      "nbnxm_kernel_ElecRF_VdwLJCombLB_VF_opencl",
      "nbnxm_kernel_ElecRF_VdwLJFsw_VF_opencl",
      "nbnxm_kernel_ElecRF_VdwLJPsw_VF_opencl",
      "nbnxm_kernel_ElecRF_VdwLJEwCombGeom_VF_opencl",
      "nbnxm_kernel_ElecRF_VdwLJEwCombLB_VF_opencl" },
    { "nbnxm_kernel_ElecEwQSTab_VdwLJ_VF_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJCombGeom_VF_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJCombLB_VF_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJFsw_VF_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJPsw_VF_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJEwCombGeom_VF_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJEwCombLB_VF_opencl" },
    { "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJ_VF_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_VF_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_VF_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJFsw_VF_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJPsw_VF_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_VF_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_VF_opencl" },
    { "nbnxm_kernel_ElecEw_VdwLJ_VF_opencl",
      "nbnxm_kernel_ElecEw_VdwLJCombGeom_VF_opencl",
      "nbnxm_kernel_ElecEw_VdwLJCombLB_VF_opencl",
      "nbnxm_kernel_ElecEw_VdwLJFsw_VF_opencl",
      "nbnxm_kernel_ElecEw_VdwLJPsw_VF_opencl",
      "nbnxm_kernel_ElecEw_VdwLJEwCombGeom_VF_opencl",
      "nbnxm_kernel_ElecEw_VdwLJEwCombLB_VF_opencl" },
    { "nbnxm_kernel_ElecEwTwinCut_VdwLJ_VF_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJCombGeom_VF_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJCombLB_VF_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJFsw_VF_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJPsw_VF_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJEwCombGeom_VF_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJEwCombLB_VF_opencl" }
};

/*! \brief Force + pruning kernel function pointers. */
static const char* nb_kfunc_noener_prune_ptr[c_numElecTypes][c_numVdwTypes] = {
    { "nbnxm_kernel_ElecCut_VdwLJ_F_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJCombLB_F_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJFsw_F_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJPsw_F_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJEwCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJEwCombLB_F_prune_opencl" },
    { "nbnxm_kernel_ElecRF_VdwLJ_F_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJCombLB_F_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJFsw_F_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJPsw_F_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJEwCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJEwCombLB_F_prune_opencl" },
    { "nbnxm_kernel_ElecEwQSTab_VdwLJ_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJCombLB_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJFsw_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJPsw_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJEwCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJEwCombLB_F_prune_opencl" },
    { "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJ_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJFsw_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJPsw_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_F_prune_opencl" },
    { "nbnxm_kernel_ElecEw_VdwLJ_F_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJCombLB_F_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJFsw_F_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJPsw_F_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJEwCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJEwCombLB_F_prune_opencl" },
    { "nbnxm_kernel_ElecEwTwinCut_VdwLJ_F_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJCombLB_F_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJFsw_F_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJPsw_F_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJEwCombGeom_F_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJEwCombLB_F_prune_opencl" }
};
...
static const char* nb_kfunc_ener_prune_ptr[c_numElecTypes][c_numVdwTypes] = {
    { "nbnxm_kernel_ElecCut_VdwLJ_VF_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJCombLB_VF_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJFsw_VF_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJPsw_VF_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJEwCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecCut_VdwLJEwCombLB_VF_prune_opencl" },
    { "nbnxm_kernel_ElecRF_VdwLJ_VF_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJCombLB_VF_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJFsw_VF_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJPsw_VF_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJEwCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecRF_VdwLJEwCombLB_VF_prune_opencl" },
    { "nbnxm_kernel_ElecEwQSTab_VdwLJ_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJCombLB_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJFsw_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJPsw_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJEwCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTab_VdwLJEwCombLB_VF_prune_opencl" },
    { "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJ_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJCombLB_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJFsw_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJPsw_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJEwCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecEwQSTabTwinCut_VdwLJEwCombLB_VF_prune_opencl" },
    { "nbnxm_kernel_ElecEw_VdwLJ_VF_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJCombLB_VF_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJFsw_VF_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJPsw_VF_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJEwCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecEw_VdwLJEwCombLB_VF_prune_opencl" },
    { "nbnxm_kernel_ElecEwTwinCut_VdwLJ_VF_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJCombLB_VF_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJFsw_VF_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJPsw_VF_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJEwCombGeom_VF_prune_opencl",
      "nbnxm_kernel_ElecEwTwinCut_VdwLJEwCombLB_VF_prune_opencl" }
};
...
select_nbnxm_kernel(NbnxmGpu* nb, enum ElecType elecType, enum VdwType vdwType, bool bDoEne, bool bDoPrune)
{
 ...
 *
 *  This function is called before the launch of both nbnxm and prune kernels.
 */
