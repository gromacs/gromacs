 ...
 */
#ifndef GMX_NBNXM_HIP_NBNXM_HIP_KERNEL_PRUNEONLY_H
#define GMX_NBNXM_HIP_NBNXM_HIP_KERNEL_PRUNEONLY_H
...
/*! \brief Launch HIP NBNXM prune-only kernel.
 *
...
#endif // GMX_NBNXM_HIP_NBNXM_HIP_KERNEL_PRUNEONLY_H
