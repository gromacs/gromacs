...
static float clusterBoundingBoxDistance2_simd4(const BoundingBox &bb_i,
                                               const BoundingBox &bb_j)
{
    ...
    bb_i_S0 = load4(bb_i.lower.ptr());
    bb_i_S1 = load4(bb_i.upper.ptr());
    bb_j_S0 = load4(bb_j.lower.ptr());
    bb_j_S1 = load4(bb_j.upper.ptr());
