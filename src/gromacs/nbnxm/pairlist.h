...
struct NbnxnPairlistGpu
{
    ...
    AlignedHostVector<nbnxn_sci_t>  sci;
    // The list of 4*j-cluster groups
    AlignedHostVector<nbnxn_cj4_t>  cj4;
    // Atom interaction bits (non-exclusions)
    AlignedHostVector<nbnxn_excl_t> excl;
