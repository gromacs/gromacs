 ...
 *
 * \brief
 * CUDA kernel for GPU version of add_nbat_f_to_f (atomdata.cpp).
                                 ...
                                 const bool               haveCpuForces)
{
    ...
    if (a < a1)
    {
        ...
        float3 *fnb_flt3 = (float3 *)&fnb[i];
        float3 *f_flt3   = (float3 *)&f[a][XX];
        float3  f;
