...
//#include "gromacs/nbnxm/nbnxm_gpu_types.h"
#include "gromacs/nbnxm/cuda/gpuD2DConstraintsCUDA.h"
...
GPU_FUNC_QUALIFIER
void gpuUpdateConstraintsSetPressureCouplingStep(bool bPressureStep) GPU_FUNC_TERM

GPU_FUNC_QUALIFIER
void gpuUpdateConstraintsCopyXPToXOnDevice() GPU_FUNC_TERM

CUDA_FUNC_QUALIFIER
void gpuUpdateConstraintsCopyXToPMEOnDevice(PmeGpu *pmeGpu) CUDA_FUNC_TERM

GPU_FUNC_QUALIFIER
int gpuUpdateConstraintsCPUCopyRequired() GPU_FUNC_TERM
