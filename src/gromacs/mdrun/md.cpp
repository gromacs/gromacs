    ...
    while (!bLastStep)
    {
        ...
        else
        {
            /* The AWH history need to be saved _before_ doing force calculations where the AWH bias is updated
               ...
               rid of this issue. */
            if (awh && checkpointSignalHandler != nullptr &&
                checkpointSignalHandler->doCheckpointThisStep() && MASTER(cr))
            {
        ...
        do_md_trajectory_writing(fplog, cr, nfile, fnm, step, step_rel, t,
                                 ...
                                 outf, mdebin, ekind, f,
                                 &nchkpt,
                                 (checkpointSignalHandler != nullptr) ? checkpointSignalHandler->doCheckpointThisStep() : false,
                                 bRerunMD, bLastStep,
