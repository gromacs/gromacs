...
void gmx::Integrator::do_md()
{
    ...
    auto checkpointHandler = compat::make_unique<CheckpointHandler>(
            this, mdState.get(), simulationSetup);
    ...
    while (!bLastStep)
    {
        ...
        do_md_trajectory_writing(fplog, cr, nfile, fnm, step, step_rel, t,
                                 ...
                                 top_global, fr,
                                 outf, mdebin, ekind, f,
                                 checkpointHandler->doCheckpointThisStep(this, mdState.get(), simulationSetup),
                                 bRerunMD, bLastStep,
        ...
        checkpointHandler->setSignal(this, mdState.get(), simulationSetup);
