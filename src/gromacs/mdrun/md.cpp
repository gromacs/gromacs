...
void gmx::Integrator::do_md()
{
    ...
    auto       resetHandler         = ResetHandler(&signals[eglsRESETCOUNTERS], !resetCountersIsLocal, ir, cr,
                                                   mdrunOptions, mdlog, fplog, step, step_rel,
                                                   (use_GPU(fr->nbv) ? fr->nbv : nullptr), nrnb,
                                                   fr->pmedata, pme_loadbal, walltime_accounting, wcycle);
