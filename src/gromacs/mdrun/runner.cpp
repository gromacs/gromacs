 ...
 */
static std::unique_ptr< std::array<t_filenm, Mdrunner::nfile> >
cloneMdFilenames(const std::array<t_filenm, Mdrunner::nfile> &source)
{
    auto filenames = gmx::compat::make_unique< std::array <t_filenm, Mdrunner::nfile> >();
...
MdrunnerBuilder &MdrunnerBuilder::setFilenames(
