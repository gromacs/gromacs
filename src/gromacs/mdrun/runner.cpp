...
Mdrunner::Mdrunner(HardwareOptionsManager hardwareOptions)
...
{
    auto newRunner = Mdrunner(hardwareOptions);
...
class Mdrunner::BuilderImplementation
{
    ...
    private:
        ...
        HardwareOptionsManager hardwareOptions_ = HardwareOptionsManager(gmx_hw_opt_t());
...
Mdrunner Mdrunner::BuilderImplementation::build()
{
    ...
    auto newRunner = Mdrunner(hardwareOptions_);
