...
MdrunnerBuilder::MdrunnerBuilder(MdrunnerBuilder &&builder) noexcept = default;

MdrunnerBuilder &MdrunnerBuilder::operator=(MdrunnerBuilder &&builder) noexcept = default;
