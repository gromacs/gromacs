...
struct Integrator
{
    ...
    AccumulatorBuilder<ISimulationAccumulatorClient>      *simulationAccumulatorBuilder_;
    //! Builds an object that will accumulates globals for modules that require that.
    AccumulatorBuilder<IMultiSimulationAccumulatorClient> *multiSimulationAccumulatorBuilder_;
