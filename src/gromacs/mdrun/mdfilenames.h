 ...
 * by gmx::Mdrunner.
 *
 * \todo These options should be reexpressed in a modernized idiom.
 * These options have not been updated to the current Options framework, and in
 * the future they should be expressed and handled by the relevant modules.
 *
 * \ingroup module_mdrun
 * \inlibraryapi
 */
