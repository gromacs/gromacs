...
Integrator::do_cg()
{
    ...
    if (MASTER(cr))
    {
        ...
        upd_mdebin_local(mdebin, FALSE, FALSE, static_cast<double>(step),
...
Integrator::do_lbfgs()
{
    ...
    *sc              = ems;
    ...
    {
        /* Copy stuff to the energy bin for easy printing etc. */
        upd_mdebin_global(mdebin, FALSE, FALSE, static_cast<double>(step),
...
Integrator::do_steep()
{
    ...
    while (!bDone && !bAbort)
    {
        ...
        if (MASTER(cr))
        {
            ...
            {
                /* Store the new (lower) energies  */
                upd_mdebin_local(mdebin, FALSE, FALSE, static_cast<double>(count),
