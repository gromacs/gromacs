...
Integrator::do_cg()
{
    ...
    GMX_LOG(mdlog.info).asParagraph().
        appendText("Note that activating conjugate gradient energy minimization via the "
                   "integrator .mdp option and the command gmx mdrun is deprecated, and "
                   "will be available in a different form in a future version of GROMACS.");
...
Integrator::do_nm()
{
    ...
    GMX_LOG(mdlog.info).asParagraph().
        appendText("Note that activating normal-mode analysis via the integrator "
                   ".mdp option and the command gmx mdrun is deprecated, and will "
