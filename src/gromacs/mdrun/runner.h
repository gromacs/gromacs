...
class Mdrunner
{
    public:
         ...
         * \{
         */
        Mdrunner(Mdrunner &&handle) noexcept            = default;
        Mdrunner &operator=(Mdrunner &&handle) noexcept = default;
        /* \} */
...
class MdrunnerBuilder final
{
    public:
         ...
         *
         * \internal
         * The runner needs to be able to extend (or at least to query) the lifetime of
         * the resources it is provided. It is a client of, but not the owner of
         * the SimulationContext. Until a longer-term structural solution is developed,
         * shared_ptr is an effective and expedient de facto handle, but indicates an incomplete
         ...
         *
         * Optional. Default multisim is nullptr, indicating no multisim work.
         * Client is responsible for correctly cleaning up multisim.
         *
         ...
         * \todo make optional or provide sensible and well-documented defaults.
         */
         ...
         *
         * Required. For guidance on preparing a valid DomdecOptions value,
         * refer to the client code in mdrun.cpp
         *
         * \param options options with which to construct domain decomposition.
         *
         * \internal
         * \todo make optional or provide reasonable default
         ...
         *
         * Required. For guidance on preparing a valid ReplicaExchangeParameters
