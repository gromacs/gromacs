 ...
 *
 * It is not clear yet whether the builder should be extensible at compile
 * time or at run time, but the builder should evolve to compose the runner,
 * rather than just consolidating the parameters for initialization.
 ...
 * the Directory code. The runner and client code will also have to be updated
...
class MdrunnerBuilder final
{
    public:
        /*!
         * \brief Default constructor is available to client code in the GROMACS build environment.
         */
        MdrunnerBuilder();
