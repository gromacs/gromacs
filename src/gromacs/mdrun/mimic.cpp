...
void gmx::Integrator::do_mimic()
{
    ...
    {
        comm.init();
        comm.sendInitData(top_global, state_global->x, constr);
    ...
    gmx_bcast_sim(sizeof(ir->nsteps), &ir->nsteps, cr);
...
//        }
    ...
    int  nstSignalComm         = nstglobalcomm;
    {
        ...
        bool usingEnsembleRestraints = false;
        bool awhUsesMultiSim         = false;
