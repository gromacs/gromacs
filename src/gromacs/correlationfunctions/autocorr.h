 ...
 */
#define eacNormal (1<<0)              /*!< Normal correlation */
#define eacCos    (1<<1)              /*!< Cosine correlation cos(x(t)-x(t+dt)) */
#define eacVector (1<<2)              /*!< Vector correlation x(t).x(t+dt) */
#define eacRcross (1<<3  | eacVector) /*!< Cross product between x(t) and x(t+dt) */
#define eacP0     (1<<4  | eacVector) /*!< Vector with Legendre polynomial of order 0 */
#define eacP1     (1<<5  | eacVector) /*!< Vector with Legendre polynomial of order 1 */
#define eacP2     (1<<6  | eacVector) /*!< Vector with Legendre polynomial of order 2 */
#define eacP3     (1<<7  | eacVector) /*!< Vector with Legendre polynomial of order 3 */
#define eacP4     (1<<8  | eacVector) /*!< Vector with Legendre polynomial of order 4 */
#define eacIden   (1<<9)              /*!< Binary identy correlation (x(t) == x(t+dt)) */
