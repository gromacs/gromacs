 ...
 * \param[inout] fitparms[] Fitting parameters, see printed manual for a detailed
 * description, but in all implemented cases the parameters corresponding to time
 * constants will be generated with increasing values. The input parameters
 * will therefore be changed to have tau_i+1 >= 2 tau_i.
