...
const int   nfp_ffn[effnNR];   /*!< Number of parameters per function type */

const char *s_ffn[effnNR+2];   /*!< Short name of each function type */

const char *longs_ffn[effnNR]; /*!< Long name of each function type */
 ...
 */
real fit_acf(int ncorr, int eFitFn, const output_env_t oenv, gmx_bool bVerbose,
