 ...
 * \param[in] n number of data point in eatch function
 * \param[in] f array of first function to crosscorrelate
 * \param[in] g array of Second function to crosscorrelate
 * \param[out] corr array of the cross correlation
 */
