...
class AutocorrTest : public ::testing::Test
{
    protected:
        ...
        {
#ifdef GMX_DOUBLE
            checker.setDefaultTolerance(test::relativeToleranceAsFloatingPoint(1, 2000000000));
#else
            checker.setDefaultTolerance(test::relativeToleranceAsFloatingPoint(1, 1000000000));
#endif
        }
