...
class CorrelationDataSet
{
    ...
    public:
         ...
         */
        CorrelationDataSet(std::string fileName);
         ...
         */
        real getValue(int set, int t);

        /*! \brief
         * Return the nummber of columns
         */
        int getNrColumns() { return nrColumns_; }
         ...
         */
        real getStartTime() { return startTime_; }

        /*! \brief
         * Return the time the function ends at
         */
        real getEndTime() { return endTime_; }
