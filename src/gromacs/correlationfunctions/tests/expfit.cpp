...
class ExpfitTest : public ::testing::Test
{
    ...
    protected:
        ...
        {
#ifdef GMX_DOUBLE
            checker.setDefaultTolerance(test::relativeToleranceAsFloatingPoint(1, 0.005));
#else
            checker.setDefaultTolerance(test::relativeToleranceAsFloatingPoint(1, 0.01));
#endif
        }
        ...
        void test(int type, double result[])
        {
