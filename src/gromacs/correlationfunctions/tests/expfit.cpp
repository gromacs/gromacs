...
#ifdef GMX_DOUBLE
            checker.setDefaultTolerance(test::relativeRealTolerance(resultMax, 2000000000));
#else
            checker.setDefaultTolerance(test::relativeRealTolerance(resultMax, 1000000000));
#endif
