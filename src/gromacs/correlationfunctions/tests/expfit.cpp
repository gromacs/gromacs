...
class ExpfitTest : public ::testing::Test
{
    ...
    protected:
        ...
        void test(int type, double result[])
        {
            ...
            {
                gmx::test::FloatingPointTolerance paramTolerance =
                    gmx::test::relativeToleranceAsFloatingPoint(result[i],
                                                                tolerance);
                EXPECT_FLOAT_EQ_TOL(result[i],
                                    result[i],
                                    paramTolerance);
            }
        }
