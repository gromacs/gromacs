 ...
 *
 * \brief
 * Declares the HybridMCMDVelocities class.
 *
...
class HybridMCMDVelocities
{
    public:
        ...
        /*! \brief Draws initial velocities from a Maxwell-Boltzmann distribution
         *         for the short NVE simulation between two Metropolis steps.
         */
