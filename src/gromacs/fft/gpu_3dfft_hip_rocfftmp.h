...
#ifndef GMX_FFT_GPU_3DFFT_HIP_ROCFFTMP_H
#define GMX_FFT_GPU_3DFFT_HIP_ROCFFTMP_H
 ...
 */
class Gpu3dFft::ImplHipRocfftMp : public Gpu3dFft::Impl
{
public:
    //! \copydoc Gpu3dFft::Impl::Impl
    ImplHipRocfftMp(bool                 allocateRealGrid,
                    MPI_Comm             comm,
