...
/*! \internal \file
 *  \brief Declares the GPU 3D FFT routines for HIP via rocFFT.
 *
...
#ifndef GMX_FFT_GPU_3DFFT_HIP_ROCFFT_H
#define GMX_FFT_GPU_3DFFT_HIP_ROCFFT_H
...
public:
    ...
    ImplHipRocfft(bool                 allocateRealGrid,
                  MPI_Comm             comm,
