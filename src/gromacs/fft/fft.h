 ...
 *  FORWARD or BACKWARD, and for real-complex transforms you
 *  can only use REAL_TO_COMPLEX or OMPLEX_TO_REAL.
 */
enum class gmx_fft_direction
{
    FORWARD,         /**< Forward complex-to-complex transform  */
    BACKWARD,        /**< Backward complex-to-complex transform */
    REAL_TO_COMPLEX, /**< Real-to-complex valued FFT            */
    COMPLEX_TO_REAL  /**< Complex-to-real valued FFT            */
};
