...
//! Pulling algorithm.
enum {
    epullUMBRELLA, epullCONSTRAINT, epullCONST_F, epullFLATBOTTOM, epullFLATBOTTOMHIGH, epullNR
};
...
//! Drude integration methods
enum {
    edrudeSCF, edrudeLagrangian, edrudeNR
};
//! Macro to pick Drude integration method
#define EDRUDETYPE(e)  enum_name(e, edrudeNR, edrude_modes)
//! Names for integration methods
extern const char *edrude_modes[edrudeNR+1];
