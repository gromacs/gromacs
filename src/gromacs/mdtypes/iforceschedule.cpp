...
gmx::IForceSchedule::IForceSchedule() :
    ...
    top_(nullptr), groups_(nullptr), state_(nullptr), vir_force_(nullptr),
...
void gmx::DummySchedule::computeStep(int flags)
{
    ...
    std::cout << "do NS gridding \n";

    std::cout << "init GPU atom data and create local pair list \n";

    std::cout << "start computing local PP forces \n";

    std::cout << "launch PMR GPU FFT+Gather \n";

    std::cout << "create non local pairlist and launch compute \n";

    std::cout << "GPU to host copyback for short-range forces \n";

    std::cout << "compute bonded and special forces \n";

    std::cout << "Reduce PME outputs \n";

    std::cout << "calc virials \n";

    std::cout << "reduce and write forces \n";
}