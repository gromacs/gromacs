...
gmx::IForceSchedule::~IForceSchedule() = default;


void gmx::IForceSchedule::init(FILE* fplog, t_commrec* cr, const gmx_multisim_t* ms, t_inputrec* inputrec,
...
void gmx::DummySchedule::computeStep(int flags)
{
