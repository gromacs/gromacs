...
typedef struct correlation_blockdata_history_t
{
...
} correlation_blockdata_history_t;

//! Correlation matrix element
typedef struct correlation_history_t
{
...
} correlation_history_t;

/* The below structs do not contain any history dependence and are just for organizing the data in the structs above. */

//! Correlation matrix.
typedef struct correlation_matrix_history_t
{
    correlation_history_t *corr_hist;              /**< Array with the correlation elements corr(x, y) in the matrix, where x, y are vector components. */
} correlation_matrix_history_t;

//! Grid of local correlation matrices.
typedef struct correlation_grid_history_t
{
    ...
    correlation_matrix_history_t *corrmatrix_hist;    /**< Correlation matrices. */
} correlation_grid_history_t;

/*! \endcond */

/* \brief
 * Allocate a correlation grid history struct.
 *
