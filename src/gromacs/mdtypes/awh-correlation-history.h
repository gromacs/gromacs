...
struct correlation_blockdata_history_t
{
    ...
    double sum_w2_tot;                 /**< Sum weights^2 over all samples. */

    double sum_wbwx;                   /**< Sum over blocks of block weight times sum_wx. */
    double sum_wbwy;                   /**< Sum over blocks of block weight times sum_wy. */
    double sum_wb2;                    /**< Sum over blocks of block weight^2. */
    double wb2_max;                    /**< Maximum block weight^2. */
 ...
 * \param[in]     ncorrmatrix    Number of correlation matrices in the grid.
 * \param[in]     ncorr          Number of correlation elements in each matrix.
 * \param[in]     nblockdata     Number of block data averages.
 */
