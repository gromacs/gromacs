...
struct t_commrec {
     ...
     * This should be either read through thisRankHasDuty(),
     * or checked with assertDutyIsInitialized().
     */
    int                    duty;
...
/*! \brief
 * Asserts that commrec duty have been initialized.
 */
inline void assertDutyIsInitialized(const t_commrec *cr)
{
