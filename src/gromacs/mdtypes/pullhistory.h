...
class PullHistory
{
    public:
        ...
        std::vector<pull_coord_work_t> pullCoordinateSums;     //!< The container of the sums of the values of the pull coordinate.
        std::vector<pull_group_work_t> pullGroupSums;          //!< The container of the sums of the values of the pull group.
        std::vector<pull_group_work_t> pullDynaSums;           //!< The container of the sums of the values for dynamic groups for geom=cylinder.
