...
/*! \brief History information for NMR distance and orientation restraints
 *
...
/*! \brief Helper structure to be able to make essential dynamics / flooding group(s) whole
 *
...
/*! \brief History of an ion type used in position swapping
 *
 * \todo move out of this file to ObservablesHistory
 *
 */
