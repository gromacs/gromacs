...
class IInputRecExtension
{
    public:
        ...
        /*! \brief Extract information from mdp file
         *
         * \todo This seems to be electric field dependent, should be more general
         * \param[in] dim          Dimension
         * \param[in] staticField  Static electric field
         * \param[in] dynamicField Dynamic electric field
         * \param[in] wi           Warning data structure for grompp
         */
