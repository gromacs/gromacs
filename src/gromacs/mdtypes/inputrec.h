...
/* Abstract type for density fitting mdrun-data only defined in maputil.c     */
typedef struct gmx_densfit *gmx_densfit_t;

typedef struct densfitting
{
    ...
    gmx_densfit_t df;                 /* Stores non-inputrec density fitting data        */
} t_densfit;
