...
enum {
    eawhgrowthEXP_LINEAR, eawhgrowthLINEAR, eawhgrowthNONE, eawhgrowthNR
};
...
struct awh_dim_params_t {
    ...
    double userCoordUnitsToInternal;  /**< Conversion factor from user coordinate units to internal units. */
};
