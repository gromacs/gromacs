...
struct AwhBiasStateHistory
{
    ...
    /*! \brief Constructor. */
    AwhBiasStateHistory() : refCoordpoint(0),
...
{
    std::vector<AwhCoordPointHistory> coordPoint; /**< History for coordinate points */

    AwhBiasStateHistory               state;      /**< The global state of the AWH bias. */

    /*! \brief Constructor. */
    AwhBiasHistory() : coordPoint(),
                       state()
    {
    }
};
