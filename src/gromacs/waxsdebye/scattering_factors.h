...
class ScatteringFactor
{
    ...
    public:
        ...
        int const atomic_number() { return atomic_number_; }
...
class ScatteringFactorTable
{
    private:
        ...
        std::vector<ScatteringFactor*> cm_;
    public:
        /*! \brief
         * Constructor
        ...
        unsigned int size() { return cm_.size(); }

        /*! \brief
         * \param i index in table
         * \return the atomic number corresponding to index
         */
        int atomic_number(int i) { return cm_[i]->atomic_number(); }
         ...
         * \return scattering factor
         */
        double computeScatteringFactor(std::string element, double q);
