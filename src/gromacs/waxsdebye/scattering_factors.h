...
class ScatteringFactor
{
    ...
    public:
         ...
         */
        virtual double const computeScatteringFactor(double q) = 0;
         ...
         * \return scattering factor
         */
        virtual double const computeScatteringFactor(double theta, double lambda) = 0;
};
