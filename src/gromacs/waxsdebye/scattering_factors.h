...
class ScatteringFactor
{
    ...
    public:
         ...
         */
        virtual void loadScatteringFactor(char *xbuf[]) = 0;
...
class ScatteringFactorTable
{
    ...
    public:
         ...
         * \return scattering factor
         */
        double computeScatteringFactor(const char *residue,
                                       const char *atom,
                                       double      q) const
        {
            std::string a(atom);
            std::string r(residue);
            return computeScatteringFactor(r, a, q);
        }
