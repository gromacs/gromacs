...
/*! \libinternal \file
 * \brief
 * Declares utilities for reading scattering factors
 *
 ...
 */
#ifndef GMX_WAXSDEBYE_SCATTERING_FACTORS_H
#define GMX_WAXSDEBYE_SCATTERING_FACTORS_H
...
typedef gmx_unique_ptr<gmx::ScatteringFactor>::type ScatteringFactorPointer;
...
/*! \internal
 * \brief
 * Store scattering factors for later retrieval.
 *
...
class ScatteringFactorTable
{
    ...
    public:
        ...
        /*! \brief Return the scattering type.
