...
class ScatteringFactor
{
    ...
    public:
        ...
        const int atomic_number() const { return atomic_number_; }
...
class ScatteringFactorTable
{
    ...
    public:
        ...
        const unsigned int size() const { return cm_.size(); }

        /*! \brief
         * \param i index in table
         * \return the atomic number corresponding to index
         */
        const int atomic_number(int i) const { return cm_[i]->atomic_number(); }
        ...
        const int max_atomic_number() const;
};
}
