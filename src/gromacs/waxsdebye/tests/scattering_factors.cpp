...
class ScatteringFactorsTest : public ::testing::Test
{
    protected:
        ...
        //! Test variables
        ScatteringFactorTable                       testTable_;
        double                                      qValues[10];
            ...
            : checker_(refData_.rootChecker())
        {
            ...
            testTable_ = ScatteringFactorTable();
        ...
        { 
            ...
            /*std::vector<ScatteringFactorPointer>::iterator sftItr = testTable_.beginSFP();
            for(; sftItr != testTable_.endSFP(); sftItr++)
            {
                for(unsigned int i = 0; i < 10; i++)
                {
                    double computeWithResidueAtom = testTable_.computeScatteringFactor((*sftItr)->residue(), (*sftItr)->atom(), qValues[i]);
                    checker_.checkReal(computeWithResidueAtom, "ScatteringFactor");
                }
            }*/
