                               ...
                               const t_inputrec *ir)
{
    ...
    fprintf(stderr, "kWaxs_ = %f\n", kWaxs_);
    fprintf(stderr, "alpha_mode_ = %d\n", alpha_mode_);
    fprintf(stderr, "alpha_min_ = %f\n", alpha_min_);
    fprintf(stderr, "alpha_max_ = %f\n", alpha_max_);
    fprintf(stderr, "nstout_ = %d\n", nstout_);
    fprintf(stderr, "nstcalc_ = %d\n", nstcalc_);
