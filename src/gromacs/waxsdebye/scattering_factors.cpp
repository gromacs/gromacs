...
class CromerMannSfactor : public ScatteringFactor
{
    ...
    public:
         ...
         */
        virtual double const computeScatteringFactor(double q);
         ...
         * \return scattering factor
         */
        virtual double const computeScatteringFactor(double theta, double lambda);
};
...
double const CromerMannSfactor::computeScatteringFactor(double theta, double lambda)
{
    double q;
...
double const CromerMannSfactor::computeScatteringFactor(double q)
{
    int    i;
    double cm = c_;
    double q4 = q/(4*M_PI);
...
double const FourierSfactor::computeScatteringFactor(double theta, double lambda)
{
    double q;
...
double const FourierSfactor::computeScatteringFactor(double q)
{
    unsigned int i;
    double       s = a0_;
