...
/*! \libinternal \file
 * \brief
 * Declares class for handling WaxsDebye forces.
 *
...
class WaxsDebyeForce
{
    private:
        ...
        //! Pointers to gmx::TextInputFile variables for writing output.
        //! Closed in destructor if open.
        boost::scoped_ptr<TextOutputFile> fp_out_, fp_alpha_;
