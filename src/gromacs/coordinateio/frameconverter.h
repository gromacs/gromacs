...
class IFrameConverter
{
    public:
         ...
         *
         * \param[in]  input  Coordinate frame to be modified.
         * \returns           New t_trxframe object with modified coordinates.
         */
        virtual t_trxframe convertFrame(const t_trxframe &input) = 0;
};
/*! \brief
