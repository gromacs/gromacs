 ...
 * teajectory files written from provided trajectory data. It performs the actual
...
class OutputManager : public IModuleCallback
{
    ...
    private:
         ...
         * A better approach will be to pass a copy of the selection to the it and expect it to
