...
class SetAtoms : public IOutputAdapter
{
    public:
            ...
            atomsNeededByOutput_(false)
        {
            ...
            if (atomFlag_ == ChangeSettingType::efUserNo)
            {
        ...
        SetAtoms(SetAtoms &&old) noexcept :
            ...
            haveLocalAtoms_(old.haveLocalAtoms_),
            atoms_(old.atoms_),
            atomsNeededByOutput_(old.atomsNeededByOutput_)
        {
        }
        ...
        //! Return local id.
        unsigned long getModuleIDFlag() override { return efChangeAtomInformationModule; }
        //! Return requirements that have been determined.
        unsigned long getModuleRequirementFlag() override { return moduleRequirements_; }
        //! Change requirements because we have extra settings.
        void setExtraRequirements() override { atomsNeededByOutput_ = true; }
    ...
    private:
        ...
        //! External setting for always requesting atom output to file.
        bool              atomsNeededByOutput_;
};
