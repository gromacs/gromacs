...
class OutputSelector : public IOutputAdapter
{
    public:
        ...
        //! Return local id.
        unsigned long getModuleIDFlag() override { return efChangeCoordinateSelectionModule; }
        //! Return requirements.
        unsigned long getModuleRequirementFlag() override { return efBaseOutputManager; }
        //! No special action for extra requirements.
        void setExtraRequirements() override {}
