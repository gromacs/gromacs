...
class SetVelocities : public IOutputAdapter
{
    public:
        ...
        {
            if (velocity_ == ChangeSettingType::efUserNo)
            {
        ...
        //! Return local id.
        unsigned long getModuleIDFlag() override { return efChangeVelocityModule; }
        //! Return local requirements that have been determined.
