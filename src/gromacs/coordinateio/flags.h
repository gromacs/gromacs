...
/*! \file
 * \brief
 * Declares gmx::CoordinateFileWriteFlags.
 *
...
/*!\brief
 * CoordinateFileWriteFlags class as a wrapper around several possible
 * modules derived from the ICoordinateData interface.
 *
 * The CoordinateFileWriteFlags class is a wrapper around the individual calls
 ...
 *
 */
class CoordinateFileWriteFlags
{
    public:
        /*! \brief
         * Default constructor for CoordinateFileWriteFlags.
         */
        CoordinateFileWriteFlags() {}

        virtual ~CoordinateFileWriteFlags() {}
        /*! \brief
         ...
         */
        void registerModules(const OutputManagerPointer &output);
