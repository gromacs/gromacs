...
/*! \file
 * \brief
 * Declares helper functions to translate user input into
 * OutputManager requirements.
 *
...
/*!\brief
 * Populate requirements struct from option interface.
 *
 * \param[in] options Pointer to global options framework.
 * \param[in] requirements Pointer to requirements to populate.
 */
void
 ...
 *
 * \param[in] reqs Pointer to requirements to check.
 */
void checkRequirementsOptions(OutputRequirements *reqs);
