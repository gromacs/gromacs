...
class OutputSelector : public ICoordinateOutput
{
    public:
        ...
        {
            GMX_ASSERT(sel.isValid() && sel.hasOnlyAtoms(),
        ...
        ~OutputSelector() override override {}
         ...
         */
        void processFrame(int /*framenumber*/, t_trxframe *input) override override;

        //! Return local requirements.
        unsigned long getModuleFlag() override override { return moduleRequirements_; }
