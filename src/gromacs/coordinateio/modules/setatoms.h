...
class SetAtoms : public ICoordinateOutput
{
    ...
    private:
        ...
        bool haveLocalAtoms() const
        {
            return haveLocalAtoms_;
        }
        /*! \brief
        ...
        {
            return haveLocalAtoms() || haveFrameAtoms(input);
        }
        //! Return pointer to t_atoms.
        t_atoms *atoms()
        {
            GMX_ASSERT(haveLocalAtoms(), "No atoms information available");
            return &atoms_;
        }
        ...
        bool              haveLocalAtoms_;
        /*! \brief
         *  Atoms information if available.
         *
         *  Note, it is expected that atom information lives longer than the
         *  frameadapter module.
         */
        t_atoms           atoms_;
        //! Local requirements
