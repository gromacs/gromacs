 ...
 */
#ifndef GMX_COORDINATIO_CONVERTERS_REGISTER_H
#define GMX_COORDINATIO_CONVERTERS_REGISTER_H
...
class ProcessFrameConversion : public IFrameConverter
{
    public:
         ...
         *
         * \param[in]  input  Coordinate frame to be modified n process chain.
         * \return            Final t_trxframe object from analysis chain.
         */
