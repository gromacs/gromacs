...
TEST(OutputManagerTest, CanAddMultipleModules)
{
    ...
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(ICoordinateOutput::efAtomOutput));
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(ICoordinateOutput::efVelocityOutput));
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(ICoordinateOutput::efForceOutput));
    EXPECT_NO_THROW(output = createMinimalOutputManager(filename,
                                                        &dummyTopology,
                                                        std::move(adapters)));
...
TEST(OutputManagerTest, CannotHideMismatchedModule)
{
    ...
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(ICoordinateOutput::efForceOutput));
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(ICoordinateOutput::efVelocityOutput));
    EXPECT_ANY_THROW(output = createMinimalOutputManager(filename,
                                                         &dummyTopology,
                                                         std::move(adapters)));
