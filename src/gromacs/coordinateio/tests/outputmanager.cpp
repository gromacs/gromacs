                                          ...
                                          unsigned long dummyModuleFlag)
{
    ...
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(dummyModuleFlag));
...
{
    unsigned long outputManagerflag = efDummyModule;
    unsigned long moduleFlag        = efDummyModule;
...
{
    unsigned long outputManagerFlag = efBaseOutputManager;
    unsigned long moduleFlag        = efChangeAtomInformationModule;
    outputManagerFlag |= (efChangeForceModule | efChangeVelocityModule);
...
TEST(OutputManagerTest, CanAddMultipleModules)
{
    ...
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(efChangeAtomInformationModule));
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(efChangeVelocityModule));
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(efChangeForceModule));
    EXPECT_NO_THROW(output = createMinimalOutputManager(filename,
                                                        &dummyTopology,
                                                        std::move(adapters)));
...
TEST(OutputManagerTest, CannotViolateModuleOrder)
{
    ...
    CoordinateOutputAdapters adapters;
    std::string              filename = "test.tng";
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(efChangeCoordinateSelectionModule));
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(efChangeVelocityModule));
    adapters.emplace_back(compat::make_unique<DummyOutputModule>(efChangeAtomInformationModule));
    EXPECT_THROW(output = createMinimalOutputManager(filename,
                                                     &dummyTopology,
