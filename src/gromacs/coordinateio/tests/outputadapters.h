...
class SetAtomsSupportedFiles : public ModuleTest
{
    public:
        void prepareTest(const char *filename)
        {
            ...
            requirements.atoms = ChangeAtomsType::efUserYes;
                                ...
                                public ModuleSelection
{
    public:
        void prepareTest(const char *filename)
        {
            ...
            requirements.box       = ChangeFrameInfoType::efUserYes;
            requirements.frameTime = ChangeFrameTimeType::efBothTime;
                                ...
                                public ModuleSelection
{
    public:
        void prepareTest()
        {
            ...
            OutputAdapterContainer adapters(efBaseOutputManager);
            //! Local atoms
            Selection              sel;
