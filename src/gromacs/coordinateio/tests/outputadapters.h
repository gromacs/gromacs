...
class SetAtomsSupportedFiles : public ModuleTest
{
    public:
        void prepareTest(const char *filename)
        {
            ...
            adapters.emplace_back(compat::make_unique<SetAtoms>(ChangeSettingType::efUserYes, atoms));
...
class SetAtomsUnSupportedFiles : public ModuleTest
{
    public:
        void prepareTest(const char *filename)
        {
            ...
            EXPECT_THROW(runTest(filename, std::move(adapters)), InconsistentInputError);
        }
};
...
class SetVelocitySupportedFiles : public ModuleTest
{
    public:
        void prepareTest(const char *filename)
        {
            ...
            adapters.emplace_back(compat::make_unique<SetVelocities>(ChangeSettingType::efUserYes));
...
class SetForceSupportedFiles : public ModuleTest
{
    public:
        void prepareTest(const char *filename)
        {
            ...
            adapters.emplace_back(compat::make_unique<SetForces>(ChangeSettingType::efUserYes));
