 ...
 * are feasible to be added to the output for a given filetype or not.
 *
...
/*!\brief
 * IModuleCallback interface for checking that requested module registration
 * in output manager is valid.
 *
 ...
 * are fulfilled. Classes and interfaces derived from this interface can check their
...
class IModuleCallback
{
    public:
        ...
        bool checkModuleFlag(unsigned long outputFlags) { return (moduleFlags_ & outputFlags) != 0u; }
    ...
    protected:
        ...
        GMX_DISALLOW_COPY_AND_ASSIGN(IModuleCallback);
};
