                      ...
                      int * gmx_restrict        numDistanceChecks)
{
    ...
    {
        real d2  = subc_bb_dist2(0, bb_ci, jclusterFirst, jGrid.boundingBoxes());
        *numDistanceChecks += 2;
    ...
    {
        real d2  = subc_bb_dist2(0, bb_ci, jclusterLast, jGrid.boundingBoxes());
        *numDistanceChecks += 2;
    ...
    for (int subc = 0; subc < jGrid.numClustersPerCell()[scj]; subc++)
    {
        ...
        *numDistanceChecks += c_nbnxnGpuClusterSize*2;
        ...
        for (int ci = 0; ci < c_gpuNumClusterPerCell; ci++)
        {
            ...
            d2l[ci]             = subc_bb_dist2(ci, bb_ci, cj, jGrid.boundingBoxes());
            *numDistanceChecks += 2;
#endif
            float d2 = d2l[ci];
...
static inline void set_icell_bb(const Grid &iGrid,
                                ...
                                NbnxnPairlistCpuWork *work)
{
    set_icell_bb_simple(iGrid.boundingBoxes(), ci, shx, shy, shz,
...
#else
    set_icell_bb_supersub(iGrid.boundingBoxes(), ci, shx, shy, shz,
