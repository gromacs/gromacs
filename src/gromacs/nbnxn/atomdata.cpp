...
void nbnxn_atomdata_copy_x_to_nbat_x(const nbnxn_search       *nbs,
                                     const Nbnxn::AtomLocality locality,
                                     gmx_bool                  FillLocal,
                                     rvec                     *x,
                                     nbnxn_atomdata_t         *nbat,
                                     gmx_wallcycle            *wcycle)
{
    ...
    switch (locality)
    {
        case Nbnxn::AtomLocality::All:
        case Nbnxn::AtomLocality::Count:
            g0 = 0;
            g1 = nbs->grid.size();
            break;
        case Nbnxn::AtomLocality::Local:
            g0 = 0;
            g1 = 1;
            break;
        case Nbnxn::AtomLocality::NonLocal:
            g0 = 1;
            g1 = nbs->grid.size();
            break;
    }
                                    ...
                                    gmx_wallcycle            *wcycle)
{
    ...
    if (nbat->out.size() > 1)
    {
        if (locality != Nbnxn::AtomLocality::All)
        {
