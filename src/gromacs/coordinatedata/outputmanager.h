...
class OutputManager
{
    public:
        ...
        /*! \brief
         * Returns the filetype as integer for other modules.
         *
         * After setting the file type, other modules can use it to perform the checks necessary
         * to see if information to write the file is available.
         */
