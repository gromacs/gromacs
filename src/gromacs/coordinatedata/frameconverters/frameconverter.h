...
class IFrameConverter
{
    public:
         ...
         * framework.
         */
        IFrameConverter() : fwflags_(0), coordinateFrame_(t_trxframe())
        {
        ...
        explicit IFrameConverter(IFrameConverter &&old) noexcept
            : fwflags_(old.fwflags_),
              coordinateFrame_(old.coordinateFrame_)
        {
        }
