 ...
 */
#ifndef GMX_TRAJECTORYANALYSIS_MODULES_REMOVEJUMP_H
#define GMX_TRAJECTORYANALYSIS_MODULES_REMOVEJUMP_H
...
class RemoveJump : public IFrameConverter
{
    public:
        /*! \brief
         * Default constructor for RemoveJump should not be used.
         *
         ...
         * Copy constructor.
         */
        RemoveJump(const RemoveJump &old) = delete;
        /*! \brief
         * Assignment operator.
         */
        RemoveJump &operator=(const RemoveJump &old) = delete;
        /*! \brief
         * Move constructor for RemoveJump.
         */
        RemoveJump &operator=(RemoveJump &&old)
        {
            referenceCoord_ = std::move(old.referenceCoord_);
         ...
         *  Move constructor for RemoveJump.
         */
        RemoveJump(RemoveJump &&old) : referenceCoord_(std::move(old.referenceCoord_))
        {
            copy_mat(old.localBox_, localBox_);
        }
