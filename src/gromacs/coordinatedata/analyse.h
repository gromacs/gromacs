...
/*!\brief
 * AnalyseCoordinateFrame class for handling the running of several analysis steps
 *
 * This analysis module allows to register modules for coordinate frame manipulation
 * that are then run ones this modules modifyFrame method is invoked.
 *
 * \inpublicapi
 * \ingroup module_coordinatedata
 *
 */
class AnalyseCoordinateFrame : public IFrameManager
{
    public:
        /*! \brief
         * Default constructor for AnalyseCoordinateFrame.
         */
        AnalyseCoordinateFrame() {}

        virtual ~AnalyseCoordinateFrame() {}
        /*! \brief
         ...
         *
         * Other modules derived from IFrameManager can be registered to be analysed
         ...
         */
        void addFrameModule(FrameManagerPointer module);
        ...
        struct FrameModule
        {
            ...
            explicit FrameModule(FrameManagerPointer module)
                : module(module)
            {
            }
            //! Pointer to module.
            FrameManagerPointer module;
        };
...
typedef std::unique_ptr<AnalyseCoordinateFrame>
    AnalyseCoordinateFramePointer;
