 ...
 * \param[out] intialReferenceProjection The projection onto eigenvectors as read from file.
 * \param[out] refprojslope The slope of the reference projections.
 */
bool readEdVecWithReferenceProjection(FILE *in, int nrAtoms, t_eigvec *tvec, real * intialReferenceProjection, real * refprojslope)
{
