 ...
 * \param[in] t_edpar The essential dyanmics parameters
...
// Duplicating the anonymous namespace at this point to keep the file structure
// where flooding related routines are collected at the end
