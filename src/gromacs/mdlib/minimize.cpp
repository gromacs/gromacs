...
/*! \internal \brief Do conjugate gradients minimization
...
/*! \internal \brief Do L-BFGS conjugate gradients minimization
    \copydoc gmx_integrator_t (FILE *fplog, t_commrec *cr,
                                 int nfile, const t_filenm fnm[],
                                 const output_env_t oenv, gmx_bool bVerbose,
                                 gmx_bool bCompact, int nstglobalcomm,
...
/*! \internal \brief Do steepest descents minimization
    \copydoc gmx_integrator_t (FILE *fplog, t_commrec *cr,
                                 int nfile, const t_filenm fnm[],
                                 const output_env_t oenv, gmx_bool bVerbose,
                                 gmx_bool bCompact, int nstglobalcomm,
...
/*! \internal \brief Do normal modes analysis
    \copydoc gmx_integrator_t (FILE *fplog, t_commrec *cr,
                                 int nfile, const t_filenm fnm[],
                                 const output_env_t oenv, gmx_bool bVerbose,
                                 gmx_bool bCompact, int nstglobalcomm,
