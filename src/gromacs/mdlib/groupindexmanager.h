...
{
    public:
        /*! \brief Typedef to abstract from the implementation of the handle to the managed objects.
         */
         ...
         *
         * \param[in] number_of_atoms The number of atoms in the group index
         * \param[in] index The indices of the atoms in the group index
         */
