 ...
 * useSimdPairListWhenSupported tells to take into account SIMD, when supported.
 * useGpuPairList tells to estimate for GPU kernels (useSimdPairListWhenSupported is ignored with useGpuPairList==true)
 */
