...
SettleCuda::SettleCuda(gmx_unused const int         nAtom,
 ...
 */
void SettleCuda::copyCoordinatesToGpu(gmx_unused const rvec *x, gmx_unused const rvec *xp)
{
    GMX_ASSERT(false, "A CPU stub for SETTLE was called insted of the correct implementation.");
}
 ...
 */
void SettleCuda::copyVelocitiesToGpu(gmx_unused const rvec *v)
{
    GMX_ASSERT(false, "A CPU stub for SETTLE was called insted of the correct implementation.");
}
 ...
 */
void SettleCuda::copyCoordinatesFromGpu(gmx_unused rvec *xp)
{
    GMX_ASSERT(false, "A CPU stub for SETTLE was called insted of the correct implementation.");
}
 ...
 *
 */
void SettleCuda::copyVelocitiesFromGpu(gmx_unused rvec *v)
{
    GMX_ASSERT(false, "A CPU stub for SETTLE was called insted of the correct implementation.");
}
 ...
 */
void SettleCuda::setXVPointers(gmx_unused rvec *xDevice, gmx_unused rvec *xpDevice, gmx_unused rvec *vDevice)
{
    GMX_ASSERT(false, "A CPU stub for SETTLE was called insted of the correct implementation.");
}
