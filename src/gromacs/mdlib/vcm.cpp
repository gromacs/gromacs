...
#pragma omp parallel num_threads(nth)
        {
                ...
                (vcm.mode == ecmLINEAR_ACCELERATION_CORRECTION && x == nullptr))
            {
                ...
                if (mdatoms.cFREEZE == nullptr)
                {
                    ...
                    {
                        case 1:
                            doStopComMotionLinear<1, false>(mdatoms, v, vcm);
                            break;
                        case 2:
                            doStopComMotionLinear<2, false>(mdatoms, v, vcm);
                            break;
                        case 3:
                            doStopComMotionLinear<3, false>(mdatoms, v, vcm);
                            break;
                    }
                }
                else
                {
                    ...
                    {
                        case 1:
                            doStopComMotionLinear<1, true>(mdatoms, v, vcm);
                            break;
                        case 2:
                            doStopComMotionLinear<2, true>(mdatoms, v, vcm);
                            break;
                        case 3:
                            doStopComMotionLinear<3, true>(mdatoms, v, vcm);
                            break;
                    }
                }
            }
