...
class LincsCuda::Impl
{
    ...
    private:
        ...
        real               *invmassDevice_;                  //!< 1/mass for all atoms (GPU)
        ...
        std::vector<float>  constraintsR0Host_;              //!< Equilibrium distances for the constraints (CPU)
        float              *constraintsR0Device_;            //!< Equilibrium distances for the constraints (GPU)
