...
class LincsCuda::Impl
{
    ...
    private:
        ...
        real               *inverseMassesDevice_;            //!< 1/mass for all atoms (GPU)

        real               *virialScaledHost_;               //!< Scaled virial tensor (9 reals, GPU)
        real               *virialScaledDevice_;             //!< Scaled virial tensor (9 reals, GPU)
