...
enum class ConstraintCoord : int
{
    ...
    Veloc,             /* Constrain velocities (mass weighted)            */
    Deriv,             /* Constrain a derivative (mass weighted),         *
                        * for instance velocity or acceleration,          *
                        * constraint virial can not be calculated.        */
    Deriv_FlexCon,     /* As Deriv, but only output flex. con.       */
...
class Constraints
{
    public:
         ...
         *
         * When econq=ConstraintCoord::Positions constrains coordinates xprime using th
         * directions in x, min_proj is not used.
         *
         * When econq=ConstraintCoord::Deriv, calculates the components xprime in
         ...
         *
         * When econq=ConstraintCoord::Deriv_FlexCon, the same is done as with ConstraintCoord::Deriv,
