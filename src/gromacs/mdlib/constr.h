...
/*! \brief Returns the flexible constraint treatment based whether the integrator is dynamic */
 ...
 * \param[out] numFlexibleConstraints       Will contain the number of flexible constraints present, when not nulll
