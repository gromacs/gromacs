        ...
        case ljcrLB:
            for (int i = 0; i < nt; i++)
            {
                ...
                if (c6 > 0 && c12 > 0)
                {
                     ...
                     */
                    nbat->nbfp_comb[i*2  ] = 0.5*std::pow(c12/c6, (real)1.0/6.0);
                         ...
                         nbnxn_free_t  *free)
{
    ...
    for (int i = 0; i < ntype; i++)
    {
        ...
        if (c6 > 0 && c12 > 0)
        {
            nbat->nbfp_comb[i*2  ] = std::pow(c12/c6, (real)1.0/6.0);
            ...
            if (i < ntype && j < ntype)
            {
                ...
                bCombLB = bCombLB &&
                    ((c6 == 0 && c12 == 0 &&
                     ...
                     (c6 > 0 && c12 > 0 &&
                      gmx_within_tol(std::pow(c12/c6, (real)1.0/6.0), 0.5*(nbat->nbfp_comb[i*2]+nbat->nbfp_comb[j*2]), tol) &&
