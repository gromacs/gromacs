                                     ...
                                     nbnxn_atomdata_t    *nbat)
{
    ...
    STS::getInstance("default")->parallel_for("nbat_x_to_x", 0, nth, [&](int th)
    {
        try
        {
            for (int g = g0; g < g1; g++)
...
static void nbnxn_atomdata_nbat_f_stdreduce(const nbnxn_atomdata_t *nbat,
                                                     int                     nth)
{
    STS::getInstance("force")->parallel_for("stdreduce", 0, nth, [&](int th)
    {
        try
        {
                                  ...
                                  const nbnxn_atomdata_t *nbat)
{
    ...
    if (nbat->nout > 1)
    {
        ...
        {
            nbnxn_atomdata_nbat_f_stdreduce(nbat, nth);
        }
    }
