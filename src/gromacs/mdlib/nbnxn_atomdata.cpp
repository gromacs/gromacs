...
{
    GMX_ASSERT(nbat->nalloc >= nbat->natoms, "We should have at least as many elements allocated as there are set");
                         ...
                         nbnxn_free_t  *free)
{
    ...
    if (zeta_matrix)
    {
        nbat->alloc(reinterpret_cast<void **>(&nbat->zeta_matrix),
