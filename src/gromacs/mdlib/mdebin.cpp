...
void print_ebin(ener_file_t fp_ene, gmx_bool bEne, gmx_bool bDR, gmx_bool bOR,
                ...
                gmx_groups_t *groups, t_grpopts *opts, const awh_t *awh)
{
    ...
    switch (mode)
    {
        case eprNORMAL:
            ...
            /* Check whether we are going to write anything out.
             * We don't have AWH in this check to avoid another conditional.
             * grompp checks if AWH output interval is a multiple of nstenergy.
             *
             * TODO: Implement a mechanism that avoids a check at each MD step
             *       for each module that might output to the energy file.
             */
