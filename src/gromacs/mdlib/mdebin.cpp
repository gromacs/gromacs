...
void print_ebin(ener_file_t fp_ene, gmx_bool bEne, gmx_bool bDR, gmx_bool bOR,
                ...
                gmx_groups_t *groups, t_grpopts *opts, const t_awhbias *awhbias)
{
    ...
    switch (mode)
    {
        case eprNORMAL:
            ...
            if (fr.nre || ndisre || nr[enxOR] || nr[enxORI])
            {
                ...
                /* AWH bias blocks. */
                if (awhbias != NULL)  // TODO: add boolean in t_mdebin. See in mdebin.h.
                {
                    write_awhbias_to_energyframe(&fr, awhbias);
                }
