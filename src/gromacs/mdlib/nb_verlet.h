 ...
 *
 * TODO: move the nonbonded module in a subdir to be able to define a module.
 *
 * \brief Computes forces and energies for short-range pair-interactions
 * based on the Verlet algorithm. The algorithms uses pair-list generated
 * at fixes intervals as well as various flavors of pair interaction kernels
 ...
 * (see DOI:10.1016/j.cpc.2013.06.003).
 *
...
/*!
 *
 * \brief This file contains the public interface of the non-bonded Verlet algorithm
 * NxN cluster implementation.
 *
 *
 * \author Berk Hess <hess@kth.se>
 * \author Szilárd Páll <pall.szilard@gmail.com>
