...
void *nbnxn_gpu_command_stream(gmx_nbnxn_gpu_t gmx_unused *nb,
                               int gmx_unused              iloc) GPU_FUNC_TERM_WITH_RETURN(nullptr)

/** Returns an opaque pointer to the GPU coordinate+charge array */
GPU_FUNC_QUALIFIER
void *nbnxn_gpu_get_xq(gmx_nbnxn_gpu_t gmx_unused *nb) GPU_FUNC_TERM_WITH_RETURN(nullptr)

/** Returns an opaque pointer to the GPU force array */
GPU_FUNC_QUALIFIER
void *nbnxn_gpu_get_f(gmx_nbnxn_gpu_t gmx_unused *nb) GPU_FUNC_TERM_WITH_RETURN(nullptr)

/** Returns an opaque pointer to the GPU shift force array */
GPU_FUNC_QUALIFIER
void *nbnxn_gpu_get_fshift(gmx_nbnxn_gpu_t gmx_unused *nb) GPU_FUNC_TERM_WITH_RETURN(nullptr)
