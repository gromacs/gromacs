...
static gmx_inline gmx::SimdReal gmx_load_hpr_hilo_pr(const real *a)
{
    gmx_mm_hpr       a_S;
    gmx::SimdReal    a_a_S;
...
static gmx_inline gmx::SimdReal gmx_set_2real_shift_pr(const real *a, real shift)
{
    gmx_mm_hpr       a0_S, a1_S;
    gmx::SimdReal    a0_a1_S;
    ...
    while (!InRange && cjf <= cjl)
    {
        ...
        *ndistc += 2;
        ...
        else if (d2 < rl2)
        {
            ...
            wco_any_S        = gmx::simdOrB(wco_S0, wco_S2);
