                      ...
                      nbnxn_list_work_t *work)
{
    ...
    x_ci->ix_S0 = load1DualHsimd(x + ia + 0*STRIDE_S + 0) + SimdReal(shx);
    x_ci->iy_S0 = load1DualHsimd(x + ia + 1*STRIDE_S + 0) + SimdReal(shy);
    x_ci->iz_S0 = load1DualHsimd(x + ia + 2*STRIDE_S + 0) + SimdReal(shz);
    x_ci->ix_S2 = load1DualHsimd(x + ia + 0*STRIDE_S + 2) + SimdReal(shx);
    x_ci->iy_S2 = load1DualHsimd(x + ia + 1*STRIDE_S + 2) + SimdReal(shy);
    x_ci->iz_S2 = load1DualHsimd(x + ia + 2*STRIDE_S + 2) + SimdReal(shz);
}
