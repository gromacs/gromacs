...
#define GMX_NBNXN_PRUNE_KERNEL_J4_CONCURRENCY_INTEL     4

#if defined _AMD_SOURCE_
#define GMX_NBNXN_PRUNE_KERNEL_J4_CONCURRENCY GMX_NBNXN_PRUNE_KERNEL_J4_CONCURRENCY_AMD
#elif defined _NVIDIA_SOURCE_
#define GMX_NBNXN_PRUNE_KERNEL_J4_CONCURRENCY GMX_NBNXN_PRUNE_KERNEL_J4_CONCURRENCY_NVIDIA
#elif defined _INTEL_SOURCE_
#define GMX_NBNXN_PRUNE_KERNEL_J4_CONCURRENCY GMX_NBNXN_PRUNE_KERNEL_J4_CONCURRENCY_INTEL
#endif
