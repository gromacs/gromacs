...
static unsigned int gpu_min_ci_balanced_factor = 50;
 ...
 /*! Docuemnted in nbnxn_ocl_internal.h */
bool useLjCombRule(cl_nbparam_t  *nbparam)
{
    return (nbparam->vdwtype == evdwOclCUTCOMBGEOM ||
            nbparam->vdwtype == evdwOclCUTCOMBLB);
}
