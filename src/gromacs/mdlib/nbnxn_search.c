                                        ...
                                        const nbnxn_grid_t *gridj)
{
     ...
     * This for converting a MxN list to a 1x1 list. This means we can't
     ...
     * most of the effective buffering of the MxN list, but not all.
     ...
     * so we overestimate.
     * With PME, the 10% value gives a buffer that is slightly larger
