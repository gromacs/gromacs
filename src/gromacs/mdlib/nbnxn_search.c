                                        ...
                                        const nbnxn_grid_t *gridj)
{
     ...
     * the small, effective buffering of the MxN lists. So we add 10%
     * of the smallest grid sub-cell dimensions. Note that the z-size
     * differs per cell and we don't use this, so we overestimate.
     * With PME, te 10% value gives a buffer which is slightly larger
