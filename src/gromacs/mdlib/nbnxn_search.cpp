...
static void setSuperClusterAtomCount(NbnxnPairlistCpu gmx_unused *nbl,
                                     int gmx_unused               numAtomsInSuperCluster)
{
}

static void setSuperClusterAtomCount(NbnxnPairlistGpu *nbl,
                                     int               numAtomsInSuperCluster)
{
    nbl->na_sc = numAtomsInSuperCluster;
}
                                     ...
                                     t_nblist *nbl_fep)
{
    ...
    if (gridj->bSimple != pairlistIsSimple(*nbl) ||
        gridi->bSimple != pairlistIsSimple(*nbl))
    {
        gmx_incons("Grid incompatible with pair-list");
    }

    sync_work(nbl);
    setSuperClusterAtomCount(nbl, gridj->na_sc);
    ...
    rbb2 = boundingbox_only_distance2(gridi, gridj, nbl->rlist, pairlistIsSimple(*nbl));
