                            ...
                            real atom_density)
{
    ...
    if (n > grid->na_sc)
    {
        ...
        if (grid->bSimple)
        {
            ...
            tlen   = std::pow(na_c/atom_density, (real)1.0/3.0);
            tlen_x = tlen;
            tlen_y = tlen;
        }
        else
        {
            ...
            tlen   = std::pow(grid->na_c/atom_density, (real)1.0/3.0);
...
real nbnxn_get_rlist_effective_inc(int cluster_size_j, real atom_density)
{
    ...
    return nbnxn_rlist_inc_outside_fac*std::pow(vol_inc_i + vol_inc_j, (real)1.0/3.0);
}
