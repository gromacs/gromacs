...
static constexpr int jClusterSize(std::integral_constant<NbnxnLayout, NbnxnLayout::Simd4xN>)
{
    return GMX_SIMD_REAL_WIDTH;
}

/* Returns the j-cluster size for the Simd4xN layout */
static constexpr int jClusterSize(std::integral_constant<NbnxnLayout, NbnxnLayout::Simd2xNN>)
{
