...
{
    static_assert(layout == NbnxnLayout::Simd4xN || layout == NbnxnLayout::Simd2xNN, "Currently jClusterSize only supports the SIMD layouts");

    return layout == NbnxnLayout::Simd4xN ? GMX_SIMD_REAL_WIDTH : GMX_SIMD_REAL_WIDTH/2;
}
