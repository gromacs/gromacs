...
typedef struct {
    ...
    bool               haveOuterAndInnerList; /* false: we have a single list up to rlistOuter in ci,nci; true: we have a list up to rlistOuter in ciOuter,nciOuter and a list up to rlistInner in ci,nci */
