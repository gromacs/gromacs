...
class UpdateGroupsCog
{
    public:
         ...
         *
         * Note that the processes coordinates starting after the last index
         * processed in the previcous call to \p addCogs(), unless \p clear()
         ...
         */
        void addCogs(gmx::ArrayRef<const int>        globalAtomIndices,
         ...
         *
         * \param[in] atomIndex  The atom index that maps to the COG
         */
        ...
        {
            return cogs_[cogIndex(atomIndex)];
        }
