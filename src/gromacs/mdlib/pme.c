...
#ifdef PME_SIMD
/* Calculate exponentials through SIMD */
inline static void calc_exponentials_lj(int start, int end, real *r_aligned, real *factor_aligned, real *d_aligned)
{
