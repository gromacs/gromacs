...
static void init_ewald_f_table(interaction_const_t *ic, double rtab)
{
     ...
     */
    double dx           = gmx::longRangeCorrectionTableSpacing(ic->eeltype,
                                                               ic->ewaldcoeff_q,
                                                               ic->rcoulomb,
                                                               ic->vdwtype,
                                                               ic->ewaldcoeff_lj,
    ...
    unsigned int ntable = gmx::longRangeCorrectionTableSize(rtab, dx);
    ...
    if (ic->eeltype == eelEWALD || EEL_PME(ic->eeltype))
    {
        ...
        const gmx::QuadraticSplineTable coulomb(ntable, dx, gmx::v_q_ewald_lr, &beta_coul);
    ...
    if (EVDW_PME(ic->vdwtype))
    {
        ...
        const gmx::QuadraticSplineTable vdw(ntable, dx, gmx::v_lj_ewald_lr, &beta_vdw);
