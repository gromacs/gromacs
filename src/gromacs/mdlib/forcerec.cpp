                               ...
                               real                    rtab)
{
     ...
     */
    ic->tabq_scale = interaction_tables->tabScale(ic->eeltype,
                                                  ic->ewaldcoeff_q,
                                                  ic->rcoulomb,
                                                  ic->vdwtype,
                                                  ic->ewaldcoeff_lj,
    ...
    if (ic->eeltype == eelEWALD || EEL_PME(ic->eeltype))
    {
        ...
        interaction_tables->fillEwaldSpline3(ic->tabq_size,
                                             ...
                                             gmx::etCoulomb,
                                             v_q_ewald_lr);
        ic->tabq_coul_F    = interaction_tables->coulombF();
        ic->tabq_coul_V    = interaction_tables->coulombV();
        ic->tabq_coul_FDV0 = interaction_tables->coulombFDV0();
    }
    ...
    if (EVDW_PME(ic->vdwtype))
    {
        ...
        interaction_tables->fillEwaldSpline3(ic->tabq_size,
                                             ...
                                             gmx::etLJ,
                                             v_lj_ewald_lr);
        ic->tabq_vdw_F    = interaction_tables->vdwF();
        ic->tabq_vdw_V    = interaction_tables->vdwV();
        ic->tabq_vdw_FDV0 = interaction_tables->vdwFDV0();
    }
}
