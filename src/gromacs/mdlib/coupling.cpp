                     ...
                     const t_commrec *cr, const t_mdatoms *md, t_state *state, real rate, const gmx_bool *randomize, const real *boltzfac)
{
    ...
    int                                        i;
    int                                        gc = 0;
    gmx::ThreeFry2x64<0>                       rng({static_cast<gmx_uint64_t>(ir->andersen_seed), gmx::RandomDomain_Thermostat});
...
static real vrescale_sumnoises(real                            nn,
                               ...
                               std::normal_distribution<real> &normalDist)
{
/*
 ...
 */
    ...
    real                           r;
    std::gamma_distribution<real>  gammaDist(0.5*nn, 1.0);
 ...
 */
    ...
    gmx::ThreeFry2x64<>            rng( { static_cast<gmx_uint64_t>(seed), gmx::RandomDomain_Thermostat } );
    std::normal_distribution<real> normalDist;
