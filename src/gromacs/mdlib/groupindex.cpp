...
/*! \file
 * \brief
 * Implements classes in GroupIndex.h
 *
...
/*! \internal \brief
 * Private implementation class for GroupIndex.
 */
class GroupIndex::Impl
{
    public:
        Impl();
...
GroupIndex::Impl::Impl(){};

/********************************************************************
 * GroupIndex
 */

void GroupIndex::init(const int number_of_atoms, const int *index, bool bParallel)
{
...
GroupIndex::GroupIndex() : impl_(PrivateImplPointer<Impl>(new Impl()))
{
}
...
void GroupIndex::bparallelSetLocalAndCollectiveIndices(const gmx_ga2la_t *ga2la)
{
...
const std::vector<int> &GroupIndex::globalIndex() const
{
    return impl_->global_index_;
}


const std::vector<int> &GroupIndex::localIndex() const
{
    return impl_->local_index_;
}

const std::vector<int> &GroupIndex::collectiveIndex() const
{
    return impl_->collective_index_;
}

int GroupIndex::numAtomsGlobal() const
{
    return impl_->global_index_.size();
}

int GroupIndex::numAtomsLocal() const
{
