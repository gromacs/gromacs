 ...
 */
/*! \libinternal \file
 * \brief Declares force calculation schedule object.
 *
 * \author Mark Abraham <mark.j.abraham@gmail.com>
 * \ingroup module_mdlib
 * \inlibraryapi
 */
#ifndef GMX_MDLIB_FORCECALCULATIONSCHEDULE_H
#define GMX_MDLIB_FORCECALCULATIONSCHEDULE_H

namespace gmx
{

/*! \libinternal
 * \brief Manage what force calculations are required each step
 *
 ...
 * thereafter.
 *
 * \todo Add more responsibilities, including whether GPUs are
 * in use, whether there is PME work, whether DD is active, whether
 * forces/virial/energy are required. */
