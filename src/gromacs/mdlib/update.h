...
template<typename T>
void scale_fprime(const t_mdatoms *md, const t_inputrec *inputrec, gmx_update_t *upd, const T scl);

template<typename T>
void scale_xprime(const t_mdatoms *md, const t_inputrec *inputrec, gmx_update_t *upd, const T scl);
