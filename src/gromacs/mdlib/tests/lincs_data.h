...
//! System of two connected atoms: starting type id for LINCS 
...
//! Three atoms, connected longitudaly: starting type id for LINCS
...
//! Basic triangle: starting type id for LINCS
...
//! CVW peptide: first type id used for LINCS when HBonds are constrained
...
//! CVW peptide: first type id used for lincs when all bonds are constrained
