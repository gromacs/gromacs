 ...
 * and checks that the MSD is not smaller than the maximum of the exact
 * value for rotational MSD beyond the location of the maximum.
 * Furthermore, we check that the MSD estimate never decreases, as this
 * is a requirement for the Verlet buffer size estimation.
 * Together these three checks ensure that we get a reasonable estimate.
 *
