 ...
 *
 * Declares the GPU-based function that applies SETTLE.
 *
 * \author Artem Zhmurov <zhmurov@gmail.com>
 * \ingroup module_mdlib
 */

#ifndef GMX_MDLIB_TESTS_SETTLE_IMPL_H
#define GMX_MDLIB_TESTS_SETTLE_IMPL_H
...
#endif // GMX_MDLIB_TESTS_SETTLE_IMPL_H
