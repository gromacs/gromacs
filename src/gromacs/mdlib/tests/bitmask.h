...
class BitmaskTest : public ::testing::TestWithParam<int>
{
};

TEST_P(BitmaskTest, SetAndClear)
{
    gmx_bitmask_t m;
    int           i = GetParam();
    bitmask_clear(&m);
...
TEST_P(BitmaskTest, InitLowBits)
{
    gmx_bitmask_t m;
    int           i = GetParam();
