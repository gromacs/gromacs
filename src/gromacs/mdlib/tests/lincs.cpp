...
class LincsTest : public ::testing::Test
{
    public:
        ...
        void testConstraints(const std::vector<RVec> *coordinates, FloatingPointTolerance tolerance,
                             ...
                             const std::vector<RVec> *finalCoordinates, FloatingPointTolerance finalCoordinatesTolerance)
        {
            ...
            t_fileio* log = gmx_fio_open("lincstest.log", "w");
 ...
 */
TEST_F(LincsTest, CysValTrpHBonds)
{
 ...
 */
TEST_F(LincsTest, CysValTrpAllBonds)
{
