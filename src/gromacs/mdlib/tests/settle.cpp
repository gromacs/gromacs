...
const real positions[] = { .130, -.041, -.291,
                .120, -.056, -.192,
                .044, -.005, -.327,
                -.854, -.406, .477,
                -.900, -.334, .425,
...
class SettleTest : public ::testing::TestWithParam<SettleTestParameters>
{
    public:
        ...
        //! Constructor
        SettleTest() :
            updatedPositions_(std::begin(positions), std::end(positions)),
            ...
            box_()
        {
            ...
            // Perturb thee atom positions, to appear like an
...
TEST_P(SettleTest, SatisfiesConstraints)
{
    ...
    csettle(settled, numThreads, threadIndex,
            ...
            std::begin(positions), updatedPositions_.data(), reciprocalTimeStep,
