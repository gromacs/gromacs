...
class DispersionCorrection
{
    public:
         ...
         * \param[in] atomtypes      The number of non-bonded atom types
        ...
        struct Correction
        {
            tensor pressureTensor; //!< Correction to the pressure tensor
            tensor virialTensor;   //!< Correction to the virial tensor
            real   pressure;       //!< Correction to the scalar pressure
            real   energy;         //!< Correction to the energy
            real   dvdl;           //!< Correction to dH/dlambda
        };
