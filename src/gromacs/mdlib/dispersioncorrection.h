...
class DispersionCorrection
{
    ...
    private:
        //! Parameters that depend on the topology only
        class TopologyParams
        {
            public:
                ...
                //! The number of atoms dispersion correction is applied to
                int                 numAtomsToCorrectFor_;
        ...
        //! Parameters that depend on the interaction functions and topology
