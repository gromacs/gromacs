                              ...
                              float*   __restrict__                gm_virialScaled)
{
    ...
    if (blockIdx.x*blockDim.x + threadIdx.x < numSettles)
    {
    ...
    : numAtoms_(numAtoms)
{
    ...
    allocateDeviceBuffer(&d_x_, numAtoms*DIM, nullptr);
    allocateDeviceBuffer(&d_xp_, numAtoms*DIM, nullptr);
    allocateDeviceBuffer(&d_v_, numAtoms*DIM, nullptr);
