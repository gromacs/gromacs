 ...
 * or an empty vector when the criteria are not satisfied
 *
 ...
 * a single atom which is not a virtual site and does have constraints;
 ...
 *
 * \param[in] mtop          The system topology
 * \param[in] updateGroups  List of update group, size should match the number of moltypes in \mtop or be 0
 */
