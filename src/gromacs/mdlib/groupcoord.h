...
*  \param[inout] nalloc_loc Local allocation size of anrs_loc array.
*  \param[opt]   coll_ind   If not NULL this array must be of size nr. It stores
 ...
 * \param[inout] shifts       Collective array of shifts for xcoll, needed to make
 ...
 *                            of this routine!
 * \param[buf]   extra_shifts Extra shifts since last time step, only needed as
 ...
 * \param[inout] xcoll_old    Positions from the last time step, used to make the
 *                            group whole.
 ...
 * 
 * \param[inout]  x          Array of positions.
