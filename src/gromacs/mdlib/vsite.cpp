                      ...
                      const matrix box)
{
    ...
    // TODO vsite can only be nullptr for EM with charge groups, so
    // once they are gone we can even strengthen the above assertion,
    // and probably remove a cppcheck suppression below.
