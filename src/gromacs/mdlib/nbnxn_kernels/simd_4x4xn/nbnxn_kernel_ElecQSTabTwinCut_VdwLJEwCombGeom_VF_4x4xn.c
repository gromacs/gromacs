 ...
 * GMX_NBNXN_SIMD_4X4XN, so that this file reduces to a stub
...
#include "gromacs/mdlib/nbnxn_kernels/simd_4x4xn/nbnxn_kernel_simd_4x4xn_common.h"
#endif /* GMX_NBNXN_SIMD_4X4XN */

#ifdef CALC_ENERGIES
void
nbnxn_kernel_ElecQSTabTwinCut_VdwLJEwCombGeom_VF_4x4xn(const nbnxn_pairlist_t    gmx_unused *nbl,
...
#endif /* CALC_ENERGIES */
#ifdef GMX_NBNXN_SIMD_4X4XN
#include "gromacs/mdlib/nbnxn_kernels/simd_4x4xn/nbnxn_kernel_simd_4x4xn_outer.h"
 ...
 * GMX_NBNXN_SIMD_4X4XN is not defined, it will call no kernel functions and
