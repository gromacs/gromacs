...
//pr4 usage could be replaced with pr12 usage.
                     ...
                     gmx_mm_ps *c6_S, gmx_mm_ps *c12_S)
{
    ...
    __m512 tmp1 = _mm512_i32gather_ps(idx, nbfp0, sizeof(float)*nbfp_stride); //ICC requires nbfp_stride here to be preprocessor constant (not a "const int")
