                         ...
                         SimdDouble in2, SimdDouble in3)
{
    ...
    return {
               _mm256_add_pd(_mm256_permute2f128_pd(in0.r, in2.r, 0x20), _mm256_permute2f128_pd(in0.r, in2.r, 0x31))
    };
}
...
{
    return {
               _mm256_castsi256_pd(_mm256_set1_epi32(e))
    };
}
...
gmx_checkbitmask_pb(gmx_exclfilter m0, gmx_exclfilter m1)
{
    ...
    return {
               _mm256_cmp_pd(_mm256_castps_pd(_mm256_cvtepi32_ps(_mm256_castpd_si256(_mm256_and_pd(m0.r, m1.r)))), _mm256_setzero_pd(), 0x0c)
    };
}
