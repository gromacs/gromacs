...

{
    ...
    rsq_S1      = simdAdd(rsq_S1, simdMaskNot(avoid_sing_S, interact_S1));
    rsq_S2      = simdAdd(rsq_S2, simdMaskNot(avoid_sing_S, interact_S2));
    rsq_S3      = simdAdd(rsq_S3, simdMaskNot(avoid_sing_S, interact_S3));
#endif
...
#define     rinv_ex_S3    rinv_S3
    ...
    rf_S1       = simdCvtI2R(ti_S1);
    rf_S2       = simdCvtI2R(ti_S2);
    rf_S3       = simdCvtI2R(ti_S3);
#endif
