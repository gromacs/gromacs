...

{
    ...
    gmx_mm_pr  rsw_S1, rsw2_S1, rsw2_r_S1;
#ifndef HALF_LJ
    gmx_mm_pr  rsw_S2, rsw2_S2, rsw2_r_S2;
    gmx_mm_pr  rsw_S3, rsw2_S3, rsw2_r_S3;
#endif
#endif
    ...
    gmx_mm_pr  rs_S1, rf_S1, frac_S1;
    gmx_mm_pr  rs_S2, rf_S2, frac_S2;
    gmx_mm_pr  rs_S3, rf_S3, frac_S3;
    ...
    gmx_mm_pr  FrLJ6_S1, FrLJ12_S1, frLJ_S1;
#ifndef HALF_LJ
    gmx_mm_pr  FrLJ6_S2, FrLJ12_S2, frLJ_S2;
    gmx_mm_pr  FrLJ6_S3, FrLJ12_S3, frLJ_S3;
#endif
...
#define     wco_vdw_S3    wco_S3
    ...
    r_S1        = gmx_mul_pr(rsq_S1, rinv_S1);
    rsw_S1      = gmx_max_pr(gmx_sub_pr(r_S1, rswitch_S), zero_S);
    rsw2_S1     = gmx_mul_pr(rsw_S1, rsw_S1);
    rsw2_r_S1   = gmx_mul_pr(rsw2_S1, r_S1);
#ifndef HALF_LJ
    r_S2        = gmx_mul_pr(rsq_S2, rinv_S2);
    ...
    r_S3        = gmx_mul_pr(rsq_S3, rinv_S3);
    rsw_S3      = gmx_max_pr(gmx_sub_pr(r_S3, rswitch_S), zero_S);
    rsw2_S3     = gmx_mul_pr(rsw_S3, rsw_S3);
    rsw2_r_S3   = gmx_mul_pr(rsw2_S3, r_S3);
#endif
#endif
...
#define add_fr_switch_pr(fr, rsw, rsw2_r, c2, c3) gmx_madd_pr(gmx_madd_pr(c3, rsw, c2), rsw2_r, fr)
    ...
    FrLJ6_S1    = gmx_mul_pr(c6_S1, add_fr_switch_pr(rinvsix_S1, rsw_S1, rsw2_r_S1, p6_fc2_S, p6_fc3_S));
#ifndef HALF_LJ
    FrLJ6_S2    = gmx_mul_pr(c6_S2, add_fr_switch_pr(rinvsix_S2, rsw_S2, rsw2_r_S2, p6_fc2_S, p6_fc3_S));
    FrLJ6_S3    = gmx_mul_pr(c6_S3, add_fr_switch_pr(rinvsix_S3, rsw_S3, rsw2_r_S3, p6_fc2_S, p6_fc3_S));
#endif
    FrLJ12_S0   = gmx_mul_pr(c12_S0, add_fr_switch_pr(gmx_mul_pr(rinvsix_S0, rinvsix_S0), rsw_S0, rsw2_r_S0, p12_fc2_S, p12_fc3_S));
    FrLJ12_S1   = gmx_mul_pr(c12_S1, add_fr_switch_pr(gmx_mul_pr(rinvsix_S1, rinvsix_S1), rsw_S1, rsw2_r_S1, p12_fc2_S, p12_fc3_S));
#ifndef HALF_LJ
    FrLJ12_S2   = gmx_mul_pr(c12_S2, add_fr_switch_pr(gmx_mul_pr(rinvsix_S2, rinvsix_S2), rsw_S2, rsw2_r_S2, p12_fc2_S, p12_fc3_S));
    FrLJ12_S3   = gmx_mul_pr(c12_S3, add_fr_switch_pr(gmx_mul_pr(rinvsix_S3, rinvsix_S3), rsw_S3, rsw2_r_S3, p12_fc2_S, p12_fc3_S));
#endif
#undef add_fr_switch_pr
...
#if defined LJ_CUT || defined LJ_FORCE_SWITCH
    /* Determine the total scalar LJ force*r */
    frLJ_S0     = gmx_sub_pr(FrLJ12_S0, FrLJ6_S0);
    frLJ_S1     = gmx_sub_pr(FrLJ12_S1, FrLJ6_S1);
#ifndef HALF_LJ
    frLJ_S2     = gmx_sub_pr(FrLJ12_S2, FrLJ6_S2);
    frLJ_S3     = gmx_sub_pr(FrLJ12_S3, FrLJ6_S3);
#endif
#endif
    ...
    VLJ6_S1     = gmx_mul_pr(sixth_S, gmx_madd_pr(c6_S1, p6_cpot_S, FrLJ6_S1));
#ifndef HALF_LJ
    VLJ6_S2     = gmx_mul_pr(sixth_S, gmx_madd_pr(c6_S2, p6_cpot_S, FrLJ6_S2));
    VLJ6_S3     = gmx_mul_pr(sixth_S, gmx_madd_pr(c6_S3, p6_cpot_S, FrLJ6_S3));
#endif
    VLJ12_S0    = gmx_mul_pr(twelveth_S, gmx_madd_pr(c12_S0, p12_cpot_S, FrLJ12_S0));
    VLJ12_S1    = gmx_mul_pr(twelveth_S, gmx_madd_pr(c12_S1, p12_cpot_S, FrLJ12_S1));
#ifndef HALF_LJ
    VLJ12_S2    = gmx_mul_pr(twelveth_S, gmx_madd_pr(c12_S2, p12_cpot_S, FrLJ12_S2));
    VLJ12_S3    = gmx_mul_pr(twelveth_S, gmx_madd_pr(c12_S3, p12_cpot_S, FrLJ12_S3));
#endif
#endif /* LJ_CUT */
...
#define v_fswitch_pr(rsw, rsw2, c0, c3, c4) gmx_madd_pr(gmx_madd_pr(c4, rsw, c3), gmx_mul_pr(rsw2, rsw), c0)
    ...
    VLJ6_S1     = gmx_mul_pr(c6_S1, gmx_madd_pr(sixth_S, rinvsix_S1, v_fswitch_pr(rsw_S1, rsw2_S1, p6_6cpot_S, p6_vc3_S, p6_vc4_S)));
#ifndef HALF_LJ
    VLJ6_S2     = gmx_mul_pr(c6_S2, gmx_madd_pr(sixth_S, rinvsix_S2, v_fswitch_pr(rsw_S2, rsw2_S2, p6_6cpot_S, p6_vc3_S, p6_vc4_S)));
    VLJ6_S3     = gmx_mul_pr(c6_S3, gmx_madd_pr(sixth_S, rinvsix_S3, v_fswitch_pr(rsw_S3, rsw2_S3, p6_6cpot_S, p6_vc3_S, p6_vc4_S)));
#endif
    ...
    VLJ12_S1    = gmx_mul_pr(c12_S1, gmx_madd_pr(twelveth_S, gmx_mul_pr(rinvsix_S1, rinvsix_S1), v_fswitch_pr(rsw_S1, rsw2_S1, p12_12cpot_S, p12_vc3_S, p12_vc4_S)));
#ifndef HALF_LJ
    ...
    VLJ12_S3    = gmx_mul_pr(c12_S3, gmx_madd_pr(twelveth_S, gmx_mul_pr(rinvsix_S3, rinvsix_S3), v_fswitch_pr(rsw_S3, rsw2_S3, p12_12cpot_S, p12_vc3_S, p12_vc4_S)));
#endif
#undef v_fswitch_pr
#endif /* LJ_FORCE_SWITCH */
    ...
    VLJ_S1 = gmx_nmsub_pr(sixth_S, FrLJ6_S1, gmx_mul_pr(twelveth_S, FrLJ12_S1));
#ifndef HALF_LJ
    VLJ_S2 = gmx_nmsub_pr(sixth_S, FrLJ6_S2, gmx_mul_pr(twelveth_S, FrLJ12_S2));
    VLJ_S3 = gmx_nmsub_pr(sixth_S, FrLJ6_S3, gmx_mul_pr(twelveth_S, FrLJ12_S3));
#endif

    {
        gmx_mm_pr sw_S0, dsw_S0;
        gmx_mm_pr sw_S1, dsw_S1;
#ifndef HALF_LJ
        gmx_mm_pr sw_S2, dsw_S2;
        gmx_mm_pr sw_S3, dsw_S3;
#endif
...
#define dswitch_pr(rsw, rsw2, c2, c3, c4) gmx_mul_pr(gmx_madd_pr(gmx_madd_pr(c4, rsw, c3), rsw, c2), rsw2)
        ...
        sw_S1  = switch_pr(rsw_S1, rsw2_S1, swV3_S, swV4_S, swV5_S);
        dsw_S1 = switch_pr(rsw_S1, rsw2_S1, swF2_S, swF3_S, swF4_S);
#ifndef HALF_LJ
        sw_S2  = switch_pr(rsw_S2, rsw2_S2, swV3_S, swV4_S, swV5_S);
        dsw_S2 = switch_pr(rsw_S2, rsw2_S2, swF2_S, swF3_S, swF4_S);
        sw_S3  = switch_pr(rsw_S3, rsw2_S3, swV3_S, swV4_S, swV5_S);
        dsw_S3 = switch_pr(rsw_S3, rsw2_S3, swF2_S, swF3_S, swF4_S);
#endif
        frLJ_S0 = gmx_nmsub_pr(gmx_mul_pr(dsw_S0, VLJ_S0), r_S0, gmx_mul_pr(sw_S0, frLJ_S0));
        frLJ_S1 = gmx_nmsub_pr(gmx_mul_pr(dsw_S1, VLJ_S1), r_S1, gmx_mul_pr(sw_S1, frLJ_S1));
#ifndef HALF_LJ
        frLJ_S2 = gmx_nmsub_pr(gmx_mul_pr(dsw_S2, VLJ_S2), r_S2, gmx_mul_pr(sw_S2, frLJ_S2));
        frLJ_S3 = gmx_nmsub_pr(gmx_mul_pr(dsw_S3, VLJ_S3), r_S3, gmx_mul_pr(sw_S3, frLJ_S3));
#endif
#ifdef CALC_ENERGIES
        VLJ_S0  = gmx_mul_pr(sw_S0, VLJ_S0);
        VLJ_S1  = gmx_mul_pr(sw_S1, VLJ_S1);
#ifndef HALF_LJ
        VLJ_S2  = gmx_mul_pr(sw_S2, VLJ_S2);
        VLJ_S3  = gmx_mul_pr(sw_S3, VLJ_S3);
#endif
#endif
...
#undef dswitch_pr
...
#ifdef LJ_EWALD_GEOM
    {
        ...
        gmx_mm_pr c6grid_S1, rinvsix_nm_S1, cr2_S1, expmcr2_S1, poly_S1;
#ifndef HALF_LJ
        gmx_mm_pr c6grid_S2, rinvsix_nm_S2, cr2_S2, expmcr2_S2, poly_S2;
        gmx_mm_pr c6grid_S3, rinvsix_nm_S3, cr2_S3, expmcr2_S3, poly_S3;
#endif
#ifdef CALC_ENERGIES
        gmx_mm_pr sh_mask_S0;
        gmx_mm_pr sh_mask_S1;
#ifndef HALF_LJ
        gmx_mm_pr sh_mask_S2;
        gmx_mm_pr sh_mask_S3;
#endif
#endif
        ...
        c6grid_S1       = gmx_mul_pr(c6s_S1, c6s_j_S);
#ifndef HALF_LJ
        c6grid_S2       = gmx_mul_pr(c6s_S2, c6s_j_S);
        c6grid_S3       = gmx_mul_pr(c6s_S3, c6s_j_S);
#endif
        ...
        rinvsix_nm_S1 = gmx_mul_pr(rinvsq_S1, gmx_mul_pr(rinvsq_S1, rinvsq_S1));
#ifndef HALF_LJ
        rinvsix_nm_S2 = gmx_mul_pr(rinvsq_S2, gmx_mul_pr(rinvsq_S2, rinvsq_S2));
        rinvsix_nm_S3 = gmx_mul_pr(rinvsq_S3, gmx_mul_pr(rinvsq_S3, rinvsq_S3));
#endif
#else
        ...
        cr2_S1        = gmx_mul_pr(lje_c2_S, rsq_S1);
#ifndef HALF_LJ
        cr2_S2        = gmx_mul_pr(lje_c2_S, rsq_S2);
        cr2_S3        = gmx_mul_pr(lje_c2_S, rsq_S3);
#endif
        expmcr2_S0    = gmx_exp_pr(gmx_mul_pr(mone_S, cr2_S0));
        expmcr2_S1    = gmx_exp_pr(gmx_mul_pr(mone_S, cr2_S1));
#ifndef HALF_LJ
        expmcr2_S2    = gmx_exp_pr(gmx_mul_pr(mone_S, cr2_S2));
        expmcr2_S3    = gmx_exp_pr(gmx_mul_pr(mone_S, cr2_S3));
#endif

        /* 1 + cr2 + 1/2*cr2^2 */
        poly_S0       = gmx_madd_pr(gmx_madd_pr(half_S, cr2_S0, one_S), cr2_S0, one_S);
        poly_S1       = gmx_madd_pr(gmx_madd_pr(half_S, cr2_S1, one_S), cr2_S1, one_S);
#ifndef HALF_LJ
        poly_S2       = gmx_madd_pr(gmx_madd_pr(half_S, cr2_S2, one_S), cr2_S2, one_S);
        poly_S3       = gmx_madd_pr(gmx_madd_pr(half_S, cr2_S3, one_S), cr2_S3, one_S);
#endif
        ...
        frLJ_S1       = gmx_madd_pr(c6grid_S1, gmx_nmsub_pr(expmcr2_S1, gmx_madd_pr(rinvsix_nm_S1, poly_S1, lje_c6_6_S), rinvsix_nm_S1), frLJ_S1);
#ifndef HALF_LJ
        frLJ_S2       = gmx_madd_pr(c6grid_S2, gmx_nmsub_pr(expmcr2_S2, gmx_madd_pr(rinvsix_nm_S2, poly_S2, lje_c6_6_S), rinvsix_nm_S2), frLJ_S2);
        frLJ_S3       = gmx_madd_pr(c6grid_S3, gmx_nmsub_pr(expmcr2_S3, gmx_madd_pr(rinvsix_nm_S3, poly_S3, lje_c6_6_S), rinvsix_nm_S3), frLJ_S3);
#endif

#ifdef CALC_ENERGIES
#ifdef CHECK_EXCLS
        sh_mask_S0    = gmx_blendzero_pr(lje_vc_S, interact_S0);
        sh_mask_S1    = gmx_blendzero_pr(lje_vc_S, interact_S1);
#ifndef HALF_LJ
        sh_mask_S2    = gmx_blendzero_pr(lje_vc_S, interact_S2);
        sh_mask_S3    = gmx_blendzero_pr(lje_vc_S, interact_S3);
#endif
#else
        sh_mask_S0    = lje_vc_S;
        sh_mask_S1    = lje_vc_S;
        ...
        VLJ_S1        = gmx_madd_pr(gmx_mul_pr(sixth_S, c6grid_S1), gmx_madd_pr(rinvsix_nm_S1, gmx_nmsub_pr(expmcr2_S1, poly_S1, one_S), sh_mask_S1), VLJ_S1);
#ifndef HALF_LJ
        ...
        VLJ_S3        = gmx_madd_pr(gmx_mul_pr(sixth_S, c6grid_S3), gmx_madd_pr(rinvsix_nm_S3, gmx_nmsub_pr(expmcr2_S3, poly_S3, one_S), sh_mask_S3), VLJ_S3);
#endif
#endif /* CALC_ENERGIES */
    }
#endif /* LJ_EWALD_GEOM */
    ...
    frLJ_S1     = gmx_blendzero_pr(frLJ_S1, wco_vdw_S1);
#ifndef HALF_LJ
    frLJ_S2     = gmx_blendzero_pr(frLJ_S2, wco_vdw_S2);
    frLJ_S3     = gmx_blendzero_pr(frLJ_S3, wco_vdw_S3);
#endif
#endif
...
#endif
#ifdef CALC_COULOMB
    fscal_S1    = gmx_mul_pr(rinvsq_S1, gmx_add_pr(frcoul_S1, frLJ_S1));
#else
    fscal_S1    = gmx_mul_pr(rinvsq_S1, frLJ_S1);
#endif
#else
    ...
    fscal_S3    = gmx_mul_pr(rinvsq_S3, gmx_add_pr(frcoul_S3, frLJ_S3));
#else
    fscal_S2    = gmx_mul_pr(rinvsq_S2, frLJ_S2);
    fscal_S3    = gmx_mul_pr(rinvsq_S3, frLJ_S3);
#endif
#else
