...

{
    ...
    rsq_S0      = rsq_S0 + selectNotMask(avoid_sing_S, interact_S0);
    rsq_S1      = rsq_S1 + selectNotMask(avoid_sing_S, interact_S1);
    rsq_S2      = rsq_S2 + selectNotMask(avoid_sing_S, interact_S2);
    rsq_S3      = rsq_S3 + selectNotMask(avoid_sing_S, interact_S3);
#endif
    ...
    rinv_S0     = selectMask(rinv_S0, wco_S0);
    rinv_S1     = selectMask(rinv_S1, wco_S1);
    rinv_S2     = selectMask(rinv_S2, wco_S2);
    rinv_S3     = selectMask(rinv_S3, wco_S3);
    ...
    rinv_ex_S0  = selectMask(rinv_S0, interact_S0);
    rinv_ex_S1  = selectMask(rinv_S1, interact_S1);
    rinv_ex_S2  = selectMask(rinv_S2, interact_S2);
    rinv_ex_S3  = selectMask(rinv_S3, interact_S3);
#else
...
#define     rinv_ex_S3    rinv_S3
     ...
     */
    brsq_S0     = beta2_S * selectMask(rsq_S0, wco_S0);
    brsq_S1     = beta2_S * selectMask(rsq_S1, wco_S1);
    brsq_S2     = beta2_S * selectMask(rsq_S2, wco_S2);
    brsq_S3     = beta2_S * selectMask(rsq_S3, wco_S3);
...
#ifdef CHECK_EXCLS
    vc_sub_S0   = vc_sub_S0 + selectMask(sh_ewald_S, interact_S0);
    vc_sub_S1   = vc_sub_S1 + selectMask(sh_ewald_S, interact_S1);
    vc_sub_S2   = vc_sub_S2 + selectMask(sh_ewald_S, interact_S2);
    vc_sub_S3   = vc_sub_S3 + selectMask(sh_ewald_S, interact_S3);
#else
    ...
    vcoul_S0    = selectMask(vcoul_S0, wco_S0);
    vcoul_S1    = selectMask(vcoul_S1, wco_S1);
    vcoul_S2    = selectMask(vcoul_S2, wco_S2);
    vcoul_S3    = selectMask(vcoul_S3, wco_S3);
#endif
...
#ifdef EXCL_FORCES
    rinvsix_S0  = selectMask(rinvsix_S0, interact_S0);
    rinvsix_S1  = selectMask(rinvsix_S1, interact_S1);
#endif
#ifndef HALF_LJ
    rinvsix_S2  = rinvsq_S2 * rinvsq_S2 * rinvsq_S2;
    rinvsix_S3  = rinvsq_S3 * rinvsq_S3 * rinvsq_S3;
#ifdef EXCL_FORCES
    rinvsix_S2  = selectMask(rinvsix_S2, interact_S2);
    rinvsix_S3  = selectMask(rinvsix_S3, interact_S3);
#endif
#endif
...
#ifdef EXCL_FORCES
    sir6_S0     = selectMask(sir6_S0, interact_S0);
    sir6_S1     = selectMask(sir6_S1, interact_S1);
#endif
#ifndef HALF_LJ
    sir6_S2     = sir2_S2 * sir2_S2 * sir2_S2;
    sir6_S3     = sir2_S3 * sir2_S3 * sir2_S3;
#ifdef EXCL_FORCES
    sir6_S2     = selectMask(sir6_S2, interact_S2);
    sir6_S3     = selectMask(sir6_S3, interact_S3);
#endif
#endif
#ifdef VDW_CUTOFF_CHECK
    sir6_S0     = selectMask(sir6_S0, wco_vdw_S0);
    sir6_S1     = selectMask(sir6_S1, wco_vdw_S1);
#ifndef HALF_LJ
    sir6_S2     = selectMask(sir6_S2, wco_vdw_S2);
    sir6_S3     = selectMask(sir6_S3, wco_vdw_S3);
#endif
#endif
...
#undef dswitch_r
    ...
    VLJ_S0      = selectMask(VLJ_S0, interact_S0);
    VLJ_S1      = selectMask(VLJ_S1, interact_S1);
#ifndef HALF_LJ
    VLJ_S2      = selectMask(VLJ_S2, interact_S2);
    VLJ_S3      = selectMask(VLJ_S3, interact_S3);
#endif
#endif
...
#ifdef LJ_EWALD_GEOM
    {
        ...
        cr2_S0        = lje_c2_S * selectMask(rsq_S0, wco_vdw_S0);
        cr2_S1        = lje_c2_S * selectMask(rsq_S1, wco_vdw_S1);
#ifndef HALF_LJ
        cr2_S2        = lje_c2_S * selectMask(rsq_S2, wco_vdw_S2);
        cr2_S3        = lje_c2_S * selectMask(rsq_S3, wco_vdw_S3);
#endif
...
#ifdef CALC_ENERGIES
#ifdef CHECK_EXCLS
        sh_mask_S0    = selectMask(lje_vc_S, interact_S0);
        sh_mask_S1    = selectMask(lje_vc_S, interact_S1);
#ifndef HALF_LJ
        sh_mask_S2    = selectMask(lje_vc_S, interact_S2);
        sh_mask_S3    = selectMask(lje_vc_S, interact_S3);
#endif
#else
        sh_mask_S0    = lje_vc_S;
        sh_mask_S1    = lje_vc_S;
     ...
     */
    frLJ_S0     = selectMask(frLJ_S0, wco_vdw_S0);
    frLJ_S1     = selectMask(frLJ_S1, wco_vdw_S1);
#ifndef HALF_LJ
    frLJ_S2     = selectMask(frLJ_S2, wco_vdw_S2);
    frLJ_S3     = selectMask(frLJ_S3, wco_vdw_S3);
#endif
#endif

#ifdef CALC_ENERGIES
    /* The potential shift should be removed for pairs beyond cut-off */
    VLJ_S0      = selectMask(VLJ_S0, wco_vdw_S0);
    VLJ_S1      = selectMask(VLJ_S1, wco_vdw_S1);
#ifndef HALF_LJ
    VLJ_S2      = selectMask(VLJ_S2, wco_vdw_S2);
    VLJ_S3      = selectMask(VLJ_S3, wco_vdw_S3);
#endif
#endif
