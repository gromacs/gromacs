...

{
...
#ifdef CALC_COUL_TAB
    /* For tables: r, rs=r/sp, rf=trunc(rs), frac=rs-rf */
    ...
    rsq_S0      = gmx_simd_add_r(rsq_S0, gmx_simd_andnot_r(interact_S0, avoid_sing_S));
    rsq_S1      = gmx_simd_add_r(rsq_S1, gmx_simd_andnot_r(interact_S1, avoid_sing_S));
    rsq_S2      = gmx_simd_add_r(rsq_S2, gmx_simd_andnot_r(interact_S2, avoid_sing_S));
    rsq_S3      = gmx_simd_add_r(rsq_S3, gmx_simd_andnot_r(interact_S3, avoid_sing_S));
#endif
