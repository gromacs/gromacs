                               ...
                               gmx_simd_bool_t           *interact_S3)
{
    ...
    *interact_S0  = gmx_load_interaction_mask_pb(size*((excl & 0x000F) >> (0 * UNROLLJ)), simd_interaction_array);
    *interact_S1  = gmx_load_interaction_mask_pb(size*((excl & 0x00F0) >> (1 * UNROLLJ)), simd_interaction_array);
    *interact_S2  = gmx_load_interaction_mask_pb(size*((excl & 0x0F00) >> (2 * UNROLLJ)), simd_interaction_array);
    *interact_S3  = gmx_load_interaction_mask_pb(size*((excl & 0xF000) >> (3 * UNROLLJ)), simd_interaction_array);
#else
