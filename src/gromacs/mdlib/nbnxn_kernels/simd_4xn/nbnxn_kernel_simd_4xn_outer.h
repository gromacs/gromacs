...

{
    ...
    SimdReal             one_S(1.0);
    SimdReal             iq_S0  = SimdReal(0.0);
    SimdReal             iq_S1  = SimdReal(0.0);
    SimdReal             iq_S2  = SimdReal(0.0);
    SimdReal             iq_S3  = SimdReal(0.0);
...
#ifdef CALC_ENERGIES
        SimdReal Vvdwtot_S = SimdReal(0.0);
        SimdReal vctot_S   = SimdReal(0.0);
#endif
