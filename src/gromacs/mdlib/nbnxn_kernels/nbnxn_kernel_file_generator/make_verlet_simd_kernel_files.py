...
LJTreatmentDict['LJCombGeom'] = { 'define' : '#define LJ_COMB_GEOM' }
LJTreatmentDict['LJCombLB'] = { 'define' : '#define LJ_COMB_LB' }
LJTreatmentDict['LJ'] = { 'define' : '/* Use no LJ combination rule */' }
LJTreatmentDict['LJFSw'] = { 'define' : '/* Use no LJ combination rule */\n#define LJ_FORCE_SWITCH' }
LJTreatmentDict['LJPSw'] = { 'define' : '/* Use no LJ combination rule */\n#define LJ_POT_SWITCH' }
