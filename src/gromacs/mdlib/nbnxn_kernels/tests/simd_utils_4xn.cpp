...
/*! \internal \file
 * \brief
 * Tests for SIMD functionality for 4xn kernels
 *
...
typedef SimdFunctionTest_kernel<real> SimdFunction4xnWithFourRealInputs;
...
template<typename ReferenceFunctionType,
         ...
         typename InputKind>
void
SimdFunction4xnWithFourRealInputs::RunTest(ReferenceFunctionType referenceFunction,
...
TEST_F(SimdFunction4xnWithFourRealInputs, gmx_mm_transpose_sum4_WorksFor4xn)
{
#ifndef GMX_DOUBLE
