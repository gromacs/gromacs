...

{
    ...
    jx_S = simdLoadDupHsimd(x+ajx);
    jy_S = simdLoadDupHsimd(x+ajy);
    jz_S = simdLoadDupHsimd(x+ajz);
...
#error "only UNROLLJ == UNROLLI*(1 or 2) currently supported in 2xnn kernels"
...
#ifdef COUNT_PAIRS
    {
        ...
        {
            simdStore(tmp, simdSub(rc2_S, i == 0 ? rsq_S0 : rsq_S2));
    ...
    rsq_S0      = simdAdd(rsq_S0, simdMaskNot(avoid_sing_S, interact_S0));
    rsq_S2      = simdAdd(rsq_S2, simdMaskNot(avoid_sing_S, interact_S2));
#endif
    ...
    simdGatherLoadTransposeHsimd<c_simdBestPairAlignment>(nbfp0, nbfp1, type+aj, &c6_S0, &c12_S0);
#ifndef HALF_LJ
    SimdReal c6_S2, c12_S2;
    simdGatherLoadTransposeHsimd<c_simdBestPairAlignment>(nbfp2, nbfp3, type+aj, &c6_S2, &c12_S2);
#endif
#endif /* not defined any LJ rule */

#ifdef LJ_COMB_GEOM
    c6s_j_S  = simdLoadDupHsimd(ljc+aj2);
    c12s_j_S = simdLoadDupHsimd(ljc+aj2+STRIDE);
...
#ifdef LJ_COMB_LB
    hsig_j_S = simdLoadDupHsimd(ljc+aj2);
    seps_j_S = simdLoadDupHsimd(ljc+aj2+STRIDE);
...
#define     rinv_ex_S2    rinv_S2
    ...
    // If we do not have a dedicated truncate operation, it might be faster
    // to just convert the integer back to real (if the compiler is stupid)
#ifdef GMX_SIMD_HAVE_TRUNC
    rf_S0       = simdSub(rs_S0);
    rf_S2       = simdSub(rs_S2);
#else
    rf_S0       = simdCvtI2R(ti_S0);
    rf_S2       = simdCvtI2R(ti_S2);
#endif
...
#ifdef TAB_FDV0
    simdGatherLoadBySimdIntTranspose<4>(tab_coul_F, ti_S0, &ctab0_S0, &ctab1_S0);
    simdGatherLoadBySimdIntTranspose<4>(tab_coul_F, ti_S2, &ctab0_S2, &ctab1_S2);
#else
    simdGatherLoadUBySimdIntTranspose<1>(tab_coul_F, ti_S0, &ctab0_S0, &ctab1_S0);
    simdGatherLoadUBySimdIntTranspose<1>(tab_coul_F, ti_S2, &ctab0_S2, &ctab1_S2);
#endif
#else
#ifdef TAB_FDV0
    simdGatherLoadBySimdIntTranspose<4>(tab_coul_F, ti_S0, &ctab0_S0, &ctab1_S0, &ctabv_S0, &dum_S0);
    simdGatherLoadBySimdIntTranspose<4>(tab_coul_F, ti_S2, &ctab0_S2, &ctab1_S2, &ctabv_S2, &dum_S2);
#else
    simdGatherLoadUBySimdIntTranspose<1>(tab_coul_F, ti_S0, &ctab0_S0, &ctab1_S0);
    simdGatherLoadUBySimdIntTranspose<1>(tab_coul_V, ti_S0, &ctabv_S0, &dum_S0);
    simdGatherLoadUBySimdIntTranspose<1>(tab_coul_F, ti_S2, &ctab0_S2, &ctab1_S2);
    simdGatherLoadUBySimdIntTranspose<1>(tab_coul_V, ti_S2, &ctabv_S2, &dum_S2);
#endif
#endif
...
#define add_fr_switch(fr, rsw, rsw2_r, c2, c3) simdFmadd(simdFmadd(c3, rsw, c2), rsw2_r, fr)
    SimdReal rsw2_r_S0 = simdMul(rsw2_S0, r_S0);
    FrLJ6_S0    = simdMul(c6_S0, add_fr_switch(rinvsix_S0, rsw_S0, rsw2_r_S0, p6_fc2_S, p6_fc3_S));
#ifndef HALF_LJ
    SimdReal rsw2_r_S2 = simdMul(rsw2_S2, r_S2);
    FrLJ6_S2    = simdMul(c6_S2, add_fr_switch(rinvsix_S2, rsw_S2, rsw2_r_S2, p6_fc2_S, p6_fc3_S));
#endif
    FrLJ12_S0   = simdMul(c12_S0, add_fr_switch(simdMul(rinvsix_S0, rinvsix_S0), rsw_S0, rsw2_r_S0, p12_fc2_S, p12_fc3_S));
#ifndef HALF_LJ
    FrLJ12_S2   = simdMul(c12_S2, add_fr_switch(simdMul(rinvsix_S2, rinvsix_S2), rsw_S2, rsw2_r_S2, p12_fc2_S, p12_fc3_S));
#endif
#undef add_fr_switch
...
#ifdef LJ_FORCE_SWITCH
#define v_fswitch_pr(rsw, rsw2, c0, c3, c4) simdFmadd(simdFmadd(c4, rsw, c3), simdMul(rsw2, rsw), c0)

    SimdReal VLJ6_S0     = simdMul(c6_S0, simdFmadd(sixth_S, rinvsix_S0, v_fswitch_pr(rsw_S0, rsw2_S0, p6_6cpot_S, p6_vc3_S, p6_vc4_S)));
#ifndef HALF_LJ
    SimdReal VLJ6_S2     = simdMul(c6_S2, simdFmadd(sixth_S, rinvsix_S2, v_fswitch_pr(rsw_S2, rsw2_S2, p6_6cpot_S, p6_vc3_S, p6_vc4_S)));
#endif
    SimdReal VLJ12_S0    = simdMul(c12_S0, simdFmadd(twelveth_S, simdMul(rinvsix_S0, rinvsix_S0), v_fswitch_pr(rsw_S0, rsw2_S0, p12_12cpot_S, p12_vc3_S, p12_vc4_S)));
#ifndef HALF_LJ
    SimdReal VLJ12_S2    = simdMul(c12_S2, simdFmadd(twelveth_S, simdMul(rinvsix_S2, rinvsix_S2), v_fswitch_pr(rsw_S2, rsw2_S2, p12_12cpot_S, p12_vc3_S, p12_vc4_S)));
#endif
#undef v_fswitch_pr
#endif /* LJ_FORCE_SWITCH */
...
#define switch_pr(rsw, rsw2, c3, c4, c5) simdFmadd(simdFmadd(simdFmadd(c5, rsw, c4), rsw, c3), simdMul(rsw2, rsw), one_S)
#define dswitch_pr(rsw, rsw2, c2, c3, c4) simdMul(simdFmadd(simdFmadd(c4, rsw, c3), rsw, c2), rsw2)
...
#undef dswitch_pr
    ...
    vctot_S      = simdAdd(vctot_S, simdAdd(vcoul_S0, vcoul_S2));
#else
    ...
    simdDecrHsimd(f+ajx, simdAdd(tx_S0, tx_S2));
    simdDecrHsimd(f+ajy, simdAdd(ty_S0, ty_S2));
    simdDecrHsimd(f+ajz, simdAdd(tz_S0, tz_S2));
}
