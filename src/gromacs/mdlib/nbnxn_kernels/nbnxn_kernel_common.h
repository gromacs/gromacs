 ...
 */
enum {
    vdwktLJCUT_COMBGEOM, vdwktLJCUT_COMBLB, vdwktLJCUT_COMBNONE, vdwktLJFORCESWITCH, vdwktLJPOTSWITCH, vdwktLJEWALDGEOM, vdwktLJEWALDLB, vdwktLJEWALDCOMBGEOM, vdwktNR = vdwktLJEWALDCOMBGEOM, vdwktLJEWALDCOMBLB, vdwktNR_ref
};
