...
/*! \internal \file
 *
 * \brief Implements Langevin (SD) integrator using HIP
 *
 * This file contains HIP implementation of back-end specific code for the
 ...
 *
 * See the corresponding CUDA implementation for a detailed description of the
 ...
 *
 * Returns pointer to a HIP kernel based on the type of SD integration.
 */
