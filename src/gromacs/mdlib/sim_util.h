 ...
 *
 * If FEP or simulated tempering is in use, fills lam0 with the
 * initial lambda values. Also, on master rank fills fep_state and
 * lambda. Reports the initial lambda state to the log file. */
