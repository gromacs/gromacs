                     ...
                     nbnxn_list_work_t *work)
{
    ...
    x_ci->ix_S0 = SimdReal(x[ia + 0*STRIDE_S    ] + shx);
    x_ci->iy_S0 = SimdReal(x[ia + 1*STRIDE_S    ] + shy);
    x_ci->iz_S0 = SimdReal(x[ia + 2*STRIDE_S    ] + shz);
    x_ci->ix_S1 = SimdReal(x[ia + 0*STRIDE_S + 1] + shx);
    x_ci->iy_S1 = SimdReal(x[ia + 1*STRIDE_S + 1] + shy);
    x_ci->iz_S1 = SimdReal(x[ia + 2*STRIDE_S + 1] + shz);
    x_ci->ix_S2 = SimdReal(x[ia + 0*STRIDE_S + 2] + shx);
    x_ci->iy_S2 = SimdReal(x[ia + 1*STRIDE_S + 2] + shy);
    x_ci->iz_S2 = SimdReal(x[ia + 2*STRIDE_S + 2] + shz);
    x_ci->ix_S3 = SimdReal(x[ia + 0*STRIDE_S + 3] + shx);
    x_ci->iy_S3 = SimdReal(x[ia + 1*STRIDE_S + 3] + shy);
    x_ci->iz_S3 = SimdReal(x[ia + 2*STRIDE_S + 3] + shz);
}
    ...
    while (!InRange && cjf <= cjl)
    {
        ...
        *ndistc += 2;
        ...
        else if (d2 < rl2)
        {
            ...
            /* Calculate distance */
            dx_S0            = work->ix_S0 - jx_S;
            dy_S0            = work->iy_S0 - jy_S;
            dz_S0            = work->iz_S0 - jz_S;
            dx_S1            = work->ix_S1 - jx_S;
            dy_S1            = work->iy_S1 - jy_S;
            dz_S1            = work->iz_S1 - jz_S;
            dx_S2            = work->ix_S2 - jx_S;
            dy_S2            = work->iy_S2 - jy_S;
            dz_S2            = work->iz_S2 - jz_S;
            dx_S3            = work->ix_S3 - jx_S;
            dy_S3            = work->iy_S3 - jy_S;
            dz_S3            = work->iz_S3 - jz_S;
