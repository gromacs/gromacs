                     ...
                     nbnxn_list_work_t *work)
{
    ...
    x_ci->ix_S0 = simdSet1(x[ia + 0*STRIDE_S    ] + shx);
    x_ci->iy_S0 = simdSet1(x[ia + 1*STRIDE_S    ] + shy);
    x_ci->iz_S0 = simdSet1(x[ia + 2*STRIDE_S    ] + shz);
    x_ci->ix_S1 = simdSet1(x[ia + 0*STRIDE_S + 1] + shx);
    x_ci->iy_S1 = simdSet1(x[ia + 1*STRIDE_S + 1] + shy);
    x_ci->iz_S1 = simdSet1(x[ia + 2*STRIDE_S + 1] + shz);
    x_ci->ix_S2 = simdSet1(x[ia + 0*STRIDE_S + 2] + shx);
    x_ci->iy_S2 = simdSet1(x[ia + 1*STRIDE_S + 2] + shy);
    x_ci->iz_S2 = simdSet1(x[ia + 2*STRIDE_S + 2] + shz);
    x_ci->ix_S3 = simdSet1(x[ia + 0*STRIDE_S + 3] + shx);
    x_ci->iy_S3 = simdSet1(x[ia + 1*STRIDE_S + 3] + shy);
    x_ci->iz_S3 = simdSet1(x[ia + 2*STRIDE_S + 3] + shz);
}
    ...
    while (!InRange && cjf <= cjl)
    {
        ...
        *ndistc += 2;
        ...
        else if (d2 < rl2)
        {
            ...
            jx_S  = simdLoad(x_j+xind_f+0*STRIDE_S);
            jy_S  = simdLoad(x_j+xind_f+1*STRIDE_S);
            jz_S  = simdLoad(x_j+xind_f+2*STRIDE_S);
            ...
            dx_S1            = simdSub(work->ix_S1, jx_S);
            dy_S1            = simdSub(work->iy_S1, jy_S);
            dz_S1            = simdSub(work->iz_S1, jz_S);
            dx_S2            = simdSub(work->ix_S2, jx_S);
            dy_S2            = simdSub(work->iy_S2, jy_S);
            dz_S2            = simdSub(work->iz_S2, jz_S);
            dx_S3            = simdSub(work->ix_S3, jx_S);
            dy_S3            = simdSub(work->iy_S3, jy_S);
            dz_S3            = simdSub(work->iz_S3, jz_S);
            ...
            wco_any_S01      = simdOrB(wco_S0, wco_S1);
            wco_any_S23      = simdOrB(wco_S2, wco_S3);
            wco_any_S        = simdOrB(wco_any_S01, wco_any_S23);
    ...
    while (!InRange && cjl > cjf)
    {
        ...
        *ndistc += 2;
        ...
        else if (d2 < rl2)
        {
            ...
            jx_S  = simdLoad(x_j+xind_l+0*STRIDE_S);
            jy_S  = simdLoad(x_j+xind_l+1*STRIDE_S);
            jz_S  = simdLoad(x_j+xind_l+2*STRIDE_S);
