...
/* Template function for leap-frog update with temperature scaling and
 * optionally Parrinello-Rahman pressure scaling.
 * haveSingleTCoupleValue is a template parameter, since if it's true
 * the compiler can achieve much better SIMD acceleration.
 */
template<bool haveSingleTCoupleValue, gmx_bool useParrinelloRahman>
static void
                         ...
                         gmx_bool bNH, gmx_bool bPR)
{
    if (bNH || bNEMD)
    {
         ...
         * all combination of T-coupling, P-coupling and NEMD.
