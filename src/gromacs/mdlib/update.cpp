                ...
                const unsigned short       ptype[])
{
    ...
    *  Two types of pruduct are supported
    *   - scalar product, T is real
    *   - dot product, T is matrix
    */
    int gf=0;
...
template<typename T>
void scale_vprime_template(const t_mdatoms      *md,
                           const t_inputrec     *inputrec,
                           gmx_update_t         *upd,
                           const T              &scl)
{
...
template<typename T>
void scale_xprime_template(const t_mdatoms        *md,
                           const t_inputrec       *inputrec,
                           gmx_update_t           *upd,
                           const T                &scl)
{
...
template<typename T>
void scale_fprime_template(const t_mdatoms        *md,
                           const t_inputrec       *inputrec,
                           gmx_update_t           *upd,
                           const T                &scl)
{
...
{
    scale_vprime_template(md, inputrec, upd, scl);
}
...
{
    scale_xprime_template(md, inputrec, upd, scl);
}
...
{
    scale_fprime_template(md, inputrec, upd, scl);
}
