                          ...
                          gmx_int64_t step, int seed, int* gatindex)
{
    ...
    gmx::ThreeFry2x64<0> rng({static_cast<gmx_uint64_t>(seed), gmx::RandomDomain_UpdateCoordinates});
    ...
    if (!bDoConstr)
    {
        for (n = start; n < nrend; n++)
        {
            ...
            rng.restart({static_cast<gmx_uint64_t>(step), static_cast<gmx_uint64_t>(ng)});
            dist.reset();
                          ...
                          int* gatindex)
{
    ...
    real         ism;
    int          n, d, ng;
    gmx_uint64_t randomDomain = bFirstHalf ? gmx::RandomDomain_UpdateCoordinates : gmx::RandomDomain_UpdateConstraints;
    ...
    gmx::ThreeFry2x64<1> rng({static_cast<gmx_uint64_t>(seed), randomDomain});
