...
static void dump_it_all(FILE gmx_unused *fp, const char gmx_unused *title,
                        ...
                        gmx::ArrayRef<const gmx::RVec> gmx_unused x,
                        gmx::ArrayRef<const gmx::RVec> gmx_unused xp,
                        gmx::ArrayRef<const gmx::RVec> gmx_unused v,
                        gmx::ArrayRef<const gmx::RVec> gmx_unused f)
{
#ifdef DEBUG
    if (fp)
    {
...
void update_coords(FILE                    *fplog,
                   ...
                   t_mdatoms               *md,
                   t_state                 *state,
                   gmx::ArrayRef<gmx::RVec> f,    /* forces on home particles */
                   t_fcdata                *fcd,
                   gmx_ekindata_t          *ekind,
                   matrix                   M,
                   gmx_update_t            *upd,
