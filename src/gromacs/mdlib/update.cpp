                         ...
                         const matrix M)
{
    ...
    /* Note: With off-diagonal scaling M is transposed wrt the box matrix */
    bool doPROffDiagonal    = (doParrinelloRahman && (M[XX][YY] != 0 || M[XX][ZZ] != 0 || M[YY][ZZ] != 0));
    ...
    if (doNoseHoover || doPROffDiagonal || handleAcceleration)
    {
