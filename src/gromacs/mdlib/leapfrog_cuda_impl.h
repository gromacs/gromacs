...
class LeapFrogCuda::Impl
{
    ...
    public:
        ...
        /*! \brief
         * Copy inverce masses from CPU to GPU.
         *
         ...
         */
        void copyInverseMassesToGpu(const real *inverseMasses);
         ...
         */
        void copyCoordinatesToGpu(const rvec *x);
         ...
         */
         void copyForcesToGpu(const rvec *f);
         ...
         */
        void setXVFPointers(rvec *xDevice, rvec *xpDevice, rvec *vDevice, rvec *fDevice);
