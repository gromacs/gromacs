 ...
 */
#define _POSIX_C_SOURCE 199309 /* for CLOCK_THREAD_CPUTIME */
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
// the gmx_runtime_t object be owned by the runner object. Now a method
// call to a function here requires that an object exist.
