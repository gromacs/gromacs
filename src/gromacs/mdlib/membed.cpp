...
static int init_ins_at(t_block *ins_at, t_block *rest_at, t_state_global *state, pos_ins_t *pos_ins,
...
static void rm_group(gmx_groups_t *groups, gmx_mtop_t *mtop, rm_t *rm_p, t_state_global *state,
