...
class CheckpointHandler final
{
    public:
         ...
         * interval.
         */
        void setSignal(gmx_walltime_accounting_t walltime_accounting) const
        {
            if (rankCanSetSignal_)
            {
                setSignalImpl_(walltime_accounting);
            }
        }
        ...
        void decideIfCheckpointingThisStep(bool bNS, bool bFirstStep, bool bLastStep)
        {
            ...
            {
                decideIfCheckpointingThisStepImpl_(bNS, bFirstStep, bLastStep);
            }
        }
    ...
    private:
        void setSignalImpl_(gmx_walltime_accounting_t walltime_accounting) const;

        void decideIfCheckpointingThisStepImpl_(bool bNS, bool bFirstStep, bool bLastStep);
