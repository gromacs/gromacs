...
void gmx::MimicCommunicator::sendInitData(gmx_mtop_t gmx_unused                *mtop,
                                          gmx::HostVector<gmx::RVec> gmx_unused coords,
...
//    constr->atom2settle_moltype()
    ...
    for (const gmx_molblock_t molblock : mtop->molblock)
    {
        ...
        for (int mol = 0; mol < molblock.nmol; ++mol)
        {
            ...
            t_iatom *at1 = mtop->moltype[molblock.type].ilist[F_CONSTR].iatoms;
            t_iatom *at2 = mtop->moltype[molblock.type].ilist[F_CONSTRNC].iatoms;
            ...
            at1 = type->ilist[F_SETTLE].iatoms;
