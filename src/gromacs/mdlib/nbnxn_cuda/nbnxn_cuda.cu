...
/*! Texture reference for Non-bonded force table; bound to cu_nbparam_t.nb_Ftab */
texture<float, 1, cudaReadModeElementType> nb_vdw_LJ6_Ftab_texref;

/*! Texture reference for Non-bonded potential table; bound to cu_nbparam_t.nb_Ftab */
texture<float, 1, cudaReadModeElementType> nb_vdw_LJ6_Vtab_texref;

/*! Texture reference for Non-bonded force table; bound to cu_nbparam_t.nb_Ftab */
texture<float, 1, cudaReadModeElementType> nb_vdw_LJ12_Ftab_texref;

/*! Texture reference for Non-bonded potential table; bound to cu_nbparam_t.nb_Ftab */
texture<float, 1, cudaReadModeElementType> nb_vdw_LJ12_Vtab_texref;
...
const struct texture<float, 1, cudaReadModeElementType> &nbnxn_cuda_get_nb_vdw_LJ6_Ftab_texref()
{
    return nb_vdw_LJ6_Ftab_texref;
}

/*! Return the reference to the nb_vdw_Vtab. */
const struct texture<float, 1, cudaReadModeElementType> &nbnxn_cuda_get_nb_vdw_LJ6_Vtab_texref()
{
    return nb_vdw_LJ6_Vtab_texref;
}

/*! Return the reference to the nb_vdw_Ftab. */
const struct texture<float, 1, cudaReadModeElementType> &nbnxn_cuda_get_nb_vdw_LJ12_Ftab_texref()
{
    return nb_vdw_LJ12_Ftab_texref;
}

/*! Return the reference to the nb_vdw_Vtab. */
const struct texture<float, 1, cudaReadModeElementType> &nbnxn_cuda_get_nb_vdw_LJ12_Vtab_texref()
{
