                             ...
                             int                     iloc)
{
    ...
    launchGpuKernel(nb_kernel, config, timingEvent, "k_calc_nb",
                                       ...
                                       int                     numParts)
{
    ...
    if (plist->haveFreshList)
    {
        launchGpuKernel(nbnxn_kernel_prune_cuda<true>, config, timingEvent, kernelName,
                        adat, nbp, plist, &numParts, &part);
    }
    else
    {
        launchGpuKernel(nbnxn_kernel_prune_cuda<false>, config, timingEvent, kernelName,
                        adat, nbp, plist, &numParts, &part);
    }
