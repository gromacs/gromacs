...
#include "gromacs/mdlib/nbnxn_cuda/nbnxn_buffer_ops_kernels.cuh"
                           ...
                           rvec                 *x)
{
    ...
    if (copyCoord)
    {
        ...
        //It is picking up the size wrong for some reason at the moment.
                               ...
                               rvec                          *f)
{
    ...
    //TODO enable copyForce=false (and zero device buffer)
