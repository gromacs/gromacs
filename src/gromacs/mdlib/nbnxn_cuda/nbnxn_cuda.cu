 ...
 * NTHREAD_Z == 1, translating to 64 th/block and 16 blocks/multiproc is fastest
 * even though this results in low occupancy. Increasing occupancy by increasing
 * the number of threads/block would result in excessive spilling on current
 * architectures.
 *
