...
GPU_FUNC_QUALIFIER
void gpuBufferOpsCopyRvecToNbatReal(int ncxy,int g, int FillLocal,gmx_pme_t* pmedata,nbnxn_atomdata_t    *nbat, gmx_nbnxn_gpu_t *gpu_nbv, const int* a,int a_nalloc,int* na_all,int* cxy_ind,int cell0,int na_sc, int iloc, int stride,  const float x[][3],int xsize,t_commrec *cr) GPU_FUNC_TERM
