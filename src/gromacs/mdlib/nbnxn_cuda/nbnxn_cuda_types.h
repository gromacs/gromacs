...
#define CUDA_TAB_SIZE_LIMIT  2048  /**< Maximum size of a potential/force table */
#define CUDA_NTABS_SIZE_LIMIT 32   /**< Maximum number of tables allowed */
...
struct cu_nbparam
{
    ...
    int                  gmx_no_table_coeffs;            /**< When set to 1, GENERIC tables are used.              */
