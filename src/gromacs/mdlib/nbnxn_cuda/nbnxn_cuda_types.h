...
struct cu_nbparam
{
    ...
    float               *nb_generic_interp_parms;        /**< Interpolation parameters                             */
    ...
    cudaTextureObject_t  nb_generic_interp_parms_texobj; /**< texture object bound to nb_generic_interp_parms      */
    ...
    float              *nb_coul_interp_parms;
    float              *nb_coul_Ftab;
    float              *nb_coul_Vtab;
    cudaTextureObject_t nb_coul_interp_parms_texobj;
    ...
    float              *nb_vdw_LJ6_interp_parms;
    float              *nb_vdw_LJ6_Ftab;
    float              *nb_vdw_LJ6_Vtab;
    cudaTextureObject_t nb_vdw_LJ6_interp_parms_texobj;
    ...
    float              *nb_vdw_LJ12_interp_parms;
    cudaTextureObject_t nb_vdw_LJ12_interp_parms_texobj;
