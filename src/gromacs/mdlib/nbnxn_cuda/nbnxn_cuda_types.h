...
static const bool disableCudaTextures = DISABLE_CUDA_TEXTURES;
...
struct cu_nbparam
{
    ...
    float           rlistInner_sq;        /**< Full, outer pair-list cut-off squared             */
    float           rlistOuter_sq;        /**< Inner, dynamic pruned pair-list cut-off squared   */
