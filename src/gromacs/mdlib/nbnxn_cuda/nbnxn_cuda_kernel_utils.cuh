...
float calculate_lj_ewald_c6grid(const cu_nbparam_t nbparam,
                                ...
                                int                typej)
{
    float ri = fetchFromParamLookupTable(nbparam.nbfp_comb, nbparam.nbfp_comb_texobj, nbfp_comb_texref, 2 * typei);
    float rj = fetchFromParamLookupTable(nbparam.nbfp_comb, nbparam.nbfp_comb_texobj, nbfp_comb_texref, 2 * typej);
    return ri * rj;
}
