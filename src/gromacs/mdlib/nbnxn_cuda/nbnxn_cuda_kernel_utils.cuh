...
#ifdef HAVE_CUDA_TEXOBJ_SUPPORT
static inline __device__
float interpolate_nb_generic_Ftab(cudaTextureObject_t texobj_nb_generic_Ftab,
                                  float r, float scale)
{
    float normalized = scale * r;
    int   index      = (int) normalized;
    ...
    return fract1 * tex1Dfetch<float>(texobj_nb_generic_Ftab, index) +
...
#ifdef HAVE_CUDA_TEXOBJ_SUPPORT
static inline __device__
float interpolate_nb_vdw_Ftab(cudaTextureObject_t texobj_nb_vdw_Ftab,
                              float r, float scale)
{
    float normalized = scale * r;
    int   index      = (int) normalized;
    ...
    return fract1 * tex1Dfetch<float>(texobj_nb_vdw_Ftab, index) +
...
#ifdef HAVE_CUDA_TEXOBJ_SUPPORT
static inline __device__
float interpolate_nb_coul_Ftab(cudaTextureObject_t texobj_nb_coul_Ftab,
                               float r, float scale)
{
    float normalized = scale * r;
    int   index      = (int) normalized;
    ...
    return fract1 * tex1Dfetch<float>(texobj_nb_coul_Ftab, index) +
