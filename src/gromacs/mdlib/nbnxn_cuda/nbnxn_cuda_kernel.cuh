...
/* Temporary solution until we remove support for CC 2.x */
#if GMX_PTX_ARCH < 300
#include "nbnxn_cuda_kernel_fermi.cuh"
#else
...
#if !defined LJ_COMB_LB || defined CALC_ENERGIES
#ifdef LJ_COMB_LB
                                convert_sigma_epsilon_to_c6_c12(sigma, epsilon,
                                                                &c6, &c12);
#endif
