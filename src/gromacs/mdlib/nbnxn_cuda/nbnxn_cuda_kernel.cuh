...
#ifdef EL_USER
    nb_F_retval_t coul_retval;
    float         nb_coul_tab_scale = nbparam.nb_coul_tab_scale;
#endif /* EL_USER */

#ifdef VDW_USER
    nb_F_retval_t vdw_LJ6_retval;
    nb_F_retval_t vdw_LJ12_retval;
    float         total_vdw_LJ_F;
#ifdef CALC_ENERGIES
    float         total_vdw_LJ_V;
#endif
...
#pragma unroll 8
                    ...
                    for (i = 0; i < NCL_PER_SUPERCL; i++)
                    {
                        if (imask & mask_ji)
                        {
...
#endif
                            {
            ...
            #endif
                                F_invr  = qi * qj_f * int_bit * coul_retval.F_r;
#ifdef CALC_ENERGIES
                                E_el   += qi * qj_f * int_bit *
#ifdef USE_TEXOBJ
                                    interpolate2_nb_coul_Vtab(nbparam.nb_coul_Vtab_texobj, r2*inv_r, nb_coul_tab_scale, coul_retval);
#else
                                    interpolate2_nb_coul_Vtab(r2*inv_r, nb_coul_tab_scale, coul_retval);
#endif
#endif /* CALC_ENERGIES */
                                ...
                                vdw_LJ6_retval =
            #ifdef USE_TEXOBJ
                                    interpolate_nb_vdw_LJ6_Ftab(nbparam.nb_vdw_LJ6_Ftab_texobj, r2*inv_r, nb_vdw_tab_scale);
            #else
                                    interpolate_nb_vdw_LJ6_Ftab(r2*inv_r, nb_vdw_tab_scale);
            #endif                  // USE_TEXOBJ

                                vdw_LJ12_retval =
            #ifdef USE_TEXOBJ
                                    interpolate_nb_vdw_LJ12_Ftab(nbparam.nb_vdw_LJ12_Ftab_texobj, r2*inv_r, nb_vdw_tab_scale);
            #else
                                    interpolate_nb_vdw_LJ12_Ftab(r2*inv_r, nb_vdw_tab_scale);
            #endif                  // USE_TEXOBJ

                                total_vdw_LJ_F = c12 * vdw_LJ12_retval.F_r + c6 * vdw_LJ6_retval.F_r;
                                F_invr         = int_bit * inv_r * total_vdw_LJ_F;

        #ifdef CALC_ENERGIES
                                total_vdw_LJ_V =

                #ifdef USE_TEXOBJ
                                    c12 * interpolate2_nb_vdw_LJ12_Vtab(nbparam.nb_vdw_LJ12_Vtab_texobj, r2*inv_r, nb_vdw_tab_scale, vdw_LJ12_retval) +
                #else
                                    c12 * interpolate2_nb_vdw_LJ12_Vtab(r2*inv_r, nb_vdw_tab_scale, vdw_LJ12_retval) +
                #endif          // USE_TEXOBJ

                #ifdef USE_TEXOBJ
                                    c6 * interpolate2_nb_vdw_LJ6_Vtab(nbparam.nb_vdw_LJ6_Vtab_texobj, r2*inv_r, nb_vdw_tab_scale, vdw_LJ6_retval);
                #else
                                    c6 * interpolate2_nb_vdw_LJ6_Vtab(r2*inv_r, nb_vdw_tab_scale, vdw_LJ6_retval);
                #endif          // USE_TEXOBJ

                                E_lj_p = int_bit * total_vdw_LJ_V;
    ...
    #ifdef CALC_ENERGIES
        #ifdef USE_TEXOBJ
                                interpolate21_nb_generic_Vtab(nbparam.nb_generic_Ftab_texobj,
                                                              nbparam.nb_generic_Vtab_texobj,
                                                              r2*inv_r, nb_generic_tab_scale, &generic_F, &generic_V);
        #else
                                interpolate21_nb_generic_Vtab(r2*inv_r, nb_generic_tab_scale, &generic_F, &generic_V);
        #endif

                                E_lj_p = int_bit * generic_V;
    #else
        #ifdef USE_TEXOBJ
                                interpolate1_nb_generic_Ftab(nbparam.nb_generic_Ftab_texobj,
                                                             r2*inv_r, nb_generic_tab_scale, &generic_F);
        #else
                                interpolate1_nb_generic_Ftab(r2*inv_r, nb_generic_tab_scale, &generic_F);
        #endif
    #endif

                                F_invr = int_bit * inv_r * generic_F;
...
/*
   ...
   #endif                  // USE_TEXOBJ
                                F_invr = int_bit * inv_r * generic_retval.F_r;


   #ifdef CALC_ENERGIES
                                E_lj_p = int_bit *
   #ifdef USE_TEXOBJ
                                    interpolate2_nb_generic_Vtab(nbparam.nb_generic_Vtab_texobj, r2*inv_r, nb_generic_tab_scale, generic_retval);
   #else
                                    interpolate2_nb_generic_Vtab(r2*inv_r, nb_generic_tab_scale, generic_retval);
   #endif // USE_TEXOBJ
