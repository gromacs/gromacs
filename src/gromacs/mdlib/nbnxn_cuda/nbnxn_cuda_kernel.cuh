...
#ifdef CALC_ENERGIES
/* If I use the !defined EL_NONE ... directive, the nested expression is not properly evaluated
 * and c_rf is declared.
 */
    ...
    float c_rf        = nbparam.c_rf;
        #endif /* EL_EWALD_ANY */
    #endif     /* defined EL_NONE || defined EL_USER */
                        ...
                        if (imask & mask_ji)
                        {
...
#endif
                            {
                                ...
                                F_invr  += qi * qj_f * (int_bit*inv_r2 -
                                                        interpolate_coulomb_force_r(nbparam, r2 * inv_r, coulomb_tab_scale)) * inv_r;
...
#ifdef EL_USER
    #ifdef CALC_ENERGIES
                                interpolate_nb_coul_VFtab(nbparam, r2*inv_r, nb_coul_tab_scale, &coul_F, &coul_V);
                                E_lj_p = int_bit * qi * qj_f * coul_V;
    #else
                                interpolate_nb_coul_Ftab(nbparam, r2*inv_r, nb_coul_tab_scale, &coul_F);
    #endif
...
#ifdef VDW_USER
    #ifdef CALC_ENERGIES
                                interpolate_nb_vdw_LJ6_VFtab(nbparam, r2*inv_r, nb_vdw_tab_scale, &vdw_LJ6_F, &vdw_LJ6_V);
                                interpolate_nb_vdw_LJ12_VFtab(nbparam, r2*inv_r, nb_vdw_tab_scale, &vdw_LJ12_F, &vdw_LJ12_V);
                                E_lj_p = int_bit * (c6 * vdw_LJ6_V + c12 * vdw_LJ12_V);
    #else
                                interpolate_nb_vdw_LJ6_Ftab(nbparam, r2*inv_r, nb_vdw_tab_scale, &vdw_LJ6_F);
                                interpolate_nb_vdw_LJ12_Ftab(nbparam, r2*inv_r, nb_vdw_tab_scale, &vdw_LJ12_F);
    #endif
...
#ifdef VDW_USER_GENERIC
    #ifdef CALC_ENERGIES
                                interpolate_nb_generic_VFtab(nbparam, r2*inv_r, nb_generic_tab_scale, &generic_F, &generic_V);
                                E_lj_p = int_bit * generic_V;
    #else
                                interpolate_nb_generic_Ftab(nbparam, r2*inv_r, nb_generic_tab_scale, &generic_F);
    #endif
