                        ...
                        if (imask & mask_ji)
                        {
...
#endif
                            {
                                ...
                                //{
                                    ...
                                    /* dispersion and repolsion switch constants */
...
#ifdef VDW_FORCE_SWITCH
                                    F_invr  +=
                                        -c6*(disp_shift_V2 + disp_shift_V3*r_switch)*r_switch*r_switch*r +
                                         c12*(-repu_shift_V2 + repu_shift_V3*r_switch)*r_switch*r_switch*r;
#ifdef CALC_ENERGIES
                                    E_lj_p  +=
