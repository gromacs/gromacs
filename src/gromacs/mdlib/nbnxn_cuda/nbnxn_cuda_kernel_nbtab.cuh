...
#ifdef VDW_USER
    float nb_tab_scale          = nbparam.nb_tab_scale;
#endif
...
#pragma unroll 8
                    ...
                    for (i = 0; i < NCL_PER_SUPERCL; i++)
                    {
                        if (imask & mask_ji)
                        {
...
#endif
                            {
        ...
        #ifdef USE_TEXOBJ
                                         interpolate_nb_Ftab(nbparam.nb_Ftab_texobj, r2*inv_r, nb_tab_scale);
        #else
                                         interpolate_nb_Ftab(r2*inv_r, nb_tab_scale);
        #endif // USE_TEXOBJ
                                ...
                                E_lj_p = int_bit *
                #ifdef USE_TEXOBJ
                                         interpolate_nb_Vtab(nbparam.nb_Vtab_texobj, r2*inv_r, nb_tab_scale);
                #else
                                         interpolate_nb_Ftab(r2*inv_r, nb_tab_scale);
                #endif // USE_TEXOBJ
