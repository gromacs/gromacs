...
DispersionCorrection::InteractionParams::~InteractionParams()
{
    ...
    {
        sfree(dispersionCorrectionTable_->data);
                                     ...
                                     real *prescorr, real *enercorr, real *dvdlcorr) const
{
    ...
    *dvdlcorr = 0;
    ...
    if (eDispCorr_ != edispcNO)
    {
        ...
        const int  numCorr   = topParams_.numCorrections_;
        ...
        *enercorr            += avcsix*enerdiff;
        ...
        if (bCorrPres)
        {
            svir = numCorr*density*avcsix*iParams_.virdiffsix_/3.0;
            if (eDispCorr_ == edispcAllEnerPres)
            {
                svir += numCorr*density*avctwelve*iParams_.virdifftwelve_/3.0;
            }
