...
#pragma omp parallel for num_threads(nthreads) schedule(static)
                ...
                if (nthreads > 1)
                {
                    reduce_thread_forces(fr->natoms_force, fr->f_novirsum,
                                         ...
                                         &Vcorr_q, &Vcorr_lj, efptCOUL, &dvdl,
                                         nthreads, fr->f_t);
                }
            ...
            PRINT_SEPDVDL("Ewald excl./charge/dip. corr.", Vcorr_q, dvdl);
            PRINT_SEPDVDL("Ewald excl. corr. LJ", Vcorr_lj, dvdl);
            ...
            if (cr->duty & DUTY_PME)
            {
                ...
                if (fr->n_tpi == 0 || (flags & GMX_FORCE_STATECHANGED))
                {
                    ...
                    status = gmx_pme_do(fr->pmedata,
                                        ...
                                        &Vlr_q, &Vlr_lj, lambda[efptCOUL], &dvdl,
                                        pme_flags);
                ...
                PRINT_SEPDVDL("PME mesh", Vlr_q + Vlr_lj, dvdl);
            }
        }
        else if (EEL_EWALD(fr->eeltype))
        {
            ...
            PRINT_SEPDVDL("Ewald long-range", Vlr_q, dvdl);
        }
        else
        {
