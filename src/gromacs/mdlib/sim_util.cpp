 ...
 * \param[in]     coputeForces    When true, compute forces and energy, when false, only compute energies
 ...
 *
 * \todo Consider removing the normal force buffer, since we don't need it.
                                ...
                                DdCloseBalanceRegionAfterForceComputation ddCloseBalanceRegion)
{
    ...
    computeSpecialForces(cr, inputrec, step, t, wcycle,
                         ...
                         bDoForces, force, fr->f_novirsum, vir_force, enerd,
                         ed, bNS);
    ...
    if (bDoForces && (flags & GMX_FORCE_VIRIAL))
    {
