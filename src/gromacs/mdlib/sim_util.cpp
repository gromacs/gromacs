...
void gmx::DefaultVerletSchedule::computeStep(int flags)
{
    ...
    GMX_ASSERT(static_cast<unsigned long>((state_->x).size()) >= static_cast<unsigned long>(gmx::paddedRVecVectorSize(fr_->natoms_force)), "coordinates should be padded");
    GMX_ASSERT(static_cast<unsigned long>(force_->size())     >= static_cast<unsigned long>(gmx::paddedRVecVectorSize(fr_->natoms_force)), "force should be padded");
