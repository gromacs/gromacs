                         ...
                         int flags)
{
    ...
    if (bNS)
    {
        ...
        nbnxn_grid_dimensions_t griddim;
        clear_rvec(griddim.corner0);
        griddim.corner1[XX]  = box[XX][XX];
        griddim.corner1[YY]  = box[YY][YY];
        griddim.corner1[ZZ]  = box[ZZ][ZZ];
        griddim.atom_density = -1;
