                                ...
                                DdCloseBalanceRegionAfterForceComputation ddCloseBalanceRegion)
{
     ...
     */
    const bool           separateForceWithVirialBuffer = (bDoForces && ((flags & GMX_FORCE_VIRIAL != 0) && fr->haveDirectVirialContributions));
                               ...
                               DdCloseBalanceRegionAfterForceComputation ddCloseBalanceRegion)
{
    ...
    // why padded here and unpadded in the do_force_cutsVERLET()
    /* Temporary solution until all routines take PaddedRVecVector */
