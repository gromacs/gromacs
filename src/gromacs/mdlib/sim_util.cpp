                         ...
                         int flags)
{
    ...
    do_force_lowlevel(fr, inputrec, &(top->idef),
                      ...
                      x, hist, f, bSepLRF ? fr->f_twin : f, NULL, NULL, NULL, enerd, fcd, top, fr->born, 
                      bBornRadii, box,
                        ...
                        int flags)
{
    ...
    do_force_lowlevel(fr, inputrec, &(top->idef),
                      cr, nrnb, wcycle, mdatoms,
                      x, hist, f, bSepLRF ? fr->f_twin : f, vir, vir, pener, enerd, fcd, top, fr->born,   // TODO: here we can add LR virial contrib
                      bBornRadii, box,
                      inputrec->fepvals, lambda,
