                         ...
                         int flags)
{
    ...
    float               cycles_movex, cycles_pme, cycles_wait_gpu;
    ...
    {
        /* Start DLB force counter just before doing domain dependent work */
        cycles_force = gmx_cycles_read();
    ...
    if (DOMAINDECOMP(cr))
    {
        ...
        else
        {
            ...
            cycles_movex = wallcycle_stop(wcycle, ewcMOVEX);
    ...
    if (DOMAINDECOMP(cr))
    {
        ...
        if (wcycle)
        {
            ...
            float cycles_dlb_force =
                static_cast<float>(cycles_force) - cycles_movex - cycles_pme;
