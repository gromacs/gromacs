                         ...
                         DdCloseBalanceRegionAfterForceComputation ddCloseBalanceRegion)
{
    ...
    {
        dd_openBalanceRegion(cr->dd, bUseGPU ? DdBalanceRegionUsingGpu::yes : DdBalanceRegionUsingGpu::no, true);
    }
              ...
              DdCloseBalanceRegionAfterForceComputation ddCloseBalanceRegion)
{
    ...
    if (ddOpenBalanceRegion == DdOpenBalanceRegionBeforeForceComputation::yes)
    {
        dd_openBalanceRegion(cr->dd,  use_GPU(fr->nbv) ? DdBalanceRegionUsingGpu::yes : DdBalanceRegionUsingGpu::no, false);
    }
}
