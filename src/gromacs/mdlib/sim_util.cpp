                                ...
                                const DDBalanceRegionHandling &ddBalanceRegionHandling)
{
    ...
    if (bNS)
    {
        ddBalanceRegionHandling.openBeforeForceComputationCpu(DdAllowBalanceRegionReopen::yes);
    }
    ...
    if (bUseGPU)
    {
        ddBalanceRegionHandling.openBeforeForceComputationGpu();
    ...
    if (bStateChanged && inputrecNeedMutot(inputrec))
    {
        if (PAR(cr))
        {
            ...
            ddBalanceRegionHandling.reopenRegionCpu();
        }
    ...
    if (!alternateGpuWait && bUseGPU)
    {
        ...
        if (ddBalanceRegionHandling.useBalancingRegion())
        {
            ...
            ddBalanceRegionHandling.closeAfterForceComputationGpu(cycles_wait_gpu, waitedForGpu);
        }
    }
              ...
              const DDBalanceRegionHandling            &ddBalanceRegionHandling)
{
     ...
     */
    ddBalanceRegionHandling.openBeforeForceComputationCpu(DdAllowBalanceRegionReopen::no);
}
