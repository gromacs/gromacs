                ...
                gmx_bool bWriteStat)
{
    ...
    bool    printReport = SIMMASTER(cr); // this is from release-2016 commit 66ec44e6, should go away with rebase
    ...
    if (printReport)
    {
        ...
        if (pme_gpu_task_enabled(pme)) // TODO query GpuTaskManager instead
        {
