...
{
    real   mO;              //!< Mass of oxygen atom
    real   mH;              //!< Mass of hydrogen atom
    real   wh;              //!< Relative hydrogen mass (i.e. mH/(mO+2*mH))
    real   dOH;             //!< Target distance between oxygen and hydrogen
    real   dHH;             //!< Target distance between hydrogen atoms
    real   ra;              //!< Double relative H mass times height of the H-O-H triangle.
    real   rb;              //!< Height of the H-O-H triangle minus ra.
    real   rc;              //!< Half the H-H distance.
    real   irc2;            //!< Reciprocal H-H distance
    /* For projection */
    real   imO;             //!< Reciprocal oxygen mass
    real   imH;             //!< Reciprocal hydrogen mass
    real   invdOH;          //!< Reciprocal O-H distance
    real   invdHH;          //!< Reciprocal H-H distance (again)
