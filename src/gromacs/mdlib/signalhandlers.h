...
{
    public:
        static std::pair<std::unique_ptr<CheckpointSignalSetter>,
        ...
        static std::pair<std::vector<std::unique_ptr<ISignalSetter>>,
        ...
        static std::pair<std::unique_ptr<ResetSignalSetter>,
