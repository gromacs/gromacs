...
{
    public:
        static void makeCheckpointSignalClasses(gmx::SimulationSignal    * sig,
                                                const t_inputrec         * ir,
                                                const t_commrec          * cr,
                                                const MdrunOptions        &mdrunOptions,
                                                bool                       needSync,
        ...
        static void deleteCheckpointSignalClasses(CheckpointSignalSetter  ** setter,
                                                  CheckpointSignalHandler ** handler);

        static void makeStopSignalClasses(gmx::SimulationSignal       * sig,
                                          bool                          needSync,
                                          const t_inputrec            * ir,
                                          const t_commrec             * cr,
                                          const MdrunOptions           &mdrunOptions,
        ...
        static void deleteStopSignalClasses(std::vector<ISignalSetter *> &setters,
                                            StopSignalHandler          ** handler);

        static void makeResetSignalClasses(gmx::SimulationSignal     * sig,
                                           bool                        needSync,
                                           const t_inputrec          * ir,
                                           const t_commrec           * cr,
                                           const MdrunOptions         &mdrunOptions,
        ...
        static void deleteResetSignalClasses(ResetSignalSetter  ** setter,
                                             ResetSignalHandler ** handler);
