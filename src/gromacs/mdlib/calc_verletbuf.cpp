                                    ...
                                    real              chanceRequested)
{
    ...
    /* Boundary "atom" type, only bConstr=false is actually used.
     * All variances are set to zero since the boundary does not move.
     */
    atom_nonbonded_kinetic_prop_t propBoundary = { 0, 0, 0, false, 0, 0 };
    ...
    while (ib1 - ib0 > 1)
    {
         ...
         */
        pot_derivatives_t boundaryInteraction = { 1/cellSize, 0, 0 };
        ...
        for (int i = 0; i < natt; i++)
        {
            ...
            real chancePerAtom = energyDriftAtomPair(&propAtom, &propBoundary,
                                                     s2_2d + s2_3d, s2_2d, 0,
                                                     cellSize,
                                                     &boundaryInteraction);
