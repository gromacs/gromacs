...
VerletbufListSetup verletbufGetListSetup(int nbnxnKernelType)
{
        ...
        nbnxnKernelType == nbnxnk8x8x8_PlainC)
    {
        ...
        listSetup.cluster_size_i = nbnxn_kernel_to_cluster_i_size(nbnxnk8x8x8_GPU);
        listSetup.cluster_size_j = nbnxn_kernel_to_cluster_j_size(nbnxnk8x8x8_GPU)/2;
    }
    else
    {
...
VerletbufListSetup verletbufGetSafeListSetup(bool useSimdPairListWhenSupported,
                                             bool makeGpuPairList)
{
    ...
    else if (GMX_SIMD && useSimdPairListWhenSupported)
    {
