...
{
    private:
        std::unique_ptr<gmx::IInputRecExtension> efield;
    public:
        ElectricFieldTest()
        {
            efield = gmx::createElectricFieldModule();
        }
                  ...
                  real expectedValue)
        {
            ...
            else
            {
                ...
                snprintf(value, sizeof(value), "1 %g %g %g", omega, t0, sigma);
            ...
            // TODO: Is it possible at all to move a unique ptr to something else?
            // efield->calculateForces(NULL, &md, f, 0);
...
{
    test(true, 0, 1, 0, 0, 0, 0);
}

TEST_F(ElectricFieldTest, OldStatic)
{
    test(false, 0, 1, 0, 0, 0, 0);
}
