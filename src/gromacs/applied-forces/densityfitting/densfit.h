...
{
    public:
        explicit Densfit(const gmx::DensfitData &parameters);
        ~Densfit();
        ...
        //! done
        void do_densfit(real t, int64_t step, const t_commrec *cr,
        ...
        void add_forces(rvec *f, int64_t step, real time);
    ...
    private:
        ...
        std::unique_ptr<gmx::LocalDensfitData> localDensfitData_; //< variable, node-local data
