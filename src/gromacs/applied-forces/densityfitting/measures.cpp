...
real normalizeMap(GridDataFloat3D *map)
{
...
DensityCrossCorrelationMeasure::DensityCrossCorrelationMeasure(const GridDataFloat3D &referenceMap)
    :  hasNormalizedSimulatedMap(false),
      ...
      derivativeMap_(referenceMap.getGrid())
{

}

const GridDataFloat3D &DensityCrossCorrelationMeasure::densityDensityDerivative()
{
    return derivativeMap_;
}

void DensityCrossCorrelationMeasure::evaluateDensityDensityDerivative( const GridDataFloat3D &simulatedMap, real forceConstant)
{
...
real DensityCrossCorrelationMeasure::goodnessOfFit(
        const GridDataFloat3D &simulatedMap)
{
    normalizedSimulatedMap_         = simulatedMap;
    normlizationFactorSimulatedMap_ = normalizeMap(&normalizedSimulatedMap_);
...
DensityCrossEntropyMeasure::DensityCrossEntropyMeasure(const GridDataFloat3D
...
const GridDataFloat3D &DensityCrossEntropyMeasure::densityDensityDerivative()
{
    return derivativeMap_;
}

void DensityCrossEntropyMeasure::evaluateDensityDensityDerivative(const GridDataFloat3D &simulatedMap, real forceConstant)
{
    std::transform(
...
real DensityCrossEntropyMeasure::goodnessOfFit(const GridDataFloat3D &simulatedMap)
{
...
DensityMeanSquareDeviationMeasure::DensityMeanSquareDeviationMeasure(const
                                                                     GridDataFloat3D &referenceMap) : referenceMap_(referenceMap),
                                                                                                      derivativeMap_(referenceMap.getGrid()) {}

const GridDataFloat3D &DensityMeanSquareDeviationMeasure::densityDensityDerivative()
{
    return derivativeMap_;
}

void DensityMeanSquareDeviationMeasure::evaluateDensityDensityDerivative(
        const GridDataFloat3D &simulatedMap, real forceConstant)
{
    std::transform(
            std::begin(referenceMap_), std::end(referenceMap_),
            std::begin(simulatedMap),
