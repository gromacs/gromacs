...
void allocate_density_grid(const std::array<int, DIM> &nValues, std::vector<float> *vox)
{
...
real get_map_spacing(const t_mapdata &map, FILE *log)
{
    rvec spacing;
    real av_spacing;
...
double get_intersecting_length(double x11, double x12, double x21, double x22)
{
