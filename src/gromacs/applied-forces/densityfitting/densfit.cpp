                         ...
                         gmx_wallcycle *wcycle)
{
    ...
    if (MASTER(cr))
    {
        switch (parameters_->densityPotential())
        {
            case gmx::DensityPotential::CrossCorrelation:
                localDensfitData_->goodnessOfFit<gmx::gaussianLogLikelihoodFunctor>(parameters_->referenceMap());
                break;
            case gmx::DensityPotential::CrossEntropy:
                localDensfitData_->goodnessOfFit<gmx::poissonLogLikelihoodFunctor>(parameters_->referenceMap());
                break;
    ...
    {
        case gmx::DensityPotential::CrossCorrelation:
            localDensfitData_->densityDensityDerivative<gmx::gaussianLogLikelihoodFunctor>(parameters_->referenceMap());
            break;
        case gmx::DensityPotential::CrossEntropy:
            localDensfitData_->densityDensityDerivative<gmx::poissonLogLikelihoodFunctor>(parameters_->referenceMap());
            break;
        case gmx::DensityPotential::NumberOfPotentials:
        default:
            break;
