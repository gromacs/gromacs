...
void Densfit::add_forces(rvec *f, int64_t step, real time)
{
...
void Densfit::do_densfit(real t, int64_t step,
                         ...
                         gmx_wallcycle *wcycle)
{
    ...
    if (MASTER(cr))
    {
        localDensfitData_->goodnessOfFit();
    }

    localDensfitData_->densityDensityDerivative();
