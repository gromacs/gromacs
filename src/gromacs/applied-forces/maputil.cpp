...
// #define WITHCCP4 or use -DCMAKE_CXX_FLAGS=-DWITHCCP4
#ifdef WITHCCP4
...
typedef struct mapdata
{
    ...
    float              cell[6];
    int                grid[3];
//    int                origin[3]; // Commented out as cppcheck complained about unused member variable
    int                axes_order[3];
    int                map_dim[3];
//    int                spacegroup; // Commented out as cppcheck complained about unused member variable
    float              min, max;
    double             mean, rms;
//    float              skew_mat[9], skew_trans[3]; // Commented out as cppcheck complained about unused member variable
...
extern void do_map_ccp4(gmx_bool bRead, gmx_unused t_mapdata *map, const char *fn,
        ...
        t_densfit *densfit)
{
    ...
    double             left;
    real               ax, ay, az, ayaz;
    std::vector<float> sim_dens_1d; /* 1d array for 3d simulated density map          */
...
extern real calc_correlation_coeff(t_densfit *densfit, FILE *log)
{
    ...
    const t_mapdata &map_exp = densfit->map_ref; /* Reference map */
    const t_mapdata &map_sim = densfit->map_sim; /* Calculated map */
