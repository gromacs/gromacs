...
struct neutronStructureFactor {
    ...
    int         proton;        /* proton number */
    int         neutron;        /* neutron number */
    double      scatterLength; /* neutron scattering length*/
};
 ...
 */
struct CromerMan {
    std::vector<double> a; /* parameter a */
    std::vector<double> b; /* parameter b */
