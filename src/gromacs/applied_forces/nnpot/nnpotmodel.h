...
public:
     ...
     *   - atom pairs (std::vector<int>): pairs of atoms within cutoff range (rlist in .mdp file)
     *   - pair shifts (std::vector<RVec>): shifts of atom pairs for periodic boundary conditions
     */
    //! \{
