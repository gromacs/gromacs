...
/*! \internal \file
 * \brief
 * Declares gmx::FreeEnergyEstimate
 *
 * \author David van der Spoel <david.vanderspoel@icm.uu.se>
 * \ingroup module_energyanalysis
 */
#ifndef GMX_ENERGYANALYSIS_FREEENERGYESTIMATE_H
#define GMX_ENERGYANALYSIS_FREEENERGYESTIMATE_H
...
class FreeEnergyEstimate : public SimpleEnergy
{
    ...
    public:
        ...
        virtual ~FreeEnergyEstimate() {};

        //! Return pointer to the EnergyHelper for cleaner code downstream
        EnergyHelper *helper() { return &(eh_[fileIndex()]); }
