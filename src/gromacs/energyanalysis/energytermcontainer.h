...
/*! \libinternal \file
 * \brief
 * Declares gmx::energyanalysis::EnergyTermContainer
 *
 * \author David van der Spoel <david.vanderspoel@icm.uu.se>
 * \ingroup module_energyanalysis
 */
#ifndef GMX_ENERGYTERMCONTAINER_HELPER_H
#define GMX_ENERGYTERMCONTAINER_HELPER_H
 ...
 * \param[in] eBegin  Energy term begin iterator
