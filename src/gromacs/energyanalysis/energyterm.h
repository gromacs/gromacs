...
class EnergyTerm
{
    ...
    public:
         ...
         */
        void computeErrorEstimate(unsigned int nb);
         ...
         */
        double errorEstimate() const { return errorEstimate_; }
        ...
        /*! \brief Returns true when the drift has been calculated
         * \return whether the drift was computed or not
         */
        bool driftCalculated() const { return drift_; }
