...
class EnergyTerm
{
    ...
    public:
        ...
        //! Return the length of the data set in time
        gmx_int64_t nSteps() const { return 1 + (stepEnd() - stepBegin()); }
