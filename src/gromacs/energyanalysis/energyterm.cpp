...
void EnergyTerm::addFrame(double t, int64_t step, int nsum,
                          double esum, double evar, double e)
{
    ...
    if (storeData_)
    {
        ...
        ef_.emplace_back(t, step, e, nsum, esum, evar);
    }
...
EnergyFrameIterator EnergyTerm::findFrame(int64_t iframe) const
{
    if (storeData())
    {
