...
typedef boost::shared_ptr<EnergyAnalysis> EnergyAnalysisPointer;

//! Iterator over such pointers
typedef std::vector<EnergyAnalysisPointer>::iterator EnergyAnalysisPointerIterator;
