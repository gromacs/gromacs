...
#ifndef GMX_ENERGYANALYSIS_SELECTENERGY_H
#define GMX_ENERGYANALYSIS_SELECTENERGY_H
 ...
 * \param[in] nre The number of energies to choose from
 * \param[in] nm  The names of the energy terms
 * \param[out] nset The number of elements in the set
