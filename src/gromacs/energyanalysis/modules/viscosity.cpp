...
class ViscosityModule : public EnergyAnalysisModule
{
    public:
        ...
        void initOptions(IOptionsContainer                 *options,
                         ICommandLineOptionsModuleSettings *settings) virtual;

        void initAnalysis(ArrayRef<const EnergyNameUnit>  eNU,
                          const gmx_output_env_t         *oenv) virtual;

        void analyzeFrame(t_enxframe *fr, const gmx_output_env_t *oenv) virtual;

        void finalizeAnalysis(const gmx_output_env_t *oenv) virtual;

        void viewOutput(gmx_unused const gmx_output_env_t *oenv) virtual {}
