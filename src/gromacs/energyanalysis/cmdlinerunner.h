 ...
 */
#ifndef ENERGYANALYSIS_CMDLINERUNNER_H
#define ENERGYANALYSIS_CMDLINERUNNER_H
 ...
 * the ABI more stable.
 */
typedef EnergyAnalysisModulePointer (*ModuleFactoryMethod)();
...
class EnergyAnalysisCommandLineRunner
{
    public:
         ...
         */
        EnergyAnalysisCommandLineRunner(EnergyAnalysisModule *module);
    ...
    private:
         ...
         */
        template <class ModuleType> EnergyAnalysisModulePointer createModule()
        {
            return EnergyAnalysisModulePointer(new ModuleType());
        }
