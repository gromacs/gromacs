...
class FreeEnergyDifferenceModule : public EnergyAnalysisModule
{
    public:
         ...
         */
        virtual void initAnalysis(std::vector<energyNameUnit> &eNU);
                                             ...
                                             ICommandLineOptionsModuleSettings *settings)
{
    static const char *const desc[] = {
        ...
        "difference with an ideal gas state: [PAR]",
        "[GRK]Delta[grk] A = A(N,V,T) - A[SUB]idealgas[sub](N,V,T) = kT [LN][CHEVRON][EXP]U[SUB]pot[sub]/kT[exp][chevron][ln][PAR]",
        "[GRK]Delta[grk] G = G(N,p,T) - G[SUB]idealgas[sub](N,p,T) = kT [LN][CHEVRON][EXP]U[SUB]pot[sub]/kT[exp][chevron][ln][PAR]",
        ...
        "estimate using:[PAR]",
        "[GRK]Delta[grk] S(N,V,T) = S(N,V,T) - S[SUB]idealgas[sub](N,V,T) = ([CHEVRON]U[SUB]pot[sub][chevron] - [GRK]Delta[grk] A)/T[PAR]",
        ...
        "difference is calculated [PAR] dF = -kT [LN][CHEVRON][EXP]-(E[SUB]B[sub]-E[SUB]A[sub])/kT[exp][chevron][SUB]A[sub][ln] ,",
...
void FreeEnergyDifferenceModule::initAnalysis(std::vector<energyNameUnit> &eNU)
{
