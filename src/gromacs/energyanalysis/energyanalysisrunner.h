 ...
 */
class EnergyAnalysisRunner : public ICommandLineOptionsModule
{
    private:
        //! The energy files
    ...
    public:
         ...
         */
        EnergyAnalysisRunner(EnergyAnalysisModulePointer module);
...
typedef std::unique_ptr<EnergyAnalysisRunner> EnergyAnalysisRunnerPointer;
