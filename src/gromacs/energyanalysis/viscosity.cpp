                          ...
                          double fitparam[])
{
    ...
    for (int i = 1; (i < nout-1) && (maxima.size() < 10); i++)
    {
...
#define NLEG 2
    ...
    {
//! Number of acfs to create from the pressure tensor
#define NEINT 5
        real *eneint[NEINT];
...
#undef NEINT
    ...
    {
//! Number of elements from the pressure tensor to consider
#define NPCOMP 5
        ...
        if ((nout > 1) && (getFnPressureAcf().size() > 0))
        {
            ...
            {
                double bInt, sInt;
//! Number of pressure legend elements
#define NPLEG 4
