 ...
 * \param[in]  terms    If the length of this string is more than zero its contents
 *                      will be parsed rather than reading the selection from the terminal.
 * \returns             The array of indices
 */
std::vector<int> select_energies(std::vector<gmx::energyanalysis::energyNameUnit> &eNU,
                                 bool                                              bVerbose,
                                 gmx::TextInputStream                             *input);
