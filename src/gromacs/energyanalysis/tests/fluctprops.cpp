...
class FluctpropsTest : public gmx::test::CommandLineTestBase
{
    public:
        ...
        {
            const char *const command[] = { "fluctprops", "-nmol", "1000" };
            ...
            ICommandLineOptionsModulePointer runner(EnergyAnalysisRunner::createModule(FluctPropsInfo::create()));
...
{
    runTest("-convergence", "convergence.xvg");
}
