...
class DhdlTest : public gmx::test::CommandLineTestBase
{
    public:
        DhdlTest()
        {
        ...
        void runTest(const char *option, const char *filename)
        {
            ...
            ICommandLineOptionsModulePointer runner(EnergyAnalysisRunner::createModule(DhdlInfo::create()));
