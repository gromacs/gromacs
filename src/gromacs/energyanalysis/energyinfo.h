...
class EnergyInfo : public ICommandLineOptionsModule
{
    public:
        ...
        //! \copydoc ICommandLineOptionsModule::initOptions(IOptionsContainer *options, ICommandLineOptionsModuleSettings *settings)
        ...
        //! \copydoc ICommandLineOptionsModule::optionsFinished()
...
typedef std::unique_ptr<EnergyInfo> EnergyInfoPointer;
