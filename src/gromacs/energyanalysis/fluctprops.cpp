...
void FluctPropsModule::addDataSet(std::string &name)
{
...
void FluctPropsModule::initAnalysis(std::vector<std::string> &eName,
                                    std::vector<std::string> &eUnit)
{
...
ICommandLineOptionsModule *FluctPropsInfo::create()
{
