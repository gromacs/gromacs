...
class FluctPropsModule : public EnergyAnalysisModule
{
    public:
         ...
         */
        unsigned int addTerm(std::vector<energyNameUnit> *eNU,
                             const char                  *term);
...
unsigned int FluctPropsModule::addTerm(std::vector<energyNameUnit> *eNU,
                                       const char                  *term)
{
    unsigned int i = 0;
...
void FluctPropsModule::initAnalysis(std::vector<energyNameUnit> &eNU)
{
