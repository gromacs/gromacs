...
namespace gmx
{
class FluctProps : public EnergyAnalysisModule
{
    private:
...
FluctProps::FluctProps()
    : EnergyAnalysisModule(FluctPropsInfo::name, FluctPropsInfo::shortDescription)
{
    fc_         = NULL;
    iEnthalpy_  = INT_MAX;
    iVolume_    = INT_MAX;
...
{
    return EnergyAnalysisModulePointer(new FluctProps);
}
