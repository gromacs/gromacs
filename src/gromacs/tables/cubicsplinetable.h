...
class CubicSplineTable
{
    public:
        ...
        // These two are plain aggregates that are only used to simplify
        // the arguments to the constructors. Don't declare variables of this kind.

        //! \internal \brief Specification for analytical table function (name, function, derivative)
        struct AnalyticalFuncSpecType
        {
        ...
        //! \internal \brief Specification for vector table function (name, function, derivative)
        struct VectorFuncSpecType
        {
            const std::string                    &desc;       //!< Brief description of function
    ...
    public:
         ...
         *
         * \param funcSpecList Initializer list with one or more functions to tabulate,
         ...
         */
        CubicSplineTable(std::initializer_list<AnalyticalFuncSpecType>   funcSpecList,
         ...
         *       since you would waste a huge amount of memory.
         */
        CubicSplineTable(std::initializer_list<VectorFuncSpecType>   funcSpecList,
                         double                                      inputSpacing,
                         const std::pair<real, real>                &range,
                         real                                        tolerance = defaultTolerance);
