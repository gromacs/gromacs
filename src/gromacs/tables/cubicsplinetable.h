...
class CubicSplineTable
{
    ...
    public:
         ...
         */
        CubicSplineTable(const std::initializer_list<const AnalyticalFuncSpecType>   &funcSpecList,
         ...
         *       since you would waste a huge amount of memory.
         */
        CubicSplineTable(const std::initializer_list<const VectorFuncSpecType>   &funcSpecList,
                         double                                                   inputSpacing,
                         const std::pair<real, real>                             &range,
                         real                                                     tolerance = defaultTolerance);
