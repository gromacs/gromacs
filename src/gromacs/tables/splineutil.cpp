...
void
throwUnlessDerivativeIsConsistentWithFunction(const std::vector<double>    &function,
...
real
findSmallestQuotientOfFunctionAndThirdDerivative(const std::vector<double>    &function,
                                                 double                        inputSpacing,
                                                 const std::pair<real, real>   &range)
{
