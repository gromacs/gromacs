...
namespace gmx
{
/*! \brief Enumerated type to distinguish spline interpolations */
enum eSplineType {
    eSplineQuadratic, eSplineCubic
};
...
class SplineTable
{
    public:
        ...
        //! Return the spline type used to created the table
        eSplineType splineType() { return splineType_; }
