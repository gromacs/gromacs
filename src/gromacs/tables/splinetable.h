...
{
/*! \libinternal
 * \brief Pure class for spline tables
 */
class SplineTable
{
    public:
         ...
         * the spacing in the table is determined by whether forces
         * are present. If they are, the number of points is the same as
         * on input, otherwise the number is halved. Similarly spacing
         * will be doubled when no forces are present.
         *
         * \param[in] ntable     Number of data points in the input table
        ...
        virtual double force(double r) const = 0;
        ...
        GMX_DISALLOW_COPY_AND_ASSIGN(SplineTable);
};
...
{
    public:
        /*! \copydoc SplineTable::SplineTable(unsigned int  ntable,
         * double        dx,
         * const double *table_v,
         * const double *table_f);
         */
        ...
        /*! \brief Return the force at a distance r */
        virtual double force(double r) const;

        /*! \brief Return the energy at a distance r */
        virtual double energy(double r) const;

        /*! \brief Return table spacing (nm) */
        virtual double spacing() const { return tabSpacing_; }

        /*! \brief Return number of points in the table */
        virtual unsigned int size() const { return tabSize_; }
