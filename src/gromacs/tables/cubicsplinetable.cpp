...
CubicSplineTable::CubicSplineTable(std::initializer_list<AnalyticalFuncSpecType>   funcSpecList,
                                   const std::pair<real, real>                    &range,
                                   real                                            tolerance)
...
CubicSplineTable::CubicSplineTable(std::initializer_list<VectorFuncSpecType>   funcSpecList,
                                   double                                      inputSpacing,
                                   const std::pair<real, real>                &range,
                                   real                                        tolerance)
    : numFuncInTable_(funcSpecList.size()), range_(range)
