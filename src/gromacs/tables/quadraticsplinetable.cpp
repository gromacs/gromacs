 ...
 */
void
fillSingleQuadraticSplineTableData(const std::vector<double>             &function,
...
QuadraticSplineTable::QuadraticSplineTable(const std::initializer_list<const AnalyticalFuncSpecType>   &funcSpecList,
                                           const std::pair<real, real>                                 &range,
                                           real                                                         tolerance)
    : numFuncInTable_(funcSpecList.size()), range_(range)
{
    ...
    for (auto thisFuncSpec : funcSpecList)
    {
        ...
        {
            ex.prependContext("Error generating quadratic spline table for function '" + thisFuncSpec.desc + "'");
            throw;
        }
        ...
        double thisMinQuotient = internal::findSmallestQuotientOfFunctionAndSecondDerivative(thisFuncSpec.derivative, range_);
    ...
    for (auto thisFuncSpec : funcSpecList)
    {
        try
        {
            ...
            fillSingleQuadraticSplineTableData(thisFuncSpec.function,
...
QuadraticSplineTable::QuadraticSplineTable(const std::initializer_list<const VectorFuncSpecType>   &funcSpecList,
                                           double                                                   inputSpacing,
                                           const std::pair<real, real>                             &range,
                                           real                                                     tolerance)
    : numFuncInTable_(funcSpecList.size()), range_(range)
{
    ...
    for (auto thisFuncSpec : funcSpecList)
    {
        ...
        double thisMinQuotient = internal::findSmallestQuotientOfFunctionAndSecondDerivative(thisFuncSpec.derivative, inputSpacing, range_);
