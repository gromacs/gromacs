...
class QuadraticSplineTable
{
    ...
    public:
         ...
         */
        QuadraticSplineTable(std::initializer_list<AnalyticalFuncSpecType>    funcSpecList,
         ...
         *       since you would waste a huge amount of memory.
         */
        QuadraticSplineTable(std::initializer_list<VectorFuncSpecType>    funcSpecList,
                             double                                       inputSpacing,
                             const std::pair<real, real>                 &range,
                             real                                         tolerance = defaultTolerance);
