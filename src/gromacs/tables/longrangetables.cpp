...
double LongRangeInteractionTables::computeSpacing(int    type_coul,
...
double LongRangeInteractionTables::spacing() const
{
...
unsigned int LongRangeInteractionTables::size()
{
    if (NULL != tableCoulomb_)
    {
...
LongRangeInteractionTables::LongRangeInteractionTables(const LongRangeInteractionTables gmx_unused &L)
{
    tableCoulomb_ = NULL;
    if (NULL != L.coulomb())
    {
        tableCoulomb_ = new SplineTable(*(L.coulomb()));
    }
    tableVdw_ = NULL;
    if (NULL != L.vanderWaals())
    {
        tableVdw_ = new SplineTable(*(L.vanderWaals()));
    }
}
