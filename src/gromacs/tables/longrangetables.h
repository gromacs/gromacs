 ...
 */
class LongRangeCorrectionTables
{
    public:
        /*! \brief Constructor
         *
         ...
         */
        LongRangeCorrectionTables(int                               type_coul,
        ...
        const QuadraticSplineTable *coulomb() const { return tableCoulomb_; }
        //! Return the Van der Waals table class
        const QuadraticSplineTable *vanderWaals() const { return tableVdw_; }
    private:
        /*! \brief Internal function to compute table spacing
         *
         * \param[in] type_coul       The electrostatics type
         * \param[in] ewaldcoeff_coul The coefficient for Coulomb
         * \param[in] r_coul          The Coulomb cut-off (switching distance)
         ...
         * \param[in] ewaldcoeff_vdw  The coefficient for Van der Waals
         * \param[in] r_vdw           The Van der Waals cut-off (switching distance)
         * \return The table spacing
         */
        double computeSpacing(int    type_coul,
                              double ewaldcoeff_coul,
                              double r_coul,
                              int    type_vdw,
                              double ewaldcoeff_vdw,
         ...
         */
        QuadraticSplineTable         *tableCoulomb_;
         ...
         */
        QuadraticSplineTable         *tableVdw_;

        GMX_DISALLOW_COPY_AND_ASSIGN(LongRangeCorrectionTables);
};
