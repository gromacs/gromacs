...
/*! \file
 * \brief
 * Declares utilities for initializing long range correction tables
 *
...
/*! \brief Function to compute table spacing for long range corrections
 *
