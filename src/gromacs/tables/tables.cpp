                               ...
                               int                             stride)
{
    ...
    /* Allocate memory */
    snew_aligned(*table_f, ntab+32, 32);
    snew_aligned(*table_v, ntab+32, 32);
    snew_aligned(*table_fdv0, 4*ntab+32, 32);
...
InteractionTables::~InteractionTables()
{
    sfree_aligned(tabCoulF_);
    sfree_aligned(tabCoulV_);
    sfree_aligned(tabCoulFDV0_);
    sfree_aligned(tabVdwF_);
    sfree_aligned(tabVdwV_);
    sfree_aligned(tabVdwFDV0_);
}
