 ...
 */
void InteractionTables::fillEwaldSpline3(double                         *params,
                                         EwaldType                       et,
 ...
 */
InteractionTables::InteractionTables(int  eeltype,
                                     real ewaldcoeff_q,
                                     real rcoulomb,
                                     int  vdwtype,
                                     real ewaldcoeff_lj,
                                     real rvdw)
{
    ...
    tabScale_  = 1.0/sc;
    tabLength_ = std::max(rcoulomb, rvdw);
}
