...
class LongRangeCorrectionTableTest : public ::testing::Test
{
    protected:
        test::TestReferenceData        refData_;
        test::TestReferenceChecker     checker_;
        LongRangeCorrectionTableTest( )
...
TEST_F(LongRangeCorrectionTableTest, QEwald)
{
    const double beta = 3.0;
    testTable(v_q_ewald_lr, &beta);
}

TEST_F(LongRangeCorrectionTableTest, LJEwald)
{
    const double beta = 3;
