                        ...
                        EVDW_PME(vdwtype))
                    {
                        for (int rc = 8; (rc <= 16); rc += 2)
                        {
                            ...
                            for (int rv = 8; (rv <= 16); rv += 2)
                            {
                                double                     rvdw = 0.1*rv;
                                char                       buf[256];
                                LongRangeCorrectionTables  it(eeltype,
                                                              ewaldcoeff_q,
                                                              rcoulomb,
                                                              &ewaldcoeff_q,
                                                              v_q_ewald_lr,
                                ...
                                snprintf(buf, sizeof(buf),
                                         ...
                                         evdw_names[vdwtype],
                                         rvdw);
                                checker_.checkDouble(it.spacing(), buf);
                            }
                        }
                    }
                }
