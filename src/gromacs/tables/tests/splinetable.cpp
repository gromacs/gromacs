...
class QuadraticSplineTableTest : public ::testing::Test
{
    protected:
        ...
        void testQuadraticSplineTableV(int           ntable,
                                       double        dx,
                              ...
                              const double *table_in_v)
        {
            ...
            double rr[4] = { 0.123, 0.371, 0.478, 0.511 };
            double toler = 1e-4;
        ...
        void testQuadraticSplineTableVF(int           ntable,
                                        double        dx,
                                        const double *table_in_v,
...
TEST_F(QuadraticSplineTableTest, VHarmonic)
{
    ...
    testQuadraticSplineTableV(8, dx, v);
...
TEST_F(QuadraticSplineTableTest, VFHarmonic)
{
    ...
    testQuadraticSplineTableVF(8, dx, v, f);
}
