...
class ArrayTest : public ::testing::Test
{
    protected:
                       ...
                       real rvdw)
        {
            ...
            it.fillEwaldSpline3(ntab, &beta_q, etCoulomb, v_q_ewald_lr);
            double beta_lj = ewaldcoeff_lj;
            it.fillEwaldSpline3(ntab, &beta_lj, etLJ, v_lj_ewald_lr);
            checker_.checkSequence(it.coulombF().begin(),
                                   it.coulombF().end(), "coulombF");
            checker_.checkSequence(it.coulombV().begin(),
                                   it.coulombV().end(), "coulombV");
            checker_.checkSequence(it.coulombFDV0().begin(),
                                   it.coulombFDV0().end(), "coulombFDV0");
            checker_.checkSequence(it.vdwF().begin(),
                                   it.vdwF().end(), "vdwF");
            checker_.checkSequence(it.vdwV().begin(),
                                   it.vdwV().end(), "vdwV");
            checker_.checkSequence(it.vdwFDV0().begin(),
                                   it.vdwFDV0().end(), "vdwFDV0");
        }
};
