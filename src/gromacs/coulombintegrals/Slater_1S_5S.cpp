...
double Slater_1S_5S(double r, double xi, double xj)
{
    double S, rxi, rxj;
    ...
    if (xi == xj)
    {
        ...
        {
            S = (1/r)*((-1596672000 + 1596672000*exp(2*rxi) - 2875101075*rxi -

                          2556858150*power(rxi, 2) - 1492929900*power(rxi, 3) -

                          641163600*power(rxi, 4) - 214719120*power(rxi, 5) -

                          57879360*power(rxi, 6) - 12735360*power(rxi, 7) - 2280960*power(rxi, 8) -

                          323840*power(rxi, 9) - 33792*power(rxi, 10) - 2048*power(rxi, 11))/

                         (1.596672e9*exp(2*rxi))
    ...
    else
    {
        if (r == 0)
        {
            S = (xi*xj*(power(xi, 10) + 11*power(xi, 9)*xj + 55*power(xi, 8)*power(xj, 2) +

                        165*power(xi, 7)*power(xj, 3) + 330*power(xi, 6)*power(xj, 4) +

                        462*power(xi, 5)*power(xj, 5) + 462*power(xi, 4)*power(xj, 6) +

                        330*power(xi, 3)*power(xj, 7) + 165*power(xi, 2)*power(xj, 8) +

                        55*xi*power(xj, 9) + 5*power(xj, 10)))/(5*power(xi + xj, 11))

            ;
        }
        else
        {
            S = (1/r)*((14175*exp(2*(rxi + rxj))*power(power(rxi, 2) - power(rxj, 2), 11) +

                          2835*exp(2*rxj)*power(rxj, 12)*

                          (-35*power(rxi, 10) - 5*power(rxi, 11) - 495*power(rxi, 8)*power(rxj, 2) -

                           55*power(rxi, 9)*power(rxj, 2) - 1254*power(rxi, 6)*power(rxj, 4) -

                           66*power(rxi, 7)*power(rxj, 4) - 726*power(rxi, 4)*power(rxj, 6) +

                           66*power(rxi, 5)*power(rxj, 6) - 55*power(rxi, 2)*power(rxj, 8) +

                           55*power(rxi, 3)*power(rxj, 8) + 5*power(rxj, 10) + 5*rxi*power(rxj, 10))

                          - exp(2*rxi)*power(rxi, 4)*(power(rxi, 18)*

                                                          (14175 + 25515*rxj + 22680*power(rxj, 2) + 13230*power(rxj, 3) +

                                                           5670*power(rxj, 4) + 1890*power(rxj, 5) + 504*power(rxj, 6) +

                                                           108*power(rxj, 7) + 18*power(rxj, 8) + 2*power(rxj, 9)) -

                                                          9*power(rxi, 16)*power(rxj, 2)*

                                                          (17325 + 31185*rxj + 27720*power(rxj, 2) + 16170*power(rxj, 3) +

                                                           6930*power(rxj, 4) + 2310*power(rxj, 5) + 616*power(rxj, 6) +

                                                           132*power(rxj, 7) + 22*power(rxj, 8) + 2*power(rxj, 9)) +

                                                          126*power(rxi, 10)*power(rxj, 8)*

                                                          (37125 + 66825*rxj + 59400*power(rxj, 2) + 34725*power(rxj, 3) +

                                                           14625*power(rxj, 4) + 5043*power(rxj, 5) + 1396*power(rxj, 6) +

                                                           276*power(rxj, 7) + 34*power(rxj, 8) + 2*power(rxj, 9)) -

                                                          126*power(rxi, 8)*power(rxj, 10)*

                                                          (51975 + 93420*rxj + 84240*power(rxj, 2) + 46815*power(rxj, 3) +

                                                           20835*power(rxj, 4) + 7485*power(rxj, 5) + 1964*power(rxj, 6) +

                                                           348*power(rxj, 7) + 38*power(rxj, 8) + 2*power(rxj, 9)) +

                                                          9*power(rxi, 2)*power(rxj, 16)*

                                                          (-135135 + 405405*rxj + 582120*power(rxj, 2) + 346500*power(rxj, 3) +

                                                           124740*power(rxj, 4) + 30492*power(rxj, 5) + 5264*power(rxj, 6) +

                                                           636*power(rxj, 7) + 50*power(rxj, 8) + 2*power(rxj, 9)) -

                                                          power(rxj, 18)*(2837835 + 3648645*rxj + 2245320*power(rxj, 2) +

                                                                            873180*power(rxj, 3) + 238140*power(rxj, 4) + 47628*power(rxj, 5) +

                                                                            7056*power(rxj, 6) + 756*power(rxj, 7) + 54*power(rxj, 8) +

                                                                            2*power(rxj, 9)) + 9*power(rxi, 14)*power(rxj, 4)*

                                                          (86625 + 155925*rxj + 138600*power(rxj, 2) + 80850*power(rxj, 3) +

                                                           34650*power(rxj, 4) + 11550*power(rxj, 5) + 3080*power(rxj, 6) +

                                                           672*power(rxj, 7) + 104*power(rxj, 8) + 8*power(rxj, 9)) -

                                                          21*power(rxi, 12)*power(rxj, 6)*

                                                          (111375 + 200475*rxj + 178200*power(rxj, 2) + 103950*power(rxj, 3) +

                                                           44550*power(rxj, 4) + 14778*power(rxj, 5) + 4056*power(rxj, 6) +

                                                           864*power(rxj, 7) + 120*power(rxj, 8) + 8*power(rxj, 9)) +

                                                          21*power(rxi, 6)*power(rxj, 12)*

                                                          (307125 + 594945*rxj + 456840*power(rxj, 2) + 281790*power(rxj, 3) +

                                                           137430*power(rxj, 4) + 47250*power(rxj, 5) + 11064*power(rxj, 6) +

                                                           1728*power(rxj, 7) + 168*power(rxj, 8) + 8*power(rxj, 9)) -

                                                          9*power(rxi, 4)*power(rxj, 14)*

                                                          (675675 + 675675*rxj + 748440*power(rxj, 2) + 561330*power(rxj, 3) +

                                                           256410*power(rxj, 4) + 76230*power(rxj, 5) + 15400*power(rxj, 6) +

                                                           2112*power(rxj, 7) + 184*power(rxj, 8) + 8*power(rxj, 9))))/

                         (14175*exp(2*(rxi + rxj))*power(rxi - rxj, 11)*power(rxi + rxj, 11))
...
double Slater_5S_1S(double r, double xi, double xj)
{
    return Slater_1S_5S(r, xj, xi);
}
