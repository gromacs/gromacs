...
cl_R Slater_6S_6S(cl_R r,cl_R xi,cl_R xj)
{
  ...
  rxj = r*xj;
  if (xi == xj) {
        if (r == 0LL) {  S = (1172755LL*xi)/8.388608e6

    ; } else {  S = (1LL/r)*(1LL + (-1LL - (15604461LL*rxi)/8.388608e6 - (7215853LL*Power(rxi,2LL))/4.194304e6 - 
      ...
      if (r == 0LL) { S = (xi*xj*(Power(xi,22LL) + 23LL*Power(xi,21LL)*xj + 253LL*Power(xi,20LL)*Power(xj,2LL) + 
    ...
    ; } else { S = (1LL/r)*((2806650LL*exp(2LL*(rxi + rxj))*Power(Power(rxi,2LL) - Power(rxj,2LL),23LL) + 
