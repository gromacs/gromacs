...
cl_R Slater_1S_6S(cl_R r,cl_R xi,cl_R xj)
{
  ...
  rxj = r*xj;
  if (xi == xj) {
        if (r == 0LL) {  S = (341LL*xi)/2048LL

    ; } else {  S = (1LL/r)*((-74724249600LL + 74724249600LL*exp(2LL*rxi) - 137006619750LL*rxi - 
      ...
      if (r == 0LL) { S = (xi*xj*(Power(xi,12LL) + 13LL*Power(xi,11LL)*xj + 78LL*Power(xi,10LL)*Power(xj,2LL) + 
    ...
    ; } else { S = (1LL/r)*((935550LL*exp(2LL*(rxi + rxj))*Power(Power(rxi,2LL) - Power(rxj,2LL),13LL) + 
