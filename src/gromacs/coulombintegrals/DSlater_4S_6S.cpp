...
cl_R DSlater_4S_6S(cl_R r,cl_R xi,cl_R xj)
{
  ...
  if (xi == xj) {
    ...
    ; } else {  S = -(-(1e9*cl_float(537882537,precision)+342262612LL)*xi + (1e9*cl_float(583896481,precision)+962393600LL)*exp(2LL*r*xi)*xi - 
    ...
    ; } else {  S = (1871100LL*exp(2LL*r*(xi + xj))*Power(Power(xi,2LL) - Power(xj,2LL),19LL) + 
