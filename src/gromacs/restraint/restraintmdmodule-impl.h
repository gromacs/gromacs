 ...
 * \ingroup module_restraint
 */
class RestraintOptionProvider final : public gmx::IMdpOptionProvider
{
    public:
        ~RestraintOptionProvider() override = default;
 ...
 * \ingroup module_restraint
 */
class RestraintOutputProvider final : public gmx::IMDOutputProvider
{
    public:
        ~RestraintOutputProvider() override = default;
