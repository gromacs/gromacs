...
std::mutex ManagerImpl::initializationMutex_ {};
...
Manager::Manager() : instance_(std::make_shared<ManagerImpl>()) {};

Manager::~Manager() = default;

void ManagerImpl::clear() noexcept
{
...
std::vector< std::shared_ptr<IRestraintPotential> > Manager::getRestraints() const
{
