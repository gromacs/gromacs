...
// The restraint manager should only have "addToSpec" called on the master thread
// and there should be thread synchronization before non-master threads call
// countRestraints() (or they shouldn't call it).
// TODO: the following tests should be enabled when we have thread awareness in tests
// or when this test is allowed to depend on gmxapi.
