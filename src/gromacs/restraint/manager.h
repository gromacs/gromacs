 ...
 *
 * A simulation runner owns one manager resource to hold restraint object used
...
class Manager final
{
    public:
        ...
        Manager              &operator=(Manager &&manager) noexcept = default;
        /*! \} */
    ...
    private:
        ...
        std::shared_ptr<ManagerImpl> instance_;
};
