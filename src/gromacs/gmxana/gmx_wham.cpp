...
typedef struct
{
    ...
    int                                tabNbins;
    /*!\}*/
    gmx::ThreeFry2x64<>                rng;                 //!< gromacs random number generator
...
void getRandomIntArray(int nPull, int blockLength, int* randomArray, gmx::ThreeFry2x64<> rng)
{
                      ...
                      t_UmbrellaWindow * window, int nWindows, t_UmbrellaOptions *opt)
{
    ...
    opt->rng.seed({static_cast<gmx_uint64_t>(opt->bsSeed), gmx::RandomDomain_Other});
