...
/*! \internal \brief Struct containing properties of protein backbones. */
struct t_bb {
    //! Protein backbone phi angle.
    real     phi;
    //! Protein backbone psi angle.
    real     psi;
    //! RMS value for backbone between frames.
    real     pprms2;
    //! Unknown float.
    real     jcaha;
    ...
    gmx_bool bHelix;
    //! Number of helix elements.
    int      nhx;
    //! Number of rms calculations.
    int      nrms;
