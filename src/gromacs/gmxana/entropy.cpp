                  ...
                  int              nskip_eigval)
{
    ...
    switch (algorithm)
    {
        case eaQuasiHarmonic:
            S = calc_entropy_qh(n-nskip_eigval, eigval+nskip_eigval, temperature);
            break;
        case eaSchlitter:
            S = calc_entropy_schlitter(n-nskip_eigval, eigval+nskip_eigval, temperature);
            break;
    }
    return S;
}
