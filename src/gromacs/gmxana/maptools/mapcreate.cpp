...
class MapCreate final : public ICommandLineOptionsModule
{
    public:
...
const char * const MapCreate::helpText_[] = {
    "[THISMODULE] creates a new density map. The map may be filled"
...
void MapCreate::initOptions(IOptionsContainer* options, ICommandLineOptionsModuleSettings *settings)
{
...
void MapCreate::init(CommandLineModuleSettings * /*settings*/)
{}
...
const char mapcreateInfo::shortDescription[] = "Create a density map";
const char mapcreateInfo::name[]             = "mapcreate";
ICommandLineOptionsModulePointer mapcreateInfo::create()
{
    return compat::make_unique<MapCreate>();
}
