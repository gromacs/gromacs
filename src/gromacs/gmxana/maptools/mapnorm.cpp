...
class MapNorm final : public ICommandLineOptionsModule
{
    public:
...
const char * const MapNorm::helpText_[] = {
    "[THISMODULE] normalizes density maps to zero mean and unit standard deviation"
};
void MapNorm::init(CommandLineModuleSettings * /*settings*/)
{
}
void MapNorm::initOptions(IOptionsContainer* options, ICommandLineOptionsModuleSettings *settings)
{
...
const char mapnormInfo::shortDescription[] = "Normalise density maps";
const char mapnormInfo::name[]             = "mapnorm";
ICommandLineOptionsModulePointer mapnormInfo::create()
{
    return compat::make_unique<MapNorm>();
}
