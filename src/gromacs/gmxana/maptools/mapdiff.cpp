...
class MapDiff final : public ICommandLineOptionsModule
{
    public:
...
const char * const MapDiff::helpText_[] = {
    "[THISMODULE] calculates the linear combination of density maps."
...
void MapDiff::init(CommandLineModuleSettings * /*settings*/)
{}

void MapDiff::initOptions(IOptionsContainer* options, ICommandLineOptionsModuleSettings *settings)
{
...
const char mapdiffInfo::shortDescription[] = "Difference between density maps";
const char mapdiffInfo::name[]             = "mapdiff";
ICommandLineOptionsModulePointer mapdiffInfo::create()
{
    return compat::make_unique<MapDiff>();
}
