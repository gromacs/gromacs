...
#define NFILE asize(fnm)
    ...
    for (t = 0; (t < VEL_NR); t++)
    {
        ...
        if (V_V != t)
        {
            ...
            dp[t].ttdf  = evaluate_integral(nfreq, nu, dos[t], NULL, 0, &stddev);
        ...
        dp[t].dostot = evaluate_integral(nfreq, nu, dos[t], NULL, 0, &stddev);
    ...
    for (t = 0; (t <= VEL_TOT); t++)
    {
        ...
        dp[t].E0  = dp[t].Emd/top.mols.nr - dp[t].Ec;
