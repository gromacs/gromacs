...
class TrjpbcWithIndexGroupSubset : public gmx::test::CommandLineTestBase,
                                    public ::testing::WithParamInterface<const char *>
{
    public:
        void runTest(const char *fileName)
        {
            ...
            ASSERT_EQ(0, gmx_trjpbc(cmdline.argc(), cmdline.argv()));
        }
};
...
TEST_P(TrjpbcWithIndexGroupSubset, WithDifferentInputFormats)
{
    runTest(GetParam());
}
