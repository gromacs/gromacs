...
typedef struct {
    ...
    double      A, B, C; /* Karplus coefficients */
    double      offset;  /* Offset for dihedral angle in histogram (e.g. -M_PI/3) */
    double      Jc;      /* Resulting Jcoupling */
    double      Jcsig;   /* Standard deviation in Jc */
} t_karplus;
