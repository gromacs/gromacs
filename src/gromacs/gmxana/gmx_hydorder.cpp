...
/* Loop over frames*/
    do
    {
        ...
        if (framenr%tblock == 0 && sk_4d != NULL)
        {
...
#define NFILE asize(fnm)
    ...
    /* Calculate axis */
    if (normal_axis[0] != NULL && std::strcmp(normal_axis[0], "x") == 0)
    {
        axis = XX;
    }
    else if (normal_axis[0] != NULL && std::strcmp(normal_axis[0], "y") == 0)
    {
        axis = YY;
    }
    else if (normal_axis[0] != NULL && std::strcmp(normal_axis[0], "z") == 0)
    {
        axis = ZZ;
    }
    else
