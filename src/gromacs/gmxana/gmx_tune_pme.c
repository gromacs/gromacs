...
enum {
    ...
    eParselogNoDdGrid,
    eParselogMdrunTpxVersionConflict,
    ...
    while (fgets(line, STRLEN, fp) != NULL)
    {
        ...
        switch (iFound)
        {
            case eFoundNothing:
                ...
                {
                    fclose(fp);
                    return eParselogMdrunTpxVersionConflict;
                }
            ...
            case eFoundDdStr:
                ...
                {
                    sscanf(&line[strlen(matchstrbal)], "%f", &(perfdata->pmeForceLoad[test_nr]));
                }
            ...
            case eFoundAccountingStr:
                ...
                {
                    sscanf(line, "Total %*f %lf", &(perfdata->numGigaCycles[test_nr]));
...
/* TODO This check is really for a functional .tpr, and if we need it,
...
/* TODO -npme 0 is more likely to succeed at low parallelism than the
                                                      ...
                                                      * constructing mdrun command lines */
{
    ...
    const char* ParseLog[] = {
        ...
        "Conflict between mdrun and .tpr version!",
