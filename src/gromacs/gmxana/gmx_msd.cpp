...
int gmx_msd(int argc, char *argv[])
{
    ...
    t_pargs            pa[]       = {
        ...
        { "-lateral", FALSE, etENUM, { axtitle }, "Calculate the lateral diffusion in a plane perpendicular to" },
        ...
        { "-beginfit", FALSE, etTIME, { &beginfit }, "Start time for fitting the MSD (%t), -1 is 10%" },
