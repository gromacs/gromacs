...
#include "gromacs/math/fca/fca.h"
...
int gmx_fca(int argc, char* argv[])
{
    ...
    if (mpi.isMaster())
    {
                              ...
                              asize(fnm), fnm, asize(pa), pa, asize(desc), desc, 0, nullptr, &oenv) )
        {
            ...
            if (opt2bSet("-f", asize(fnm), fnm) && opt2bSet("-v", asize(fnm), fnm))
            {
                ...
                eigVecManager = gmx::compat::make_unique<FcaEigenVec>(opt2fn_null("-v", asize(fnm), fnm),
                                                                      ftp2fn(efTPS, asize(fnm), fnm),
                                                                      ftp2fn_null(efNDX, asize(fnm), fnm), nullptr);
    ...
    if (bWriteMI)
    {
        ...
        {
            ThreeFry2x64<64> rng(123456, RandomDomain::Other);
