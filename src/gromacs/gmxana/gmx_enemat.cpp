...
#define NFILE asize(fnm)
    ...
    if (n == 0)
    {
        ...
        fprintf(stderr,
                "None of the specified energy groups were not found in this .edr \n"
                "file. Perhaps you used the wrong groups, the wrong files, or didn't \n"
                "use a .tpr that was made from an .mdp file that specified these \n"
                "energy groups.");
        return 1;
    }
    nset = n;
