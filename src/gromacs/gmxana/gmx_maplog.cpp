...
class MapLog final : public ToolRunner
{
    public:
...
void MapLog::initOptions(gmx::Options *options)
{
    setHelpText("[THISMODULE] calculates the logarithm of a density map. When"
...
{
    return gmx::MapLog().run(argc, argv);
}
