...
#define NFILE asize(fnm)
    ...
    if (bOV && fr.bV == FALSE)
    {
        gmx_fatal(FARGS, "Cannot write velocities since your input file does not contain velocities.");
    }
    if (bOF && fr.bF == FALSE)
    {
        gmx_fatal(FARGS, "Cannot write forces since your input file does not contain forces.");
    }
