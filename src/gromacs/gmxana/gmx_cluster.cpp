...
static int rms_dist_comp(const t_dist &a, const t_dist &b)
{
    return a.dist < b.dist;
}

static int clust_id_comp(const t_clustid &a, const t_clustid &b)
{
    return a.clust < b.clust;
}

static int nrnb_comp(const t_nnb &a, const t_nnb &b)
{
