...
#define NFILE asize(fnm)
    ...
    tel_mat = 0;
    teller  = 0;
    gmx::StructureSimilarityMeasure::comparisonFunction similarityMeasure;
    if (ewhat == ewRMSD)
    {
        similarityMeasure = gmx::StructureSimilarityMeasure::rmsd;
    }
    else
    {
        similarityMeasure = gmx::StructureSimilarityMeasure::sizeIndependentRho;
    }
