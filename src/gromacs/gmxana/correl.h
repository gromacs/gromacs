 ...
 * \param[in] nframes Number of valid data points in the data
 * \param[in] nfft    Length of the data arrays. The arrays will be zero padded before ACF.
 * \param[in] c       Data array of nfunc x nfft, will also be used for output
 * \return fft error code, or zero if everything went fine (see fft/fft.h)
 */
extern int many_auto_correl(int nfunc, int nframes, int nfft, real **c);
