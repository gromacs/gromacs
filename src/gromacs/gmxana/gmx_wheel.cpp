...
static void wheel(const std::string &fn, int nres, char *resnm[], int r0, real rot0, char *title)
{
...
static void wheel2(const std::string &fn, int nres, char *resnm[], real rot0, char *title)
{
