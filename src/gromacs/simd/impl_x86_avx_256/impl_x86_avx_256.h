...
gmx_simd_cvt_fb2dbdb_avx_256(__m256 f, __m256d *d0, __m256d *d1)
{
    ...
    *d0 = _mm256_castps_pd(_mm256_permute2f128_ps(t1, t2, 0x20));
    *d1 = _mm256_castps_pd(_mm256_permute2f128_ps(t1, t2, 0x31));
}
...
{
    __m256 t0, t1, t2;
    t0 = _mm256_permute2f128_ps( _mm256_castpd_ps(d0), _mm256_castpd_ps(d1), 0x21);
    t1 = _mm256_shuffle_ps(_mm256_castpd_ps(d0), t0, _MM_SHUFFLE(3, 1, 3, 1));
    t2 = _mm256_shuffle_ps(t0, _mm256_castpd_ps(d1), _MM_SHUFFLE(3, 1, 3, 1));
    return _mm256_blend_ps(t1, t2, 0xF0);
}
