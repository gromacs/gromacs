...
#define GMX_SIMD4_HAVE_LOAD3
#define GMX_SIMD4_HAVE_STORE3
#define GMX_SIMD4_HAVE_SIMD_TRANSPOSE
...
#define gmx_simd4_load3_f(a)       _mm_maskload_ps(a, _mm_set_epi32(0, -1, -1, -1))
#define gmx_simd4_store3_f(a, b)   _mm_maskstore_ps(a, _mm_set_epi32(0, -1, -1, -1), b)
...
/*! \brief Transpose the matrix formed by only first four elements of
 * the four input vectors.
 *
 * Upon output, the contents of elements after the first four are
 * undefined. */
...
#define gmx_simd4_load3_d(a)        _mm256_maskload_pd(a, _mm256_set_epi32(0, 0, -1, -1, -1, -1, -1, -1))
#define gmx_simd4_store3_d(a, b)    _mm256_maskstore_pd(a, _mm256_set_epi32(0, 0, -1, -1, -1, -1, -1, -1), b)
...
/* Internal functions used in rvec_operations.h */
#if (defined GMX_DOUBLE) || (defined DOXYGEN)

#  define gmx_simd4_load3_r              gmx_simd4_load3_d
#  define gmx_simd4_store3_r             gmx_simd4_store3_d
 ...
 */
#  define gmx_simd4_load3_r              gmx_simd4_load3_f
 ...
 */
#  define gmx_simd4_store3_r             gmx_simd4_store3_f
