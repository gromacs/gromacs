...
#    define gmx_simd_rcp_mask_f(a, m)        _mm256_and_ps(_mm256_rcp_ps(gmx_simd_blendv_f(_mm256_set1_ps(1.0f), a, m)), m)
#    define gmx_simd_rsqrt_mask_f(a, m)      _mm256_and_ps(_mm256_rsqrt_ps(gmx_simd_blendv_f(_mm256_set1_ps(1.0f), a, m)), m)
#endif
...
#else
/* For masked rcp/rsqrt we need to make sure we do not use the masked-out arguments if FP exceptions are enabled */
#    define gmx_simd_rcp_mask_d(a, m)        _mm256_and_pd(gmx_simd_rcp_d(gmx256_simd_blendv_d(_mm256_set1_pd(1.0), a, m)), m)
#    define gmx_simd_rsqrt_mask_d(a, m)      _mm256_and_pd(gmx_simd_rsqrt_d(gmx256_simd_blendv_d(_mm256_set1_pd(1.0), a, m)), m)
#endif
...
#define gmx_simd_cvt_fb2dbdb       gmx_simd_cvt_fb2dbdb_avx_256
#define gmx_simd_cvt_dbdb2fb       gmx_simd_cvt_dbdb2fb_avx_256
/* Higher-level utility functions */
...
static gmx_inline void gmx_simdcall
gmx_simd_cvt_fb2dbdb_avx_256(__m256 f, __m256d *d0, __m256d *d1)
{
    __m256 t1, t2;
    t1  = _mm256_unpacklo_ps(f, f);
    t2  = _mm256_unpackhi_ps(f, f);
    *d0 = _mm256_permute2f128_ps(t1, t2, 0x20);
    *d1 = _mm256_permute2f128_ps(t1, t2, 0x31);
}

static gmx_inline __m256 gmx_simdcall
gmx_simd_cvt_dbdb2fb_avx_256(__m256d d0, __m256d d1)
{
    __m256d t0 = _mm256_permute2f128_ps(d0, d1, 0x21);
    d0 = _mm256_shuffle_ps(d0, t0, _MM_SHUFFLE(3, 1, 3, 1));
    d1 = _mm256_shuffle_ps(t0, d1, _MM_SHUFFLE(3, 1, 3, 1));
    return _mm256_blend_ps(d0, d1, 0xF0);
}
...
{
    __m256 t0 = _mm256_permute2f128_pd(scalar, scalar, 0x21);
    __m256 t1 = _mm256_permute_pd(scalar, 0b0000);
    __m256 t2 = _mm256_permute_pd(scalar, 0b1111);
