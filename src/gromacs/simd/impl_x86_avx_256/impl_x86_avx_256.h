...
#define gmx_simd_load_fi(m)        _mm256_castps_si256(_mm256_load_ps((float *)m))
#define gmx_simd_set1_fi           _mm256_set1_epi32
#define gmx_simd_store_fi(m, x)     _mm256_store_ps((float *)m, _mm256_castsi256_ps(x))
#define gmx_simd_loadu_fi(m)       _mm256_castps_si256(_mm256_loadu_ps((float *)m))
...
#define gmx_simd_load_di(m)        _mm_load_si128((__m128i *)m)
#define gmx_simd_set1_di           _mm_set1_epi32
#define gmx_simd_store_di(m, x)     _mm_store_si128((__m128i *)m, x)
#define gmx_simd_loadu_di(m)       _mm_loadu_si128((__m128i *)m)
