                      ...
                      SimdFloat            v2)
{
    ...
    avx256Transpose3By4InLanes(&v0.simdInternal_, &v1.simdInternal_, &v2.simdInternal_, &tv3);
    t0          = _mm256_add_ps(t0, v0.simdInternal_);
    t1          = _mm256_add_ps(t1, v1.simdInternal_);
    t2          = _mm256_add_ps(t2, v2.simdInternal_);
                      ...
                      SimdFloat            v2)
{
    ...
    avx256Transpose3By4InLanes(&v0.simdInternal_, &v1.simdInternal_, &v2.simdInternal_, &tv3);
    t0          = _mm256_sub_ps(t0, v0.simdInternal_);
    t1          = _mm256_sub_ps(t1, v1.simdInternal_);
    t2          = _mm256_sub_ps(t2, v2.simdInternal_);
