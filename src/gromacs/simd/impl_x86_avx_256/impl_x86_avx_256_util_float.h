                      ...
                      SimdFloat            v2)
{
    ...
    t6 = _mm256_extractf128_ps(v2.simdInternal_, 0x1);
    t7 = _mm256_extractf128_ps(tv3, 0x1);
    t0 = _mm256_castps256_ps128(v0.simdInternal_);
    t1 = _mm256_castps256_ps128(v1.simdInternal_);
