...
{
    return { _mm_add_ps(_mm_mul_ps(a.r, b.r), c.r) };
}

static inline Simd4Float gmx_simdcall
simd4FmsubF(Simd4Float a, Simd4Float b, Simd4Float c)
{
    return { _mm_sub_ps(_mm_mul_ps(a.r, b.r), c.r) };
}

static inline Simd4Float gmx_simdcall
simd4FnmaddF(Simd4Float a, Simd4Float b, Simd4Float c)
{
    return { _mm_sub_ps(c.r, _mm_mul_ps(a.r, b.r)) };
}

static inline Simd4Float gmx_simdcall
simd4FnmsubF(Simd4Float a, Simd4Float b, Simd4Float c)
{
    return { _mm_sub_ps(_mm_setzero_ps(), _mm_add_ps(_mm_mul_ps(a.r, b.r), c.r)) };
}
#endif
...
{
    return { _mm_rsqrt_ps(x.r) };
}

static inline Simd4Float gmx_simdcall
simd4AbsF(Simd4Float x)
{
    return { _mm_andnot_ps( _mm_set1_ps(GMX_FLOAT_NEGZERO), x.r ) };
}

static inline Simd4Float gmx_simdcall
simd4NegF(Simd4Float x)
{
    return { _mm_xor_ps(x.r, _mm_set1_ps(GMX_FLOAT_NEGZERO)) };
}

static inline Simd4Float gmx_simdcall
simd4MaxF(Simd4Float a, Simd4Float b)
{
    return { _mm_max_ps(a.r, b.r) };
}

static inline Simd4Float gmx_simdcall
simd4MinF(Simd4Float a, Simd4Float b)
{
    return { _mm_min_ps(a.r, b.r) };
}

static inline Simd4Float gmx_simdcall
simd4RoundF(Simd4Float x)
{
    return { _mm_round_ps(x.r, _MM_FROUND_NINT) };
}

static inline Simd4Float gmx_simdcall
simd4TruncF(Simd4Float x)
{
    return { _mm_round_ps(x.r, _MM_FROUND_TRUNC) };
}
...
{
    return { _mm_cmp_ps(a.r, b.r, _CMP_EQ_OQ) };
}

static inline Simd4FBool gmx_simdcall
simd4CmpLtF(Simd4Float a, Simd4Float b)
{
    return { _mm_cmp_ps(a.r, b.r, _CMP_LT_OQ) };
}

static inline Simd4FBool gmx_simdcall
simd4CmpLeF(Simd4Float a, Simd4Float b)
{
    return { _mm_cmp_ps(a.r, b.r, _CMP_LE_OQ) };
}

static inline Simd4FBool gmx_simdcall
simd4AndFB(Simd4FBool a, Simd4FBool b)
{
    return { _mm_and_ps(a.b, b.b) };
}

static inline Simd4FBool gmx_simdcall
simd4OrFB(Simd4FBool a, Simd4FBool b)
{
    return { _mm_or_ps(a.b, b.b) };
}
