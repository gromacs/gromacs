                       ...
                       SimdDouble          v2)
{
    ...
    avx256Transpose4By4(&v0.simdInternal_, &v1.simdInternal_, &v2.simdInternal_, &tv3);

    _mm256_maskstore_pd(base + align * offset[0], mask, v0.simdInternal_);
    _mm256_maskstore_pd(base + align * offset[1], mask, v1.simdInternal_);
    _mm256_maskstore_pd(base + align * offset[2], mask, v2.simdInternal_);
                      ...
                      SimdDouble          v2)
{
    ...
    t0  = _mm256_add_pd(t0, v0.simdInternal_);
    t1  = _mm256_add_pd(t1, v1.simdInternal_);
    t2  = _mm256_add_pd(t2, v2.simdInternal_);
                      ...
                      SimdDouble          v2)
{
    ...
    t0  = _mm256_sub_pd(t0, v0.simdInternal_);
    t1  = _mm256_sub_pd(t1, v1.simdInternal_);
    t2  = _mm256_sub_pd(t2, v2.simdInternal_);
                             ...
                             SimdDouble *    v3)
{
    ...
    {
        v0->simdInternal_ = _mm256_load_pd(base + _mm_extract_epi32(offset.simdInternal_, 0));
        v1->simdInternal_ = _mm256_load_pd(base + _mm_extract_epi32(offset.simdInternal_, 1));
        v2->simdInternal_ = _mm256_load_pd(base + _mm_extract_epi32(offset.simdInternal_, 2));
        v3->simdInternal_ = _mm256_load_pd(base + _mm_extract_epi32(offset.simdInternal_, 3));
    }
    else
    {
        v0->simdInternal_ = _mm256_load_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 0));
        v1->simdInternal_ = _mm256_load_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 1));
        v2->simdInternal_ = _mm256_load_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 2));
        v3->simdInternal_ = _mm256_load_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 3));
    }
    avx256Transpose4By4(&v0->simdInternal_, &v1->simdInternal_, &v2->simdInternal_, &v3->simdInternal_);
}
                             ...
                             SimdDouble *      v1)
{
        ...
        align == 8 || align == 12 || align == 16)
    {
        ...
        t3  = _mm_load_pd(base + _mm_extract_epi32(offset.simdInternal_, 2));
        t4  = _mm_load_pd(base + _mm_extract_epi32(offset.simdInternal_, 3));
    }
    else
    {
        ...
        t3  = _mm_load_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 2));
        t4  = _mm_load_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 3));
    }
                              ...
                              SimdDouble *    v1)
{
    ...
    {
        t1   = _mm_loadu_pd(base + _mm_extract_epi32(offset.simdInternal_, 0));
        t2   = _mm_loadu_pd(base + _mm_extract_epi32(offset.simdInternal_, 1));
        t3   = _mm_loadu_pd(base + _mm_extract_epi32(offset.simdInternal_, 2));
        t4   = _mm_loadu_pd(base + _mm_extract_epi32(offset.simdInternal_, 3));
    }
    else
    {
        t1   = _mm_loadu_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 0));
        t2   = _mm_loadu_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 1));
        t3   = _mm_loadu_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 2));
        t4   = _mm_loadu_pd(base + align * _mm_extract_epi32(offset.simdInternal_, 3));
    }
    tA  = _mm256_insertf128_pd(_mm256_castpd128_pd256(t1), t3, 0x1);
    tB  = _mm256_insertf128_pd(_mm256_castpd128_pd256(t2), t4, 0x1);
