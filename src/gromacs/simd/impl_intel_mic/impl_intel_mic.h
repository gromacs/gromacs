                                     ...
                                     gmx_simd_float_t    &v3)
{
    ...
    simdoffset = gmx_simd_loadu_fi_mic(offset);
    ...
    {
        simdoffset = _mm512_add_epi32(simdoffset, _mm512_slli_epi32(simdoffset, 1));
        simdoffset = _mm512_slli_epi32(simdoffset, 2);
    }
    else
    {
...
gmx_simd_gather_loadu_bysimdint_transpose_f_mic(const float *       base,
                                                ...
                                                gmx_simd_float_t   &v1)
{
    gmx_simd_gather_load_bysimdint_transpose_f_mic<align>(base, simdoffset, v0, v1);
}
                                        ...
                                        gmx_simd_float_t  v3)
{
    ...
    t0 = _mm512_swizzle_ps(_mm512_mask_blend_ps(_mm512_int2mask(0x3333), v0, v2), _MM_SWIZ_REG_BADC);
    t2 = _mm512_mask_blend_ps(_mm512_int2mask(0x3333), v2, v0);
    t1 = _mm512_swizzle_ps(_mm512_mask_blend_ps(_mm512_int2mask(0x3333), v1, v3), _MM_SWIZ_REG_BADC);
    t3 = _mm512_mask_blend_ps(_mm512_int2mask(0x3333), v3, v1);

    t0 = _mm512_add_ps(t0, t2);
    t1 = _mm512_add_ps(t1, t3);

    t2 = _mm512_swizzle_ps(_mm512_mask_blend_ps(_mm512_int2mask(0b0101010101010101), t0, t1), _MM_SWIZ_REG_CDAB);
    t3 = _mm512_mask_blend_ps(_mm512_int2mask(0b0101010101010101), t1, t0);
...
{
    __m512 t0, t1;
    t0 = _mm512_loadunpacklo_ps(_mm512_undefined_ps(), m0);
    t1 = _mm512_loadunpacklo_ps(_mm512_undefined_ps(), m1);
    return _mm512_mask_permute4f128_ps(t0, _mm512_int2mask(0xFF00), t1, _MM_PERM_BABA);
}
...
{
    __m512 t0;
    t0 = _mm512_permute4f128_ps(a, _MM_PERM_DCDC);
    _mm512_mask_packstorelo_ps(m0, _mm512_int2mask(0x00FF), a);
    _mm512_mask_packstorelo_ps(m1, _mm512_int2mask(0x00FF), t0);
}
                          ...
                          gmx_simd_float_t a)
{
    ...
    t = _mm512_loadunpacklo_ps(_mm512_undefined_ps(), m);
                                           ...
                                           gmx_simd_float_t   &v1)
{
    ...
    idx0 = _mm512_loadunpackhi_epi32(idx0, offset+8);
                                              ...
                                              gmx_simd_float_t   v1)
{
    ...
    t0 = _mm512_swizzle_ps(_mm512_mask_blend_ps(_mm512_int2mask(0x3333), v0, v1), _MM_SWIZ_REG_BADC);
    t1 = _mm512_mask_blend_ps(_mm512_int2mask(0x3333), v1, v0);
    t0 = _mm512_add_ps(t0, t1);

    t0 = _mm512_add_ps(t0, _mm512_permute4f128_ps(t0, _MM_PERM_DDBB));
    t0 = _mm512_add_ps(t0, _mm512_swizzle_ps(t0, _MM_SWIZ_REG_CDAB));
    t0 = _mm512_mask_permute4f128_ps(t0, _mm512_int2mask(0xAAAA), t0, _MM_PERM_CCCC);
                                     ...
                                     gmx_simd_double_t    &v3)
{
    ...
    simdoffset = gmx_simd_loadu_di_mic(offset);
...
gmx_simd_gather_loadu_bysimdint_transpose_d_mic(const double *       base,
                                                ...
                                                gmx_simd_double_t   &v1)
{
    gmx_simd_gather_load_bysimdint_transpose_d_mic<align>(base, simdoffset, v0, v1);
}
...
{
    __m512d t0, t1;
    t0 = _mm512_loadunpacklo_pd(_mm512_undefined_pd(), m0);
    t1 = _mm512_loadunpacklo_pd(_mm512_undefined_pd(), m1);
    return _mm512_castps_pd(_mm512_mask_permute4f128_ps(_mm512_castpd_ps(t0), _mm512_int2mask(0xFF00), _mm512_castpd_ps(t1), _MM_PERM_BABA));
}
...
{
    __m512d t0;
    t0 = _mm512_castps_pd(_mm512_permute4f128_ps(_mm512_castpd_ps(a), _MM_PERM_DCDC));
    _mm512_mask_packstorelo_pd(m0, _mm512_int2mask(0x0F), a);
    _mm512_mask_packstorelo_pd(m1, _mm512_int2mask(0x0F), t0);
}
                          ...
                          gmx_simd_double_t a)
{
    ...
    t = _mm512_loadunpacklo_pd(_mm512_undefined_pd(), m);
                                              ...
                                              gmx_simd_double_t  v1)
{
    ...
    t0 = _mm512_swizzle_pd(_mm512_mask_blend_pd(_mm512_int2mask(0x33), v0, v1), _MM_SWIZ_REG_BADC);
    t1 = _mm512_mask_blend_pd(_mm512_int2mask(0x33), v1, v0);
    t0 = _mm512_add_pd(t0, t1);

    t0 = _mm512_add_pd(t0, _mm512_swizzle_pd(t0, _MM_SWIZ_REG_CDAB));
    t0 = _mm512_castps_pd(_mm512_mask_permute4f128_ps(_mm512_castpd_ps(t0), _mm512_int2mask(0b1100110011001100), _mm512_castpd_ps(t0), _MM_PERM_BADC));

    t2 = gmx_simd4_load_d(m);
    t2 = gmx_simd4_add_d(t2, t0);
    gmx_simd4_store_d(m, t2);
                          ...
                          gmx_simd4_float_t &v2, gmx_simd4_float_t &v3)
{
    ...
    v0 = _mm512_mask_mov_ps(_mm512_setzero_ps(), _mm512_int2mask(0x000F), v0);
}
#endif
