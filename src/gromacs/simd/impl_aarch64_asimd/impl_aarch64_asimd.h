...
#ifndef GMX_SIMD_IMPL_AARCH64_ASIMD_H
#define GMX_SIMD_IMPL_AARCH64_ASIMD_H

#include <math.h>

#include <arm_neon.h>

/* ARM AArch64 64-bit Advanced SIMD instruction wrappers
 *
...
/* Aarch64 always has FMA support, so make sure we use that for single too. */
...
/* Aarch64 has a real rounding conversion instruction */
...
#define gmx_simd_set_exponent_f    gmx_simd_set_exponent_f_aarch64_asimd

/* We can do more efficient reduce with vector pairwise arithmetic */
#undef  gmx_simd_reduce_f
#define gmx_simd_reduce_f(a)       gmx_simd_reduce_f_aarch64_asimd(a)
...
#define gmx_simd_get_exponent_d    gmx_simd_get_exponent_d_aarch64_asimd
#define gmx_simd_get_mantissa_d    gmx_simd_get_mantissa_d_aarch64_asimd
#define gmx_simd_set_exponent_d    gmx_simd_set_exponent_d_aarch64_asimd
...
#define gmx_simd_anytrue_db(x)     (vmaxv_u32((uint32x4_t)(x))!=0)
...
#define gmx_simd_reduce_d(a)       gmx_simd_reduce_d_aarch64_asimd(a)
...
gmx_simd_set_exponent_f_aarch64_asimd(gmx_simd_float_t x)
{
...
gmx_simd_reduce_f_aarch64_asimd(gmx_simd_float_t a)
{
    a = vpaddq_f32(a,a);
    a = vpaddq_f32(a,a);
...
gmx_simd_get_exponent_d_aarch64_asimd(gmx_simd_double_t x)
{
...
static gmx_inline gmx_simd_double_t
gmx_simd_get_mantissa_d_aarch64_asimd(gmx_simd_double_t x)
{
...
static gmx_inline gmx_simd_double_t
gmx_simd_set_exponent_d_aarch64_asimd(gmx_simd_double_t x)
{
...
gmx_simd_reduce_d_aarch64_asimd(gmx_simd_double_t a)
{
    a = vpaddq_f64(a,a);
    return vgetq_lane_f64(a,0);
}

#endif /* GMX_SIMD_IMPL_AARCH64_ASIMD_H */
