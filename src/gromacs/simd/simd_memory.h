...
class SimdArrayRef
{
    ...
    class iterator
    {
        ...
        public:
            ...
            {
                GMX_ASSERT(reinterpret_cast<size_t>(p)%simdWidth == 0,
    ...
    public:
            ...
            : begin_(begin), end_(end)
        {
            ...
            GMX_ASSERT(reinterpret_cast<size_t>(begin)%simdWidth == 0,
                       "Aligned ArrayRef requires aligned starting address");
            GMX_ASSERT(reinterpret_cast<size_t>(end)%simdWidth == 0,
