 ...
 * Meaning that a[1] refers to the 2nd SIMD vector and thus reals 8-16 for 8-wide
...
class SimdArrayRef
{
    ...
    class iterator
    {
        ...
        public:
            ...
            {
                GMX_ASSERT(reinterpret_cast<size_t>(p)%(simdWidth*sizeof(T)) == 0,
    ...
    public:
         ...
         * Begin pointer as to be aligned according to SIMD requirement.
            ...
            : begin_(begin), end_(end)
        {
            ...
            GMX_ASSERT(reinterpret_cast<size_t>(begin)%(simdWidth*sizeof(T)) == 0,
                       "Aligned ArrayRef requires aligned starting address");
            GMX_ASSERT(reinterpret_cast<size_t>(end)%(simdWidth*sizeof(T)) == 0,
        ...
        size_t size() const { return (end_-begin_)/simdWidth; }
