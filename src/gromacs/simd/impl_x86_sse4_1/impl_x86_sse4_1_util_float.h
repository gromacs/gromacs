                                  ...
                                  SimdFloat *    v3)
{
    ...
    if (align == 4 || align == 8 || align == 12 || align == 16)
    {
        ...
        v0->r = _mm_load_ps(base + _mm_extract_epi32(offset.i, 0) );
        v1->r = _mm_load_ps(base + _mm_extract_epi32(offset.i, 1) );
        v2->r = _mm_load_ps(base + _mm_extract_epi32(offset.i, 2) );
        v3->r = _mm_load_ps(base + _mm_extract_epi32(offset.i, 3) );
    }
    else
    {
        ...
        v0->r = _mm_load_ps(base + align * _mm_extract_epi32(offset.i, 0) );
        v1->r = _mm_load_ps(base + align * _mm_extract_epi32(offset.i, 1) );
        v2->r = _mm_load_ps(base + align * _mm_extract_epi32(offset.i, 2) );
        v3->r = _mm_load_ps(base + align * _mm_extract_epi32(offset.i, 3) );
    }
                                  ...
                                  SimdFloat *     v1)
{
    ...
    {
        v0->r = _mm_castpd_ps(_mm_load_sd((const double *)(base + _mm_extract_epi32(offset.i, 0))));
        v1->r = _mm_castpd_ps(_mm_load_sd((const double *)(base + _mm_extract_epi32(offset.i, 1))));
        t1    = _mm_castpd_ps(_mm_load_sd((const double *)(base + _mm_extract_epi32(offset.i, 2))));
        t2    = _mm_castpd_ps(_mm_load_sd((const double *)(base + _mm_extract_epi32(offset.i, 3))));
    }
    else
    {
        v0->r = _mm_castpd_ps(_mm_load_sd((const double *)(base + align * _mm_extract_epi32(offset.i, 0))));
        v1->r = _mm_castpd_ps(_mm_load_sd((const double *)(base + align * _mm_extract_epi32(offset.i, 1))));
        t1    = _mm_castpd_ps(_mm_load_sd((const double *)(base + align * _mm_extract_epi32(offset.i, 2))));
        t2    = _mm_castpd_ps(_mm_load_sd((const double *)(base + align * _mm_extract_epi32(offset.i, 3))));
    }
