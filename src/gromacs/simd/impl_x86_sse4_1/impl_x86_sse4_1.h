...
#    define gmx_simd_rcp_mask_f(a, m)    _mm_and_ps(_mm_rcp_ps(_mm_blendv_ps(_mm_set1_pd(1.0f), a, m)), m)
#    undef  gmx_simd_rsqrt_mask_f
#    define gmx_simd_rsqrt_mask_f(a, m)  _mm_and_ps(_mm_rsqrt_ps(_mm_blendv_ps(_mm_set1_pd(1.0f), a, m)), m)
