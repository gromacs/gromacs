                                  ...
                                  SimdDouble *    v3)
{
    ...
    if (align == 4 || align == 8 || align == 12 || align == 16)
    {
        ...
        t3  = _mm_load_pd(base + _mm_extract_epi32(offset.i, 0) + 2);
        t4  = _mm_load_pd(base + _mm_extract_epi32(offset.i, 1) + 2);
    }
    else
    {
        ...
        t3  = _mm_load_pd(base + align * _mm_extract_epi32(offset.i, 0) + 2);
        t4  = _mm_load_pd(base + align * _mm_extract_epi32(offset.i, 1) + 2);
    }
