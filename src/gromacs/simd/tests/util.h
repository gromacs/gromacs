...
class SimdTest : public ::testing::Test
{
    public:
        ...
        {
#ifdef GMX_DOUBLE
            ulpTol = 255; //!< Aim for ~twice the precision we have in single
#else
            ulpTol = 10;  //!< Be a bit liberal so compiler optimization doesn't bite us
#endif
            absTol = 0;
        }
        void setUlpTol(int newTol)   { ulpTol = newTol; }
    ...
    protected:
        int                    ulpTol; //!< Default tolerance in units-in-last-position
