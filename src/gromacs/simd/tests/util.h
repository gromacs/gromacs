...
class SimdTest : public ::testing::Test
{
    public:
         ...
         * all-SIMD-flavor of compareSimdRealUlp. It will thus return success if
        ...
        /*! \brief Compare two real SIMD variables for exact identity.
         *
         * This is an internal implementation routine. YOu should always use
        ...
        /*! \brief Compare scalar against SIMD real for exact identity.
         *
         * This is an internal implementation routine. YOu should always use
         * GMX_EXPECT_SIMD_REAL_EQ() instead.
         *
         * This version expands the scalar into a SIMD vector and calls the
         * all-SIMD-flavor of compareSimdRealEq. It will thus return success if
         * all elements are equal to the scalar.
         */
        ::testing::AssertionResult
        compareSimdRealEq(const char * refExpr, const char * tstExpr,
 ...
 */
gmx_simd_real_t   setSimdFrom1R(real value);
 ...
 * operations that have been tested separately in the bootstrapping tests.
 */
gmx_simd_int32_t   setSimdFrom1I(int value);
