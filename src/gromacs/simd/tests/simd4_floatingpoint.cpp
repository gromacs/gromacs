...
{
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(4, 10, 18), gmx_simd4_mul_r(rSimd4_1_2_3, rSimd4_4_5_6));
}

TEST_F(Simd4FloatingPointTest, gmxSimd4FmaddR)
{
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(11, 18, 27), gmx_simd4_fmadd_r(rSimd4_1_2_3, rSimd4_4_5_6, rSimd4_7_8_9)); // 1*4+7, etc.
}

TEST_F(Simd4FloatingPointTest, gmxSimd4FmsubR)
{
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(-3, 2, 9), gmx_simd4_fmsub_r(rSimd4_1_2_3, rSimd4_4_5_6, rSimd4_7_8_9)); // 1*4-7, etc.
}

TEST_F(Simd4FloatingPointTest, gmxSimd4FnmaddR)
{
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(3, -2, -9), gmx_simd4_fnmadd_r(rSimd4_1_2_3, rSimd4_4_5_6, rSimd4_7_8_9)); // -1*4+7, etc.
}

TEST_F(Simd4FloatingPointTest, gmxSimd4FnmsubR)
{
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(-11, -18, -27), gmx_simd4_fnmsub_r(rSimd4_1_2_3, rSimd4_4_5_6, rSimd4_7_8_9)); // -1*4-7, etc.
}
...
{
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(3, 2, 4), gmx_simd4_max_r(rSimd4_1_2_3, rSimd4_3_1_4));
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(3, 2, 4), gmx_simd4_max_r(rSimd4_3_1_4, rSimd4_1_2_3));
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(-1, -1, -3), gmx_simd4_max_r(rSimd4_m1_m2_m3, rSimd4_m3_m1_m4));
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(-1, -1, -3), gmx_simd4_max_r(rSimd4_m3_m1_m4, rSimd4_m1_m2_m3));
}

TEST_F(Simd4FloatingPointTest, gmxSimd4MinR)
{
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(1, 1, 3), gmx_simd4_min_r(rSimd4_1_2_3, rSimd4_3_1_4));
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(1, 1, 3), gmx_simd4_min_r(rSimd4_3_1_4, rSimd4_1_2_3));
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(-3, -2, -4), gmx_simd4_min_r(rSimd4_m1_m2_m3, rSimd4_m3_m1_m4));
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(-3, -2, -4), gmx_simd4_min_r(rSimd4_m3_m1_m4, rSimd4_m1_m2_m3));
}
...
{
    GMX_EXPECT_SIMD4_REAL_EQ( 2, gmx_simd4_trunc_r(rSimd4_2p25));
    GMX_EXPECT_SIMD4_REAL_EQ( 3, gmx_simd4_trunc_r(rSimd4_3p75));
    GMX_EXPECT_SIMD4_REAL_EQ(-2, gmx_simd4_trunc_r(rSimd4_m2p25));
    GMX_EXPECT_SIMD4_REAL_EQ(-3, gmx_simd4_trunc_r(rSimd4_m3p75));
}
...
{
    gmx_simd4_real_t x      = setSimd4From3R(4.0, M_PI, 1234567890.0);
    gmx_simd4_real_t ref    = setSimd4From3R(0.5, 1.0/sqrt(M_PI), 1.0/sqrt(1234567890.0));
...
TEST_F(Simd4FloatingPointTest, gmxSimd4BoolCmpEqAndBlendZeroR)
{
    ...
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(0, 0, 3), gmx_simd4_blendzero_r(rSimd4_1_2_3, eq));
}

TEST_F(Simd4FloatingPointTest, gmxSimd4BlendNotZeroR)
{
    gmx_simd4_bool_t eq   = gmx_simd4_cmpeq_r(rSimd4_5_7_9, rSimd4_7_8_9);
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(1, 2, 0), gmx_simd4_blendnotzero_r(rSimd4_1_2_3, eq));
}
...
TEST_F(Simd4FloatingPointTest, gmxSimd4BoolCmpLTR)
{
    ...
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(1, 2, 0), gmx_simd4_blendzero_r(rSimd4_1_2_3, lt));
}
...
TEST_F(Simd4FloatingPointTest, gmxSimd4BoolAndB)
{
    gmx_simd4_bool_t eq   = gmx_simd4_cmpeq_r(rSimd4_5_7_9, rSimd4_7_8_9);
    gmx_simd4_bool_t le   = gmx_simd4_cmple_r(rSimd4_5_7_9, rSimd4_7_8_9);
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(0, 0, 3), gmx_simd4_blendzero_r(rSimd4_1_2_3, gmx_simd4_and_b(eq, le)));
}
...
TEST_F(Simd4FloatingPointTest, gmxSimd4BoolOrB)
{
    gmx_simd4_bool_t eq   = gmx_simd4_cmpeq_r(rSimd4_5_7_9, rSimd4_7_8_9);
    gmx_simd4_bool_t lt   = gmx_simd4_cmplt_r(rSimd4_5_7_9, rSimd4_7_8_9);
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(1, 2, 3), gmx_simd4_blendzero_r(rSimd4_1_2_3, gmx_simd4_or_b(eq, lt)));
}
...
TEST_F(Simd4FloatingPointTest, gmxSimd4AnytrueB)
{
     ...
     */
    eq = gmx_simd4_cmpeq_r(rSimd4_5_7_9, setSimd4From3R(5, 0, 0));
...
{
    gmx_simd4_bool_t lt   = gmx_simd4_cmplt_r(rSimd4_5_7_9, rSimd4_7_8_9);
    GMX_EXPECT_SIMD4_REAL_EQ(setSimd4From3R(4, 5, 3), gmx_simd4_blendv_r(rSimd4_1_2_3, rSimd4_4_5_6, lt));
}

TEST_F(Simd4FloatingPointTest, gmxSimd4Dotproduct3R)
{
    gmx_simd4_real_t v1 = setSimd4From3R(1, 4, 5);
    gmx_simd4_real_t v2 = setSimd4From3R(3, 8, 2);
#    ifdef GMX_DOUBLE
