...
extern gmx_inline gmx_simd_ref_pr
gmx_simd_ref_boolean_pr_wrapper(gmx_simd_ref_pr a, gmx_simd_ref_pr b)
{
...
{
    return gmx_simd_ref_boolean_pr_wrapper<gmx_simd_ref_and_pb>(a, b);
}

static gmx_inline gmx_simd_ref_pr
gmx_simd_ref_or_pr_wrapper(gmx_simd_ref_pr a, gmx_simd_ref_pr b)
{
    return gmx_simd_ref_boolean_pr_wrapper<gmx_simd_ref_or_pb>(a, b);
}
