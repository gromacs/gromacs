...
#ifdef GMX_SIMD4_HAVE_REAL
/// \brief Return stl vector from floating-point simd4.
::std::vector<real>
...
/// \brief Return floating-point simd4 value from stl vector.
///
/// If the vector is longer
...
/// \brief Print contents of Simd datatype to string.
///
...
/// \brief Internal implementation - use the macro GMX_EXPECT_SIMD4_REAL_EQ() instead.
///
