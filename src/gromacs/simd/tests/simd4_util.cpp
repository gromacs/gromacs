...
const gmx_simd4_real_t rSimd_1_2_3    = setSimd3R(1, 2, 3);
const gmx_simd4_real_t rSimd_4_5_6    = setSimd3R(4, 5, 6);
const gmx_simd4_real_t rSimd_7_8_9    = setSimd3R(7, 8, 9);
const gmx_simd4_real_t rSimd_5_7_9    = setSimd3R(5, 7, 9);
const gmx_simd4_real_t rSimd_m1_m2_m3 = setSimd3R(-1, -2, -3);
const gmx_simd4_real_t rSimd_3_1_4    = setSimd3R(3, 1, 4);
const gmx_simd4_real_t rSimd_m3_m1_m4 = setSimd3R(-3, -1, -4);
const gmx_simd4_real_t rSimd_2p25     = gmx_simd4_set1_r(2.25);
const gmx_simd4_real_t rSimd_3p75     = gmx_simd4_set1_r(3.75);
const gmx_simd4_real_t rSimd_m2p25    = gmx_simd4_set1_r(-2.25);
const gmx_simd4_real_t rSimd_m3p75    = gmx_simd4_set1_r(-3.75);
