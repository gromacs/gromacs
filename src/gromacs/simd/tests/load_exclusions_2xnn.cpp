...
typedef SimdFunctionTest<3,2,unsigned int> SimdFunction_load_2xnn_exclusions;
...
SimdFunction_load_2xnn_exclusions::callFunction(SimdFunctionSet &simdFunctionSet,
                                                    ...
                                                    real *_result)
{
    const unsigned int numArrayInputs = numInputs - 1;
    ...
    {
        masks[i] = simdFunctionSet.load_exclmask(inputs[i]);
    }
