...
class SimdFloatingpointUtilTest : public SimdTest
{
    public:
        ...
        {
            int i;
            // Point mem1 halfway through mem0
    ...
    protected:
        ...
        real *                                 mem1_;                             //!< Aligned pointer inside mem0_
};
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdGatherLoadTranspose4)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 4)
        {
            simdGatherLoadTranspose<4>(mem0_, offset_, v0, v1, v2, v3);
        }
        else if (align == 8)
        {
            simdGatherLoadTranspose<8>(mem0_, offset_, v0, v1, v2, v3);
        }
        else if (align == 12)
        {
            simdGatherLoadTranspose<12>(mem0_, offset_, v0, v1, v2, v3);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdGatherLoadTranspose2)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 2)
        {
            simdGatherLoadTranspose<2>(mem0_, offset_, v0, v1);
        }
        else if (align == 4)
        {
            simdGatherLoadTranspose<4>(mem0_, offset_, v0, v1);
        }
        else if (align == c_simdBestPairAlignment)
        {
            simdGatherLoadTranspose<c_simdBestPairAlignment>(mem0_, offset_, v0, v1);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdGatherLoadUTranspose3)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 3)
        {
            simdGatherLoadUTranspose<3>(mem0_, offset_, v0, v1, v2);
        }
        else if (align == 4)
        {
            simdGatherLoadUTranspose<4>(mem0_, offset_, v0, v1, v2);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdTransposeScatterStoreU3)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 3)
        {
            simdTransposeScatterStoreU<3>(mem0_, offset_, v0, v1, v2);
        }
        else if (align == 4)
        {
            simdTransposeScatterStoreU<4>(mem0_, offset_, v0, v1, v2);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdTransposeScatterIncrU3)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 3)
        {
            simdTransposeScatterIncrU<3>(mem0_, offset_, v0, v1, v2);
        }
        else if (align == 4)
        {
            simdTransposeScatterIncrU<4>(mem0_, offset_, v0, v1, v2);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdTransposeScatterDecrU3)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 3)
        {
            simdTransposeScatterDecrU<3>(mem0_, offset_, v0, v1, v2);
        }
        else if (align == 4)
        {
            simdTransposeScatterDecrU<4>(mem0_, offset_, v0, v1, v2);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdExpandScalarsToTriplets)
{
    ...
    simdExpandScalarsToTriplets(vs, v0, v1, v2);
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdGatherLoadBySimdIntTranspose4)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 4)
        {
            simdGatherLoadBySimdIntTranspose<4>(mem0_, simdoffset, v0, v1, v2, v3);
        }
        else if (align == 8)
        {
            simdGatherLoadBySimdIntTranspose<8>(mem0_, simdoffset, v0, v1, v2, v3);
        }
        else if (align == 12)
        {
            simdGatherLoadBySimdIntTranspose<12>(mem0_, simdoffset, v0, v1, v2, v3);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdGatherLoadBySimdIntTranspose2)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 4)
        {
            simdGatherLoadBySimdIntTranspose<4>(mem0_, simdoffset, v0, v1);
        }
        else if (align == 8)
        {
            simdGatherLoadBySimdIntTranspose<8>(mem0_, simdoffset, v0, v1);
        }
        else if (align == 12)
        {
            simdGatherLoadBySimdIntTranspose<12>(mem0_, simdoffset, v0, v1);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdGatherLoadUBySimdIntTranspose2)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 1)
        {
            simdGatherLoadUBySimdIntTranspose<1>(mem0_, simdoffset, v0, v1);
        }
        else if (align == 3)
        {
            simdGatherLoadUBySimdIntTranspose<3>(mem0_, simdoffset, v0, v1);
        }
        else if (align == 5)
        {
            simdGatherLoadUBySimdIntTranspose<5>(mem0_, simdoffset, v0, v1);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdReduceIncr4Sum)
{
    ...
    tstsum = simdReduceIncr4ReturnSum(mem0_, v0, v1, v2, v3);
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdGatherLoadTranspose2Hsimd)
{
    ...
    for (i = 0; i < nalign; i++)
    {
        ...
        if (align == 2)
        {
            simdGatherLoadTransposeHsimd<2>(mem0_, mem1_, offset_, v0, v1);
        }
        else if (align == 4)
        {
            simdGatherLoadTransposeHsimd<4>(mem0_, mem1_, offset_, v0, v1);
        }
        else if (align == c_simdBestPairAlignment)
        {
            simdGatherLoadTransposeHsimd<c_simdBestPairAlignment>(mem0_, mem1_, offset_, v0, v1);
        }
        else
        {
            FAIL();
...
TEST_F(SimdFloatingpointUtilTest, gmxSimdReduceIncr4SumHsimd)
{
    ...
    tstsum = simdReduceIncr4ReturnSumHsimd(mem0_, v0, v1);
...
#endif      // GMX_SIMD_HAVE_REAL && GMX_SIMD==2
