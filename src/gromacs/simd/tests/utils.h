...
#ifndef GMX_SIMD_TESTS_UTILS_H
#define GMX_SIMD_TESTS_UTILS_H
...
/*! Typedef for an unsigned integer whose size is that of real on all
    systems. Thanks to the magic of Google Test! */
typedef ::testing::internal::FloatingPoint<real>::Bits UnsignedIntWithSizeOfReal;

/*! Union type to facilitate low-level manipulations */
typedef union
{
    //! Real member of union
    real                      r;
    //! Unsigned member of union
