...
TEST_F(SimdTestFloatingPoint, gmxSimdFnegR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdMinR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdRoundR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdTruncR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdFractionR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdGetExponentR)
{
    GMX_EXPECT_SIMD_REAL_EQ(setSimd3R(60.0, -41.0, 54.0), gmx_simd_get_exponent_r(rSimd_Exp));
}

TEST_F(SimdTestFloatingPoint, gmxSimdGetMantissaR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdSetExponentR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdRsqrtR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdRcpR)
{
    gmx_simd_real_t x      = setSimd3R(4.0, M_PI, 1234567890.0);
...
TEST_F(SimdTestFloatingPoint, gmxSimdBoolCmpEqAndBlendZeroR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdBlendNotZeroR)
{
    gmx_simd_bool_t eq   = gmx_simd_cmpeq_r(rSimd_5_7_9, rSimd_7_8_9);
    GMX_EXPECT_SIMD_REAL_EQ(setSimd3R(1, 2, 0), gmx_simd_blendnotzero_r(rSimd_1_2_3, eq));
}

TEST_F(SimdTestFloatingPoint, gmxSimdBoolCmpLER)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdBoolCmpLTR)
{
...
TEST_F(SimdTestFloatingPoint, gmxSimdBoolAndB)
{
    gmx_simd_bool_t eq   = gmx_simd_cmpeq_r(rSimd_5_7_9, rSimd_7_8_9);
    gmx_simd_bool_t le   = gmx_simd_cmple_r(rSimd_5_7_9, rSimd_7_8_9);
...
TEST_F(SimdTestFloatingPoint, gmxSimdBoolOrB)
{
    gmx_simd_bool_t eq   = gmx_simd_cmpeq_r(rSimd_5_7_9, rSimd_7_8_9);
    gmx_simd_bool_t lt   = gmx_simd_cmplt_r(rSimd_5_7_9, rSimd_7_8_9);
...
TEST_F(SimdTestFloatingPoint, gmxSimdAnytrueB)
{
    gmx_simd_bool_t eq;
...
TEST_F(SimdTestFloatingPoint, gmxSimdBlendvR)
{
    gmx_simd_bool_t lt   = gmx_simd_cmplt_r(rSimd_5_7_9, rSimd_7_8_9);
