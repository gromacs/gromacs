...
typedef gmx::test::SimdTest SimdFloatingPointTest;
...
{
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(3, 2, 4), gmx_simd_max_r(rSimd_1_2_3, rSimd_3_1_4));
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(3, 2, 4), gmx_simd_max_r(rSimd_3_1_4, rSimd_1_2_3));
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(-1, -1, -3), gmx_simd_max_r(rSimd_m1_m2_m3, rSimd_m3_m1_m4));
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(-1, -1, -3), gmx_simd_max_r(rSimd_m3_m1_m4, rSimd_m1_m2_m3));
}

TEST_F(SimdFloatingPointTest, gmxSimdMinR)
{
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(1, 1, 3), gmx_simd_min_r(rSimd_1_2_3, rSimd_3_1_4));
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(1, 1, 3), gmx_simd_min_r(rSimd_3_1_4, rSimd_1_2_3));
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(-3, -2, -4), gmx_simd_min_r(rSimd_m1_m2_m3, rSimd_m3_m1_m4));
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(-3, -2, -4), gmx_simd_min_r(rSimd_m3_m1_m4, rSimd_m1_m2_m3));
}
...
{
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(60.0, -41.0, 54.0), gmx_simd_get_exponent_r(rSimd_Exp));
}

TEST_F(SimdFloatingPointTest, gmxSimdGetMantissaR)
{
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(1.219097320577810839026256,
...
{
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(pow(2.0, 60.0), pow(2.0, -41.0), pow(2.0, 54.0)),
                            gmx_simd_set_exponent_r(gmx::test::setSimdFrom3R(60.0, -41.0, 54.0)));
}
...
{
    gmx_simd_real_t x      = gmx::test::setSimdFrom3R(4.0, M_PI, 1234567890.0);
    gmx_simd_real_t ref    = gmx::test::setSimdFrom3R(0.5, 1.0/sqrt(M_PI), 1.0/sqrt(1234567890.0));
...
{
    gmx_simd_real_t x      = gmx::test::setSimdFrom3R(4.0, M_PI, 1234567890.0);
    gmx_simd_real_t ref    = gmx::test::setSimdFrom3R(0.25, 1.0/M_PI, 1.0/1234567890.0);
...
TEST_F(SimdFloatingPointTest, gmxSimdBoolCmpEqAndBlendZeroR)
{
    ...
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(0, 0, 3), gmx_simd_blendzero_r(rSimd_1_2_3, eq));
}

TEST_F(SimdFloatingPointTest, gmxSimdBlendNotZeroR)
{
    gmx_simd_bool_t eq   = gmx_simd_cmpeq_r(rSimd_5_7_9, rSimd_7_8_9);
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(1, 2, 0), gmx_simd_blendnotzero_r(rSimd_1_2_3, eq));
}
...
TEST_F(SimdFloatingPointTest, gmxSimdBoolCmpLTR)
{
    ...
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(1, 2, 0), gmx_simd_blendzero_r(rSimd_1_2_3, lt));
}
...
TEST_F(SimdFloatingPointTest, gmxSimdBoolAndB)
{
    gmx_simd_bool_t eq   = gmx_simd_cmpeq_r(rSimd_5_7_9, rSimd_7_8_9);
    gmx_simd_bool_t le   = gmx_simd_cmple_r(rSimd_5_7_9, rSimd_7_8_9);
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(0, 0, 3), gmx_simd_blendzero_r(rSimd_1_2_3, gmx_simd_and_b(eq, le)));
}
...
TEST_F(SimdFloatingPointTest, gmxSimdBoolOrB)
{
    gmx_simd_bool_t eq   = gmx_simd_cmpeq_r(rSimd_5_7_9, rSimd_7_8_9);
    gmx_simd_bool_t lt   = gmx_simd_cmplt_r(rSimd_5_7_9, rSimd_7_8_9);
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(1, 2, 3), gmx_simd_blendzero_r(rSimd_1_2_3, gmx_simd_or_b(eq, lt)));
}
...
TEST_F(SimdFloatingPointTest, gmxSimdAnytrueB)
{
     ...
     */
    eq = gmx_simd_cmpeq_r(rSimd_5_7_9, gmx::test::setSimdFrom3R(5, 0, 0));
...
{
    gmx_simd_bool_t lt   = gmx_simd_cmplt_r(rSimd_5_7_9, rSimd_7_8_9);
    GMX_EXPECT_SIMD_REAL_EQ(gmx::test::setSimdFrom3R(4, 5, 3), gmx_simd_blendv_r(rSimd_1_2_3, rSimd_4_5_6, lt));
}
