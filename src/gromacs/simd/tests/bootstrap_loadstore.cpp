 ...
 *
 * \param[in]  maxWidthForCheck  The number of elements of the SIMD4 vector
 * that are loaded and stored (if this is less than the SIMD4 width).
 */
template <typename T, typename TSimd> void
...
{
    // Can't use simd4LoadStoreTester because we want to use a vector
    // of length 3 in the final comparison
