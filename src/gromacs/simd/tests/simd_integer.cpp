...
{
    gmx_simd_bool_t  eq   = gmx_simd_cmpeq_r(rSimd_5_7_9, setSimdIntFrom3R(5, 0, 0));  // eq should be T,F,F
...
TEST_F(SimdIntegerTest, gmxSimdCvtIB2B)
{
    ...
    GMX_EXPECT_SIMD_REAL_EQ(setSimdIntFrom3R(1, 0, 0), gmx_simd_blendzero_r(rSimd_1_2_3, eq));
}
#endif
