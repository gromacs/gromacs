...
TEST_F(SimdIntegerTest, setI)
{
    GMX_EXPECT_SIMD_INT_EQ(setSimdIntFrom1I(0), SimdInt32(0));
...
TEST_F(SimdIntegerTest, cmpEqAndSelectMask)
{
    ...
    GMX_EXPECT_SIMD_INT_EQ(setSimdIntFrom3I(0, 0, 3), selectMask(iSimd_1_2_3, eq));
}

TEST_F(SimdIntegerTest, cmpEqAndselectNotMask)
{
    SimdIBool eq   = (iSimd_5_7_9 == iSimd_7_8_9);
    GMX_EXPECT_SIMD_INT_EQ(setSimdIntFrom3I(1, 2, 0), selectNotMask(iSimd_1_2_3, eq));
}

TEST_F(SimdIntegerTest, cmpLt)
{
    SimdIBool lt   = (iSimd_5_7_9 < iSimd_7_8_9);
    GMX_EXPECT_SIMD_INT_EQ(setSimdIntFrom3I(1, 2, 0), selectMask(iSimd_1_2_3, lt));
}
...
TEST_F(SimdIntegerTest, andB)
{
    ...
    GMX_EXPECT_SIMD_INT_EQ(setSimdIntFrom3I(0, 0, 3), selectMask(iSimd_1_2_3, eq1 && eq2));
}
...
TEST_F(SimdIntegerTest, orB)
{
    ...
    GMX_EXPECT_SIMD_INT_EQ(setSimdIntFrom3I(1, 0, 3), selectMask(iSimd_1_2_3, eq1 || eq2));
}
...
TEST_F(SimdIntegerTest, gmxSimdCvtB2IB)
{
    ...
    GMX_EXPECT_SIMD_INT_EQ(setSimdIntFrom3I(1, 0, 0), selectMask(iSimd_1_2_3, eqi));
...
TEST_F(SimdIntegerTest, gmxSimdCvtIB2B)
{
    ...
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(1.0, 0, 0), selectMask(rSimd_1_2_3, eq));
}
