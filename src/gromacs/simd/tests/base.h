 ...
 * functions. Declaring these is not really necessary, but they
 * describe the interface to which the derived classes should adhere
 * if they want to be called by the callFunction() functions in
 * classes derived from SimdFunctionTestBase. These functions here
 * could be made pure virtual, but there's no code that actually uses
 * dynamic dispatch.
 */
