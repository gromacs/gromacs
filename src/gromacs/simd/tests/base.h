 ...
 */
template<class _realType, class _epiType, class _boolType, class _exclfilterType>
...
class x86SimdFunctionSet :
    public SimdFunctionSetBase<gmx_mm_pr, gmx_epi32, gmx_mm_pb, gmx_exclfilter>
{
    public:
        realType load_pr(const real *a)
        {
        ...
        exclfilterType load_exclusion_filter(const unsigned *a)
        {
            /* In double precision, gmx_load_exclusion_filter is intended to
            ...
            return_value = TestFunctions::gmx_load_exclusion_filter(duplicated_ints);
            sfree(duplicated_ints);
#else
            return_value = TestFunctions::gmx_load_exclusion_filter(a);
#endif
            return return_value;
        }
