...
typedef SimdFunctionTest<3,1,real> SimdFunctionBlendzero;

template<>
template<class SimdFunctionSet,
         typename FunctionType> void
SimdFunctionBlendzero::callFunction(SimdFunctionSet &simdFunctionSet,
...
TEST_F(SimdFunctionBlendzero, gmx_blendzero_pr_Works)
{
    ...
    Tester(ReferenceFunctions::gmx_simd_ref_blendzero_pr,
           TestFunctions::gmx_blendzero_pr);
}

// ===

typedef SimdFunctionTest<4,1,real> SimdFunctionMasknotadd;
...
TEST_F(SimdFunctionMasknotadd, gmx_masknot_add_pr_Works)
{
    ...
    Tester(ReferenceFunctions::gmx_simd_ref_masknot_add_pr,
           TestFunctions::gmx_masknot_add_pr);
}
} // namespace
