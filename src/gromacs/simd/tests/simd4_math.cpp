...
/*! \internal \file
 * \brief
 * Test fixture and tests for SIMD4 math.
 *
 ...
 */
class Simd4MathTest : public ::gmx::test::SimdMathTest
{
    public:
#ifdef GMX_SIMD4_HAVE_REAL
...
::testing::AssertionResult
Simd4MathTest::compareSimd4MathFunction(const char * refFuncExpr, const char *simdFuncExpr,
...
#    endif
    ...
    for (x = range_.first; x < range_.second; x += dx)
    {
        ...
        refval  = refFunc(x);
        vsimd   = simd4Real2Vector(simdFunc(simdx));
