...
#ifdef GMX_SIMD_HAVE_REAL
/// \brief Return stl vector from floating-point simd.
///
/// The vector will have the same length as the SIMD width.
::std::vector<real>
...
/// \brief Return floating-point simd value from stl vector.
///
...
#ifdef GMX_SIMD_HAVE_REAL
/// \brief Internal implementation - use the macro GMX_EXPECT_SIMD_REAL_EQ() instead.
///
...
/// \brief Internal implementation - use the macro GMX_EXPECT_SIMD_FUNC_NEAR instead.
///
...
#ifdef GMX_SIMD_HAVE_INT32
//! \brief Convert integer SIMD to STL vector
std::vector<int>
...
//! \brief Returns a string with a printout of SIMD contents
std::string
...
/// \brief Internal routine. Use the macro GMX_EXPECT_SIMD_INT_EQ instead.
///
