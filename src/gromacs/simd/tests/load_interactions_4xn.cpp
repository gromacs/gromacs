...
{
#include "gromacs/mdlib/nbnxn_kernels/load_interactions_4xn.h"
#include "gromacs/mdlib/nbnxn_kernels/load_interactions_4xn_code.h"
}
...
typedef SimdFunctionTest<unsigned int> SimdFunction_load_interactions_4xn;

template<>
template<class SimdFunctionSet,
         typename FunctionType> void
SimdFunction_load_interactions_4xn::callFunction(SimdFunctionSet &simdFunctionSet,
...
{
    prepare(5, 4);
    Tester(ReferenceFunctions::gmx_simd_ref_load_interactions_4xn,
           TestFunctions::gmx_load_interactions_4xn,
