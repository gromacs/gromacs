...
constexpr real c0    = 0.0 + 1.0/3.0;
constexpr real c1    = 1.0 + 5.0/7.0;
constexpr real c2    = 2.0 + 9.0/13.0;
constexpr real c3    = 3.0 + 17.0/19.0;
constexpr real c4    = 4.0 + 23.0/29.0;
constexpr real c5    = 5.0 + 31.0/37.0;
constexpr real c6    = 6.0 + 41.0/43.0;
constexpr real c7    = 7.0 + 47.0/53.0;
constexpr real c8    = 8.0 + 59.0/61.0;
