...
//! Test if a SIMD4 real is bitwise identical to reference SIMD4 or real scalar.
//
// If the reference value is a scalar, test is performed against all SIMD4 elements.
#define GMX_ASSERT_SIMD4_REAL_EQ(ref, tst) ASSERT_PRED_FORMAT4(::simd4Test::compareSimd4RealUlp, ref, tst, 0, 0)

//! Test if a SIMD4 real is within tolerance of reference SIMD4 or real scalar.
//
// If the reference value is a scalar, test is performed against all SIMD4 elements.
#define GMX_ASSERT_SIMD4_REAL_NEAR(ref, tst, ulpTol, absTol) ASSERT_PRED_FORMAT4(::simd4Test::compareSimd4RealUlp, ref, tst, ulpTol, absTol)
...
//! Test approximate equality of SIMD4 vs. reference version of a function
//
...
#define GMX_ASSERT_SIMD4_FUNC_NEAR(refFunc, tstFunc, range, ulpTol, absTol) \
    ASSERT_PRED_FORMAT5(::simd4Test::compareSimd4MathFunction, refFunc, tstFunc, range, ulpTol, absTol)
