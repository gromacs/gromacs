...
extern const gmx_simd4_real_t rSimd_1_2_3;     //!< Generic (different) fp values.
extern const gmx_simd4_real_t rSimd_4_5_6;     //!< Generic (different) fp values.
extern const gmx_simd4_real_t rSimd_7_8_9;     //!< Generic (different) fp values.
extern const gmx_simd4_real_t rSimd_5_7_9;     //!< rSimd_1_2_3 + rSimd_4_5_6.
extern const gmx_simd4_real_t rSimd_m1_m2_m3;  //!< Generic negative fp values.
extern const gmx_simd4_real_t rSimd_3_1_4;     //!< Used to test min/max.
extern const gmx_simd4_real_t rSimd_m3_m1_m4;  //!< negative rSimd_3_1_4.
extern const gmx_simd4_real_t rSimd_2p25;      //!< Value that rounds down.
extern const gmx_simd4_real_t rSimd_3p75;      //!< Value that rounds up.
extern const gmx_simd4_real_t rSimd_m2p25;     //!< Negative value that rounds up.
extern const gmx_simd4_real_t rSimd_m3p75;     //!< Negative value that rounds down.
//! \brief Three large floating-point values whose exponents are >32.
extern const gmx_simd4_real_t rSimd_Exp;
extern const gmx_simd4_real_t rSimd_Bits1; //!< Pattern F0 repeated to fill single/double.
extern const gmx_simd4_real_t rSimd_Bits2; //!< Pattern CC repeated to fill single/double.
extern const gmx_simd4_real_t rSimd_Bits3; //!< Pattern C0 repeated to fill single/double.
extern const gmx_simd4_real_t rSimd_Bits4; //!< Pattern 0C repeated to fill single/double.
extern const gmx_simd4_real_t rSimd_Bits5; //!< Pattern FC repeated to fill single/double.
extern const gmx_simd4_real_t rSimd_Bits6; //!< Pattern 3C repeated to fill single/double.
 ...
 */
std::vector<real> simdReal2Vector(const gmx_simd4_real_t simd);
 ...
 */
gmx_simd4_real_t   vector2SimdReal(const std::vector<real> &v);
