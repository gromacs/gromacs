...
gmx_simd_ref_anytrue_pr(gmx_simd_ref_pr a)
{
    ...
    {
        b.r[i] = TestFunctions::HardwareSimdFunctionSet::isSimdTrue(a.r[i]);
    }
...
/*! \brief Wrapper function to help RunTest.
 *
 ...
 */
static gmx_inline int
gmx_anytrue_pr_wrapper(gmx_mm_pr a)
{
    int returnValue;
    returnValue = (0 != gmx_anytrue_pb(a));
    return returnValue;
}
             ...
             real                *result)
{
    ...
    result_int = function(a);
    result[0]  = (real) (0 != result_int);
}

TEST_F(SimdFunctionAnytrue, gmx_anytrue_pb_Works)
{
    prepare(1, 1);
    RunTest(ReferenceFunctions::gmx_simd_ref_anytrue_pr,
            gmx_anytrue_pr_wrapper, booleanReal(0));
}
