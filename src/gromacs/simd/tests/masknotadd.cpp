...
callFunction(SimdFunctionSet     &simdFunctionSet,
             ...
             real                *result)
{
    typename SimdFunctionSet::realType a, b, c, d, result_pr;
...
{
    prepare(4, 1, 5, 0);
    RunTest(ReferenceFunctions::gmx_simd_ref_masknot_add_pr,
            gmx_masknot_add_pr, real(0));
}
} // namespace
