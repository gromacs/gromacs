...
typedef SimdTest SimdTestVectorOperations;

TEST_F(SimdTestVectorOperations, gmxSimdCalcRsqR)
{
...
TEST_F(SimdTestVectorOperations, gmxSimdIprodR)
{
...
TEST_F(SimdTestVectorOperations, gmxSimdNorm2R)
{
    gmx_simd_real_t simdX     = setSimd3R(1, 2, 3);
    gmx_simd_real_t simdY     = setSimd3R(3, 0, 5);
    gmx_simd_real_t simdZ     = setSimd3R(4, 1, 8);
...
TEST_F(SimdTestVectorOperations, gmxSimdCprodR)
{
    gmx_simd_real_t aX    = setSimd3R(1, 2, 3);
    gmx_simd_real_t aY    = setSimd3R(3, 0, 5);
    gmx_simd_real_t aZ    = setSimd3R(4, 1, 8);
