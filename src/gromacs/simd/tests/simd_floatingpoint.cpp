...
TEST_F(SimdFloatingpointTest, set)
{
    real  r  = 2.0;
    real *p  = &r;
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom1R(0.0), SimdReal(0.0));
...
TEST_F(SimdFloatingpointTest, mulMask)
{
    SimdBool m = isNonZero(setSimdRealFrom3R(1, 0, 1));
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(4, 0, 18),
                            mulMask(rSimd_1_2_3, rSimd_4_5_6, m));
}
...
TEST_F(SimdFloatingpointTest, fmaMask)
{
    SimdBool m = isNonZero(setSimdRealFrom3R(1, 0, 1));
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(11, 0, 27),
                            fmaMask(rSimd_1_2_3, rSimd_4_5_6, rSimd_7_8_9, m)); // 1*4+7, etc.
}
...
TEST_F(SimdFloatingpointTest, rsqrtMask)
{
     ...
     */
    setUlpTol(1LL << shiftbits);
    GMX_EXPECT_SIMD_REAL_NEAR(ref, rsqrtMask(x, m));
}
...
TEST_F(SimdFloatingpointTest, rcpMask)
{
    SimdReal        x                  = setSimdRealFrom3R(M_PI, 0.0, -1234567890.0);
    SimdBool        m                  = isNonZero(x);
     ...
     */
    setUlpTol(1LL << shiftbits);
    GMX_EXPECT_SIMD_REAL_NEAR(ref, rcpMask(x, m));
}

TEST_F(SimdFloatingpointTest, cmpEqAndSelectMask)
{
    SimdBool eq   = rSimd_5_7_9 == rSimd_7_8_9;
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(0, 0, 3), selectMask(rSimd_1_2_3, eq));
}

TEST_F(SimdFloatingpointTest, isNonZeroAndSelectMask)
{
    SimdBool eq   = isNonZero(setSimdRealFrom3R(1, 0, 2));
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(1, 0, 3), selectMask(rSimd_1_2_3, eq));
}

TEST_F(SimdFloatingpointTest, selectNotMask)
{
    SimdBool eq   = rSimd_5_7_9 == rSimd_7_8_9;
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(1, 2, 0), selectNotMask(rSimd_1_2_3, eq));
}

TEST_F(SimdFloatingpointTest, cmpLe)
{
    SimdBool le   = rSimd_5_7_9 <= rSimd_7_8_9;
    GMX_EXPECT_SIMD_REAL_EQ(rSimd_1_2_3, selectMask(rSimd_1_2_3, le));
}

TEST_F(SimdFloatingpointTest, cmpLt)
{
    SimdBool lt   = rSimd_5_7_9 < rSimd_7_8_9;
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(1, 2, 0), selectMask(rSimd_1_2_3, lt));
}
...
TEST_F(SimdFloatingpointTest, andB)
{
    SimdBool eq   = rSimd_5_7_9 == rSimd_7_8_9;
    SimdBool le   = rSimd_5_7_9 <= rSimd_7_8_9;
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(0, 0, 3), selectMask(rSimd_1_2_3, (eq && le)));
}
...
TEST_F(SimdFloatingpointTest, orB)
{
    SimdBool eq   = rSimd_5_7_9 == rSimd_7_8_9;
    SimdBool lt   = rSimd_5_7_9 < rSimd_7_8_9;
    GMX_EXPECT_SIMD_REAL_EQ(setSimdRealFrom3R(1, 2, 3), selectMask(rSimd_1_2_3, (eq || lt)));
}
