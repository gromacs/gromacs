...
{
    gmx_simd4_real_t simdX  = setSimd4From3R(1, 2, 3);
    gmx_simd4_real_t simdY  = setSimd4From3R(3, 0, 5);
    gmx_simd4_real_t simdZ  = setSimd4From3R(4, 1, 8);
    gmx_simd4_real_t simdR2 = setSimd4From3R(26, 5, 98);
