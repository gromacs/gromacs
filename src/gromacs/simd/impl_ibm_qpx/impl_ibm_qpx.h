 ...
 ****************************************************/
static __attribute__((always_inline)) gmx_simdcall vector4double
...
static __attribute__((always_inline)) gmx_simdcall double
...
static __attribute__((always_inline)) gmx_simdcall int
...
static __attribute__((always_inline)) gmx_simdcall float
