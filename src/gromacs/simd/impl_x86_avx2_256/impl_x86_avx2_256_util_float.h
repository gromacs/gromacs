                                  ...
                                  SimdFloat *    v3)
{
    ...
    if (align == 4)
    {
        simdoffset.i = _mm256_slli_epi32(simdoffset.i, 2);
    }
    else if (align == 8)
    {
        simdoffset.i = _mm256_slli_epi32(simdoffset.i, 3);
    }
    else if (align == 12)
    {
        /* multiply by 3, then by 4 */
        simdoffset.i = _mm256_add_epi32(simdoffset.i, _mm256_slli_epi32(simdoffset.i, 1));
        simdoffset.i = _mm256_slli_epi32(simdoffset.i, 2);
    }
    else if (align == 16)
    {
        simdoffset.i = _mm256_slli_epi32(simdoffset.i, 4);
    }
                                  ...
                                  SimdFloat *     v1)
{
    ...
    if (align == 2)
    {
        simdoffset.i = _mm256_slli_epi32(simdoffset.i, 1);
    }
    else if (align == 4)
    {
        simdoffset.i = _mm256_slli_epi32(simdoffset.i, 2);
