                     ...
                     SimdFloat *          v2)
{
    ...
    *v0 = _mm256_i32gather_ps(base + 0, vindex.simdInternal_, 4);
    *v1 = _mm256_i32gather_ps(base + 1, vindex.simdInternal_, 4);
    *v2 = _mm256_i32gather_ps(base + 2, vindex.simdInternal_, 4);
}
