...
{
    *out0 = 1.0f/std::sqrt(x0);
    *out1 = 1.0f/std::sqrt(x1);
}
...
{
    *out0 = 1.0/std::sqrt(x0);
    *out1 = 1.0/std::sqrt(x1);
}
...
invsqrtPairSingleAccuracy(double x0,    double x1,
                          double *out0, double *out1)
{
    *out0 = 1.0f/std::sqrt(static_cast<float>(x0));
    *out1 = 1.0f/std::sqrt(static_cast<float>(x1));
}
