...
#define gmx_simd_load_fi(m)       _mm_load_si128((__m128i *)m)
#define gmx_simd_set1_fi          _mm_set1_epi32
#define gmx_simd_store_fi(m, x)    _mm_store_si128((__m128i *)m, x)
#define gmx_simd_loadu_fi(m)      _mm_loadu_si128((__m128i *)m)
...
#define gmx_simd_load_di(m)        _mm_loadl_epi64((__m128i *)m)
#define gmx_simd_set1_di           _mm_set1_epi32
#define gmx_simd_store_di(m, x)     _mm_storel_epi64((__m128i *)m, x)
#define gmx_simd_loadu_di(m)       _mm_loadl_epi64((__m128i *)m)
