...
#undef  GMX_SIMD_HAVE_HSIMD_FLOAT_UTIL  /* No need for half-simd, width is 4 */
#undef  GMX_SIMD_HAVE_HSIMD_DOUBLE_UTIL /* No need for half-simd, width is 2 */
...
#define gmx_simd_gather_load_3_transpose_f       gmx_simd_gather_load_3_transpose_f_sse2
#define gmx_simd_transpose_scatter_store_3_f     gmx_simd_transpose_scatter_store_3_f_sse2
#define gmx_simd_transpose_scatter_incr_3_f      gmx_simd_transpose_scatter_incr_3_f_sse2
#define gmx_simd_transpose_scatter_decr_3_f      gmx_simd_transpose_scatter_decr_3_f_sse2
#define gmx_simd_expand_scalars_to_triplets_f    gmx_simd_expand_scalars_to_triplets_f_sse2
#define gmx_simd_pairs_storage_alignment_f       gmx_simd_pairs_storage_alignment_f_sse2
#define gmx_simd_load_pairs_transpose_f          gmx_simd_load_pairs_transpose_f_sse2
#define gmx_simd_loadu_2_transpose_f             gmx_simd_loadu_2_transpose_f_sse2
#define gmx_simd_load_4_transpose_f              gmx_simd_load_4_transpose_f_sse2
#define gmx_simd_load_2of4_transpose_f           gmx_simd_load_2of4_transpose_f_sse2
...
#define gmx_simd_gather_load_3_transpose_d       gmx_simd_gather_load_3_transpose_d_sse2
#define gmx_simd_transpose_scatter_store_3_d     gmx_simd_transpose_scatter_store_3_d_sse2
#define gmx_simd_transpose_scatter_incr_3_d      gmx_simd_transpose_scatter_incr_3_d_sse2
#define gmx_simd_transpose_scatter_decr_3_d      gmx_simd_transpose_scatter_decr_3_d_sse2
#define gmx_simd_expand_scalars_to_triplets_d    gmx_simd_expand_scalars_to_triplets_d_sse2
#define gmx_simd_pairs_storage_alignment_d       gmx_simd_pairs_storage_alignment_d_sse2
#define gmx_simd_load_pairs_transpose_d          gmx_simd_load_pairs_transpose_d_sse2
#define gmx_simd_loadu_2_transpose_d             gmx_simd_loadu_2_transpose_d_sse2
#define gmx_simd_load_4_transpose_d              gmx_simd_load_4_transpose_d_sse2
#define gmx_simd_load_2of4_transpose_d           gmx_simd_load_2of4_transpose_d_sse2
...
gmx_simd_gather_load_3_transpose_f_sse2(const float * base, const gmx_int32_t offset[],
                                        gmx_simd_float_t * v0, gmx_simd_float_t * v1, gmx_simd_float_t * v2)
{
    __m128 t1, t2, t3, t4, t5, t6, t7, t8;
    t1   = _mm_castpd_ps(_mm_load_sd((const double *)(base + 3 * offset[0])));
    t2   = _mm_castpd_ps(_mm_load_sd((const double *)(base + 3 * offset[1])));
    t3   = _mm_castpd_ps(_mm_load_sd((const double *)(base + 3 * offset[2])));
    t4   = _mm_castpd_ps(_mm_load_sd((const double *)(base + 3 * offset[3])));
    t5   = _mm_load_ss(base + 3 * offset[0] + 2);
    t6   = _mm_load_ss(base + 3 * offset[1] + 2);
    t7   = _mm_load_ss(base + 3 * offset[2] + 2);
    t8   = _mm_load_ss(base + 3 * offset[3] + 2);
...
static gmx_inline void gmx_simdcall
gmx_simd_transpose_scatter_store_3_f_sse2(float * base, const gmx_int32_t offset[],
                                          gmx_simd_float_t v0, gmx_simd_float_t v1, gmx_simd_float_t v2)
{
    __m128 t1, t2;
    ...
    _mm_storel_pi((__m64 *)(base + 3 * offset[0]), t1);
    _mm_store_ss(base + 3 * offset[0] + 2, v2);
    _mm_storeh_pi((__m64 *)(base + 3 * offset[1]), t1);
    _mm_store_ss(base + 3 * offset[1] + 2, _mm_shuffle_ps(v2, v2, _MM_SHUFFLE(1, 1, 1, 1)));
    _mm_storel_pi((__m64 *)(base + 3 * offset[2]), t2);
    _mm_store_ss(base + 3 * offset[2] + 2, _mm_shuffle_ps(v2, v2, _MM_SHUFFLE(2, 2, 2, 2)));
    _mm_storeh_pi((__m64 *)(base + 3 * offset[3]), t2);
    _mm_store_ss(base + 3 * offset[3] + 2, _mm_shuffle_ps(v2, v2, _MM_SHUFFLE(3, 3, 3, 3)));
}

static gmx_inline void gmx_simdcall
gmx_simd_transpose_scatter_incr_3_f_sse2(float * base, const gmx_int32_t offset[],
                                         gmx_simd_float_t v0, gmx_simd_float_t v1, gmx_simd_float_t v2)
{
    ...
    t1          = _mm_load_ss(base + 3 * offset[0]);
    t1          = _mm_loadh_pi(t1, (__m64 *)(base + 3 * offset[0] + 1));
    t1          = _mm_add_ps(t1, t7);
    _mm_store_ss(base + 3 * offset[0], t1);
    _mm_storeh_pi((__m64 *)(base + 3 * offset[0] + 1), t1);
    t2          = _mm_load_ss(base + 3 * offset[1]);
    t2          = _mm_loadh_pi(t2, (__m64 *)(base + 3 * offset[1] + 1));
    t2          = _mm_add_ps(t2, t8);
    _mm_store_ss(base + 3 * offset[1], t2);
    _mm_storeh_pi((__m64 *)(base + 3 * offset[1] + 1), t2);
    t3          = _mm_load_ss(base + 3 * offset[2]);
    t3          = _mm_loadh_pi(t3, (__m64 *)(base + 3 * offset[2] + 1));
    t3          = _mm_add_ps(t3, t9);
    _mm_store_ss(base + 3 * offset[2], t3);
    _mm_storeh_pi((__m64 *)(base + 3 * offset[2] + 1), t3);
    t4          = _mm_load_ss(base + 3 * offset[3]);
    t4          = _mm_loadh_pi(t4, (__m64 *)(base + 3 * offset[3] + 1));
    t4          = _mm_add_ps(t4, t10);
    _mm_store_ss(base + 3 * offset[3], t4);
    _mm_storeh_pi((__m64 *)(base + 3 * offset[3] + 1), t4);
}

static gmx_inline void gmx_simdcall
gmx_simd_transpose_scatter_decr_3_f_sse2(float * base, const gmx_int32_t offset[],
                                         gmx_simd_float_t v0, gmx_simd_float_t v1, gmx_simd_float_t v2)
{
...
static const int gmx_simd_pairs_storage_alignment_f_sse2 = 2;

static gmx_inline void gmx_simdcall
gmx_simd_load_pairs_transpose_f_sse2(const float * base,    gmx_int32_t offset[],
                                     gmx_simd_float_t * v0, gmx_simd_float_t * v1)
{
    __m128 t1, t2;
    *v0  = _mm_loadl_pi(_mm_setzero_ps(), (__m64 *)(base + gmx_simd_pairs_storage_alignment_f_sse2 * offset[0]));
    *v1  = _mm_loadl_pi(_mm_setzero_ps(), (__m64 *)(base + gmx_simd_pairs_storage_alignment_f_sse2 * offset[1]));
    t1   = _mm_loadl_pi(_mm_setzero_ps(), (__m64 *)(base + gmx_simd_pairs_storage_alignment_f_sse2 * offset[2]));
    t2   = _mm_loadl_pi(_mm_setzero_ps(), (__m64 *)(base + gmx_simd_pairs_storage_alignment_f_sse2 * offset[3]));
...
static gmx_inline void gmx_simdcall
gmx_simd_loadu_2_transpose_f_sse2(const float * base,    gmx_int32_t offset[],
                                  gmx_simd_float_t * v0, gmx_simd_float_t * v1)
{
    __m128 t1, t2;
    *v0  = _mm_castpd_ps(_mm_load_sd((const double *)(base + offset[0])));
    *v1  = _mm_castpd_ps(_mm_load_sd((const double *)(base + offset[1])));
    t1   = _mm_castpd_ps(_mm_load_sd((const double *)(base + offset[2])));
    t2   = _mm_castpd_ps(_mm_load_sd((const double *)(base + offset[3])));
    t1   = _mm_unpacklo_ps(*v0, t1);
    t2   = _mm_unpacklo_ps(*v1, t2);
    *v0  = _mm_unpacklo_ps(t1, t2);
    *v1  = _mm_unpackhi_ps(t1, t2);
...
static gmx_inline void gmx_simdcall
gmx_simd_load_2of4_transpose_f_sse2(const float * base,    gmx_simd_fint32_t offset,
                                    gmx_simd_float_t * v0, gmx_simd_float_t * v1)
{
    __m128 t1, t2;
...
static gmx_inline void gmx_simdcall
gmx_simd_load_4_transpose_f_sse2(const float * base,    gmx_simd_fint32_t offset,
                                 gmx_simd_float_t * v0, gmx_simd_float_t * v1,
 ...
 ****************************************************/
static gmx_inline void gmx_simdcall
gmx_simd_gather_load_3_transpose_d_sse2(const double * base, const gmx_int32_t offset[],
                                        gmx_simd_double_t * v0, gmx_simd_double_t * v1, gmx_simd_double_t * v2)
{
    __m128d t1, t2, t3, t4;
    t1           = _mm_loadu_pd(base + 3 * offset[0]);
    t2           = _mm_loadu_pd(base + 3 * offset[1]);
    t3           = _mm_load_sd(base + 3 * offset[0] + 2);
    t4           = _mm_load_sd(base + 3 * offset[1] + 2);
...
static gmx_inline void gmx_simdcall
gmx_simd_transpose_scatter_store_3_d_sse2(double * base, const gmx_int32_t offset[],
                                          gmx_simd_double_t v0, gmx_simd_double_t v1, gmx_simd_double_t v2)
{
    __m128d t1, t2;
    ...
    _mm_storeu_pd(base + 3 * offset[0], t1);
    _mm_store_sd(base + 3 * offset[0] + 2, v2);
    _mm_storeu_pd(base + 3 * offset[1], t2);
    _mm_storeh_pi((__m64 *)(base + 3 * offset[1] + 2), _mm_castpd_ps(v2));
}

static gmx_inline void gmx_simdcall
gmx_simd_transpose_scatter_incr_3_d_sse2(double * base, const gmx_int32_t offset[],
                                         gmx_simd_double_t v0, gmx_simd_double_t v1, gmx_simd_double_t v2)
{
    __m128d t1, t2, t3, t4, t5, t6, t7;

    t1          = _mm_loadu_pd(base + 3 * offset[0]);
    t2          = _mm_load_sd(base + 3 * offset[0] + 2);
    t3          = _mm_loadu_pd(base + 3 * offset[1]);
    t4          = _mm_load_sd(base + 3 * offset[1] + 2);
    ...
    _mm_storeu_pd(base + 3 * offset[0], t1);
    _mm_store_sd(base + 3 * offset[0] + 2, t2);
    _mm_storeu_pd(base + 3 * offset[1], t3);
    _mm_store_sd(base + 3 * offset[1] + 2, t4);
}

static gmx_inline void gmx_simdcall
gmx_simd_transpose_scatter_decr_3_d_sse2(double * base, const gmx_int32_t offset[],
                                         gmx_simd_double_t v0, gmx_simd_double_t v1, gmx_simd_double_t v2)
{
    /* This implementation is identical to the increment version, apart from using subtraction instead */
    __m128d t1, t2, t3, t4, t5, t6, t7;
...
static const int gmx_simd_pairs_storage_alignment_d_sse2 = 2;

static gmx_inline void gmx_simdcall
gmx_simd_load_pairs_transpose_d_sse2(const double * base,    gmx_int32_t offset[],
                                     gmx_simd_double_t * v0, gmx_simd_double_t * v1)
{
    __m128d t1, t2;
    t1   = _mm_load_pd(base + gmx_simd_pairs_storage_alignment_d_sse2 * offset[0]);
    t2   = _mm_load_pd(base + gmx_simd_pairs_storage_alignment_d_sse2 * offset[1]);
    *v0  = _mm_unpacklo_pd(t1, t2);
    *v1  = _mm_unpackhi_pd(t1, t2);
}

static gmx_inline void gmx_simdcall
gmx_simd_loadu_2_transpose_d_sse2(const double * base,    gmx_int32_t offset[],
                                  gmx_simd_double_t * v0, gmx_simd_double_t * v1)
{
    __m128d t1, t2;
    t1   = _mm_loadu_pd(base + offset[0]);
    t2   = _mm_loadu_pd(base + offset[1]);
    *v0  = _mm_unpacklo_pd(t1, t2);
    *v1  = _mm_unpackhi_pd(t1, t2);
}

static gmx_inline void gmx_simdcall
gmx_simd_load_2of4_transpose_d_sse2(const double * base,    gmx_simd_dint32_t offset,
                                    gmx_simd_double_t * v0, gmx_simd_double_t * v1)
{
    __m128d t1, t2;
    offset = _mm_slli_epi32(offset, 2);
...
static gmx_inline void gmx_simdcall
gmx_simd_load_4_transpose_d_sse2(const double * base,    gmx_simd_dint32_t offset,
                                 gmx_simd_double_t * v0, gmx_simd_double_t * v1,
