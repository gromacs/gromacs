...
transpose(SimdDouble * v0,
          SimdDouble * v1,
          SimdDouble * v2,
          SimdDouble * v3)
{
    __m128d t0 = v0->simdInternal_;
    __m128d t1 = v1->simdInternal_;
    v0->simdInternal_ = _mm_unpacklo_pd(t0, t1);
    v1->simdInternal_ = _mm_unpacklo_pd(v2->simdInternal_, v3->simdInternal_);
    v3->simdInternal_ = _mm_unpackhi_pd(v2->simdInternal_, v3->simdInternal_);
    v2->simdInternal_ = _mm_unpackhi_pd(t0, t1);
}
...
{
    triplets0->simdInternal_ = _mm_shuffle_pd(scalar.simdInternal_, scalar.simdInternal_, _MM_SHUFFLE2(0, 0));
    triplets1->simdInternal_ = _mm_shuffle_pd(scalar.simdInternal_, scalar.simdInternal_, _MM_SHUFFLE2(1, 0));
    triplets2->simdInternal_ = _mm_shuffle_pd(scalar.simdInternal_, scalar.simdInternal_, _MM_SHUFFLE2(1, 1));
}
#endif
