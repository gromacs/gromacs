...
static inline SimdFloat gmx_simdcall
maskedAdd(SimdFloat a, SimdFloat b, SimdFBool m)
{
    return {
               _mm_and_ps(_mm_add_ps(a.simdInternal_, b.simdInternal_), m.simdInternal_)
    };
}

static inline SimdFloat gmx_simdcall
maskedMul(SimdFloat a, SimdFloat b, SimdFBool m)
{
    return {
...
static inline SimdFloat gmx_simdcall
maskedFma(SimdFloat a, SimdFloat b, SimdFloat c, SimdFBool m)
{
    return {
...
#if GMX_SIMD_X86_SSE2
static inline SimdFloat gmx_simdcall
maskedRsqrt(SimdFloat x, SimdFBool m)
{
#ifndef NDEBUG
...
static inline SimdFloat gmx_simdcall
maskedRcp(SimdFloat x, SimdFBool m)
{
#ifndef NDEBUG
    x.simdInternal_ = _mm_or_ps(_mm_andnot_ps(m.simdInternal_, _mm_set1_ps(1.0f)), _mm_and_ps(m.simdInternal_, x.simdInternal_));
#endif
...
{
    return {
               _mm_cmpneq_ps(a.simdInternal_, _mm_setzero_ps())
    };
}
...
{
    return {
               _mm_or_si128(_mm_cmpgt_epi32(a.simdInternal_, _mm_setzero_si128()),
                            _mm_cmplt_epi32(a.simdInternal_, _mm_setzero_si128()))
    };
}
