...
static inline void gmx_simdcall storeU(float *m, SimdFloat a) { _mm_storeu_ps(m, a.simdInternal_); }
...
static inline SimdFInt32 gmx_simdcall simdLoadUFI(const std::int32_t *m)
{
    return {
...
static inline bool gmx_simdcall anyTrue(SimdFBool a) { return _mm_movemask_ps(a.simdInternal_) != 0; }
...
static inline bool gmx_simdcall anyTrue(SimdFIBool a) { return _mm_movemask_epi8(a.simdInternal_) != 0; }
