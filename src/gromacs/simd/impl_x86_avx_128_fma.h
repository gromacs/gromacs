...
/* Neither AVX_128_FMA nor AVX_256 is a superset of the other, so
 * we can't set any convenience define that "this or higher" is supported.
 */
...
#define gmx_simd4_load1_d                _mm256_load1_pd
...
#define gmx_simd4_max_d                  _mm256_max_d
#define gmx_simd4_min_d                  _mm256_min_d
...
#define gmx_simd4_dbool_t                __m256
#define gmx_simd4_cmpeq_d                _mm256_cmpeq_pd
#define gmx_simd4_cmplt_d                _mm256_cmplt_pd
#define gmx_simd4_cmple_d                _mm256_cmple_pd
