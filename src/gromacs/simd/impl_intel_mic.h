...
#define gmx_simd_loadu_d(m)        gmx_simd_loadu_d_mic
...
#define gmx_simd_storeu_di         gmx_simd_storeu_i_mic
...
#define gmx_simd_anytrue_dib       (_mm512_mask2int(x)&0xFF)
...
#define gmx_simd4_loadu_d(m)        gmx_simd4_loadu_d_mic
...
static gmx_inline __m512d
gmx_simd4_loadu_d_mic(double *m)
{
