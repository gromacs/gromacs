...
#define gmx_simd_storeu_pd         _mm_storeu_pd
...
gmx_simd_get_exponent_f_sse2(__m128 x)
{
    ...
    iexp = _mm_sub_epi32(_mm_srli_epi32(iexp, mantissabits), expbias);
...
gmx_simd_set_exponent_f_sse2(__m128 x)
{
    ...
    iexp = _mm_slli_epi32(_mm_add_epi32(iexp, expbias), mantissabits);
...
gmx_simd_get_exponent_d_sse2(__m128d x)
{
    ...
    iexp   = _mm_sub_epi32(_mm_srli_epi64(iexp, mantissabits), expbias);
...
gmx_simd_set_exponent_d_sse2(__m128d x)
{
    ...
    iexp = _mm_shuffle_epi32(iexp, _MM_SHUFFLE(3, 1, 2, 0));
    iexp = _mm_slli_epi64(_mm_add_epi32(iexp, expbias), mantissabits);
