...
ldexp(SimdDouble value, SimdDInt32 exponent)
{
    ...
    iExponent = _mm512_mask_slli_epi32(_mm512_setzero_epi32(), 0xAAAA, _mm512_add_epi32(iExponent, exponentBias), 20);
...
{
    return {
               _mm512_mask_cmp_epi32_mask(0xFF, _mm512_castsi256_si512(a.simdInternal_), _mm512_castsi256_si512(b.simdInternal_), _MM_CMPINT_EQ)
    };
}
...
{
    return {
               _mm512_mask_test_epi32_mask(0xFF, _mm512_castsi256_si512(a.simdInternal_), _mm512_castsi256_si512(a.simdInternal_))
    };
}
...
{
    return {
               _mm512_mask_cmp_epi32_mask(0xFF, _mm512_castsi256_si512(a.simdInternal_), _mm512_castsi256_si512(b.simdInternal_), _MM_CMPINT_LT)
    };
}
