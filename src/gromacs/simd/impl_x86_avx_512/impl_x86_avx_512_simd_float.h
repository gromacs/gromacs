...
{
    return {
               _mm256_rsqrt14_ps(x.simdInternal_)
    };
}
...
{
    return {
               _mm256_rcp14_ps(x.simdInternal_)
    };
}
...
{
    return {
               _mm256_mask_add_ps(a.simdInternal_, m.simdInternal_, a.simdInternal_, b.simdInternal_)
    };
}
...
{
    return {
               _mm256_maskz_mul_ps(m.simdInternal_, a.simdInternal_, b.simdInternal_)
    };
}
...
{
    return {
               _mm256_maskz_fmadd_ps(m.simdInternal_, a.simdInternal_, b.simdInternal_, c.simdInternal_)
    };
}
...
{
    return {
               _mm256_maskz_rsqrt14_ps(m.simdInternal_, x.simdInternal_)
    };
}
...
{
    return {
               _mm256_maskz_rcp14_ps(m.simdInternal_, x.simdInternal_)
    };
}
...
{
    return {
               _mm256_roundscale_ps(x.simdInternal_, 0)
    };
}
...
trunc(SimdFloat x)
{
    ...
    return {
               _mm256_trunc_ps(x.simdInternal_)
    };
#else
    return {
               _mm256_cvtepi32_ps(_mm256_cvttps_epi32(x.simdInternal_))
    };
#endif
}
...
{
    __m256  rExponent = _mm256_getexp_ps(value.simdInternal_);
    __m256i iExponent =  _mm256_cvtps_epi32(rExponent);

    exponent->simdInternal_ = _mm256_add_epi32(iExponent, _mm256_set1_epi32(1));

    return {
               _mm256_getmant_ps(value.simdInternal_, _MM_MANT_NORM_p5_1, _MM_MANT_SIGN_src)
    };
}
...
{
    return {
               _mm256_cmp_ps_mask(a.simdInternal_, b.simdInternal_, _CMP_EQ_OQ)
    };
}
...
{
    return {
               _mm256_cmp_ps_mask(a.simdInternal_, b.simdInternal_, _CMP_NEQ_OQ)
    };
}
...
{
    return {
               _mm256_cmp_ps_mask(a.simdInternal_, b.simdInternal_, _CMP_LT_OQ)
    };
}
...
{
    return {
               _mm256_cmp_ps_mask(a.simdInternal_, b.simdInternal_, _CMP_LE_OQ)
    };
}
...
{
    return {
               _mm256_test_epi32_mask( _mm256_castps_si256(a.simdInternal_), _mm256_castps_si256(a.simdInternal_) )
    };
}
...
{
    return {
               _mm256_mask_mov_ps(_mm256_setzero_ps(), m.simdInternal_, a.simdInternal_)
    };
}
...
{
    return {
               _mm256_mask_mov_ps(a.simdInternal_, m.simdInternal_, _mm256_setzero_ps())
    };
}
...
{
    return {
               _mm256_mask_blend_ps(sel.simdInternal_, a.simdInternal_, b.simdInternal_)
    };
}
...
{
    return {
               _mm256_cmp_epi32_mask(a.simdInternal_, b.simdInternal_, _MM_CMPINT_EQ)
    };
}
...
{
    return {
               _mm256_test_epi32_mask( a.simdInternal_, a.simdInternal_ )
    };
}
...
{
    return {
               _mm256_cmp_epi32_mask(a.simdInternal_, b.simdInternal_, _MM_CMPINT_LT)
    };
}
...
{
    return {
               _mm256_mask_mov_epi32(_mm256_setzero_si256(), m.simdInternal_, a.simdInternal_)
    };
}
...
{
    return {
               _mm256_mask_mov_epi32(a.simdInternal_, m.simdInternal_, _mm256_setzero_si256())
    };
}
...
{
    return {
               _mm256_mask_blend_epi32(sel.simdInternal_, a.simdInternal_, b.simdInternal_)
    };
}
