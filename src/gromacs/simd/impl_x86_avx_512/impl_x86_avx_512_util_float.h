                     ...
                     SimdFloat  v3)
{
    ...
    return *reinterpret_cast<float *>(&t3);
              ...
              const float * m1)
{
    ...
    return {
               _mm512_castpd_ps(_mm512_insertf64x4(_mm512_castpd256_pd512(_mm256_load_pd((double*)m0)),
...
loadDuplicateHsimd(const float * m)
{
    ...
    return {
               _mm512_castpd_ps(_mm512_broadcast_f64x4(_mm256_load_pd((double*)m)))
    };
}
                         ...
                         SimdFloat *          v1)
{
    ...
    idx0 = _mm256_load_si256((const __m256i*)offset);
