...
//   own routines avx256Mask2Int() & avx256Int2Mask() that simply return
...
// - gcc does not provide _mm256_trunc_ps(), and all alternative ops where we
...
// Technically it is straightforward to emulate extract on AVX-256 through
