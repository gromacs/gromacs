...
/* By default we make do with "double" that has twice the precision of single.
 * Then 2 N-R iterations will suffice on x86 */
...
#ifndef GMX_SIMD_RSQRT_ITER_F_IMPLEMENTED
static gmx_inline gmx_simd4_float_t
