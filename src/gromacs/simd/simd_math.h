 ...
 *          zero for arguments reaching -126.5 in single or -1022.5 in double,
 *          and it might overflow for arguments reaching 127.5 (single) or
 *          1022.5 (double). If you enable the unsafe math optimization,
 *          very small arguments will not lead to zero-clamping, but produce
 *          undefined results.
 *
 ...
 *          127.5*ln(2)=88.3 (single) or 1023.5*ln(2)=709.4 (double). If the
