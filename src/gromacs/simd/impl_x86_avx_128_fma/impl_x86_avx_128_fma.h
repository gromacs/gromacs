...
#undef  gmx_simd_gather_load_3_transpose_f
#define gmx_simd_gather_load_3_transpose_f      gmx_simd_gather_load_3_transpose_f_avx_128_fma
#undef  gmx_simd_transpose_scatter_store_3_f
#define gmx_simd_transpose_scatter_store_3_f    gmx_simd_transpose_scatter_store_3_f_avx_128_fma
...
gmx_simd_gather_load_3_transpose_f_avx_128_fma(const float * base, const gmx_int32_t offset[],
                                               gmx_simd_float_t * v0, gmx_simd_float_t * v1, gmx_simd_float_t * v2)
{
    __m128  t1, t2, t3, t4;
    __m128i mask = _mm_set_epi32(0, -1, -1, -1);
    t1             = gmx_mm_maskload_ps(base + 3 * offset[0], mask);
    t2             = gmx_mm_maskload_ps(base + 3 * offset[1], mask);
    t3             = gmx_mm_maskload_ps(base + 3 * offset[2], mask);
    t4             = gmx_mm_maskload_ps(base + 3 * offset[3], mask);
...
static gmx_inline void gmx_simdcall
gmx_simd_transpose_scatter_store_3_f_avx_128_fma(float * base, const gmx_int32_t offset[],
                                                 gmx_simd_float_t v0, gmx_simd_float_t v1, gmx_simd_float_t v2)
{
    __m128  t3   = _mm_setzero_ps();
    __m128i mask = _mm_set_epi32(0, -1, -1, -1);
    _MM_TRANSPOSE4_PS(v0, v1, v2, t3);
    gmx_mm_maskstore_ps(base + 3 * offset[0], mask, v0);
    gmx_mm_maskstore_ps(base + 3 * offset[1], mask, v1);
    gmx_mm_maskstore_ps(base + 3 * offset[2], mask, v2);
    gmx_mm_maskstore_ps(base + 3 * offset[3], mask, t3);
