...
gmx_simd_get_exponent_f_avx2_256(gmx_simd_float_t x)
{
    ...
    iexp = _mm256_sub_epi32(_mm256_srli_epi32(iexp, mantissabits), expbias);
...
gmx_simd_set_exponent_f_avx2_256(gmx_simd_float_t x)
{
    ...
    iexp = _mm256_slli_epi32(_mm256_add_epi32(iexp, expbias), mantissabits);
...
gmx_simd_get_exponent_d_avx2_256(gmx_simd_double_t x)
{
    ...
    iexp = _mm256_sub_epi64(_mm256_srli_epi64(iexp, mantissabits), expbias);
...
gmx_simd_set_exponent_d_avx2_256(gmx_simd_double_t x)
{
    ...
    iexp = _mm256_slli_epi64(_mm256_add_epi64(iexp, expbias), mantissabits);
