 ...
 *
 * Note that the reference implementation rounds exact half-way cases
 ...
 *
 * Note that the argument will be _rounded_ to nearest integer since that is what
 ...
 * \param a factor1
 * \param b factor2
 * \return a*b. Note that only the low 32 bits are retained, so this can overflow.
 */
static gmx_inline gmx_simd_fint32_t
