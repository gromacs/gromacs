...
/*! SIMD double support present */
#define GMX_SIMD_HAVE_DOUBLE

/*! SIMD implementation uses software */
#undef GMX_SIMD_HAVE_HARDWARE

/*! SIMD implementation does not care about load alignment */
#define GMX_SIMD_HAVE_LOADU

/*! SIMD implementation does not care about store alignment */
#define GMX_SIMD_HAVE_STOREU

/*! SIMD support for logical operations on floating-point data */
#define GMX_SIMD_HAVE_LOGICAL

/*! SIMD implementation supports fused multiply-add */
#undef GMX_SIMD_HAVE_FMA

/*! SIMD implementation support for getting fraction of FP number */
#undef GMX_SIMD_HAVE_FRACTION

/*! Integers corresponding to float SIMD. */
#define GMX_SIMD_HAVE_FINT32

/*! Support for extracting integer from gmx_simd_fint32_t */
...
/*! Accuracy of SIMD 1/sqrt(x) lookup */
#define GMX_SIMD_RSQRT_BITS             23

/*! Accuracy of SIMD 1/x lookup */
#define GMX_SIMD_RCP_BITS               23

/* SINGLE-PRECISION FLOATING-POINT OPERATIONS */

/*! \brief Float SIMD register. Supported with GMX_SIMD_HAVE_FLOAT.
 */
typedef struct
{
...
/*! Fused-multiply-add. Result is a*b+c. Hardware if GMX_SIMD_HAVE_FMA. */
#define gmx_simd_fmadd_f(a, b, c) gmx_simd_add_f(gmx_simd_mul_f(a, b), c)


/*! Fused-multiply-subtract. Result is a*b-c. Hardware if GMX_SIMD_HAVE_FMA. */
#define gmx_simd_fmsub_f(a, b, c) gmx_simd_sub_f(gmx_simd_mul_f(a, b), c)


/*! Fused-negated-multiply-add. Result is -a*b+c. Hardware if GMX_SIMD_HAVE_FMA. */
...
/*! Bitwise and for two SIMD fp registers. Supported with GMX_SIMD_HAVE_LOGICAL. */
static gmx_inline gmx_simd_float_t
...
/*! Bitwise andnot for SIMD FP. c=(~a) & b. Supported with GMX_SIMD_HAVE_LOGICAL. */
static gmx_inline gmx_simd_float_t
...
/*! Bitwise or for SIMD FP. Supported with GMX_SIMD_HAVE_LOGICAL. */
static gmx_inline gmx_simd_float_t
...
/*! Bitwise xor for SIMD FP. Supported with GMX_SIMD_HAVE_LOGICAL. */
static gmx_inline gmx_simd_float_t
 ...
 *
 * Both the argument and return values are float.
 */
static gmx_inline gmx_simd_float_t
...
/*! Get SIMD mantissa - similar to gmx_simd_get_exponent_f() */
static gmx_inline gmx_simd_float_t
...
/*! Integer SIMD register type to use for conversions to/from float.
 *
 * This is also the widest integer SIMD type.
 */
typedef struct
{
    int i[GMX_SIMD_FINT32_WIDTH]; /*!< Implementation dependent. Don't touch. */
}
gmx_simd_fint32_t;
...
/*! Load aligned SIMD integer data */
...
/*! Load unaligned integer SIMD data. Supported with GMX_SIMD_HAVE_LOADU */
#define gmx_simd_loadu_fi  gmx_simd_load_fi

/*! Store unaligned integer SIMD data. Supported with GMX_SIMD_HAVE_LOADU */
...
/*! Integer SIMD bitwise and. Available with GMX_SIMD_HAVE_FINT32_LOGICAL. */
static gmx_inline gmx_simd_fint32_t
...
/*! Integer SIMD bitwise not-and. Available with GMX_SIMD_HAVE_FINT32_LOGICAL. */
static gmx_inline gmx_simd_fint32_t
...
/*! Integer SIMD bitwise or. Available with GMX_SIMD_HAVE_FINT32_LOGICAL. */
static gmx_inline gmx_simd_fint32_t
...
/*! Integer SIMD bitwise xor. Available with GMX_SIMD_HAVE_FINT32_LOGICAL. */
static gmx_inline gmx_simd_fint32_t
...
/*! Boolean type for float SIMD data.
 *
...
typedef struct
{
    int b[GMX_SIMD_FLOAT_WIDTH]; /*!< Implementation dependent. Don't touch. */
}
gmx_simd_fbool_t;
...
/*! Select from single precision fp SIMD register where boolean is true */
static gmx_inline gmx_simd_float_t
...
/*! Select from single precision fp SIMD register where boolean is false */
static gmx_inline gmx_simd_float_t
 ...
 *
 * For each element, select the value from register b
...
typedef struct
{
    int b[GMX_SIMD_FINT32_WIDTH]; /*!< Implementation dependent. Don't touch. */
}
gmx_simd_fibool_t;
 ...
 *
 * The return value is a double SIMD.
 */
static gmx_inline gmx_simd_double_t
...
typedef struct
{
    int i[GMX_SIMD_DINT32_WIDTH]; /*!< Implementation dependent. Don't touch. */
}
gmx_simd_dint32_t;
...
/*! Load unaligned integer data to gmx_simd_dint32_t */
#define gmx_simd_loadu_di  gmx_simd_load_di

/*! Store unaligned integer data from gmx_simd_dint32_t */
...
/*! Boolean type for double precision SIMD data.
 *
...
typedef struct
{
    int b[GMX_SIMD_DOUBLE_WIDTH]; /*!< Implementation dependent. Don't touch. */
}
gmx_simd_dbool_t;
...
/*! Returns non-zero if any of the boolean in x is True, otherwise 0.
 *
 * The actual return value for "any true" will depend on the architecture, so
 * any non-zero value should be considered truth.
 */
static gmx_inline int
...
/*! Select from a double precision fp SIMD register where boolean is true */
static gmx_inline gmx_simd_double_t
...
/*! Select from a double precision fp SIMD register where boolean is false */
static gmx_inline gmx_simd_double_t
...
/*! Boolean type for integer datatypes corresponding to double SIMD.
 *
...
typedef struct
{
    int b[GMX_SIMD_DINT32_WIDTH]; /*!< Implementation dependent. Don't touch. */
}
gmx_simd_dibool_t;
...
/*! SIMD4 float type. Available with GMX_SIMD_HAVE_SIMD4_FLOAT.
 *
 * Unless you specifically want a single-precision type you should check
 * gmx_simd4_real_t instead.
 */
...
/*! Select from double precision fp SIMD register where boolean is true */
#    define gmx_simd4_blendzero_d gmx_simd_blendzero_d

/*! Select from double precision fp SIMD register where boolean is false */
...
/*! Return 1 if SIMD floating-point ops have overflowed, and reset check.
