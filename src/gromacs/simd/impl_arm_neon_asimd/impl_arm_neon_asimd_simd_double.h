...
public:
    ...
    SimdDBool(bool b)
        : simdInternal_(vdupq_n_u64(b ? 0xFFFFFFFFFFFFFFFF : 0)) {}

    // Internal utility constructor to simplify return statements
    SimdDBool(uint64x2_t simd)
        : simdInternal_(simd) {}
...
public:
    ...
    SimdDIBool(bool b)
        : simdInternal_(vdup_n_u32(b ? 0xFFFFFFFF : 0)) {}

    // Internal utility constructor to simplify return statements
    SimdDIBool(uint32x2_t simd)
        : simdInternal_(simd) {}
