...
/* Temporary convenience define for Gromacs files that dont properly separate
 * difference SIMD acceleration architectures into separate files.
 */
...
gmx_simd_get_exponent_f_avx_256(__m256 x)
{
    ...
    iexp128a  = _mm_srli_epi32(iexp128a, mantissabits);
    iexp128b  = _mm_srli_epi32(iexp128b, mantissabits);
...
gmx_simd_set_exponent_f_avx_256(__m256 x)
{
    ...
    iexp128b  = _mm256_extractf128_si256(iexp256, 0x1);
    iexp128a  = _mm256_castsi256_si128(iexp256);
    iexp128a  = _mm_slli_epi32(_mm_add_epi32(iexp128a, expbias), mantissabits);
    iexp128b  = _mm_slli_epi32(_mm_add_epi32(iexp128b, expbias), mantissabits);
    iexp256   = _mm256_castsi128_si256(iexp128a);
    iexp256   = _mm256_insertf128_si256(iexp256, iexp128b, 0x1);
...
gmx_simd_get_exponent_d_avx_256(__m256d x)
{
    ...
    iexp128b  = _mm256_extractf128_si256(iexp256, 0x1);
    iexp128a  = _mm256_castsi256_si128(iexp256);
    iexp128a  = _mm_srli_epi64(iexp128a, mantissabits);
    iexp128b  = _mm_srli_epi64(iexp128b, mantissabits);
...
gmx_simd_set_exponent_d_avx_256(__m256d x)
{
    ...
    iexp128b = _mm_slli_epi64(iexp128b, mantissabits);
    iexp128a = _mm_slli_epi64(iexp128a, mantissabits);
