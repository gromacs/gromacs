...
#ifdef __cplusplus
/*! \brief Load 4 floats from non-contiguous aligned memory and transpose.
 *
...
/*! \brief Load 2 floats from non-contiguous aligned memory and transpose.
 *
 * \tparam     align  Alignment of the storage, i.e. the distance
 *                    (measured in elements, not bytes) between index points.
 *                    When this is identical to the number of output components
...
/*! \brief Load 3 floats from non-contiguous unaligned memory and transpose.
 *
 * \tparam     align  Alignment of the storage, i.e. the distance
 *                    (measured in elements, not bytes) between index points.
 *                    When this is identical to the number of output components
...
/*! \brief Transpose and store 3 floats to non-contiguous unaligned memory.
 *
 * \tparam     align  Alignment of the storage, i.e. the distance
 *                    (measured in elements, not bytes) between index points.
 *                    When this is identical to the number of output components
...
/*! \brief Transpose and add 3 floats to non-contiguous unaligned memory.
 *
 * \tparam     align  Alignment of the storage, i.e. the distance
 *                    (measured in elements, not bytes) between index points.
 *                    When this is identical to the number of output components
...
/*! \brief Transpose and subtract 3 floats to non-contiguous unaligned memory.
 *
...
/*! \brief Load 2 floats from non-contiguous unaligned memory and transpose.
 *
 * \tparam     align  Alignment of the storage, i.e. the distance
 *                    (measured in elements, not bytes) between index points.
 *                    When this is identical to the number of output components
...
#ifdef __cplusplus
/*! \brief Load 4 doubles from non-contiguous aligned memory and transpose.
 *
 * \tparam     align  Alignment of the storage, i.e. the distance
 *                    (measured in elements, not bytes) between index points.
 *                    When this is identical to the number of output components
...
/*! \brief Load 2 doubles from non-contiguous aligned memory and transpose.
 *
 * \tparam     align  Alignment of the storage, i.e. the distance
 *                    (measured in elements, not bytes) between index points.
 *                    When this is identical to the number of output components
...
/*! \brief Load 3 doubles from non-contiguous unaligned memory and transpose.
 *
...
/*! \brief Transpose and store 3 doubles to non-contiguous unaligned memory.
 *
...
/*! \brief Transpose and add 3 doubles to non-contiguous unaligned memory.
 *
...
/*! \brief Transpose and subtract 3 doubles to non-contiguous unaligned memory.
 *
...
/*! \brief Load 2 doubles from non-contiguous unaligned memory and transpose.
 *
