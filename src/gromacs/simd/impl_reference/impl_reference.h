 ...
 */
static gmx_inline void
gmx_simd_cvt_fb2ddb(gmx_simd_fbool_t f, gmx_simd_dbool_t *d0, gmx_simd_dbool_t *d1)
{
#if (GMX_SIMD_FLOAT_WIDTH == 2*GMX_SIMD_DOUBLE_WIDTH)
    int i;
    for (i = 0; i < GMX_SIMD_DOUBLE_WIDTH; i++)
...
#else
    gmx_fatal(FARGS, "gmx_simd_cvt_fb2ddb() requires GMX_SIMD_FLOAT_WIDTH==2*GMX_SIMD_DOUBLE_WIDTH");
    /* Avoid compiler warnings about unused arguments */
    d0->b[0] = f.b[0];
    d1->b[0] = f.b[0];
#endif
 ...
 */
static gmx_inline gmx_simd_fbool_t
gmx_simd_cvt_ddb2fb(gmx_simd_dbool_t d0, gmx_simd_dbool_t d1)
{
    gmx_simd_fbool_t f;
#if (GMX_SIMD_FLOAT_WIDTH == 2*GMX_SIMD_DOUBLE_WIDTH)
    int              i;
...
#else
    gmx_fatal(FARGS, "gmx_simd_cvt_ddb2fb() requires GMX_SIMD_FLOAT_WIDTH==2*GMX_SIMD_DOUBLE_WIDTH");
    /* Avoid compiler warnings about unused arguments & uninitialized f */
    f.b[0] = d0.b[0] + d1.b[0];
#endif
    return f;
...
/*! \brief Load three floats from non-adjacent memory aligned-to-4 and transpose.
 *
 * \param      base   Pointer to the start of the memory area
 ...
 */
static gmx_inline void
gmx_simd_load_3of4_transpose_f(const float * base,    gmx_simd_fint32_t offset,
                               gmx_simd_float_t * v0, gmx_simd_float_t * v1,
                               gmx_simd_float_t * v2)
{
    int i;
 ...
 */
static gmx_inline void
gmx_simd_load_2of4_transpose_f(const float * base,    gmx_simd_fint32_t offset,
                               gmx_simd_float_t * v0, gmx_simd_float_t * v1)
{
    int i;
    for (i = 0; i < GMX_SIMD_FLOAT_WIDTH; i++)
 ...
 */
static gmx_inline void
gmx_simd_load_3of4_transpose_d(const double * base,    gmx_simd_dint32_t offset,
                               gmx_simd_double_t * v0, gmx_simd_double_t * v1,
 ...
 *
 * \param row0   Input data
 * \param row1   Input data
 * \param row2   Input data
 * \param row3   Input data
 * \param[out] col0  Transpose of input
 * \param[out] col1  Transpose of input
 * \param[out] col2  Transpose of input
 * \param[out] col3  Transpose of input
 */
static gmx_inline void
gmx_simd4_transpose_f(gmx_simd4_float_t   row0, gmx_simd4_float_t   row1,
                      gmx_simd4_float_t   row2, gmx_simd4_float_t   row3,
                      gmx_simd4_float_t * col0, gmx_simd4_float_t * col1,
                      gmx_simd4_float_t * col2, gmx_simd4_float_t * col3)
{
    col0->r[0] = row0.r[0];
    col0->r[1] = row1.r[0];
    col0->r[2] = row2.r[0];
 ...
 */
static gmx_inline void
gmx_simd4_transpose_d(gmx_simd4_double_t   row0, gmx_simd4_double_t   row1,
                      gmx_simd4_double_t   row2, gmx_simd4_double_t   row3,
                      gmx_simd4_double_t * col0, gmx_simd4_double_t * col1,
                      gmx_simd4_double_t * col2, gmx_simd4_double_t * col3)
{
    col0.r[0] = row0.r[0];
    col0.r[1] = row1.r[0];
    col0.r[2] = row2.r[0];
