...
#if GMX_SIMD_FLOAT_WIDTH > 4 || defined DOXYGEN //set in simd.h for GMX_SIMD_FLOAT_WIDTH<=4
//! \brief 1 if float 4xN load utils present, otherwise 0
#define GMX_SIMD_HAVE_4NSIMD_UTIL_FLOAT                          1
#endif

#if GMX_SIMD_DOUBLE_WIDTH > 4 || defined DOXYGEN //set in simd.h for GMX_SIMD_DOUBLE_WIDTH<=4
