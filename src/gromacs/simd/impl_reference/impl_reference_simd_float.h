 ...
 *
 * You should typically call the real-precision \ref gmx_simd_mul_mask_r.
 *
 * \param a factor1
 * \param b factor2
 * \param m mask
 ...
 *
 * You should typically call the real-precision \ref gmx_simd_fmadd_mask_r.
 *
 ...
 *
 * You should typically call the real-precision \ref gmx_simd_rsqrt_mask_r.
 *
 * This is a low-level instruction that should only be called from routines
 * implementing the inverse square root in simd_math.h.
 *
 ...
 *
 * You should typically call the real-precision \ref gmx_simd_rcp_mask_r.
 *
 * This is a low-level instruction that should only be called from routines
 * implementing the reciprocal in simd_math.h.
 *
