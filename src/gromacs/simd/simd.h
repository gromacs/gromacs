...
/*! \brief Return a string with the name of a SIMD type
 *
...
/*! \brief Return the SIMD type that would fit this hardware best */
SimdType
simdSuggested(const CpuInfo &c);

/*! \brief Return the SIMD type the library was compiled with */
SimdType
simdCompiled();

/*! \brief Check if binary was compiled with the provided SIMD type
 *
