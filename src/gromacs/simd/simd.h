...
/*! \brief Load 2/4 consecutive reals from each of GMX_SIMD_REAL_WIDTH
 *         offsets, and transpose into 2/4 SIMD real variables.
 *
...
/*! \brief Load 2/4 consecutive reals from each of GMX_SIMD_REAL_WIDTH offsets
 *         specified by a SIMD integer, transpose into 2/4 SIMD real variables.
 *
 * This is defined to the name of an overloaded function, which can be used
 * to load either 4 or 2 data elements depending on the number of output args.
 *
 ...
 *         real variables in memory, return sum.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
