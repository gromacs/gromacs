...
#if 0
/* Finally, a hack to cover a possible corner case of using
   GMX_SIMD_HAVE_FLOAT or GMX_SIMD_HAVE_DOUBLE on some system where
   GMX_SIMD_HAVE_REAL is not defined.
