...
#else
/* No SIMD support at all, not even reference. For symmetry we use a dummy
 * implementation to set all defines to 0, and make SIMD widths negative.
 */
...
{
#    if GMX_SIMD && GMX_SIMD_HAVE_FINT32
...
{
#    if GMX_SIMD && GMX_SIMD_HAVE_DINT32
