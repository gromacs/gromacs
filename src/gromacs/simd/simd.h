...
/*! \libinternal \brief Proxy object to enable load() for SimdFloat & float
 *
...
/*! \brief Float load function that returns proxy object for SimdFloat & float
 *
...
/*! \libinternal \brief Proxy object to enable load() for SimdDouble & double
 *
 * This object is returned by the load() function that takes a single pointer
...
/*! \brief Double load function that returns proxy object for SimdDouble & double
 *
 * \param m Pointer to load memory
...
/*! \libinternal \brief Proxy object to enable load() for SimdFInt32 & SImdDInt32 & int
 *
 * This object is returned by the load() function that takes a single pointer
...
/*! \libinternal \brief Proxy object to enable loadU() for SimdFInt32 & SImdDInt32 & int
 *
...
/*! \brief Integer loadU function that returns proxy object for SimdFInt32 & SImdDInt32 & int
 *
 * \param m Pointer to load memory
 * \return Proxy object that will call the actual load for either SimdFInt32
 *         or SimdDInt32 when you assign it and the conversion method is called.
