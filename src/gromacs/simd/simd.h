...
#    define gmx_simd_loadu_2_transpose_r           gmx_simd_loadu_2_transpose_d
...
/*! \brief Load two unaligned real elements and transpose.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_loadu_2_transpose_d, otherwise
 * \ref gmx_simd_loadu_2_transpose_f.
 *
 * \copydetails gmx_simd_loadu_2_transpose_f
 */
#    define gmx_simd_loadu_2_transpose_r            gmx_simd_loadu_2_transpose_f
