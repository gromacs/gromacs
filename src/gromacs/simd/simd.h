...
#    define gmx_simd_gather_load_3_transpose_r     gmx_simd_gather_load_3_transpose_d
#    define gmx_simd_transpose_scatter_store_3_r   gmx_simd_transpose_scatter_store_3_d
#    define gmx_simd_transpose_scatter_incr_3_r    gmx_simd_transpose_scatter_incr_3_d
#    define gmx_simd_transpose_scatter_decr_3_r    gmx_simd_transpose_scatter_decr_3_d
#    define gmx_simd_expand_scalars_to_triplets_r  gmx_simd_expand_scalars_to_triplets_d
#    define gmx_simd_pairs_storage_alignment_r     gmx_simd_pairs_storage_alignment_d
#    define gmx_simd_load_pairs_transpose_r        gmx_simd_load_pairs_transpose_d
#    define gmx_simd_load_4_transpose_r            gmx_simd_load_4_transpose_d
#    define gmx_simd_load_3of4_transpose_r         gmx_simd_load_3of4_transpose_d
#    define gmx_simd_load_2of4_transpose_r         gmx_simd_load_2of4_transpose_d
#    define gmx_simd_reduce_incr_4_return_sum_r    gmx_simd_reduce_incr_4_return_sum_d
#    ifdef GMX_SIMD_HAVE_HSIMD_DOUBLE_UTIL
#        define GMX_SIMD_HAVE_HSIMD_UTIL
...
#        define gmx_simd_load_pairs_transpose_hsimd_r     gmx_simd_load_pairs_transpose_hsimd_d
...
/*! \brief Load real triplets from non-adjacent memory locations and transpose.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_gather_load_3_transpose_d, otherwise
 * \ref gmx_simd_gather_load_3_transpose_f.
 *
 * \copydetails gmx_simd_gather_load_3_transpose_f
 */
#    define gmx_simd_gather_load_3_transpose_r      gmx_simd_gather_load_3_transpose_f

/*! \brief Transpose and store real triplets to non-adjacent memory locations.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_transpose_scatter_store_3_d, otherwise
 * \ref gmx_simd_transpose_scatter_store_3_f.
 *
 * \copydetails gmx_simd_transpose_scatter_store_3_f
 */
#    define gmx_simd_transpose_scatter_store_3_r    gmx_simd_transpose_scatter_store_3_f

/*! \brief Transpose and add to non-adjacent memory real triplets.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_transpose_scatter_incr_3_d, otherwise
 * \ref gmx_simd_transpose_scatter_incr_3_f.
 *
 * \copydetails gmx_simd_transpose_scatter_incr_3_f
 */
#    define gmx_simd_transpose_scatter_incr_3_r     gmx_simd_transpose_scatter_incr_3_f

/*! \brief Transpose and subtract from non-adjacent memory real triplets.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_transpose_scatter_decr_3_d, otherwise
 * \ref gmx_simd_transpose_scatter_decr_3_f.
 *
 * \copydetails gmx_simd_transpose_scatter_decr_3_f
 */
#    define gmx_simd_transpose_scatter_decr_3_r     gmx_simd_transpose_scatter_decr_3_f
...
/*! \brief Alignment to use for specially aligned real pair data.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_pairs_storage_alignment_d, otherwise
 * \ref gmx_simd_pairs_storage_alignment_f.
 *
 * \copydetails gmx_simd_pairs_storage_alignment_f
 */
#    define gmx_simd_pairs_storage_alignment_r      gmx_simd_pairs_storage_alignment_f

/*! \brief Load real pairs that are custom-aligned in memory and transpose.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_load_pairs_transpose_d, otherwise
 * \ref gmx_simd_load_pairs_transpose_f.
 *
 * \copydetails gmx_simd_load_pairs_transpose_f
 */
#    define gmx_simd_load_pairs_transpose_r         gmx_simd_load_pairs_transpose_f

/*! \brief Load real quartets from non-adjacent memory aligned-to-4 and transpose.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_load_4_transpose_d, otherwise
 * \ref gmx_simd_load_4_transpose_f.
 *
 * \copydetails gmx_simd_load_4_transpose_f
 */
#    define gmx_simd_load_4_transpose_r             gmx_simd_load_4_transpose_f

/*! \brief Load three reals from non-adjacent memory aligned-to-4 and transpose.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_load_3of4_transpose_d, otherwise
 * \ref gmx_simd_load_3of4_transpose_f.
 *
 * \copydetails gmx_simd_load_3of4_transpose_f
 */
#    define gmx_simd_load_3of4_transpose_r          gmx_simd_load_3of4_transpose_f

/*! \brief Load two reals from non-adjacent memory aligned-to-4 and transpose.
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_load_2of4_transpose_d, otherwise
 * \ref gmx_simd_load_2of4_transpose_f.
 *
 * \copydetails gmx_simd_load_2of4_transpose_f
 */
#    define gmx_simd_load_2of4_transpose_r          gmx_simd_load_2of4_transpose_f
...
#    ifdef GMX_SIMD_HAVE_HSIMD_FLOAT_UTIL
...
/*! \brief Load real pairs custom-aligned from two memory bases, transpose to simd
 *
 * If GMX_DOUBLE is defined, this will be aliased to
 * \ref gmx_simd_load_pairs_transpose_hsimd_d, otherwise
 * \ref gmx_simd_load_pairs_transpose_hsimd_f.
 *
 * \copydetails gmx_simd_load_pairs_transpose_hsimd_f
 */
#        define gmx_simd_load_pairs_transpose_hsimd_r    gmx_simd_load_pairs_transpose_hsimd_f
...
#        define GMX_SIMD_HAVE_INT32_ARITHMETICS
#    endif
#    if (defined GMX_SIMD_HAVE_HSIMD_FLOAT_UTIL) || (defined DOXYGEN)
/*! \brief Defined if default real precision provides half-register utilitiess
 *
 *  if GMX_DOUBLE is defined, this will be aliased to
 *  \ref GMX_SIMD_HAVE_HSIMD_DOUBLE_UTIL, otherwise GMX_SIMD_HAVE_HSIMD_FLOAT_UTIL.
 */
#        define  GMX_SIMD_HAVE_HSIMD_UTIL
#    endif
