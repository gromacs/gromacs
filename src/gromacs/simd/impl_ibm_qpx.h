...
/* We need to provide xor_sign if bitwise logical operations are not supported */
#define gmx_simd_xor_sign_f(a, b)  vec_mul(a, vec_cpsgn(b, vec_splats(1.0)))
...
/* We need to provide xor_sign if bitwise logical operations are not supported */
#define gmx_simd_xor_sign_d(a, b)  vec_mul(a, vec_cpsgn(b, vec_splats(1.0)))
