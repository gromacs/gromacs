                     ...
                     SimdFloat  v3)
{
    ...
    t0 = _mm512_mask_add_ps(t0, 0xCCCC, v2.simdInternal_, _mm512_permute_ps(v2.simdInternal_, 0x4E));
    t1 = _mm512_add_ps(v1.simdInternal_, _mm512_permute_ps(v1.simdInternal_, 0x4E));
    t1 = _mm512_mask_add_ps(t1, 0xCCCC, v3.simdInternal_, _mm512_permute_ps(v3.simdInternal_, 0x4E));
    t2 = _mm512_add_ps(t0, _mm512_permute_ps(t0, 0xB1));
    t2 = _mm512_mask_add_ps(t2, 0xAAAA, t1, _mm512_permute_ps(t1, 0xB1));

    t2 = _mm512_add_ps(t2, _mm512_shuffle_f32x4(t2, t2, 0x4E));
    t2 = _mm512_add_ps(t2, _mm512_shuffle_f32x4(t2, t2, 0xB1));

    t0 = _mm512_maskz_loadu_ps(0xF, m);
    t0 = _mm512_add_ps(t0, t2);
    _mm512_mask_storeu_ps(m, 0xF, t0);
              ...
              const float * m1)
{
    ...
    return {
               _mm512_mask_loadu_ps(_mm512_maskz_loadu_ps(0x00FF, m0), 0xFF00, m1-8)
    };
}
...
loadDuplicateHsimd(const float * m)
{
    ...
    tmp = _mm512_maskz_loadu_ps(0x00FF, m);
    return {
...
{
    __m512 tmp;
    tmp = _mm512_maskz_expandloadu_ps(0x0101, m);
               ...
               SimdFloat   a)
{
    ...
    _mm512_mask_storeu_ps(m0,   0x00FF, a.simdInternal_);
    _mm512_mask_storeu_ps(m1-8, 0xFF00, a.simdInternal_);
}
              ...
              SimdFloat   a)
{
    ...
    __m512 x = _mm512_mask_loadu_ps(_mm512_maskz_loadu_ps(0x00FF, m0), 0xFF00, m1-8);

    x = _mm512_add_ps(x, a.simdInternal_);
    _mm512_mask_storeu_ps(m0,   0x00FF, x);
    _mm512_mask_storeu_ps(m1-8, 0xFF00, x);
}
          ...
          SimdFloat  a)
{
    ...
    t               = _mm512_maskz_loadu_ps(0x00FF, m);
    t               = _mm512_sub_ps(t, a.simdInternal_);
    _mm512_mask_storeu_ps(m, 0x00FF, t);
}
                         ...
                         SimdFloat *          v1)
{
    ...
    idx0 = _mm512_maskz_loadu_epi32(0x00FF, offset);

    idx0 = _mm512_mullo_epi32(idx0, _mm512_set1_epi32(align));
    idx1 = _mm512_add_epi32(idx0, _mm512_set1_epi32(1));

    idx = _mm512_mask_shuffle_i32x4(idx0, 0xFF00, idx1, idx1, 0x44);
                          ...
                          SimdFloat   v1)
{
    ...
    t0 = _mm512_mask_add_ps(t0, 0xCCCC, t1, _mm512_permute_ps(t1, 0xB1));
    t0 = _mm512_add_ps(t0, _mm512_shuffle_f32x4(t0, t0, 0xB1));
    t0 = _mm512_mask_shuffle_f32x4(t0, 0xAAAA, t0, t0, 0xEE);

    t1 = _mm512_maskz_loadu_ps(0xF, m);
    t1 = _mm512_add_ps(t1, t0);
    _mm512_mask_storeu_ps(m, 0xF, t1);
