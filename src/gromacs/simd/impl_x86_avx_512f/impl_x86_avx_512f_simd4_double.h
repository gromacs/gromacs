...
{
    return {
               _mm512_castpd512_pd256(_mm512_rsqrt14_pd(_mm512_castpd256_pd512(x.simdInternal_)))
    };
}
#endif
...
{
    return {
               _mm512_mask_cmp_pd_mask(0xF, _mm512_castpd256_pd512(a.simdInternal_), _mm512_castpd256_pd512(b.simdInternal_), _CMP_EQ_OQ)
    };
}
...
{
    return {
               _mm512_mask_cmp_pd_mask(0xF, _mm512_castpd256_pd512(a.simdInternal_), _mm512_castpd256_pd512(b.simdInternal_), _CMP_NEQ_OQ)
    };
}
...
{
    return {
               _mm512_mask_cmp_pd_mask(0xF, _mm512_castpd256_pd512(a.simdInternal_), _mm512_castpd256_pd512(b.simdInternal_), _CMP_LT_OQ)
    };
}
...
{
    return {
               _mm512_mask_cmp_pd_mask(0xF, _mm512_castpd256_pd512(a.simdInternal_), _mm512_castpd256_pd512(b.simdInternal_), _CMP_LE_OQ)
    };
}
...
anyTrue(Simd4DBool x)
{
    return ( x.simdInternal_ & 0xF ) != 0;
}
...
{
    return {
               _mm512_castpd512_pd256(_mm512_mask_mov_pd(_mm512_setzero_pd(), m.simdInternal_, _mm512_castpd256_pd512(a.simdInternal_)))
    };
}
...
{
    return {
               _mm512_castpd512_pd256(_mm512_mask_mov_pd(_mm512_castpd256_pd512(a.simdInternal_), m.simdInternal_, _mm512_setzero_pd()))
    };
}
...
{
    return {
               _mm512_castpd512_pd256(_mm512_mask_blend_pd(sel.simdInternal_, _mm512_castpd256_pd512(a.simdInternal_), _mm512_castpd256_pd512(b.simdInternal_)))
    };
}
