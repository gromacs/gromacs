...
#ifndef GMX_SIMD_IMPL_X86_AVX_512F_DEFINITIONS_H
#define GMX_SIMD_IMPL_X86_AVX_512F_DEFINITIONS_H
...
//   compilers are fine when we just use hexadecimal literals, we stick to that.
...
#endif // GMX_SIMD_IMPL_X86_AVX_512F_DEFINITIONS_H
