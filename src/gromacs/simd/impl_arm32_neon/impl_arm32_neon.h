...
#ifndef GMX_SIMD_IMPL_ARM32_NEON_H
#define GMX_SIMD_IMPL_ARM32_NEON_H
...
/* Capability definitions for ARM32 NEON */
...
#define gmx_simd_get_exponent_f    gmx_simd_get_exponent_f_arm32_neon
#define gmx_simd_get_mantissa_f    gmx_simd_get_mantissa_f_arm32_neon
#define gmx_simd_set_exponent_f    gmx_simd_set_exponent_f_arm32_neon
...
#define gmx_simd_andnot_fi(a, b)    vandq_s32(vmvnq_s32(a), b)
...
#define gmx_simd_anytrue_fb        gmx_simd_anytrue_fb_arm32_neon
...
#define gmx_simd_reduce_f(a)       gmx_simd_reduce_f_arm32_neon(a)
...
#define gmx_simd_blendnotzero_fi(a, sel)  vandq_s32(a, vmvnq_s32(vreinterpretq_s32_u32(sel)))
...
gmx_simd_get_exponent_f_arm32_neon(gmx_simd_float_t x)
{
...
static gmx_inline gmx_simd_float_t
gmx_simd_get_mantissa_f_arm32_neon(gmx_simd_float_t x)
{
...
static gmx_inline gmx_simd_float_t
gmx_simd_set_exponent_f_arm32_neon(gmx_simd_float_t x)
{
...
gmx_simd_reduce_f_arm32_neon(gmx_simd_float_t a)
{
...
gmx_simd_anytrue_fb_arm32_neon(gmx_simd_fbool_t a)
{
...
/* ARM32 Neon is already 4-wide in single, so just reuse float type for SIMD4 */
...
#define gmx_simd4_dotproduct3_f          gmx_simd4_dotproduct3_f_arm32_neon
...
static gmx_inline float
gmx_simd4_dotproduct3_f_arm32_neon(gmx_simd_float_t a, gmx_simd_float_t b)
{
    gmx_simd_float_t  c;
    c = gmx_simd_mul_f(a, b);
    /* set 4th element to 0, then add all of them */
    c = vsetq_lane_f32(0.0f, c, 3);
    return gmx_simd_reduce_f_arm32_neon(c);
}

#endif /* GMX_SIMD_IMPL_ARM32_NEON_H */
