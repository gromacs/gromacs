                          ...
                          MPI_Comm                communicator)
{
    ...
    do
    {
        ...
        for (auto taskOnThisRankIt = currentDisplacementIt; *taskOnThisRankIt != *nextDisplacementIt; ++taskOnThisRankIt)
        {
            gpuTasksOnRanksOfThisNode.back().push_back(gpuTasksOnThisNode[*taskOnThisRankIt]);
        }
