                          ...
                          MPI_Comm                communicator)
{
    ...
    auto nextDisplacement    = currentDisplacement + 1;
    do
    {
        gpuTasksOnRanksOfThisNode.emplace_back(std::vector<GpuTask>(&gpuTasksOnThisNode[*currentDisplacement],
                                                                    &gpuTasksOnThisNode[*nextDisplacement]));
