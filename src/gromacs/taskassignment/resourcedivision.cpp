                                                   ...
                                                   int                            ngpu)
{
    ...
    if (ngpu > 0)
    {
         ...
         */
        GMX_RELEASE_ASSERT(hardwareOptions.nthreads_omp.isSet(), "nthreads_omp is negative, but previous checks should "
                           "have prevented this");
                               ...
                               int                            nPmeRanks)
{
    ...
    if (GMX_OPENMP)
    {
        ...
        if (hardwareOptions->nthreads_omp_pme.isSet() >= 1 &&
    ...
    else
    {
        ...
        if (hardwareOptions->nthreads_omp.isSet() || hardwareOptions->nthreads_omp_pme.isSet())
        {
