                               ...
                               int              nPmeRanks)
{
    ...
    /* With thread-MPI the master thread should set hw_opt->totNumThreadsIsAuto,
     * which could change from false to true. The other threads receive
     * a partially processed hw_opt from the master thread and should not
     * set hw_opt->totNumThreadsIsAuto again.
     */
