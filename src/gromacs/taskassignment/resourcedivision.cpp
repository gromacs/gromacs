                               ...
                               int              nPmeRanks)
{
    ...
    if (GMX_THREAD_MPI)
    {
        ...
        {
            gmx_fatal(FARGS, "With specifying the number of OpenMP threads with thread-MPI, you also need to specify the number of thread-MPI ranks or the total number of threads");
        }
    }
    else
    {
