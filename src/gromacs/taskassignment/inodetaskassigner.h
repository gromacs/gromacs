 ...
 * where the user explicitly required assignment to CPUs, explictly
...
{
    public:
        /*! \brief Given the information from the inputrec, decide whether GPUs will be used for non-bonded interactions.
         *
