...
/* TODO The contents of the string from which we make the .xvf file
...
{
    gmx::test::MemoryInputStream stream;
    stream.setInputLines(xvgLines);

    gmx::XvgTable table = gmx::readXvgTable(&stream.inputStream());
