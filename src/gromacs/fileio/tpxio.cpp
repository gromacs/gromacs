                     ...
                     gmx_groups_t *groups)
{
    ...
    {
        GMX_RELEASE_ASSERT(atoms->flags == (T_ATOMS_MASS | T_ATOMS_ATOMTYPE | T_ATOMS_ATOMTYPEB), "All optional entries in t_atoms should be present when writing a tpr file");
    }
