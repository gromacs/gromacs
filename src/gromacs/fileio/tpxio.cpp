                        ...
                        gmx_bool bRead)
{
    ...
    /* For backward compatibility without changing the file format.
     * TODO: Remove this at the tpx file format change.
     */
    int numAtomsPerMolecule = moltype[molb->type].atoms.nr;
                    ...
                    int file_version)
{
    ...
    {
        do_molblock(fio, &molblock, mtop->moltype, bRead);
    }
