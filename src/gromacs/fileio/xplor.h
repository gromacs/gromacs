...
struct XplorData{
    ...
    const static float    nmToXplorUnits;   //!< Multiply by this factor to obtain nm from xplor units (Aangstrom)
    const static int      magicCheckNumber; //!< Typically -9999; establishes sucessful file reading
};
