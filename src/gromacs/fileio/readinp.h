 ...
 * from "key = value" lines in file \c fn.
 *
 * \param[in]  reader          Text stream to read.
...
/*! \brief Write "key = value" lines from \c inp to \c fn.
 *
 * \param[in]  writer          Text stream to write.
 * \param[in]  fn              Filename corresponding to \c writer.
...
void write_inpfile(gmx::TextWriter *writer, const char *fn, int ninp, t_inpfile inp[],
