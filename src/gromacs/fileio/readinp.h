...
void replace_inp_entry(std::vector<t_inpfile> &inp,
 ...
 */
#define REM_TYPE(name)       replace_inp_entry(inp, name, NULL)
#define REPL_TYPE(old, new)   replace_inp_entry(inp, old, new)
#define STYPE(name, var, def)  if ((tmp = get_estr(inp, name, def)) != NULL) std::strcpy(var, tmp)
#define STYPENC(name, def) get_estr(inp, name, def)
#define ITYPE(name, var, def)  var    = get_eint(inp, name, def, wi)
#define STEPTYPE(name, var, def)  var = get_eint64(inp, name, def, wi)
#define RTYPE(name, var, def)  var    = get_ereal(inp, name, def, wi)
#define ETYPE(name, var, defs) var    = get_eenum(inp, name, defs)
#define EETYPE(name, var, defs) var   = get_eeenum(inp, name, defs, wi)
