 ...
 * \internal
 * \brief
 * Wrapper to include all utilities for simple file conversion.
 *
 * \author
 * \ingroup fileio
 */
...
#include "gromacs/fileio/modules/setatoms.h"
#include "gromacs/fileio/modules/setbox.h"
#include "gromacs/fileio/modules/setconnection.h"
#include "gromacs/fileio/modules/setforces.h"
#include "gromacs/fileio/modules/setprecision.h"
#include "gromacs/fileio/modules/settime.h"
#include "gromacs/fileio/modules/setvelocities.h"
...
void
OutputFlags::initFileOptions(IOptionsContainer *options)
{
...
void
OutputFlags::registerModules(OutputManagerPointer &output)
{
