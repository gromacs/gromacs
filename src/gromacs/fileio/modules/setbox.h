...
class SetBox : public ICoordinateOutput
{
    public:
        /*! \brief
         * Default constructor for SetBox should not be used.
         *
         ...
         * framework.
         */
        explicit SetBox(matrix box, bool bHaveNewBox) : bHaveNewBox_(bHaveNewBox)
        {
            copy_mat(box, box_);
        }
        /*! \brief
         * Copy constructor.
         */
        SetBox(const SetBox &old) = delete;
        /*! \brief
         * Assignment operator.
         */
        SetBox &operator=(const SetBox &old) = delete;
        /*! \brief
        ...
        SetBox &operator=(SetBox &&old)
        {
            ...
            bHaveNewBox_ = std::move(old.bHaveNewBox_);
            return *this;
        }
        /*! \brief
         *  Move constructor for SetBox.
         */
        SetBox(SetBox &&old) : bHaveNewBox_(std::move(old.bHaveNewBox_))
        {
            copy_mat(old.box_, box_);
        }
         ...
         */
        virtual void processFrame(const int /*framenumner*/, const t_trxframe &input);

    private:
        //! New box information from the user.
        matrix                            box_;
        //! Decide if new box will be written or not, default false.
        bool                              bHaveNewBox_;
};
