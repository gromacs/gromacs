...
class SetAtoms : public ICoordinateOutput
{
    public:
         ...
         * framework.
         */
        explicit SetAtoms(t_atoms *atoms) : ICoordinateOutput(efAtomOutput)
        {
            setLocalAtoms_ = setAtoms(atoms);
        }
        /*! \brief
        ...
        {
            setLocalAtoms_ = std::move(old.setLocalAtoms_);
            return *this;
        }
        /*! \brief
         *  Move constructor for SetAtoms.
         */
        SetAtoms(SetAtoms &&old) : ICoordinateOutput(old.moduleFlags_)
        {
        }
    ...
    private:
        ...
        bool setLocalAtoms()
        {
            return haveLocalAtoms() && setLocalAtoms_;
        }
        /*! \brief
        ...
        /*! \brief
         * User variable choice to determine if we want to set new atom information
         * or not.
         *
         * This value is set during construction time and decides if the atom information
         * in a t_trxframe gets replaced by new, user chosen data, or if the old data (if
         * available) is going to be used instead.
         */
        bool                              setLocalAtoms_;
};
