...
/*! \brief Mass reading settings for readConfAndTopology */
enum
{
    readAtomsMassNone,    //!< Don't attempt to lookup masses (with tpr we have them anyhow)
    readAtomsMassAttempt, //!< Attempt loop up masses when not present in structure file
    readAtomsMassRequired //!< Require all masses to be read, fatal error with missing masses
};
