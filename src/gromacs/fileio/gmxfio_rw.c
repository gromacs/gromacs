                                     ...
                                     const char *desc, const char *srcfile, int line)
{
    gmx_bool ret;
    gmx_fio_lock(fio);
    ret = fio->iotp->nread(fio, item, 1, eioGMX_INT64, desc, srcfile, line);
    gmx_fio_unlock(fio);
    return ret;
}
                                      ...
                                      const char *desc, const char *srcfile, int line)
{
    gmx_bool ret;
    gmx_fio_lock(fio);
    ret = fio->iotp->nwrite(fio, &item, 1, eioGMX_INT64, desc, srcfile, line);
    gmx_fio_unlock(fio);
    return ret;
}
                                      ...
                                      const char *desc, const char *srcfile, int line)
{
    ...
    for (i = 0; i < n; i++)
    {
        ret = ret && fio->iotp->nread(fio, &(item[i]), 1, eioGMX_INT64, desc,
                                      srcfile, line);
    }
    gmx_fio_unlock(fio);
    return ret;
                                       ...
                                       const char *desc, const char *srcfile, int line)
{
    ...
    for (i = 0; i < n; i++)
    {
        ret = ret && fio->iotp->nwrite(fio, &(item[i]), 1, eioGMX_INT64,
                                       desc, srcfile, line);
    }
    gmx_fio_unlock(fio);
    return ret;
                                    ...
                                    const char *desc, const char *srcfile, int line)
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        {
            ret = ret && fio->iotp->nwrite(fio, &(item[i]), 1, eioGMX_INT64, desc,
                                           srcfile, line);
        }
    }
    gmx_fio_unlock(fio);
