                         ...
                         real              b_factor)
{
    ...
    {
        gmx_fatal(FARGS, "Can only print PQR atom lines as ATOM or HETATM records");
    }

    /* Check atom name */
    if (atom_name == nullptr)
    {
        gmx_incons("Need atom information to print pqr");
    }

    /* Check residue name */
    if (res_name == nullptr)
    {
        gmx_incons("Need residue information to print pqr");
    }
