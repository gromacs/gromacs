                           ...
                           FILE *list)
{
    ...
    {
        pullHistoryNumEntries = pullhist->ngroups;
    }
    else
    {
                      ...
                      t_state *state, ObservablesHistory *observablesHistory)
{
    ...
    {
        flags_pullxh |= (1<<eenhENERGY_N);
        flags_pullxh |= ((1<<eenhENERGY_AVER) | (1<<eenhENERGY_SUM) |
                        (1<<eenhENERGY_NSUM));
    }
    ...
    {
        flags_pullfh |= (1<<eenhENERGY_N);
        flags_pullfh |= ((1<<eenhENERGY_AVER) | (1<<eenhENERGY_SUM) |
                        (1<<eenhENERGY_NSUM));
    }
                            ...
                            gmx_bool reproducibilityRequested)
{
    ...
    *bReadEkin = ((flags_eks & (1<<eeksEKINH)) || (flags_eks & (1<<eeksEKINF)) || (flags_eks & (1<<eeksEKINO)) ||
    ...
    if (flags_pullxh && observablesHistory->pullXHistory == nullptr)
    {
    ...
    if (flags_pullfh && observablesHistory->pullFHistory == nullptr)
    {
