    ...
    for (int i = 0; i < epullcoordh_NR && ret == 0; i++)
    {
        switch (i)
        {
            ...
            case epullcoordh_DR45_SUM:
                ...
                break;
            case epullcoordh_FSCAL_SUM:     ret = do_cpte_double(xd, part, i, flags, &(pullCoordHist->f_scal), list); break;
        }
    }
                         ...
                         FILE *list)
{
    ...
    if (bRead)
    {
        snew(pullHist->pullCoordinateSums, pullHist->numCoordinates);
        snew(pullHist->pullGroupSums,      pullHist->numGroups);
        snew(pullHist->pullDynaSums,       pullHist->numCoordinates);
    }
