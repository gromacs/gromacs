                      ...
                      t_state *state, ObservablesHistory *observablesHistory)
{
    ...
    do_cpt_header(gmx_fio_getxdr(fp), FALSE, &file_version,
                  ...
                  &flagsPullxHistory, &flagsPullfHistory, &flags_dfh, &nED, &eSwapCoords,
                  nullptr);
                            ...
                            gmx_bool reproducibilityRequested)
{
    ...
    int                  fflags, flags_eks, flags_enh, flagsPullxHistory, flagsPullfHistory, flags_dfh;
    int                  nED, eSwapCoords;
    int                  ret;
    gmx_file_position_t *outputfiles;
    int                  nfiles;
                                   ...
                                   gmx_int64_t *step)
{
    ...
    ivec      dd_nc;
    int       nlambda;
    int       flags_eks, flags_enh, flagsPullxHistory, flagsPullfHistory, flags_dfh;
    double    t;
    t_state   state;
    int       nED, eSwapCoords;
    t_fileio *fp;
    ...
    do_cpt_header(gmx_fio_getxdr(fp), TRUE, &file_version,
                  ...
                  &nlambda, &state.flags, &flags_eks, &flags_enh, &flagsPullxHistory, &flagsPullfHistory,
                  &flags_dfh, &nED, &eSwapCoords, nullptr);
...
void list_checkpoint(const char *fn, FILE *out)
{
    ...
    do_cpt_header(gmx_fio_getxdr(fp), TRUE, &file_version,
                  ...
                  &state.natoms, &state.ngtc, &state.nnhpres, &state.nhchainlength,
                  &nlambda, &state.flags,
                  &flags_eks, &flags_enh, &flagsPullxHistory, &flagsPullfHistory, &flags_dfh, &nED, &eSwapCoords,
                  out);
