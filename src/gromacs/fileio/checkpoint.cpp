                            ...
                            gmx_bool reproducibilityRequested)
{
    ...
    state->initializeCoupling(state->ngtc, state->nnhpres, headerContents->nhchainlength); /* need to keep this here to keep the tpr format working */
