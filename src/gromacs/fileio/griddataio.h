...
class MrcFile
{
    public:
         ...
         */
        void write(std::string filename, const GridDataFloat3D &grid_data);
         ...
         */
        void write_with_own_meta(std::string filename, GridDataFloat3D &grid_data, const MrcMetaData &meta, bool bOwnGridStats);
         ...
         */
        GridDataFloat3D read(std::string filename);
         ...
         * \returns grid_data will be filled with real-valued, real-space data on a grid upon succesful reading
         */
        GridDataFloat3D read_with_meta(std::string filename, MrcMetaData *meta);
