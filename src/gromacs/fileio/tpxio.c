...
#define tpx_version_intramolecular_bondeds 98
static const int tpx_version = tpx_version_intramolecular_bondeds;
                    ...
                    int file_version)
{
    ...
    if (file_version >= tpx_version_intramolecular_bondeds)
    {
