...
enum tpxv {
    ...
    tpxv_RemoveObsoleteVariables1                            /**< remove optimize_fft, dihre_fc, nstcheckpoint */
};
...
static const int tpx_version = tpxv_RemoveObsoleteVariables1;
                        ...
                        int file_version, real *fudgeQQ)
{
    ...
    if (file_version > 25 && file_version < tpxv_RemoveObsoleteVariables1)
    {
    ...
    if (file_version < tpxv_RemoveObsoleteVariables1)
    {
