...
class PlotFile
{
    public:
        /*! \brief Constructor
         *
         * \todo Implement extracting output format from the filename
        ...
        /*! \brief Plot the entire file at last
         *
         * This will do the equivalent of startPlot, then plot the data, and
         * calling finishPlot.
         */
        void plotAll();

        /*! \brief Start plotting the data
         *
         * This plots everything but the real data, that is
         * the header etc.
         */
        void startPlot();

        /*! \brief Plot a single row of data
         *
         * Plot a "time" value and multiple data values
         */
        void addRow(real x, std::vector<real> y);

        /*! \brief Finish a plot file
         *
         * Do whatever is need to finish a plot file.
         */
        void finishPlot();

    private:
        //! Low level handling of files
        PlotFileWriter                 *writer_;
        ...
        //! Internal boolean telling us whether we have started plotting
        bool                            plotStarted_;
};
