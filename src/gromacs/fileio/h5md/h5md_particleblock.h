...
public:
     ...
     *
     * \throws H5mdError if the data set frame dimensions are not { 3, 3 }.
     */
    H5mdParticleBlockBuilder& setBox(H5mdFrameDataSet<real>&& box);

    /*! \brief Assign a position data set.
     *
     * \throws H5mdError if the value frame dimensions are not 1-dimensional
...
private:
     ...
     * in a throw.
     *
     * \throws H5mdError if an inconsistency is found.
     */
