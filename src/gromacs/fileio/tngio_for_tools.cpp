                             ...
                             t_trxframe             *fr)
{
    ...
    {
        blockId = blockIds[i];
        tng_data_block_dependency_get(input, blockId, &block_dependency);
                                               ...
                                               gmx_bool *bOK)
{
    ...
    tng_util_frame_current_compression_get(input, blockId, &codec_id, &local_prec);
