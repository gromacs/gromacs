...
struct MrcDensityMapHeader{
    ...
    std::array<char, c_formatIdentifierLength> formatIdentifier_;
    ...
    std::array<float, c_numUserDefinedFloats> userDefinedFloat_;

    //! Number of used crystallographic labels, 0 for imagestacks, 1 for emdb data.
    mrc_integer          numUsedLabels_;
    ...
    /*! \libinternal \brief Skew matrix and translation.
     */
    struct SkewData
    {
