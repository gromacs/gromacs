    ...
    public             ISimulator
{
    ...
    private:
         ...
         */
        std::unique_ptr<ISimulatorElement> buildIntegrator(
...
template<typename ... Args>
ModularSimulator::ModularSimulator(Args && ... args) :
    ISimulator(std::forward<Args>(args) ...)
{
...
//! \cond
template <typename T, typename U>
void ModularSimulator::addToCallList(
        gmx::compat::not_null<U*>               element,
        std::vector < compat::not_null < T *>> &callList)
{
...
template <typename T, typename U>
void ModularSimulator::addToCallListAndMove(
        std::unique_ptr<U>                      element,
        std::vector < compat::not_null < T *>> &callList,
        std::vector < std::unique_ptr < T>>    &elementList)
{
