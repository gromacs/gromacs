...
struct pull_t
{
    ...
    gmx_bool           bXOutAverage; /* Output average pull coordinates */
    gmx_bool           bFOutAverage; /* Output average pull forces */

    PullHistory       *xHistory;     /* Pull coordinate history */
    PullHistory       *fHistory;     /* Pull force history */
