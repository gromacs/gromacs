...
/*! \internal \brief Abstract base class for pull potential data.
...
/*! \internal \brief Abstract base class for pull potential function types.
...
class PullPotentialFunction
{
    ...
    public:
        ...
        /*! \internal \brief Create a new PullPotentialFunction and set its interal data.
        ...
        /*! \internal \brief The name of the pull potential as read in the mdp file. */
        static std::string name;

        virtual ~PullPotentialFunction();

        /*! \internal \brief Function type for an external pull potential function
         *
    ...
    private:
        /*! \internal \brief Private constructor to ensure PullPotentialas are porperly created via the registered create routing
         */
        PullPotentialFunction();
};

/*! \internal \brief Here, the external pull potentials will be registered, e.g. {{awh.name, awh.create},{another.name, another.create}} */
