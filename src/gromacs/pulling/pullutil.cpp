...
/*! \brief Sum the weights and weighted coordinates for part of a pull group.
 *
 * Only sums over indices in pgrp from ind_start to ind_end.
 * Always calculates the weighted sum of x, of xp only when xp!=NULL.
 * If PBC is required, calculate PBC distances with respect to x_pbc.
 * Returns the sums in sum_com.
 */
...
/*! \brief Sum the weights and weighted coordinates for part of a cos-weighted pull group.
 *
 * Only sums over indices in pgrp from ind_start to ind_end.
 * Always calculates the weighted sum of x, of xp only when xp!=NULL.
 * Using cosine weighting along dimension cosdim with frequency twopi_box
 * Returns the sums in sum_com.
 */
