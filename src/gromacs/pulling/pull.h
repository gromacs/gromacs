 ...
 * separately by the module itself. The parameter \p reference_value is used
 * to set the pull reference value, which might be printed in the pull output
 * and can be used the next step for the pull COM and/or distance calculation
 * with pull geomertries cylinder and distance-periodic.
 ...
 * \param[in]    reference_value The pull coordinate reference value.
 */
