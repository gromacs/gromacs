...
/*! \brief Sets the previous step COM to the current COM and updates the com_prev_step in the state
 *
 ...
 */
void preparePrevStepPullCom(const t_inputrec *ir, const t_mdatoms *md, t_state *state, const t_commrec *cr, bool startingFromCheckpoint);
