                                  ...
                                  real *V, tensor vir, real *dVdl)
{
    ...
    else if (pcrd->params.eGeom == epullgANGLE)
    {
        ...
        if (cos_theta2 < 1)
        {
            double invdr01, invdr23;
            double a, b, a01, a23, b01, b23;

            /* The force f01 that acts on groups 0 and 1 can be expressed as the sum of
             *  one vector component parallel to dr01 and one parallel to dr23:
             * f01 = dV/dtheta*(a01*dr23 - b01*dr01),
             * The force f23 acting on groups 2 and 3 is obtained by swapping 01 <-> 23 in this equation.
             */
            ...
            /* Force components for groups 0, 1 */
            a01     = a*invdr01*invdr23;
            b01     = b*invdr01*invdr01;

            /* Force components for groups 2, 3 */
