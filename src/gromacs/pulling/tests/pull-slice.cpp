...
class SlicedPullTest : public ::testing::Test
{
    protected:
        ...
        void test(rvec x[], int ind[], int nat_grp, real slice_min, real slice_max, int nat_slice)
        {
            pull_t pull;
            pull.ngroup = 2;
            ...
            pgrp_sliced->params.slice_x_min = slice_min;
            pgrp_sliced->params.slice_x_max = slice_max;
...
TEST_F (SlicedPullTest, 2of3AtomsInSlice)
{
    ...
    test(x, ind, nat_grp, slice_min, slice_max, nat_slice);
}
