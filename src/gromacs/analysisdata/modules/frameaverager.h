 ...
 * need to average a set of values over frames.  It takes care of accumulating
 * the values and computing their variance.  Accumulation is always in double
 * precision.  For now, does nothing fancy, but provides ground for other
 * implementation (e.g., related to parallelization) that would benefit all
 * such modules.
 *
...
class AnalysisDataFrameAverager
{
    public:
        /*! \brief
         * Sets the number of columns to average over.
         *
         ...
         *
         * Can be called multiple times for a frame, and does not need to be
