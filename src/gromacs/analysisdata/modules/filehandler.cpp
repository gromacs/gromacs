...
namespace gmx
{
Filehandler::Filehandler(TrajectoryDataWriteSettings *settings) : settings_(settings), sel_(nullptr), trr_(nullptr), infile_(nullptr)
{
    strcpy(filemode_, "w");
}
Filehandler::Filehandler() : settings_(nullptr), sel_(nullptr), trr_(nullptr), infile_(nullptr)
{
    strcpy(filemode_, "w");
}
