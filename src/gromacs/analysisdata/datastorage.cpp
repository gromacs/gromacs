...
namespace mpi
{
    ...
    template <>
    inline data_layout mpi_type_traits<gmx::AnalysisDataStorage::Impl::StoredFrame::Status>::get_layout(const gmx::AnalysisDataStorage::Impl::StoredFrame::Status& status)
    {
        return get_layout_enum<gmx::AnalysisDataStorage::Impl::StoredFrame::Status>(status);
    }
    //! declaring Status is a named data type
    SET_MPI_STATIC(gmx::AnalysisDataStorage::Impl::StoredFrame::Status);

    template <>
    inline data_layout mpi_type_traits<gmx::AnalysisDataStorage::Impl::StoredFrame>::get_layout(const gmx::AnalysisDataStorage::Impl::StoredFrame& sf)
    {
