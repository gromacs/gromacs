...
AnalysisDataStorage::collectFrames()
{
    ...
    comm::world.gather(recv_size, recv_counts, 0); //gather number of frames on each node
    ...
    comm::world.gatherv(selection, recv_sel, recv_counts, 0); //gather frame numbers of frames
    //gather frames
