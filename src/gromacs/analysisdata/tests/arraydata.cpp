...
TEST_F(AnalysisArrayDataTest, CanSetXAxis)
{
    ...
    data.setRowCount(5);
    data.setXAxis(1.0, 1.0);
    EXPECT_FLOAT_EQ(1.0, data.xvalue<real>(0));
    EXPECT_FLOAT_EQ(3.0, data.xvalue<real>(2));
    EXPECT_FLOAT_EQ(5.0, data.xvalue<real>(4));
    data.setXAxisValue(0, 3.0);
    data.setXAxisValue(2, 1.0);
    EXPECT_FLOAT_EQ(3.0, data.xvalue<real>(0));
    EXPECT_FLOAT_EQ(2.0, data.xvalue<real>(1));
    EXPECT_FLOAT_EQ(1.0, data.xvalue<real>(2));
    EXPECT_FLOAT_EQ(4.0, data.xvalue<real>(3));
}
...
TEST_F(AnalysisArrayDataTest, CanSetXAxisBeforeRowCount)
{
    ...
    }
    {
        ...
        data.setRowCount(3);
        EXPECT_FLOAT_EQ(2.0, data.xvalue<real>(0));
        EXPECT_FLOAT_EQ(3.0, data.xvalue<real>(1));
        EXPECT_FLOAT_EQ(5.0, data.xvalue<real>(2));
    }
}
