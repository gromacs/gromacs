...
extern template real findStructureSimilarity<RMSD>(int nAtoms, const real *mass, const rvec *x, const rvec *xp, const int *index);
extern template real findStructureSimilarity<RhoMeasure>(int nAtoms, const real *mass, const rvec *x, const rvec *xp, const int *index);
