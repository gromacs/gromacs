...
/*! \libinternal \file
   ...
   \note The organization of the functions is the same as explained
         in header irreg_array_2_matrix_products.h
...
inline bool matrixInverseLUPRef(const IrregArray2D<T, Alloc, false> &a, IrregArray2D<T, Alloc, false> &aInv)
{
    ...
    typedef std::allocator<index_type>                     index_allocator_type;
    typedef std::vector<index_type, index_allocator_type>  index_vector_type;
