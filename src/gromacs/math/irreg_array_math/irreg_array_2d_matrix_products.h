...
inline void
//typename std::enable_if<!(gmx::SimdSetup<T>::doSimd_), void>::type
matrixProductMatrixTMatrixTSimd(const IrregArray2D<T, Alloc, false> &a,
                                const IrregArray2D<T, Alloc, false> &b,
                                IrregArray2D<T, Alloc, false> &c)
{
    ...
    // number of rows    of matrix A
    const index_type     l = a.length1();
    // number of columns of matrix A
    const index_type     m = a.length2(0);
 ...
 */
template<typename T, class Alloc = std::allocator<T> >
inline void matrixProductMatrixTMatrixTRef(const IrregArray2D<T, Alloc, false> &a,
                                           const IrregArray2D<T, Alloc, false> &b,
                                           IrregArray2D<T, Alloc, false> &c)
{
    typedef typename IrregArray2D<T, Alloc, false>::value_type value_type;
 ...
 */
template<typename T, class Alloc = std::allocator<T> >
inline void matrixProductMatrixTMatrixT(const IrregArray2D<T, Alloc, false> &a,
                                        const IrregArray2D<T, Alloc, false> &b,
                                        IrregArray2D<T, Alloc, false> &c)
{
#if GMX_SIMD
...
inline
typename std::enable_if<!(gmx::SimdSetup<T>::doSimd_), void>::type
matrixProductMatrixTMatrixSimd(const IrregArray2D<T, Alloc, false> &a,
                               const IrregArray2D<T, Alloc, false> &b,
                               IrregArray2D<T, Alloc, false> &c)
{
 ...
 */
template<typename T, class Alloc = std::allocator<T> >
inline void matrixProductMatrixTMatrixRef(const IrregArray2D<T, Alloc, false> &a,
                                          const IrregArray2D<T, Alloc, false> &b,
                                          IrregArray2D<T, Alloc, false> &c)
{
    typedef typename IrregArray2D<T, Alloc, false>::value_type value_type;
 ...
 */
template<typename T, class Alloc = std::allocator<T> >
inline void matrixProductMatrixTMatrix(const IrregArray2D<T, Alloc, false> &a,
                                       const IrregArray2D<T, Alloc, false> &b,
                                       IrregArray2D<T, Alloc, false> &c)
{
#if GMX_SIMD
