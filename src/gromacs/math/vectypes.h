...
class BasicVector
{
    public:
        ...
        // and note a pointer like int*. If there is a use case for a 3-element array
        ...
        static_assert(!std::is_pointer<ValueType>::value, "BasicVector value type must not be a pointer.");
