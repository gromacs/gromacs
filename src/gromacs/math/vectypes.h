...
class BasicVector
{
    public:
        ...
        BasicVector<ValueType> scale(const ValueType &right)
        {
            for (int i = 0; i < DIM; ++i)
            {
                this->x_[i] = this->x_[i]*right;
            }
            return *this;
        }

        //! Clear vector (return Zerro vector)
        BasicVector<ValueType> clear()
        {
            for (int i = 0; i < DIM; ++i)
            {
                this->x_[i] = 0;
...
/*! \brief
 * clear for gmx::BasicVector
 */
template <typename ValueType> static inline
typename BasicVector<ValueType>::BasicVector clear(BasicVector<ValueType> v)
{
    BasicVector<ValueType> tmp;
    tmp = v;
    return tmp.clear();
}
 ...
 */
template <typename ValueType> static inline
typename BasicVector<ValueType>::BasicVector scale(BasicVector<ValueType> v, ValueType s)
{
    BasicVector<ValueType> tmp;
    tmp = v;
    return tmp.scale(s);
 ...
 */
template <typename ValueType> static inline
typename BasicVector<ValueType>::BasicVector unitv(BasicVector<ValueType> v)
{
    return v.unitv();
}
 ...
 */
template <typename ValueType> static inline
typename BasicVector<ValueType>::BasicVector cross(BasicVector<ValueType> a, BasicVector<ValueType> b)
{
    return a.cross(b);
}
