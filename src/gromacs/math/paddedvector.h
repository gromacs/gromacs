 ...
 *
 * \todo Consider explicitly tieng these types to the SimdTrait
 ...
 *
 * The interface is slightly similar to std::vector. However, access
...
class PaddedVector
{
    ...
    public:
        ...
        //! Indexing operator.
        value_type &operator[](int i) { return storage_[i]; }
        //! Indexing operator as const.
        value_type operator[](int i) const { return storage_[i]; }
