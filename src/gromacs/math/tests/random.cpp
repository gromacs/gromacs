...
TEST_F(RandomTest, NormalDistributionLogical)
{
    gmx::ThreeFry2x64<8>           rng(123456, gmx::RandomDomain::Other);
...
TEST_F(RandomTest, NormalDistributionReset)
{
    gmx::ThreeFry2x64<8>                                rng(123456, gmx::RandomDomain::Other);
    gmx::NormalDistribution<real>                       distA(2.0, 5.0);
    gmx::NormalDistribution<real>                       distB(2.0, 5.0);
...
TEST_F(RandomTest, NormalDistributionAltParam)
{
    gmx::ThreeFry2x64<8>                       rngA(123456, gmx::RandomDomain::Other);
    gmx::ThreeFry2x64<8>                       rngB(123456, gmx::RandomDomain::Other);
    gmx::NormalDistribution<real>              distA(2.0, 5.0);
...
TEST_F(RandomTest, GenerateCanonical)
{
    gmx::test::TestReferenceData        data;
    gmx::test::TestReferenceChecker     checker(data.rootChecker());
    ...
    for (int i = 0; i < 10; i++)
    {
        result.push_back(std::generate_canonical<real, std::numeric_limits<real>::digits>(rng));
    }
...
TEST_F(RandomTest, ExponentialDistributionLogical)
{
    gmx::ThreeFry2x64<8>                rng(123456, gmx::RandomDomain::Other);
...
TEST_F(RandomTest, ExponentialDistributionReset)
{
    gmx::ThreeFry2x64<8>                                rng(123456, gmx::RandomDomain::Other);
    gmx::ExponentialDistribution<real>                  distA(2.0);
    gmx::ExponentialDistribution<real>                  distB(2.0);
...
TEST_F(RandomTest, ExponentialDistributionAltParam)
{
    gmx::ThreeFry2x64<8>                            rngA(123456, gmx::RandomDomain::Other);
    gmx::ThreeFry2x64<8>                            rngB(123456, gmx::RandomDomain::Other);
    gmx::ExponentialDistribution<real>              distA(2.0);
...
TEST_F(RandomTest, UniformRealDistribution)
{
    gmx::test::TestReferenceData            data;
    gmx::test::TestReferenceChecker         checker(data.rootChecker());
...
TEST_F(RandomTest, UniformRealDistributionLogical)
{
    gmx::ThreeFry2x64<8>                rng(123456, gmx::RandomDomain::Other);
...
TEST_F(RandomTest, UniformRealDistributionReset)
{
    gmx::ThreeFry2x64<8>                           rng(123456, gmx::RandomDomain::Other);
    gmx::UniformRealDistribution<real>             distA(2.0, 5.0);
    gmx::UniformRealDistribution<real>             distB(2.0, 5.0);
...
TEST_F(RandomTest, UniformRealDistributionAltParam)
{
    gmx::ThreeFry2x64<8>                            rngA(123456, gmx::RandomDomain::Other);
    gmx::ThreeFry2x64<8>                            rngB(123456, gmx::RandomDomain::Other);
    gmx::UniformRealDistribution<real>              distA(2.0, 5.0);
...
TEST_F(RandomTest, UniformIntDistributionLogical)
{
    gmx::ThreeFry2x64<8>               rng(123456, gmx::RandomDomain::Other);
...
TEST_F(RandomTest, UniformIntDistributionReset)
{
    gmx::ThreeFry2x64<8>                         rng(123456, gmx::RandomDomain::Other);
    gmx::UniformIntDistribution<int>             distA(2, 5);
    gmx::UniformIntDistribution<int>             distB(2, 5);
...
TEST_F(RandomTest, UniformIntDistributionAltParam)
{
    gmx::ThreeFry2x64<8>                          rngA(123456, gmx::RandomDomain::Other);
    gmx::ThreeFry2x64<8>                          rngB(123456, gmx::RandomDomain::Other);
    gmx::UniformIntDistribution<int>              distA(2, 5);
