...
TEST(GridTest, multiIndexToCoordinate)
{
    ...
    std::vector < MdFloatVector < 3>> expectedResult = {{{0, 0, 0}}, {{0, 0.24375, 0}}, {{0, 5, 0}}, {{0, 0, -4}}, {{0.2, 0.15, 4.2}}};
...
TEST(GridTest, internalVectorFromGridPointToCoordinate)
{
    ...
    std::vector < MdFloatVector < 3>> spaceCoordinate = {{{0, 0, 0}}, {{0, 0.24375, 0}}, {{0, 5, 0}}, {{0, 0, -4}}, {{0.2, 0.15, 4.2}}};
