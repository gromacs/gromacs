...
class MdFloatVector
{
    public:
        ...
        {
            std::copy(il.begin(), il.end(), mdFloatVector.data());
        };

        /*! \brief Access the n-th mdFloatVector.
         * \param[in] n The dimension of the mdFloatVector.
         */
        reference operator[](size_type n) { return mdFloatVector[n]; }
        /*! \brief Access the constant reference to the n-th mdFloatVector.
         * \param[in] n The dimension of the mdFloatVector.
         */
        constexpr const_reference operator[](size_type n) const { return mdFloatVector[n]; }
    private:
        //!\brief The mdFloatVector.
        std::array<value_type, Rank> mdFloatVector = {};
};
