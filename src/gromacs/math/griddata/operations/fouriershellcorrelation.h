...
class FourierShellCorrelation
{
    public:
         ...
         *
         */
        FourierShellCorrelation(const Grid < DIM, GridWithTranslation < DIM>> &RealGrid);
        ...
        std::vector<real> getFscCurve(const GridDataFloat3D &reference, const GridDataFloat3D &other);
