...
class FourierTransformRealToComplex3D : public FourierTransform3D
{
    public:
        ...
        std::unique_ptr < GridDataComplex3D> result(const GridDataReal3D &realInputGridData);
        void  result(const GridDataReal3D &realInputGridData, GridDataComplex3D &complexTransformedGridData);
...
class FourierTransformComplexToReal3D : public FourierTransform3D
{
    public:
        ...
        std::unique_ptr < GridDataReal3D> result(const GridDataComplex3D &complexInputGridData);
        void result(const GridDataComplex3D &complexInputGridData, GridDataReal3D &realTransformedGridData);
