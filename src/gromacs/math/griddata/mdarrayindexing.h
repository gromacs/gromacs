...
/*! \internal \brief Multidimensional offset from zero to index an array.
...
/*! \internal \brief The bounds of a multidimensional array.
...
/*! \internal \brief Check if two offsets are equal.
...
/*! \internal \brief Check if two offsets are not equal.
 * \tparam Rank the dimension of the offsets.
 * \param[in] lhs first offset to compare
 * \param[in] rhs second offset to compare
...
/*! \internal \brief Check if two bounds are equal.
...
/*! \internal \brief Check if two bounds are different.
 * \tparam Rank the dimension of the bounds.
 * \param[in] lhs first bounds to compare
 * \param[in] rhs second bounds to compare
...
/*! \internal \brief Iterator over multidimensional array elements within bounds.
 *
