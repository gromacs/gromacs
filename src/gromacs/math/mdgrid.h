...
class MdGrid
{
    public:
        ...
        /*! \brief
         * Resets the bounds and extents or shrinks the containing grid cell correspondingly.
        ...
        /*! \brief
         * Unit cell accessor.
         * Unit cell times extent yields the grid cell.
    ...
    private:
        /*! \brief Evaluate unit cell from cell and grid extent.
         * \param[in] bounds Number of grid points in each dimension
         * \param[in] extent The full extent of the grid
         * \returns Unit cell of the grid
         */
        CanonicalVectorBasis<Rank> unitCellFromBoundsAndExtent(const bounds<Rank> &bounds, const MdFloatVector<Rank> &extent)
        {
