...
constexpr typename Extents::index_type staticExtentsProdcut(size_t const i = 0)
{
    return (i < Extents::rank()) ? Extents::static_extent(i) * staticExtentsProdcut<Extents>(i + 1) : 1;
}
} // namespace detail
/*! \libinternal
 * \brief
