...
class MultiDimArray
{
    public:
        ...
        static MultiDimArray allocate(IndexType && ... dynamicExtent)
        {
            MultiDimArray newArray;
            newArray.resize(std::forward<IndexType>(dynamicExtent) ...);
            return newArray;
        }
        /*! \libinternal \brief
        ...
        void resize(IndexType && ... dynamicExtent)
        {
            ...
            layout_right::mapping<Extents> map { Extents { std::forward<IndexType>(dynamicExtent) ...}};
