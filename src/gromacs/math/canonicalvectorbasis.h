...
class MdFloatVector
{
    public:
         ...
         *
         * Allows conversion from gmx::RVec for three dimensional grids in single precision build.
         */
        MdFloatVector(const float (&mdFloatVector)[Rank])
        {
         ...
         * \param[in] mdFloatVector The mdFloatVector as plain C array.
         *
         * Allows conversion from gmx::RVec for three dimensional grids in double precision builds.
         */
        MdFloatVector(const double (&mdFloatVector)[Rank])
        {
            std::copy(std::begin(mdFloatVector), std::end(mdFloatVector), std::begin(mdFloatVector_));
        }
