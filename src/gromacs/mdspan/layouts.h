...
/*! \brief Right aligned array layout indexer.
...
class layout_right
{
    ...
    public:
      /*!\brief Mapping from multidimensional integers within extents to one-dimensional integers.
        ...
        class mapping
        {
            ...
            private:
              ...
              */
                ...
                /* \brief Statically calculate offset.
