...
/*! \brief Enable querying extent of specific rank by splitting of a static extent from the variadic template arguments.
 *
 */
template< int R, std::ptrdiff_t E0, std::ptrdiff_t ... StaticExtents >
struct extents_analyse<R, E0, StaticExtents...> {

    /*! \brief The extent analysis of the next lower rank.  */
    ...
    /*! \brief Store analysis of the next extent of next lower rank.
     */
...
/*! \brief Specialisation for rank 0 extents analysis.
...
/*! \brief Multidimensional extents with static and dynamic dimensions.
 *
