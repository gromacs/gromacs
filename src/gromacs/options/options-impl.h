 ...
 * \ingroup module_options
 */
class OptionSectionStorage : public IOptionsContainerWithSections
{
    public:
        /*! \internal \brief
        ...
        class Group : public IOptionsContainer
        {
            public:
                ...
                explicit Group(OptionSectionStorage *parent) : parent_(parent) {}
        ...
        typedef std::unique_ptr<OptionSectionStorage> SectionPointer;
        ...
        OptionSectionStorage(const OptionManagerContainer &managers, const char *name)
         ...
         * Does not throw.
         */
        OptionSectionStorage *findSection(const char *name) const;
        /*! \brief
        ...
        GMX_DISALLOW_COPY_AND_ASSIGN(OptionSectionStorage);
};
...
class OptionsImpl
{
    public:
        ...
        OptionSectionStorage    rootSection_;
};
