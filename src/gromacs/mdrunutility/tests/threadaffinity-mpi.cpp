...
typedef gmx::test::ThreadAffinityTestBase ThreadAffinityMultiRankTest;

TEST_F(ThreadAffinityMultiRankTest, PinsWholeNode)
{
    GMX_MPI_TEST(4);
...
TEST_F(ThreadAffinityMultiRankTest, PinsWithOffsetAndStride)
{
    GMX_MPI_TEST(4);
    setAffinityOption(threadaffON);
    setOffsetAndStride(1, 2);
    ThreadAffinityTestHelper helper;
...
TEST_F(ThreadAffinityMultiRankTest, PinsTwoNodes)
{
    GMX_MPI_TEST(4);
    ThreadAffinityTestHelper helper;
...
TEST_F(ThreadAffinityMultiRankTest, DoesNothingWhenDisabled)
{
    GMX_MPI_TEST(4);
    setAffinityOption(threadaffOFF);
    ThreadAffinityTestHelper helper;
    helper.setLogicalProcessorCount(4);
    helper.setAffinity(this, 1);
}

TEST_F(ThreadAffinityMultiRankTest, HandlesTooManyThreadsWithAuto)
{
    GMX_MPI_TEST(4);
    ThreadAffinityTestHelper helper;
    helper.setLogicalProcessorCount(6);
    helper.setAffinity(this, 2);
}

TEST_F(ThreadAffinityMultiRankTest, HandlesTooManyThreadsWithForce)
{
    GMX_MPI_TEST(4);
    setAffinityOption(threadaffON);
    ThreadAffinityTestHelper helper;
...
class ThreadAffinityHeterogeneousNodesTest : public gmx::test::ThreadAffinityTestBase
{
    public:
