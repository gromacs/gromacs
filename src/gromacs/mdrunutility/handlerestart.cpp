 ...
 *
 * Read just the simulation 'generation' and with bAppendFiles check files.
                     ...
                     gmx_bool *bAddPart)
{
        ...
        else
        {
            ...
            if (*bAppendFiles)
            {
                ...
                if (nexist != nfiles)
                {
                    ...
                    fprintf(stderr, "\n\n");
                    fprintf(stderr,
                            "Note: Checkpointing is merely intended for plain continuation of runs.\n"
    ...
    if (PAR(cr))
    {
        ...
        gmx_bcast(sizeof(*bAppendFiles), bAppendFiles, cr);
