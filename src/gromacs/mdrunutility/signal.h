 ...
 */
#ifndef GMX_MDRUNUTILITY_SIGNAL_H
#define GMX_MDRUNUTILITY_SIGNAL_H
...
class SimulationSignaller
{
    public:
        ...
        SimulationSignaller(SimulationSignals *signals,
                            ...
                            bool               doInterSim,
                            bool               doIntraSim);
        /*! \brief Fill the array of reals in which signals will be
         * communicated with the signal values to be sent.
         *
         * \return A handle to the array of reals to communicate. */
