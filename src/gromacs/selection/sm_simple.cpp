...
evaluate_resindex(t_topology *top, t_trxframe * /* fr */, t_pbc * /* pbc */,
                  gmx_ana_index_t *g, gmx_ana_selvalue_t *out, void * /* data */);
/** \brief Checks whether molecule information is present in the topology.
 *
...
evaluate_pdbatomname(t_topology *top, t_trxframe * /* fr */, t_pbc * /* pbc */,
                     gmx_ana_index_t *g, gmx_ana_selvalue_t *out, void * /* data */);
/** \brief Checks whether atom types are present in the topology.
 *
 * \param[in] top  Topology structure.
 * \param     npar Not used.
 * \param     param Not used.
...
evaluate_charge(t_topology *top, t_trxframe * /* fr */, t_pbc * /* pbc */,
                gmx_ana_index_t *g, gmx_ana_selvalue_t *out, void * /* data */);
/** \brief Checks whether PDB info is present in the topology.
 *
 * \param[in] top  Topology structure.
 * \param     npar Not used.
 * \param     param Not used.
