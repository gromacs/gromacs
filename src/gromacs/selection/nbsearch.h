 ...
 *
 * To use the search, create an object of this type, call setParameters() to
...
class AnalysisNeighborhood
{
    public:
        ...
        /*! \brief
         * Set common parameters for the neighborhood searching.
         *
         ...
         * method.
         * \todo
         * Get rid of the \p maxn parameter.  initSearch() should (re)allocate
         * enough memory (possibly using some overallocation strategy).
         */
        void setParameters(real cutoff, int maxn);
        /*! \brief
 ...
 * for moving the variable around.
 *
 * Methods in this class do not throw.
 *
 * \todo
...
class AnalysisNeighborhoodSearch
{
    public:
         ...
         */
        explicit AnalysisNeighborhoodSearch(internal::AnalysisNeighborhoodSearchImpl *impl);
    ...
    private:
        internal::AnalysisNeighborhoodSearchImpl *impl_;
};
...
class AnalysisNeighborhoodPairSearch
{
    public:
         ...
         * Cannot be called from user code.
         */
        explicit AnalysisNeighborhoodPairSearch(internal::AnalysisNeighborhoodPairSearchImpl *impl);
        //! Creates a shallow copy (copy references the same implementation).
    ...
    private:
        internal::AnalysisNeighborhoodPairSearchImpl *impl_;
};
