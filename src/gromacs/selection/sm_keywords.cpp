...
/** \brief Allocates data for integer keyword evaluation.
 *
...
/** \brief Allocates data for real keyword evaluation.
 *
 * \param[in] npar  Not used.
 * \param     param Not used.
...
/** \brief Allocates data for string keyword evaluation.
 *
 * \param[in] npar  Not used.
 * \param     param Not used.
...
/** \brief Initializes data for real keyword evaluation.
 *
 * \param[in] top   Not used.
 * \param[in] npar  Not used (should be 2).
...
/** \brief Initializes data for string keyword evaluation.
 *
 * \param[in] top   Not used.
 * \param[in] npar  Not used (should be 2).
...
/** \brief Initializes keyword evaluation for an arbitrary group.
 *
 * \param[in] top   Not used.
 * \param[in] npar  Not used.
...
/** \brief Initializes output for keyword evaluation in an arbitrary group.
 *
 * \param[in]     top   Not used.
