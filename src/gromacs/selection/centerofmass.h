 ...
 *
 * Copyright (c) 2009,2010,2011,2013,2014,2015,2016,2018, by the GROMACS development team, led by
 ...
 */
void
gmx_calc_cog(const gmx::gmx_mtop_t *top, gmx::rvec x[], int nrefat, const int index[], gmx::rvec xout);
/** Calculate a single center of mass. */
void
gmx_calc_com(const gmx::gmx_mtop_t *top, gmx::rvec x[], int nrefat, const int index[], gmx::rvec xout);
/** Calculate force on a single center of geometry. */
void
gmx_calc_cog_f(const gmx::gmx_mtop_t *top, gmx::rvec f[], int nrefat, const int index[], gmx::rvec fout);
/*! \brief
 ...
 */
void
gmx_calc_com_f(const gmx::gmx_mtop_t *top, gmx::rvec f[], int nrefat, const int index[], gmx::rvec fout);
/** Calculate a single center of mass/geometry. */
void
gmx_calc_comg(const gmx::gmx_mtop_t *top, gmx::rvec x[], int nrefat, const int index[],
              bool bMass, gmx::rvec xout);
/** Calculate force on a single center of mass/geometry. */
void
gmx_calc_comg_f(const gmx::gmx_mtop_t *top, gmx::rvec f[], int nrefat, const int index[],
                bool bMass, gmx::rvec fout);

/** Calculate a single center of geometry iteratively, taking PBC into account. */
void
gmx_calc_cog_pbc(const gmx::gmx_mtop_t *top, gmx::rvec x[], const gmx::t_pbc *pbc,
                 int nrefat, const int index[], gmx::rvec xout);
/** Calculate a single center of mass iteratively, taking PBC into account. */
void
gmx_calc_com_pbc(const gmx::gmx_mtop_t *top, gmx::rvec x[], const gmx::t_pbc *pbc,
                 int nrefat, const int index[], gmx::rvec xout);
/** Calculate a single center of mass/geometry iteratively with PBC. */
void
gmx_calc_comg_pbc(const gmx::gmx_mtop_t *top, gmx::rvec x[], const gmx::t_pbc *pbc,
                  int nrefat, const int index[], bool bMass, gmx::rvec xout);
 ...
 */
void
gmx_calc_cog_block(const gmx::gmx_mtop_t *top, gmx::rvec x[], const gmx::t_block *block,
                   const int index[], gmx::rvec xout[]);
/** Calculate centers of mass for a blocked index. */
void
gmx_calc_com_block(const gmx::gmx_mtop_t *top, gmx::rvec x[], const gmx::t_block *block,
                   const int index[], gmx::rvec xout[]);
/** Calculate forces on centers of geometry for a blocked index. */
void
gmx_calc_cog_f_block(const gmx::gmx_mtop_t *top, gmx::rvec f[], const gmx::t_block *block,
                     const int index[], gmx::rvec fout[]);
/*! \brief
 ...
 */
void
gmx_calc_com_f_block(const gmx::gmx_mtop_t *top, gmx::rvec f[], const gmx::t_block *block,
                     const int index[], gmx::rvec fout[]);
/** Calculate centers of mass/geometry for a blocked index. */
void
gmx_calc_comg_block(const gmx::gmx_mtop_t *top, gmx::rvec x[], const gmx::t_block *block,
                    const int index[], bool bMass, gmx::rvec xout[]);
/** Calculate forces on centers of mass/geometry for a blocked index. */
void
gmx_calc_comg_f_block(const gmx::gmx_mtop_t *top, gmx::rvec f[], const gmx::t_block *block,
                      const int index[], bool bMass, gmx::rvec fout[]);
/** Calculate centers of mass/geometry for a set of blocks; */
void
gmx_calc_comg_blocka(const gmx::gmx_mtop_t *top, gmx::rvec x[], const gmx::t_blocka *block,
                     bool bMass, gmx::rvec xout[]);
/** Calculate forces on centers of mass/geometry for a set of blocks; */
void
gmx_calc_comg_f_blocka(const gmx::gmx_mtop_t *top, gmx::rvec x[], const gmx::t_blocka *block,
                       bool bMass, gmx::rvec xout[]);
