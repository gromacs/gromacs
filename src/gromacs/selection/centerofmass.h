...
/** \brief Calculate a single center of geometry.
 *
...
/** \brief Calculate force on a single center of mass.
 *
 * \param[in]  top    Topology structure (unused, can be NULL).
...
/** \brief Calculate centers of geometry for a blocked index.
 *
 * \param[in]  top   Topology structure (unused, can be NULL).
 * \param[in]  x     Position vectors of all atoms.
...
/** \brief Calculate forces on centers of mass for a blocked index.
 *
 * \param[in]  top   Topology structure (unused, can be NULL).
 * \param[in]  f     Forces on all atoms.
 * \param[in]  block t_block structure that divides \p index into blocks.
