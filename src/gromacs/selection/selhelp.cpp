...
const char *const CmdLineHelpText::text[] = {
    ...
    "Many selection-enabled tools also provide a [TT]-fgroup[tt] option",
    "to specify the atom indices that are present in the trajectory for case",
    "the trajectory only has a subset of atoms from the topology/structure file."
};
