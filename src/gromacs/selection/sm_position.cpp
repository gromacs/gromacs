...
/** \brief Initializes position evaluation keywords.
 *
...
/** \brief Initializes the \p cog selection method.
 *
 * \param[in]     top   Topology data structure.
 * \param[in]     npar  Not used.
 * \param[in]     param Not used.
...
/** \brief Initializes output for position evaluation selection methods.
 *
 * \param[in]     top   Topology data structure.
