...
function (do_cmake_config)
    ...
    if (NOT GMX_GPU)
        # TODO: This produces some wildcard globbing that needs to be tested
        # for robustness and possibly fixed.
        install(EXPORT libgromacs
                FILE libgromacs${GMX_LIBS_SUFFIX}.cmake
                DESTINATION ${CMAKE_INSTALL_DIR}/gromacs${GMX_LIBS_SUFFIX}
                COMPONENT libraries)
    endif()
