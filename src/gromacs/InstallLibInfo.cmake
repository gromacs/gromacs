...
function (do_cmake_config)
    ...
    # TODO: GPU builds would require also exports for the static intermediate
    # CUDA libraries, but I do not have facilities to test the alternatives.
    if (NOT GMX_GPU)
        set(EXPORT_FILE_NAME libgromacs.cmake)
        if (NOT BUILD_SHARED_LIBS)
            set(EXPORT_FILE_NAME libgromacs_static.cmake)
        endif()
        # TODO: This produces some wildcard globbing that may pick up obsolete
        # files left over from earlier installation to the same prefix.
        # Need to experiment with CONFIGURATIONS option to make this more
        # robust.
