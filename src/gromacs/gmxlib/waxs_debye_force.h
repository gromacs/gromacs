...
class WaxsDebyeForce
{
    private:
        ...
        //! Reference data and error in this, read from file
        std::vector<double>    _Sref, _dSref;
        
        //! Difference data and error in this, optionally read from file
        std::vector<double>    _dSexp, _ddSexp;
        
        //! Computed scattering function in simulation
        std::vector<double>    _Scalc;
