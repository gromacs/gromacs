...
void pr_iparams(FILE *fp, t_functype ftype, t_iparams *iparams)
{
    ...
    switch (ftype)
    {
        ...
        case F_CMAP:
            ...
            break;
        case  F_RESTRANGLES: // Monica and Nicu; Similar with F_ANGRES
            pr_harm(fp,iparams,"b0","cb");
            break;
        case  F_RESTRDIHS: // Monica and Nicu; Similar with F_ANGRES
            fprintf(fp,"phiA=%15.8e, cpA=%15.8e",
	        iparams->restrdihs.phiA,iparams->restrdihs.cpA);
            break;
        case  F_CBTDIHS: // Monica and Nicu; Similar with F_RBDIHS
