                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            rinv13           = sse2_invsqrt_f(rsq13);
            rinv21           = sse2_invsqrt_f(rsq21);
            rinv22           = sse2_invsqrt_f(rsq22);
            rinv23           = sse2_invsqrt_f(rsq23);
            rinv31           = sse2_invsqrt_f(rsq31);
            rinv32           = sse2_invsqrt_f(rsq32);
            rinv33           = sse2_invsqrt_f(rsq33);

            rinvsq00         = sse2_inv_f(rsq00);
