                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    __m128d           c6grid_10;
    __m128d           c6grid_20;
    __m128d           ewclj,ewclj2,ewclj6,ewcljrsq,poly,exponent,f6A,f6B;
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end-1; jidx+=2)
        {
            ...
            c6grid_00       = gmx_mm_load_2real_swizzle_pd(vdwparam+vdwioffset0+vdwjidx0A+2,
            ...
            poly             = _mm_mul_pd(exponent,_mm_add_pd(_mm_add_pd(one,ewcljrsq),_mm_mul_pd(_mm_mul_pd(ewcljrsq,ewcljrsq),one_half)));
            ...
            fvdw             = _mm_mul_pd(_mm_sub_pd(vvdw12,_mm_add_pd(vvdw6,_mm_mul_pd(_mm_mul_pd(c6grid_00,one_sixth),_mm_mul_pd(exponent,ewclj6)))),rinvsq00);
        ...
        if(jidx<j_index_end)
        {
            ...
            c6grid_00       = gmx_mm_load_1real_pd(vdwparam+vdwioffset0+vdwjidx0A+2);
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end-1; jidx+=2)
        {
            ...
            fvdw              = _mm_mul_pd(_mm_sub_pd(_mm_mul_pd(c12_00,_mm_mul_pd(rinvsix,rinvsix)),_mm_add_pd(_mm_mul_pd(_mm_sub_pd(c6_00,f6A),rinvsix),f6B)),rinvsq00);
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3_F,outeriter*18 + inneriter*135);
}
