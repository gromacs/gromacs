...
static gmx_inline void gmx_simdcall gmx_mm_decrement_1rvec_4ptr_swizzle_ps(float * ptrA,
                                                                           float * ptrB,
                                                                           float * ptrC,
                                                                           float * ptrD,
...
static gmx_inline void gmx_simdcall gmx_mm_update_iforce_4atom_swizzle_ps(__m128 fix1, __m128 fiy1, __m128 fiz1,
                                                                          __m128 fix2, __m128 fiy2, __m128 fiz2,
                                                                          __m128 fix3, __m128 fiy3, __m128 fiz3,
...
#ifdef __PGI
#    define SSE41_FLOAT_NEGZERO   ({ const union { int  fi; float f; } _gmx_fzero = {-2147483648}; _gmx_fzero.f; })
#else
#    define SSE41_FLOAT_NEGZERO  (-0.0f)
#endif

static gmx_inline __m128 gmx_simdcall sse41_set_exponent_f(__m128 x)
{
...
static gmx_inline __m128 gmx_simdcall sse41_exp_f(__m128 x)
{
    ...
    fexppart  = sse41_set_exponent_f(y);
    intpart   = _mm_cvtepi32_ps(_mm_cvtps_epi32(y));
    valuemask = _mm_cmple_ps(_mm_andnot_ps(_mm_set1_ps(SSE41_FLOAT_NEGZERO), y), arglimit);
...
static gmx_inline __m128 gmx_simdcall sse41_invsqrt_f(__m128 x)
{
...
static gmx_inline __m128 gmx_simdcall sse41_inv_f(__m128 x)
{
