...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSw_VdwLJSw_GeomW4P1_VF_sse4_1_single
 ...
 */
void
nb_kernel_ElecEwSw_VdwLJSw_GeomW4P1_VF_sse4_1_single
 ...
 */
void
nb_kernel_ElecEwSw_VdwLJSw_GeomW4P1_F_sse4_1_single
                    (const struct t_nblist         * gmx_restrict       nlist,
                     rvec                          * gmx_restrict          xx,
                     rvec                          * gmx_restrict          ff,
                     const struct nb_kernel_data_t * gmx_restrict kernel_data,
