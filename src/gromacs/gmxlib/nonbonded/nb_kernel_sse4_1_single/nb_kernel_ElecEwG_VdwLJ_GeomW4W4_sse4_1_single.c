...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwLJ_GeomW4W4_VF_sse4_1_single
 ...
 */
void
nb_kernel_ElecEwG_VdwLJ_GeomW4W4_VF_sse4_1_single
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    alphaj1          = _mm_set1_ps(gaussian[inr+1]);
    jq2              = _mm_set1_ps(charge[inr+2]);
    alphaj2          = _mm_set1_ps(gaussian[inr+2]);
    jq3              = _mm_set1_ps(charge[inr+3]);
    alphaj3          = _mm_set1_ps(gaussian[inr+3]);
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai1,alphai1), _mm_mul_ps(alphaj1,alphaj1) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ewrt             = _mm_mul_ps (alphai1,alphaij);
            alphaij          = _mm_mul_ps (ewrt,alphaj1);
            ...
            velect           = _mm_mul_ps(qq11,_mm_sub_ps(rinv11,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq11,rinv11),_mm_sub_ps(rinvsq11,_mm_mul_ps(felect,scale)));
            ...
            /* EWALD ELECTROSTATICS WITH GAUSSIAN CHARGE DISTRIBUTIONS */
            /* Calculate Ewald table index by multiplying r with scale and truncate to integer */
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai1,alphai1), _mm_mul_ps(alphaj2,alphaj2) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ewrt             = _mm_mul_ps (alphai1,alphaij);
            alphaij          = _mm_mul_ps (ewrt,alphaj2);
            ...
            rscale           = _mm_mul_ps(scale,r12);
            rscale2          = _mm_mul_ps(rscale,rscale);
            ewrt             = _mm_mul_ps(rscale,ewtabscale);
            if (gmx_mm_any_lt(rscale2,rcutoff2)) { 
            ewg_mask         = _mm_cmplt_ps(rscale2,rcutoff2 );
            //  ewrt = (r12*scale < rcutoff) ? ewrt : 0
            ewrt             = _mm_or_ps(_mm_and_ps(ewg_mask , ewrt) , _mm_andnot_ps(ewg_mask, zero));
            ewitab           = _mm_cvttps_epi32(ewrt);
            eweps            = _mm_sub_ps(ewrt,_mm_round_ps(ewrt, _MM_FROUND_FLOOR));
            ewitab           = _mm_slli_epi32(ewitab,2);
            ...
            felect           = _mm_mul_ps(_mm_add_ps(ewtabF,_mm_mul_ps(eweps,ewtabD)),scale);
            velect           = _mm_sub_ps(_mm_mul_ps(ewtabV,scale),_mm_mul_ps(_mm_mul_ps(ewtabhalfspace,eweps),_mm_add_ps(_mm_mul_ps(ewtabF,scale),felect)));
            velect           = _mm_mul_ps(qq12,_mm_sub_ps(rinv12,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq12,rinv12),_mm_sub_ps(rinvsq12,_mm_mul_ps(felect,scale)));
            felect           = _mm_or_ps(_mm_and_ps(ewg_mask , felect) , _mm_andnot_ps(ewg_mask, zero));
            felec            = _mm_sub_ps(felec,felect);            
            }
            ...
            /* EWALD ELECTROSTATICS WITH GAUSSIAN CHARGE DISTRIBUTIONS */
            /* Calculate Ewald table index by multiplying r with scale and truncate to integer */
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai1,alphai1), _mm_mul_ps(alphaj3,alphaj3) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ewrt             = _mm_mul_ps (alphai1,alphaij);
            alphaij          = _mm_mul_ps (ewrt,alphaj3);
            ...
            rscale           = _mm_mul_ps(scale,r13);
            rscale2          = _mm_mul_ps(rscale,rscale);
            ewrt             = _mm_mul_ps(rscale,ewtabscale);
            if (gmx_mm_any_lt(rscale2,rcutoff2)) { 
            ewg_mask         = _mm_cmplt_ps(rscale2,rcutoff2 );
            //  ewrt = (r13*scale < rcutoff) ? ewrt : 0
            ewrt             = _mm_or_ps(_mm_and_ps(ewg_mask , ewrt) , _mm_andnot_ps(ewg_mask, zero));
            ewitab           = _mm_cvttps_epi32(ewrt);
            eweps            = _mm_sub_ps(ewrt,_mm_round_ps(ewrt, _MM_FROUND_FLOOR));
            ewitab           = _mm_slli_epi32(ewitab,2);
            ...
            felect           = _mm_mul_ps(_mm_add_ps(ewtabF,_mm_mul_ps(eweps,ewtabD)),scale);
            velect           = _mm_sub_ps(_mm_mul_ps(ewtabV,scale),_mm_mul_ps(_mm_mul_ps(ewtabhalfspace,eweps),_mm_add_ps(_mm_mul_ps(ewtabF,scale),felect)));
            velect           = _mm_mul_ps(qq13,_mm_sub_ps(rinv13,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq13,rinv13),_mm_sub_ps(rinvsq13,_mm_mul_ps(felect,scale)));
            felect           = _mm_or_ps(_mm_and_ps(ewg_mask , felect) , _mm_andnot_ps(ewg_mask, zero));
            felec            = _mm_sub_ps(felec,felect);            
            }
            ...
            /* EWALD ELECTROSTATICS WITH GAUSSIAN CHARGE DISTRIBUTIONS */
            /* Calculate Ewald table index by multiplying r with scale and truncate to integer */
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai2,alphai2), _mm_mul_ps(alphaj1,alphaj1) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ...
            rscale           = _mm_mul_ps(scale,r21);
            rscale2          = _mm_mul_ps(rscale,rscale);
            ewrt             = _mm_mul_ps(rscale,ewtabscale);
            if (gmx_mm_any_lt(rscale2,rcutoff2)) { 
            ewg_mask         = _mm_cmplt_ps(rscale2,rcutoff2 );
            //  ewrt = (r21*scale < rcutoff) ? ewrt : 0
            ewrt             = _mm_or_ps(_mm_and_ps(ewg_mask , ewrt) , _mm_andnot_ps(ewg_mask, zero));
            ewitab           = _mm_cvttps_epi32(ewrt);
            eweps            = _mm_sub_ps(ewrt,_mm_round_ps(ewrt, _MM_FROUND_FLOOR));
            ewitab           = _mm_slli_epi32(ewitab,2);
            ...
            felect           = _mm_mul_ps(_mm_add_ps(ewtabF,_mm_mul_ps(eweps,ewtabD)),scale);
            velect           = _mm_sub_ps(_mm_mul_ps(ewtabV,scale),_mm_mul_ps(_mm_mul_ps(ewtabhalfspace,eweps),_mm_add_ps(_mm_mul_ps(ewtabF,scale),felect)));
            velect           = _mm_mul_ps(qq21,_mm_sub_ps(rinv21,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq21,rinv21),_mm_sub_ps(rinvsq21,_mm_mul_ps(felect,scale)));
            felect           = _mm_or_ps(_mm_and_ps(ewg_mask , felect) , _mm_andnot_ps(ewg_mask, zero));
            felec            = _mm_sub_ps(felec,felect);            
            }
            ...
            /* EWALD ELECTROSTATICS WITH GAUSSIAN CHARGE DISTRIBUTIONS */
            /* Calculate Ewald table index by multiplying r with scale and truncate to integer */
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai2,alphai2), _mm_mul_ps(alphaj2,alphaj2) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ewrt             = _mm_mul_ps (alphai2,alphaij);
            alphaij          = _mm_mul_ps (ewrt,alphaj2);
            ...
            rscale           = _mm_mul_ps(scale,r22);
            rscale2          = _mm_mul_ps(rscale,rscale);
            ewrt             = _mm_mul_ps(rscale,ewtabscale);
            if (gmx_mm_any_lt(rscale2,rcutoff2)) { 
            ewg_mask         = _mm_cmplt_ps(rscale2,rcutoff2 );
            //  ewrt = (r22*scale < rcutoff) ? ewrt : 0
            ewrt             = _mm_or_ps(_mm_and_ps(ewg_mask , ewrt) , _mm_andnot_ps(ewg_mask, zero));
            ewitab           = _mm_cvttps_epi32(ewrt);
            eweps            = _mm_sub_ps(ewrt,_mm_round_ps(ewrt, _MM_FROUND_FLOOR));
            ewitab           = _mm_slli_epi32(ewitab,2);
            ...
            felect           = _mm_mul_ps(_mm_add_ps(ewtabF,_mm_mul_ps(eweps,ewtabD)),scale);
            velect           = _mm_sub_ps(_mm_mul_ps(ewtabV,scale),_mm_mul_ps(_mm_mul_ps(ewtabhalfspace,eweps),_mm_add_ps(_mm_mul_ps(ewtabF,scale),felect)));
            velect           = _mm_mul_ps(qq22,_mm_sub_ps(rinv22,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq22,rinv22),_mm_sub_ps(rinvsq22,_mm_mul_ps(felect,scale)));
            felect           = _mm_or_ps(_mm_and_ps(ewg_mask , felect) , _mm_andnot_ps(ewg_mask, zero));
            felec            = _mm_sub_ps(felec,felect);            
            }
            ...
            /* EWALD ELECTROSTATICS WITH GAUSSIAN CHARGE DISTRIBUTIONS */
            /* Calculate Ewald table index by multiplying r with scale and truncate to integer */
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai2,alphai2), _mm_mul_ps(alphaj3,alphaj3) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ewrt             = _mm_mul_ps (alphai2,alphaij);
            alphaij          = _mm_mul_ps (ewrt,alphaj3);
            ...
            rscale           = _mm_mul_ps(scale,r23);
            rscale2          = _mm_mul_ps(rscale,rscale);
            ewrt             = _mm_mul_ps(rscale,ewtabscale);
            if (gmx_mm_any_lt(rscale2,rcutoff2)) { 
            ewg_mask         = _mm_cmplt_ps(rscale2,rcutoff2 );
            //  ewrt = (r23*scale < rcutoff) ? ewrt : 0
            ewrt             = _mm_or_ps(_mm_and_ps(ewg_mask , ewrt) , _mm_andnot_ps(ewg_mask, zero));
            ewitab           = _mm_cvttps_epi32(ewrt);
            eweps            = _mm_sub_ps(ewrt,_mm_round_ps(ewrt, _MM_FROUND_FLOOR));
            ewitab           = _mm_slli_epi32(ewitab,2);
            ...
            felect           = _mm_mul_ps(_mm_add_ps(ewtabF,_mm_mul_ps(eweps,ewtabD)),scale);
            velect           = _mm_sub_ps(_mm_mul_ps(ewtabV,scale),_mm_mul_ps(_mm_mul_ps(ewtabhalfspace,eweps),_mm_add_ps(_mm_mul_ps(ewtabF,scale),felect)));
            velect           = _mm_mul_ps(qq23,_mm_sub_ps(rinv23,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq23,rinv23),_mm_sub_ps(rinvsq23,_mm_mul_ps(felect,scale)));
            felect           = _mm_or_ps(_mm_and_ps(ewg_mask , felect) , _mm_andnot_ps(ewg_mask, zero));
            felec            = _mm_sub_ps(felec,felect);            
            }
            ...
            /* EWALD ELECTROSTATICS WITH GAUSSIAN CHARGE DISTRIBUTIONS */
            /* Calculate Ewald table index by multiplying r with scale and truncate to integer */
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai3,alphai3), _mm_mul_ps(alphaj1,alphaj1) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ...
            rscale           = _mm_mul_ps(scale,r31);
            rscale2          = _mm_mul_ps(rscale,rscale);
            ewrt             = _mm_mul_ps(rscale,ewtabscale);
            if (gmx_mm_any_lt(rscale2,rcutoff2)) { 
            ewg_mask         = _mm_cmplt_ps(rscale2,rcutoff2 );
            //  ewrt = (r31*scale < rcutoff) ? ewrt : 0
            ewrt             = _mm_or_ps(_mm_and_ps(ewg_mask , ewrt) , _mm_andnot_ps(ewg_mask, zero));
            ewitab           = _mm_cvttps_epi32(ewrt);
            eweps            = _mm_sub_ps(ewrt,_mm_round_ps(ewrt, _MM_FROUND_FLOOR));
            ewitab           = _mm_slli_epi32(ewitab,2);
            ...
            felect           = _mm_mul_ps(_mm_add_ps(ewtabF,_mm_mul_ps(eweps,ewtabD)),scale);
            velect           = _mm_sub_ps(_mm_mul_ps(ewtabV,scale),_mm_mul_ps(_mm_mul_ps(ewtabhalfspace,eweps),_mm_add_ps(_mm_mul_ps(ewtabF,scale),felect)));
            velect           = _mm_mul_ps(qq31,_mm_sub_ps(rinv31,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq31,rinv31),_mm_sub_ps(rinvsq31,_mm_mul_ps(felect,scale)));
            felect           = _mm_or_ps(_mm_and_ps(ewg_mask , felect) , _mm_andnot_ps(ewg_mask, zero));
            felec            = _mm_sub_ps(felec,felect);            
            }
            ...
            /* EWALD ELECTROSTATICS WITH GAUSSIAN CHARGE DISTRIBUTIONS */
            /* Calculate Ewald table index by multiplying r with scale and truncate to integer */
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai3,alphai3), _mm_mul_ps(alphaj2,alphaj2) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ewrt             = _mm_mul_ps (alphai3,alphaij);
            alphaij          = _mm_mul_ps (ewrt,alphaj2);
            ...
            rscale           = _mm_mul_ps(scale,r32);
            rscale2          = _mm_mul_ps(rscale,rscale);
            ewrt             = _mm_mul_ps(rscale,ewtabscale);
            if (gmx_mm_any_lt(rscale2,rcutoff2)) { 
            ewg_mask         = _mm_cmplt_ps(rscale2,rcutoff2 );
            //  ewrt = (r32*scale < rcutoff) ? ewrt : 0
            ewrt             = _mm_or_ps(_mm_and_ps(ewg_mask , ewrt) , _mm_andnot_ps(ewg_mask, zero));
            ewitab           = _mm_cvttps_epi32(ewrt);
            eweps            = _mm_sub_ps(ewrt,_mm_round_ps(ewrt, _MM_FROUND_FLOOR));
            ewitab           = _mm_slli_epi32(ewitab,2);
            ...
            felect           = _mm_mul_ps(_mm_add_ps(ewtabF,_mm_mul_ps(eweps,ewtabD)),scale);
            velect           = _mm_sub_ps(_mm_mul_ps(ewtabV,scale),_mm_mul_ps(_mm_mul_ps(ewtabhalfspace,eweps),_mm_add_ps(_mm_mul_ps(ewtabF,scale),felect)));
            velect           = _mm_mul_ps(qq32,_mm_sub_ps(rinv32,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq32,rinv32),_mm_sub_ps(rinvsq32,_mm_mul_ps(felect,scale)));
            felect           = _mm_or_ps(_mm_and_ps(ewg_mask , felect) , _mm_andnot_ps(ewg_mask, zero));
            felec            = _mm_sub_ps(felec,felect);            
            }
            ...
            /* EWALD ELECTROSTATICS WITH GAUSSIAN CHARGE DISTRIBUTIONS */
            /* Calculate Ewald table index by multiplying r with scale and truncate to integer */
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai3,alphai3), _mm_mul_ps(alphaj3,alphaj3) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ewrt             = _mm_mul_ps (alphai3,alphaij);
            alphaij          = _mm_mul_ps (ewrt,alphaj3);
            ...
            rscale           = _mm_mul_ps(scale,r33);
            rscale2          = _mm_mul_ps(rscale,rscale);
            ewrt             = _mm_mul_ps(rscale,ewtabscale);
            if (gmx_mm_any_lt(rscale2,rcutoff2)) { 
            ewg_mask         = _mm_cmplt_ps(rscale2,rcutoff2 );
            //  ewrt = (r33*scale < rcutoff) ? ewrt : 0
            ewrt             = _mm_or_ps(_mm_and_ps(ewg_mask , ewrt) , _mm_andnot_ps(ewg_mask, zero));
            ewitab           = _mm_cvttps_epi32(ewrt);
            eweps            = _mm_sub_ps(ewrt,_mm_round_ps(ewrt, _MM_FROUND_FLOOR));
            ewitab           = _mm_slli_epi32(ewitab,2);
            ...
            felect           = _mm_mul_ps(_mm_add_ps(ewtabF,_mm_mul_ps(eweps,ewtabD)),scale);
            velect           = _mm_sub_ps(_mm_mul_ps(ewtabV,scale),_mm_mul_ps(_mm_mul_ps(ewtabhalfspace,eweps),_mm_add_ps(_mm_mul_ps(ewtabF,scale),felect)));
            velect           = _mm_mul_ps(qq33,_mm_sub_ps(rinv33,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq33,rinv33),_mm_sub_ps(rinvsq33,_mm_mul_ps(felect,scale)));
            felect           = _mm_or_ps(_mm_and_ps(ewg_mask , felect) , _mm_andnot_ps(ewg_mask, zero));
            felec            = _mm_sub_ps(felec,felect);            
            }
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W4W4_VF,outeriter*26 + inneriter*521);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwLJ_GeomW4W4_F_sse4_1_single
 * Electrostatics interaction: EwaldG
 * VdW interaction:            LennardJones
 * Geometry:                   Water4-Water4
 ...
 */
void
nb_kernel_ElecEwG_VdwLJ_GeomW4W4_F_sse4_1_single
                    (t_nblist                    * gmx_restrict       nlist,
                     rvec                        * gmx_restrict          xx,
                     rvec                        * gmx_restrict          ff,
                     t_forcerec                  * gmx_restrict          fr,
