                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    __m128           c6grid_00;
    __m128           ewclj,ewclj2,ewclj6,ewcljrsq,poly,exponent,f6A,f6B;
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            c6grid_00       = gmx_mm_load_4real_swizzle_ps(vdwparam+vdwioffset0+vdwjidx0A+2,
                                                               vdwparam+vdwioffset0+vdwjidx0B+2,
                                                               vdwparam+vdwioffset0+vdwjidx0C+2,
                                                               vdwparam+vdwioffset0+vdwjidx0D+2);
            ...
            poly             = _mm_mul_ps(exponent,_mm_add_ps(_mm_add_ps(one,ewcljrsq),_mm_mul_ps(_mm_mul_ps(ewcljrsq,ewcljrsq),one_half)));
            ...
            fvdw             = _mm_mul_ps(_mm_sub_ps(vvdw12,_mm_add_ps(vvdw6,_mm_mul_ps(_mm_mul_ps(c6grid_00,one_sixth),_mm_mul_ps(exponent,ewclj6)))),rinvsq00);
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            fvdw              = _mm_mul_ps(_mm_sub_ps(_mm_mul_ps(c12_00,_mm_mul_ps(rinvsix,rinvsix)),_mm_add_ps(_mm_mul_ps(_mm_sub_ps(c6_00,f6A),rinvsix),f6B)),rinvsq00);
