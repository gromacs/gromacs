...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwNone_GeomW3P1_VF_sse4_1_single
 ...
 */
void
nb_kernel_ElecEwG_VdwNone_GeomW3P1_VF_sse4_1_single
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    alphai0          = _mm_set1_ps(gaussian[inr+0]);
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            ewrt             = _mm_add_ps( _mm_mul_ps(alphai0,alphai0), _mm_mul_ps(alphaj0,alphaj0) );
            alphaij          = gmx_mm_invsqrt_ps(ewrt);
            ewrt             = _mm_mul_ps (alphai0,alphaij);
            ...
            velect           = _mm_mul_ps(qq00,_mm_sub_ps(rinv00,velect));
            velect           = _mm_or_ps(_mm_and_ps(ewg_mask , velect) , _mm_andnot_ps(ewg_mask, zero));
            velec            = _mm_sub_ps(velec,velect);            

            felect           = _mm_mul_ps(_mm_mul_ps(qq00,rinv00),_mm_sub_ps(rinvsq00,_mm_mul_ps(felect,scale)));
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_W3_VF,outeriter*19 + inneriter*162);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwNone_GeomW3P1_F_sse4_1_single
 * Electrostatics interaction: EwaldG
 * VdW interaction:            None
 * Geometry:                   Water3-Particle
 ...
 */
void
nb_kernel_ElecEwG_VdwNone_GeomW3P1_F_sse4_1_single
                    (t_nblist                    * gmx_restrict       nlist,
                     rvec                        * gmx_restrict          xx,
                     rvec                        * gmx_restrict          ff,
                     t_forcerec                  * gmx_restrict          fr,
