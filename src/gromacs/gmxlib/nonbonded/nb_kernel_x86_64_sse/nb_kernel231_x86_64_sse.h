 ...
 */
#ifndef _NB_KERNEL231_X86_64_SSE_H_
#define _NB_KERNEL231_X86_64_SSE_H_


/*! \file  nb_kernel231_x86_64_sse.h
 *  \brief x86_64 SSE-optimized versions of nonbonded kernel 231
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 231 with forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel231_x86_64_sse  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 231 without forces, optimized for x86_64 sse.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Reaction-field <br>
 ...
 */
void
nb_kernel231nf_x86_64_sse(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL231_X86_64_SSE_H_ */
