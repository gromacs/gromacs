...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwLJ_GeomW3W3_VF_c
 ...
 */
void
nb_kernel_ElecEwG_VdwLJ_GeomW3W3_VF_c
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end; jidx++)
        {
            ...
            alphaij          = alphai0 * alphaj1 * gmx_invsqrt(alphai0*alphai0 + alphaj1*alphaj1);
            ewrt             = r01*ewtabscale;
            ewitab           = ewrt;
            eweps            = ewrt-ewitab;
            ...
            scale            = alphaij/ewc;
            if (  r01 * scale < rcutoff ) {
                ewrt             = scale * r01*ewtabscale;
                ewitab           = ewrt;
                eweps            = ewrt-ewitab;
                ewitab           = 4*ewitab;
                felect           = (ewtab[ewitab]+eweps*ewtab[ewitab+1])*scale ;
                velec            -=  qq01*(rinv01 - (scale*ewtab[ewitab+2]-ewtabhalfspace*eweps*(scale*ewtab[ewitab]+felect)));
                felec            -=  qq01*rinv01*( rinvsq01 - scale*felect );
            }
            ...
            alphaij          = alphai0 * alphaj2 * gmx_invsqrt(alphai0*alphai0 + alphaj2*alphaj2);
            ewrt             = r02*ewtabscale;
            ewitab           = ewrt;
            eweps            = ewrt-ewitab;
            ...
            scale            = alphaij/ewc;
            if (  r02 * scale < rcutoff ) {
                ewrt             = scale * r02*ewtabscale;
                ewitab           = ewrt;
                eweps            = ewrt-ewitab;
                ewitab           = 4*ewitab;
                felect           = (ewtab[ewitab]+eweps*ewtab[ewitab+1])*scale ;
                velec            -=  qq02*(rinv02 - (scale*ewtab[ewitab+2]-ewtabhalfspace*eweps*(scale*ewtab[ewitab]+felect)));
                felec            -=  qq02*rinv02*( rinvsq02 - scale*felect );
            }
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3W3_VF,outeriter*32 + inneriter*237);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwLJ_GeomW3W3_F_c
 * Electrostatics interaction: EwaldG
 * VdW interaction:            LennardJones
 * Geometry:                   Water3-Water3
 ...
 */
void
nb_kernel_ElecEwG_VdwLJ_GeomW3W3_F_c
                    (t_nblist                    * gmx_restrict       nlist,
                     rvec                        * gmx_restrict          xx,
                     rvec                        * gmx_restrict          ff,
                     t_forcerec                  * gmx_restrict          fr,
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3W3_F,outeriter*30 + inneriter*223);
}
