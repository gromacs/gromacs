...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwLJEw_GeomW3P1_VF_c
 ...
 */
void
nb_kernel_ElecEwG_VdwLJEw_GeomW3P1_VF_c
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end; jidx++)
        {
            ...
            alphaij          = alphai0 * alphaj0 * gmx_invsqrt(alphai0*alphai0 + alphaj0*alphaj0);
            ewrt             = r00*ewtabscale;
            ewitab           = ewrt;
            eweps            = ewrt-ewitab;
            ...
            scale            = alphaij/ewc;
            if (  r00 * scale < rcutoff ) {
                ewrt             = scale * r00*ewtabscale;
                ewitab           = ewrt;
                eweps            = ewrt-ewitab;
                ewitab           = 4*ewitab;
                felect           = (ewtab[ewitab]+eweps*ewtab[ewitab+1])*scale ;
                velec            -=  qq00*(rinv00 - (scale*ewtab[ewitab+2]-ewtabhalfspace*eweps*(scale*ewtab[ewitab]+felect)));
                felec            -=  qq00*rinv00*( rinvsq00 - scale*felect );
            }
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3_VF,outeriter*32 + inneriter*104);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwLJEw_GeomW3P1_F_c
 * Electrostatics interaction: EwaldG
 * VdW interaction:            LJEwald
 * Geometry:                   Water3-Particle
 ...
 */
void
nb_kernel_ElecEwG_VdwLJEw_GeomW3P1_F_c
                    (t_nblist                    * gmx_restrict       nlist,
                     rvec                        * gmx_restrict          xx,
                     rvec                        * gmx_restrict          ff,
                     t_forcerec                  * gmx_restrict          fr,
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3_F,outeriter*30 + inneriter*96);
}
