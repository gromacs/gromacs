...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwNone_GeomW4P1_VF_c
 ...
 */
void
nb_kernel_ElecEwG_VdwNone_GeomW4P1_VF_c
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end; jidx++)
        {
            ...
            alphaij          = alphai1 * alphaj0 * gmx_invsqrt(alphai1*alphai1 + alphaj0*alphaj0);
            ewrt             = r10*ewtabscale;
            ewitab           = ewrt;
            eweps            = ewrt-ewitab;
            ...
            scale            = alphaij/ewc;
            if (  r10 * scale < rcutoff ) {
                ewrt             = scale * r10*ewtabscale;
                ewitab           = ewrt;
                eweps            = ewrt-ewitab;
                ewitab           = 4*ewitab;
                felect           = (ewtab[ewitab]+eweps*ewtab[ewitab+1])*scale ;
                velec            -=  qq10*(rinv10 - (scale*ewtab[ewitab+2]-ewtabhalfspace*eweps*(scale*ewtab[ewitab]+felect)));
                felec            -=  qq10*rinv10*( rinvsq10 - scale*felect );
            }
            ...
            alphaij          = alphai2 * alphaj0 * gmx_invsqrt(alphai2*alphai2 + alphaj0*alphaj0);
            ewrt             = r20*ewtabscale;
            ewitab           = ewrt;
            eweps            = ewrt-ewitab;
            ...
            scale            = alphaij/ewc;
            if (  r20 * scale < rcutoff ) {
                ewrt             = scale * r20*ewtabscale;
                ewitab           = ewrt;
                eweps            = ewrt-ewitab;
                ewitab           = 4*ewitab;
                felect           = (ewtab[ewitab]+eweps*ewtab[ewitab+1])*scale ;
                velec            -=  qq20*(rinv20 - (scale*ewtab[ewitab+2]-ewtabhalfspace*eweps*(scale*ewtab[ewitab]+felect)));
                felec            -=  qq20*rinv20*( rinvsq20 - scale*felect );
            }
            ...
            alphaij          = alphai3 * alphaj0 * gmx_invsqrt(alphai3*alphai3 + alphaj0*alphaj0);
            ewrt             = r30*ewtabscale;
            ewitab           = ewrt;
            eweps            = ewrt-ewitab;
            ...
            scale            = alphaij/ewc;
            if (  r30 * scale < rcutoff ) {
                ewrt             = scale * r30*ewtabscale;
                ewitab           = ewrt;
                eweps            = ewrt-ewitab;
                ewitab           = 4*ewitab;
                felect           = (ewtab[ewitab]+eweps*ewtab[ewitab+1])*scale ;
                velec            -=  qq30*(rinv30 - (scale*ewtab[ewitab+2]-ewtabhalfspace*eweps*(scale*ewtab[ewitab]+felect)));
                felec            -=  qq30*rinv30*( rinvsq30 - scale*felect );
            }
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_W4_VF,outeriter*31 + inneriter*78);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwNone_GeomW4P1_F_c
 * Electrostatics interaction: EwaldG
 * VdW interaction:            None
 * Geometry:                   Water4-Particle
 ...
 */
void
nb_kernel_ElecEwG_VdwNone_GeomW4P1_F_c
                    (t_nblist                    * gmx_restrict       nlist,
                     rvec                        * gmx_restrict          xx,
                     rvec                        * gmx_restrict          ff,
                     t_forcerec                  * gmx_restrict          fr,
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_W4_F,outeriter*30 + inneriter*75);
}
