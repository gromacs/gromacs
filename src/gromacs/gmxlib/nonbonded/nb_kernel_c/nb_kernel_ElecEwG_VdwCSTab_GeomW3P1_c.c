...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwCSTab_GeomW3P1_VF_c
 ...
 */
void
nb_kernel_ElecEwG_VdwCSTab_GeomW3P1_VF_c
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3_VF,outeriter*32 + inneriter*111);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwCSTab_GeomW3P1_F_c
 * Electrostatics interaction: EwaldG
 * VdW interaction:            CubicSplineTable
 * Geometry:                   Water3-Particle
 ...
 */
void
nb_kernel_ElecEwG_VdwCSTab_GeomW3P1_F_c
                    (t_nblist                    * gmx_restrict       nlist,
                     rvec                        * gmx_restrict          xx,
                     rvec                        * gmx_restrict          ff,
                     t_forcerec                  * gmx_restrict          fr,
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3_F,outeriter*30 + inneriter*100);
}
