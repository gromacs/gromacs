...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwBham_GeomP1P1_VF_c
 ...
 */
void
nb_kernel_ElecEwG_VdwBham_GeomP1P1_VF_c
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_VF,outeriter*15 + inneriter*64);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwG_VdwBham_GeomP1P1_F_c
 * Electrostatics interaction: EwaldG
 * VdW interaction:            Buckingham
 * Geometry:                   Particle-Particle
 ...
 */
void
nb_kernel_ElecEwG_VdwBham_GeomP1P1_F_c
                    (t_nblist                    * gmx_restrict       nlist,
                     rvec                        * gmx_restrict          xx,
                     rvec                        * gmx_restrict          ff,
                     t_forcerec                  * gmx_restrict          fr,
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_F,outeriter*13 + inneriter*60);
}
