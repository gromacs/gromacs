                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    _fjsp_v2r8           ewclj,ewclj2,ewclj6,ewcljrsq,poly,exponent,f6A,f6B;
    ...
    ewclj2           = _fjsp_mul_v2r8(ewclj,ewclj);
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        vdwioffset0      = 4*nvdwtype*vdwtype[inr+0];
        ...
        for(jidx=j_index_start; jidx<j_index_end-1; jidx+=2)
        {
            ...
            c6grid_00       = gmx_fjsp_load_2real_swizzle_v2r8(vdwparam+vdwioffset0+vdwjidx0A+2,
                                                                   vdwparam+vdwioffset0+vdwjidx0B+2);
	    ...
	    _fjsp_store_v2r8(&ewconv.simd,itab_tmp);
            ...
            poly             = _fjsp_mul_v2r8(exponent,_fjsp_add_v2r8(_fjsp_add_v2r8(one,ewcljrsq),_fjsp_mul_v2r8(_fjsp_mul_v2r8(ewcljrsq,ewcljrsq),one_half)));
            /* vvdw6 = [C6 - C6grid * (1-poly)]/r6 */
            vvdw6            = _fjsp_mul_v2r8(_fjsp_msub_v2r8(c6_00,_fjsp_mul_v2r8(c6grid_00,_fjsp_msub_v2r8(one,poly))),rinvsix);
            vvdw12           = _fjsp_mul_v2r8(c12_00,_fjsp_mul_v2r8(rinvsix,rinvsix));
            vvdw             = _fjsp_msub_v2r8(_fjsp_mul_v2r8(vvdw12,one_twelfth),_fjsp_mul_v2r8(vvdw6,one_sixth));
            /* fvdw = vvdw12/r - (vvdw6/r + (C6grid * exponent * beta^6)/r) */
            fvdw             = _fjsp_mul_v2r8(_fjsp_msub_v2r8(vvdw12,_fjsp_add_v2r8(vvdw6,_fjsp_mul_v2r8(_fjsp_mul_v2r8(c6grid_00,one_sixth),_fjsp_mul_v2r8(exponent,ewclj6)))),rinvsq00);
        ...
        if(jidx<j_index_end)
        {
            ...
            c6grid_00       = gmx_fjsp_load_1real_swizzle_v2r8(vdwparam+vdwioffset0+vdwjidx0A+2);
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
	    ...
	    _fjsp_store_v2r8(&ewconv.simd,itab_tmp);
            ...
            fvdw              = _fjsp_mul_v2r8(_fjsp_msub_v2r8(_fjsp_mul_v2r8(c12_00,_fjsp_mul_v2r8(rinvsix,rinvsix)),_fjsp_add_v2r8(_fjsp_mul_v2r8(_fjsp_msub_v2r8(c6_00,f6A),rinvsix),f6B)),rinvsq00);
