                     ...
                     t_nrnb                        * gmx_restrict        nrnb)
{
    ...
    invsqrta         = kernel_data->invsqrta;
    dvda             = kernel_data->dvda;
    gbtabscale       = gmx_fjsp_set1_v2r8(kernel_data->gbtabscale);
    gbtab            = kernel_data->gbtabdata;
    gbinvepsdiff     = gmx_fjsp_set1_v2r8((1.0/kernel_data->ic->epsilon_r) - (1.0/kernel_data->gb_epsilon_solvent));
