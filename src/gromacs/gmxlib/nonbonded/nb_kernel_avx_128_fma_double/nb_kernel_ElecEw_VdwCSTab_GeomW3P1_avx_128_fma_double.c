...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEw_VdwCSTab_GeomW3P1_VF_avx_128_fma_double
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEw_VdwCSTab_GeomW3P1_F_avx_128_fma_double
 * Electrostatics interaction: Ewald
 * VdW interaction:            CubicSplineTable
 * Geometry:                   Water3-Particle
