                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end-1; jidx+=2)
        {
            ...
            poly             = _mm_mul_pd(exponent,_mm_macc_pd(_mm_mul_pd(ewcljrsq,ewcljrsq),one_half,_mm_add_pd(one,ewcljrsq)));
            ...
            fvdw             = _mm_mul_pd(_mm_sub_pd(vvdw12,_mm_macc_pd(_mm_mul_pd(c6grid_00,one_sixth),_mm_mul_pd(exponent,ewclj6),vvdw6)),rinvsq00);
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end-1; jidx+=2)
        {
            ...
            fvdw              = _mm_mul_pd(_mm_add_pd(_mm_mul_pd(_mm_nmacc_pd(c6_00,f6A,_mm_mul_pd(c12_00,rinvsix)),rinvsix),f6B),rinvsq00);
