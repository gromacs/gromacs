...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSh_VdwLJSh_GeomP1P1_VF_avx_128_fma_double
 ...
 */
void
nb_kernel_ElecEwSh_VdwLJSh_GeomP1P1_VF_avx_128_fma_double
                     ...
                     t_nrnb                        * gmx_restrict        nrnb)
{
    ...
    sh_vdw_invrcut6  = _mm_set1_pd(kernel_data->ic->sh_invrc6);
    rvdw             = _mm_set1_pd(kernel_data->ic->rvdw);
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSh_VdwLJSh_GeomP1P1_F_avx_128_fma_double
 * Electrostatics interaction: Ewald
 * VdW interaction:            LennardJones
 * Geometry:                   Particle-Particle
