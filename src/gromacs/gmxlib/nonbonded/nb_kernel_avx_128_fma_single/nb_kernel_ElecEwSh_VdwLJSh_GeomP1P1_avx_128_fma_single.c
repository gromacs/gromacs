...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSh_VdwLJSh_GeomP1P1_VF_avx_128_fma_single
 ...
 */
void
nb_kernel_ElecEwSh_VdwLJSh_GeomP1P1_VF_avx_128_fma_single
                     ...
                     t_nrnb                        * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_VF,outeriter*9 + inneriter*52);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSh_VdwLJSh_GeomP1P1_F_avx_128_fma_single
 * Electrostatics interaction: Ewald
 * VdW interaction:            LennardJones
 * Geometry:                   Particle-Particle
 ...
 */
void
nb_kernel_ElecEwSh_VdwLJSh_GeomP1P1_F_avx_128_fma_single
                    (const struct t_nblist         * gmx_restrict       nlist,
                     rvec                          * gmx_restrict          xx,
                     rvec                          * gmx_restrict          ff,
                     const struct nb_kernel_data_t * gmx_restrict kernel_data,
                     t_nrnb                        * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_F,outeriter*7 + inneriter*39);
}
