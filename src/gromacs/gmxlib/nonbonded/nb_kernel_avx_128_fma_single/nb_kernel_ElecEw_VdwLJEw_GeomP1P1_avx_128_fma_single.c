                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
	    ...
	    poly	     = _mm_mul_ps(exponent,_mm_macc_ps(_mm_mul_ps(ewcljrsq,ewcljrsq),one_half,_mm_add_ps(one,ewcljrsq)));
	    ...
	    fvdw	     = _mm_mul_ps(_mm_sub_ps(vvdw12,_mm_macc_ps(_mm_mul_ps(c6grid_00,one_sixth),_mm_mul_ps(exponent,ewclj6),vvdw6)),rinvsq00);
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
	    ...
	    fvdw              = _mm_mul_ps(_mm_add_ps(_mm_mul_ps(_mm_nmacc_ps(c6_00,f6A,_mm_mul_ps(c12_00,rinvsix)),rinvsix),f6B),rinvsq00);
