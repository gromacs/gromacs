                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    __m256d           c6grid_10;
    __m256d           c6grid_20;
    __m256d           ewclj,ewclj2,ewclj6,ewcljrsq,poly,exponent,f6A,f6B;
    ...
    ewclj2           = _mm256_mul_pd(ewclj,ewclj);
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            c6grid_00       = gmx_mm256_load_4real_swizzle_pd(vdwioffsetptr0+vdwjidx0A+2,
            ...
            poly             = _mm256_mul_pd(exponent,_mm256_add_pd(_mm256_add_pd(one,ewcljrsq),_mm256_mul_pd(_mm256_mul_pd(ewcljrsq,ewcljrsq),one_half)));
            ...
            fvdw             = _mm256_mul_pd(_mm256_sub_pd(vvdw12,_mm256_add_pd(vvdw6,_mm256_mul_pd(_mm256_mul_pd(c6grid_00,one_sixth),_mm256_mul_pd(exponent,ewclj6)))),rinvsq00);
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3_VF,outeriter*20 + inneriter*157);
}
/*
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+3]>=0; jidx+=4)
        {
            ...
            fvdw              = _mm256_mul_pd(_mm256_sub_pd(_mm256_mul_pd(c12_00,_mm256_mul_pd(rinvsix,rinvsix)),_mm256_add_pd(_mm256_mul_pd(_mm256_sub_pd(c6_00,f6A),rinvsix),f6B)),rinvsq00);
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W3_F,outeriter*18 + inneriter*138);
}
