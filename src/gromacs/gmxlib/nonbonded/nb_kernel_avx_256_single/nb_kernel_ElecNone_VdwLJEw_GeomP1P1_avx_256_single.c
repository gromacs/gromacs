                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    __m256           c6grid_00;
    __m256           ewclj,ewclj2,ewclj6,ewcljrsq,poly,exponent,f6A,f6B;
    ...
    ewclj2           = _mm256_mul_ps(ewclj,ewclj);
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        vdwioffsetptr0   = vdwparam+4*nvdwtype*vdwtype[inr+0];
        ...
        for(jidx=j_index_start; jidx<j_index_end && jjnr[jidx+7]>=0; jidx+=8)
        {
            ...
            vdwjidx0A        = 4*vdwtype[jnrA+0];
            vdwjidx0B        = 4*vdwtype[jnrB+0];
            vdwjidx0C        = 4*vdwtype[jnrC+0];
            vdwjidx0D        = 4*vdwtype[jnrD+0];
            vdwjidx0E        = 4*vdwtype[jnrE+0];
            vdwjidx0F        = 4*vdwtype[jnrF+0];
            vdwjidx0G        = 4*vdwtype[jnrG+0];
            vdwjidx0H        = 4*vdwtype[jnrH+0];
            ...
            c6grid_00       = gmx_mm256_load_8real_swizzle_ps(vdwioffsetptr0+vdwjidx0A+2,
                                                                  vdwioffsetptr0+vdwjidx0B+2,
                                                                  vdwioffsetptr0+vdwjidx0C+2,
                                                                  vdwioffsetptr0+vdwjidx0D+2,
                                                                  vdwioffsetptr0+vdwjidx0E+2,
                                                                  vdwioffsetptr0+vdwjidx0F+2,
                                                                  vdwioffsetptr0+vdwjidx0G+2,
                                                                  vdwioffsetptr0+vdwjidx0H+2);
            ...
            poly             = _mm256_mul_ps(exponent,_mm256_add_ps(_mm256_add_ps(one,ewcljrsq),_mm256_mul_ps(_mm256_mul_ps(ewcljrsq,ewcljrsq),one_half)));
            ...
            fvdw             = _mm256_mul_ps(_mm256_sub_ps(vvdw12,_mm256_add_ps(vvdw6,_mm256_mul_ps(_mm256_mul_ps(c6grid_00,one_sixth),_mm256_mul_ps(exponent,ewclj6)))),rinvsq00);
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
	    ...
	    fvdw	      = _mm256_mul_ps(_mm256_sub_ps(_mm256_mul_ps(_mm256_sub_ps(_mm256_mul_ps(c12_00,rinvsix),_mm256_sub_ps(c6_00,f6A)),rinvsix),f6B),rinvsq00);
