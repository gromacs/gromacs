                      ...
                      t_nrnb *                  nrnb)
{
    ...
    /* 4 VdW parameters for LJ-PME, 3 for Buckingham, otherwise 2 */
    nvdwparam           = (ivdw == GMX_NBKERNEL_VDW_LJEWALD) ? 4 : ((ivdw == GMX_NBKERNEL_VDW_BUCKINGHAM) ? 3 : 2);
    table_nelements     = 12;
