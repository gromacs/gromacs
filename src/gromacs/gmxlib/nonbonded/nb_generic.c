...
void
gmx_nb_generic_kernel(const struct t_nblist *        nlist,
                      rvec       *                   xx,
                      rvec       *                   ff,
                      ...
                      t_nrnb       *                 nrnb)
{
    ...
    if (bExactCutoff)
    {
        rcutoff  = ( kernel_data->ic->rcoulomb > kernel_data->ic->rvdw ) ? kernel_data->ic->rcoulomb : kernel_data->ic->rvdw;
