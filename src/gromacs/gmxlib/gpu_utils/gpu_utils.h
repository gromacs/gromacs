 ...
 */
CUDA_FUNC_QUALIFIER
int get_cuda_gpu_device_id(const struct gmx_gpu_info_t *CUDA_FUNC_ARGUMENT(gpu_info),
                           const gmx_gpu_opt_t *CUDA_FUNC_ARGUMENT(gpu_opt),
                           int CUDA_FUNC_ARGUMENT(index)) CUDA_FUNC_TERM_WITH_RETURN(-1)
