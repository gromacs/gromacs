...
/* What type of SIMD instructions were compiled in, if any?
...
static const
enum gmx_cpuid_simd compiled_simd = GMX_CPUID_SIMD_X86_AVX2_256;
#elif defined GMX_SIMD_X86_AVX_256
static const
enum gmx_cpuid_simd compiled_simd = GMX_CPUID_SIMD_X86_AVX_256;
#elif defined GMX_SIMD_X86_AVX_128_FMA
static const
enum gmx_cpuid_simd compiled_simd = GMX_CPUID_SIMD_X86_AVX_128_FMA;
#elif defined GMX_SIMD_X86_SSE4_1
static const
enum gmx_cpuid_simd compiled_simd = GMX_CPUID_SIMD_X86_SSE4_1;
#elif defined GMX_SIMD_X86_SSE2
static const
enum gmx_cpuid_simd compiled_simd = GMX_CPUID_SIMD_X86_SSE2;
#elif defined GMX_SIMD_SPARC64_HPC_ACE
static const
enum gmx_cpuid_simd compiled_simd = GMX_CPUID_SIMD_SPARC64_HPC_ACE;
#elif defined GMX_SIMD_IBM_QPX
static const
enum gmx_cpuid_simd compiled_simd = GMX_CPUID_SIMD_IBM_QPX;
#else
static const
enum gmx_cpuid_simd compiled_simd = GMX_CPUID_SIMD_NONE;
#endif
                 ...
                 unsigned int * edx)
{
    ...
    *edx = 0;
     ...
     *
     * This is REALLY bad, since we will lose all Gromacs SIMD instructions.
     */
    *eax = 0;
    *ebx = 0;
    *ecx = 0;
                     ...
                     int           print_to_stderr)
{
    ...
    {
        fprintf(log,
                "\nDetecting CPU-specific SIMD instructions.\nPresent hardware specification:\n"
                "%s"
