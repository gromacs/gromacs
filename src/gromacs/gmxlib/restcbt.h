...
* Given a bending angle O_i, an equilibrum angle O_0, three particles
* with positions Xj, Xi, Xk and bending constant k_b the following factors
* are computed:
*
* - prefactor = 1/sqrt((Xj-Xi)(Xj-Xi)(Xk-Xj)(Xk-Xj))
*               k_b/ sin^4(O_i) (cos(O_i) - cos(O_0)(1-cos(O_i)cos(O_0)
* - ratio_ante = ((Xj-Xi)(Xk-Xj))/((Xj-Xi)(Xj-Xi))
* - ratio_post = ((Xj-Xi)(Xk-Xj))/((Xk-Xj)(Xk-Xj))
*
*  The factor ¨prefactor¨ is the common term that comes in front of
*  each force, while ¨ratio_ante¨ and ¨ratio_post¨ are used in the
*  formula of each force differentely
*/
