...
enum
{
    ...
    eNR_NBNXM_EWALD,
    eNR_NBNXM_EWALD_E,
    eNR_NBNXM_ADD_LJ_FSW,
    eNR_NBNXM_ADD_LJ_FSW_E,
    eNR_NBNXM_ADD_LJ_PSW,
    eNR_NBNXM_ADD_LJ_PSW_E,
    eNR_NBNXM_ADD_LJ_EWALD,
    eNR_NBNXM_ADD_LJ_EWALD_E,
    eNR_NB14,
    eNR_WEIGHTS,
    eNR_SPREAD,
    eNR_SPREADBSP,
