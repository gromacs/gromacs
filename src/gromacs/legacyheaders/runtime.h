...
gmx_runtime_t runtime_init();

void runtime_destroy(gmx_runtime_t runtime);

void runtime_start(gmx_runtime_t runtime);

void runtime_end(gmx_runtime_t runtime);

double runtime_get_current_elapsed_run_time(gmx_runtime_t runtime);

double runtime_get_elapsed_run_time(gmx_runtime_t runtime);

double runtime_get_elapsed_run_time_per_thread(gmx_runtime_t runtime);
