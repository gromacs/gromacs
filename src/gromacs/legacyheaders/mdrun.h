...
int mdrunner(gmx_hw_opt_t *hw_opt,
             ...
             gmx_bool bCompact, const char *tng_compr, int nstglobalcomm, ivec ddxyz,
             int dd_node_order, real rdd, real rconstr, const char *dddlb_opt,
             real dlb_scale, const char *ddcsx, const char *ddcsy, const char *ddcsz,
             const char *nbpu_opt,
