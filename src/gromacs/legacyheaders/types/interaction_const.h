...
typedef struct
{
    ...
    /* Verlet cut-off scheme table types */
    real *tabVerlet_nbtab_F;
    real *tabVerlet_nbtab_V;

    real *tabVerlet_vdw_LJ6_F;
    real *tabVerlet_vdw_LJ6_V;

    real *tabVerlet_vdw_LJ12_F;
    real *tabVerlet_vdw_LJ12_V;

    real *tabVerlet_coul_F;
    real *tabVerlet_coul_V;
