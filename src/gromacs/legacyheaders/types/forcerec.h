...
typedef struct t_forcerec {
    ...
    int          gmx_no_table_coeffs; /* This variable is used as a boolean and is
                                       * evaluated either as ==0 or !=0 depending
                                       * whether the GMX_NO_TABLE_COEFFS is set or not.
                                       * This will be removed in the future and an additional
                                       * vdw-type will be defined specifically for generic
                                       * tabulated interactions. */
    const char*  nocoeffsPLEASE;      /* It is filled with the content of
                                       * GMX_NO_TABLE_COEFFS environment variable.
                                       * Avoid scale factors and other coefficients.
