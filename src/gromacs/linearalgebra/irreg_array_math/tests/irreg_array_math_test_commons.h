...
#ifndef GMX_MATH_TESTS_IRREG_ARRAY_MATH_TESTS_COMMONS_H
#define GMX_MATH_TESTS_IRREG_ARRAY_MATH_TESTS_COMMONS_H
...
#include "gromacs/linearalgebra/irreg_array_math.h"
