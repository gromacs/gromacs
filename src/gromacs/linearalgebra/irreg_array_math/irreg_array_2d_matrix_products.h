 ...
 */
#ifndef GMX_LINEARALGEBRA_IRREG_ARRAY_MATH_IRREG_ARRAY_2D_MATRIX_PRODUCTS_H
#define GMX_LINEARALGEBRA_IRREG_ARRAY_MATH_IRREG_ARRAY_2D_MATRIX_PRODUCTS_H
#include <numeric>
#include <type_traits>
 ...
 */
template<typename T, class Alloc = std::allocator<T> >
inline void matrixMatrixMatrixTProduct(const IrregArray2D<T, Alloc> &a, const IrregArray2D<T, Alloc> &b, IrregArray2D<T, Alloc> &c)
{
#if GMX_SIMD
