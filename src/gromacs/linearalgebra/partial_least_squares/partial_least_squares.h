...
// TODO(update comments, look at random generator)
...
{
    /** \internal \brief The type to represent the size of matrices and vectors */
    ...
    /** \internal \brief The type to represent the index to iterate on matrices and vectors */
    ...
    {
        //! \internal \brief the matrix to cover
        const MatrixType &matrix;
        //! \internal \brief the column index to access
        ...
        public:
            ...
            /** \internal \brief returns the valus at position
    ...
    public:
        /**
         * \internal @brief pls_denham computes the pls regression
         *
