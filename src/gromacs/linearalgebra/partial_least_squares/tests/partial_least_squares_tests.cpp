...
TEST(PartialLeastSquaresTest, SimpleTest){
    ...
    Pls1dArray              y(n, 0);
    Pls2dArray              X(index_type(0), index_type(n-1), index_type(0), index_type(p-1));

    Pls2dArray              W(index_type(0), index_type(p-1), index_type(0), index_type(k-1));
    Pls1dArray              q(k);
...
TEST(PartialLeastSquaresTest, ComparePrevious){
    // In this test we simply compare the current obtained results
    // to some previous results (validated with matlab too).
...
TEST(PartialLeastSquaresTest, ParametersFailureTest){
    // In this test we ensure that the function throw when invalid
    ...
    }
    {
        ...
        const index_type                               k = 4;
        Pls1dArray              y(n, 0);
        Pls2dArray              X(index_type(0), index_type(n), index_type(0), index_type(p-1));
