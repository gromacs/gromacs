...
static void F77_FUNC(dstqrb, DSTQRB)(int *n,
                                     double *d__,
                                     double *e,
                                     double *z__,
                                     double *work,
...
L30:
    ...
    if (anorm > ssfmax)
    {
        ...
        ("g", &c__0, &c__0, &anorm, &ssfmax, &i__1, &c__1, &d__[l], n,
         info);
        i__1 = lend - l;
        F77_FUNC(dlascl, DLASCL)
        ("g", &c__0, &c__0, &anorm, &ssfmax, &i__1, &c__1, &e[l], n,
         info);
    }
    else if (anorm < ssfmin)
    {
        ...
        i__1   = lend - l + 1;
        F77_FUNC(dlascl, DLASCL)
        ("g", &c__0, &c__0, &anorm, &ssfmin, &i__1, &c__1, &d__[l], n,
         info);
        i__1 = lend - l;
        F77_FUNC(dlascl, DLASCL)
        ("g", &c__0, &c__0, &anorm, &ssfmin, &i__1, &c__1, &e[l], n,
         info);
    }
    ...
    L60:
        ...
        if (m == l + 1)
        {
            if (icompz > 0)
            {
                F77_FUNC(dlaev2, DLAEV2)
                (&d__[l], &e[l], &d__[l + 1], &rt1, &rt2, &c__, &s);
                work[l]          = c__;
                work[*n - 1 + l] = s;
            ...
            {
                F77_FUNC(dlae2, DLAE2)
                (&d__[l], &e[l], &d__[l + 1], &rt1, &rt2);
            }
            d__[l]     = rt1;
            d__[l + 1] = rt2;
            e[l]       = 0.;
    ...
    L110:
        ...
        if (m == l - 1)
        {
            ...
            {
                F77_FUNC(dlaev2, DLAEV2)
                (&d__[l - 1], &e[l - 1], &d__[l], &rt1, &rt2, &c__, &s);
...
L140:
    if (iscale == 1)
    {
        i__1 = lendsv - lsv + 1;
        F77_FUNC(dlascl, DLASCL)
        ("g", &c__0, &c__0, &ssfmax, &anorm, &i__1, &c__1, &d__[lsv],
         n, info);
        i__1 = lendsv - lsv;
        F77_FUNC(dlascl, DLASCL)
        ("g", &c__0, &c__0, &ssfmax, &anorm, &i__1, &c__1, &e[lsv], n,
         info);
    }
    else if (iscale == 2)
    {
        i__1 = lendsv - lsv + 1;
        F77_FUNC(dlascl, DLASCL)
        ("g", &c__0, &c__0, &ssfmin, &anorm, &i__1, &c__1, &d__[lsv],
         n, info);
        i__1 = lendsv - lsv;
        F77_FUNC(dlascl, DLASCL)
        ("g", &c__0, &c__0, &ssfmin, &anorm, &i__1, &c__1, &e[lsv], n,
         info);
    }
                                     ...
                                     int *           ierr)
{
    ...
    if (*ido == 0)
    {
        ...
        *ierr    = 0;
        ...
        {
            idist = 2;
            F77_FUNC(dlarnv, DLARNV)
            (&idist, &iwork[1], n, &resid[1]);
        }
...
L30:
    ...
    ("T", n, &i__1, &c_b22, &v[v_offset], ldv, &workd[1], &c__1, &c_b24,
     &workd[*n + 1], &c__1);
    i__1 = *j - 1;
    F77_FUNC(dgemv, DGEMV)
                                     ...
                                     double *workd)
{
    ...
    F77_FUNC(dlaset, DLASET)
    ("All", &kplusp, &kplusp, &c_b4, &c_b5, &q[q_offset], ldq);
    ...
    L40:
        ...
        if (h__[iend + h_dim1] < 0.)
        {
            ...
            F77_FUNC(dscal, DSCAL)
            (&kplusp, &c_b14, &q[iend * q_dim1 + 1], &c__1);
        }
    ...
    {
        F77_FUNC(dgemv, DGEMV)
        ("N", n, &kplusp, &c_b5, &v[v_offset], ldv, &q[(*kev + 1)
                                                               * q_dim1
                                                       + 1],
         &c__1, &c_b4, &workd[*n + 1], &c__1);
    }
    ...
    for (i__ = 1; i__ <= i__1; ++i__)
    {
        i__2 = kplusp - i__ + 1;
        F77_FUNC(dgemv, DGEMV)
        ("N", n, &i__2, &c_b5, &v[v_offset], ldv, &q[(*kev - i__ + 1)
                                                             * q_dim1
                                                     + 1],
         &c__1, &c_b4, &workd[1], &c__1);
        F77_FUNC(dcopy, DCOPY)
        (n, &workd[1], &c__1, &v[(kplusp - i__ + 1) * v_dim1 + 1], &c__1);
    }

    F77_FUNC(dlacpy, DLACPY)
    ("All", n, kev, &v[(*np + 1) * v_dim1 + 1], ldv, &v[v_offset], ldv);

    if (h__[*kev + 1 + h_dim1] > 0.)
    {
        F77_FUNC(dcopy, DCOPY)
        (n, &workd[*n + 1], &c__1, &v[(*kev + 1) * v_dim1 + 1], &c__1);
    }

    F77_FUNC(dscal, DSCAL)
    (n, &q[kplusp + *kev * q_dim1], &resid[1], &c__1);
    if (h__[*kev + 1 + h_dim1] > 0.)
    {
        F77_FUNC(daxpy, DAXPY)
        (n, &h__[*kev + 1 + h_dim1], &v[(*kev + 1) * v_dim1 + 1], &c__1,
         &resid[1], &c__1);
    }
...
static void F77_FUNC(dsortr, DSORTR)(const char *which,
                                     int *   apply,
                                     int *   n,
                                     double *x1,
                                     double *x2)
...
static void F77_FUNC(dsesrt, DSESRT)(const char *which,
                                     int *   apply,
                                     int *   n,
                                     double *x,
                                     int *   na,
...
static void F77_FUNC(dsgets, DSGETS)(int *ishift,
                                     const char *which,
                                     int *       kev,
                                     int *       np,
                                     double *    ritz,
                                     ...
                                     double *    shifts)
{
    ...
    {
        i__1 = *kev + *np;
        F77_FUNC(dsortr, DSORTR)
        ("LA", &c__1, &i__1, &ritz[1], &bounds[1]);
        kevd2 = *kev / 2;
        if (*kev > 1)
        {
    ...
    else
    {
        i__1 = *kev + *np;
        F77_FUNC(dsortr, DSORTR)
        (which, &c__1, &i__1, &ritz[1], &bounds[1]);
    }
    ...
    if (*ishift == 1 && *np > 0)
    {
        ...
        F77_FUNC(dsortr, DSORTR)
        ("SM", &c__1, np, &bounds[1], &ritz[1]);
        F77_FUNC(dcopy, DCOPY)
        (np, &ritz[1], &c__1, &shifts[1], &c__1);
    }
...
static void F77_FUNC(dsconv, DSCONV)(int *n,
                                     double *ritz,
                                     double *bounds,
                                     double *tol,
                                     int *   nconv)
                                     ...
                                     int *   ierr)
{
    ...
    F77_FUNC(dcopy, DCOPY)
    (n, &h__[(h_dim1 << 1) + 1], &c__1, &eig[1], &c__1);
    i__1 = *n - 1;
    F77_FUNC(dcopy, DCOPY)
    (&i__1, &h__[h_dim1 + 2], &c__1, &workl[1], &c__1);
    F77_FUNC(dstqrb, DSTQRB)
    (n, &eig[1], &workl[1], &bounds[1], &workl[*n + 1], ierr);
    if (*ierr != 0)
    {
        goto L9000;
    }
...
L30:
    ...
    (ido, bmat, &iwork[11], &c__0, n, &iwork[12], &v[v_offset], ldv,
...
L40:
    ...
    F77_FUNC(dcopy, DCOPY)
    (n, &resid[1], &c__1, &v[iwork[12] * v_dim1 + 1], &c__1);
    if (*rnorm >= safmin)
    {
        temp1 = 1. / *rnorm;
        F77_FUNC(dscal, DSCAL)
        (n, &temp1, &v[iwork[12] * v_dim1 + 1], &c__1);
        F77_FUNC(dscal, DSCAL)
        (n, &temp1, &workd[iwork[8]], &c__1);
    }
    else
    {

        F77_FUNC(dlascl, DLASCL)
        ("General", &i__, &i__, rnorm, &c_b18, n, &c__1, &v[iwork[12]
                                                                    * v_dim1
                                                            + 1],
         n, &infol);
        F77_FUNC(dlascl, DLASCL)
    ...
    iwork[5] = 1;
    F77_FUNC(dcopy, DCOPY)
    (n, &v[iwork[12] * v_dim1 + 1], &c__1, &workd[iwork[10]], &c__1);
    ipntr[1] = iwork[10];
    ipntr[2] = iwork[9];
    ipntr[3] = iwork[8];
    *ido     = 1;
...
L50:
    ...
    F77_FUNC(dcopy, DCOPY)
    (n, &workd[iwork[9]], &c__1, &resid[1], &c__1);
    ...
    {
        F77_FUNC(dcopy, DCOPY)
        (n, &resid[1], &c__1, &workd[iwork[8]], &c__1);
    }
L60:
...
L65:
    ...
    {
        F77_FUNC(dgemv, DGEMV)
        ("T", n, &iwork[12], &c_b18, &v[v_offset], ldv, &workd[iwork[8]],
    ...
    {
        F77_FUNC(dcopy, DCOPY)
        (n, &resid[1], &c__1, &workd[iwork[9]], &c__1);
        ipntr[1] = iwork[9];
        ipntr[2] = iwork[8];
        *ido     = 2;
...
L100:
    ...
    if (h__[iwork[12] + h_dim1] < 0.)
    {
        ...
        {
            F77_FUNC(dscal, DSCAL)
            (n, &c_b50, &v[(iwork[12] + 1) * v_dim1 + 1], &c__1);
        }
        else
        {
            F77_FUNC(dscal, DSCAL)
            (n, &c_b50, &resid[1], &c__1);
        }
    }
                                     ...
                                     int *           info)
{
    ...
    {
        F77_FUNC(dgetv0, DGETV0)
        (ido, bmat, &c__1, &iwork[3], n, &c__1, &v[v_offset], ldv, &resid[1], &workd[*n * 3 + 1], &ipntr[1], &workd[1], &iwork[41],
         info);
    ...
    (ido, bmat, n, &c__0, &iwork[9], mode, &resid[1], &workd[*n * 3
                                                             + 1],
...
L20:
    ...
    F77_FUNC(dsaitr, DSAITR)
    (ido, bmat, n, nev, np, mode, &resid[1], &workd[*n * 3 + 1],
     &v[v_offset], ldv, &h__[h_offset], ldh, &ipntr[1], &workd[1],
     &iwork[21], info);
    ...
    F77_FUNC(dcopy, DCOPY)
    (&iwork[7], &ritz[1], &c__1, &workl[iwork[7] + 1], &c__1);
    F77_FUNC(dcopy, DCOPY)
    (&iwork[7], &bounds[1], &c__1, &workl[(iwork[7] << 1) + 1], &c__1);

    *nev = iwork[9];
    *np  = iwork[10];
    F77_FUNC(dsgets, DSGETS)
    (ishift, which, nev, np, &ritz[1], &bounds[1], &workl[1]);

    F77_FUNC(dcopy, DCOPY)
    (nev, &bounds[*np + 1], &c__1, &workl[*np + 1], &c__1);
    F77_FUNC(dsconv, DSCONV)
    (nev, &ritz[*np + 1], &workl[*np + 1], tol, &iwork[8]);
    ...
    if (iwork[8] >= iwork[9] || iwork[6] > *mxiter || *np == 0)
    {
        ...
        if (!std::strncmp(which, "BE", 2))
        {
            ...
            F77_FUNC(dsortr, DSORTR)
            (wprime, &c__1, &iwork[7], &ritz[1], &bounds[1]);
            nevd2 = *nev / 2;
            nevm2 = *nev - nevd2;
            if (*nev > 1)
            {
        ...
        std::strncpy(wprime, "LA", 2);
        F77_FUNC(dsortr, DSORTR)
        (wprime, &c__1, &iwork[9], &bounds[1], &ritz[1]);
        ...
        if (!std::strncmp(which, "BE", 2))
        {
            ...
            std::strncpy(wprime, "LA", 2);
            F77_FUNC(dsortr, DSORTR)
            (wprime, &c__1, &iwork[8], &ritz[1], &bounds[1]);
        }
        else
        {
            F77_FUNC(dsortr, DSORTR)
            (which, &c__1, &iwork[8], &ritz[1], &bounds[1]);
        }
                              ...
                              int *       info)
{
    ...
    (ido, bmat, n, which, &iwork[13], &iwork[15], tol, &resid[1], &iwork[11], &iwork[6], &iwork[5], &iwork[10], &v[v_offset], ldv, &workl[iwork[3]], &iwork[8], &workl[iwork[16]], &workl[iwork[1]], &workl[iwork[4]], &iwork[9], &workl[iwork[7]], &ipntr[1], &workd[1],
     &iwork[21], info);
                              ...
                              int *       info)
{
    ...
    *info = 0;
    ...
    if (*rvec)
    {
        ...
        i__1 = *ncv - 1;
        F77_FUNC(dcopy, DCOPY)
        (&i__1, &workl[ih + 1], &c__1, &workl[ihb], &c__1);
        F77_FUNC(dcopy, DCOPY)
        (ncv, &workl[ih + ldh], &c__1, &workl[ihd], &c__1);
        ...
        F77_FUNC(dcopy, DCOPY)
        (&nconv, &workl[ihd], &c__1, &d__[1], &c__1);
    }
    else
    {

        F77_FUNC(dcopy, DCOPY)
        (&nconv, &workl[ritz], &c__1, &d__[1], &c__1);
        F77_FUNC(dcopy, DCOPY)
        (ncv, &workl[ritz], &c__1, &workl[ihd], &c__1);
    }
    if (!std::strncmp(type__, "REGULR", 6))
    {
        ...
        if (*rvec)
        {
            F77_FUNC(dsesrt, DSESRT)
            ("LA", rvec, &nconv, &d__[1], ncv, &workl[iq], &ldq);
        }
        else
        {
            F77_FUNC(dcopy, DCOPY)
            (ncv, &workl[bounds], &c__1, &workl[ihb], &c__1);
        }
    }
    else
    {
        ...
        F77_FUNC(dcopy, DCOPY)
        (ncv, &workl[ihd], &c__1, &workl[iw], &c__1);
        ...
        (&nconv, &workl[ihd], &c__1, &d__[1], &c__1);
        F77_FUNC(dsortr, DSORTR)
        ("LA", &c__1, &nconv, &workl[ihd], &workl[iw]);
        if (*rvec)
        {
            F77_FUNC(dsesrt, DSESRT)
            ("LA", rvec, &nconv, &d__[1], ncv, &workl[iq], &ldq);
        ...
        else
        {
            ...
            d__1 = bnorm2 / rnorm;
            F77_FUNC(dscal, DSCAL)
            (ncv, &d__1, &workl[ihb], &c__1);
            F77_FUNC(dsortr, DSORTR)
            ("LA", &c__1, &nconv, &d__[1], &workl[ihb]);
        }
    }
    ...
    if (*rvec && *howmny == 'A')
    {
        ...
        (ncv, &nconv, &workl[iq], &ldq, &workl[iw + *ncv], &workl[ihb],
         &ierr);

        F77_FUNC(dorm2r, DORM2R)
        ("Right", "Notranspose", n, ncv, &nconv, &workl[iq], &ldq, &workl[iw + *ncv], &v[v_offset], ldv, &workd[*n + 1], &ierr);
        F77_FUNC(dlacpy, DLACPY)
        ("All", n, &nconv, &v[v_offset], ldv, &z__[z_offset], ldz);
...
static void F77_FUNC(sstqrb, SSTQRB)(int *n,
                                     float *d__,
                                     float *e,
                                     float *z__,
                                     float *work,
...
static void F77_FUNC(ssortr, SSORTR)(const char *which,
                                     int *  apply,
                                     int *  n,
                                     float *x1,
                                     float *x2)
...
static void F77_FUNC(ssesrt, SSESRT)(const char *which,
                                     int *  apply,
                                     int *  n,
                                     float *x,
                                     int *  na,
...
static void F77_FUNC(ssgets, SSGETS)(int *ishift,
                                     const char *which,
                                     int *       kev,
                                     int *       np,
                                     float *     ritz,
...
static void F77_FUNC(ssconv, SSCONV)(int *n,
                                     float *ritz,
                                     float *bounds,
                                     float *tol,
                                     int *  nconv)
...
static void F77_FUNC(sseigt, SSEIGT)(float *rnorm,
                                     int *  n,
                                     float *h__,
                                     int *  ldh,
                                     float *eig,
...
L20:
    ...
    F77_FUNC(ssaitr, SSAITR)
    (ido, bmat, n, nev, np, mode, &resid[1], &workd[*n * 3 + 1], &v[v_offset], ldv, &h__[h_offset], ldh, &ipntr[1], &workd[1], &iwork[21], info);
    ...
    *nev = iwork[9];
    *np  = iwork[10];
    F77_FUNC(ssgets, SSGETS)
    (ishift, which, nev, np, &ritz[1], &bounds[1], &workl[1]);

    F77_FUNC(scopy, SCOPY)
    (nev, &bounds[*np + 1], &c__1, &workl[*np + 1], &c__1);
    F77_FUNC(ssconv, SSCONV)
    (nev, &ritz[*np + 1], &workl[*np + 1], tol, &iwork[8]);
