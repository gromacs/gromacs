...
typedef struct gmx_gpu_opt_t
{
    ...
    int       dev_use_count;      /* count of this rank's GPU tasks for accessing gpu_opt->dev_use */
    int       dev_use_count_node; /* total intranode count of GPU tasks used - sum of dev_use_count */
