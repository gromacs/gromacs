                                      ...
                                      const GpuTaskManager &gpuTasks)
{
    ...
    const bool rankUsesAnyGpus  = gpuTasks.gpuInfo(GpuTask::NB) || gpuTasks.gpuInfo(GpuTask::PME);   //TODO hide this
    int        gpuRankIndicator = rankUsesAnyGpus ? 1 : 0;
    int        gpuRankCount     = 0;
