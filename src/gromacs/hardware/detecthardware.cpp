...
//! Constant used to help minimize preprocessed code
static const bool isX86 = GMX_TARGET_X86;
...
/*! \brief Warn the user if the OpenMP system doesn't agree with the hardware detection about the number of logical processors.
 *
