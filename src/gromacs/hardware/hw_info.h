...
/*! \brief Threading and GPU options, can be set automatically or by the user
 *
 * \todo These are over-written by mdrun while resolving defaults
 * automatically, which creates problems. Find a way to improve this.
 */
struct gmx_hw_opt_t
{
