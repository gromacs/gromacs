...
class HardwareTopology
{
    public:
        ...
        /*! \brief Information about a single hardware thread in a core */
        struct HWThread
        {
            int                    logicalProcessorId; //!< Id of the operating system logical processor
        };

        /*! \brief Information about a single core in a socket */
        struct Core
        {
            std::vector<HWThread>  hwThreads;       //!< All the hardware threads in this core
        };

        /*! \brief Information about a single core in the system */
        struct Socket
        {
            std::vector<Core>      cores;          //!< All the cores in this socket
        };

        /*! \brief Information about socket, core and hwthread for a logical processor */
        ...
        /*! \brief Hardware topology information about the entire machine
         *
