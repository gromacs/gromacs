...
/*! \libinternal \brief Detect CPU capabilities and basic hardware topology
 *
 *  This class provides a lot of information about x86 CPUs, and some very
 *  limited information about other hardware. The topology information is
...
class CpuInfo
{
    ...
    public:
        ...
        /*! \brief Entry with basic information for a single logical processor */
    ...
    public:
        ...
        /*! \brief Construct the CpuInfo class and perform the actual detection.
         *
         *  \note The detection is deliberately performed again for every object
         *        that is constructed. This might seem like overkill, but there
         ...
         *
         *  Only a few systems (x86) provide hardware topology information in cpuinfo.
