...
CubicBondType::CubicBondType(BondName bondName, ForceConstant quadraticForceConstant, ForceConstant cubicForceConstant, EquilDistance equilDistance) :
    bondName_(bondName), quadraticForceConstant_(quadraticForceConstant), cubicForceConstant_(cubicForceConstant), equilDistance_(equilDistance)
{}
...
MorseBondType::MorseBondType(BondName bondName, ForceConstant forceConstant, Exponent exponent, EquilDistance equilDistance) :
