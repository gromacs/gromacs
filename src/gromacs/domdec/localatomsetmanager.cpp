...
{
    public:
        std::vector < internal::LocalAtomSetData> atomSetData_; /**< handles to the managed atom sets */
};
...
{
    impl_->atomSetData_.push_back(internal::LocalAtomSetData(globalAtomIndex));
...
{
    for (auto &atomSet : impl_->atomSetData_)
    {
