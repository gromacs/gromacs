...
class LocalAtomSet
{
    ...
    private:
        ...
        /*! \brief Private constructor so Only LocalAtomSetManager may construct group indexs. */
        LocalAtomSet();

        /*! \brief Initialize an group index with an index group.
         *
         * If init is called within a parallel simulation, initialization
         * shall be finished during domain decomposition.
         *
