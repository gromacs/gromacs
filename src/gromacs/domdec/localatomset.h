...
class LocalAtomSet
{
    ...
    private:
        ...
        {}
        /*! \brief Forbid construction from temporaries.
         *
         * rvalue binding will cause undefined behaviour due to LocalAtomSetData
         * being stored as const ref.
         *
         * \param[in] data The data for the atom set is stored
         * in LocalAtomSetData, which is manged by \ref gmx::LocalAtomSetManager.
         */
        LocalAtomSet(const internal::LocalAtomSetData &&data) = delete;
