                           ...
                           real *r_2b, real *r_mb)
{
    ...
    *r_mb     = 0;
    ...
    for (mb = 0; mb < mtop->nmolblock; mb++)
    {
        ...
        else
        {
            ...
            for (mol = 0; mol < molb->nmol; mol++)
            {
                ...
                int  ft_mol_2b, a_mol_2b_1 = -1, a_mol_2b_2 = -1;
                int  ft_mol_mb, a_mol_mb_1 = -1, a_mol_mb_2 = -1;
    ...
    if (mtop->bIntermolecularInteractions)
    {
        ...
        int  ft_im_2b, a_im_2b_1 = -1, a_im_2b_2 = -1;
        int  ft_im_mb, a_im_mb_1 = -1, a_im_mb_2 = -1;
