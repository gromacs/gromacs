...
void dd_move_x(struct gmx_domdec_t *dd, matrix box, rvec x[], gmx_wallcycle_t wcycle);
 ...
 */
void dd_move_f(struct gmx_domdec_t *dd, rvec f[], rvec *fshift, gmx_wallcycle_t wcycle);
