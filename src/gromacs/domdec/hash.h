...
static void gmx_hash_clear(gmx_hash *hash)
{
    int i;
...
static void gmx_hash_realloc(gmx_hash *hash, int nkey_used_estimate)
{
    /* Memory requirements:
 ...
 */
static void gmx_hash_clear_and_optimize(gmx_hash *hash)
{
...
static gmx_hash *gmx_hash_init(int nkey_used_estimate)
{
    gmx_hash *hash;
...
static void gmx_hash_set(gmx_hash *hash, int key, int value)
{
    int ind, ind_prev, i;
...
static void gmx_hash_del(gmx_hash *hash, int key)
{
    int ind, ind_prev;
...
static void gmx_hash_change_value(gmx_hash *hash, int key, int value)
{
    int ind;
...
static void gmx_hash_change_or_set(gmx_hash *hash, int key, int value)
{
    int ind;
...
static gmx_bool gmx_hash_get(const gmx_hash *hash, int key, int *value)
{
    int ind;
...
static int gmx_hash_get_minone(const gmx_hash *hash, int key)
{
    int ind;
