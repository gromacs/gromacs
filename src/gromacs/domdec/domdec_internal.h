...
{
    private:
        gmx::ArrayRef<T> ensureSize(size_t numElements)
        {
...
class DDBufferAccess
{
    public:
        ...
        void ensureSize(size_t numElements)
        {
            buffer = ddBuffer_.ensureSize(numElements);
        }

    private:
        DDBuffer<T>      &ddBuffer_;
    public:
        gmx::ArrayRef<T>  buffer;
};
