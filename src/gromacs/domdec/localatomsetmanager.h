...
class LocalAtomSetManager
{
    public:
         ...
         */
        typedef std::shared_ptr<LocalAtomSet> LocalAtomSetHandle;
         ...
         */
        LocalAtomSetHandle add(const int number_of_atoms, const int *index);

        /*! \brief Erase and destroy all atom sets that only the manager references.
         *
         * Atoms will still be part of the simulation though their indices will no longer be managed as atom set.
         */
        void clean();
