...
#include "gromacs/domdec/ga2la_hashed.h"
...
class gmx_ga2la_t
{
    public:
        ...
        ~gmx_ga2la_t()
        {
            usingDirect_ ? data_.direct.~vector() : data_.hashed.~Ga2laHashed();
        }
        ...
        //! Returns a reference to the entry when present, nullptr otherwise
