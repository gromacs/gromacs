...
/*! \brief Structure containing the local atom information for a plain list */
typedef struct {
    int  la;   /**< The local atom index */
    int  cell; /**< The DD zone index for neighboring domains, zone+zone otherwise */
} gmx_laa_t;

/*! \brief Structure containing the local atom information for a hash table */
typedef struct {
...
/*! \brief Structure containing all global to local mapping information */
 ...
 * \return a pointer to a gmx_ga2la_t struct
 */
