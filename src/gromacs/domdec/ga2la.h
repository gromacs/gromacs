 ...
 */
static void ga2la_clear(gmx_ga2la *ga2la)
{
    int i;
...
/*! \brief Initializes and returns a pointer to a gmx_ga2la structure
 *
 ...
 */
static gmx_ga2la *ga2la_init(int natoms_total, int natoms_local)
{
    gmx_ga2la *ga2la;
 ...
 */
static void ga2la_set(gmx_ga2la *ga2la, int a_gl, int a_loc, int cell)
{
    int ind, ind_prev, i;
 ...
 * \param[in]     a_gl  The global atom index
 */
static void ga2la_del(gmx_ga2la *ga2la, int a_gl)
{
    int ind, ind_prev;
 ...
 */
static void ga2la_change_la(gmx_ga2la *ga2la, int a_gl, int a_loc)
{
    int ind;
 ...
 */
static gmx_bool ga2la_get(const gmx_ga2la *ga2la, int a_gl, int *a_loc, int *cell)
{
    int ind;
 ...
 */
static gmx_bool ga2la_get_home(const gmx_ga2la *ga2la, int a_gl, int *a_loc)
{
    int ind;
 ...
 * \return if the global atom a_gl is a home atom
 */
static gmx_bool ga2la_is_home(const gmx_ga2la *ga2la, int a_gl)
{
    int ind;
