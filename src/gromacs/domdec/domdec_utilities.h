...
#ifndef GMX_DOMDEC_DOMDEC_UTIL_H
#define GMX_DOMDEC_DOMDEC_UTIL_H

#include "gromacs/legacyheaders/types/forcerec.h"

/* Return the charge group information for global charge group cg_gl */
int ddcginfo(const cginfo_mb_t *cginfo_mb, int cg_gl);
