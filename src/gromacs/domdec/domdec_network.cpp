...
void dd_sendrecv_int(const class gmx_domdec_t gmx_unused *dd,
...
void dd_sendrecv_real(const class gmx_domdec_t gmx_unused *dd,
                      int gmx_unused ddimind, int gmx_unused direction,
...
void dd_sendrecv_rvec(const class gmx_domdec_t gmx_unused *dd,
                      int gmx_unused ddimind, int gmx_unused direction,
...
void dd_sendrecv2_rvec(const class gmx_domdec_t gmx_unused *dd,
