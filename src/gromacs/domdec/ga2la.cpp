...
/*! \brief Returns the size of the direct list to be used with a hash table
 *
 ...
 */
static int directListSizeWithHashTable(int numAtomsLocal)
{
...
gmx_ga2la_t::gmx_ga2la_t(int numAtomsTotal,
                         int numAtomsLocal) :
    direct_(directListIsFaster(numAtomsTotal, numAtomsLocal) ? numAtomsTotal : 0),
    mod_(directListSizeWithHashTable(numAtomsLocal)),
