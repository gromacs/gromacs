...
void dd_store_state(gmx_domdec_t *dd, t_state_local *state)
{
    int i;
...
static void restoreAtomGroups(gmx_domdec_t *dd,
                              const int *gcgs_index, const t_state_local *state)
{
...
static gmx_bool test_dd_cutoff(t_commrec *cr,
                               t_state_local *state, const t_inputrec *ir,
                               real cutoff_req)
{
    gmx_domdec_t *dd;
    gmx_ddbox_t   ddbox;
...
gmx_bool change_dd_cutoff(t_commrec *cr, t_state_local *state, const t_inputrec *ir,
                          real cutoff_req)
{
...
static void dd_sort_state(gmx_domdec_t *dd, rvec *cgcm, t_forcerec *fr, t_state_local *state,
                          int ncg_home_old)
{
                         ...
                         gmx_bool             bVerbose)
{
    ...
    if (bMasterState)
    {
        ...
        auto xGlobal = positionsFromGlobalStatePointer(state_global);
