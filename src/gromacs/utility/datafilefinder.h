 ...
 *
 * By default, current directory is searched in addition to the data
 * directories, and an exception is thrown if the file could not be found.
 * If current directory is searched, it always has the highest precedence.
 *
...
class DataFileOptions
{
    public:
        /*! \brief
         * Constructs default options for searching a file with the specified
         * name.
         *
         * \param[in] filename  File name to search.
         *
         * This constructor is not explicit to allow passing a simple string to
         * DataFileFinder methods to search for such a string with the default
         * parameters.
         */
        ...
        //! Sets whether the current (working) directory is also searched.
...
class DataFileFinder
{
    public:
         ...
         *
         * The constructed finder searches only from the directory specified by
         * the global program context (see ProgramContextInterface), and
         * optionally from the current directory.
         *
         * Does not throw.
         */
        DataFileFinder();
         ...
         * directory specified by the global program context.
         */
         ...
         *
         * \param[in] options  Identifies the file to be searched.
