    ...
    : public              std::iterator<std::forward_iterator_tag, EnumType>
{
    public:
        ...
        /*!@{*/
        EnumerationIterator begin() const { return EnumerationIterator {}; }
        EnumerationIterator end()   const { return EnumerationIterator { Last }; }
        /*!@}*/
 ...
 *  };
 *
 *  const EnumerationNames<Foo, std::string> FooStrings = { { "Bar", "Baz", "Fooz" } };
 *
...
>
struct EnumerationNames final
{
    //! Convenience alias
    using KeyIterator = EnumerationIterator<EnumType, ArraySize>;
    ...
    static constexpr KeyIterator keys() { return KeyIterator {}; }
