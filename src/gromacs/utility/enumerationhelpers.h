 ...
 *
 *  for (EnumerationIterator<Foo> c : iter)
 *  {
    ...
    : public              std::iterator<std::forward_iterator_tag, EnumType>
{
    public:
        ...
        /*!@{*/
        static IteratorType begin() { return IteratorType {}; }
        static IteratorType end()   { return IteratorType { Last }; }
        /*!@}*/
};
...
{
    //! Convenience alias
    using EnumerationWrapper = EnumerationWrapper<EnumType, ArraySize>;
    ...
    static constexpr EnumerationWrapper keys() { return EnumerationWrapper {}; }
