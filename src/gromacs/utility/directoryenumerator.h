...
class DirectoryEnumerator
{
    public:
         ...
         * \param[in,out] result List of files with the given extension in
         *     \p dirname.  Files are appended to the existing list.
         * \throws std::bad_alloc if out of memory.
         * \throws FileIOError if opening the directory fails and `bThrow == true`
         * \throws FileIOError if some other I/O error occurs.
         */
        static void enumerateFilesWithExtension(
         ...
         * \returns `true` if there were more files.
         * \throws  std::bad_alloc if out of memory.
         * \throws  FileIOError if listing the next file fails.
         *
         * If there are more files in the directory, this method returns `true`
         * and sets \p filename to the name of the next file.
         * \p filename will not contain any path information, only the name of
         * the file.
         * If the return value is `false`, \p filename will be cleared.
         *
