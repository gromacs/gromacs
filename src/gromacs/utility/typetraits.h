...
struct isIntegralConstant : public std::integral_constant<bool, false> {};

template<typename Int, Int N>
struct isIntegralConstant<std::integral_constant<Int, N>, void> : public std::integral_constant<bool, true> {};

template<typename Int, Int N>
struct isIntegralConstant<std::integral_constant<Int, N>, Int> : public std::integral_constant<bool, true> {};
