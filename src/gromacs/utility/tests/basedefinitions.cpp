...
TEST(BasedefinitionsTest, GmxAlignedDeclaresAlignedVariable)
{
    ...
    //Do not test larger than biggest type supported.
    //Should use max_align_t but not supported by older compilers (e.g. GCC 4.8)

    constexpr int max_real_align = sizeof(long double)/sizeof(real);
    ...
    constexpr int max_int_align = sizeof(long double)/sizeof(int);
