...
{
    EXPECT_TRUE(regexMatch(";	By user: jenkins (-1)\n", Regex("^;.*\n")));
    EXPECT_TRUE(regexMatch(";	By user: jenkins (-1)\n", Regex("^;[[:blank:]]*.*\n")));
    EXPECT_TRUE(regexMatch(";	By user: jenkins (-1)\n", Regex("^;[[:blank:]]*By user:.*\n")));
    EXPECT_TRUE(regexMatch(";	By user: jenkins (-1)\n", Regex("^;[[:blank:]]*By user:.*$")));
    EXPECT_TRUE(regexMatch(";	Executable:   D:\\jenkins-build\\workspace\\Matrix_PreSubmit_master\\7b6ef549\\gromacs\\bin\\gmxpreprocess-test.exe\n", Regex("^;.*\n")));
    EXPECT_TRUE(regexMatch(";	Executable:   D:\\jenkins-build\\workspace\\Matrix_PreSubmit_master\\7b6ef549\\gromacs\\bin\\gmxpreprocess-test.exe\n", Regex("^;[[:blank:]]*.*\n")));
    EXPECT_TRUE(regexMatch(";	Executable:   D:\\jenkins-build\\workspace\\Matrix_PreSubmit_master\\7b6ef549\\gromacs\\bin\\gmxpreprocess-test.exe\n", Regex("^;[[:blank:]]*Executable:.*\n")));
    EXPECT_TRUE(regexMatch(";	Executable:   D:\\jenkins-build\\workspace\\Matrix_PreSubmit_master\\7b6ef549\\gromacs\\bin\\gmxpreprocess-test.exe\r\n", Regex("^;[[:blank:]]*Executable:.*$")));
    EXPECT_TRUE(regexMatch(";	Executable:   D:\\jenkins-build\\workspace\\Matrix_PreSubmit_master\\7b6ef549\\gromacs\\bin\\gmxpreprocess-test.exe\n", Regex("^;[[:blank:]]*Executable:.*$")));
}
