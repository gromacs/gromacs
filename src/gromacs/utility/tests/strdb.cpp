...
TEST_F(get_a_lineTest, ParsesValidSingleLines)
{
    ...
    runTest("mdp-option = 2", "mdp-option = 2");
    runTest("mdp-option = 3\n", "mdp-option = 3");
    runTest("  mdp-option = 4", "  mdp-option = 4");
    runTest("mdp-option = 5;comment\n", "mdp-option = 5");
    runTest("mdp-option = 6; comment\n", "mdp-option = 6");
    runTest("mdp-option = 7  ; comment\n", "mdp-option = 7  ");
    runTest("  mdp-option = 8  ; comment\n", "  mdp-option = 8  ");
    runTest(";mdp-option = 9  ; comment\n", "");
    runTest("", "");
