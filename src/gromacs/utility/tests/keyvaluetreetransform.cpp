...
TEST_F(TreeValueTransformTest, SimpleTransforms)
{
    ...
    transform.rules()->addRule().from<std::string>("/a").to<int>("/i").transformWith(&gmx::fromStdString<int>);
    transform.rules()->addRule().from<std::string>("/b").to<int>("/j").transformWith(&gmx::fromStdString<int>);
...
TEST_F(TreeValueTransformTest, SimpleTransformsCaseAndDashInsensitive)
{
    ...
    transform.rules()->addRule().from<std::string>("/Ax").to<int>("/i").transformWith(&gmx::fromStdString<int>);
    transform.rules()->addRule().from<std::string>("/B-Y").to<int>("/j").transformWith(&gmx::fromStdString<int>);
...
TEST_F(TreeValueTransformTest, SimpleTransformsToObject)
{
    ...
    gmx::KeyValueTreeTransformer transform;
    transform.rules()->addRule().from<std::string>("/a").to<int>("/foo/i").transformWith(&gmx::fromStdString<int>);
    transform.rules()->addRule().from<std::string>("/b").to<int>("/foo/j").transformWith(&gmx::fromStdString<int>);
...
TEST_F(TreeValueTransformTest, ObjectFromMultipleStrings)
{
    ...
    gmx::KeyValueTreeTransformer transform;
    transform.rules()->addRule().from<std::string>("/a").to<int>("/foo/a").transformWith(&gmx::fromStdString<int>);
