...
TYPED_TEST_CASE(ConstArrayRefTest, ArrayRefTypes);
...
#define DEFINE_VECTOR_FROM_ARRAY(v, a, aSize)   \
    std::vector<TypeParam> v(a, a + aSize)

TYPED_TEST(ConstArrayRefTest, MakeWithAssignmentWorks)
{
...
TYPED_TEST(ConstArrayRefTest, ConstructWithTemplateConstructorWorks)
{
    DEFINE_ARRAY(a, aSize);
    ConstArrayRef<TypeParam> arrayRef(a);
    this->runTests(a, aSize, a, arrayRef);
...
TYPED_TEST(ConstArrayRefTest, ConstructFromPointersWorks)
{
    DEFINE_ARRAY(a, aSize);
...
TYPED_TEST(ConstArrayRefTest, MakeFromPointersWorks)
{
    DEFINE_ARRAY(a, aSize);
...
TYPED_TEST(ConstArrayRefTest, MakeFromArrayWorks)
{
    DEFINE_ARRAY(a, aSize);
...
TYPED_TEST(ConstArrayRefTest, ConstructFromVectorWorks)
{
    DEFINE_ARRAY(a, aSize);
    std::vector<TypeParam>   v(a, a + aSize);
...
TYPED_TEST(ConstArrayRefTest, MakeFromVectorWorks)
{
    DEFINE_ARRAY(a, aSize);
    std::vector<TypeParam>   v(a, a + aSize);
...
#else
            GMX_UNUSED_VALUE(bTestingProblematicConstructor);
#endif
            {
                EXPECT_EQ(aSize, arrayRef.size());
                EXPECT_EQ(a[aSize-1], arrayRef.back());
...
TYPED_TEST_CASE(NonConstArrayRefTest, ArrayRefTypes);
...
TYPED_TEST(NonConstArrayRefTest, ConstructFromStructFieldWithTemplateConstructorWorks)
{
    DEFINE_ARRAY(a, aSize);
    Helper<TypeParam> h;
    h.size = aSize;
...
TYPED_TEST(NonConstArrayRefTest, MakeWithAssignmentWorks)
{
    DEFINE_ARRAY(a, aSize);
...
TYPED_TEST(NonConstArrayRefTest, ConstructWithTemplateConstructorWorks)
{
    DEFINE_ARRAY(a, aSize);
    ArrayRef<TypeParam> arrayRef(a);
    this->runTests(a, aSize, a, arrayRef, false);
...
TYPED_TEST(NonConstArrayRefTest, ConstructFromPointersWorks)
{
    DEFINE_ARRAY(a, aSize);
...
TYPED_TEST(NonConstArrayRefTest, MakeFromPointersWorks)
{
    DEFINE_ARRAY(a, aSize);
...
TYPED_TEST(NonConstArrayRefTest, MakeFromArrayWorks)
{
    DEFINE_ARRAY(a, aSize);
...
TYPED_TEST(NonConstArrayRefTest, ConstructFromVectorWorks)
{
    DEFINE_ARRAY(a, aSize);
    std::vector<TypeParam> v(a, a + aSize);
...
TYPED_TEST(NonConstArrayRefTest, MakeFromVectorWorks)
{
    DEFINE_ARRAY(a, aSize);
    std::vector<TypeParam> v(a, a + aSize);
