 ...
 */
#ifndef GMX_UTILITY_DEFAULTINITALLOCATOR_H
#define GMX_UTILITY_DEFAULTINITALLOCATOR_H
 ...
 *
 * Note that allocator::construct is deprecated in C++17 and removed in C++20
 * so we will need to come up with a better solution then.
 */
...
#endif // GMX_UTILITY_DEFAULTINITALLOCATOR_H
