...
// all outside code accesses the debug output stream through this object
StreamAdapter debug(&cnullpt);
// all outside code accesses the error output stream through this object
StreamAdapter error(&module_errpt);
// all outside code accesses the high   verbosity output stream through this object
StreamAdapter blab3(&cnullpt);
// all outside code accesses the medium verbosity output stream through this object
StreamAdapter blab2(&cnullpt);
// all outside code accesses the low    verbosity output stream through this object
StreamAdapter blab1(&cnullpt);
// all outside code accesses the no     verbosity output stream through this object
