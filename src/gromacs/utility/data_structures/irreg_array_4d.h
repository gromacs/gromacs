...
class IrregArray4D
{
    ...
    public:
        ...
        void initArray(const index_type x1, const index_type x2, const IrregArray1D<size_type, AForeign> &sizes1, const index_type z1, const index_type z2, const IrregArray1D<size_type, AForeign> &sizes2)
        {
            ...
            last3_     = z2;
            last4_     = 0;
            // the allocator of sizes1 may differm so create a copy with the right allocator
            IrregArray1D<size_type, allocator_size_type> irregVec(sizes1);
            IrregArray2D<size_type, allocator_size_type> irregMat(first1_, last1_, irregVec, (size_type)0);
