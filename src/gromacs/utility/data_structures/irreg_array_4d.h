...
class IrregArray4D
{
    ...
    private:
        ...
        index_type              last4_;
        //! row-specific last_ing index of dimension 2
        IrregArray1D<size_type> irreg_;
        //! row,column-specific last_ing index of dimension 3
        IrregArray2D<size_type> irreg_mat_;
        //! dimension1,2,3-specific last_ing index of dimension 4
        IrregArray3D<size_type> irreg_ten_;
    ...
    public:
         ...
         */
        IrregArray4D()
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), is_irreg_(false), arr_(nullptr)
        {
        }
        /*! \brief  copy constructor

            \param[in]   iniT   array to be copied
         */
        IrregArray4D(const IrregArray4D<value_type> &iniT)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), is_irreg_(false), arr_(nullptr)
        {
            initArray(iniT);
        }
        ...
        IrregArray4D(const IrregArray4D<value_type, AForeign> &iniT)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), is_irreg_(false), arr_(nullptr)
        {
            initArray(iniT);
        }
        ...
        IrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const IrregArray3D<size_type, AForeign> &sizes3)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), is_irreg_(true), arr_(nullptr)
        {
         ...
         */
        template <class AForeign = allocator_size_type>
        IrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const IrregArray3D<size_type, AForeign> &sizes3, const value_type &ini)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), is_irreg_(true), arr_(nullptr)
        {
        ...
        IrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const index_type z1, const index_type z2, const size_type *sizes2)
            : first1_(x1), first2_(1), first3_(z1), first4_(1), last1_(0), last2_(0), last3_(0), last4_(0), is_irreg_(true), arr_(nullptr)
        {
            initArray(x1, x2, IrregArray1D<size_type, allocator_size_type>(x1, x2, sizes1), z1, z2, sizes2);
        }
        /*! \brief   specialized constructor for irregular, symmetrically shaped matrices
                     application: interaction energy matrix site1 form1(site1) site2 form2(site2)
        ...
        IrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const index_type z1, const index_type z2, const size_type *sizes2, const value_type &ini)
            : first1_(x1), first2_(1), first3_(z1), first4_(1), last1_(0), last2_(0), last3_(0), last4_(0), is_irreg_(true), arr_(nullptr)
        {
            initArray(x1, x2, IrregArray1D<size_type, allocator_size_type>(x1, x2, sizes1), z1, z2, IrregArray1D<size_type, allocator_size_type>(z1, z2, sizes2), ini);
        }
        /*! \brief   specialized constructor for irregular, symmetrically shaped matrices
                     application: interaction energy matrix site1 form1(site1) site2 form2(site2)
         ...
         */
        template <class AForeign = allocator_size_type>
        IrregArray4D(const index_type s1, const index_type s2, const index_type s3, const index_type s4, const index_type d1, const size_type *sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const value_type &ini)
            : first1_(s1), first2_(s2), first3_(s3), first4_(s4), last1_(s1+d1-1), last2_(0), last3_(0), last4_(0), is_irreg_(true), arr_(nullptr)
        {
            initArray(s1, s2, s3, IrregArray1D<size_type, allocator_size_type>(s1, s1 + d1 - 1, sizes1), sizes2, ini);
        }
         ...
         */
        template <class AForeign = allocator_size_type>
        IrregArray4D(const index_type s1, const index_type s2, const index_type s3, const index_type s4, const index_type d1, const size_type *sizes1, const IrregArray2D<size_type, AForeign> &sizes2)
            : first1_(s1), first2_(s2), first3_(s3), first4_(s4), last1_(s1 + d1 - 1), last2_(0), last3_(0), last4_(0), is_irreg_(true), arr_(nullptr)
        {
            initArray(s1, s2, s3, IrregArray1D<size_type, allocator_size_type>(s1, (s1 + d1 - 1), sizes1), sizes2);
        }
        /*! \brief   specialized constructor for irregular, symmetrically shaped matrices
                     application: interaction energy matrix site1 form1(site1) site2 form2(site2)
        ...
        IrregArray4D(const index_type x1, const index_type x2, const IrregArray1D<size_type, AForeign> &sizes1, const index_type z1, const index_type z2, const IrregArray1D<size_type, AForeign> &sizes2, const value_type &ini)
            : first1_(x1), first2_(x1), first3_(z1), first4_(z1), last1_(x2), last2_(0), last3_(z2), last4_(0), is_irreg_(true), arr_(nullptr)
        {
            ...
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), is_irreg_(true), arr_(nullptr)
        {
            ...
            value_type prev_length = (ini.begin())->size();
            ...
            if (!is_irreg_)
            {
                value_type prev_length = ini.begin()->begin()->size();
                for (l4_ilist_ptr_type iPtrL4 = ini.begin(); iPtrL4 != ini.end(); ++iPtrL4)
                {
            ...
            if (!is_irreg_)
            {
                value_type prev_length = ini.begin()->begin()->begin()->size();
                for (l4_ilist_ptr_type iPtrL4 = ini.begin(); iPtrL4 != ini.end(); ++iPtrL4)
                {
                    for (l3_ilist_ptr_type iPtrL3 = iPtrL4->begin(); iPtrL3 != iPtrL4->end(); ++iPtrL3)
                    {
        ...
        void initArray(const IrregArray4D<TForeign, AForeign> &ini)
        {
            if (ini.arr_ != nullptr)
            {
                if (ini.is_irreg_)
                {
                    initArray(ini.first1_, ini.last1_, ini.irreg_, ini.irreg_mat_, ini.irreg_ten_);
                }
                else
                {
        ...
        void initArray(const index_type x1, const index_type y1, const index_type z1, const index_type k1, const IrregArray1D<size_type, AForeign> &sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const IrregArray3D<size_type, AForeign> &sizes3)
        {
            ...
            last3_     = 0;
            last4_     = 0;
            irreg_.initArray(first1_, last1_);
            for (index_type i = getFirst1(); i <= getLast1(); i++)
            {
                irreg_[i] = sizes1(i);
            }
            irreg_mat_.initArray(getBegin1(), getLast1(), irreg_);
            for (index_type i = getFirst1(); i <= getLast1(); i++)
            {
            ...
            irreg_ten_.initArray(getBegin1(), getLast1(), irreg_, irreg_mat_);
            for (index_type i = getFirst1(); i <= getLast1(); i++)
            {
                for (index_type j = getFirst2(); j <= getLast2(i); j++)
                {
        ...
        void initArray(const index_type x1, const index_type x2, const IrregArray1D<size_type, AForeign> &sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const IrregArray3D<size_type, AForeign> &sizes3)
        {
            ...
            IrregArray1D<size_type> tmpIrreg(first1_, last1_, (size_type)0);
        ...
        void initArray(const index_type x1, const index_type x2, const IrregArray1D<size_type, AForeign> &sizes1, const index_type z1, const index_type z2, const IrregArray1D<size_type, AForeign> &sizes2)
        {
            ...
            irreg_mat_.initArray(first1_, last1_, sizes1, (size_type)0);
            ...
            irreg_ten_.initArray(first1_, last1_, irreg_, irreg_mat_, (size_type)0);
            for (index_type i = first1_; i <= last1_; i++)
            {
                for (index_type j = first2_; j <= getLast2(i); j++)
                {
        ...
        {
            initArray(x1, x2, IrregArray1D<size_type, allocator_size_type>(x1, x2, sizes1), z1, z2, IrregArray1D<size_type, allocator_size_type>(z1, z2, sizes2));
        }
        ...
        {
            return (is_irreg_ ? irreg_[x] : (last2_ - first2_ + 1));
        }
        ...
        {
            return (is_irreg_ ? irreg_mat_(x, y) : (last3_ - first3_ + 1));
        }
        ...
        {
            return (is_irreg_ ? irreg_ten_(x, y, z) : (last4_ - first4_ + 1));
        }
        ...
        {
            return (is_irreg_ ? (irreg_[x] + first2_ - 1) : last2_);
        }
        ...
        {
            return (is_irreg_ ? (irreg_mat_(x, y) + first3_ - 1) : last3_);
        }
        ...
        {
            return (is_irreg_ ? (irreg_ten_(x, y, z) + first4_ - 1) : last4_);
        }
        ...
        {
            return (is_irreg_ ? (irreg_[x] + first2_) : (last2_ + 1));
        }
        ...
        {
            return (is_irreg_ ? (irreg_mat_(x, y) + first3_) : (last3_ + 1));
        }
        ...
        {
            return (is_irreg_ ? (irreg_ten_(x, y, z) + first4_) : (last4_ + 1));
        }
        ...
        size_type getSize() const
        {
            ...
            size += irreg_ten_.getSize() - sizeof(IrregArray3D<size_type>);
            // the storage data
        ...
        void deallocateArray()
        {
            if (arr_ != nullptr)
            {
                ...
                for (index_type i = getFirst1(); i <= getLast1(); ++i)
                {
                    for (index_type j = getFirst2(); j <= getLast2(i); ++j)
                    {
                        for (index_type k = getFirst3(); k <= getLast3(i, j); ++k)
                        {
                            ...
                            {
                                allocator_.destroy( &this->operator()(i, j, k, l));
                            }
                        }
                    }
                }
                ...
                for (index_type i = getFirst1(); i <= getLast1(); i++)
                {
                    for (index_type j = getFirst2(); j <= getLast2(i); j++)
                    {
                        for (index_type t = getFirst3(); t <= getLast3(i, j); t++)
                        {
                            arr_[i][j][t] += first4_;
                            allocator_.deallocate(arr_[i][j][t], getLength4(i, j, t));
                        }
                        arr_[i][j] += first3_;
                        p_allocator_.deallocate(arr_[i][j], getLength3(i, j));
                    }
                    arr_[i] += first2_;
                    p2_allocator_.deallocate(arr_[i], getLength2(i));
                }
                arr_ += first1_;
                p3_allocator_.deallocate(arr_, getLength1());
...
/* if block allocation was used
                else
                {
                    ...
                    allocator_.deallocate(arr_[first1_][first2_][first3_], d1*d2*d3*d4);
                    arr_[first1_][first2_] += first3_;
                    p_allocator_.deallocate(arr_[first1_][first2_], d1*d2*d3);
                    arr_[first1_] += first2_;
                    p2_allocator_.deallocate(arr_[first1_], d1*d2);
                    arr_ += first1_;
                    p3_allocator_.deallocate(arr_, d1);
                }
 */
    ...
    private:
        ...
        void allocateArray()
        {
            ...
            try
            {
                arr_  = p3_allocator_.allocate(getLength1());
                arr_ -= getFirst1();
                for (index_type i = getFirst1(); i <= getLast1(); ++i)
                {
                    arr_[i]  = p2_allocator_.allocate(getLength2(i));
                    arr_[i] -= getFirst2();
                }
                for (index_type i = getFirst1(); i <= getLast1(); i++)
                {
                    for (index_type j = getFirst2(); j <= getLast2(i); ++j)
                    {
                        arr_[i][j]  = p_allocator_.allocate(getLength3(i, j));
                        arr_[i][j] -= getFirst3();
                    }
                }
                for (index_type i = getFirst1(); i <= getLast1(); i++)
                {
                    for (index_type j = getFirst2(); j <= getLast2(i); ++j)
                    {
                        for (index_type k = getFirst3(); k <= getLast3(i, j); ++k)
                        {
                            arr_[i][j][k]  = allocator_.allocate(getLength4(i, j, k));
            ...
            for (index_type i = getFirst1(); i <= getLast1(); ++i)
            {
                for (index_type j = getFirst2(); j <= getLast2(i); ++j)
                {
                    for (index_type k = getFirst3(); k <= getLast3(i, j); ++k)
                    {
                        for (index_type l = getFirst4(); l <= getLast4(i, j, k); ++l)
                        {
                            allocator_.construct( &this->operator()(i, j, k, l), value_type());
                        }
                    }
                }
            }
        ...
        void allocateArray(const index_type x1, const index_type x2, const index_type y1, const index_type y2, const index_type z1, const index_type z2, const index_type k1, const index_type k2)
        {
            ...
            try
            {
                arr_              = p3_allocator_.allocate(d1);
                arr_              = arr_ - first1_;
                arr_[x1]          = p2_allocator_.allocate(d1*d2);
                arr_[x1]         -= first2_;
                arr_[x1][y1]      = p_allocator_.allocate(d1*d2*d3);
                arr_[x1][y1]     -= first3_;
                arr_[x1][y1][z1]  = allocator_.allocate(d1*d2*d3*d4);
