...
class IrregArray4D
{
    ...
    private:
        ...
        IrregArray3D<size_type, allocator_size_type> irregTen_;
    ...
    public:
         ...
         */
        IrregArray4D()
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), isIrreg_(false), arr_(nullptr)
        {
        }
        ...
        IrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const IrregArray3D<size_type, AForeign> &sizes3)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), isIrreg_(true), arr_(nullptr)
        {
        ...
        IrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const IrregArray3D<size_type, AForeign> &sizes3, const value_type &ini)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), isIrreg_(true), arr_(nullptr)
        {
            initArray(x1, x2, IrregArray1D<size_type, allocator_size_type>(x1, x2, sizes1), sizes2, sizes3, ini);
        }
        /*! \brief   general constructor helper function for irregularly shaped matrices and all special cases
        ...
        IrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const index_type z1, const index_type z2, const size_type *sizes2)
            : first1_(x1), first2_(1), first3_(z1), first4_(1), last1_(0), last2_(0), last3_(0), last4_(0), isIrreg_(true), arr_(nullptr)
        {
        ...
        IrregArray4D(const index_type s1, const index_type s2, const index_type s3, const index_type s4, const index_type d1, const size_type *sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const value_type &ini)
            : first1_(s1), first2_(s2), first3_(s3), first4_(s4), last1_(s1+d1-1), last2_(0), last3_(0), last4_(0), isIrreg_(true), arr_(nullptr)
        {
...
//std::cout << *this << std::endl;
        ...
        void initArray(const IrregArray4D<TForeign, AForeign> &ini)
        {
            if (ini.arr_ != nullptr)
            {
                if (ini.isIrreg_)
                {
//                    initArray(ini.first1_, ini.last1_, ini.irregTen_.irregMat_.irreg_, ini.irregTen_.irregMat_, ini.irregTen_);
                    initArray(ini.irregTen_);
                }
                else
                {
        ...
        void initArray(const index_type x1, const index_type y1, const index_type z1, const index_type k1, const IrregArray1D<size_type, AForeign> &sizes1, const IrregArray2D<size_type, AForeign> &sizes2, const IrregArray3D<size_type, AForeign> &sizes3)
        {
            ...
            last3_     = 0;
            last4_     = 0;
            irregTen_.initArray(first1_, last1_, sizes1, sizes2);
...
//////////////
        ...
        void initArray(const IrregArray3D<size_type, AForeign> &sizes3)
        {
            ...
            last3_     = 0;
            last4_     = 0;
            irregTen_.initArray(sizes3.irregMat_);
            for (index_type i = getFirst1(); i <= getLast1(); i++)
            {
...
/////////////////
        ...
        void initArray(const index_type x1, const index_type x2, const IrregArray1D<size_type, AForeign> &sizes1, const index_type z1, const index_type z2, const IrregArray1D<size_type, AForeign> &sizes2)
        {
            ...
            IrregArray2D<size_type> irregMat(first1_, last1_, sizes1, (size_type)0);
            ...
            irregTen_.initArray(first1_, last1_, irregVec, irregMat, (size_type)0);
            for (index_type i = first1_; i <= last1_; i++)
            {
                for (index_type j = first2_; j <= getLast2(i); j++)
                {
        ...
        {
            return (isIrreg_ ? irregTen_.getLength2(x) : (last2_ - first2_ + 1));
        }
        ...
        {
            return (isIrreg_ ? irregTen_.getLength3(x, y) : (last3_ - first3_ + 1));
        }
        ...
        {
            return (isIrreg_ ? irregTen_(x, y, z) : (last4_ - first4_ + 1));
        }
        ...
        {
            return (isIrreg_ ? irregTen_.getLast2(x) : last2_);
        }
        ...
        {
            return (isIrreg_ ? irregTen_.getLast3(x, y) : last3_);
        }
        ...
        {
            return (isIrreg_ ? (irregTen_(x, y, z) + first4_ - 1) : last4_);
        }
        ...
        {
            return (isIrreg_ ? irregTen_.getEnd2(x) : (last2_ + 1));
        }
        ...
        {
            return (isIrreg_ ? irregTen_.getEnd3(x, y) : (last3_ + 1));
        }
        ...
        {
            return (isIrreg_ ? (irregTen_(x, y, z) + first4_) : (last4_ + 1));
        }
        ...
        size_type getSize() const
        {
            ...
            size += irregTen_.getSize() - sizeof(IrregArray3D<size_type>);
            // the storage data
