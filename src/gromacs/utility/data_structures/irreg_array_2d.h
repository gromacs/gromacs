...
class IrregArray2D
{
    ...
    public:
         ...
         */
        IrregArray2D()
            : first1_(0), first2_(0), last1_(0), last2_(0), is_irreg_(false), arr_(nullptr) {}
        ...
        IrregArray2D(const index_type x1, const index_type x2, const size_type * const sizes)
            : first1_(0), first2_(0), last1_(0), last2_(0), is_irreg_(false), arr_(nullptr)
        {
            allocateArray(x1, x2, IrregArray1D<size_type, allocator_size_type>(x1, x2, sizes));
        }
        ...
        IrregArray2D(const std::initializer_list<std::initializer_list<value_type> > &ini)
            : first1_(0), first2_(0), last1_(0), last2_(0), is_irreg_(true), arr_(nullptr)
        {
        ...
        {
            IrregArray1D<size_type, allocator_size_type> tmpvec(x1, x2, sizes);
