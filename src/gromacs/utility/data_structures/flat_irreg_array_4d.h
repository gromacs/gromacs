...
class FlatIrregArray4D
{
    ...
    private:
        ...
        index_type                  first4_;
        //! last_ing index of dimension 1
        index_type                  last1_;
        //! last_ing index of dimension 2
        index_type                  last2_;
        //! last_ing index of dimension 3
        index_type                  last3_;
        //! last_ing index of dimension 4
        index_type                  last4_;
    ...
    public:
         ...
         */
        FlatIrregArray4D()
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), is_irreg_(false), arr_(nullptr)
        {
        }
        ...
        FlatIrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2, const FlatIrregArray3D<size_type, AForeign> &sizes3)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), is_irreg_(true), arr_(nullptr)
        {
        ...
        FlatIrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const index_type z1, const index_type z2, const size_type *sizes2)
            : first1_(x1), first2_(1), first3_(z1), first4_(1), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), is_irreg_(true), arr_(nullptr)
        {
        ...
        FlatIrregArray4D(const index_type s1, const index_type s2, const index_type s3, const index_type s4, const index_type d1, const size_type *sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2, const value_type &ini)
            : first1_(s1), first2_(s2), first3_(s3), first4_(s4), last1_(s1 + d1 - 1), last2_(0), last3_(0), last4_(0), nelements_(0), is_irreg_(true), arr_(nullptr)
        {
        ...
        FlatIrregArray4D(const index_type x1, const index_type x2, const IrregArray1D<size_type, AForeign> &sizes1, const index_type z1, const index_type z2, const IrregArray1D<size_type, AForeign> &sizes2, const value_type &ini)
            : first1_(x1), first2_(x1), first3_(z1), first4_(z1), last1_(x2), last2_(0), last3_(z2), last4_(0), nelements_(0), is_irreg_(true), arr_(nullptr)
        {
        ...
        index_type getLast4(const index_type x, const index_type y, const index_type z) const
        {
            if (is_irreg_)
            {
                if (x == last1_ && y == getLast2(last1_) && z == getLast3(last1_, getLast2(last1_)))
                {
                    return nelements_ - 1 - irreg_ten_(x, y, z) + first4_;
                }
                else
                {
                    // get first element of next stripe in the underlying data array of irreg_mat to avoid further conditionals
        ...
        index_type getEnd4(const index_type x, const index_type y, const index_type z) const
        {
            if (is_irreg_)
            {
                if (x == last1_ && y == getLast2(last1_) && z == getLast3(last1_, getLast2(last1_)))
                {
                    return nelements_ - irreg_ten_(x, y, z) + first4_;
                }
                else
                {
                    // get first element of next stripe in the underlying data array of irreg_mat to avoid further conditionals
        ...
        size_type getArrayIndex(const index_type x, const index_type y, const index_type z, const index_type k) const
        {
            if (is_irreg_)
            {
                return irreg_ten_(x, y, z) + (k - first4_);
            }
            else
            {
        ...
        void allocateArray(const index_type s1, const index_type s2, const index_type s3, const index_type s4, const IrregArray1D<size_type, AForeign> &sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2, const FlatIrregArray3D<size_type, AForeign> &sizes3)
        {
            ...
            irreg_ten_.initArray(first1_, last1_, irreg_, irreg_mat_);
            ...
            for (index_type i = first1_; i <= last1_; i++)
            {
                for (index_type j = first2_; j <= first2_ + static_cast<index_type>(irreg_(i)) - 1; j++)
                {
                    for (index_type k = first3_; k <= first3_ + static_cast<index_type>(irreg_mat_(i, j)) - 1; k++)
                    {
                        // zero length seems to be OK with the standard allocator, but size_type may be signed
                        ...
                        {
                            irreg_ten_(i, j, k) = last_index + last_length;
                            last_index          = irreg_ten_(i, j, k);
                            last_length         = sizes3(i, j, k);
                        }
                    }
