...
class FlatIrregArray4D
{
    ...
    private:
        ...
        //! irregTen_[i][j][k] = x is the index of the first actual array element arr_[x] of the
        //! stripe FlatIrregArray3D[i][j][k][:] in dimension 4 of the of the represented 4D array
        FlatIrregArray3D<size_type, allocator_size_type> irregTen_;
    ...
    public:
         ...
         */
        FlatIrregArray4D()
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), isIrreg_(false), arr_(nullptr)
        {
        }
         ...
         */
        FlatIrregArray4D(const FlatIrregArray4D<value_type> &iniT)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), isIrreg_(false), arr_(nullptr)
        {
        ...
        FlatIrregArray4D(const FlatIrregArray4D<value_type, AForeign> &iniT)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), isIrreg_(false), arr_(nullptr)
        {
        ...
        FlatIrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2, const FlatIrregArray3D<size_type, AForeign> &sizes3)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), isIrreg_(true), arr_(nullptr)
        {
         ...
         */
        template <class AForeign = allocator_size_type>
        FlatIrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2, const FlatIrregArray3D<size_type, AForeign> &sizes3, const value_type &ini)
            : first1_(0), first2_(0), first3_(0), first4_(0), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), isIrreg_(true), arr_(nullptr)
        {
        ...
        FlatIrregArray4D(const index_type x1, const index_type x2, const size_type *sizes1, const index_type z1, const index_type z2, const size_type *sizes2)
            : first1_(x1), first2_(1), first3_(z1), first4_(1), last1_(0), last2_(0), last3_(0), last4_(0), nelements_(0), isIrreg_(true), arr_(nullptr)
        {
         ...
         */
        template <class AForeign = allocator_size_type>
        FlatIrregArray4D(const index_type s1, const index_type s2, const index_type s3, const index_type s4, const index_type d1, const size_type *sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2, const value_type &ini)
            : first1_(s1), first2_(s2), first3_(s3), first4_(s4), last1_(s1 + d1 - 1), last2_(0), last3_(0), last4_(0), nelements_(0), isIrreg_(true), arr_(nullptr)
        {
         ...
         */
        template <class AForeign = allocator_size_type>
        FlatIrregArray4D(const index_type s1, const index_type s2, const index_type s3, const index_type s4, const index_type d1, const size_type *sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2)
            : first1_(s1), first2_(s2), first3_(s3), first4_(s4), last1_(s1+d1-1), last2_(0), last3_(0), last4_(0), nelements_(0), isIrreg_(true), arr_(nullptr)
        {
         ...
         */
        template <class AForeign = allocator_size_type>
        void initArray(const index_type x1, const index_type x2, const size_type *sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2, const FlatIrregArray3D<size_type, AForeign> &sizes3)
        {
        ...
        size_type getLength4(const index_type x, const index_type y, const index_type z) const
        {
            if (isIrreg_)
            {
                ...
                {
                    return nelements_ - irregTen_(x, y, z);
                }
                else
                {
                    // get first element of next stripe in the underlying data array of irreg_mat to avoid further conditionals
                    const size_type        i       = irregTen_.getArrayIndex(x, y, z);
                    const size_type* const a       = irregTen_.getArray();
                    return a[i + 1] - a[i];
                }
            }
            else
        ...
        index_type getLast4(const index_type x, const index_type y, const index_type z) const
        {
            if (isIrreg_)
            {
                if (x == last1_ && y == getLast2(last1_) && z == getLast3(last1_, getLast2(last1_)))
                {
                    return nelements_ - 1 - irregTen_(x, y, z) + first4_;
                }
                else
                {
                    // get first element of next stripe in the underlying data array of irreg_mat to avoid further conditionals
        ...
        index_type getEnd4(const index_type x, const index_type y, const index_type z) const
        {
            if (isIrreg_)
            {
                if (x == last1_ && y == getLast2(last1_) && z == getLast3(last1_, getLast2(last1_)))
                {
                    return nelements_ - irregTen_(x, y, z) + first4_;
                }
                else
                {
                    // get first element of next stripe in the underlying data array of irreg_mat to avoid further conditionals
        ...
        size_type getArrayIndex(const index_type x, const index_type y, const index_type z, const index_type k) const
        {
            if (isIrreg_)
            {
                return irregTen_(x, y, z) + (k - first4_);
            }
            else
            {
        ...
        size_type getSize() const
        {
            ...
            size += irregTen_.getSize() - sizeof(FlatIrregArray3D<size_type>);
            // the storage data
        ...
        void allocateArray(const index_type s1, const index_type s2, const index_type s3, const index_type s4, const IrregArray1D<size_type, AForeign> &sizes1, const FlatIrregArray2D<size_type, AForeign> &sizes2, const FlatIrregArray3D<size_type, AForeign> &sizes3)
        {
            ...
            irregTen_.initArray(first1_, last1_, irregVec, irregMat);
            ...
            for (index_type i = first1_; i <= last1_; i++)
            {
                for (index_type j = first2_; j <= first2_ + static_cast<index_type>(irregVec(i)) - 1; j++)
                {
                    for (index_type k = first3_; k <= first3_ + static_cast<index_type>(irregMat(i, j)) - 1; k++)
                    {
                        ...
                        {
                            irregTen_(i, j, k)  = 0;
                            last_index          = irregTen_(i, j, k);
                            last_length         = sizes3(i, j, k);
                        }
                        else
                        {
                            irregTen_(i, j, k)  = last_index + last_length;
                            last_index          = irregTen_(i, j, k);
                            last_length         = sizes3(i, j, k);
                        }
                    }
