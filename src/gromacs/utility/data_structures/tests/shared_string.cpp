...
TEST_F(SharedStringTest, ImplicitAndExplicitConversion)
{
    ...
    //! implict conversion from shared_string to std::string, MSVC 2012 warns implicit conversion would be ambigous
    std::string test_string1(static_cast<const char*>(test_shared_string1));
