...
TEST_F(SharedStringTest, ConstructDestruct)
{
    ...
    debug << std::endl;
    debug << "-------------------------------------------------------------------------------" << std::endl;
    debug << "Running test 1: creation and destruction of Symtab, Symbol and"                  << std::endl;
    ...
    try
    {
        gmx::Symbol test_symbol;
    }
    catch (std::exception const &e)
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"Symbol\" object." << std::endl;
        debug << "Exception message: " << e.what() << std::endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"Symbol\" object." << std::endl;
    }
    EXPECT_FALSE(caught_exception) << "Construction destruction of \"Symbol\" failed";

    caught_exception = false;
    try
    {
        gmx::Symbuf test_symbuf;
    }
    catch (std::exception const &e)
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"Symbuf\" object." << std::endl;
        debug << "Exception message: " << e.what() << std::endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"Symbuf\" object." << std::endl;
    }
    EXPECT_FALSE(caught_exception) << "Construction destruction of \"Symbuf\" failed";
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"Symtab\" object." << std::endl;
        debug << "Exception message: " << e.what() << std::endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"Symtab\" object." << std::endl;
    }
    EXPECT_FALSE(caught_exception) << "Construction destruction of \"Symtab\" failed";
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"shared_string\" object." << std::endl;
        debug << "Exception message: " << e.what() << std::endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"shared_string\" object." << std::endl;
    }
