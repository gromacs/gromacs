...
inline long double sumArray(const gmx::IrregArray2D<T, Alloc> &test_arr, const size_t ncycles)
{
    long double sum = 0;
    if (!test_arr.isIrreg())
    {
 ...
 */
template<typename T, class Alloc>
inline long double sumArray(const gmx::FlatIrregArray2D<T, Alloc> &test_arr, const size_t ncycles)
{
    long double sum = 0;
    if (!test_arr.isIrreg())
    {
...
TYPED_TEST(ParamIrregArray2DTest, 2DArrayAccessOperatorPerformance)
{
    ...
    const size_type          dim1    = 100;
    const size_type          dim2    = 10;
    const size_1d_array_type sizes(1, dim1, dim2);
    array_type               test_arr(1, dim1, 1, dim2, 1);
    array_type               test_arr2(1, dim1, sizes, 1);
 ...
 */
template<typename T, class Alloc>
inline long double sumArray(const gmx::IrregArray3D<T, Alloc> &test_arr, const size_t ncycles)
{
    long double sum = 0;
    if (!test_arr.isIrreg())
    {
 ...
 */
template<typename T, class Alloc>
inline long double sumArray(const gmx::FlatIrregArray3D<T, Alloc> &test_arr, const size_t ncycles)
{
    long double sum = 0;
    if (!test_arr.isIrreg())
    {
 ...
 */
template<typename T, class Alloc>
inline long double sumArray(const gmx::IrregArray4D<T, Alloc> &test_arr, const size_t ncycles)
{
    long double sum = 0;
    if (!test_arr.isIrreg())
    {
 ...
 */
template<typename T, class Alloc>
inline long double sumArray(const gmx::FlatIrregArray4D<T, Alloc> &test_arr, const size_t ncycles)
{
    long double sum = 0;
    if (!test_arr.isIrreg())
    {
 ...
 */
template<typename T, class Alloc>
inline long double sumArrayCachedIndices(const gmx::IrregArray4D<T, Alloc> &test_arr, const size_t ncycles)
{
    long double sum = 0;
    if (!test_arr.isIrreg())
    {
 ...
 */
template<typename T, class Alloc>
inline long double sumArrayCachedIndices(const gmx::FlatIrregArray4D<T, Alloc> &test_arr, const size_t ncycles)
{
    long double sum = 0;
    if (!test_arr.isIrreg())
    {
...
TYPED_TEST(ParamIrregArray4DTest, 4DArrayAccessOperatorPerformance)
{
    ...
    array_type               test_arr(1, dim1, 1, dim2, 1, dim3, 1, dim4, 1);
    array_type               test_arr2(1, dim1, sizes1, sizes2, sizes3,   1);
