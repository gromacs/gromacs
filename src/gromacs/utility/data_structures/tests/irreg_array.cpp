...
TEST_F(IrregArrayTest, ConstructDestruct)
{
    ...
    catch (std::exception const &e)
    {
        ...
        debug << "Caught std::exception in constructing/destructing a \"IrregArray1D\" object." << endl;
        debug << "Exception message: " << e.what() << endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"IrregArray1D\" object." << endl;
    }
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"IrregArray2D\" object." << endl;
        debug << "Exception message: " << e.what() << endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"IrregArray2D\" object." << endl;
    }
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"IrregArray3D\" object." << endl;
        debug << "Exception message: " << e.what() << endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"IrregArray3D\" object." << endl;
    }
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"IrregArray4D\" object." << endl;
        debug << "Exception message: " << e.what() << endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"IrregArray4D\" object." << endl;
    }
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"FlatIrregArray2D\" object." << endl;
        debug << "Exception message: " << e.what() << endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"FlatIrregArray2D\" object." << endl;
    }
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"FlatIrregArray3D\" object." << endl;
        debug << "Exception message: " << e.what() << endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"FlatIrregArray3D\" object." << endl;
    }
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception in constructing/destructing a \"FlatIrregArray4D\" object." << endl;
        debug << "Exception message: " << e.what() << endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception in constructing/destructing a \"FlatIrregArray4D\" object." << endl;
    }
...
TEST_F(IrregArrayTest, DataStructuresIrregArray1DUsage)
{
    ...
    {
        caught_exception = true;
        debug << "Caught std::exception while assigning values via operator[]." << endl;
        debug << "Exception message: " << e.what() << endl;
    }
    catch (...)
    {
        caught_exception = true;
        debug << "Caught non-standard exception while assigning via operator[]." << endl;
    }
