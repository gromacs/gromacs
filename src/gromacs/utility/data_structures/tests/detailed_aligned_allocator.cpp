...
TEST_F(DetailedAlignedAllocatorTest, DataStructuresIrregArray2Alloc)
{
    typedef gmx::DefaultAlignedAllocator<unsigned int> default_allocator_type;
    ...
    sizes1[5] = 3;
    sizes1[6] = 9;
    gmx::IrregArray2D<unsigned int, default_allocator_type> test_arr1((ssize_t)0, (ssize_t)6, sizes1, 99u);
...
TEST_F(DetailedAlignedAllocatorTest, DataStructuresIrregArray3DAlloc)
{
    ...
    gmx::IrregArray3D<unsigned int, default_allocator_type> test_arr1((ssize_t)0, (ssize_t)6, sizes1, sizes2, 99u);
...
TEST_F(DetailedAlignedAllocatorTest, DataStructuresIrregArray4DAlloc)
{

//    typedef gmx::DefaultAlignedAllocator<unsigned int> default_allocator_type;

    typedef std::allocator<unsigned int> default_allocator_type;
    ...
    // let the array start with index 0, and initialize it with value 99
    gmx::IrregArray2D<size_t>       sizes2(sizes1.getBegin1(), sizes1.getLast1(), sizes1, 2u);
    gmx::IrregArray3D<size_t>       sizes3(sizes1.getBegin1(), sizes1.getLast1(), sizes1, sizes2, 3u);

    gmx::IrregArray4D<unsigned int, default_allocator_type> test_arr1((ssize_t)0, (ssize_t)0, sizes1, sizes2, sizes3, 99u);
