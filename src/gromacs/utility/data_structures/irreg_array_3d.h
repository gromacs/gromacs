...
class IrregArray3D
{
    ...
    public:
         ...
         */
        IrregArray3D() : first1_(0), first2_(0), first3_(0), last1_(0), last2_(0), last3_(0), is_irreg_(false), arr_(nullptr)
        {
        }
        //! copy constructor
        //! \param[in]   iniT
        IrregArray3D(const IrregArray3D &iniT) : first1_(0), first2_(0), first3_(0), is_irreg_(false), arr_(nullptr)
        {
            initArray(iniT);
        }
        ...
        IrregArray3D(const IrregArray3D<value_type, AForeign> &iniT) : first1_(0), first2_(0), first3_(0), is_irreg_(false), arr_(nullptr)
        {
            initArray(iniT);
        }
        ...
        IrregArray3D(const index_type x1, const index_type x2, const index_type y1, const index_type y2, const index_type z1, const index_type z2)
            : first1_(0), first2_(0), first3_(0), last1_(0), last2_(0), last3_(0), is_irreg_(false), arr_(nullptr)
        {
        ...
        void initArray(const IrregArray3D<TForeign, AForeign> &ini)
        {
            if (ini.arr_ != nullptr)
            {
                if (ini.is_irreg_)
                {
                    initArray(ini.first1_, ini.last1_, ini.irreg_, ini.irreg_mat_);
                }
                else
                {
        ...
        void initArray(const index_type x1, const index_type x2, const IrregArray1D<size_type, AForeign> &sizes1, const IrregArray2D<size_type, AForeign> &sizes2)
        {
            ...
            irreg_mat_.initArray(getBegin1(), getLast1(), irreg_, 0);
        ...
        void initArray(const index_type x1, const index_type x2, const index_type y1, const index_type y2, const IrregArray1D<size_type, AForeign> &sizes)
        {
            ...
            last2_     = y2;
            last3_     = 0;
            const size_type dim2 = last2_ - first2_;
            irreg_.initArray(x1, x2);
