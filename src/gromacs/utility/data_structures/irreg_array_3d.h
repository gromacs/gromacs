...
/*! \file
    ...
    \date Feb 2015
 */
#ifndef GMX_UTILITY_IRREG_ARRAY_3D_H
#define GMX_UTILITY_IRREG_ARRAY_3D_H
...
class IrregArray3D
{
    ...
    private:
        ...
        index_type              end3_;
        //! row-specific end_ing index of dimension 2
        IrregArray1D<size_type> irreg_;
        //! row,column-specific end_ing index of dimension 3
        IrregArray2D<size_type> irreg_mat_;
        //! flag says that dimX(i) = end_X(i) - begin_X(i) + 1 is not a constant
        bool                    is_irreg_;
        ...
        template<class W, typename AW> friend class IrregArray3D;
    ...
    public:
         ...
         */
        IrregArray3D() : begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
        }
        //! copy constructor
        IrregArray3D(const IrregArray3D<value_type> &ini_t) : begin1_(0), begin2_(0), begin3_(0), arr_(nullptr), is_irreg_(false)
        {
            initArray(ini_t);
        }
        ...
        IrregArray3D(const index_type x1, const index_type x2, const index_type y1, const index_type y2, const index_type z1, const index_type z2) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
        ...
        /*! \brief specialized constructor for irregular, symmetrically shaped matrices
            ...
            \param[in]    z2       last index in dimension 3
         */
        IrregArray3D(const index_type x1, const index_type x2, const size_type *sizes, const index_type z1, const index_type z2) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        ...
        /*! \brief specialized constructor for irregular, symmetrically shaped matrices
            ...
            \param[in]    ini      initialization value for the data array elements
         */
        IrregArray3D(const index_type x1, const index_type x2, const size_type *sizes, const index_type z1, const index_type z2, const value_type &ini) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
         ...
         */
        IrregArray3D(const index_type x1, const index_type x2, const size_type *sizes1, const IrregArray2D<size_type> &sizes2) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
        ...
        /*! \brief general constructor for irregularly shaped matrices and all special cases
            ...
            \param[in]    ini      initialization value for the data array elements
         */
        IrregArray3D(const index_type x1, const index_type x2, const size_type *sizes1, const IrregArray2D<size_type> &sizes2, const value_type &ini) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
         ...
         */
        IrregArray3D(const index_type x1, const index_type x2, const IrregArray1D<size_type> &sizes, const index_type z1, const index_type z2) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
            initArray(x1, x2, sizes, z1, z2);
        }
        /*! \brief general constructor for irregularly shaped matrices and all special cases
            ...
            \param[in]    ini      initialization value for the data array elements
         */
        IrregArray3D(const index_type x1, const index_type x2, const IrregArray1D<size_type> &sizes, const index_type z1, const index_type z2, const value_type &ini) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
            initArray(x1, x2, sizes, z1, z2, ini);
        }
        /*! \brief general constructor for irregularly shaped matrices and all special cases
            ...
            \param[in]    sizes2   number of elements in dimension 3 as function of the indices in the lower dimensions
         */
        IrregArray3D(const index_type x1, const index_type x2, const IrregArray1D<size_type> &sizes1, const IrregArray2D<size_type> &sizes2) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
            initArray(x1, x2, sizes1, sizes2);
        }
        /*! \brief general constructor for irregularly shaped matrices and all special cases
            ...
            \param[in]    ini      initialization value for the data array elements
         */
        IrregArray3D(const index_type x1, const index_type x2, const IrregArray1D<size_type> &sizes1, const IrregArray2D<size_type> &sizes2, const value_type &ini) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
         ...
         */
        IrregArray3D(const index_type x1, const index_type x2, const index_type y1, const index_type y2, const size_type *sizes) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        ...
        /*! \brief general constructor for irregularly shaped matrices and all special cases
            ...
            \param[in]    ini      initialization value for the data array elements
         */
        IrregArray3D(const index_type x1, index_type x2, const index_type y1, const index_type y2, const size_type *sizes, const value_type &ini) :
            begin1_(0), begin2_(0), begin3_(0), end1_(0), end2_(0), end3_(0), is_irreg_(false), arr_(nullptr)
        {
            initArray(x1, x2, y1, y2, sizes, ini);
        }
        /*! \brief  initialize IrregArray3D<value_type> from IrregArray3D<T_foreign>,
        ...
        void initArray(const IrregArray3D<T_foreign, A_foreign> &ini)
        {
            if (ini.is_irreg_)
            {
                initArray(ini.begin1_, ini.end1_, ini.irreg_, ini.irreg_mat_);
            }
            else
            {
                initArray(ini.begin1_, ini.end1_, ini.begin2_, ini.end2_, ini.begin3_, ini.end3_);
            }
            for (index_type i = begin1_; i <= end1_; i++)
            {
                for (index_type j = begin2_; j <= getEnd2(i); j++)
                {
                    for (index_type k = begin3_; k <= getEnd3(i, j); k++)
                    {
         ...
         */
        void initArray(const index_type x1, const index_type x2, const size_type *sizes1, const IrregArray2D<size_type> &sizes2)
        {
            is_irreg_ = true;
        ...
        /*! \brief   constructor helper function, assign the book keeping data and allocate memory for
            ...
            \param[in]    sizes2  number of array elements in dimension 3 as a
                                  function of the indices in the lower dimensions
         */
        void initArray(const index_type x1, const index_type x2, const IrregArray1D<size_type> &sizes1, const IrregArray2D<size_type> &sizes2)
        {
            is_irreg_ = true;
            ...
            irreg_mat_.initArray(getBegin1(), getEnd1(), irreg_, 0);
            ...
            allocateArray(getBegin1(), getBegin2(), getBegin3(), dim1, irreg_, irreg_mat_);
        }
        /*! \brief   constructor helper function, assign the book keeping data and allocate memory for
            ...
            \param[in]    ini     initialization value for the data array elements
         */
        void initArray(const index_type x1, const index_type x2, const IrregArray1D<size_type> &sizes1, const IrregArray2D<size_type> &sizes2, const value_type &ini)
        {
            initArray(x1, x2, sizes1, sizes2);
            for (index_type i = x1; i <= x2; i++)
            {
                for (index_type j = x1; j <= getEnd2(i); j++)
                {
                    for (index_type k = x1; k <= getEnd3(i, j); k++)
                    {
                        arr_[i][j][k] = ini;
                    }
                }
        ...
        /*! \brief   constructor helper function, assign the book keeping data and allocate memory for
            ...
            \param[in]    ini     initialization value for the data array elements
         */
        void initArray(const index_type x1, const index_type x2, const IrregArray2D<size_type> &sizes2, const value_type &ini)
        {
        ...
        /*! \brief   assign the book keeping data and allocate memory for the
            ...
            \param[in]    y2      last index in dimension 2
            \param[in]    sizes   number of array elements in dimension 2 as a
                                  function of the indices in the lower dimesions
         */
        void initArray(const index_type x1, const index_type x2, const index_type y1, const index_type y2, const IrregArray1D<size_type> &sizes)
        {
            ...
            end3_   = 0;
            irreg_.initArray(x1, x2);
            irreg_mat_.initArray(x1, x2, y1, y2, 0);
            for (index_type i = x1; i <= x2; i++)
            {
                irreg_[i] = dim2;
                for (index_type j = y1; j <= y2; j++)
                {
                    irreg_mat_(i, j) = sizes(j);
                }
            }
            allocateArray(begin1_, begin2_, begin3_, dim1, irreg_, irreg_mat_);
        }
        /*! \brief   assign the book keeping data and allocate memory for the
                     book keeping and data arrays
        ...
        void initArray(index_type x1, index_type x2, const IrregArray1D<size_type> &sizes, index_type z1, index_type z2)
        {
            ...
            end3_   = z2;
            irreg_.initArray(x1, x2);
            irreg_mat_.initArray(x1, x2, sizes, dim3);
            for (index_type i = x1; i <= x2; i++)
            {
                irreg_[i] = sizes[i];
                for (index_type j = begin2_; j < begin2_ + sizes[i]; j++)
                {
                    irreg_mat_(i, j) = dim3;
                }
            }
        ...
        size_type getSize() const
        {
            ...
            size += irreg_mat_.getSize() - sizeof(IrregArray2D<size_type>);
            // the storage data
        ...
        void allocateArray(const index_type x1, const index_type x2, const index_type y1, const index_type y2, const index_type z1, const index_type z2)
        {
            ...
            const size_type dim1 = x2 - x1 + 1;
            const size_type dim2 = y2 - y1 + 1;
            const size_type dim3 = z2 - z1 + 1;
            try
            {
                arr_          = p2_allocator_.allocate(dim1+1);
                arr_         -= begin1_;
                arr_[x1]      = p_allocator_.allocate(dim1*dim2);
                arr_[x1]     -= begin2_;
                arr_[x1][y1]  = allocator_.allocate(dim1*dim2*dim3);
                arr_[x1][y1] -= begin3_;
                // since we dont run over all elements in the first dimension ...
                for (index_type i = y1 + 1; i <= y2; i++)
                {
                    arr_[x1][i] = arr_[x1][i-1] + dim3;
                }
                // set the rest
                for (index_type i = x1 + 1; i <= x2; i++)
                {
                    arr_[i]     = arr_[i-1] + dim2;
                    arr_[i][y1] = arr_[i-1][y1] + dim2*dim3;
                    for (index_type j = y1 + 1; j <= y2; j++)
                    {
                        arr_[i][j] = arr_[i][j-1] + dim3;
                    }
                }
            }
            catch (std::bad_alloc)
            ...
            for (index_type i = getBegin1(); i <= getEnd1(); ++i)
            {
                for (index_type j = getBegin2(); j <= getEnd2(); ++j)
                {
                    ...
                    {
                        allocator_.construct( &this->operator()(i, j, k), value_type());
                    }
                }
            }
         ...
         */
        void allocateArray(const index_type s1, const index_type s2, const index_type s3, const index_type d1, const IrregArray1D<size_type> &irr, const IrregArray2D<size_type> &irr_mat)
        {
            const index_type e1 = s1 + d1 - 1;
            try
            {
                arr_ = p2_allocator_.allocate(d1);
                arr_ = arr_ - s1;
                for (index_type i = s1; i <= e1; ++i)
                {
                    arr_[i]  = p_allocator_.allocate(irr[i]);
                    arr_[i] -= s2;
                }
                for (index_type i = s1; i <= e1; i++)
                {
                    for (index_type j = s2; j < static_cast<index_type>(irr[i]) + s2; ++j)
                    {
                        arr_[i][j]  = allocator_.allocate(irr_mat(i, j));
                        arr_[i][j] -= s3;
                    }
                }
            }
            ...
            if (arr_ != nullptr)
            {
                ...
                for (index_type i = getBegin1(); i <= getEnd1(); ++i)
                {
                    for (index_type j = getBegin2(); j <= getEnd2(i); ++j)
                    {
                        for (index_type k = getBegin3(); k <= getEnd3(i, j); ++k)
                        {
                            allocator_.destroy( &this->operator()(i, j, k));
                        }
                    }
                }
                ...
                if (!is_irreg_)
                {
                    ...
                    arr_[begin1_][begin2_] += begin3_;
                    allocator_.deallocate(arr_[begin1_][begin2_], dim1*dim2*dim3+1);
                    arr_[begin1_] += begin2_;
                    p_allocator_.deallocate(arr_[begin1_], dim1*dim2+1);
                    arr_ += begin1_;
                    p2_allocator_.deallocate(arr_, dim1+1);
                }
                else
                {
                    for (index_type i = getBegin1(); i <= getEnd1(); i++)
                    {
                        ...
                        {
                            arr_[i][j] += begin3_;
                            allocator_.deallocate(arr_[i][j], getLength3(i, j));
                        }
                        arr_[i] += begin2_;
                        p_allocator_.deallocate(arr_[i], getLength2(i));
                    }
                    arr_ += begin1_;
                    p2_allocator_.deallocate(arr_, getLength1());
                }
                arr_ = nullptr;
            }
         ...
         */
        IrregArray3D<value_type> &operator=(const IrregArray3D<value_type> &rhs)
        {
            deallocateArray();
            initArray(rhs);
            return *this;
        ...
        /*! \brief  conversion operator (explicit to avoid unintended implicit conversion), usable via
                    IrregArray3D<T_foreign> newArr = static_cast<IrregArray3D<T_foreign> >(FlatIrregArray<T> oldArr);
         */
        template<typename T_foreign, typename A_foreign = std::allocator<T_foreign> >
        explicit
        operator IrregArray3D<T_foreign, A_foreign>() const
        {
            IrregArray3D<T_foreign, A_foreign> result;
