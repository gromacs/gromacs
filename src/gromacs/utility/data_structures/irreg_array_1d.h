...
/*! \file
    ...
    \date Feb 2015
 */
#ifndef GMX_UTILITY_IRREG_ARRAY_1D_H
#define GMX_UTILITY_IRREG_ARRAY_1D_H
...
class IrregArray1D
{
    ...
    public:
         ...
         */
        IrregArray1D()
            : begin1_(0), end1_(0), arr_(nullptr) {}
        ...
        //! get the first index of dimension 1
        index_type getBegin() const { return begin1_; }
        //! get the last index of dimension 1
        index_type getEnd1() const { return end1_; }
        //! get the last index of dimension 1
        index_type getEnd() const { return end1_; }
        ...
        friend std::ostream &operator<<(std::ostream &output, const IrregArray1D &vec)
        {
            ...
            for (index_type i = vec.begin1_; i <= vec.end1_; i++)
            {
