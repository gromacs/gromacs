 ...
 */
#ifndef GMX_UTILITY_DATASTRUCTURES_irregVec_ARRAY_1D_H
#define GMX_UTILITY_DATASTRUCTURES_irregVec_ARRAY_1D_H
...
class IrregArray1D
{
    ...
    public:
         ...
         */
        IrregArray1D()
            : first1_(0), last1_(0), arr_(nullptr) {}
        ...
        //! copy constructor
        //! \param[in]    ini_vec   template to be copied
        IrregArray1D(const IrregArray1D &ini_vec)
            : first1_(0), last1_(0), arr_(nullptr)
        {
            initArray(ini_vec);
        }
         ...
         */
        template<class AForeign = allocator_type>
        IrregArray1D(const IrregArray1D<value_type, AForeign> &ini_vec)
            : first1_(0), last1_(0), arr_(nullptr)
        {
            initArray(ini_vec);
        }
        ...
        void deallocateArray()
        {
            if (arr_ != nullptr)
            {
                ...
                arr_ += first1_;
                allocator_.deallocate(arr_, getLength1());
                arr_ = nullptr;
            }
        }
        //! destructor
