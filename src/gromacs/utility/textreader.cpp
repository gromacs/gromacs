    ...
    public:
        ...
        explicit Impl(const TextInputStreamPointer &stream)
            : stream_(stream), trimLeadingWhiteSpace_(false), trimTrailingWhiteSpace_(false),
              trimTrailingComment_(false), commentChar_(';')
        {
        }
...
void TextReader::trimLeadingWhiteSpace(bool doTrimming)
{
    impl_->trimLeadingWhiteSpace_ = doTrimming;
}

void TextReader::trimTrailingWhiteSpace(bool doTrimming)
{
    impl_->trimTrailingWhiteSpace_ = doTrimming;
}

void TextReader::trimTrailingComment(bool doTrimming)
{
