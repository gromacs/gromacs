 ...
 *
 * That the memory pointed at ostensibly leaks is not a problem in
 * practice (see https://isocpp.org/wiki/faq/ctors for discussion of
 * alternatives and trade-offs). */
std::size_t PageAlignedAllocationPolicy::alignment()
{
    static size_t *thePageSize = new std::size_t(getPageSize());
    return *thePageSize;
}
