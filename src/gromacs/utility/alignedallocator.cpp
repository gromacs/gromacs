 ...
 *
 *  \param bytes  Amount of memory (bytes) to allocate. Asking for zero
 *                bytes will return a pointer that is non-null and properly
 *                aligned (but obviously you should not use it).
 *
