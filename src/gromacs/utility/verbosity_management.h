...
/*! \file
    ...
    \brief
     The header file for the VerbosityManagement class
...
extern StreamAdapter error; //! error messages
extern StreamAdapter debug; //! debugging information
extern StreamAdapter blab3; //! high   detail progress information/intermediate results
extern StreamAdapter blab2; //! medium detail progress information/intermediate results
extern StreamAdapter blab1; //! low    detail progress information/intermediate results
extern StreamAdapter blab0; //! no     detail, essential information only
