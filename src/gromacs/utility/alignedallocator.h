 ...
 *  \tparam alignment  Alignment of memory, specified in number of T objects.
 *
 ...
 * aligned load and store operations in those containers.
 *
...
class AlignedAllocator
{
    public:
        ...
        {
            void *p = internal::alignedMalloc(n*sizeof(T), alignment*sizeof(T));
