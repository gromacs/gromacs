 ...
 *
 * The memory will always be aligned to the estimated cache line size, usually
 * 64 or 128 bytes. It will also be padded by the same amount at the end of the
 ...
 * aligned load and store operations in those containers. The memory will
 * always be aligned to the estimated cache line size, usually 64 or 128 bytes.
 * It will also be padded by the same amount at the end of the area, to help
