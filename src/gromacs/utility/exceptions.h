...
class ErrorMessage
{
    public:
        ...
        ErrorMessage(const std::string &context, const std::string &reason);
        ~ErrorMessage();
        ...
        const std::vector<ErrorMessage> &details() const
        {
            return impl_->details_;
        }

        void addDetails(const ErrorMessage &message)
        {
            impl_->details_.push_back(message);
        }
