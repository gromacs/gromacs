...
/*! \brief
 * Initialize the idef structure in t_topology.
 *
 * \param[in] idef Pointer to idef structure.
 */
void init_idef(t_idef *idef);
/*! \brief
 * Proper clean up of idef structure in t_topology.
 *
 * \param[in] idef Pointer to idef structure.
 * \param[in] fromMtop decide if we should clear data structures shared with
 *                     mtop or not.
 */
