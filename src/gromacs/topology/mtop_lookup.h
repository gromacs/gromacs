                     ...
                     int              *atomIndexInMolecule)
{
    ...
    GMX_ASSERT(*moleculeBlock >= 0 && *moleculeBlock < static_cast<int>(mtop->molblockIndices.size()), "The starting molecule block index for the search should be within range and molblockIndices should not be empty");
    ...
    int molIndex = (globalAtomIndex - globalAtomStart) / mtop->molblockIndices[*moleculeBlock].numAtomsPerMolecule;
    ...
    {
        *atomIndexInMolecule = globalAtomIndex - globalAtomStart - molIndex*mtop->molblockIndices[*moleculeBlock].numAtomsPerMolecule;
    }
}
