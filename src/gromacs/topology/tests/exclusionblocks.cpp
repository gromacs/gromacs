...
static int fillExclusionBlock(ExclusionBlocks *b)
{
    snew(b->nra, b->nr);
    snew(b->a, b->nr);
...
static void compareBlocks(ExclusionBlocks *b, t_blocka *ba)
{
    for (int i = 0; i < b->nr; i++)
    {
...
static void cleanUp(ExclusionBlocks *b, t_blocka *ba)
{
