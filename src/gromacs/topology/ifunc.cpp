...
const t_interaction_function interaction_function[F_NRE] =
{
    ...
    def_nofc    ("DPD",      "DPD"                                                  ),
    def_bond    ("DRUDEBONDS", "Drude Bond",    2, 2, 2,  eNR_BONDS,  drude_bonds   ),
    def_bondnb  ("POLARIZATION", "Polarization", 2, 1, 0,  0,          polarize      ),
    def_bonded  ("ANISOPOL", "Aniso. Pol.", 5, 3, 0,  eNR_ANISOPOL, aniso_pol   ),
    def_bonded  ("WATERPOL", "Water Pol.",      5, 6, 0,  eNR_WPOL,   water_pol     ),
    def_bonded  ("THOLE",    "Thole Pol.",      4, 4, 0,  eNR_THOLE,  thole_pol     ),
    def_bondnb  ("ANHARM_POL", "Anharm. Pol.", 2, 3, 0, 0,          anharm_polarize      ),
    def_bondnb  ("HYPER_POL", "Hyperpolariz.", 2, 4, 0, 0,          hyperpolarize   ),
