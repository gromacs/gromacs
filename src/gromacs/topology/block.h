    ...
    public:
        ...
        struct Block
        {
            public:
                ...
                struct iterator
                {
                    //! Constructor, constructs a range starting at 0 with 0 blocks
        ...
        /*! \brief Return the end of block \p blockIndex-1 and/or the start of block \p blockIndex
         *
         * Can be called with 0 <= \p blockIndex <= \p numBlocks().
         * Returns 0 when \p numBlocks() = 0.
         */
        int boundary(int blockIndex) const
        {
