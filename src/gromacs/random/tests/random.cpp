...
class Treefry : public ::testing::TestWithParam<std::pair<threefry2x64_ctr_t,
                                                          threefry2x64_key_t> >
{
};
...
TEST_P(Treefry, 2x64)
{
    ...
    checker.checkSequenceArray(2, rand.v, "Treefry2x64");
}
...
const threefry2x64_ctr_t tf_max  = {{GMX_UINT64_MAX, GMX_UINT64_MAX}};
/** input value: Pi */
...
INSTANTIATE_TEST_CASE_P(0_ff_pi, Treefry,
