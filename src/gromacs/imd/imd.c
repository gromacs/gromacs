...
extern gmx_bool do_IMD(
        ...
        gmx_int64_t     step,
        t_commrec      *cr,
        gmx_bool        bNS,    /* Is this a neighbor searching step?          */
        matrix          box,
...
extern void IMD_prep_energies_send_positions(t_IMD *imd, gmx_enerdata_t *enerd, gmx_int64_t step, gmx_bool bHaveNewEnergies, gmx_wallcycle_t wcycle)
{
    wallcycle_start(wcycle, ewcIMD);
