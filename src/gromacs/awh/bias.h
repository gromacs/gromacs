...
struct BiasState
{
    ...
    std::vector<PointState> points;   /**< Vector of state of the grid points */
...
class Bias
{
    ...
    private:
         ...
         */
        void setSkippedUpdateHistogramScaleFactors(double *weighthistScaling,
    ...
    private:
         ...
         */
        bool isCovered(const gmx_multisim_t *ms) const;
