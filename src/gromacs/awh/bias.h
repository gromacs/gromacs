...
/*! \internal \brief Global state of a bias.
 *
...
/*! \internal \brief A bias acting on a multidimensional coordinate.
 *
 ...
 *
 * Each coordinate point have further statistical properties and function values
...
class Bias
{
    ...
    private:
        ...
        /* Data members. */
    public:
        const int                    biasIndex;    /**< The index of this bias. Only for writing to the log file. TODO: should be in params. */
    private:
