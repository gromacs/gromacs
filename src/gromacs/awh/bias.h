...
struct DimParams
{
     ...
     * Constructor.
     *
     * \param[in] pullCoordIndex  The pull coordinate index for this dimension.
     * \param[in] pullCoord       The pull coordinate for this dimension.
     * \param[in] beta            1/(k_B T).
     */
    DimParams(int                 pullCoordIndex,
              const t_pull_coord &pullCoord,
              double              beta);
    ...
    const int    pullCoordIndex;           /**< Indices of the pull coordinates for each coordinate dimension. */
...
class Bias
{
    public:
         ...
         */
        void setCoordValue(struct pull_t *pull_work, const t_pbc *pbc);
         ...
         * \param[in,out] fplog          Log file.
         */
        void doStep(bool convolveForce,
                    awh_dvec biasForce,
        ...
        /*! \brief
         * Set pull forces for the pull coordinates the bias is responsible for.
         *
         ...
         */
        void applyForceToPullCoords(const awh_dvec    biasForce,
    ...
    private:
         ...
         * \param[in,out] fplog  Log file.
         */
        void update(const gmx_multisim_t *ms, double t, gmx_int64_t step, FILE *fplog);
         ...
         */
        void doSkippedUpdatesForAllPoints(gmx_int64_t step);
         ...
         * \param[in] step  Current time step.
         */
        void doSkippedUpdatesInNeighborhood(gmx_int64_t step);
