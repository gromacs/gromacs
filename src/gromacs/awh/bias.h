...
{
    public:
        /*! \brief Constructor, does not set up the grid.
         *
        ...
        /*! \brief
         * Partition sampling domain based on the current coordinate reference value, update the histogram size in \p params.
         *
         * \param[in] awhBiasParams  AWH bias parameters.
         * \param[in] grid           The grid setup.
         * \returns the new histogram size.
         */
        double partitionDomain(const awh_bias_params_t &awhBiasParams,
                               const Grid              &grid);
    ...
    public:
         ...
         */
        void setCoordValue(const Grid &grid, int dim, double coordValue);
