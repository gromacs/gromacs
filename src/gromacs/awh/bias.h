...
class Bias
{
    ...
    private:
         ...
         * \param[in,out] fplog  Log file.
         */
        void updateFreeEnergyAndAddSamplesToHistogram(const gmx_multisim_t *ms, double t, gmx_int64_t step, FILE *fplog);
    ...
    private:
         ...
         * \returns the new histogram size.
         */
        double newHistSizeInitialStage(double t, bool detectedCovering, FILE *fplog);
         ...
         */
        void sampleCoordAndPmf(const std::vector<double> &probWeightNeighbor,
    ...
    public:
        /*! \brief
         * Increases the issued warning count by 1.
         */
        void incrementWarningsIssued()
        {
            numWarningsIssued_ += 1;
        }

        /*! \brief
         * Returns the number of warnings issued during this run.
         */
        int numWarningsIssued() const
        {
            return numWarningsIssued_;
        }
