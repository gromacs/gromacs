...
static void inicorrelation_blockdata_t(correlation_blockdata_t *b, double blocklength)
{
    b->sum_wx  = 0;
    b->sum_wy  = 0;
    b->sum_w   = 0;
                             ...
                             double blocklength, bool bConst_nblocks)
{
    ...
    if (bConst_nblocks)
    {
        ...
        {
            inicorrelation_blockdata_t(&corr->blockdata[n], blocklength*scaling);
    ...
    else
    {
        ...
        inicorrelation_blockdata_t(&corr->blockdata[0], blocklength);
        inicorrelation_blockdata_t(&corr->blockdata[1], GMX_DOUBLE_MAX);
    }
}
