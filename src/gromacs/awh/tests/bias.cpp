...
struct AwhTestParameters
{
    ...
    struct AwhDimParams    awhDimParams;  //!< Dimension parameters pointed to by \p awhBiasParams
    struct AwhBiasParams   awhBiasParams; //!< Bias parameters pointed to by \[ awhParams
    struct AwhParams       awhParams;     //!< AWH parameters, this is the struct to actually use
