...
TEST(gridTest, neighborhood)
{
    ...
    static_assert(std::abs(pointsPerScope - std::round(pointsPerScope)) > 1e-4, "If the scope is close to an integer number of points, this test can be unstable due to rounding issues");
