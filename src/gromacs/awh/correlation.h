...
struct correlation_blockdata_t
{
...
struct correlation_t
{
    ...
    correlation_blockdata_t  *blockdata;           /**< The block averaging data */
};
...
struct correlation_matrix_t
{
    ...
    correlation_t *corr;                 /**< Array with the correlation elements corr(x, y) in the matrix, where x, y are vector components. */
};
