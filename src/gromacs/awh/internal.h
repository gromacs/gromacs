...
/*! \brief Query if a coordinate point is in the target sampling region.
 *
 * \param[in] coordpoint      Point to query for.
 * \returns true if the given point is in the target region.
 */
bool in_target_region(const coordpoint_t *coordpoint);
