    ...
    for (int m = 0; m < corrgrid->ncorrmatrix; m++)
    {
        ...
        for (int k = 0; k < corrmatrix->ncorr; k++)
        {
            ...
            for (int l = 0; l < corr->nblockdata; l++)
            {
                ...
                // TODO: Unify these two identical structs
                ...
                blockdata_hist->sum_w2_tot           = blockdata->sum_w2_tot;
                blockdata_hist->sum_wbwx             = blockdata->sum_wbwx;
                blockdata_hist->sum_wbwy             = blockdata->sum_wbwy;
                blockdata_hist->sum_wb2              = blockdata->sum_wb2;
                blockdata_hist->wb2_max              = blockdata->wb2_max;
    ...
    for (int m = 0; m < corrgrid->ncorrmatrix; m++)
    {
        ...
        for (int k = 0; k < corrmatrix->ncorr; k++)
        {
            ...
            for (int l = 0; l < corr->nblockdata; l++)
            {
                ...
                blockdata->sum_w2_tot           = blockdata_hist->sum_w2_tot;
                blockdata->sum_wbwx             = blockdata_hist->sum_wbwx;
                blockdata->sum_wbwy             = blockdata_hist->sum_wbwy;
                blockdata->sum_wb2              = blockdata_hist->sum_wb2;
                blockdata->wb2_max              = blockdata_hist->wb2_max;
