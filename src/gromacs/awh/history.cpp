...
static void restore_bias_state_from_history(const awh_bias_history_t *bias_history, AwhBias *bias)
{
    ...
    linear_gridindex_to_multidim(bias->grid.get(), bias_history->origin_index_updatelist, bias->origin_updatelist);
    linear_gridindex_to_multidim(bias->grid.get(), bias_history->end_index_updatelist, bias->end_updatelist);
