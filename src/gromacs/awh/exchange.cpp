...
static awh_replex_t *init_awh_replica_exchange(const awh_bias_t *awh_bias, const gmx_multisim_t *ms, bool all_replicas_exchange)
{
    awh_replex_t *replex;
                                        ...
                                        const int *exchange_indices, int bMulti_exchange)
{
    ...
    replex = init_awh_replica_exchange(&awh->awh_bias[0], ms, all_replicas_exchange);
