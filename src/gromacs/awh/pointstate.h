...
{
    public:
        /*! \brief Constructor, gives empty histogram with flat target. */
        PointState() : bias_(0),
                       freeEnergy_(0),
                       target_(1),
         ...
         *
         * \param[in] biasState  The global state of the bias.
         */
        void setInitialReferenceWeightHistogram(const BiasState &biasState)
        {
            weightsumRef_ = biasState.histSize*target_;
        }
                           ...
                           gmx_int64_t step, double weighthistScaling, double logPmfsumScaling)
        {
            ...
            int lastUpdateIndex   = step > 0 ? (step - 1)/params.nstupdate_free_energy : 0;
                       ...
                       double weighthistScaling, double logPmfsumScaling)
        {
            ...
            /* Store that this was most recent update performed. */
    ...
    private:
        ...
        void updateFreeEnergy(const BiasParams &params, double weightAtPoint)
        {
            ...
            double weighthistTarget   = weightsumRef() + params.update_weight*target_;
        ...
        void updateWeightHistogram(const BiasParams &params, double weightAtPoint, double scaleFactor)
        {
            if (params.idealWeighthistUpdate)
            {
                ...
                weightsumRef_ += target_*params.update_weight*params.localWeightScaling;
            }
            else
            {
    ...
    public:
        ...
        double updateTarget(const BiasParams &params, double freeEnergyCutoff)
        {
            ...
            target_ *= target_constant_weight;
