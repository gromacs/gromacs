...
/*! \internal \brief An axis, i.e. dimension, of the grid.
 */
struct GridAxis
{
    /*! \brief Returns is the axis has periodic boundaries.
     */
    bool isPeriodic() const
    {
        return npoints_period  > 0;
    }
...
/*! \internal \brief A point in the grid.
 */
struct GridPoint
{
...
/*! \internal \brief The grid, generally multidimensional and periodic.
 */
class Grid
{
    private:
