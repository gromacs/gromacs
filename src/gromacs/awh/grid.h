...
struct Grid
{
    std::vector<GridPoint> point;   /**< Grid points array */
    int                    ndim;    /**< Number of dimensions of the grid */
    std::vector<GridAxis>  axis;    /**< Grid axes array of length ndim */
};
 ...
 */
Grid *init_grid(int ndim, const DimParams *dimParams, const awh_dvec origin, const awh_dvec end,
 ...
 */
void map_grid_to_datagrid(std::vector<int> *gridpoint_to_datapoint, const double* const *datagrid, int ndatapoints,
