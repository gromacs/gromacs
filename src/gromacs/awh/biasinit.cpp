                                     ...
                                     FILE                    *fplog)
{
    ...
    if (fplog != nullptr)
    {
        fprintf(fplog,
                ...
                awhstr, get_blocklength(&bias.forcecorr()),
                measureBlocklengthInWeight ? "" : "ps",
                awhstr, get_nblocks(&bias.forcecorr()));
    }
    ...
    tempWorkSpace_()
{
    ...
    forcecorr_ = init_correlation_grid(pointState_.size(), ndim(),
                                       nblocks, blocklength,
                                       blocklengthInWeight,
                                       mdTimeStep,
                                       params_.numStepsSampleCoord);
