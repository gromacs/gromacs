 ...
 *
 * \brief
 * This file contains the BiasWriter class that writes data of a Bias to energy rames.
 *
...
class BiasWriter
{
    private:
        ...
        {
            return varToBlock_[static_cast<int>(var)] >= 0;
        }
        ...
        {
            return varToBlock_[static_cast<int>(var)];
        }
         ...
         */
        void transferVariablePointDataToWriter(AwhVar                    var,
                                               int                       m,
                                               const Bias               &bias,
    ...
    private:
        ...
        int                varToBlock_[static_cast<int>(AwhVar::Count)]; /**< Start block index for each variable, -1 when variable should not be written */
