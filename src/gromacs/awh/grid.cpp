 ...
 */
static bool local_to_global_index(const grid_t *grid, const awh_ivec origin_local_dim, const awh_ivec local_index_dim,
                          ...
                          double inv_pointvariance, double period)
{
    ...
    else
    {
        ...
        axis->npoints         = 1 + std::max(1, static_cast<int>(ceil(c_pointDensity*nstdevs)));
    }
