...
/*! \libinternal \brief An AWH bias and its coupling to the system.
 */
struct AwhBiasAndCoupling
{
    std::unique_ptr<Bias> bias;           /**< The AWH bias. */
    std::vector<int>      pullCoordIndex; /**< The pull coordinates this bias acts on. */
...
class Awh
{
    ...
    private:
        std::vector<AwhBiasAndCoupling> biasAndCoupling_;  /**< AWH bias + coupling. */
