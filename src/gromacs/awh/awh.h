...
class Awh
{
    public:
         ...
         * these coordinate in \ref Awh::update.
         *
         ...
         * \param[in,out] awhHistoryPtr  Pointer to AWH  history to initialize.
        ...
        /*! \brief Peform an AWH update every MD step.
         *
         ...
         * since AWH need the current coordinate values.
         *
         ...
         */
        real applyBiasForcesAndUpdateFreeEnergies(struct pull_t          *pull_work,
                                                  int                     ePBC,
    ...
    public:
         ...
         *
         * This function is public because it needs to be called at the pre-processing
         * stage by the AWH parameter struct (which needs to be in mdtypes).
         * Pull requires all external potentials to register themselves at this time.
         *
