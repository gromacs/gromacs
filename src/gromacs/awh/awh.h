 ...
 *
 * \brief
 * Declares the AwhBiasCollection class.
 *
...
class AwhBiasCollection
{
    ...
    /* Temporary working vector used during the update of each bias.
    ...
    public:
         ...
         * restore a checkpointed history to the current state if needed.
         *
