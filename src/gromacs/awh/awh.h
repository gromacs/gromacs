...
class AwhBiasCollection
{
    ...
    bool              convolveForce_;    /**< If true, the force on the pull coordinate is convolved. Otherwise, simple umbrella force. */
    gmx_int64_t       seed_;             /**< Random seed. */
    double            potentialOffset_;  /**< The offset of the bias potential due to bias updates. */

    /* Working vector used during the update of each bias */
    std::vector<double>  work;              /**< Working vector of doubles. */
    ...
    public:
        ...
        /*! \brief Returns the number of biases.
         *
        ...
        /*! \brief Returns a const reference to a given bias.
         *
         * \param[in] index  The index of the requested bias.
         * \returns a const reference to the requested bias.
         */
        const Bias &bias(int index) const
        {
            return bias_[index];
        }

        /*! \brief Returns the potential offset.
         *
         * \returns the potential offset.
         */
        double potentialOffset() const
        {
            return potentialOffset_;
        }
