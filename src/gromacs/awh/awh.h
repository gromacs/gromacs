...
class BiasCoupledToSystem
{
    public:
        ...
        /*! \brief Returns the pull coordinate index of the dimension.
         *
    ...
    private:
        std::unique_ptr<Bias> bias_;           /**< The AWH bias. */
...
class Awh
{
    ...
    private:
        std::vector<BiasCoupledToSystem> biasCoupledToSystem_; /**< AWH bias + coupling. */
