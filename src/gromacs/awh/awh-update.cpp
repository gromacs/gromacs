...
static void updateTarget(Bias *bias)
{
    ...
    for (auto &coordPoint : bias->coordPoint)
    {
        ...
        else if (params.eTarget == eawhtargetCUTOFF)
        {
            ...
            coordPoint.target = 1/(1 + std::exp(df));
        }
 ...
 */
static void updateFreeEnergyOfPoint(CoordPoint *coordPoint, const BiasParams &params, double weight_point)
{
 ...
 */
static void updateWeightHistogramOfPoint(CoordPoint *coordPoint, const BiasParams &params, double weight_point, double scaleFactor)
{
 ...
 */
static void updatePoint(CoordPoint *coordPoint, const BiasParams &params,
                        double weight_point, double weighthistScaling, double logPmfsumScaling)
{
    updateFreeEnergyOfPoint(coordPoint, params, weight_point);
    updateWeightHistogramOfPoint(coordPoint, params, weight_point, weighthistScaling);
                               ...
                               gmx_int64_t step, double weighthistScaling, double logPmfsumScaling)
{
    ...
    for (int i = 0; i < nupdates_skipped; i++)
    {
        ...
        updatePoint(coordPoint, params, 0, weighthistScaling, logPmfsumScaling);
    }
...
static void updatePointNew(CoordPoint *coordPoint, const BiasParams &params,
                           gmx_int64_t step, double weighthistScaling, double logPmfsumScaling)
{
    updatePoint(coordPoint, params, coordPoint->weightsum_iteration, weighthistScaling, logPmfsumScaling);
