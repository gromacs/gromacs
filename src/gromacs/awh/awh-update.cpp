...
static const double c_largePositiveExponent =  300.0;
 ...
 *
 * This function also takes care of exiting the initial stage.
 *
 * \param[in,out] awh_bias    AWH bias.
 * \param[in] t               Time.
...
static void update(awh_bias_t *awh_bias, const gmx_multisim_t *ms, double t, gmx_int64_t step, FILE *fplog)
{
    ...
    awh_bias->log_relative_sampleweight -= std::log(weighthistScalingNew);
