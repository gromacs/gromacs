                            ...
                            const awh_params_t      *awh_params)
{
    ...
    awh->bias.resize(awh_params->nbias);
    ...
    for (int k = 0; k < awh_params->nbias; k++)
    {
        ...
        awh->bias[k].params.nstsample_coord       = nstsample_coord;
        awh->bias[k].params.nstupdate_free_energy = nstupdate_free_energy;

        initBias(fplog, ir, cr, k, awh_params->nbias, &awh->bias[k], awh_params->awh_bias_params[k]);
    }
