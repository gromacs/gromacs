 ...
 */
/*! \libinternal \file
 *  \brief Implements a GpuHostSynchronizer class for OpenCL.
 *
 *  \author Aleksei Iupinov <a.yupinov@gmail.com>
 * \inlibraryapi
 */
#ifndef GMX_GPU_UTILS_GPUHOSTSYNCHRONIZER_OCL_H
#define GMX_GPU_UTILS_GPUHOSTSYNCHRONIZER_OCL_H
...
class GpuHostSynchronizer
{
    public:
        //! A constructor
        GpuHostSynchronizer() : event_(nullptr){}
        //! A destructor
        ~GpuHostSynchronizer()
        {
            if (event_)
        ...
        {
            GMX_ASSERT(nullptr == event_, "Do not call markSyncPoint more than once!");
