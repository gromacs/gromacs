...
template <>
struct OpenClTraits<cl_context> : OpenClTraitsBase<cl_context>
{
...
template <>
struct OpenClTraits<cl_command_queue> : OpenClTraitsBase<cl_command_queue>
{
    //! Function that will release a handle of this type.
...
template <>
struct OpenClTraits<cl_program> : OpenClTraitsBase<cl_program>
{
    //! Function that will release a handle of this type.
...
template <>
struct OpenClTraits<cl_kernel> : OpenClTraitsBase<cl_kernel>
{
    //! Function that will release a handle of this type.
    static constexpr ReleaserType releaser = clReleaseKernel;
};

/*! \brief Wrapper of OpenCL type \c cl_type to implement RAII.
 *
