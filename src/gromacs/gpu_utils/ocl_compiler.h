 ...
 *  Nvidia reports 32, AMD for GPU 64. Intel seems to reports 16, but that is not correct,
 *  as it actually picks execution width in run time.
 *  Moreover, this should actually be queried for each kernel individually (Redmine #2520).
 *
