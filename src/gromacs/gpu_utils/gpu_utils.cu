 ...
 */
static gmx_bool init_gpu_application_clocks(gmx::Logger *mdlog, int gmx_unused gpuid, const gmx_gpu_info_t gmx_unused *gpu_info)
{
...
gmx_bool init_gpu(gmx::Logger *mdlog, int mygpu, char *result_str,
