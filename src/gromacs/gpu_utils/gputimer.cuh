...
#ifndef GMX_GPU_UTILS_GPUTIMER_CUH
#define GMX_GPU_UTILS_GPUTIMER_CUH
...
class GpuTimer
{
    ...
    public:
        ...
        /*! \brief
         * Accumulates the total time with the last timespan.
         * To be called after stopRecording and the CUDA stream of the event has been synchronized.
