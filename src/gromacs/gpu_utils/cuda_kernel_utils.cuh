                   ...
                   int index)
{
    ...
    /* Preferring texture objects on any new architecture.
     * Note that the (GMX_PTX_ARCH == 0) condition above accomodates for the host compiler pass,
     * which is not likely to be relevant in the device-side function.
     * It does no harm though, is used in same shape elsewhere in code,
     * and hopefully avoids potential texture reference compilations errors.
     */
