...
class DeviceContext
{
    ...
    private:
        ...
        /*! \brief Mutex to ensure shared context is free of races.
         *
         * Note that contexts might be shared across thread-MPI ranks
         * (with CUDA), or across multiple GPU tasks within a rank. This
         * mutex is common to all threads in a process, so naturally works
         * to keep access free of races. */
