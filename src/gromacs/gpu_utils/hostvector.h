...
class HostVector
{
    private:
        ...
        bool       usingPinningMode_;
        //! Whether the allocation is pinned to a page that will suit efficient GPU transfer.
        bool       isPinned_;
    public:
        //! Default constructor.
        HostVector() : v_(), usingPinningMode_(false), isPinned_(false) {};
        ...
        void usePinningMode(bool newMode);
        //! Pin the allocation to physical memory, if it is not already pinned.
        void pin();
        //! Unpin the allocation, if it is pinned.
        void unpin();
