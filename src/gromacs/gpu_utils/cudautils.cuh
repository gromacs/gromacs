 ...
 *
 * \tparam[in] T         Raw data type
 * \param[out] d_ptr     device pointer to the memory to be deallocated
 * \param[out] texObj    texture object to be deinitialized
 * \param[out] texRef    texture reference to be deinitialized
 * \param[in]  devInfo   pointer to the info struct of the device in use
 */
template <typename T>
