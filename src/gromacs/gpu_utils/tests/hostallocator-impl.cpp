 ...
 * implementation of nvcc mean that no compilation unit should include
 * a gtest header while being compiled by nvcc. None of -isystem,
 * -Wno-undef, nor pragma GCC diagnostic work.
 *
