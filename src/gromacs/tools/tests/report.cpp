...
TEST(ReportTest, WritesCorrectHeadersFormated)
{
...
TEST(ReportTest, WritesCorrectHeadersUnformatted)
{
    gmx::StringOutputStream stream;
    gmx::TextWriter         test(&stream);
