 ...
 */
#ifndef GMX_TOOLS_REPORT_H
#define GMX_TOOLS_REPORT_H
...
void writeInformation(TextOutputFile *outputStream, bool writeFormattedText,
                      const t_inputrec &ir, const gmx_mtop_t &top, bool notStdout);
