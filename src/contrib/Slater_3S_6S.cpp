...
cl_R Slater_3S_6S(cl_R r,cl_R xi,cl_R xj)
{
  ...
  rxj = r*xj;
  if (xi == xj) {
        if (r == 0LL) {  S = (64049LL*xi)/393216LL

    ; } else {  S = (1LL/r)*((-12804747411456000LL + 12804747411456000LL*exp(2LL*rxi) - 
      ...
      if (r == 0LL) { S = (xi*xj*(Power(xi,16LL) + 17LL*Power(xi,15LL)*xj + 136LL*Power(xi,14LL)*Power(xj,2LL) + 
    ...
    ; } else { S = (1LL/r)*((2806650LL*exp(2LL*(rxi + rxj))*Power(Power(rxi,2LL) - Power(rxj,2LL),17LL) + 
