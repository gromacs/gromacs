...
{
  static char *desc[] = {
    "gentop generates a primitive topology from a coordinate file.",
  ...
  int        i,j,k,l,m,ndih,alg,dih,cgtp,eQGEN;
  real       mu;
...
#define NFILE asize(fnm)
  ...
  if (eQGEN != eQGEN_OK) {
    ...
    if (bTOP) {    
      ...
      fp = ffopen(fn,"w");
      print_top_header(fp,fn,"Generated by gentop",TRUE, forcefield,1.0);
	...
	atoms->atomtype[i] = put_symtab(&symtab,
      ...
      print_rtp(ftp2fn(efRTP,NFILE,fnm),"Generated by gentop",
