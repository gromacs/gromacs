...
proper dih.	& {\tt dihedraltypes}	& 2$^{(c)}$ & 1	& $\theta_{max}$ (deg); f$_c$ (\kJmol); mult & X$^{(b)}$ \\
improper dih.	& {\tt dihedraltypes}	& 2$^{(d)}$ & 2	& $\theta_0$ (deg); f$_c$ (\kJmolrad{-2}) & X	\\
...
{\em mandatory} & {\tt atoms}		& 1 & 	& atom type; residue number; 	& 	\\
		...
		&			&   &	& charge group number; q (e); m (u) 	& X$^{(c)}$ \\
\hline
bond		& {\tt bonds}$^{(d,e)}$	& 2 & 1	& b$_0$ (nm); f$_c$ (\kJmolnm{-2})	& X	\\
G96 bond	& {\tt bonds}$^{(d,e)}$	& 2 & 2	& b$_0$ (nm); f$_c$ (\kJmolnm{-4})	& X	\\
morse		& {\tt bonds}$^{(d,e)}$	& 2 & 3	& b$_0$ (nm); D (\kJmol); $\beta$ (nm$^{-1}$) & \\
cubic bond	& {\tt bonds}$^{(d,e)}$ & 2 & 4	& b$_0$ (nm); C$_2$ (\kJmolnm{-2}); & \\
 & & & & C$_3$ (\kJmolnm{-3}) & \\
connection	& {\tt bonds}$^{(d)}$	& 2 & 5	& & \\
harmonic pot.	& {\tt bonds}		& 2 & 6	& b$_0$ (nm); f$_c$ (\kJmolnm{-2})	& X	\\
LJ 1-4		& {\tt pairs}		& 2 & 1	& V$^{(a)}$; W$^{(a)}$ & X \\
angle		& {\tt angles}$^{(e)}$	& 3 & 1	& $\theta_0$ (deg); f$_c$ (\kJmolrad{-2}) & X	\\
G96 angle	& {\tt angles}$^{(e)}$	& 3 & 2	& $\theta_0$ (deg); f$_c$ (\kJmol) & X	\\
proper dih.	& {\tt dihedrals}	& 4 & 1	& $\theta_{max}$ (deg); f$_c$ (\kJmol); mult & X$^{(b)}$	\\
