...
\hline
bond		& {\tt bonds}$^{(c,d)}$	& 2 & 1	& b$_0$ (nm); f$_c$ (\kJmolnm{-2})	& X	\\
G96 bond	& {\tt bonds}$^{(c,d)}$	& 2 & 2	& b$_0$ (nm); f$_c$ (\kJmolnm{-4})	& X	\\
morse		& {\tt bonds}$^{(c,d)}$	& 2 & 3	& b$_0$ (nm); D (\kJmol); $\beta$ (nm$^{-1}$) & X \\
cubic bond	& {\tt bonds}$^{(c,d)}$ & 2 & 4	& b$_0$ (nm); C$_2$ (\kJmolnm{-2}); & \\
 & & & & C$_3$ (\kJmolnm{-3}) & \\
connection	& {\tt bonds}$^{(c)}$	& 2 & 5	& & \\
harmonic pot.	& {\tt bonds}		& 2 & 6	& b$_0$ (nm); f$_c$ (\kJmolnm{-2})	& X	\\
LJ 1-4		& {\tt pairs}		& 2 & 1	& c$_6$ (\kJmolnm{6}); & \\
 & & & & c$_{12}$ (\kJmolnm{12}) & X \\
angle		& {\tt angles}$^{(d)}$	& 3 & 1	& $\theta_0$ (deg); f$_c$ (\kJmolrad{-2}) & X	\\
G96 angle	& {\tt angles}$^{(d)}$	& 3 & 2	& $\theta_0$ (deg); f$_c$ (\kJmol) & X	\\
