...
new module in less than a day, and the extensions required for group kernels
are also very straightforward (group kernels can be more complex, but those
are gradually on their way out). For the higer-level
...
<dd>
This is the top-level wrapper that you should always start to include.
