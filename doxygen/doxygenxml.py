        ...
        if detailselem is not None and len(detailselem) > 0:
            ...
            if detailselem[0].find('libinternal') is not None:
                if self._visibility == DocType.public:
                    ...
                    # TODO: Entity.get_location() should exist for this to work reliably
...
class Member(Entity):
    ...
    def get_location(self):
        return self.get_raw_location().get_location()
            ...
            if len(memberlist) > 1:
                ...
                if otherdeclarations:
                    ...
                    for otherdeclaration in otherdeclarations:
                        details.append('{0}: another declaration is here'.format(otherdeclaration.get_location()))
