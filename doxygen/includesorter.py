...
class GroupedSorter(object):
    ...
    _std_cpp_headers = ['algorithm', 'deque', 'exception', 'iterator',
            'limits', 'list', 'map', 'memory', 'numeric', 'set', 'stdexcept',
    ...
    def get_sortable_object(self, include):
        ...
        if not included_file:
            ...
            if main_header and main_header == included_file:
                ...
                if included_file.is_test_file() or included_file.get_directory().get_name() == 'testutils':
