...
(cd ${RPM_INSTALL_PREFIX}/%{_target}/bin && ln -sf mdrun_mpi mdrun)
...
/usr/local/gromacs/%{_target}/lib/libgmx_mpi.so.1.0.0
/usr/local/gromacs/%{_target}/lib/libgmx_mpi.so.1
/usr/local/gromacs/%{_target}/lib/libmd_mpi.so.1.0.0
/usr/local/gromacs/%{_target}/lib/libmd_mpi.so.1
%files devel
%defattr(-,root,root)
/usr/local/gromacs/share/template/*
/usr/local/gromacs/%{_target}/lib/libgmx_mpi.so
/usr/local/gromacs/%{_target}/lib/libgmx_mpi.a
/usr/local/gromacs/%{_target}/lib/libgmx_mpi.la
/usr/local/gromacs/%{_target}/lib/libmd_mpi.so
/usr/local/gromacs/%{_target}/lib/libmd_mpi.a
/usr/local/gromacs/%{_target}/lib/libmd_mpi.la
