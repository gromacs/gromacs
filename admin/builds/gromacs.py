...
def do_build(context):
    ...
    if context.job_type == JobType.RELEASE:
        ...
        if not context.opts.mdrun_only:
            ...
            if context.opts.gmxapi_version:
                gmxapi_cmd = 'bash  ' + os.path.join(context.workspace.get_project_dir(Project.GROMACS), 'admin', 'builds','gmxapitest.sh' + context.opts.gmxapi_version)
