...
def do_build(context):
    cmd = [context.env.cmake_command]
    if context.opts.release or context.params.get('RELEASE', Parameter.bool):
        cmd += ['-DGMX_BUILD_TARBALL=ON']
    cmd += ['-P', 'cmake/gmxVersionInfo.cmake']
