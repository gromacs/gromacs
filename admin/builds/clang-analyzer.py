...
def do_build(context):
    ...
    context.build_target(target=libgromacs)
    context.build_target(target=gmx_objlib)
    context.build_target(target=mdrun_objlib)
    context.build_target(target=view_objlib)
