...
#    run_build(context, cmake_opts)
    ...
    files = context.run_check_output(cmd, failure_message='git ls-files failed').splitlines()

    cmd = ['tar', 'cfz', 'new-reference-data.tgz', files]
    context.run_cmd(cmd, failure_message='failed to make tarball of new reference data')
