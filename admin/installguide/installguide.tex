...
Most often \gromacs{} build will by default not be portable,
...
By default, this will be done by the build system based on the capabilities
...
binaries for each architecture present in the heteroggeneraleneous environment.
