...
system size (see ``Running in parallel''). Building for Xeon Phi works
almost as any other Unix. See the instructions above for details. The
recommended configuration is
\begin{verbatim}
CFLAGS=-mmic CXXFLAGS=-mmic cmake .. -DGMX_FFT_LIBRARY=mkl
make
make install
\end{verbatim}
