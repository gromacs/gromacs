...
\subsubsection{Making a distributable build}
...
portable across a family of processors can be build by choosing the
least common denominator of SIMD support, and setting the \cmake{}
option \verb+GMX_DISTRIBUTABLE_BUILD+ on. This might be necessary if
the build host is different from that used at runtime. mdrun will
check for problems before they arise.
