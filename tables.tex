...
the single cut-off denoted by the variables rshort and rlong (see
above). These variables should be the same (but need not be 1.0) and
consistent with the table data.  The neighborsearching algorithm will
search all atom-pairs within a distance rlong and compute the
interactions using your potential functions.
